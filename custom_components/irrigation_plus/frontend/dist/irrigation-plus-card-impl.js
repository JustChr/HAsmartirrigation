...
`;const vi=e=>String(e).padStart(2,"0");function wi(e){return e instanceof Date?e:new Date(e)}function ki(e){const t=wi(e);return`${vi(t.getHours())}:${vi(t.getMinutes())}`}function xi(e){const t=wi(e);return`${t.getFullYear()}-${vi(t.getMonth()+1)}-${vi(t.getDate())} ${vi(t.getHours())}:${vi(t.getMinutes())}`}function zi(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class Si extends(Ee(le)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){fe().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const i=Object.values(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).some(e=>!0!==e.queued&&!0!==e.paused);i&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):i||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[i,n,o,r]=await Promise.all([(t=this.hass,t.callWS({type:_e+"/config"})),xe(this.hass),ze(this.hass).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),Se(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=i,this.zones=n,this._outlook=o,this._distributors=r,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),bi(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),bi(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),bi(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const i="all"===t,n=i?void 0:this.zones.find(e=>{var i;return(null===(i=e.id)||void 0===i?void 0:i.toString())===t}),o=i?`(${this._linkedZoneCount})`:`: ${null!==(e=null==n?void 0:n.name)&&void 0!==e?e:t}`;try{await(r=this.hass,a=i?void 0:t,r.callWS(Object.assign({type:_e+"/irrigate_now"},void 0!==a?{zone_id:a}:{}))),fi(this,`${ui("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${o}`)}catch(e){const t=mi(e);console.error("irrigate_now failed",e),fi(this,`${ui("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var r,a}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const i=new Date(t);return i.getTime()>Date.now()?i:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:_e+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),bi(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:_e+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),bi(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,i;const n=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(i=this._runMinutes[n])&&void 0!==i?i:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const i=this._zoneDistributor(e);return!!i&&Object.keys(null!==(t=i.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var i,n,o;if(t>0)try{await(i=this.hass,n=e.id.toString(),o=t,i.callWS({type:_e+"/run_zone",zone_id:n,duration:o})),fi(this,`${ui("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=mi(e);console.error("run_zone failed",e),fi(this,`${ui("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===i?void 0:i[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,i;if(this.hass&&void 0!==e.id)try{await(t=this.hass,i=e.id.toString(),t.callWS({type:_e+"/stop_zone",zone_id:i})),fi(this,`${ui("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=mi(e);console.error("stop_zone failed",e),fi(this,`${ui("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var i,n;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,n=t.id.toString(),i.callApi("POST",_e+"/zones",{id:n,calculate:!0,override_cache:!0})).catch(e=>{const t=mi(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var i,n;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,n=t.id.toString(),i.callApi("POST",_e+"/zones",{id:n,update:!0})).catch(e=>{const t=mi(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;pi(0,t?_i("setup","zones",t):_i("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,i,n;const o=null!==(t=e.duration)&&void 0!==t?t:0,r=Number(null!==(i=e.bucket_threshold)&&void 0!==i?i:0),a=this._zoneEstimate(e),s=a&&a.available&&null!=a.live_deficit?a.live_deficit:Number(null!==(n=e.bucket)&&void 0!==n?n:0);return o>0&&s<r}_zoneRunDuration(e){var t,i;const n=this._zoneEstimate(e);return(null===(t=this.config)||void 0===t?void 0:t.live_estimate_enabled)&&n&&n.available&&null!=n.live_deficit&&null!=n.live_duration?{seconds:n.live_duration,live:!0}:{seconds:null!==(i=e.duration)&&void 0!==i?i:0,live:!1}}_zoneWillWater(e){var t;const i=this._zoneRunDuration(e);if(!i.live)return this._zoneHasDeficit(e);const n=Number(null!==(t=e.bucket_threshold)&&void 0!==t?t:0);return this._zoneEstimate(e).live_deficit<n&&i.seconds>0}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,i=new Date(e),n=ki(i),o=new Date;return zi(i,o)?`${ui("panels.zones.outlook.today",t)} ${n}`:zi(i,function(e,t){const i=new Date(e.getTime());return i.setDate(i.getDate()+t),i}(o,1))?`${ui("panels.zones.outlook.tomorrow",t)} ${n}`:function(e,t){const i=wi(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(i)} ${ki(i)}`}(i,t)}_renderEstimatedTag(e){if(!this.hass||!e.estimated)return G``;const t=this.hass.language;return G`<span
    ...
    `}_renderLastRunLine(e){const t=this.hass.language,i=function(e,t){const i=wi(e).getTime()-Date.now(),n=new Intl.RelativeTimeFormat(t,{numeric:"auto"}),o=Math.round(i/1e3);if(Math.abs(o)<60)return n.format(o,"second");const r=Math.round(o/60);if(Math.abs(r)<60)return n.format(r,"minute");const a=Math.round(r/60);if(Math.abs(a)<24)return n.format(a,"hour");const s=Math.round(a/24);if(Math.abs(s)<30)return n.format(s,"day");const l=Math.round(s/30);return Math.abs(l)<12?n.format(l,"month"):n.format(Math.round(l/12),"year")}(e.timestamp,t),n=e.checks.filter(e=>e.enabled&&e.would_skip).map(e=>this._guardLabel(e).toLowerCase()).join(", "),o=e.would_skip?`${ui("panels.zones.outlook.last_run_skipped",t)}${n?` (${n})`:""}`:ui("panels.zones.outlook.last_run_ran",t);return G`
    ...
    `}_renderZoneDecision(e){if(!this.hass)return G``;const t=this.hass.language;let i,n,o,r;if(e.state===$e.Disabled)i=ui("panels.zones.status.decision_disabled",t),n="neutral",o="mdi:power-off";else if(e.last_calculated)if(this._zoneWillWater(e)){const a=gi(this._zoneRunDuration(e).seconds),s=this._triggeredGuards,l=this._nextIrrigateRunForZone(e);s.length>0?(i=ui("panels.zones.status.decision_water_skip",t,"{duration}",a,"{reason}",this._guardLabel(s[0]).toLowerCase()),n="skip",o="mdi:weather-rainy"):l&&l.next_run_utc?(i=ui("panels.zones.status.decision_water_at",t,"{duration}",a,"{time}",this._formatRunTime(l.next_run_utc)),n="water",o="mdi:water",r=l):(i=ui("panels.zones.status.decision_water_no_schedule",t,"{duration}",a),n="water",o="mdi:water-alert")}else i=ui("panels.zones.status.decision_no_water",t),n="ok",o="mdi:check-circle-outline";else i=ui("panels.zones.status.decision_unknown",t),n="unknown",o="mdi:help-circle-outline";return G`
    ...
    `}_renderZoneEstimate(e){if(!this.hass)return G``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return G``;const i=this.hass.language,n=di(this.config,ke),o=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",r=ui(`panels.zones.status.estimate_method.${"proxy"===t.method||"hourly_sensor"===t.method?t.method:"hourly"}`,i)+(t.as_of?` · ${ki(t.as_of)}`:"");return G`
    ...
    `}renderZone(e,t){var i;if(!this.hass)return G``;const n=Number(null!==(i=e.bucket)&&void 0!==i?i:0),o=n<0?"var(--warning-color)":"var(--success-color)",r=e.state===$e.Automatic?"state-automatic":e.state===$e.Manual?"state-manual":"state-disabled",a=e.last_calculated?xi(e.last_calculated):ui("panels.zones.status.never",this.hass.language);return G`
      <ha-card>
    ...
    `}_renderRunZoneControl(e){if(!this.hass||"none"===this.actionsMode||!this._canActuate(e)||void 0===e.id)return G``;const t=this.hass.language,i=String(e.id),n=this._activeRun(e);if(n){const i=!0===n.queued,o=!i&&!0===n.paused,r=i||o?null:this._runSecondsLeft(n);return G`
        <div
        ...
        >
          <span class="run-zone-countdown">
            ...
            ${i?ui("panels.zones.stop_zone.queued",t):o?ui("panels.zones.stop_zone.paused",t):null===r?ui("panels.zones.stop_zone.watering",t):this._formatCountdown(r)}
          </span>
          <button
    ...
    `}_formatCountdown(e){const t=Math.max(0,e),i=Math.floor(t/3600),n=Math.floor(t%3600/60),o=t%60,r=e=>String(e).padStart(2,"0");return i>0?`${i}:${r(n)}:${r(o)}`:`${n}:${r(o)}`}render(){var e,t;if(!this.hass)return G``;if(this.isLoading)return G`

...
`;const ln=e=>String(e).padStart(2,"0");function dn(e){return e instanceof Date?e:new Date(e)}function cn(e){const t=dn(e);return`${ln(t.getHours())}:${ln(t.getMinutes())}`}function hn(e){const t=dn(e);return`${t.getFullYear()}-${ln(t.getMonth()+1)}-${ln(t.getDate())} ${ln(t.getHours())}:${ln(t.getMinutes())}`}function un(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class pn extends(an(ce)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){is().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const i=Object.values(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).some(e=>!0!==e.queued&&!0!==e.paused);i&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):i||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:be+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[i,s,a,n]=await Promise.all([Li(this.hass),Bi(this.hass),(t=this.hass,t.callWS({type:be+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),Vi(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=i,this.zones=s,this._outlook=a,this._distributors=n,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),Ja(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",be+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),Ja(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",be+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),Ja(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const i="all"===t,s=i?void 0:this.zones.find(e=>{var i;return(null===(i=e.id)||void 0===i?void 0:i.toString())===t}),a=i?`(${this._linkedZoneCount})`:`: ${null!==(e=null==s?void 0:s.name)&&void 0!==e?e:t}`;try{await(n=this.hass,o=i?void 0:t,n.callWS(Object.assign({type:be+"/irrigate_now"},void 0!==o?{zone_id:o}:{}))),Xa(this,`${Fa("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${a}`)}catch(e){const t=Va(e);console.error("irrigate_now failed",e),Xa(this,`${Fa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var n,o}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const i=new Date(t);return i.getTime()>Date.now()?i:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:be+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),Ja(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:be+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),Ja(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,i;const s=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(i=this._runMinutes[s])&&void 0!==i?i:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const i=this._zoneDistributor(e);return!!i&&Object.keys(null!==(t=i.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var i,s,a;if(t>0)try{await(i=this.hass,s=e.id.toString(),a=t,i.callWS({type:be+"/run_zone",zone_id:s,duration:a})),Xa(this,`${Fa("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=Va(e);console.error("run_zone failed",e),Xa(this,`${Fa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===i?void 0:i[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,i;if(this.hass&&void 0!==e.id)try{await(t=this.hass,i=e.id.toString(),t.callWS({type:be+"/stop_zone",zone_id:i})),Xa(this,`${Fa("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=Va(e);console.error("stop_zone failed",e),Xa(this,`${Fa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var i,s;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,s=t.id.toString(),i.callApi("POST",be+"/zones",{id:s,calculate:!0,override_cache:!0})).catch(e=>{const t=Va(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var i,s;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,s=t.id.toString(),i.callApi("POST",be+"/zones",{id:s,update:!0})).catch(e=>{const t=Va(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;Ka(0,t?en("setup","zones",t):en("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,i,s;const a=null!==(t=e.duration)&&void 0!==t?t:0,n=Number(null!==(i=e.bucket_threshold)&&void 0!==i?i:0),o=this._zoneEstimate(e),r=o&&o.available&&null!=o.live_deficit?o.live_deficit:Number(null!==(s=e.bucket)&&void 0!==s?s:0);return a>0&&r<n}_zoneRunDuration(e){var t,i;const s=this._zoneEstimate(e);return(null===(t=this.config)||void 0===t?void 0:t.live_estimate_enabled)&&s&&s.available&&null!=s.live_deficit&&null!=s.live_duration?{seconds:s.live_duration,live:!0}:{seconds:null!==(i=e.duration)&&void 0!==i?i:0,live:!1}}_zoneWillWater(e){var t;const i=this._zoneRunDuration(e);if(!i.live)return this._zoneHasDeficit(e);const s=Number(null!==(t=e.bucket_threshold)&&void 0!==t?t:0);return this._zoneEstimate(e).live_deficit<s&&i.seconds>0}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,i=new Date(e),s=cn(i),a=new Date;return un(i,a)?`${Fa("panels.zones.outlook.today",t)} ${s}`:un(i,function(e,t){const i=new Date(e.getTime());return i.setDate(i.getDate()+t),i}(a,1))?`${Fa("panels.zones.outlook.tomorrow",t)} ${s}`:function(e,t){const i=dn(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(i)} ${cn(i)}`}(i,t)}_renderEstimatedTag(e){if(!this.hass||!e.estimated)return W``;const t=this.hass.language;return W`<span
    ...
    ></span>`}_guardLabel(e){return Fa(`panels.zones.outlook.checks.${e.id}`,this.hass.language)}_guardDetail(e){var t;return e.available&&null!==e.observed?Fa(`panels.zones.outlook.check_detail.${e.id}`,this.hass.language,"{observed}",String(e.observed),"{threshold}",String(null!==(t=e.threshold)&&void 0!==t?t:"")):""}_renderSkipReasons(){const e=this.hass.language;return W`
      ...
      <div class="outlook-line outlook-dim skip-reasons-note">
        ${Fa("panels.zones.outlook.provisional",e)}
      </div>
    `}_openSchedules(){Ka(0,en("setup","when-to-water"))}_runActionLabel(e){return Fa(`panels.zones.outlook.actions.${e.action}`,this.hass.language)}_runTargetsLabel(e){const t=this.hass.language;if("all"===e.zones)return Fa("panels.zones.outlook.targets_all",t);const i=Array.isArray(e.zones)?e.zones.length:0;return Fa("panels.zones.outlook.targets_zones",t,"{count}",String(i))}_renderOutlookBanner(){if(!this.hass||!this._outlook)return W``;const e=this.hass.language,t=this._nextIrrigateRun,i=this._triggeredGuards,s=this._outlook.last_skip_evaluation;return t&&t.next_run_utc?W`
      <ha-card class="outlook-card">
        <div class="outlook">
          <div class="outlook-line outlook-headline">
            ...
            <span>
              <strong
                >${Fa("panels.zones.outlook.next_run",e)}:</strong
              >
          ...
          ${i.length>0?W`
                <div class="outlook-line outlook-skip">
                  ...
                  <span
                    >${Fa("panels.zones.outlook.will_skip",e)}</span
                  >
                  <button
                    class="outlook-info-btn"
                    aria-expanded="${this._skipDetailsOpen}"
                    title="${Fa("panels.zones.outlook.why_skipped",e)}"
                  ...
                  >
                    ...
                    <span class="outlook-info-label"
                      >${Fa("panels.zones.outlook.why_skipped",e)}</span
                    >
                  </button>
                </div>
              ...
              `:W`
                <div class="outlook-line outlook-clear">
                  ...
                  <span
                    >${Fa("panels.zones.outlook.will_run",e)}</span
                  >
                </div>
              `}
    ...
    `:W`
        <ha-card class="outlook-card">
          <div class="outlook">
            <div class="outlook-line outlook-headline">
              ...
              <span>${Fa("panels.zones.outlook.no_schedule",e)}</span>
              ${this.hideSettingsLinks?"":W`
                    <button
                      class="outlook-link"
                      @click="${this._openSchedules}"
                    >
                      ${Fa("panels.zones.outlook.setup_schedule",e)}
                    </button>
                  `}
            </div>
            ${s?this._renderLastRunLine(s):""}
        ...
        <ha-card class="rain-delay-card paused">
          <div class="rain-delay">
            ...
            <span class="rain-delay-msg">
              <strong
                >${Fa("panels.zones.rain_delay.paused",e)}</strong
              >
              ${Fa("panels.zones.rain_delay.until",e)}
              ${hn(t.toISOString())}
            </span>
            <button class="action-btn" @click="${()=>this._clearRainDelay()}">
              <ha-icon icon="mdi:play"></ha-icon>
              ${Fa("panels.zones.rain_delay.resume",e)}
            </button>
          </div>
        </ha-card>
      `:W`
      <div class="rain-delay-row">
        <span class="rain-delay-label">
          ...
          ${Fa("panels.zones.rain_delay.title",e)}
        </span>
        <button class="action-btn" @click="${()=>this._setRainDelay(24)}">
          ${Fa("panels.zones.rain_delay.delay_24h",e)}
        </button>
        <button class="action-btn" @click="${()=>this._setRainDelay(48)}">
          ${Fa("panels.zones.rain_delay.delay_48h",e)}
        </button>
      </div>
    `}_renderLastRunLine(e){const t=this.hass.language,i=function(e,t){const i=dn(e).getTime()-Date.now(),s=new Intl.RelativeTimeFormat(t,{numeric:"auto"}),a=Math.round(i/1e3);if(Math.abs(a)<60)return s.format(a,"second");const n=Math.round(a/60);if(Math.abs(n)<60)return s.format(n,"minute");const o=Math.round(n/60);if(Math.abs(o)<24)return s.format(o,"hour");const r=Math.round(o/24);if(Math.abs(r)<30)return s.format(r,"day");const l=Math.round(r/30);return Math.abs(l)<12?s.format(l,"month"):s.format(Math.round(l/12),"year")}(e.timestamp,t),s=e.checks.filter(e=>e.enabled&&e.would_skip).map(e=>this._guardLabel(e).toLowerCase()).join(", "),a=e.would_skip?`${Fa("panels.zones.outlook.last_run_skipped",t)}${s?` (${s})`:""}`:Fa("panels.zones.outlook.last_run_ran",t);return W`
      <div class="outlook-line outlook-last">
        <span class="outlook-dim"
          >${Fa("panels.zones.outlook.last_run",t)}:</span
        >
        <span>${a} · ${i}</span>
      </div>
    `}_renderZoneDecision(e){if(!this.hass)return W``;const t=this.hass.language;let i,s,a,n;if(e.state===on.Disabled)i=Fa("panels.zones.status.decision_disabled",t),s="neutral",a="mdi:power-off";else if(e.last_calculated)if(this._zoneWillWater(e)){const o=Ya(this._zoneRunDuration(e).seconds),r=this._triggeredGuards,l=this._nextIrrigateRunForZone(e);r.length>0?(i=Fa("panels.zones.status.decision_water_skip",t,"{duration}",o,"{reason}",this._guardLabel(r[0]).toLowerCase()),s="skip",a="mdi:weather-rainy"):l&&l.next_run_utc?(i=Fa("panels.zones.status.decision_water_at",t,"{duration}",o,"{time}",this._formatRunTime(l.next_run_utc)),s="water",a="mdi:water",n=l):(i=Fa("panels.zones.status.decision_water_no_schedule",t,"{duration}",o),s="water",a="mdi:water-alert")}else i=Fa("panels.zones.status.decision_no_water",t),s="ok",a="mdi:check-circle-outline";else i=Fa("panels.zones.status.decision_unknown",t),s="unknown",a="mdi:help-circle-outline";return W`
      <div class="zone-decision ${s}">
        <ha-icon icon="${a}"></ha-icon>
        <span>${i}</span>
        ${n?this._renderEstimatedTag(n):""}
      </div>
    `}_zoneEstimate(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_estimates)||void 0===i?void 0:i[String(e.id)]}_zoneFault(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_faults)||void 0===i?void 0:i[String(e.id)]}_renderZoneFault(e){if(!this.hass)return W``;const t=this._zoneFault(e);if(!t)return W``;const i=this.hass.language,s=Fa(`panels.zones.fault.${t.reason}`,i)||Fa("panels.zones.fault.generic",i),a=t.timestamp?hn(t.timestamp):"";return W`
      <div class="zone-fault" title="${a}">
        <ha-icon icon="mdi:alert-circle"></ha-icon>
        <span>
          <strong>${Fa("panels.zones.fault.title",i)}</strong>
          — ${s}
        </span>
      </div>
    `}_zoneSkip(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_skips)||void 0===i?void 0:i[String(e.id)]}_renderZoneSkip(e){if(!this.hass)return W``;const t=this._zoneSkip(e);if(!t)return W``;const i=this.hass.language,s=Fa("panels.zones.skip.soil_moisture",i,"{observed}",String(t.observed),"{threshold}",String(t.threshold)),a=t.timestamp?hn(t.timestamp):"";return W`
      <div class="zone-skip" title="${a}">
        <ha-icon icon="mdi:water-off"></ha-icon>
        <span>
          <strong>${Fa("panels.zones.skip.title",i)}</strong>
          — ${s}
        </span>
      </div>
    `}_durationClamped(e){var t,i;if(e.state!==on.Automatic)return!1;const s=e.maximum_duration;if(null==s||s<0)return!1;const a=null!==(t=e.duration)&&void 0!==t?t:0;return!(a<=0)&&a-(null!==(i=e.lead_time)&&void 0!==i?i:0)>=s}_renderDurationClamped(e){var t;if(!this.hass||!this._durationClamped(e))return W``;const i=this.hass.language,s=Fa("panels.zones.clamped.detail",i,"{maximum}",Ya(null!==(t=e.maximum_duration)&&void 0!==t?t:0));return W`
      <div class="zone-clamped" title="${s}">
        <ha-icon icon="mdi:timer-alert-outline"></ha-icon>
        <span>
          <strong>${Fa("panels.zones.clamped.title",i)}</strong>
          <ha-icon
            class="clamped-hint"
            icon="mdi:information-outline"
          ></ha-icon>
    ...
    `}_renderZoneEstimate(e){if(!this.hass)return W``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return W``;const i=this.hass.language,s=qa(this.config,yt),a=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",n=Fa(`panels.zones.status.estimate_method.${"proxy"===t.method||"hourly_sensor"===t.method?t.method:"hourly"}`,i)+(t.as_of?` · ${cn(t.as_of)}`:"");return W`
      <span class="status-sep">·</span>
      <span class="zone-estimate" title="${n}">
        ${Fa("panels.zones.status.estimate_now",i)}
        <strong style="color: ${a}"
          >≈ ${t.live_deficit.toFixed(2)} ${s}</strong
        >
        <span class="estimate-tag"
          >${Fa("panels.zones.status.estimate_tag",i)}</span
        >
      </span>
    `}_renderZoneNextRun(e){if(!this.hass)return W``;const t=this._nextIrrigateRunForZone(e);if(!t||!t.next_run_utc)return W``;return e.state!==on.Disabled&&e.last_calculated&&this._zoneWillWater(e)&&0===this._triggeredGuards.length?W``:W`
      <span class="status-sep">·</span>
      <span>
        ${Fa("panels.zones.outlook.next_run",this.hass.language)}:
        <strong>${this._formatRunTime(t.next_run_utc)}</strong>
        ${this._renderEstimatedTag(t)}
      </span>
    `}renderZone(e,t){var i;if(!this.hass)return W``;const s=Number(null!==(i=e.bucket)&&void 0!==i?i:0),a=s<0?"var(--warning-color)":"var(--success-color)",n=e.state===on.Automatic?"state-automatic":e.state===on.Manual?"state-manual":"state-disabled",o=e.last_calculated?hn(e.last_calculated):Fa("panels.zones.status.never",this.hass.language);return W`
      <ha-card>
        <div class="card-header">
          <div class="name">${e.name}</div>
          <span class="zone-state-badge ${n}">
            ${Fa(`panels.zones.labels.states.${e.state}`,this.hass.language)}
          </span>
          ${this.hideSettingsLinks?"":W`
                <ha-icon-button
                  ...
                  title="${Fa("panels.zones.actions.open_settings",this.hass.language)}"
        ...
        <div class="card-content">
          <div class="zone-status-line">
            <span
              title="${Fa("panels.zones.help.bucket",this.hass.language)}"
            >
              ${Fa("panels.zones.labels.bucket",this.hass.language)}:
              <strong style="color: ${a}"
                >${s.toFixed(2)}
                ${qa(this.config,yt)}</strong
              >
            </span>
            <span class="status-sep">·</span>
            <span>
              ${Fa("panels.zones.status.last_checked",this.hass.language)}:
              <strong>${o}</strong>
            </span>
        ...
        <div class="card-content zone-action-bar">
          ${"full"===this.actionsMode&&e.state===on.Automatic?W`
                <button
                  class="action-btn"
                  title="${Fa("panels.zones.help.update",this.hass.language)}"
                  @click="${()=>this.handleUpdateZone(t)}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:update"></ha-icon>
                  ${Fa("panels.zones.actions.update",this.hass.language)}
                </button>
                <button
                  class="action-btn"
                  title="${Fa("panels.zones.help.calculate",this.hass.language)}"
                  @click="${()=>this.handleCalculateZone(t)}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:calculator"></ha-icon>
                  ${Fa("panels.zones.actions.calculate",this.hass.language)}
                </button>
              `:""}
          ${"none"!==this.actionsMode&&this._canActuate(e)&&this._zoneHasDeficit(e)?W`
                ...
                >
                  ...
                  ${Fa("panels.zones.labels.irrigate_now",this.hass.language)}
                </button>
              `:this._canActuate(e)?"":W`
                  <button
                    class="action-btn"
                    disabled
                    title="${Fa("panels.zones.help.irrigate_link_entity",this.hass.language)}"
                  >
                    <ha-icon icon="mdi:water"></ha-icon>
                    ${Fa("panels.zones.labels.irrigate_now",this.hass.language)}
                  </button>
                  <span class="zones-top-note">
                    ${Fa("panels.zones.help.irrigate_link_entity",this.hass.language)}
                  </span>
                `}
    ...
    `}_renderRunZoneControl(e){if(!this.hass||"none"===this.actionsMode||!this._canActuate(e)||void 0===e.id)return W``;const t=this.hass.language,i=String(e.id),s=this._activeRun(e);if(s){const i=!0===s.queued,a=!i&&!0===s.paused,n=i||a?null:this._runSecondsLeft(s);return W`
        ...
        >
          <span class="run-zone-countdown">
            ...
            ${i?Fa("panels.zones.stop_zone.queued",t):a?Fa("panels.zones.stop_zone.paused",t):null===n?Fa("panels.zones.stop_zone.watering",t):this._formatCountdown(n)}
          </span>
          <button
          ...
          >
            ...
            ${Fa("panels.zones.stop_zone.stop",t)}
          </button>
        </div>
      ...
      <div class="run-zone-control-wrap">
        <div
          ...
          title="${Fa("panels.zones.run_zone.help",t)}"
        >
          <input
          ...
          <span class="run-zone-unit"
            >${Fa("panels.zones.run_zone.minutes",t)}</span
          >
          <button
            class="action-btn"
          ...
          >
            ...
            ${Fa("panels.zones.run_zone.run",t)}
          </button>
        </div>
        ${a?W`<span class="run-zone-busy-hint">
              ${Fa("panels.zones.run_zone.busy_hint",t)}
            </span>`:""}
      </div>
    `}_formatCountdown(e){const t=Math.max(0,e),i=Math.floor(t/3600),s=Math.floor(t%3600/60),a=t%60,n=e=>String(e).padStart(2,"0");return i>0?`${i}:${n(s)}:${n(a)}`:`${s}:${n(a)}`}render(){var e,t;if(!this.hass)return W``;if(this.isLoading)return W`
        <ha-card header="${Fa("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            <div class="loading-indicator">
              ${Fa("common.loading-messages.general",this.hass.language)}
            </div>
          </div>
        </ha-card>
      ...
      ${s?this.hideSettingsLinks?W`
              <ha-card>
                <div class="card-content description-text">
                  ${Fa("panels.zones.no_items",this.hass.language)}
                </div>
              </ha-card>
            `:W`
                ...
                <div class="setup-banner">
                  ...
                  <div class="setup-banner-content">
                    <div class="setup-banner-title">
                      ${Fa("wizard.title",this.hass.language)}
                    </div>
                    <div class="setup-banner-desc">
                      ${Fa("wizard.setup_complete_banner",this.hass.language)}
                    </div>
                  </div>
                  <button
                  ...
                  >
                    ${Fa("wizard.open_wizard",this.hass.language)}
                  </button>
                </div>
              </ha-card>
            `:""}
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${Fa("panels.zones.title",this.hass.language)}
          </div>
        </div>
        <div class="card-content zones-top-actions">
          ${"full"===this.actionsMode?W`
                <button
                  class="action-btn"
                  title="${Fa("panels.zones.help.update_all",this.hass.language)}"
                  @click="${this.handleUpdateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:update"></ha-icon>
                  ${Fa("panels.zones.cards.zone-actions.actions.update-all",this.hass.language)}
                </button>
                <button
                  class="action-btn"
                  title="${Fa("panels.zones.help.calculate_all",this.hass.language)}"
                  @click="${this.handleCalculateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:calculator"></ha-icon>
                  ${Fa("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language)}
                </button>
              `:""}
          ${"none"!==this.actionsMode?W`
                <button
                  class="action-btn"
                  raised
                  title="${Fa("panels.zones.help.irrigate_all",this.hass.language)}"
                  @click="${()=>{this._confirmIrrigate="all"}}"
                  ?disabled="${!i||this.isSaving}"
                >
                  <ha-icon icon="mdi:water"></ha-icon>
                  ${Fa("panels.zones.actions.irrigate_all",this.hass.language)}
                </button>
              `:""}
          ${i?"":W`<span class="zones-top-note"
                >${Fa("panels.info.cards.irrigate_now.no_linked_zones",this.hass.language)}</span
              >`}
        </div>
      </ha-card>
      ...
      ${null!==this._confirmIrrigate?W`
            <ha-dialog
              ...
              heading="${Fa("panels.zones.confirm_irrigate.title",this.hass.language)}"
            >
              <p>
                ${Fa("panels.zones.confirm_irrigate.body",this.hass.language)}
              </p>
              <p>
                <strong>
                  ${"all"===this._confirmIrrigate?`${Fa("panels.zones.confirm_irrigate.all_linked_zones",this.hass.language)} (${this._linkedZoneCount})`:null!==(t=null===(e=this.zones.find(e=>{var t;return(null===(t=e.id)||void 0===t?void 0:t.toString())===this._confirmIrrigate}))||void 0===e?void 0:e.name)&&void 0!==t?t:this._confirmIrrigate}
                </strong>
              </p>
              <div class="dialog-footer">
                ...
                >
                  ${Fa("common.actions.cancel",this.hass.language)}
                </button>
                <button
            ...
            <ha-card class="error-banner-card">
              <div class="error-banner">
                ...
                <ha-icon-button
                  ...
                  aria-label="${Fa("common.actions.cancel",this.hass.language)}"
                ></ha-icon-button>
              </div>
            </ha-card>
          `:""}
    ...
    `}}t([me()],pn.prototype,"config",void 0),t([me({type:Boolean})],pn.prototype,"hideSettingsLinks",void 0),t([me({attribute:!1})],pn.prototype,"actionsMode",void 0),t([me({type:Array})],pn.prototype,"zones",void 0),t([ve()],pn.prototype,"_outlook",void 0),t([ve()],pn.prototype,"_distributors",void 0),t([me({type:Boolean})],pn.prototype,"isLoading",void 0),t([me({type:Boolean})],pn.prototype,"isSaving",void 0),t([ve()],pn.prototype,"_operationError",void 0),t([ve()],pn.prototype,"_confirmIrrigate",void 0),t([ve()],pn.prototype,"_skipDetailsOpen",void 0),t([ve()],pn.prototype,"_runMinutes",void 0),t([ve()],pn.prototype,"_now",void 0),customElements.get("irrigation-plus-view-zones")||customElements.define("irrigation-plus-view-zones",pn);const gn=e=>9*e/5+32;function mn(e,t,i){if(null==e||Number.isNaN(e))return null;switch(t){case"temperature":return i?{value:e,unit:"°C"}:{value:gn(e),unit:"°F"};case"precipitation":return i?{value:e,unit:rt}:{value:(n=e,n/25.4),unit:lt};case"windspeed":return i?{value:e,unit:ht}:{value:(a=e,2.2369362920544*a),unit:ct};case"pressure":return i?{value:e,unit:"hPa"}:{value:(s=e,.0295299830714*s),unit:dt}}var s,a,n}function vn(e,t,i,s){const a=mn(e,t,i);if(!a)return"-";const n=function(e,t){return"pressure"===e?t?0:2:"precipitation"===e?t?1:2:1}(t,i);return`${a.value.toFixed(n)} ${a.unit}`}function fn(e,t){return null==e||Number.isNaN(e)?"-":t?`${e.toFixed(0)} L`:`${(e=>.264172052*e)(e).toFixed(1)} gal`}let _n=class extends ce{render(){var e,t,i;if(!this.hass||!this.zone)return W``;const s=(null===(e=this.config)||void 0===e?void 0:e.units)===He,a=null!==(t=this.zone.run_log)&&void 0!==t?t:[],n=this.hass.language;return W`
      <div class="history-usage">
        <span class="history-usage-label"
          >${Fa("panels.zones.history.total_used",n)}</span
        >
        <span class="history-usage-value"
          >${fn(null!==(i=this.zone.water_used_total)&&void 0!==i?i:0,s)}</span
        >
      </div>
      ${0===a.length?W`<div class="weather-note">
            ${Fa("panels.zones.history.empty",n)}
          </div>`:W`
            <table class="history-table">
              <thead>
                <tr>
                  <th>${Fa("panels.zones.history.when",n)}</th>
                  <th>${Fa("panels.zones.history.result",n)}</th>
                  <th class="num">
                    ${Fa("panels.zones.history.volume",n)}
                  </th>
                  <th>${Fa("panels.zones.history.detail",n)}</th>
                </tr>
              </thead>
              <tbody>
          ...
          `}
    `}_renderRow(e,t){const i=this.hass.language,s=Fa(`panels.zones.history.results.${e.result}`,i);let a="";return e.detail&&(a="skipped"===e.result?e.detail.split(",").map(e=>Fa(`panels.zones.outlook.checks.${e}`,i)||e).join(", "):/^[A-Za-z0-9_-]+$/.test(e.detail)&&Fa(`panels.zones.fault.${e.detail}`,i)||e.detail),W`
      <tr>
        <td>${hn(e.ts)}</td>
        <td>
        ...
        <td class="num">
          ${e.volume_l>0?fn(e.volume_l,t):"-"}
        </td>
        <td class="history-detail">${cs(a)}</td>
      </tr>
    `}static get styles(){return[rn,r`
      ...
      `]}};t([me({attribute:!1})],_n.prototype,"hass",void 0),t([me({attribute:!1})],_n.prototype,"zone",void 0),t([me({attribute:!1})],_n.prototype,"config",void 0),_n=t([ue("ip-zone-history")],_n);let bn=class extends(an(ce)){constructor(){super(...arguments),this._zones=[],this._isLoading=!0,this._loadFailed=!1,this._initialLoadDone=!1}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:be+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{const[e,t]=await Promise.all([Li(this.hass),Bi(this.hass)]);this._config=e,this._zones=t,this._initialLoadDone=!0,this._loadFailed=!1}catch(t){console.error("Error fetching data:",t),Ja(this,this.hass,"common.errors.load_failed",t),e&&(this._loadFailed=!0)}finally{e&&(this._isLoading=!1)}}get _linkedZoneId(){var e,t;const i=null===(t=null===(e=this.path)||void 0===e?void 0:e.params)||void 0===t?void 0:t.zone;return null!=i&&""!==i?Number(i):null}_effectiveZone(){var e,t;if(!this._zones.length)return;const i=e=>null==e?void 0:this._zones.find(t=>t.id===e);return null!==(t=null!==(e=i(this._selectedZoneId))&&void 0!==e?e:i(this._linkedZoneId))&&void 0!==t?t:this._zones[0]}render(){if(!this.hass)return W``;const e=this.hass.language;if(this._isLoading)return W`
        <ha-card header="${Fa("panels.history.title",e)}">
          <div class="card-content">
            <div class="loading-indicator">
              ${Fa("common.loading-messages.general",e)}
            </div>
          </div>
        </ha-card>
      `;if(this._loadFailed)return W`
        <ha-card header="${Fa("panels.history.title",e)}">
          <div class="card-content">
            <div class="weather-note">
              ${Fa("common.errors.load_failed",e)}
            </div>
          </div>
        </ha-card>
        ...
        <div class="card-content">
          <div class="zone-picker">
            <label for="zone-select"
              >${Fa("panels.history.select_zone",e)}</label
            >
            <select
              id="zone-select"
    ...
    `}static get styles(){return[rn,r`
      ...
      `]}};t([me({attribute:!1})],bn.prototype,"hass",void 0),t([me({type:Boolean})],bn.prototype,"narrow",void 0),t([me({attribute:!1})],bn.prototype,"path",void 0),t([ve()],bn.prototype,"_zones",void 0),t([ve()],bn.prototype,"_config",void 0),t([ve()],bn.prototype,"_selectedZoneId",void 0),t([ve()],bn.prototype,"_isLoading",void 0),t([ve()],bn.prototype,"_loadFailed",void 0),bn=t([ue("irrigation-plus-view-history")],bn);
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */
const yn={},wn=rs(class extends ls{constructor(e){if(super(e),e.type!==ns&&e.type!==ss&&e.type!==os)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===G||t===K)return t;const i=e.element,s=e.name;if(e.type===ns){if(t===i[s])return G}else if(e.type===os){if(!!t===i.hasAttribute(s))return G}else if(e.type===ss&&i.getAttribute(s)===t+"")return G;return((e,t=yn)=>{e._$AH=t;
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */})(e),t}});let $n=class extends ce{constructor(){super(...arguments),this.label="",this.unit="",this.help="",this.required=!1,this._helpOpen=!1}_toggleHelp(){this._helpOpen=!this._helpOpen}render(){return W`
      <div class="ip-field">
    ...
    `}_renderServiceAndKey(e){return W`
      <ip-field
        label="${Fa("weather_service_config.service_label",e)}"
      >
        <select
          class="si-input"
          .value="${wn(this.service||Ce)}"
        ...
        >
          ...
          >
            ${Fa("weather_service_config.openmeteo",e)}
          </option>
          <option
            value="${Se}"
            ?selected="${this.service===Se}"
          >
            ${Fa("weather_service_config.owm",e)}
          </option>
          <option
            value="${Ae}"
            ?selected="${this.service===Ae}"
          >
            ${Fa("weather_service_config.pw",e)}
          </option>
          <option
            value="${Ee}"
            ?selected="${this.service===Ee}"
          >
            ${Fa("weather_service_config.met",e)}
          </option>
        </select>
      </ip-field>

      ${this._needsKey?this._renderKeyField(e):W`<div class="info-note">
            ${Fa("weather_service_config.no_api_key_needed",e)}
          </div>`}
    `}_renderKeyField(e){var t;const i=this._hasStoredKey;return W`
      <ip-field
        label="${Fa("weather_service_config.api_key_label",e)}"
        help="${Fa("weather_service_config.api_key_help",e)}"
      >
        <span class="api-badge ${i?"configured":"missing"}"
          >${Fa(i?"weather_service_config.api_key_configured":"weather_service_config.api_key_not_configured",e)}</span
        >
        <div class="api-row">
          <input
            type="password"
            class="si-input flex1"
            placeholder="${Fa("weather_service_config.api_key_placeholder",e)}"
            .value="${this.apiKey}"
          ...
          >
            ${this._testing?Fa("weather_service_config.test_button_testing",e):Fa("weather_service_config.test_button",e)}
          </button>
        </div>
        ${null!==this._testResult?W`<div
              class="test-result ${this._testResult.success?"success":"error"}"
            >
              ${this._testResult.success?Fa("weather_service_config.test_success",e):Fa("weather_service_config.test_error_"+(null!==(t=this._testResult.error)&&void 0!==t?t:"unknown"),e)}
            </div>`:""}
      </ip-field>
    `}static get styles(){return r`
      :host {
    ...
    `}};t([me({attribute:!1})],xn.prototype,"hass",void 0),t([me({type:Boolean})],xn.prototype,"useWeather",void 0),t([me()],xn.prototype,"service",void 0),t([me()],xn.prototype,"apiKey",void 0),t([me({attribute:!1})],xn.prototype,"weatherConfig",void 0),t([ve()],xn.prototype,"_testing",void 0),t([ve()],xn.prototype,"_testResult",void 0),xn=t([ue("ip-weather-source-config")],xn);let kn=class extends(an(ce)){constructor(){super(...arguments),this.section="all",this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._weatherConfig=null,this._weatherService=null,this._useWeatherService=!1,this._newApiKey="",this._weatherSaving=!1,this._coords=null,this._coordsEnabled=!1,this._coordsLat="",this._coordsLon="",this._coordsElev="",this._coordsSaving=!1,this._zones=[],this._saveStatus="idle",this._savedResetTimer=null,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null,t={};return i=>{t=Object.assign(Object.assign({},t),i),e&&clearTimeout(e),e=window.setTimeout(()=>{const i=t;t={},e=null,this.saveData(i)},500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:be+"_config_updated"})]}async _fetchData(){var e;if(!this.hass)return;const t=!this._initialLoadDone;t&&(this.isLoading=!0,this._scheduleUpdate());try{const[t,a,n,o]=await Promise.all([Li(this.hass),Xi(this.hass),Qi(this.hass),Bi(this.hass).catch(e=>(console.warn("Could not fetch zones for the sequencing note:",e),[]))]);this.config=t,this._zones=o,this._weatherConfig=a,this._useWeatherService=a.use_weather_service,this._weatherService=null!==(e=a.weather_service)&&void 0!==e?e:Ce,this._applyCoordinates(n),this.data=(i=this.config,s=["calctime","autocalcenabled","autocalcmode","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","days_between_irrigation"],i?Object.entries(i).filter(([e])=>s.includes(e)).reduce((e,[t,i])=>Object.assign(e,{[t]:i}),{}):{}),this._initialLoadDone=!0}catch(e){console.error("Error fetching data:",e),Ja(this,this.hass,"common.errors.load_failed",e)}finally{t&&(this.isLoading=!1),this._scheduleUpdate()}var i,s}firstUpdated(){is().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}render(){var e,t;return this.hass&&this.config&&this.data?this.isLoading?W`<div class="loading-indicator">
        ${Fa("common.loading-messages.general",this.hass.language)}
      </div>`:W`${this._renderSaveStatus()} ${this._renderCards()}`:W`<div class="loading-indicator">
        ${Fa("common.loading-messages.configuration",null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en")}
      ...
      <div class="settings-section-header">
        ${Fa(`panels.general.sections.${e}`,this.hass.language)}
      </div>
    `:W``}async _saveWeatherConfig(){if(this.hass){this._weatherSaving=!0,this._scheduleUpdate();try{await Ji(this.hass,this._useWeatherService,this._useWeatherService?this._weatherService:null,this._newApiKey||null),this._newApiKey="",await this._fetchData()}catch(e){console.error("Failed to save weather config:",e),Ja(this,this.hass,"common.errors.save_failed",e)}finally{this._weatherSaving=!1,this._scheduleUpdate()}}}_renderWeatherServiceCard(){var e;return this.hass?W`
      <ha-card
        header="${Fa("weather_service_config.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Fa("weather_service_config.description",this.hass.language)}
        </div>
        <div class="card-content">
          ...
          <div style="margin-top: 12px;">
            ...
            >
              ${this._weatherSaving?Fa("common.saving-messages.saving",this.hass.language):Fa("weather_service_config.save_button",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    `:W``}_renderAutoUpdateCard(){var e,t;return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${Fa("panels.general.cards.automatic-update.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Fa("panels.general.cards.automatic-update.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Fa("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}
            </label>
            <ha-switch
          ...
          ${this.data.autoupdateenabled?W`
                <div class="setting-row">
                  <label>
                    ${Fa("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}
                  </label>
                  <div class="inline-row">
                    ...
                    <select
                      ...
                      .value="${wn(this.data.autoupdateschedule||Oe)}"
                    ...
                    >
                      ...
                      >
                        ${Fa("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
                      </option>
                      <option
                        value="${Oe}"
                        ?selected="${(this.data.autoupdateschedule||Oe)===Oe}"
                      >
                        ${Fa("panels.general.cards.automatic-update.options.hours",this.hass.language)}
                      </option>
                      <option
                        value="${De}"
                        ?selected="${this.data.autoupdateschedule===De}"
                      >
                        ${Fa("panels.general.cards.automatic-update.options.days",this.hass.language)}
                      </option>
                    </select>
                  </div>
                </div>
                <div class="setting-row">
                  <label>
                    ${Fa("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language)}
                    (s)
                  </label>
                  <input
                    type="number"
    ...
    `:W``}_renderAutoCalcCard(){return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${Fa("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Fa("panels.general.cards.automatic-duration-calculation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Fa("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}
            </label>
            <ha-switch
    ...
    `:W``}_renderAutoCalcMode(){if(!this.hass||!this.config)return W``;const e=this.hass.language,t=xe.includes(this.config.autocalcmode)?this.config.autocalcmode:$e;return W`
      <div class="setting-row">
        <label>
          ${Fa("panels.general.cards.automatic-duration-calculation.labels.calc-mode",e)}
        </label>
        <select
          class="settings-input"
          .value="${wn(t)}"
        ...
        >
          ${xe.map(i=>W`
              <option value="${i}" ?selected="${t===i}">
                ${Fa(`panels.general.cards.automatic-duration-calculation.modes.${i}`,e)}
              </option>
            `)}
        </select>
      </div>
      ${t===$e?W`
            <div class="setting-row">
              <label>
                ${Fa("panels.general.cards.automatic-duration-calculation.labels.calc-time",e)}
              </label>
              <input
                type="text"
                class="settings-input shortfield"
          ...
          `:W`
            <div class="card-content description-text">
              ${Fa("panels.general.cards.automatic-duration-calculation.help.before-run",e)}
            </div>
          `}
    `}_renderRunHistoryLoggingCard(){return this.hass&&this.config?W`
      <ha-card
        header="${Fa("panels.general.cards.run-history-logging.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Fa("panels.general.cards.run-history-logging.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Fa("panels.general.cards.run-history-logging.labels.log-no-demand",this.hass.language)}
            </label>
            <ha-switch
    ...
    `:W``}_renderWeatherSkipCard(){var e,t,i,s,a;if(!this.hass||!this.config||!this.data)return W``;const n=this.hass.language,o=this.config.skip_irrigation_on_precipitation?"skip":this.config.forecast_weighting_enabled?"water_less":"ignore";return W`
      <ha-card header="${Fa("weather_skip.title",this.hass.language)}">
        <div class="card-content description-text">
          ${Fa("weather_skip.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Fa("weather_skip.forecast_rain_label",n)}
            </label>
            <select
              class="settings-input"
              .value="${wn(o)}"
            ...
            >
              ${["ignore","water_less","skip"].map(e=>W`
                  <option value="${e}" ?selected="${o===e}">
                    ${Fa(`weather_skip.forecast_rain_options.${e}`,n)}
                  </option>
                `)}
            </select>
          </div>
          <div class="description-text">
            ${Fa(`weather_skip.forecast_rain_help.${o}`,n)}
          </div>
          ${"ignore"!==o?W`
                <div class="setting-row">
                  <label>
                    ${Fa("weather_skip.lookahead_label",n)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="description-text">
                  ${Fa(`weather_skip.lookahead_help.${o}`,n)}
                </div>
              `:""}
          ${"skip"===o?W`
                <div class="setting-row">
                  <label>
                    ${Fa("weather_skip.threshold_label",n)}
                    (${qa(this.config,ke)})
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Fa("weather_skip.temp_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Fa("weather_skip.temp_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_temp_enabled?W`
                <div class="setting-row">
                  <label>
                    ${Fa("weather_skip.temp_threshold_label",this.hass.language)}
                    (°C)
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Fa("weather_skip.wind_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Fa("weather_skip.wind_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_wind_enabled?W`
                <div class="setting-row">
                  <label>
                    ${Fa("weather_skip.wind_threshold_label",this.hass.language)}
                    (m/s)
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Fa("weather_skip.freeze_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Fa("weather_skip.freeze_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_freeze_enabled?W`
                <div class="setting-row">
                  <label>
                    ${Fa("weather_skip.freeze_threshold_label",this.hass.language)}
                    (°C)
                  </label>
                  <input
                    type="number"
                ...
                <div class="description-text">
                  ${Fa("weather_skip.freeze_help",this.hass.language)}
                </div>
              `:""}

          <div class="section-divider">
            ${Fa("weather_skip.rain_sensor_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Fa("weather_skip.rain_sensor_label",this.hass.language)}
            </label>
            <ha-entity-picker
              .hass="${this.hass}"
      ...
      >
        ...
        <div class="card-content">
          ...
          ${this._coordsEnabled?W`
                <div class="setting-row">
                  <label>
                    ${Fa("coordinate_config.latitude",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="setting-row">
                  <label>
                    ${Fa("coordinate_config.longitude",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="setting-row">
                  <label>
                    ${Fa("coordinate_config.elevation",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
              ...
              `:W`
                ...
                >
                  ${Fa("coordinate_config.current_ha_coords",this.hass.language)}:
                  ${Fa("coordinate_config.latitude",this.hass.language)}:
          ...
          <div style="margin-top: 12px;">
            ...
            >
              ${this._coordsSaving?Fa("common.saving-messages.saving",this.hass.language):Fa("common.actions.save",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    `}_renderDaysBetweenIrrigationCard(){var e;return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${Fa("days_between_irrigation.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Fa("days_between_irrigation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Fa("days_between_irrigation.label",this.hass.language)}
              <div class="setting-description">
                ${Fa("days_between_irrigation.help_text",this.hass.language)}
              </div>
            </label>
            <input
              type="number"
    ...
    `:W``}_renderZoneSequencingCard(){var e,t;if(!this.hass||!this.config||!this.data)return W``;const i=(this.config.zone_sequencing||Gt)===Kt,s=this._zones.some(e=>e.watering_mode===Ni);return W`
      <ha-card
        header="${Fa("zone_sequencing.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Fa("zone_sequencing.description",this.hass.language)}
        </div>
        ${s?W`<div class="card-content">
              <div class="advisory">
                <ha-icon icon="mdi:information-outline"></ha-icon>
                <span
                  >${Fa("zone_sequencing.batch_note",this.hass.language)}</span
                >
              </div>
            </div>`:""}
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Fa("zone_sequencing.title",this.hass.language)}
            </label>
            <select
              class="settings-input"
              .value="${wn(this.config.zone_sequencing||Gt)}"
              @change="${e=>this.handleConfigChange({[Wt]:e.target.value})}"
            >
              <option
                value="${Gt}"
                ?selected="${(this.config.zone_sequencing||Gt)===Gt}"
              >
                ${Fa("zone_sequencing.parallel",this.hass.language)}
              </option>
              <option
                value="${qt}"
                ?selected="${this.config.zone_sequencing===qt}"
              >
                ${Fa("zone_sequencing.sequential",this.hass.language)}
              </option>
              <option
                value="${Kt}"
                ?selected="${this.config.zone_sequencing===Kt}"
              >
                ${Fa("zone_sequencing.rotating",this.hass.language)}
              </option>
            </select>
          </div>
          ${i?W`
                <div class="setting-row">
                  <label>
                    ${Fa("zone_sequencing.max_consecutive_duration_label",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    min="1"
                  ...
                  <span class="unit-label">
                    ${Fa("zone_sequencing.max_consecutive_duration_unit",this.hass.language)}
                  </span>
                </div>
                <div class="setting-row">
                  <label>
                    ${Fa("zone_sequencing.min_absorption_time_label",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    min="0"
                  ...
                  />
                  <span class="unit-label">
                    ${Fa("zone_sequencing.min_absorption_time_unit",this.hass.language)}
                  </span>
                </div>
              `:""}
        </div>
    ...
    `}_renderBatchCard(){var e;if(!this.hass||!this.config)return W``;const t=!!this.config.batch_run_service,i=this.config.batch_paused_entity;return W`
      <ha-card header="${Fa("batch.title",this.hass.language)}">
        <div class="card-content description-text">
          ${Fa("batch.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${Fa("batch.run_service",this.hass.language)}</label>
            <ha-entity-picker
              .hass="${this.hass}"
          ...
          <div class="description-text">
            ${Fa("batch.run_service_help",this.hass.language)}
          </div>
          ${t?W`
                <div class="setting-row">
                  <label
                    >${Fa("batch.stop_service",this.hass.language)}</label
                  >
                  <ha-entity-picker
                    .hass="${this.hass}"
                ...
                <div class="description-text">
                  ${Fa("batch.stop_service_help",this.hass.language)}
                </div>
                ${this.config.batch_stop_service?"":W`<div class="batch-warning">
                      ${Fa("batch.stop_service_missing",this.hass.language)}
                    </div>`}
                <div class="setting-row">
                  <label
                    >${Fa("batch.paused_entity",this.hass.language)}</label
                  >
                  <ha-entity-picker
                    .hass="${this.hass}"
                    .value="${i||""}"
                ...
                <div class="description-text">
                  ${Fa("batch.paused_entity_help",this.hass.language)}
                </div>
                ${i?W`
                      <div class="setting-row">
                        <label>
                          ${Fa("batch.pause_timeout",this.hass.language)}
                        </label>
                        <input
                          type="number"
                          min="0"
                          ...
                          @change="${e=>{const t=parseInt(e.target.value,10);isNaN(t)||this.handleConfigChange({[ti]:Math.max(0,t)})}}"
                        />
                        <span class="unit-label">
                          ${Fa("batch.pause_timeout_unit",this.hass.language)}
                        </span>
                      </div>
                      <div class="description-text">
                        ${Fa("batch.pause_timeout_help",this.hass.language)}
                      </div>
                      <div class="setting-row">
                        <label>
                          ${Fa("batch.pause_timeout_service",this.hass.language)}
                        </label>
                        <ha-entity-picker
                          .hass="${this.hass}"
                          ...
                          .includeDomains="${["script"]}"
                          allow-custom-entity
                          @value-changed="${e=>this.handleConfigChange({[ii]:e.detail.value||null})}"
                        ></ha-entity-picker>
                      </div>
                      <div class="description-text">
                        ${Fa("batch.pause_timeout_service_help",this.hass.language)}
                      </div>
                    `:""}
                <div class="batch-warning">
                  ${Fa("batch.master_warning",this.hass.language)}
                </div>
              `:""}
        </div>
      </ha-card>
    `}_renderMasterSwitchCard(){var e,t;if(!this.hass||!this.config)return W``;const i=!!this.config.master_kick_enabled;return W`
      <ha-card header="${Fa("master.title",this.hass.language)}">
        <div class="card-content description-text">
          ${Fa("master.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${Fa("master.entity",this.hass.language)}</label>
            <ha-entity-picker
              .hass="${this.hass}"
          ...
          ${this.config.master_entity?W`
                <div class="setting-row">
                  <label
                    >${Fa("master.kick_enabled",this.hass.language)}</label
                  >
                  <ha-switch
                    .checked="${i}"
                    @change="${e=>this.handleConfigChange({[ai]:e.target.checked})}"
                  ></ha-switch>
                </div>
                ${i?W`
                      <div class="setting-row">
                        <label>
                          ${Fa("master.kick_pause",this.hass.language)}
                        </label>
                        <input
                          type="number"
                          min="0"
                          ...
                          @input="${e=>{const t=parseFloat(e.target.value);isNaN(t)||this.handleConfigChange({[ni]:t})}}"
                        />
                        <span class="unit-label">
                          ${Fa("master.seconds_unit",this.hass.language)}
                        </span>
                      </div>
                    `:""}
                <div class="setting-row">
                  <label
                    >${Fa("master.settle",this.hass.language)}</label
                  >
                  <input
                    type="number"
                    min="0"
                    ...
                    @input="${e=>{const t=parseInt(e.target.value,10);isNaN(t)||this.handleConfigChange({[si]:t})}}"
                  />
                  <span class="unit-label">
                    ${Fa("master.seconds_unit",this.hass.language)}
                  </span>
    ...
    `}};t([me()],kn.prototype,"narrow",void 0),t([me()],kn.prototype,"path",void 0),t([me()],kn.prototype,"section",void 0),t([me()],kn.prototype,"data",void 0),t([me()],kn.prototype,"config",void 0),t([me({type:Boolean})],kn.prototype,"isLoading",void 0),t([me({type:Boolean})],kn.prototype,"isSaving",void 0),t([me()],kn.prototype,"_weatherConfig",void 0),t([me()],kn.prototype,"_weatherService",void 0),t([me({type:Boolean})],kn.prototype,"_useWeatherService",void 0),t([me()],kn.prototype,"_newApiKey",void 0),t([me({type:Boolean})],kn.prototype,"_weatherSaving",void 0),t([ve()],kn.prototype,"_coords",void 0),t([ve()],kn.prototype,"_coordsEnabled",void 0),t([ve()],kn.prototype,"_coordsLat",void 0),t([ve()],kn.prototype,"_coordsLon",void 0),t([ve()],kn.prototype,"_coordsElev",void 0),t([ve()],kn.prototype,"_coordsSaving",void 0),t([ve()],kn.prototype,"_zones",void 0),t([ve()],kn.prototype,"_saveStatus",void 0),kn=t([ue("irrigation-plus-view-general")],kn);let zn=class extends ce{constructor(){super(...arguments),this.metric=!0,this.name="",this.size="",this.throughput="",this.linkedEntity="",this.showEntity=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{value:t},bubbles:!0,composed:!0}))}render(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",s=this.metric?"m²":st,a=this.metric?at:nt;return W`
      <ip-field label="${Fa("panels.zones.labels.name",i)}" required>
        <input
          type="text"
          class="si-input"
          .value="${this.name}"
      ...
      <ip-field
        label="${Fa("panels.zones.labels.size",i)}"
        unit="${s}"
        help="${Fa("field_help.zone_size",i)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      <ip-field
        label="${Fa("panels.zones.labels.throughput",i)}"
        unit="${a}"
        help="${Fa("field_help.zone_throughput",i)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      ${this.showEntity?W`
            <ip-field
              label="${Fa("panels.zones.labels.linked_entity",i)}"
              help="${Fa("field_help.zone_linked_entity",i)}"
            >
              <ha-entity-picker
                .hass="${this.hass}"
    ...
    `}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await Ui(this.hass,e)}_renderModuleOptions(e){if(!this.hass)return W``;const t=null!=e?String(e):"";return W`
      <option value="" ?selected="${""===t}">
        ---${Fa("common.labels.select",this.hass.language)}---
      </option>
    ...
    `}_renderDistributorSelector(e,t){var i,s;if(!this.hass)return W``;if(!(null===(i=this.config)||void 0===i?void 0:i.distributors_enabled))return W``;const a=this.hass.language,n=null!=e.distributor_id;return W`
      <ha-settings-row>
        <span slot="heading"
          >${Fa("panels.zones.labels.distributor",a)}</span
        >
        <span slot="description"
          >${Fa("panels.zones.labels.distributor_help",a)}</span
        >
        <select
          class="settings-input"
          .value="${wn(n?String(e.distributor_id):"")}"
          @change="${i=>this._onZoneDistributorChange(t,e,i)}"
        >
          <option value="" ?selected="${!n}">
            ${Fa("panels.zones.labels.distributor_none",a)}
          </option>
      ...
      ${n?W`
            <ha-settings-row>
              <span slot="heading"
                >${Fa("panels.zones.labels.outlet_number",a)}</span
              >
              <span slot="description"
                >${Fa("panels.zones.labels.outlet_number_readonly_help",a)}</span
              >
        ...
        ${y?W`
             ...
             used to sit alongside it moved to the Weather & Location tab). -->
              <div class="card-content zone-settings">
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.name",this.hass.language)}</span
                  >
                  <input
                    type="text"
                    class="settings-input"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.size",this.hass.language)}
                    (${qa(this.config,mt)})</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.throughput",this.hass.language)}
                    (${qa(this.config,vt)})</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.soil_type",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Fa("field_help.zone_soil_type",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${wn(null!==(s=Object.keys(Zt).find(t=>Zt[t]===e.drainage_rate))&&void 0!==s?s:"custom")}"
                    @change="${i=>{const s=i.target.value;"custom"!==s&&void 0!==Zt[s]&&this.handleEditZone(t,Object.assign(Object.assign({},e),{[St]:Zt[s]}))}}"
                  >
                    <option
                      value="custom"
                      ?selected="${!Object.values(Zt).includes(null!==(a=e.drainage_rate)&&void 0!==a?a:-1)}"
                    >
                      ${Fa("panels.zones.labels.soil_types.custom",this.hass.language)}
                    </option>
                    ${Object.keys(Zt).map(t=>W`
                        <option
                          value="${t}"
                          ?selected="${Zt[t]===e.drainage_rate}"
                        >
                          ${Fa(`panels.zones.labels.soil_types.${t}`,this.hass.language)}
                        </option>
                      `)}
                  </select>
                </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.drainage_rate",this.hass.language)}
                    (${qa(this.config,St)})</span
                  >
                  <span slot="description"
                    >${Fa("field_help.zone_drainage_rate",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.plant_type",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Fa("field_help.zone_plant_type",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${wn(null!==(o=e.plant_type)&&void 0!==o?o:"custom")}"
                    @change="${i=>{const s=i.target.value,a={[Ct]:s};"custom"!==s&&void 0!==Ft[s]&&(a.kc=Ft[s]),this.handleEditZone(t,Object.assign(Object.assign({},e),a))}}"
                  >
                    <option
                      value="custom"
                      ?selected="${"custom"===(null!==(r=e.plant_type)&&void 0!==r?r:"custom")}"
                    >
                      ${Fa("panels.zones.labels.plant_types.custom",this.hass.language)}
                    </option>
                    ${Object.keys(Ft).map(t=>W`
                        ...
                        >
                          ${Fa(`panels.zones.labels.plant_types.${t}`,this.hass.language)}
                        </option>
                      `)}
                  </select>
                </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.kc",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Fa("field_help.zone_kc",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.state",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${wn(e.state)}"
                  ...
                  >
                    <option
                      value="${on.Automatic}"
                      ?selected="${e.state===on.Automatic}"
                    >
                      ${Fa("panels.zones.labels.states.automatic",this.hass.language)}
                    </option>
                    <option
                      value="${on.Manual}"
                      ?selected="${e.state===on.Manual}"
                    >
                      ${Fa("panels.zones.labels.states.manual",this.hass.language)}
                    </option>
                    <option
                      value="${on.Disabled}"
                      ?selected="${e.state===on.Disabled}"
                    >
                      ${Fa("panels.zones.labels.states.disabled",this.hass.language)}
                    </option>
                  </select>
                </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("common.labels.module",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${wn(void 0!==e.module?String(e.module):"")}"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.mapping",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${wn(void 0!==e.mapping?String(e.mapping):"")}"
                ...
                ${null!=e.distributor_id?W`<div class="distributor-managed">
                      ${Fa("panels.zones.labels.distributor_managed_note",this.hass.language)}
                    </div>`:W`
                      <ha-settings-row>
                        <span slot="heading"
                          >${Fa("panels.zones.labels.watering_mode",this.hass.language)}</span
                        >
                        <span slot="description"
                          >${Fa("panels.zones.labels.watering_mode_description",this.hass.language)}</span
                        >
                        <select
                          class="settings-input"
                          .value="${wn(null!==(d=e.watering_mode)&&void 0!==d?d:"classic")}"
                        ...
                        >
                          ...
                          >
                            ${Fa("panels.zones.labels.watering_modes.classic",this.hass.language)}
                          </option>
                          <option
                            value="service"
                            ?selected="${"service"===e.watering_mode}"
                          >
                            ${Fa("panels.zones.labels.watering_modes.service",this.hass.language)}
                          </option>
                          <option
                            value="${Hi}"
                            ?selected="${e.watering_mode===Hi}"
                          >
                            ${Fa("panels.zones.labels.watering_modes.opensprinkler",this.hass.language)}
                          </option>
                          <option
                            value="${Ni}"
                            ?selected="${e.watering_mode===Ni}"
                          >
                            ${Fa("panels.zones.labels.watering_modes.batch",this.hass.language)}
                          </option>
                        </select>
                      </ha-settings-row>

                      ${e.watering_mode===Ni?W`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Fa("panels.zones.labels.batch_valve",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Fa("panels.zones.labels.batch_valve_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                            ...
                            ${e.confirm_entity?"":W`<div class="zone-warning">
                                  ${Fa("panels.zones.labels.batch_valve_missing",this.hass.language)}
                                </div>`}
                          `:""}
                      ${"service"===e.watering_mode?W`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Fa("panels.zones.labels.run_service",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Fa("panels.zones.labels.run_service_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                                .value="${e.run_service||""}"
                            ...
                            <ha-settings-row>
                              <span slot="heading"
                                >${Fa("panels.zones.labels.duration_field",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Fa("panels.zones.labels.duration_field_help",this.hass.language)}</span
                              >
                              <input
                                type="text"
                                class="settings-input"
                                placeholder="${Fa("panels.zones.labels.duration_field_placeholder",this.hass.language)}"
                                .value="${e.duration_field||"duration"}"
                                @input="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Nt]:i.target.value||void 0}))}"
                              />
                            </ha-settings-row>
                            <ha-settings-row>
                              <span slot="heading"
                                >${Fa("panels.zones.labels.duration_unit",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Fa("panels.zones.labels.duration_unit_help",this.hass.language)}</span
                              >
                              <select
                                class="settings-input"
                                .value="${wn(null!==(h=e.duration_unit)&&void 0!==h?h:"seconds")}"
                              ...
                              >
                                ...
                                >
                                  ${Fa("panels.zones.labels.duration_units.seconds",this.hass.language)}
                                </option>
                                <option
                                  value="minutes"
                                  ?selected="${"minutes"===e.duration_unit}"
                                >
                                  ${Fa("panels.zones.labels.duration_units.minutes",this.hass.language)}
                                </option>
                              </select>
                            </ha-settings-row>
                            <ha-settings-row>
                              <span slot="heading"
                                >${Fa("panels.zones.labels.stop_service",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Fa("panels.zones.labels.stop_service_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                            ...
                            <ha-settings-row>
                              <span slot="heading"
                                >${Fa("panels.zones.labels.confirm_entity",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Fa("panels.zones.labels.confirm_entity_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                                .value="${e.confirm_entity||""}"
                            ...
                            ${this._showLatencyMargin(e)?W`
                                  <ha-settings-row>
                                    <span slot="heading"
                                      >${Fa("panels.zones.labels.latency_margin",this.hass.language)}
                                      (${ot})</span
                                    >
                                    <span slot="description"
                                      >${Fa("panels.zones.labels.latency_margin_help",this.hass.language)}</span
                                    >
                                    <input
                                      type="number"
                                      class="settings-input shortfield"
                                      ...
                                      @input="${i=>{const s=this._clampLatencyMargin(i.target.valueAsNumber);null!==s&&this.handleEditZone(t,Object.assign(Object.assign({},e),{[Rt]:s}))}}"
                                    />
                                  </ha-settings-row>
                                `:""}
                            ${(null===(g=this.config)||void 0===g?void 0:g.observed_watering_enabled)?W`
                                  <ha-settings-row>
                                    <span slot="heading"
                                      >${Fa("panels.zones.labels.observed_entity",this.hass.language)}</span
                                    >
                                    <span slot="description"
                                      >${Fa("panels.zones.labels.observed_entity_help",this.hass.language)}</span
                                    >
                                    <ha-entity-picker
                                      .hass="${this.hass}"
                      ...
                      ${e.watering_mode===Hi?W`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Fa("panels.zones.labels.opensprinkler_station",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Fa("panels.zones.labels.opensprinkler_station_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                            ...
                            ${this._hasOpenSprinklerStations()?"":W`<div class="distributor-managed">
                                  ${Fa("panels.zones.labels.opensprinkler_no_stations",this.hass.language)}
                                </div>`}
                          `:"service"!==e.watering_mode?W`
                              <ha-settings-row>
                                <span slot="heading"
                                  >${Fa("panels.zones.labels.linked_entity",this.hass.language)}</span
                                >
                                <ha-entity-picker
                                  .hass="${this.hass}"
                                  .value="${e.linked_entity||""}"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.soil_moisture_sensor",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Fa("panels.zones.labels.soil_moisture_sensor_help",this.hass.language)}</span
                  >
                  <ha-entity-picker
                    .hass="${this.hass}"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.soil_moisture_threshold",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Fa("panels.zones.labels.soil_moisture_threshold_help",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                    ...
                    @input="${i=>{const s=i.target.value,a=""===s?null:Number(s);this.handleEditZone(t,Object.assign(Object.assign({},e),{[jt]:null===a||isNaN(a)?null:a}))}}"
                  />
                </ha-settings-row>
                ...
                ${null==e.distributor_id?W`
                      <ha-settings-row>
                        <span slot="heading"
                          >${Fa("panels.zones.labels.flow_sensor",this.hass.language)}</span
                        >
                        <ha-entity-picker
                          .hass="${this.hass}"
                          .value="${e.flow_sensor||""}"
                      ...
                      ${this._flowSensorIsTotalizer(e)?W`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Fa("panels.zones.labels.flow_counter_type",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Fa("panels.zones.labels.flow_counter_type_help",this.hass.language)}</span
                              >
                              <select
                                class="settings-input"
                                .value="${wn(e.flow_counter_type||"auto")}"
                              ...
                              >
                                ${["auto","per_run","lifetime"].map(t=>W`
                                    ...
                                    >
                                      ${Fa(`panels.zones.labels.flow_counter_type_${t}`,this.hass.language)}
                                    </option>
                                  `)}
                              </select>
                            </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.maximum-bucket",this.hass.language)}
                    (${qa(this.config,yt)})</span
                  >
                  <input
                    type="number"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.multiplier",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.lead-time",this.hass.language)}
                    (${ot})</span
                  >
                  <input
                    type="number"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.maximum-duration",this.hass.language)}
                    (${ot})</span
                  >
                  <input
                    type="number"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Fa("panels.zones.labels.bucket_threshold",this.hass.language)}
                    (${qa(this.config,yt)})</span
                  >
                  <input
                    type="number"
                ...
                ${e.state===on.Manual?W`
                      <ha-settings-row>
                        <span slot="heading"
                          >${Fa("panels.zones.labels.duration",this.hass.language)}
                          (${ot})</span
                        >
                        <input
                          type="number"
                ...
                <div class="settings-danger-row">
                  <button
                    class="action-btn"
                    @click="${()=>{this._pendingConfirm={title:Fa("panels.zones.confirm_action.reset_bucket_title",this.hass.language),body:Fa("panels.zones.confirm_action.reset_bucket_body",this.hass.language),confirmLabel:Fa("panels.zones.actions.reset-bucket",this.hass.language),onConfirm:()=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[yt]:0}))}}}"
                    ?disabled="${this.isSaving}"
                  >
                    ${Fa("panels.zones.actions.reset-bucket",this.hass.language)}
                  </button>
                  <button
                  ...
                  >
                    ...
                    ${Fa("common.actions.delete",this.hass.language)}
                  </button>
                </div>
              </div>
              ...
              ${e.explanation&&e.explanation.length>0?W`
                    <ha-expansion-panel
                      .header="${Fa("panels.zones.actions.information",this.hass.language)}"
                    >
                      <div class="card-content">
                        ${cs(e.explanation)}
                      </div>
    ...
    `}render(){var e;if(!this.hass)return W``;if(this.isLoading)return W`
      ...
      <ha-card>
        <div class="card-header">
          ...
          <ha-icon-button
            .path="${sn}"
            title="${Fa("panels.zones.cards.add-zone.header",this.hass.language)}"
      ...
      <ha-dialog
        ...
        heading="${Fa("panels.zones.cards.add-zone.header",this.hass.language)}"
      >
        ...
        <div class="dialog-footer">
          ...
          >
            ${this.isSaving?Fa("common.saving-messages.adding",this.hass.language):Fa("panels.zones.cards.add-zone.actions.add",this.hass.language)}
          </button>
        </div>
      </ha-dialog>
      ...
      ${t?W`
            <ha-dialog
              ...
              heading="${Fa("common.actions.confirm_delete",this.hass.language)}"
            >
              <p>
                ${Fa("common.actions.confirm_delete_zone",this.hass.language)}
              </p>
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${Fa("common.labels.bulk_actions",this.hass.language)}
          </div>
        </div>
        <div class="card-content bulk-actions">
          <button
            class="action-btn danger-button"
            @click="${()=>{this._pendingConfirm={title:Fa("panels.zones.confirm_action.reset_all_buckets_title",this.hass.language),body:Fa("panels.zones.confirm_action.reset_all_buckets_body",this.hass.language),confirmLabel:Fa("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language),onConfirm:()=>this.handleResetAllBuckets()}}}"
            ?disabled="${this.isSaving}"
          >
            ${Fa("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language)}
          </button>
          <button
            class="action-btn danger-button"
            @click="${()=>{this._pendingConfirm={title:Fa("panels.zones.confirm_action.clear_weather_title",this.hass.language),body:Fa("panels.zones.confirm_action.clear_weather_body",this.hass.language),confirmLabel:Fa("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language),onConfirm:()=>this.handleClearAllWeatherdata()}}}"
            ?disabled="${this.isSaving}"
          >
            ${Fa("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language)}
          </button>
        </div>
      </ha-card>
    ...
    `}};t([me()],Sn.prototype,"config",void 0),t([me({attribute:!1})],Sn.prototype,"path",void 0),t([me({type:Array})],Sn.prototype,"zones",void 0),t([me({type:Array})],Sn.prototype,"modules",void 0),t([me({type:Array})],Sn.prototype,"mappings",void 0),t([me({type:Array})],Sn.prototype,"distributors",void 0),t([me({type:Boolean})],Sn.prototype,"isLoading",void 0),t([ve()],Sn.prototype,"_expanded",void 0),t([me({type:Boolean})],Sn.prototype,"isSaving",void 0),t([me({type:Boolean})],Sn.prototype,"_showAddZone",void 0),t([ve()],Sn.prototype,"_pendingConfirm",void 0),t([ve()],Sn.prototype,"_saveStatus",void 0),t([me()],Sn.prototype,"_confirmDeleteZoneId",void 0),t([me()],Sn.prototype,"_newZoneName",void 0),t([me()],Sn.prototype,"_newZoneSize",void 0),t([me()],Sn.prototype,"_newZoneThroughput",void 0),t([me()],Sn.prototype,"_newZoneEntity",void 0),Sn=t([ue("irrigation-plus-view-zone-settings")],Sn);let An=class extends ce{_emit(e){this.dispatchEvent(new CustomEvent("distributor-changed",{detail:{value:Object.assign(Object.assign({},this.distributor),e)},bubbles:!0,composed:!0}))}_onNumber(e,t){const i=t.target.valueAsNumber;isNaN(i)||this._emit({[e]:Math.max(0,Math.round(i))})}render(){var e,t,i,s;if(!this.hass||!this.distributor)return W``;const a=this.hass.language,n=this.distributor,o=n.watering_mode===Mi;return W`
      <ha-settings-row>
        <span slot="heading"
          >${Fa("panels.distributors.labels.name",a)}</span
        >
        <input
          type="text"
          class="settings-input"
          .value="${null!==(e=n.name)&&void 0!==e?e:""}"
          @input="${e=>this._emit({[bi]:e.target.value})}"
        />
      </ha-settings-row>

      <ha-settings-row>
        <span slot="heading"
          >${Fa("panels.zones.labels.watering_mode",a)}</span
        >
        <span slot="description"
          >${Fa("panels.distributors.labels.watering_mode_help",a)}</span
        >
        <select
          class="settings-input"
          .value="${wn(null!==(t=n.watering_mode)&&void 0!==t?t:Di)}"
          @change="${e=>this._emit({[yi]:e.target.value})}"
        >
          <option
            value="${Di}"
            ?selected="${(null!==(i=n.watering_mode)&&void 0!==i?i:Di)===Di}"
          >
            ${Fa("panels.zones.labels.watering_modes.classic",a)}
          </option>
          <option
            value="${Mi}"
            ?selected="${n.watering_mode===Mi}"
          >
            ${Fa("panels.zones.labels.watering_modes.service",a)}
          </option>
        </select>
      </ha-settings-row>
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Fa("panels.distributors.labels.notify_target",a)}</span
        >
        <span slot="description"
          >${Fa("panels.distributors.labels.notify_target_help",a)}</span
        >
        <input
          type="text"
          class="settings-input"
          placeholder="${Fa("panels.distributors.labels.notify_target_placeholder",a)}"
          .value="${null!==(s=n.notify_target)&&void 0!==s?s:""}"
          @input="${e=>this._emit({[Ei]:e.target.value||null})}"
        />
      </ha-settings-row>
    `}_renderInletWatchRows(e){var t;const i=this.distributor,s=i.watering_mode===Mi?"panels.distributors.labels.inlet_entity_help_service":"panels.distributors.labels.inlet_entity_help",a=null!==(t=i.watch_mode)&&void 0!==t?t:"ignore";return W`
      <ha-settings-row>
        <span slot="heading"
          >${Fa("panels.distributors.labels.inlet_entity",e)}</span
        >
        <span slot="description">${Fa(s,e)}</span>
        <ha-entity-picker
          .hass="${this.hass}"
          .value="${i.inlet_entity||""}"
          .includeDomains="${["switch","valve","input_boolean"]}"
          allow-custom-entity
          @value-changed="${e=>this._emit({[wi]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>
      ...
      ${i.inlet_entity?W`
            <ha-settings-row>
              <span slot="heading"
                >${Fa("panels.distributors.labels.watch_mode",e)}</span
              >
              <span slot="description"
                >${Fa("panels.distributors.labels.watch_mode_help",e)}</span
              >
              <select
                class="settings-input"
                .value="${wn(a)}"
                @change="${e=>this._emit({[$i]:e.target.value})}"
              >
                ${Oi.map(t=>W`
                    <option value="${t}" ?selected="${a===t}">
                      ${Fa(`panels.distributors.labels.watch_mode_${t}`,e)}
                    </option>
                  `)}
              </select>
            </ha-settings-row>
    ...
    `}_renderServiceRows(e){var t,i;const s=this.distributor;return W`
      <ha-settings-row>
        <span slot="heading"
          >${Fa("panels.distributors.labels.run_service",e)}</span
        >
        <span slot="description"
          >${Fa("panels.distributors.labels.run_service_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
          .value="${s.run_service||""}"
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Fa("panels.distributors.labels.duration_field",e)}</span
        >
        <span slot="description"
          >${Fa("panels.distributors.labels.duration_field_help",e)}</span
        >
        <input
          type="text"
          class="settings-input"
          placeholder="${Fa("panels.distributors.labels.duration_field_placeholder",e)}"
          .value="${s.duration_field||"duration"}"
          @input="${e=>this._emit({[zi]:e.target.value||"duration"})}"
        />
      </ha-settings-row>

      <ha-settings-row>
        <span slot="heading"
          >${Fa("panels.distributors.labels.duration_unit",e)}</span
        >
        <select
          class="settings-input"
          .value="${wn(null!==(t=s.duration_unit)&&void 0!==t?t:"seconds")}"
        ...
        >
          ...
          >
            ${Fa("panels.distributors.labels.duration_units.seconds",e)}
          </option>
          <option value="minutes" ?selected="${"minutes"===s.duration_unit}">
            ${Fa("panels.distributors.labels.duration_units.minutes",e)}
          </option>
        </select>
      </ha-settings-row>
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Fa("panels.distributors.labels.stop_service",e)}</span
        >
        <span slot="description"
          >${Fa("panels.distributors.labels.stop_service_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
    ...
    `}_renderSensorRows(e){const t=this.distributor;return W`
      <ha-settings-row>
        <span slot="heading"
          >${Fa("panels.distributors.labels.confirm_entity",e)}</span
        >
        <span slot="description"
          >${Fa("panels.distributors.labels.confirm_entity_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Fa("panels.distributors.labels.flow_sensor",e)}</span
        >
        <span slot="description"
          >${Fa("panels.distributors.labels.flow_sensor_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
          .value="${t.flow_sensor||""}"
    ...
    `}_renderTimingRows(e){var t,i,s,a;const n=this.distributor,o=(null!==(t=n.pause_seconds)&&void 0!==t?t:0)<10,r=(null!==(i=n.skip_pulse_seconds)&&void 0!==i?i:0)<10;return W`
      <ha-settings-row>
        <span slot="heading"
          >${Fa("panels.distributors.labels.pause_seconds",e)}
          (${ot})</span
        >
        <span slot="description"
          >${Fa("field_help.distributor_pause_seconds",e)}</span
        >
        <input
          type="number"
          class="settings-input shortfield"
      ...
      ${o?W`<div class="timing-warning">
            ${Fa("panels.distributors.hints.below_floor_pause",e)}
          </div>`:""}

      <ha-settings-row>
        <span slot="heading"
          >${Fa("panels.distributors.labels.skip_pulse_seconds",e)}
          (${ot})</span
        >
        <span slot="description"
          >${Fa("field_help.distributor_skip_pulse_seconds",e)}</span
        >
        <input
          type="number"
          class="settings-input shortfield"
      ...
      ${r?W`<div class="timing-warning">
            ${Fa("panels.distributors.hints.below_floor_skip",e)}
          </div>`:""}
    `}static get styles(){return r`
      ${rn}
      ...
      <div class="outlet-config">
        <div class="commissioning-head">
          <span class="section-title"
            >${Fa("panels.distributors.outlets.title",t)}</span
          >
        </div>
        <div class="item-description">
          ${Fa("panels.distributors.outlets.help",t)}
        </div>
        ${0===this.zones.length?W`<div class="weather-note">
              ${Fa("panels.distributors.outlets.no_zones",t)}
            </div>`:W`
              <ha-settings-row>
                <span slot="heading"
                  >${Fa("panels.distributors.outlets.count",t)}</span
                >
                <select
                  class="settings-input shortfield"
                  .value="${wn(String(s))}"
              ...
              ${o?W`<div class="timing-warning">
                    ${Fa("panels.distributors.outlets.gap_warning",t)}
                  </div>`:""}
              <div class="commissioning-note">
                ${Fa("panels.distributors.hints.outlet_change",t)}
              </div>
            `}
      </div>
    `}_renderAdvisories(){var e,t;if(!this.hass)return W``;const i=this.hass.language,s=null===(e=this.config)||void 0===e?void 0:e.zone_sequencing,a=s===Gt,n=s===qt||s===Kt,o=!!(null===(t=this.config)||void 0===t?void 0:t.master_off_after);return W`
      <div class="advisories">
        <div class="advisory">
          <ha-icon icon="mdi:flask-outline"></ha-icon>
          <span
            >${Fa("panels.distributors.hints.experimental",i)}</span
          >
        </div>
        <div class="advisory">
          <ha-icon icon="mdi:water-alert-outline"></ha-icon>
          <span>${Fa("panels.distributors.hints.pressure",i)}</span>
        </div>
        ${a?W`<div class="advisory">
              <ha-icon icon="mdi:information-outline"></ha-icon>
              <span
                >${Fa("panels.distributors.hints.parallel_draw",i)}</span
              >
            </div>`:""}
        ${n&&o?W`<div class="advisory">
              <ha-icon icon="mdi:information-outline"></ha-icon>
              <span
                >${Fa("panels.distributors.hints.master_off_after",i)}</span
              >
            </div>`:""}
      </div>
    `}_renderCommissioning(e){var t;if(!this.hass)return W``;const i=this.hass.language,s="synced"===e.position_state,a=!!e.commissioning_confirmed,n=!!e.active_cycle&&Object.keys(e.active_cycle).length>0,o=e.id;return W`
      <div class="commissioning">
        <div class="commissioning-head">
          <span class="section-title"
            >${Fa("panels.distributors.commissioning.title",i)}</span
          >
          <span class="pos-badge pos-${e.position_state}">
            ${Fa("panels.distributors.commissioning.outlet",i)}
            ${e.current_outlet} ·
            ${Fa(`panels.distributors.commissioning.states.${e.position_state}`,i)}
          </span>
        </div>
        ...
        <ha-settings-row>
          <span slot="heading"
            >${Fa("panels.distributors.commissioning.set_outlet",i)}</span
          >
          <span slot="description"
            >${Fa("panels.distributors.commissioning.set_outlet_help",i)}</span
          >
          <div class="inline-controls">
            <input
              ...
              max="${6}"
              step="1"
              .value="${wn(String(null!==(t=this._outletDraft[o])&&void 0!==t?t:e.current_outlet))}"
            ...
            >
              ${Fa("panels.distributors.commissioning.set_outlet",i)}
            </button>
            <button
              class="action-btn secondary"
              ?disabled="${this.isSaving}"
            ...
            >
              ${Fa("panels.distributors.commissioning.resync_home",i)}
            </button>
          </div>
        </ha-settings-row>
        <div class="commissioning-note">
          ${Fa("panels.distributors.hints.undetectable",i)}
        </div>

        <!-- Test run -->
        <ha-settings-row>
          <span slot="heading"
            >${Fa("panels.distributors.commissioning.test_run",i)}</span
          >
          <span slot="description"
            >${Fa("panels.distributors.commissioning.test_run_help",i)}</span
          >
          <button
            class="action-btn secondary"
          ...
          >
            ...
            ${Fa("panels.distributors.commissioning.test_run",i)}
          </button>
        </ha-settings-row>
        ...
        <ha-settings-row>
          <span slot="heading"
            >${Fa("panels.distributors.commissioning.confirmed",i)}</span
          >
          <span slot="description"
            >${Fa(s?"panels.distributors.commissioning.confirmed_help":"panels.distributors.commissioning.needs_sync",i)}</span
          >
          <ha-switch
            .checked="${wn(a)}"
        ...
        <div class="run-now-row">
          ...
          >
            <ha-icon icon="mdi:play"></ha-icon>
            ${Fa("panels.distributors.commissioning.run_now",i)}
          </button>
          <span class="run-now-hint">
            ${Fa(n?"panels.distributors.commissioning.run_now_active":"panels.distributors.commissioning.run_now_help",i)}
          </span>
        </div>
      </div>
    `}renderDistributor(e,t){var i;if(!this.hass)return W``;const s=this._isExpanded(e),a=this.hass.language;return W`
      <ha-card id="distributor-${null!==(i=e.id)&&void 0!==i?i:"new"}">
        ...
        >
          <div class="name">${e.name}</div>
          <span class="pos-badge pos-${e.position_state}">
            ${Fa(`panels.distributors.commissioning.states.${e.position_state}`,a)}
          </span>
          <ha-icon
            class="dist-chevron"
    ...
    `}render(){var e;if(!this.hass)return W``;const t=this.hass.language;if(this.isLoading)return W`
        <ha-card header="${Fa("panels.distributors.title",t)}">
          <div class="card-content">
            <div class="loading-indicator">
              ${Fa("common.loading-messages.general",t)}
            </div>
          </div>
        </ha-card>
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">${Fa("panels.distributors.title",t)}</div>
          ${this._renderSaveStatus()}
          <ha-icon-button
            .path="${sn}"
            title="${Fa("panels.distributors.add.header",t)}"
            @click="${()=>{this._showAdd=!0}}"
          ></ha-icon-button>
        </div>
        <div class="card-content">
          <div class="item-description">
            ${Fa("panels.distributors.description",t)}
          </div>
          ${this._renderAdvisories()}
          ${0===this.distributors.length?W`<div class="weather-note">
                ${Fa("panels.distributors.no_items",t)}
              </div>`:""}
        </div>
      </ha-card>
      ...
      <ha-dialog
        ...
        heading="${Fa("panels.distributors.add.header",t)}"
      >
        <div class="add-form">
          <ip-field
            label="${Fa("panels.distributors.labels.name",t)}"
            required
          >
            <input
              type="text"
              class="settings-input"
              placeholder="${Fa("panels.distributors.add.name_placeholder",t)}"
              .value="${this._newName}"
        ...
        <div class="dialog-footer">
          ...
          >
            ${this.isSaving?Fa("common.saving-messages.adding",t):Fa("panels.distributors.add.actions.add",t)}
          </button>
        </div>
      </ha-dialog>
      ...
      ${i?W`
            <ha-dialog
              ...
              heading="${Fa("common.actions.confirm_delete",t)}"
            >
              <p>${Fa("panels.distributors.confirm_delete",t)}</p>
      ...
      ${s?W`
            <ha-dialog
              ...
              heading="${Fa("panels.distributors.commissioning.confirm_dialog.title",t)}"
            >
              <p>
                ${Fa("panels.distributors.commissioning.confirm_dialog.body",t)}
              </p>
              ...
              <div class="dialog-footer">
                ...
                >
                  ${Fa("panels.distributors.commissioning.confirm_dialog.confirm",t)}
                </button>
              </div>
            </ha-dialog>
          `:""}
      ...
      ${a?W`
            <ha-dialog
              ...
              heading="${Fa("panels.distributors.commissioning.confirm_resync.title",t)}"
            >
              <p>
                ${Fa("panels.distributors.commissioning.confirm_resync.body",t)}
              </p>
              ...
              <div class="dialog-footer">
                ...
                >
                  ${Fa("panels.distributors.commissioning.resync_home",t)}
                </button>
              </div>
            </ha-dialog>
          `:""}
      ...
      ${n?W`
            <ha-dialog
              ...
              heading="${Fa("panels.distributors.commissioning.confirm_set_outlet.title",t)}"
            >
              <p>
                ${Fa("panels.distributors.commissioning.confirm_set_outlet.body",t)}
              </p>
              <p>
                <strong
                  >${n.name} ·
              ...
              <div class="dialog-footer">
                ...
                >
                  ${Fa("panels.distributors.commissioning.set_outlet",t)}
                </button>
              </div>
            </ha-dialog>
          `:""}
    ...
    `}};t([me()],Cn.prototype,"config",void 0),t([me({attribute:!1})],Cn.prototype,"path",void 0),t([me({type:Array})],Cn.prototype,"distributors",void 0),t([me({type:Array})],Cn.prototype,"zones",void 0),t([me({type:Boolean})],Cn.prototype,"isLoading",void 0),t([me({type:Boolean})],Cn.prototype,"isSaving",void 0),t([ve()],Cn.prototype,"_expanded",void 0),t([me({type:Boolean})],Cn.prototype,"_showAdd",void 0),t([me()],Cn.prototype,"_newName",void 0),t([me()],Cn.prototype,"_confirmDeleteId",void 0),t([ve()],Cn.prototype,"_armConfirmId",void 0),t([ve()],Cn.prototype,"_confirmResyncHomeId",void 0),t([ve()],Cn.prototype,"_confirmSetOutletId",void 0),t([ve()],Cn.prototype,"_outletDraft",void 0),t([ve()],Cn.prototype,"_outletRows",void 0),t([ve()],Cn.prototype,"_saveStatus",void 0),Cn=t([ue("irrigation-plus-view-distributor-settings")],Cn);let En=class extends(an(ce)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.moduleCache=new Map,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout(()=>{this.saveToHA(t),e=null},500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){is().catch(e=>{console.error("Failed to load HA form:",e)})}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:be+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;e&&(this.isLoading=!0,this._scheduleUpdate());try{const[e,t,i,s]=await Promise.all([Li(this.hass),Bi(this.hass),ji(this.hass),Fi(this.hass)]);this.config=e,this.zones=t,this.modules=i,this.allmodules=s,this._initialLoadDone=!0,this.moduleCache.clear()}catch(e){console.error("Error fetching data:",e),Ja(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}}async handleAddModule(){var e,t;if((null===(t=null===(e=this.moduleInput)||void 0===e?void 0:e.selectedOptions)||void 0===t?void 0:t[0])&&!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.moduleInput.selectedOptions[0].text,t=this.allmodules.find(t=>t.name===e);if(!t)return;const i={name:e,description:t.description,config:t.config,schema:t.schema};this.modules=[...this.modules,i],this.moduleCache.clear(),this._scheduleUpdate(),await this.saveToHA(i),await this._fetchData()}catch(e){console.error("Error adding module:",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}}}async handleRemoveModule(e,t){if(!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.modules[t],a=null==e?void 0:e.id;this.modules;this.modules=this.modules.filter((e,i)=>i!==t),this.moduleCache.clear(),this._scheduleUpdate(),this.hass&&void 0!==a&&await(i=this.hass,s=a.toString(),i.callApi("POST",be+"/modules",{id:s,remove:!0}))}catch(e){console.error("Error removing module:",e),Ja(this,this.hass,"common.errors.delete_failed",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}var i,s}}async saveToHA(e){if(this.hass)try{await Zi(this.hass,e)}catch(e){throw console.error("Error saving module:",e),Ja(this,this.hass,"common.errors.save_failed",e),e}}renderModule(e,t){if(!this.hass)return W``;const i=this.zones.filter(t=>t.module===e.id).length,s=`module-${e.id||t}-${i}-${JSON.stringify(e)}`;if(this.moduleCache.has(s))return this.moduleCache.get(s);const a=W`
      <ha-card>
        <div class="card-header">
          <div class="name">${e.name}</div>
        ...
        <div class="card-content">
          ...
          <div class="moduleconfig">
            <label class="subheader"
              >${Fa("panels.modules.cards.module.labels.configuration",this.hass.language)}
              (*
              ${Fa("panels.modules.cards.module.labels.required",this.hass.language)})</label
            >
            ${e.schema?Object.entries(e.schema).map(([e])=>this.renderConfig(t,e)):null}
          </div>
          <div class="card-footer">
            ${i?W`<div class="weather-note">
                  ${Fa("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}
                </div>`:W`<button
                  class="action-btn danger"
    ...
    `;return this.moduleCache.set(s,a),a}renderUsageChip(e){return this.hass?e?W`<span class="usage-chip"
      ...
      >
        ${Object.entries(n.options).map(([e,i])=>W`<option
              ...
              ?selected="${h===Wa(i,0)}"
            >
              ${Fa("panels.modules.cards.module.translated-options."+Wa(i,1),t)}
            </option>`)}
      ...
      <ha-card header="${Fa("panels.modules.title",this.hass.language)}">
        <div class="card-content">
          ${Fa("panels.modules.description",this.hass.language)}
          ${this.isLoading?W`<div class="loading-indicator">
                ...
                <div class="add-row">
                  <select
                    id="moduleInput"
                    class="settings-input"
                    aria-label="${Fa("common.labels.module",this.hass.language)}"
                    ?disabled="${this.isSaving}"
                  >
                  ...
                  >
                    ...
                    ${this.isSaving?Fa("common.saving-messages.adding",this.hass.language):Fa("panels.modules.cards.add-module.actions.add",this.hass.language)}
                  </button>
                </div>
              `}
        </div>
    ...
    `}};t([me()],En.prototype,"config",void 0),t([me({type:Array})],En.prototype,"zones",void 0),t([me({type:Array})],En.prototype,"modules",void 0),t([me({type:Array})],En.prototype,"allmodules",void 0),t([me({type:Boolean})],En.prototype,"isLoading",void 0),t([me({type:Boolean})],En.prototype,"isSaving",void 0),t([fe("#moduleInput")],En.prototype,"moduleInput",void 0),En=t([ue("irrigation-plus-view-modules")],En);let Tn=class extends(an(ce)){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this.debounceTimers=new Map,this.globalDebounceTimer=null,this.mappingCache=new Map,this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()},this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()}))}firstUpdated(){is().catch(e=>{console.error("Failed to load HA form:",e)})}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:be+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[t,i,s]=await Promise.all([Li(this.hass),Bi(this.hass),Wi(this.hass)]);this.config=t,this.zones=i,this.mappings=s,this._initialLoadDone=!0,this.mappingCache.clear()}catch(e){console.error("Error fetching data:",e),Ja(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}}handleAddMapping(){if(!this.mappingNameInput.value.trim())return;const e={[Ne]:"",[Ie]:"",[Pe]:"",[Le]:"",[Re]:"",[Be]:"",[Ue]:"",[je]:"",[Fe]:""},t={name:this.mappingNameInput.value.trim(),mappings:e};this.mappings=[...this.mappings,t],this.isSaving=!0,this.saveToHA(t).then(()=>(this.mappingNameInput.value="",this._fetchData())).catch(e=>{console.error("Failed to add mapping:",e),Ja(this,this.hass,"common.errors.save_failed",e),this.mappings=this.mappings.slice(0,-1)}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()})}handleRemoveMapping(e,t){const i=this.mappings[t].id;if(null==i)return;const s=[...this.mappings];var a,n;(this.mappings=this.mappings.filter((e,i)=>i!==t),this.mappingCache.delete(i.toString()),this.hass)&&(this.isSaving=!0,(a=this.hass,n=i.toString(),a.callApi("POST",be+"/mappings",{id:n,remove:!0})).catch(e=>{console.error("Failed to delete mapping:",e),Ja(this,this.hass,"common.errors.delete_failed",e),this.mappings=s,this._fetchData().catch(e=>{console.error("Failed to refresh data after delete error:",e)})}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditMapping(e,t){this.mappings[e]=t,t.id&&this.mappingCache.delete(t.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout(()=>{this.isSaving=!0,this.saveToHA(t).catch(e=>{console.error("Failed to save mapping:",e),Ja(this,this.hass,"common.errors.save_failed",e)}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()}),this.globalDebounceTimer=null},500),this._scheduleUpdate()}async saveToHA(e){var t;if(!this.hass)throw new Error("Home Assistant connection not available");const i=[],s=this.hass.states;for(const t in e.mappings){const a=e.mappings[t].sensorentity;if(a&&""!==a.trim()){const n=a.trim();e.mappings[t].sensorentity=n,n in s||i.push(n)}}if(i.length>0){const e=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("ha-card");throw e&&Ga({body:{message:Fa("panels.mappings.cards.mapping.errors.source_does_not_exist",this.hass.language)+": "+i.join(", ")},error:Fa("panels.mappings.cards.mapping.errors.invalid_source",this.hass.language)},e),new Error("Invalid sensor entities found")}const{id:a,name:n,mappings:o}=e;await qi(this.hass,{id:a,name:n,mappings:o})}renderMappingSetting(e,t){const i=this.mappings[e];if(!i||!this.hass)return W``;const s=i.mappings[t];return W`
      <div class="mappingline">
        <div class="mappingsettingname">
          <label for="${`${t}_${e}`}">
            ${Fa(`panels.mappings.cards.mapping.items.${t.toLowerCase()}`,this.hass.language)}
          </label>
        </div>
        <div class="mappingsettingline">
          <label
            >${Fa("panels.mappings.cards.mapping.source",this.hass.language)}:</label
          >
    ...
    `}renderSimpleRadioOptions(e,t,i){if(!this.hass||!this.config)return W``;const s=t===Ie||t===Ue,a=i[Xe];return W`
      ${!s&&this.config.use_weather_service?W`
            <label>
              ...
              />
              ${Fa("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}
            </label>
          `:""}
      ${s?W`
            <label>
              <input
                ...
                @change="${i=>this.handleSimpleSourceChange(e,t,i)}"
              />
              ${Fa("panels.mappings.cards.mapping.sources.none",this.hass.language)}
            </label>
          `:""}
      ...
      <label>
        <input
          ...
          @change="${i=>this.handleSimpleSourceChange(e,t,i)}"
        />
        ${Fa("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}
      </label>
      ...
      <label>
        <input
          ...
          @change="${i=>this.handleSimpleSourceChange(e,t,i)}"
        />
        ${Fa("panels.mappings.cards.mapping.sources.static",this.hass.language)}
      </label>
    ...
    `}renderSensorInput(e,t,i){if(!this.hass)return W``;const s=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${s}_sensor_entity">
          ${Fa("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}:
        </label>
        <input
          type="text"
          class="settings-input"
    ...
    `}renderStaticValueInput(e,t,i){if(!this.hass)return W``;const s=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${s}_static_value">
          ${Fa("panels.mappings.cards.mapping.static_value",this.hass.language)}:
        </label>
        <input
          type="text"
          class="settings-input"
    ...
    `}renderUnitSelect(e,t,i){if(!this.hass||!this.config)return W``;const s=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${s}_unit">
          ${Fa("panels.mappings.cards.mapping.input-units",this.hass.language)}:
        </label>
        <select
          id="${s}_unit"
          class="settings-input"
    ...
    `}renderPressureTypeSelect(e,t,i){if(!this.hass)return W``;const s=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${s}_pressure_type">
          ${Fa("panels.mappings.cards.mapping.pressure-type",this.hass.language)}:
        </label>
        <select
          id="${s}_pressure_type"
          class="settings-input"
    ...
    `}renderAggregateSelect(e,t,i){if(!this.hass)return W``;const s=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${s}_aggregate">
          ${Fa("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
        </label>
        <select
          id="${s}_aggregate"
          class="settings-input"
        ...
        <label for="${s}_aggregate">
          ${Fa("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}
        </label>
      </div>
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return W`<option value="${e}" ?selected="${e===t}">
        ${Fa("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return W``}renderPressureTypes(e,t){if(this.hass&&this.config){let e=W``;const i=t[Ge];return e=W`${e}
        <option
          value="${Ke}"
          ?selected="${i===Ke}"
        >
          ${Fa("panels.mappings.cards.mapping.pressure_types."+Ke,this.hass.language)}
        </option>
        <option
          value="${Ve}"
          ?selected="${i===Ve}"
        >
          ${Fa("panels.mappings.cards.mapping.pressure_types."+Ve,this.hass.language)}
        </option>`,e}return W``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return W``;const i=function(e){switch(e){case Ne:case je:return[{unit:"°C",system:He},{unit:"°F",system:Me}];case Le:case Ie:return[{unit:rt,system:He},{unit:lt,system:Me}];case Re:return[{unit:ut,system:He},{unit:pt,system:Me}];case Pe:return[{unit:"%",system:[He,Me]}];case Be:return[{unit:"millibar",system:He},{unit:"hPa",system:He},{unit:"psi",system:Me},{unit:dt,system:Me}];case Fe:return[{unit:"km/h",system:He},{unit:ht,system:He},{unit:ct,system:Me}];case Ue:return[{unit:"W/m2",system:He},{unit:"MJ/day/m2",system:He},{unit:"W/sq ft",system:Me},{unit:"MJ/day/sq ft",system:Me}];default:return[]}}(e);let s=t[et];const a=this.config.units;if(!t[et])for(const e of i)if("string"==typeof e.system){if(a===e.system){s=e.unit;break}}else{for(const t of e.system)if(a===t.system){s=e.unit;break}if(s===e.unit)break}return W`
      ${i.map(e=>W`
    ...
    `}render(){return this.hass?this.isLoading?W`
        <ha-card
          header="${Fa("panels.mappings.title",this.hass.language)}"
        >
          <div class="card-content">
            <div class="loading-indicator">
              ${Fa("common.loading-messages.general",this.hass.language)}
      ...
      >
        <div class="card-content">
          ${Fa("panels.mappings.description",this.hass.language)}
          <div class="add-row">
            <input
              id="mappingNameInput"
              class="settings-input"
              type="text"
              placeholder="${Fa("panels.mappings.labels.mapping-name",this.hass.language)}"
            />
            <button
              class="action-btn ${this.isSaving?"saving":""}"
              ?disabled="${this.isSaving}"
            ...
            >
              <ha-icon icon="mdi:plus"></ha-icon>
              ${Fa("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    ...
    `}renderMappingCard(e,t){if(!this.hass)return W``;const i=this.zones.filter(t=>t.mapping===e.id).length;return W`
      <ha-card>
        ...
        <div class="card-content">
          <ha-settings-row>
            <span slot="heading"
              >${Fa("panels.mappings.labels.mapping-name",this.hass.language)}</span
            >
            <input
              id="name${e.id}"
              class="settings-input"
          ...
          <div class="card-footer">
            ${i?W`<div class="weather-note">
                  ${Fa("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}
                </div>`:W`<button
                  class="action-btn danger"
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach(e=>{clearTimeout(e)}),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};t([me()],Tn.prototype,"config",void 0),t([me({type:Array})],Tn.prototype,"zones",void 0),t([me({type:Array})],Tn.prototype,"mappings",void 0),t([me({type:Boolean})],Tn.prototype,"isLoading",void 0),t([me({type:Boolean})],Tn.prototype,"isSaving",void 0),t([fe("#mappingNameInput")],Tn.prototype,"mappingNameInput",void 0),Tn=t([ue("irrigation-plus-view-mappings")],Tn);const On="06:00",Dn=90;function Mn(e){switch(e){case ui:return{mode:e,time:On};case pi:case gi:return{mode:e,offset:0};case mi:return{mode:e,azimuth:Dn};default:return{mode:hi}}}function Hn(e,t,i,s){const a=function(e){return e===hi||e===ui||e===pi||e===gi||e===mi}(e)?e:hi,n=Mn(a);return a===ui&&void 0!==t&&(n.time=t),a!==pi&&a!==gi||void 0===i||(n.offset=i),a===mi&&void 0!==s&&(n.azimuth=s),n}function Nn(e){var t,i,s;return{mode:e.mode,time:e.mode===ui?null!==(t=e.time)&&void 0!==t?t:On:void 0,offset:e.mode===pi||e.mode===gi?null!==(i=e.offset)&&void 0!==i?i:0:void 0,azimuth:e.mode===mi?null!==(s=e.azimuth)&&void 0!==s?s:Dn:void 0}}function In(e){return{start:Hn(e.start_mode,e.start_time,e.start_offset,e.start_azimuth),finish:Hn(e.finish_mode,e.finish_time,e.finish_offset,e.finish_azimuth),anchor:e.anchor===fi?fi:_i}}function Pn(e,t){const i=e.start.mode!==hi,s=e.finish.mode!==hi;if(!i&&!s)return{start:"error",finish:"error",valid:!1};return function(e,t,i){if(!(null==i?void 0:i.start)&&!(null==i?void 0:i.finish))return t;const s=e.start.mode!==hi,a=e.finish.mode!==hi,n=s&&a?e.anchor:s?fi:_i,o=e=>e===n?"unreachable_no_run":"unreachable_ignored";return Object.assign(Object.assign({},t),{start:i.start?o(fi):t.start,finish:i.finish?o(_i):t.finish})}(e,i?s?e.anchor===_i?{start:"demand_floored",finish:"exact_deferred",valid:!0}:{start:"exact",finish:"demand_capped_deferred",valid:!0}:{start:"exact",finish:"demand_open",valid:!0}:{start:"demand_open",finish:"exact",valid:!0},t)}function Ln(e){if(e.recurrence===ri&&0===(e.days_of_week||[]).length)return"no_days";if(e.recurrence!==di){const t=In(e);if(t.start.mode===hi&&t.finish.mode===hi)return"no_window"}return Array.isArray(e.zones)&&0===e.zones.length?"no_zones":null}function Rn(e,t){const i=Ln(e);if(i)return{text:Fa(`panels.schedules.summary.${"no_window"===i?"invalid":i}`,t),isError:!0};const s=function(e,t){if("all"===e||!Array.isArray(e))return Fa("panels.schedules.summary.zones_all",t);return Fa("panels.schedules.summary.zones_some",t,"count",e.length)}(e.zones,t),a=function(e,t){switch(e.recurrence){case ri:{const i=(e.days_of_week||[]).map(e=>Fa(`panels.schedules.days.${e}`,t)).join(", ");return Fa("panels.schedules.summary.recurrence_weekly",t,"days",i)}case li:return Fa("panels.schedules.summary.recurrence_monthly",t,"day",e.day_of_month||1);case di:{const i=e.interval_hours||24;return e.start_time?Fa("panels.schedules.summary.recurrence_interval_at",t,"hours",i,"time",e.start_time):Fa("panels.schedules.summary.recurrence_interval",t,"hours",i)}default:return Fa("panels.schedules.summary.recurrence_daily",t)}}(e,t);if(e.recurrence===di){return{text:`${a}, ${Fa("panels.schedules.summary.watering",t,"zones",s)}.`,isError:!1}}const n=In(e),o=n.start.mode!==hi,r=n.finish.mode!==hi,l=Fa("panels.schedules.summary.watering",t,"zones",s);let d;return d=o?r?n.anchor===_i?Fa("panels.schedules.summary.anchor_finish",t,"finish",Bn(n.finish,t),"start",Bn(n.start,t)):Fa("panels.schedules.summary.anchor_start",t,"start",Bn(n.start,t),"finish",Bn(n.finish,t)):Fa("panels.schedules.summary.start_only",t,"when",Bn(n.start,t)):Fa("panels.schedules.summary.finish_only",t,"when",Bn(n.finish,t)),{text:`${a}, ${l}, ${d}.`,isError:!1}}function Bn(e,t){var i,s,a;switch(e.mode){case ui:return null!==(i=e.time)&&void 0!==i?i:"";case pi:case gi:{const i=Fa(`panels.schedules.summary.${e.mode}`,t),a=null!==(s=e.offset)&&void 0!==s?s:0;if(0===a)return i;return Fa(a<0?"panels.schedules.summary.offset_before":"panels.schedules.summary.offset_after",t,"minutes",Math.abs(a),"event",i)}case mi:return Fa("panels.schedules.summary.at_azimuth",t,"degrees",null!==(a=e.azimuth)&&void 0!==a?a:Dn);default:return""}}function Un(e){return(e%360+360)%360}const jn=Math.PI/180;function Fn(e,t,i){const s=e*jn,a=23.45*Math.sin(360*(284+function(e){const t=Date.UTC(e.getUTCFullYear(),0,1),i=Date.UTC(e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate());return Math.floor((i-t)/864e5)+1}(i))/365*jn)*jn,n=15*(i.getUTCHours()+i.getUTCMinutes()/60+i.getUTCSeconds()/3600+t/15-12)*jn;return Un(Math.atan2(Math.sin(n),Math.cos(n)*Math.sin(s)-Math.tan(a)*Math.cos(s))/jn+180)}function Zn(e,t,i){return Math.abs(e-t)>180?e>t?i>=e||i<=t:i<=e||i>=t:Math.min(e,t)<=i&&i<=Math.max(e,t)}const Wn=9e5;function qn(e,t,i,s,a){let n=s,o=a;for(;o-n>6e4;){const s=n+(o-n)/2,a=Fn(e,t,new Date(s));Zn(Fn(e,t,new Date(n)),a,i)?o=s:n=s}return new Date(n)}const Gn={hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"};function Kn(e,t){if(!e)return Vn(t);let i;try{i=new Intl.DateTimeFormat("en-US",Object.assign(Object.assign({},Gn),{timeZone:e})).formatToParts(t)}catch(e){return Vn(t)}const s=e=>{var t,s;return parseInt(null!==(s=null===(t=i.find(t=>t.type===e))||void 0===t?void 0:t.value)&&void 0!==s?s:"0",10)},a=s("hour")%24;return new Date(Date.UTC(s("year"),s("month")-1,s("day"),a,s("minute"),s("second")))}function Vn(e){return new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours(),e.getMinutes(),e.getSeconds()))}function Yn(e){return 60*e.getUTCHours()+e.getUTCMinutes()}function Xn(e,t){if("number"!=typeof(null==e?void 0:e.latitude)||"number"!=typeof(null==e?void 0:e.longitude))return;const{latitude:i,longitude:s,time_zone:a}=e;return e=>function(e,t,i,s,a){const n=Kn(s,a),o=new Date(Date.UTC(n.getUTCFullYear(),n.getUTCMonth(),n.getUTCDate())),r=function(e,t,i,s,a=1){const n=s.getTime(),o=n+864e5*a;let r=n,l=Fn(e,t,s);for(;r<o;){r+=Wn;const s=Fn(e,t,new Date(r));if(Zn(l,s,i))return qn(e,t,i,r-Wn,r);l=s}return null}(e,t,Un(i),function(e,t){let i=e.getTime();for(let s=0;s<2;s++){const s=Kn(t,new Date(i)).getTime()-i;i=e.getTime()-s}return new Date(i)}(o,s));return null===r?null:Yn(Kn(s,r))}(i,s,e,a,t)}const Jn=1440,Qn=44,eo=260;function to(e){return(e%Jn+Jn)%Jn}function io(e){const t=to(Math.round(e)),i=Math.floor(t/60),s=t%60;return`${String(i).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function so(e){const t=Math.round(e),i=Math.floor(t/60),s=t%60;return i?`${i}h ${s}m`:`${s}m`}function ao(e,t){const i=t/Jn*2*Math.PI+Math.PI/2;return[66+e*Math.cos(i),66+e*Math.sin(i)]}function no(e,t,i){const s=i-t>=Jn?t+Jn-.5:i,[a,n]=ao(e,t),[o,r]=ao(e,s),l=s-t>720?1:0;return`M ${a.toFixed(2)} ${n.toFixed(2)} A ${e} ${e} 0 ${l} 1 ${o.toFixed(2)} ${r.toFixed(2)}`}function oo(e,t,i,s,a){const n=2*Math.PI*e/Jn,o=[[0,i]];for(let e=0;e<=10;e++){const t=Math.PI/2+e/10*(Math.PI/2);o.push([s*Math.cos(t),i-s+s*Math.sin(t)])}for(let e=0;e<=10;e++){const t=Math.PI+e/10*(Math.PI/2);o.push([s*Math.cos(t),s*Math.sin(t)-3.2])}return o.push([0,-i]),o.map(([i,s],o)=>{const[r,l]=ao(e+s,(e=>t-a*e/n)(i));return`${o?"L":"M"} ${r.toFixed(2)} ${l.toFixed(2)}`}).join(" ")+" Z"}function ro(e,t,i,s,a){const n=(t-e)/48,o=[];for(let r=0;r<48;r++){const l=e+r*n,d=l+n/2;let c=1;i>0&&(c=Math.min(c,(d-e)/i)),s>0&&(c=Math.min(c,(t-d)/s)),c=Math.max(0,Math.min(1,c)),o.push({d:no(a,l,l+1.25*n),opacity:c})}return o}function lo(e){const[t,i]=e.split(":").map(e=>parseInt(e,10));return 60*(t||0)+(i||0)}function co(e,t,i,s){var a,n,o,r;switch(e.mode){case ui:return to(lo(null!==(a=e.time)&&void 0!==a?a:"06:00"));case pi:return to(t+(null!==(n=e.offset)&&void 0!==n?n:0));case gi:return to(i+(null!==(o=e.offset)&&void 0!==o?o:0));case mi:{if(!s)return null;const t=s(null!==(r=e.azimuth)&&void 0!==r?r:Dn);return null===t?null:to(t)}default:return null}}function ho(e,t){return{wraps:!1,arc:no(Qn,e,t),capStart:oo(Qn,e,5,1.8,-1),capEnd:oo(Qn,t,5,1.8,1)}}function uo(e){const{rows:t,recurrence:i,intervalHours:s,intervalStartTime:a,nominalDemandMinutes:n,sunriseMinutes:o,sunsetMinutes:r,azimuthResolver:l}=e,d=no(Qn,0,Jn),c=[0,360,720,1080].map(e=>{const[t,i]=ao(38,e),[s,a]=ao(50,e);return{x1:t,y1:i,x2:s,y2:a}}),[h,u]=ao(57,o),[p,g]=ao(57,r);if(i===di){const{runs:e,overlaps:t,wrapAt:i}=function(e,t,i){const s=60*Math.max(1,Number(t)||24),a=i?lo(i):0,n=[];for(let t=a;t<a+Jn&&n.length<24;t+=s)n.push([t,t+e]);const o=[];for(let e=0;e+1<n.length;e++)n[e][1]>n[e+1][0]&&o.push([n[e+1][0],Math.min(n[e][1],n[e+1][1])]);return{runs:n,overlaps:o,wrapAt:a+Jn}}(n,s,a),l=e.map(([e,t])=>{if(t<=i)return ho(e,t);const s=i-8,a=s-e,n=Math.min(a,120);return{wraps:!0,capStart:oo(Qn,e,5,1.8,-1),fade:ro(e,s,0,n,Qn)}});return{trackPath:d,windowArc:null,dottedPath:null,runs:l,overlaps:t.map(([e,t])=>({d:no(Qn,e,t),fromMinutes:e,toMinutes:t})),ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:e.map(([e,t])=>{const[i,s]=ao(57,(e+t)/2);return{x:i,y:s,fromMinutes:e,toMinutes:t}}),centre:{kind:"interval",perDay:e.length,intervalHours:Math.max(1,Number(s)||24)}}}const m=co(t.start,o,r,l);let v=co(t.finish,o,r,l);null!==m&&null!==v&&v<=m&&(v+=Jn);if(null===m&&null===v)return{trackPath:d,windowArc:null,dottedPath:null,runs:[],overlaps:[],ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:[],centre:{kind:"invalid"}};const f=null!==m&&null!==v?v-m:null;let _,b,y=0;if(null!==m&&null!==v){const e=f;b=Math.min(n,e),y=Math.max(0,n-e),_=t.anchor===_i?v-b:m}else null!==m?(_=m,b=n):(b=n,_=v-b);const w=_+b;let $=null!=m?m:_,x=null!=v?v:w,k=0,z=0;null===m&&($=_-eo,k=eo),null===v&&(x=w+eo,z=eo);const S=null!==f&&f<60,A=null===m||null===v?{kind:"faded",segments:ro($,x,k,z,Qn)}:{kind:"solid",d:no(Qn,$,S?$+60:x)},C=y>1?no(Qn,_-y,_):null,[E,T]=ao(57,(_+w)/2),O=null===f?{kind:"run",minutes:b}:{kind:"window",minutes:f};return{trackPath:d,windowArc:A,dottedPath:C,runs:[ho(_,w)],overlaps:[],ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:[{x:E,y:T,fromMinutes:_,toMinutes:w}],centre:O}}const po=q`<circle cx="12" cy="12" r="4.4" />
  ${Array.from({length:8},(e,t)=>{const i=t*Math.PI/4,s=(12+6.6*Math.cos(i)).toFixed(1),a=(12+6.6*Math.sin(i)).toFixed(1),n=(12+9.2*Math.cos(i)).toFixed(1),o=(12+9.2*Math.sin(i)).toFixed(1);return q`<line x1="${s}" y1="${a}" x2="${n}" y2="${o}" />`})}`,go=q`<path d="M13.5,2.5A9.5,9.5 0 1,0 21.5,14 7.6,7.6 0 0,1 13.5,2.5Z" />`,mo=q`<path d="M12,2.6C12,2.6 18.6,9.4 18.6,13.7A6.6,6.6 0 0,1 5.4,13.7C5.4,9.4 12,2.6 12,2.6Z" />`;let vo=class extends ce{constructor(){super(...arguments),this.recurrence="daily",this.nominalDemandSeconds=0}_sunTimes(){var e,t,i,s,a,n;const o=null===(t=null===(e=this.hass)||void 0===e?void 0:e.states)||void 0===t?void 0:t["sun.sun"],r=null===(i=null==o?void 0:o.attributes)||void 0===i?void 0:i.next_rising,l=null===(s=null==o?void 0:o.attributes)||void 0===s?void 0:s.next_setting,d=null===(n=null===(a=this.hass)||void 0===a?void 0:a.config)||void 0===n?void 0:n.time_zone,c=(e,t)=>{if(!e)return t;const i=new Date(e);return isNaN(i.getTime())?t:Yn(Kn(d,i))};return{sunrise:c(r,360),sunset:c(l,1200)}}_azimuthResolver(){var e;return Xn(null===(e=this.hass)||void 0===e?void 0:e.config,new Date)}_renderRun(e,t){return e.wraps?q`
    ...
    `:q`
      ...
      `}_t(e,t,i){return Fa(`panels.schedules.dial.${e}`,t,"{from}",io(i.fromMinutes),"{to}",io(i.toMinutes))}_note(e,t){var i;const s=this.nominalDemandSeconds/60;if(!s)return W``;if("interval"===e.centre.kind){const i=e.overlaps.length>0;return W`
        <div class="d-note ${i?"warn":""}">
          ${i?Fa("panels.schedules.dial.collision_note",t):Fa("panels.schedules.dial.runs_of",t,"{count}",e.runs.length,"{duration}",so(s))}
        </div>
      `}if("window"!==e.centre.kind)return W``;const a=s-(null!==(i=e.centre.minutes)&&void 0!==i?i:0);return a<=1?W``:W`
      <div class="d-note warn">
        ${Fa("panels.schedules.dial.shortfall",t,"{duration}",so(a))}
      </div>
    `}_centreText(e,t){var i,s;const a=e.centre;switch(a.kind){case"invalid":return{val:"—",lbl:""};case"interval":return{val:Fa("panels.schedules.dial.every_hours",t,"{hours}",a.intervalHours),lbl:Fa("panels.schedules.dial.per_day",t,"{count}",a.perDay)};case"run":return{val:so(null!==(i=a.minutes)&&void 0!==i?i:0),lbl:Fa("panels.schedules.dial.run_label",t)};default:return{val:so(null!==(s=a.minutes)&&void 0!==s?s:0),lbl:Fa("panels.schedules.dial.window_label",t)}}}render(){if(!this.hass||!this.rows)return W``;const e=this.hass.language,{sunrise:t,sunset:i}=this._sunTimes(),s=uo({rows:this.rows,recurrence:this.recurrence,intervalHours:this.intervalHours,intervalStartTime:this.intervalStartTime,nominalDemandMinutes:this.nominalDemandSeconds/60,sunriseMinutes:t,sunsetMinutes:i,azimuthResolver:this._azimuthResolver()}),{val:a,lbl:n}=this._centreText(s,e),o=Fa("panels.schedules.dial.sunrise",e,"{time}",io(s.sun.minutes)),r=Fa("panels.schedules.dial.sunset",e,"{time}",io(s.moon.minutes));return W`
      <div class="viz-dial">
        <div class="d-wrap">
          <svg
            viewBox="0 0 132 132"
            role="img"
            aria-label="${Fa("panels.schedules.dial.aria_label",e)}"
          >
    ...
    `}};t([me({attribute:!1})],vo.prototype,"hass",void 0),t([me({attribute:!1})],vo.prototype,"rows",void 0),t([me({attribute:!1})],vo.prototype,"recurrence",void 0),t([me({attribute:!1})],vo.prototype,"intervalHours",void 0),t([me({attribute:!1})],vo.prototype,"intervalStartTime",void 0),t([me({attribute:!1})],vo.prototype,"nominalDemandSeconds",void 0),vo=t([ue("ip-run-window-dial")],vo);const fo=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"];function _o(){return{name:"",recurrence:"daily",enabled:!0,start_mode:ui,start_time:"06:00",finish_mode:hi,action:"irrigate",zones:"all"}}function bo(e,t){return Fa(`panels.schedules.types.${e}`,t)||e}let yo=class extends ce{constructor(){super(...arguments),this.zones=[],this.heading="",this._actionSlot="content",this._save=()=>{this.dispatchEvent(new CustomEvent("save",{detail:{value:this.schedule},bubbles:!0,composed:!0}))},this._cancel=()=>{this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}}firstUpdated(){this._detectActionSlot()}async _detectActionSlot(){var e;const t=this.renderRoot.querySelector("ha-dialog");if(!t)return;await t.updateComplete;for(let i=0;i<10&&!(null===(e=t.shadowRoot)||void 0===e?void 0:e.querySelector("slot"));i++)await new Promise(e=>setTimeout(e,0));const i=t.shadowRoot;(null==i?void 0:i.querySelector('slot[name="footer"]'))?this._actionSlot="footer":(null==i?void 0:i.querySelector('slot[name="primaryAction"]'))&&(this._actionSlot="material")}_emitChanged(e){this.dispatchEvent(new CustomEvent("schedule-changed",{detail:{value:Object.assign(Object.assign({},this.schedule),e)},bubbles:!0,composed:!0}))}_renderZonePicker(){const e="all"===this.schedule.zones||!Array.isArray(this.schedule.zones),t=e?[]:this.schedule.zones.map(String);return W`
      <div class="field">
        <div class="switch-container">
          ...
          />
          <label for="zones_all"
            >${Fa("panels.schedules.zones_all",this.hass.language)}</label
          >
          <input
            type="radio"
            id="zones_specific"
          ...
          <label for="zones_specific"
            >${Fa("panels.schedules.zones_specific",this.hass.language)}</label
          >
        </div>
        ${e?"":W`
    ...
    `}_renderRecurrenceFields(){const e=this.schedule,t=this.hass.language;switch(e.recurrence){case"weekly":return W`
        ...
        `;case"monthly":return W`
          <div class="field">
            <label
              >${Fa("panels.schedules.fields.day_of_month",t)}</label
            >
            <input
              type="number"
              min="1"
        ...
        `;case"interval":return W`
          <div class="field field-inline">
            <label
              >${Fa("panels.schedules.fields.interval_hours",t)}</label
            >
            <input
              type="number"
              min="1"
            ...
            />
            <span class="suffix"
              >${Fa("panels.schedules.hours",t)}</span
            >
          </div>
          <div class="field field-inline">
            <label
              >${Fa("panels.schedules.fields.start_time",t)}</label
            >
            <input
              type="time"
              .value="${e.start_time||""}"
            ...
            <span class="field-help"
              >${Fa("panels.schedules.help.interval_start",t)}</span
            >
          </div>
        `;default:return W``}}_renderRowStepper(e,t){var i,s,a;const n=this.hass.language;switch(e.mode){case ui:return W`
          <input
            type="time"
            .value="${null!==(i=e.time)&&void 0!==i?i:"06:00"}"
            @change=${i=>t(Object.assign(Object.assign({},e),{time:i.target.value}))}
          />
        `;case pi:case gi:return W`
          <span class="row-inline"
            >${Fa("panels.schedules.fields.offset_by",n)}</span
          >
          <input
            type="number"
            step="1"
          ...
          />
          <span class="row-inline"
            >${Fa("panels.schedules.minutes",n)}</span
          >
        `;case mi:return W`
          <input
            type="number"
            step="1"
            .value="${String(null!==(a=e.azimuth)&&void 0!==a?a:Dn)}"
            @input=${i=>{var s;const a=parseInt(i.target.value);t(Object.assign(Object.assign({},e),{azimuth:isNaN(a)?null!==(s=e.azimuth)&&void 0!==s?s:Dn:(a%360+360)%360}))}}
          />
          <span class="row-inline">°</span>
        `;default:return W``}}_renderWindowRow(e,t,i,s){const a=this.hass.language;return W`
      <div class="field">
        <label>${Fa(`panels.schedules.fields.${e}_mode`,a)}</label>
        <div class="rowfields">
          <select
            @change=${e=>s(Mn(e.target.value))}
          >
            ${vi.map(e=>W`
                <option value="${e}" .selected="${t.mode===e}">
                  ${Fa(`panels.schedules.bound_mode.${e}`,a)}
                </option>
              `)}
          </select>
        ...
        <span
          ...
          >${Fa(`panels.schedules.help.${i}`,a)}</span
        >
      </div>
    `;var n}_renderAnchorRow(e,t){const i=this.hass.language;return W`
      <div class="field">
        <div class="rowfields">
          <span class="row-inline"
            >${Fa("panels.schedules.fields.anchor_prefix",i)}</span
          >
          <select
          ...
          >
            ${[fi,_i].map(t=>W`
                <option value="${t}" .selected="${e.anchor===t}">
                  ${Fa(`panels.schedules.anchor.${t}`,i)}
                </option>
              `)}
          </select>
          <span class="row-inline"
            >${Fa("panels.schedules.fields.anchor_suffix",i)}</span
          >
        </div>
      </div>
    `}_unresolvableEnds(e){var t;const i=Xn(null===(t=this.hass)||void 0===t?void 0:t.config,new Date);if(!i)return{};const s=e=>{var t;return e.mode===mi&&null===i(null!==(t=e.azimuth)&&void 0!==t?t:Dn)};return{start:s(e.start),finish:s(e.finish)}}_renderWindowRows(){const e=this.schedule;if(e.recurrence===di)return W``;const t=In(e),i=Pn(t,this._unresolvableEnds(t)),s=e=>this._emitChanged(function(e){const t=Nn(e.start),i=Nn(e.finish);return{start_mode:t.mode,start_time:t.time,start_offset:t.offset,start_azimuth:t.azimuth,finish_mode:i.mode,finish_time:i.time,finish_offset:i.offset,finish_azimuth:i.azimuth,anchor:e.anchor}}(e)),a=t.start.mode!==hi&&t.finish.mode!==hi;return W`
    ...
    `}_nameMissing(){return!(this.schedule.name||"").trim()}_canSave(){return!this._nameMissing()&&null===Ln(this.schedule)}_renderSection(e,t){return W`
      <div class="sect-card">
        <h4>
          ${Fa(`panels.schedules.sections.${e}`,this.hass.language)}
        </h4>
        ${t}
      </div>
    `}_renderSummary(){const e=Rn(this.schedule,this.hass.language);return W`
    ...
    `}_renderSeasonSection(){const e=this.schedule,t=this.hass.language;return W`
      <div class="field">
        <div class="rowfields">
          ...
          />
          <span class="suffix"
            >${Fa("panels.schedules.season.to",t)}</span
          >
          <input
            type="date"
            .value="${e.end_date||""}"
        ...
        <span class="field-help"
          >${Fa("panels.schedules.season.note",t)}</span
        >
      </div>
    `}render(){var e;if(!this.hass||!this.schedule)return W``;const t=this.schedule,i=this.hass.language;return W`
      ...
      <ha-dialog open heading="${this.heading}" @closed=${this._cancel}>
        <div class="dialog-content">
          ...
          <div class="field">
            <label>${Fa("panels.schedules.fields.name",i)}</label>
            <input
              type="text"
              .value="${t.name}"
            ...
            ${this._nameMissing()?W`<span class="field-help err"
                  >${Fa("panels.schedules.help.name_required",i)}</span
                >`:""}
          </div>
          ...
          ${this._renderSection("when",W`
              <div class="field">
                <select
                  ...
                  aria-label="${Fa("panels.schedules.fields.recurrence",i)}"
              ...
              ${t.recurrence===di?W``:this._renderRecurrenceFields()}
              <div class="when-row">
                <div class="when-rows-col">
                  ${t.recurrence===di?this._renderRecurrenceFields():W``}
    ...
    `}_renderEnabledToggle(e){return W`
      <label class="enabled-toggle">
        ...
        ></ha-switch>
        <span>${Fa("panels.schedules.fields.enabled",e)}</span>
      </label>
    `}_renderButtons(e){return W`
      <div class="dialog-buttons">
        <button class="dialog-btn" @click=${this._cancel}>
          ${Fa("common.actions.cancel",e)}
        </button>
        <button
          class="dialog-btn dialog-btn-primary"
    ...
    ${this._renderButtons(e)}`;return"content"===this._actionSlot?W`
      ...
      `:W` <div slot="footer" class="dialog-footer">${t}</div> `}static get styles(){return[rn,r`
      ...
      `]}};t([me({attribute:!1})],yo.prototype,"hass",void 0),t([me({attribute:!1})],yo.prototype,"schedule",void 0),t([me({attribute:!1})],yo.prototype,"zones",void 0),t([me({attribute:!1})],yo.prototype,"heading",void 0),t([ve()],yo.prototype,"_actionSlot",void 0),yo=t([ue("ip-schedule-dialog")],yo);let wo=class extends(an(ce)){constructor(){super(...arguments),this._schedules=[],this._zones=[],this._isLoading=!0,this._loadFailed=!1,this._loaded=!1,this._showDialog=!1,this._editingSchedule=_o(),this._editingId=null}hassSubscribe(){return this._load(),[this.hass.connection.subscribeMessage(()=>this._load(),{type:be+"_config_updated"})]}async _load(){var e;if(this.hass)try{const[t,i]=await Promise.all([(e=this.hass,e.callWS({type:be+"/schedules"})),Bi(this.hass)]);this._schedules=t||[],this._zones=i||[],this._loaded=!0,this._loadFailed=!1}catch(e){console.error("Failed to load schedules",e),Ja(this,this.hass,"common.errors.load_failed",e),this._loaded||(this._loadFailed=!0)}finally{this._isLoading=!1}}_openAdd(){this._editingSchedule=_o(),this._editingId=null,this._showDialog=!0,this._refreshNominalDemand()}_openEdit(e){var t;this._editingSchedule=Object.assign({},e),this._editingId=null!==(t=e.id)&&void 0!==t?t:null,this._showDialog=!0}_closeDialog(){this._showDialog=!1}async _save(){const e=Object.assign({},this._editingSchedule);this._editingId&&(e.id=this._editingId);try{const t=await Ki(this.hass,e);if(t&&!1===t.success)throw new Error(t.error||"");this._closeDialog(),await this._load()}catch(e){console.error("Failed to save schedule",e),Ja(this,this.hass,"common.errors.save_failed",e)}}async _delete(e){try{await(t=this.hass,i=e,t.callWS({type:be+"/schedule_delete",schedule_id:i})),await this._load()}catch(e){console.error("Failed to delete schedule",e),Ja(this,this.hass,"common.errors.delete_failed",e)}var t,i}_onScheduleChanged(e){const t=this._editingSchedule.zones;this._editingSchedule=e.detail.value,JSON.stringify(t)!==JSON.stringify(this._editingSchedule.zones)&&this._refreshNominalDemand()}async _refreshNominalDemand(){const e=this._editingSchedule.zones;try{const{nominal_demand_seconds:t}=await((e,t)=>e.callWS({type:be+"/schedule_nominal_demand",zones:t}))(this.hass,"all"===e?"all":e);this._showDialog&&JSON.stringify(this._editingSchedule.zones)===JSON.stringify(e)&&(this._editingSchedule=Object.assign(Object.assign({},this._editingSchedule),{nominal_demand_seconds:t}))}catch(e){console.error("Failed to fetch nominal demand",e)}}_zonesLabel(e){if("all"===e)return Fa("panels.schedules.zones_all",this.hass.language);if(Array.isArray(e)){const t=e.map(e=>{const t=this._zones.find(t=>String(t.id)===String(e));return t?t.name:e}).join(", ");return t||e.join(", ")}return String(e)}_dialogTitle(){return this._editingId?Fa("panels.schedules.dialog.edit_title",this.hass.language):Fa("panels.schedules.dialog.add_title",this.hass.language)}render(){return this.hass?this._isLoading?W`
        <ha-card
          header="${Fa("panels.schedules.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Fa("common.loading",this.hass.language)}...
          </div>
        </ha-card>
      `:this._loadFailed?W`
        <ha-card
        ...
        >
          <div class="card-content">
            ${Fa("common.errors.load_failed",this.hass.language)}
          </div>
        </ha-card>
      `:W`
      ${this._showDialog?W`
      ...
      >
        <div class="card-content">
          ${Fa("panels.schedules.description",this.hass.language)}
        </div>
        <div class="card-content">
          <button class="add-btn" @click=${this._openAdd}>
            <svg style="width:20px;height:20px" viewBox="0 0 24 24">
              <path fill="currentColor" d="${sn}" />
            </svg>
            ${Fa("panels.schedules.add",this.hass.language)}
          </button>
        </div>
      </ha-card>
      ...
      ${0===this._schedules.length?W`
            <ha-card>
              <div class="card-content">
                ${Fa("panels.schedules.no_items",this.hass.language)}
              </div>
            </ha-card>
          `:this._schedules.map(e=>W`
              <ha-card header="${e.name}">
                <div class="card-content">
                  <div class="summary">
                    ${Rn(e,this.hass.language).text}
                  </div>
                  <div class="info-row">
                    <span class="info-label"
                      >${Fa("panels.schedules.fields.recurrence",this.hass.language)}:</span
                    >
                    <span
                      >${bo(e.recurrence,this.hass.language)}</span
                    >
                  </div>
                  ${"interval"!==e.recurrence&&"time"===e.start_mode&&e.start_time?W`
                        <div class="info-row">
                          <span class="info-label"
                            >${Fa("panels.schedules.fields.start_time",this.hass.language)}:</span
                          >
                  ...
                  ${"interval"!==e.recurrence&&"time"===e.finish_mode&&e.finish_time?W`
                        <div class="info-row">
                          <span class="info-label"
                            >${Fa("panels.schedules.fields.finish_time",this.hass.language)}:</span
                          >
                  ...
                  ${e.interval_hours?W`
                        <div class="info-row">
                          <span class="info-label"
                            >${Fa("panels.schedules.fields.interval_hours",this.hass.language)}:</span
                          >
                          <span
                            >${e.interval_hours}
                            ${Fa("panels.schedules.hours",this.hass.language)}</span
                          >
                        </div>
                      `:""}
                  ...
                  <div class="info-row">
                    <span class="info-label"
                      >${Fa("panels.schedules.fields.zones",this.hass.language)}:</span
                    >
                    <span>${this._zonesLabel(e.zones)}</span>
                  </div>
                  <div class="info-row">
                    <span class="info-label"
                      >${Fa("panels.schedules.fields.enabled",this.hass.language)}:</span
                    >
                    <span
                      >${e.enabled?Fa("common.labels.yes",this.hass.language):Fa("common.labels.no",this.hass.language)}</span
                    >
                  </div>
                </div>
                <div class="card-content action-buttons">
                  <div class="action-buttons-left">
                    ...
                    >
                      ...
                      <span class="action-button-label"
                        >${Fa("common.actions.edit",this.hass.language)}</span
                      >
                    </div>
                  </div>
                  <div class="action-buttons-right">
                    ...
                    >
                      <span class="action-button-label"
                        >${Fa("common.actions.delete",this.hass.language)}</span
                      >
                      <svg style="width:20px;height:20px" viewBox="0 0 24 24">
            ...
            `)}
    `:W``}static get styles(){return[rn,r`
      ...
      `]}};t([me({attribute:!1})],wo.prototype,"hass",void 0),t([ve()],wo.prototype,"_schedules",void 0),t([ve()],wo.prototype,"_zones",void 0),t([ve()],wo.prototype,"_isLoading",void 0),t([ve()],wo.prototype,"_loadFailed",void 0),t([ve()],wo.prototype,"_showDialog",void 0),t([ve()],wo.prototype,"_editingSchedule",void 0),t([ve()],wo.prototype,"_editingId",void 0),wo=t([ue("irrigation-plus-view-schedules")],wo);let $o=class extends(an(ce)){constructor(){super(...arguments),this._forecast=null,this._mappings=[],this._records=new Map,this._loading=!0,this._metric=!0,this._climate=[]}hassSubscribe(){return this._fetch(),[this.hass.connection.subscribeMessage(()=>this._fetch(),{type:be+"_config_updated"})]}async _fetch(){var e,t;if(this.hass)try{const[i,s,a,n]=await Promise.all([(t=this.hass,t.callWS({type:be+"/weather_forecast"})),Wi(this.hass),Li(this.hass),Gi(this.hass)]);this._forecast=i,this._mappings=s||[],this._metric=(null==a?void 0:a.units)!==Me;const o=n?Object.values(n):[];this._climate=o.length>0&&(null===(e=o[0])||void 0===e?void 0:e.monthly_estimates)||[];const r=new Map;await Promise.all(this._mappings.map(async e=>{if(void 0!==e.id)try{r.set(e.id,await((e,t,i=10)=>e.callWS({type:be+"/weather_records",mapping_id:t,limit:i}))(this.hass,e.id.toString(),0)||[])}catch(e){}})),this._records=r}catch(e){console.error("Failed to fetch weather data",e)}finally{this._loading=!1}}render(){return this.hass?W`${this._renderForecast()} ${this._renderRecords()}
    ${this._renderSeasonal()}`:W``}_renderSeasonal(){if(!this.hass)return W``;const e=this.hass.language;return W`
      <ha-card
        header="${Fa("panels.setup.weather_data.seasonal_title",e)}"
      >
        <div class="card-content">
          ${0===this._climate.length?W`<div class="weather-note">
                ${Fa("panels.zones.calendar.no_data",e)}
              </div>`:W`
                <div class="seasonal-table">
                  <div class="weather-header">
                    <span
                      >${Fa("panels.zones.calendar.month",e)}</span
                    >
                    <span>${Fa("panels.zones.calendar.et",e)}</span>
                    <span
                      >${Fa("panels.zones.calendar.precipitation",e)}</span
                    >
                    <span
                      >${Fa("panels.zones.calendar.avg_temp",e)}</span
                    >
                  </div>
                  ${this._climate.map(e=>W`
                      <div class="weather-row">
                        ...
                        >
                        <span
                          >${vn(e.estimated_et_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${vn(e.average_precipitation_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${vn(e.average_temperature_c,"temperature",this._metric)}</span
                        >
                      </div>
                    `)}
                </div>
    ...
    `}_renderForecast(){if(!this.hass)return W``;const e=this.hass.language,t=this._forecast;return W`
      <ha-card
        header="${Fa("panels.setup.weather_data.forecast_title",e)}"
      >
        <div class="card-content">
          ${t&&t.available&&0!==t.days.length?W`
              ...
              `:W`<div class="weather-note">
                ${Fa("panels.setup.weather_data.forecast_none",e)}
              </div>`}
        </div>
      </ha-card>
    `}_renderForecastDay(e,t){const i=(()=>{try{return new Intl.DateTimeFormat(t,{weekday:"short",month:"short",day:"numeric"}).format(new Date(e.date+"T00:00:00"))}catch(t){return e.date}})(),s=e=>{const t=mn(e,"temperature",this._metric);return t?`${Math.round(t.value)}°`:"-"};return W`
      <div class="forecast-day">
        ...
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-rainy"></ha-icon>${vn(e.precipitation,"precipitation",this._metric)}
        </div>
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-windy"></ha-icon>${vn(e.windspeed,"windspeed",this._metric)}
        </div>
      </div>
    `}_renderRecords(){if(!this.hass)return W``;const e=this.hass.language;return this._loading&&0===this._mappings.length?W`<ha-card
        header="${Fa("panels.mappings.weather-records.title",e)}"
      >
        <div class="card-content">
          <div class="loading-indicator">
            ${Fa("common.loading-messages.general",e)}
      ...
      >
        <div class="card-content">
          <div class="weather-note">
            ${Fa("panels.mappings.no_items",e)}
          </div>
        </div>
      </ha-card>`:W`${this._mappings.map(t=>this._renderMappingRecords(t,e))}`}_renderMappingRecords(e,t){const i=void 0!==e.id&&this._records.get(e.id)||[],s=`${Fa("panels.mappings.weather-records.title",t)} — ${e.name}`,a=e=>{try{return t=e,Number.isNaN(dn(t).getTime())?"-":function(e){const t=dn(e);return`${ln(t.getMonth()+1)}-${ln(t.getDate())} ${ln(t.getHours())}:${ln(t.getMinutes())}`}(e)}catch(e){return"-"}var t};return W`
      <ha-card header="${s}">
        <div class="card-content">
          ${0===i.length?W`<div class="weather-note">
                ${Fa("panels.mappings.weather-records.no-data",t)}
              </div>`:W`
                <div class="weather-table">
                  <div class="weather-header">
                    <span
                      >${Fa("panels.mappings.weather-records.timestamp",t)}</span
                    >
                    <span
                      >${Fa("panels.mappings.weather-records.temperature",t)}</span
                    >
                    <span
                      >${Fa("panels.mappings.weather-records.humidity",t)}</span
                    >
                    <span
                      >${Fa("panels.mappings.weather-records.dewpoint",t)}</span
                    >
                    <span
                      >${Fa("panels.mappings.weather-records.wind",t)}</span
                    >
                    <span
                      >${Fa("panels.mappings.weather-records.pressure",t)}</span
                    >
                    <span
                      >${Fa("panels.mappings.weather-records.precipitation",t)}</span
                    >
                    <span
                      >${Fa("panels.mappings.weather-records.retrieval-time",t)}</span
                    >
                  </div>
                  ${i.map(e=>W`
                      <div class="weather-row">
                        ...
                        <span
                          >${vn(e.temperature,"temperature",this._metric)}</span
                        >
                        <span>${(e=>null!=e?e.toFixed(1)+" %":"-")(e.humidity)}</span>
                        <span
                          >${vn(e.dewpoint,"temperature",this._metric)}</span
                        >
                        <span
                          >${vn(e.wind_speed,"windspeed",this._metric)}</span
                        >
                        <span
                          >${vn(e.pressure,"pressure",this._metric)}</span
                        >
                        <span
                          >${vn(e.precipitation,"precipitation",this._metric)}</span
                        >
    ...
    `}};t([me()],$o.prototype,"narrow",void 0),t([ve()],$o.prototype,"_forecast",void 0),t([ve()],$o.prototype,"_mappings",void 0),t([ve()],$o.prototype,"_records",void 0),t([ve()],$o.prototype,"_loading",void 0),t([ve()],$o.prototype,"_metric",void 0),t([ve()],$o.prototype,"_climate",void 0),$o=t([ue("irrigation-plus-view-weather-data")],$o);let xo=class extends(an(ce)){constructor(){super(...arguments),this._saving=!1}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch experimental config:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to refresh experimental config:",e)})},{type:be+"_config_updated"})]}async _fetchData(){if(this.hass)try{this.config=await Li(this.hass)}catch(e){console.error("Error fetching config:",e),Ja(this,this.hass,"common.errors.load_failed",e)}}async _toggle(e,t){if(this.hass&&this.config){this.config=Object.assign(Object.assign({},this.config),{[e]:t}),this._saving=!0;try{await Ri(this.hass,{[e]:t})}catch(e){console.error("Error saving experimental config:",e),Ja(this,this.hass,"common.errors.save_failed",e),await this._fetchData()}finally{this._saving=!1}}}render(){var e,t;return this.hass&&this.config?W`
      ${this._renderIntro()}
    ...
    `:W`<div class="loading-indicator">
      ...
      <ha-card header="${Fa(`${e}.title`,this.hass.language)}">
        <div class="card-content description-text">
          ${Fa(`${e}.description`,this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${Fa(`${e}.label`,this.hass.language)}</label>
            <ha-switch
              .checked="${t}"
          ...
          ${t?W`<div class="setting-row">
                <label>
                  ${Fa(`${e}.debounce_label`,this.hass.language)}
                </label>
                <input
                  type="number"
                  class="settings-input shortfield"
          ...
          <div class="setting-note">
            ${Fa(`${e}.note`,this.hass.language)}
          </div>
        </div>
      </ha-card>
    `}async _saveDebounce(e){if(!this.hass||!this.config)return;const t=Number.parseInt(e,10);if(Number.isNaN(t)||t<0)await this._fetchData();else{this.config=Object.assign(Object.assign({},this.config),{[ze]:t}),this._saving=!0;try{await Ri(this.hass,{[ze]:t})}catch(e){console.error("Error saving sensor debounce:",e),Ja(this,this.hass,"common.errors.save_failed",e),await this._fetchData()}finally{this._saving=!1}}}_renderIntro(){return this.hass?W`
      <div class="experimental-banner">
        <ha-icon icon="mdi:flask-outline"></ha-icon>
        <div>
          <div class="experimental-banner-title">
            ${Fa("panels.experimental.title",this.hass.language)}
          </div>
          <div class="experimental-banner-text">
            ${Fa("panels.experimental.warning",this.hass.language)}
          </div>
        </div>
      </div>
    `:W``}_renderToggleCard(e,t,i){if(!this.hass)return W``;const s=`panels.experimental.${e}`;return W`
      <ha-card header="${Fa(`${s}.title`,this.hass.language)}">
        <div class="card-content description-text">
          ${Fa(`${s}.description`,this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${Fa(`${s}.label`,this.hass.language)}</label>
            <ha-switch
              .checked="${i}"
              ?disabled="${this._saving}"
    ...
    `}};t([me()],xo.prototype,"narrow",void 0),t([ve()],xo.prototype,"config",void 0),t([ve()],xo.prototype,"_saving",void 0),xo=t([ue("irrigation-plus-view-experimental")],xo);var ko;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.Distributors="distributors",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}(ko||(ko={}));const zo={[ko.WeatherLocation]:"panels.setup.tabs.weather_location",[ko.Zones]:"panels.setup.tabs.my_zones",[ko.Distributors]:"panels.setup.tabs.distributors",[ko.WhenToWater]:"panels.setup.tabs.when_to_water",[ko.Advanced]:"panels.setup.tabs.advanced",[ko.Experimental]:"panels.setup.tabs.experimental",[ko.Help]:"panels.help.title"};let So=class extends(an(ce)){hassSubscribe(){return this._fetchConfig(),[this.hass.connection.subscribeMessage(()=>this._fetchConfig(),{type:be+"_config_updated"})]}async _fetchConfig(){if(this.hass)try{this.config=await Li(this.hass)}catch(e){console.error("Failed to fetch setup config:",e)}}get _distributorsEnabled(){var e,t;return null!==(t=null===(e=this.config)||void 0===e?void 0:e.distributors_enabled)&&void 0!==t&&t}get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(ko).includes(null!=t?t:"")?t:ko.WeatherLocation}_selectTab(e){Ka(0,en("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return W``;const e=this._distributorsEnabled,t=Object.values(ko).filter(t=>t!==ko.Distributors||e);let i=this._activeTab;return i!==ko.Distributors||e||(i=ko.WeatherLocation),W`
      <div class="setup-container">
        <nav class="setup-nav">
          ${t.map(e=>W`
              ...
              >
                ${Fa(zo[e],this.hass.language)}
              </button>
            `)}
          <button
            class="setup-nav-btn wizard-btn"
            @click="${this._openWizard}"
            title="${Fa("wizard.title",this.hass.language)}"
          >
            <ha-icon icon="mdi:creation"></ha-icon>
            ${Fa("wizard.open_button",this.hass.language)}
          </button>
        </nav>
        <div class="setup-content">${this._renderContent(i)}</div>
      </div>
    `}_renderContent(e){if(!this.hass)return W``;switch(e){case ko.WeatherLocation:return W`
          ...
          <irrigation-plus-view-weather-data
            ...
            .narrow="${this.narrow}"
          ></irrigation-plus-view-weather-data>
        `;case ko.Zones:return W`<irrigation-plus-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></irrigation-plus-view-zone-settings>`;case ko.Distributors:return W`<irrigation-plus-view-distributor-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></irrigation-plus-view-distributor-settings>`;case ko.WhenToWater:return W`
          <irrigation-plus-view-general
            .hass="${this.hass}"
            .narrow="${this.narrow}"
        ...
        `;case ko.Advanced:return W`
          ...
          <irrigation-plus-view-mappings
            ...
            .narrow="${this.narrow}"
          ></irrigation-plus-view-mappings>
        `;case ko.Experimental:return W`<irrigation-plus-view-experimental
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></irrigation-plus-view-experimental>`;case ko.Help:return this._renderHelp()}}_renderHelp(){return this.hass?W`
      <ha-card
        header="${Fa("panels.help.cards.how-to-get-help.title",this.hass.language)}"
      >
        <div class="card-content">
          ${Fa("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)}
          <a href="${"https://justchr.github.io/HAsmartirrigation/"}" target="_blank" rel="noopener noreferrer"
            >${Fa("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
          >.
          ${Fa("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
          <a
            href="https://community.home-assistant.io/t/irrigation-plus-save-water-by-precisely-watering-your-lawn-garden"
            target="_blank"
            rel="noopener noreferrer"
            >${Fa("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
          >
          ${Fa("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
          <a href="${"https://github.com/JustChr/HAsmartirrigation/issues"}" target="_blank" rel="noopener noreferrer"
            >${Fa("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
          >
          (${Fa("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
        </div>
      </ha-card>
    ...
    `}};var Ao;t([me({attribute:!1})],So.prototype,"hass",void 0),t([me({type:Boolean})],So.prototype,"narrow",void 0),t([me({attribute:!1})],So.prototype,"path",void 0),t([ve()],So.prototype,"config",void 0),So=t([ue("irrigation-plus-view-setup")],So),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done"}(Ao||(Ao={}));let Co=class extends ce{constructor(){super(...arguments),this._step=Ao.Welcome,this._saving=!1,this._error="",this._confirmClose=!1,this._siConfig=null,this._useWeather=!1,this._weatherService=Ce,this._apiKey="",this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=Ze,this._humiditySource=Ze,this._precipSource=Ze,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="",this._scheduleTime="06:00",this._scheduleCreated=!1,this._creatingSchedule=!1}async connectedCallback(){super.connectedCallback(),await this._loadInitialData()}async _loadInitialData(){var e;if(this.hass){try{const[t,i,s]=await Promise.all([Fi(this.hass),Xi(this.hass),Li(this.hass)]);this._availableModules=t,this._weatherConfig=i,this._siConfig=s,this._useWeather=i.use_weather_service,this._weatherService=null!==(e=i.weather_service)&&void 0!==e?e:Ce}catch(e){console.error("Wizard: failed to load initial data",e),this._error=Va(e)}this.requestUpdate()}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}))}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}))}async _next(){this._error="";try{switch(this._saving=!0,this._step){case Ao.Welcome:this._step=Ao.Weather;break;case Ao.Weather:await this._saveWeather(),this._step=Ao.Module;break;case Ao.Module:await this._saveModule(),this._step=Ao.Mapping;break;case Ao.Mapping:await this._saveMapping(),this._step=Ao.Zone;break;case Ao.Zone:await this._saveZone(),this._step=Ao.Done;break;case Ao.Done:this._close()}}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._saving=!1,this.requestUpdate()}}_back(){this._step>Ao.Welcome&&(this._step=this._step-1,this._error="")}get _canSkipCurrentStep(){return this._step===Ao.Weather}_skipStep(){this._canSkipCurrentStep&&this._step<Ao.Done&&(this._step=this._step+1,this._error="")}async _saveWeather(){await Ji(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null)}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0}catch(e){return}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await Zi(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>ji(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.")}async _saveMapping(){const e=this._useWeather?Ze:Ye,t={[je]:{[Xe]:this._tempSource},[Pe]:{[Xe]:this._humiditySource},[Le]:{[Xe]:this._precipSource}},i=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const s of i)t[s]={[Xe]:e};const s=await qi(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(s,()=>Wi(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.")}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await Ui(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:on.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0})}async _createDefaultSchedule(){var e,t;if(!this._scheduleCreated&&!this._creatingSchedule){this._error="",this._creatingSchedule=!0;try{const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";await Ki(this.hass,{name:Fa("wizard.steps.done.schedule_name",i)||"Daily",recurrence:"daily",enabled:!0,start_mode:ui,start_time:this._scheduleTime||"06:00",finish_mode:hi,action:"irrigate",zones:"all"}),this._scheduleCreated=!0}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._creatingSchedule=!1,this.requestUpdate()}}}render(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return W`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          <div class="wizard-header">
            <span class="wizard-title">${Fa("wizard.title",i)}</span>
            <button
              class="wizard-close-btn"
              @click="${this._close}"
              title="${Fa("wizard.close",i)}"
              aria-label="${Fa("wizard.close",i)}"
            >
              <ha-icon icon="mdi:close"></ha-icon>
            </button>
          </div>
          ${this._step!==Ao.Welcome&&this._step!==Ao.Done?W`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>Ao.Welcome&&this._step<Ao.Done?this._confirmClose=!0:this._close())}_renderStepper(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",s=[Fa("wizard.stepper.weather",i),Fa("wizard.stepper.module",i),Fa("wizard.stepper.mapping",i),Fa("wizard.stepper.zone",i)];return W`
      ${s.map((e,t)=>{const i=t+1,a=this._step===i,n=this._step>i;return W`
        ...
        `})}
    `}_renderStep(e){switch(this._step){case Ao.Welcome:return this._renderWelcome(e);case Ao.Weather:return this._renderWeather(e);case Ao.Module:return this._renderModule(e);case Ao.Mapping:return this._renderMapping(e);case Ao.Zone:return this._renderZone(e);case Ao.Done:return this._renderDone(e);default:return W``}}_renderFooter(e){return this._step===Ao.Done?W``:W`
      <div class="footer-left">
        ${this._step>Ao.Welcome?W`<button
              class="wizard-btn secondary"
              @click="${this._back}"
              ?disabled="${this._saving}"
            >
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Fa("common.saving-messages.saving",e):this._step===Ao.Welcome||this._step<Ao.Zone?Fa("wizard.next",e):Fa("wizard.finish",e)}
      </button>
    `}_renderWelcome(e){return W`
      <h2 class="step-title">
        ${Fa("wizard.steps.welcome.title",e)}
      </h2>
      <p class="step-desc">${Fa("wizard.steps.welcome.intro",e)}</p>
      <ul class="step-list">
        <li>① ${Fa("wizard.steps.welcome.step1_label",e)}</li>
        <li>② ${Fa("wizard.steps.welcome.step2_label",e)}</li>
        <li>③ ${Fa("wizard.steps.welcome.step3_label",e)}</li>
        <li>④ ${Fa("wizard.steps.welcome.step4_label",e)}</li>
      </ul>
      <p class="step-tip">${Fa("wizard.steps.welcome.tip",e)}</p>
    `}_renderWeather(e){return W`
      <h2 class="step-title">
        ${Fa("wizard.steps.weather.title",e)}
      </h2>
      <p class="step-desc">
        ${Fa("wizard.steps.weather.description",e)}
      </p>
    ...
    `}_renderModule(e){if(0===this._availableModules.length)return W`
        <h2 class="step-title">
          ${Fa("wizard.steps.module.title",e)}
        </h2>
        <p class="step-desc">
          ${Fa("wizard.steps.module.no_modules",e)}
        </p>
      `;const t=this._availableModules[this._selectedModuleIndex];return W`
      <h2 class="step-title">${Fa("wizard.steps.module.title",e)}</h2>
      <p class="step-desc">
        ${Fa("wizard.steps.module.description",e)}
      </p>

      <ip-field
        label="${Fa("wizard.steps.module.pick_label",e)}"
        required
      >
        <select
          class="wizard-input"
    ...
    `}_renderMapping(e){const t=[{value:Ze,label:Fa("wizard.steps.mapping.use_weather_service",e)},{value:"sensor",label:Fa("wizard.steps.mapping.use_sensor",e)},{value:"static",label:Fa("wizard.steps.mapping.use_static",e)},{value:Ye,label:Fa("wizard.steps.mapping.use_none",e)}],i=(i,s,a)=>W`
      <ip-field
        label="${Fa("wizard.steps.mapping.source_label",e)} ${i}"
      >
        <select
          class="wizard-input"
    ...
    `;return W`
      <h2 class="step-title">
        ${Fa("wizard.steps.mapping.title",e)}
      </h2>
      <p class="step-desc">
        ${Fa("wizard.steps.mapping.description",e)}
      </p>

      <ip-field
        label="${Fa("wizard.steps.mapping.name_label",e)}"
        required
      >
        <input
          type="text"
      ...
      ${i(Fa("panels.mappings.cards.mapping.items.temperature",e)||"Temperature",this._tempSource,e=>{this._tempSource=e,this.requestUpdate()})}
      ${i(Fa("panels.mappings.cards.mapping.items.humidity",e)||"Humidity",this._humiditySource,e=>{this._humiditySource=e,this.requestUpdate()})}
      ${i(Fa("panels.mappings.cards.mapping.items.precipitation",e)||"Precipitation",this._precipSource,e=>{this._precipSource=e,this.requestUpdate()})}

      <p class="step-tip">
        ${Fa("wizard.steps.mapping.description",e)}
      </p>
    `}_renderZone(e){var t;const i="imperial"!==(null===(t=this._siConfig)||void 0===t?void 0:t.units);return W`
      <h2 class="step-title">${Fa("wizard.steps.zone.title",e)}</h2>
      <p class="step-desc">
        ${Fa("wizard.steps.zone.description",e)}
      </p>
    ...
    `}_renderDone(e){return W`
      <div class="done-wrapper">
        ...
        <h2 class="step-title">${Fa("wizard.steps.done.title",e)}</h2>
        <p class="step-desc">
          ${Fa("wizard.steps.done.description",e)}
        </p>
        <ul class="step-list">
          <li>${Fa("wizard.steps.done.tip1",e)}</li>
          <li>${Fa("wizard.steps.done.tip2",e)}</li>
          <li>${Fa("wizard.steps.done.tip3",e)}</li>
        </ul>
        ...
        <div class="schedule-offer">
          ${this._scheduleCreated?W`
                <div class="schedule-created">
                  ...
                  <span
                    >${Fa("wizard.steps.done.schedule_created",e)}</span
                  >
                </div>
              `:W`
                <p class="schedule-offer-title">
                  ${Fa("wizard.steps.done.schedule_title",e)}
                </p>
                <p class="schedule-offer-desc">
                  ${Fa("wizard.steps.done.schedule_desc",e)}
                </p>
                <div class="schedule-offer-row">
                  ...
                  >
                    ${this._creatingSchedule?Fa("common.saving-messages.saving",e):Fa("wizard.steps.done.schedule_create",e)}
                  </button>
                </div>
              `}
        </div>
        ...
        <div class="done-actions">
          ...
          >
            ${Fa("wizard.steps.done.go_zones",e)}
          </button>
          <button
            class="wizard-btn secondary"
            @click="${()=>{this._close(),this._navigate("setup")}}"
          >
            ${Fa("wizard.steps.done.go_setup",e)}
          </button>
        </div>
      </div>
    `}static get styles(){return r`
    ...
    `}};t([me({attribute:!1})],Co.prototype,"hass",void 0),t([ve()],Co.prototype,"_step",void 0),t([ve()],Co.prototype,"_saving",void 0),t([ve()],Co.prototype,"_error",void 0),t([ve()],Co.prototype,"_confirmClose",void 0),t([ve()],Co.prototype,"_siConfig",void 0),t([ve()],Co.prototype,"_useWeather",void 0),t([ve()],Co.prototype,"_weatherService",void 0),t([ve()],Co.prototype,"_apiKey",void 0),t([ve()],Co.prototype,"_weatherConfig",void 0),t([ve()],Co.prototype,"_availableModules",void 0),t([ve()],Co.prototype,"_selectedModuleIndex",void 0),t([ve()],Co.prototype,"_moduleConfig",void 0),t([ve()],Co.prototype,"_mappingName",void 0),t([ve()],Co.prototype,"_tempSource",void 0),t([ve()],Co.prototype,"_humiditySource",void 0),t([ve()],Co.prototype,"_precipSource",void 0),t([ve()],Co.prototype,"_zoneName",void 0),t([ve()],Co.prototype,"_zoneSize",void 0),t([ve()],Co.prototype,"_zoneThroughput",void 0),t([ve()],Co.prototype,"_zoneEntity",void 0),t([ve()],Co.prototype,"_scheduleTime",void 0),t([ve()],Co.prototype,"_scheduleCreated",void 0),t([ve()],Co.prototype,"_creatingSchedule",void 0),Co=t([ue("ip-setup-wizard")],Co);const Eo=rn;var To;!function(e){e.Zones="zones",e.History="history",e.Setup="setup"}(To||(To={})),e.SmartIrrigationPanel=class extends ce{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}async firstUpdated(){const e=Qa().page;Object.values(To).includes(e)||Ka(0,en(To.Zones)),window.addEventListener("location-changed",()=>{if(window.location.pathname.split("/")[1]!==be)return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())}),is().then(()=>{this._scheduleUpdate()}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}),this.hass&&Li(this.hass).then(e=>{this._config=e,this._scheduleUpdate()}).catch(e=>{console.error("Failed to fetch config for version display:",e)})}_ensureLanguage(){this.hass&&!Ua(this.hass.language)&&function(e){const t=Ba(e);return Ua(e)?Promise.resolve():(Ra[t]||(Ra[t]=fetch(`${ye}/${t}.json?v=${_e}`).then(e=>e.ok?e.json():Promise.reject(e.status)).then(e=>{La[t]=e}).catch(()=>{La[t]=La.en})),Ra[t])}(this.hass.language).then(()=>this.requestUpdate())}render(){var e,t;if(this.hass&&!Ua(this.hass.language))return this._ensureLanguage(),W``;const i=Qa(),s=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return W`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
            .narrow=${this.narrow}
          ></ha-menu-button>
          <div class="main-title">${Fa("title",this.hass.language)}</div>
        ...
        ${s&&a?W`
              <ha-tab-group @wa-tab-show=${this.handlePageSelected}>
                ${Object.values(To).map(e=>W`
                    <ha-tab-group-tab
                      slot="nav"
                      panel="${e}"
                      .active=${i.page===e}
                    >
                      ${Fa(`panels.${e}.title`,this.hass.language)}
                    </ha-tab-group-tab>
                  `)}
              </ha-tab-group>
            `:W`
    ...
    `}getView(e){switch(e.page){case"zones":default:return W`
        ...
        `;case"setup":return W`
          <irrigation-plus-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0}}"
          ></irrigation-plus-view-setup>
        `}}navigateToPage(e){if(e!==Qa().page){const t=en(e);Ka(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==Qa().page){const e=en(t);Ka(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[Eo,r`
        :host {
          color: var(--primary-text-color);
      ...
      `]}},t([me({attribute:!1})],e.SmartIrrigationPanel.prototype,"hass",void 0),t([me({type:Boolean,reflect:!0})],e.SmartIrrigationPanel.prototype,"narrow",void 0),t([ve()],e.SmartIrrigationPanel.prototype,"_wizardOpen",void 0),t([ve()],e.SmartIrrigationPanel.prototype,"_config",void 0),e.SmartIrrigationPanel=t([ue("irrigation-plus")],e.SmartIrrigationPanel);let Oo=class extends ce{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params=void 0}render(){return this._params?W`
      <ha-dialog
        open
        .heading=${!0}
    ...
    `}};t([me({attribute:!1})],Oo.prototype,"hass",void 0),t([ve()],Oo.prototype,"_params",void 0),Oo=t([ue("ip-error-dialog")],Oo);var Do=Object.freeze({__proto__:null,get ErrorDialog(){return Oo}})}({});

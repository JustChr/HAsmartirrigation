...
`;const dn=e=>String(e).padStart(2,"0");function cn(e){return e instanceof Date?e:new Date(e)}function hn(e){const t=cn(e);return`${dn(t.getHours())}:${dn(t.getMinutes())}`}function un(e){const t=cn(e);return`${t.getFullYear()}-${dn(t.getMonth()+1)}-${dn(t.getDate())} ${dn(t.getHours())}:${dn(t.getMinutes())}`}function pn(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class gn extends(nn(ce)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){ss().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const i=Object.values(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).some(e=>!0!==e.queued&&!0!==e.paused);i&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):i||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:be+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[i,s,a,n]=await Promise.all([Ri(this.hass),Ui(this.hass),(t=this.hass,t.callWS({type:be+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),Yi(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=i,this.zones=s,this._outlook=a,this._distributors=n,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),Qa(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",be+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),Qa(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",be+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),Qa(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const i="all"===t,s=i?void 0:this.zones.find(e=>{var i;return(null===(i=e.id)||void 0===i?void 0:i.toString())===t}),a=i?`(${this._linkedZoneCount})`:`: ${null!==(e=null==s?void 0:s.name)&&void 0!==e?e:t}`;try{await(n=this.hass,o=i?void 0:t,n.callWS(Object.assign({type:be+"/irrigate_now"},void 0!==o?{zone_id:o}:{}))),Ja(this,`${Wa("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${a}`)}catch(e){const t=Ya(e);console.error("irrigate_now failed",e),Ja(this,`${Wa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var n,o}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const i=new Date(t);return i.getTime()>Date.now()?i:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:be+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),Qa(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:be+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),Qa(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,i;const s=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(i=this._runMinutes[s])&&void 0!==i?i:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const i=this._zoneDistributor(e);return!!i&&Object.keys(null!==(t=i.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var i,s,a;if(t>0)try{await(i=this.hass,s=e.id.toString(),a=t,i.callWS({type:be+"/run_zone",zone_id:s,duration:a})),Ja(this,`${Wa("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=Ya(e);console.error("run_zone failed",e),Ja(this,`${Wa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===i?void 0:i[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,i;if(this.hass&&void 0!==e.id)try{await(t=this.hass,i=e.id.toString(),t.callWS({type:be+"/stop_zone",zone_id:i})),Ja(this,`${Wa("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=Ya(e);console.error("stop_zone failed",e),Ja(this,`${Wa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var i,s;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,s=t.id.toString(),i.callApi("POST",be+"/zones",{id:s,calculate:!0,override_cache:!0})).catch(e=>{const t=Ya(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var i,s;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,s=t.id.toString(),i.callApi("POST",be+"/zones",{id:s,update:!0})).catch(e=>{const t=Ya(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;Va(0,t?tn("setup","zones",t):tn("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,i,s;const a=null!==(t=e.duration)&&void 0!==t?t:0,n=Number(null!==(i=e.bucket_threshold)&&void 0!==i?i:0),o=this._zoneEstimate(e),r=o&&o.available&&null!=o.live_deficit?o.live_deficit:Number(null!==(s=e.bucket)&&void 0!==s?s:0);return a>0&&r<n}_zoneRunDuration(e){var t,i;const s=this._zoneEstimate(e);return(null===(t=this.config)||void 0===t?void 0:t.live_estimate_enabled)&&s&&s.available&&null!=s.live_deficit&&null!=s.live_duration?{seconds:s.live_duration,live:!0}:{seconds:null!==(i=e.duration)&&void 0!==i?i:0,live:!1}}_zoneWillWater(e){var t;const i=this._zoneRunDuration(e);if(!i.live)return this._zoneHasDeficit(e);const s=Number(null!==(t=e.bucket_threshold)&&void 0!==t?t:0);return this._zoneEstimate(e).live_deficit<s&&i.seconds>0}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,i=new Date(e),s=hn(i),a=new Date;return pn(i,a)?`${Wa("panels.zones.outlook.today",t)} ${s}`:pn(i,function(e,t){const i=new Date(e.getTime());return i.setDate(i.getDate()+t),i}(a,1))?`${Wa("panels.zones.outlook.tomorrow",t)} ${s}`:function(e,t){const i=cn(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(i)} ${hn(i)}`}(i,t)}_renderEstimatedTag(e){if(!this.hass||!e.estimated)return Z``;const t=this.hass.language;return Z`<span
    ...
    `}_openSchedules(){Va(0,tn("setup","when-to-water"))}_runActionLabel(e){return Wa(`panels.zones.outlook.actions.${e.action}`,this.hass.language)}_runTargetsLabel(e){const t=this.hass.language;if("all"===e.zones)return Wa("panels.zones.outlook.targets_all",t);const i=Array.isArray(e.zones)?e.zones.length:0;return Wa("panels.zones.outlook.targets_zones",t,"{count}",String(i))}_renderOutlookBanner(){if(!this.hass||!this._outlook)return Z``;const e=this.hass.language,t=this._nextIrrigateRun,i=this._triggeredGuards,s=this._outlook.last_skip_evaluation;return t&&t.next_run_utc?Z`
    ...
    `}_renderLastRunLine(e){const t=this.hass.language,i=function(e,t){const i=cn(e).getTime()-Date.now(),s=new Intl.RelativeTimeFormat(t,{numeric:"auto"}),a=Math.round(i/1e3);if(Math.abs(a)<60)return s.format(a,"second");const n=Math.round(a/60);if(Math.abs(n)<60)return s.format(n,"minute");const o=Math.round(n/60);if(Math.abs(o)<24)return s.format(o,"hour");const r=Math.round(o/24);if(Math.abs(r)<30)return s.format(r,"day");const l=Math.round(r/30);return Math.abs(l)<12?s.format(l,"month"):s.format(Math.round(l/12),"year")}(e.timestamp,t),s=e.checks.filter(e=>e.enabled&&e.would_skip).map(e=>this._guardLabel(e).toLowerCase()).join(", "),a=e.would_skip?`${Wa("panels.zones.outlook.last_run_skipped",t)}${s?` (${s})`:""}`:Wa("panels.zones.outlook.last_run_ran",t);return Z`
    ...
    `}_renderZoneDecision(e){if(!this.hass)return Z``;const t=this.hass.language;let i,s,a,n;if(e.state===rn.Disabled)i=Wa("panels.zones.status.decision_disabled",t),s="neutral",a="mdi:power-off";else if(e.last_calculated)if(this._zoneWillWater(e)){const o=Xa(this._zoneRunDuration(e).seconds),r=this._triggeredGuards,l=this._nextIrrigateRunForZone(e);r.length>0?(i=Wa("panels.zones.status.decision_water_skip",t,"{duration}",o,"{reason}",this._guardLabel(r[0]).toLowerCase()),s="skip",a="mdi:weather-rainy"):l&&l.next_run_utc?(i=Wa("panels.zones.status.decision_water_at",t,"{duration}",o,"{time}",this._formatRunTime(l.next_run_utc)),s="water",a="mdi:water",n=l):(i=Wa("panels.zones.status.decision_water_no_schedule",t,"{duration}",o),s="water",a="mdi:water-alert")}else i=Wa("panels.zones.status.decision_no_water",t),s="ok",a="mdi:check-circle-outline";else i=Wa("panels.zones.status.decision_unknown",t),s="unknown",a="mdi:help-circle-outline";return Z`
      <div class="zone-decision ${s}">
        <ha-icon icon="${a}"></ha-icon>
        <span>${i}</span>
        ${n?this._renderEstimatedTag(n):""}
      </div>
    `}_zoneEstimate(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_estimates)||void 0===i?void 0:i[String(e.id)]}_zoneFault(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_faults)||void 0===i?void 0:i[String(e.id)]}_renderZoneFault(e){if(!this.hass)return Z``;const t=this._zoneFault(e);if(!t)return Z``;const i=this.hass.language,s=Wa(`panels.zones.fault.${t.reason}`,i)||Wa("panels.zones.fault.generic",i),a=t.timestamp?un(t.timestamp):"";return Z`
      <div class="zone-fault" title="${a}">
        <ha-icon icon="mdi:alert-circle"></ha-icon>
        <span>
          <strong>${Wa("panels.zones.fault.title",i)}</strong>
          — ${s}
        </span>
      </div>
    `}_zoneSkip(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_skips)||void 0===i?void 0:i[String(e.id)]}_renderZoneSkip(e){if(!this.hass)return Z``;const t=this._zoneSkip(e);if(!t)return Z``;const i=this.hass.language,s=Wa("panels.zones.skip.soil_moisture",i,"{observed}",String(t.observed),"{threshold}",String(t.threshold)),a=t.timestamp?un(t.timestamp):"";return Z`
      <div class="zone-skip" title="${a}">
        <ha-icon icon="mdi:water-off"></ha-icon>
        <span>
          <strong>${Wa("panels.zones.skip.title",i)}</strong>
          — ${s}
        </span>
      </div>
    `}_durationClamped(e){var t,i;if(e.state!==rn.Automatic)return!1;const s=e.maximum_duration;if(null==s||s<0)return!1;const a=null!==(t=e.duration)&&void 0!==t?t:0;return!(a<=0)&&a-(null!==(i=e.lead_time)&&void 0!==i?i:0)>=s}_renderDurationClamped(e){var t;if(!this.hass||!this._durationClamped(e))return Z``;const i=this.hass.language,s=Wa("panels.zones.clamped.detail",i,"{maximum}",Xa(null!==(t=e.maximum_duration)&&void 0!==t?t:0));return Z`
      <div class="zone-clamped" title="${s}">
        <ha-icon icon="mdi:timer-alert-outline"></ha-icon>
        <span>
          <strong>${Wa("panels.zones.clamped.title",i)}</strong>
          <ha-icon
            class="clamped-hint"
            icon="mdi:information-outline"
          ></ha-icon>
    ...
    `}_renderZoneEstimate(e){if(!this.hass)return Z``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return Z``;const i=this.hass.language,s=Ga(this.config,wt),a=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",n=Wa(`panels.zones.status.estimate_method.${"proxy"===t.method||"hourly_sensor"===t.method?t.method:"hourly"}`,i)+(t.as_of?` · ${hn(t.as_of)}`:"");return Z`
      <span class="status-sep">·</span>
      <span class="zone-estimate" title="${n}">
        ${Wa("panels.zones.status.estimate_now",i)}
        <strong style="color: ${a}"
          >≈ ${t.live_deficit.toFixed(2)} ${s}</strong
        >
        <span class="estimate-tag"
          >${Wa("panels.zones.status.estimate_tag",i)}</span
        >
      </span>
    ...
    `}renderZone(e,t){var i;if(!this.hass)return Z``;const s=Number(null!==(i=e.bucket)&&void 0!==i?i:0),a=s<0?"var(--warning-color)":"var(--success-color)",n=e.state===rn.Automatic?"state-automatic":e.state===rn.Manual?"state-manual":"state-disabled",o=e.last_calculated?un(e.last_calculated):Wa("panels.zones.status.never",this.hass.language);return Z`
      <ha-card>
    ...
    `}_renderRunZoneControl(e){if(!this.hass||"none"===this.actionsMode||!this._canActuate(e)||void 0===e.id)return Z``;const t=this.hass.language,i=String(e.id),s=this._activeRun(e);if(s){const i=!0===s.queued,a=!i&&!0===s.paused,n=i||a?null:this._runSecondsLeft(s);return Z`
        <div
        ...
        >
          <span class="run-zone-countdown">
            ...
            ${i?Wa("panels.zones.stop_zone.queued",t):a?Wa("panels.zones.stop_zone.paused",t):null===n?Wa("panels.zones.stop_zone.watering",t):this._formatCountdown(n)}
          </span>
          <button
    ...
    `}}t([me()],gn.prototype,"config",void 0),t([me({type:Boolean})],gn.prototype,"hideSettingsLinks",void 0),t([me({attribute:!1})],gn.prototype,"actionsMode",void 0),t([me({type:Array})],gn.prototype,"zones",void 0),t([ve()],gn.prototype,"_outlook",void 0),t([ve()],gn.prototype,"_distributors",void 0),t([me({type:Boolean})],gn.prototype,"isLoading",void 0),t([me({type:Boolean})],gn.prototype,"isSaving",void 0),t([ve()],gn.prototype,"_operationError",void 0),t([ve()],gn.prototype,"_confirmIrrigate",void 0),t([ve()],gn.prototype,"_skipDetailsOpen",void 0),t([ve()],gn.prototype,"_runMinutes",void 0),t([ve()],gn.prototype,"_now",void 0),customElements.get("irrigation-plus-view-zones")||customElements.define("irrigation-plus-view-zones",gn);const mn=e=>9*e/5+32;function vn(e,t,i){if(null==e||Number.isNaN(e))return null;switch(t){case"temperature":return i?{value:e,unit:"°C"}:{value:mn(e),unit:"°F"};case"precipitation":return i?{value:e,unit:lt}:{value:(n=e,n/25.4),unit:dt};case"windspeed":return i?{value:e,unit:ut}:{value:(a=e,2.2369362920544*a),unit:ht};case"pressure":return i?{value:e,unit:"hPa"}:{value:(s=e,.0295299830714*s),unit:ct}}var s,a,n}function fn(e,t,i,s){const a=vn(e,t,i);if(!a)return"-";const n=function(e,t){return"pressure"===e?t?0:2:"precipitation"===e?t?1:2:1}(t,i);return`${a.value.toFixed(n)} ${a.unit}`}function _n(e,t){return null==e||Number.isNaN(e)?"-":t?`${e.toFixed(0)} L`:`${(e=>.264172052*e)(e).toFixed(1)} gal`}let bn=class extends ce{render(){var e,t,i;if(!this.hass||!this.zone)return Z``;const s=(null===(e=this.config)||void 0===e?void 0:e.units)===Ne,a=null!==(t=this.zone.run_log)&&void 0!==t?t:[],n=this.hass.language;return Z`
      <div class="history-usage">
        ...
        <span class="history-usage-value"
          >${_n(null!==(i=this.zone.water_used_total)&&void 0!==i?i:0,s)}</span
        >
      </div>
      ${0===a.length?Z`<div class="weather-note">
          ...
          `}
    `}_renderRow(e,t){const i=this.hass.language,s=Wa(`panels.zones.history.results.${e.result}`,i);let a="";return e.detail&&(a="skipped"===e.result?e.detail.split(",").map(e=>Wa(`panels.zones.outlook.checks.${e}`,i)||e).join(", "):/^[A-Za-z0-9_-]+$/.test(e.detail)&&Wa(`panels.zones.fault.${e.detail}`,i)||e.detail),Z`
      <tr>
        <td>${un(e.ts)}</td>
        <td>
        ...
        <td class="history-detail">${hs(a)}</td>
      </tr>
    `}static get styles(){return[ln,r`
      ...
      `]}};t([me({attribute:!1})],bn.prototype,"hass",void 0),t([me({attribute:!1})],bn.prototype,"zone",void 0),t([me({attribute:!1})],bn.prototype,"config",void 0),bn=t([ue("ip-zone-history")],bn);let yn=class extends(nn(ce)){constructor(){super(...arguments),this._zones=[],this._isLoading=!0,this._loadFailed=!1,this._initialLoadDone=!1}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:be+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{const[e,t]=await Promise.all([Ri(this.hass),Ui(this.hass)]);this._config=e,this._zones=t,this._initialLoadDone=!0,this._loadFailed=!1}catch(t){console.error("Error fetching data:",t),Qa(this,this.hass,"common.errors.load_failed",t),e&&(this._loadFailed=!0)}finally{e&&(this._isLoading=!1)}}get _linkedZoneId(){var e,t;const i=null===(t=null===(e=this.path)||void 0===e?void 0:e.params)||void 0===t?void 0:t.zone;return null!=i&&""!==i?Number(i):null}_effectiveZone(){var e,t;if(!this._zones.length)return;const i=e=>null==e?void 0:this._zones.find(t=>t.id===e);return null!==(t=null!==(e=i(this._selectedZoneId))&&void 0!==e?e:i(this._linkedZoneId))&&void 0!==t?t:this._zones[0]}render(){if(!this.hass)return Z``;const e=this.hass.language;if(this._isLoading)return Z`
...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
const wn={},$n=ls(class extends ds{constructor(e){if(super(e),e.type!==os&&e.type!==as&&e.type!==rs)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===G||t===K)return t;const i=e.element,s=e.name;if(e.type===os){if(t===i[s])return G}else if(e.type===rs){if(!!t===i.hasAttribute(s))return G}else if(e.type===as&&i.getAttribute(s)===t+"")return G;return((e,t=wn)=>{e._$AH=t;
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
    ...
    `}};t([me()],xn.prototype,"label",void 0),t([me()],xn.prototype,"unit",void 0),t([me()],xn.prototype,"help",void 0),t([me({type:Boolean})],xn.prototype,"required",void 0),t([ve()],xn.prototype,"_helpOpen",void 0),xn=t([ue("ip-field")],xn);let kn=class extends ce{constructor(){super(...arguments),this.useWeather=!1,this.service=Ee,this.apiKey="",this.weatherConfig=null,this._testing=!1,this._testResult=null,this._testResultTimer=null}disconnectedCallback(){super.disconnectedCallback(),this._testResultTimer&&(clearTimeout(this._testResultTimer),this._testResultTimer=null)}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{value:t},bubbles:!0,composed:!0}))}get _noApiKeyServices(){var e,t;return null!==(t=null===(e=this.weatherConfig)||void 0===e?void 0:e.no_api_key_services)&&void 0!==t?t:[Ee]}get _needsKey(){return this.useWeather&&!!this.service&&!this._noApiKeyServices.includes(this.service)}get _hasStoredKey(){const e=this.weatherConfig;return this.service===Ae?!!(null==e?void 0:e.has_owm_api_key):this.service===Ce?!!(null==e?void 0:e.has_pw_api_key):this.service===Te&&!!(null==e?void 0:e.has_met_api_key)}async _testApiKey(){if(this.hass&&!this._testing){this._testing=!0,this._testResult=null,this._testResultTimer&&(clearTimeout(this._testResultTimer),this._testResultTimer=null);try{this._testResult=await(e=this.hass,t=this.service,i=this.apiKey||null,e.callWS({type:be+"/weather_config_test",weather_service:null!=t?t:null,api_key:null!=i?i:null})),this._testResultTimer=window.setTimeout(()=>{this._testResult=null,this._testResultTimer=null},12e3)}catch(e){this._testResult={success:!1,error:"unknown"}}finally{this._testing=!1}var e,t,i}}render(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return Z`
      <ip-field
        label="${Wa("weather_service_config.enabled_label",i)}"
      >
        <ha-switch
    ...
    `}_renderKeyField(e){var t;const i=this._hasStoredKey;return Z`
      ...
      >
        <span class="api-badge ${i?"configured":"missing"}"
          >${Wa(i?"weather_service_config.api_key_configured":"weather_service_config.api_key_not_configured",e)}</span
        >
        <div class="api-row">
          <input
            type="password"
        ...
        >
          ${xe.map(i=>Z`
              <option value="${i}" ?selected="${t===i}">
                ${Wa(`panels.general.cards.automatic-duration-calculation.modes.${i}`,e)}
              </option>
            `)}
        </select>
      </div>
    ...
    `:Z``}_renderZoneSequencingCard(){var e,t;if(!this.hass||!this.config||!this.data)return Z``;const i=(this.config.zone_sequencing||Kt)===Vt,s=this._zones.some(e=>e.watering_mode===Ii);return Z`
      <ha-card
    ...
    `}_renderBatchCard(){var e;if(!this.hass||!this.config)return Z``;const t=!!this.config.batch_run_service,i=this.config.batch_paused_entity;return Z`
          ...
          ${t?Z`
                <div class="setting-row">
                  ...
                  <ha-entity-picker
                    ...
                    .includeDomains="${["script"]}"
                    allow-custom-entity
                    @value-changed="${e=>this.handleConfigChange({[ei]:e.detail.value||null})}"
                  ></ha-entity-picker>
                </div>
                <div class="description-text">
                ...
                ${i?Z`
                      <div class="setting-row">
                        ...
                        <input
                          ...
                          @change="${e=>{const t=parseInt(e.target.value,10);isNaN(t)||this.handleConfigChange({[ii]:Math.max(0,t)})}}"
                        />
                        <span class="unit-label">
                      ...
                      <div class="setting-row">
                        ...
                        <ha-entity-picker
                          ...
                          .includeDomains="${["script"]}"
                          allow-custom-entity
                          @value-changed="${e=>this.handleConfigChange({[si]:e.detail.value||null})}"
                        ></ha-entity-picker>
                      </div>
                      <div class="description-text">
          ...
          ${this.config.master_entity?Z`
                ...
                ${i?Z`
                      <div class="setting-row">
                        ...
                        <input
                          ...
                          @input="${e=>{const t=parseFloat(e.target.value);isNaN(t)||this.handleConfigChange({[oi]:t})}}"
                        />
                        <span class="unit-label">
                ...
                <div class="setting-row">
                  ...
                  <input
                    ...
                    @input="${e=>{const t=parseInt(e.target.value,10);isNaN(t)||this.handleConfigChange({[ai]:t})}}"
                  />
                  <span class="unit-label">
                    ${Wa("master.seconds_unit",this.hass.language)}
                  </span>
    ...
    `}};t([me()],zn.prototype,"narrow",void 0),t([me()],zn.prototype,"path",void 0),t([me()],zn.prototype,"section",void 0),t([me()],zn.prototype,"data",void 0),t([me()],zn.prototype,"config",void 0),t([me({type:Boolean})],zn.prototype,"isLoading",void 0),t([me({type:Boolean})],zn.prototype,"isSaving",void 0),t([me()],zn.prototype,"_weatherConfig",void 0),t([me()],zn.prototype,"_weatherService",void 0),t([me({type:Boolean})],zn.prototype,"_useWeatherService",void 0),t([me()],zn.prototype,"_newApiKey",void 0),t([me({type:Boolean})],zn.prototype,"_weatherSaving",void 0),t([ve()],zn.prototype,"_coords",void 0),t([ve()],zn.prototype,"_coordsEnabled",void 0),t([ve()],zn.prototype,"_coordsLat",void 0),t([ve()],zn.prototype,"_coordsLon",void 0),t([ve()],zn.prototype,"_coordsElev",void 0),t([ve()],zn.prototype,"_coordsSaving",void 0),t([ve()],zn.prototype,"_zones",void 0),t([ve()],zn.prototype,"_saveStatus",void 0),zn=t([ue("irrigation-plus-view-general")],zn);let Sn=class extends ce{constructor(){super(...arguments),this.metric=!0,this.name="",this.size="",this.throughput="",this.linkedEntity="",this.showEntity=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{value:t},bubbles:!0,composed:!0}))}render(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",s=this.metric?"m²":at,a=this.metric?nt:ot;return Z`
      <ip-field label="${Wa("panels.zones.labels.name",i)}" required>
        <input
          type="text"
          class="si-input"
          .value="${this.name}"
      ...
      <ip-field
        label="${Wa("panels.zones.labels.size",i)}"
        unit="${s}"
        help="${Wa("field_help.zone_size",i)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      <ip-field
        label="${Wa("panels.zones.labels.throughput",i)}"
        unit="${a}"
        help="${Wa("field_help.zone_throughput",i)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      ${this.showEntity?Z`
            <ip-field
              label="${Wa("panels.zones.labels.linked_entity",i)}"
              help="${Wa("field_help.zone_linked_entity",i)}"
            >
              <ha-entity-picker
                .hass="${this.hass}"
    ...
    `}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await ji(this.hass,e)}_renderModuleOptions(e){if(!this.hass)return Z``;const t=null!=e?String(e):"";return Z`
              ...
              <div class="card-content zone-settings">
                <ha-settings-row>
                  ...
                  <input
                    ...
                    class="settings-input"
                    .value="${e.name}"
                    @input="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[mt]:i.target.value}))}"
                  />
                </ha-settings-row>
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${$n(null!==(s=Object.keys(Zt).find(t=>Zt[t]===e.drainage_rate))&&void 0!==s?s:"custom")}"
                    @change="${i=>{const s=i.target.value;"custom"!==s&&void 0!==Zt[s]&&this.handleEditZone(t,Object.assign(Object.assign({},e),{[At]:Zt[s]}))}}"
                  >
                    <option
                      value="custom"
                ...
                <ha-settings-row>
                  ...
                  <input
                    ...
                    @input="${i=>{const s=Math.round(100*i.target.valueAsNumber)/100;isNaN(s)||this.handleEditZone(t,Object.assign(Object.assign({},e),{[At]:s}))}}"
                  />
                </ha-settings-row>
                ...
                <ha-settings-row>
                  ...
                  <select
                    ...
                    @change="${i=>{const s=i.target.value,a={[Et]:s};"custom"!==s&&void 0!==Wt[s]&&(a.kc=Wt[s]),this.handleEditZone(t,Object.assign(Object.assign({},e),a))}}"
                  >
                    <option
                      value="custom"
                ...
                <ha-settings-row>
                  ...
                  <input
                    ...
                    @input="${i=>{const s=Math.round(100*i.target.valueAsNumber)/100;isNaN(s)||this.handleEditZone(t,Object.assign(Object.assign({},e),{[Ct]:s,[Et]:"custom"}))}}"
                  />
                </ha-settings-row>
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${$n(e.state)}"
                    @change="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[_t]:i.target.value,[bt]:0}))}"
                  >
                    <option
                      value="${rn.Automatic}"
                ...
                <ha-settings-row>
                  ...
                  <select
                    ...
                    @change="${i=>{const s=i.target.value;this.handleEditZone(t,Object.assign(Object.assign({},e),{[yt]:s?parseInt(s):void 0}))}}"
                  >
                ...
                <ha-settings-row>
                  ...
                  <select
                    ...
                    @change="${i=>{const s=i.target.value;this.handleEditZone(t,Object.assign(Object.assign({},e),{[xt]:s?parseInt(s):void 0}))}}"
                  >
                      ...
                      ${"service"===e.watering_mode?Z`
                            ...
                            <ha-settings-row>
                              ...
                              <select
                                ...
                                @change="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Pt]:i.target.value}))}"
                              >
                                <option
                                  value="seconds"
                            ...
                            ${this._showLatencyMargin(e)?Z`
                                  <ha-settings-row>
                                    ...
                                    <input
                                      ...
                                      @input="${i=>{const s=this._clampLatencyMargin(i.target.valueAsNumber);null!==s&&this.handleEditZone(t,Object.assign(Object.assign({},e),{[Bt]:s}))}}"
                                    />
                                  </ha-settings-row>
                                `:""}
                            ${(null===(g=this.config)||void 0===g?void 0:g.observed_watering_enabled)?Z`
                                  <ha-settings-row>
                                    ...
                                    <ha-entity-picker
                                      ...
                                      allow-custom-entity
                                      @value-changed="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Ut]:i.detail.value||null}))}"
                                    ></ha-entity-picker>
                                  </ha-settings-row>
                                `:""}
                          `:""}
                      ${e.watering_mode===Ni?Z`
                            <ha-settings-row>
                              <span slot="heading"
                ...
                <ha-settings-row>
                  ...
                  <ha-entity-picker
                    ...
                    allow-custom-entity
                    @value-changed="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[jt]:i.detail.value||null}))}"
                  ></ha-entity-picker>
                </ha-settings-row>
                ...
                <ha-settings-row>
                  ...
                  <input
                    ...
                    @input="${i=>{const s=i.target.value,a=""===s?null:Number(s);this.handleEditZone(t,Object.assign(Object.assign({},e),{[Ft]:null===a||isNaN(a)?null:a}))}}"
                  />
                </ha-settings-row>
                      ...
                      ${this._flowSensorIsTotalizer(e)?Z`
                            <ha-settings-row>
                              ...
                              <select
                                ...
                                @change="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Mt]:i.target.value||"auto"}))}"
                              >
                ...
                <ha-settings-row>
                  ...
                  <input
                    ...
                    @input="${i=>{const s=i.target.valueAsNumber;isNaN(s)||this.handleEditZone(t,Object.assign(Object.assign({},e),{[zt]:Math.round(s)}))}}"
                  />
                </ha-settings-row>
                ...
                <ha-settings-row>
                  ...
                  <input
                    ...
                    @input="${i=>{const s=Math.round(10*i.target.valueAsNumber)/10;isNaN(s)||this.handleEditZone(t,Object.assign(Object.assign({},e),{[Ot]:Math.min(s,0)}))}}"
                  />
                </ha-settings-row>
    ...
    `}};t([me()],An.prototype,"config",void 0),t([me({attribute:!1})],An.prototype,"path",void 0),t([me({type:Array})],An.prototype,"zones",void 0),t([me({type:Array})],An.prototype,"modules",void 0),t([me({type:Array})],An.prototype,"mappings",void 0),t([me({type:Array})],An.prototype,"distributors",void 0),t([me({type:Boolean})],An.prototype,"isLoading",void 0),t([ve()],An.prototype,"_expanded",void 0),t([me({type:Boolean})],An.prototype,"isSaving",void 0),t([me({type:Boolean})],An.prototype,"_showAddZone",void 0),t([ve()],An.prototype,"_pendingConfirm",void 0),t([ve()],An.prototype,"_saveStatus",void 0),t([me()],An.prototype,"_confirmDeleteZoneId",void 0),t([me()],An.prototype,"_newZoneName",void 0),t([me()],An.prototype,"_newZoneSize",void 0),t([me()],An.prototype,"_newZoneThroughput",void 0),t([me()],An.prototype,"_newZoneEntity",void 0),An=t([ue("irrigation-plus-view-zone-settings")],An);let Cn=class extends ce{_emit(e){this.dispatchEvent(new CustomEvent("distributor-changed",{detail:{value:Object.assign(Object.assign({},this.distributor),e)},bubbles:!0,composed:!0}))}_onNumber(e,t){const i=t.target.valueAsNumber;isNaN(i)||this._emit({[e]:Math.max(0,Math.round(i))})}render(){var e,t,i,s;if(!this.hass||!this.distributor)return Z``;const a=this.hass.language,n=this.distributor,o=n.watering_mode===Hi;return Z`
      <ha-settings-row>
        ...
        <input
          ...
          @input="${e=>this._emit({[yi]:e.target.value})}"
        />
      </ha-settings-row>
      ...
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${$n(null!==(t=n.watering_mode)&&void 0!==t?t:Mi)}"
          @change="${e=>this._emit({[wi]:e.target.value})}"
        >
          <option
            value="${Mi}"
            ?selected="${(null!==(i=n.watering_mode)&&void 0!==i?i:Mi)===Mi}"
          >
            ${Wa("panels.zones.labels.watering_modes.classic",a)}
          </option>
          <option
            value="${Hi}"
            ?selected="${n.watering_mode===Hi}"
          >
      ...
      <ha-settings-row>
        ...
        <input
          ...
          @input="${e=>this._emit({[Ti]:e.target.value||null})}"
        />
      </ha-settings-row>
    `}_renderInletWatchRows(e){var t;const i=this.distributor,s=i.watering_mode===Hi?"panels.distributors.labels.inlet_entity_help_service":"panels.distributors.labels.inlet_entity_help",a=null!==(t=i.watch_mode)&&void 0!==t?t:"ignore";return Z`
      <ha-settings-row>
        <span slot="heading"
          >${Wa("panels.distributors.labels.inlet_entity",e)}</span
        >
        <span slot="description">${Wa(s,e)}</span>
        <ha-entity-picker
          .hass="${this.hass}"
      ...
      ${i.inlet_entity?Z`
            <ha-settings-row>
              ...
              <select
                class="settings-input"
                .value="${$n(a)}"
                @change="${e=>this._emit({[xi]:e.target.value})}"
              >
                ${Di.map(t=>Z`
    ...
    `}_renderServiceRows(e){var t,i;const s=this.distributor;return Z`
      <ha-settings-row>
        ...
        <ha-entity-picker
          ...
          .includeDomains="${["script"]}"
          allow-custom-entity
          @value-changed="${e=>this._emit({[ki]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>
      ...
      <ha-settings-row>
        ...
        <input
          ...
          @input="${e=>this._emit({[Si]:e.target.value||"duration"})}"
        />
      </ha-settings-row>
      ...
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${$n(null!==(t=s.duration_unit)&&void 0!==t?t:"seconds")}"
          @change="${e=>this._emit({[Ai]:e.target.value})}"
        >
          <option
            value="seconds"
      ...
      <ha-settings-row>
        ...
        <ha-entity-picker
          ...
          .includeDomains="${["script"]}"
          allow-custom-entity
          @value-changed="${e=>this._emit({[zi]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>
    `}_renderSensorRows(e){const t=this.distributor;return Z`
      <ha-settings-row>
        ...
        <ha-entity-picker
          ...
          allow-custom-entity
          @value-changed="${e=>this._emit({[Ci]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>
    ...
    `}_hasOwnActuation(e){return!!(e.linked_entity||e.run_service||e.stop_service)}_membersByOutlet(e){const t=new Map;if(void 0===e)return t;for(const i of this.zones)i.distributor_id===e&&null!=i.outlet_number&&void 0!==i.id&&t.set(i.outlet_number,i);return t}_outletCount(e){const t=this._membersByOutlet(e.id),i=t.size?Math.max(...t.keys()):0,s=Math.max(2,i),a=void 0!==e.id?this._outletRows[e.id]:void 0;return Math.min(6,Math.max(s,null!=a?a:s))}_assignZone(e,t,i){return ji(this.hass,{id:e.id,[Pi]:t,[Li]:i})}_optimisticZone(e,t,i){void 0!==e&&(this.zones=this.zones.map(s=>s.id===e?Object.assign(Object.assign({},s),{distributor_id:t,outlet_number:i}):s))}_runAssign(e){e.length&&(this.isSaving=!0,this._saveStatus="saving",this._scheduleUpdate(),Promise.all(e).then(()=>this._markSaved()).catch(e=>{console.error("Failed to assign zone to outlet:",e),this._saveStatus="idle",Qa(this,this.hass,"common.errors.save_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(()=>{})}))}_setOutletCount(e,t){if(void 0===e.id)return;const i=this._membersByOutlet(e.id),s=[];for(const[e,a]of i)e>t&&s.push(a);this._outletRows=Object.assign(Object.assign({},this._outletRows),{[e.id]:t}),s.length?(s.forEach(e=>this._optimisticZone(e.id,null,null)),this._runAssign(s.map(e=>this._assignZone(e,null,null)))):this._scheduleUpdate()}_onOutletZoneChange(e,t,i){const s=i.target.value,a=s?parseInt(s):null,n=this._membersByOutlet(e.id).get(t),o=null!==a?this.zones.find(e=>e.id===a):null,r=[];n&&n.id!==a&&(r.push(this._assignZone(n,null,null)),this._optimisticZone(n.id,null,null)),o&&(r.push(this._assignZone(o,e.id,t)),this._optimisticZone(o.id,e.id,t)),this._runAssign(r)}_renderOutletConfig(e){if(!this.hass)return Z``;const t=this.hass.language,i=this._membersByOutlet(e.id),s=this._outletCount(e),a=this.zones.filter(e=>void 0!==e.id&&null==e.distributor_id&&!this._hasOwnActuation(e)),n=[...i.keys()].sort((e,t)=>e-t),o=n.some((e,t)=>e!==t+1),r=[];for(let n=1;n<=s;n++){const s=i.get(n),o=s?[...a,s]:[...a];o.sort((e,t)=>(e.name||"").localeCompare(t.name||"")),r.push(Z`
        <div class="outlet-row">
          ...
          <select
            class="settings-input"
            .value="${$n(null!=(null==s?void 0:s.id)?String(s.id):"")}"
        ...
        ${0===this.zones.length?Z`<div class="weather-note">
              ...
              <ha-settings-row>
                ...
                <select
                  ...
                  ?disabled="${this.isSaving}"
                >
                  ${Array.from({length:5},(e,t)=>2+t).map(e=>Z`<option value="${e}" ?selected="${e===s}">
                        ${e}
                      </option>`)}
                </select>
              </ha-settings-row>
    ...
    `}_renderAdvisories(){var e,t;if(!this.hass)return Z``;const i=this.hass.language,s=null===(e=this.config)||void 0===e?void 0:e.zone_sequencing,a=s===Kt,n=s===Gt||s===Vt,o=!!(null===(t=this.config)||void 0===t?void 0:t.master_off_after);return Z`
      <div class="advisories">
        <div class="advisory">
          <ha-icon icon="mdi:flask-outline"></ha-icon>
          <span
            >${Wa("panels.distributors.hints.experimental",i)}</span
          >
        </div>
        <div class="advisory">
          <ha-icon icon="mdi:water-alert-outline"></ha-icon>
          <span>${Wa("panels.distributors.hints.pressure",i)}</span>
        </div>
        ${a?Z`<div class="advisory">
              <ha-icon icon="mdi:information-outline"></ha-icon>
              <span
                >${Wa("panels.distributors.hints.parallel_draw",i)}</span
              >
            </div>`:""}
        ${n&&o?Z`<div class="advisory">
              <ha-icon icon="mdi:information-outline"></ha-icon>
              <span
                >${Wa("panels.distributors.hints.master_off_after",i)}</span
              >
            </div>`:""}
      </div>
    `}_renderCommissioning(e){var t;if(!this.hass)return Z``;const i=this.hass.language,s="synced"===e.position_state,a=!!e.commissioning_confirmed,n=!!e.active_cycle&&Object.keys(e.active_cycle).length>0,o=e.id;return Z`
      <div class="commissioning">
        <div class="commissioning-head">
          <span class="section-title"
            >${Wa("panels.distributors.commissioning.title",i)}</span
          >
          <span class="pos-badge pos-${e.position_state}">
            ${Wa("panels.distributors.commissioning.outlet",i)}
            ${e.current_outlet} ·
            ${Wa(`panels.distributors.commissioning.states.${e.position_state}`,i)}
          </span>
        </div>
        ...
        <ha-settings-row>
          <span slot="heading"
            >${Wa("panels.distributors.commissioning.set_outlet",i)}</span
          >
          <span slot="description"
            >${Wa("panels.distributors.commissioning.set_outlet_help",i)}</span
          >
          <div class="inline-controls">
            ...
            >
              ${Wa("panels.distributors.commissioning.set_outlet",i)}
            </button>
            <button
              class="action-btn secondary"
              ?disabled="${this.isSaving}"
            ...
            >
              ${Wa("panels.distributors.commissioning.resync_home",i)}
            </button>
          </div>
        </ha-settings-row>
        <div class="commissioning-note">
          ${Wa("panels.distributors.hints.undetectable",i)}
        </div>

        <!-- Test run -->
        <ha-settings-row>
          <span slot="heading"
            >${Wa("panels.distributors.commissioning.test_run",i)}</span
          >
          <span slot="description"
            >${Wa("panels.distributors.commissioning.test_run_help",i)}</span
          >
          <button
            class="action-btn secondary"
          ...
          >
            ...
            ${Wa("panels.distributors.commissioning.test_run",i)}
          </button>
        </ha-settings-row>
        ...
        <ha-settings-row>
          <span slot="heading"
            >${Wa("panels.distributors.commissioning.confirmed",i)}</span
          >
          <span slot="description"
            >${Wa(s?"panels.distributors.commissioning.confirmed_help":"panels.distributors.commissioning.needs_sync",i)}</span
          >
          <ha-switch
            .checked="${$n(a)}"
        ...
        <div class="run-now-row">
          ...
          >
            <ha-icon icon="mdi:play"></ha-icon>
            ${Wa("panels.distributors.commissioning.run_now",i)}
          </button>
          <span class="run-now-hint">
            ${Wa(n?"panels.distributors.commissioning.run_now_active":"panels.distributors.commissioning.run_now_help",i)}
          </span>
        </div>
      </div>
    `}renderDistributor(e,t){var i;if(!this.hass)return Z``;const s=this._isExpanded(e),a=this.hass.language;return Z`
    ...
    `;return this.moduleCache.set(s,a),a}renderUsageChip(e){return this.hass?e?Z`<span class="usage-chip"
      ...
      >
        ${Object.entries(n.options).map(([e,i])=>Z`<option
              ...
              ?selected="${h===qa(i,0)}"
            >
              ${Wa("panels.modules.cards.module.translated-options."+qa(i,1),t)}
            </option>`)}
    ...
    `}renderSimpleRadioOptions(e,t,i){if(!this.hass||!this.config)return Z``;const s=t===Pe||t===je,a=i[Je];return Z`
    ...
    `}handleSimpleSourceChange(e,t,i){const s=this.mappings[e],a=i.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[Je]:a,[Qe]:""})})}))}handleSimpleInputChange(e,t,i,s){const a=this.mappings[e],n=s.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},a),{mappings:Object.assign(Object.assign({},a.mappings),{[t]:Object.assign(Object.assign({},a.mappings[t]),{[i]:n})})}))}renderMappingInputs(e,t,i){if(!this.hass)return Z``;const s=i[Je];return Z`
      ${s===qe?this.renderSensorInput(e,t,i):""}
      ${s===Ge?this.renderStaticValueInput(e,t,i):""}
      ${s===qe||s===Ge?this.renderUnitSelect(e,t,i):""}
      ${t!==Ue||s!==qe&&s!==Ge?"":this.renderPressureTypeSelect(e,t,i)}
      ${s===qe?this.renderAggregateSelect(e,t,i):""}
    ...
    `}handleSensorChange(e,t,i){const s=this.mappings[e];this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[Qe]:i.target.value})})}))}handleStaticValueChange(e,t,i){const s=this.mappings[e];this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[et]:i.target.value})})}))}handleUnitChange(e,t,i){const s=this.mappings[e];this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[tt]:i.target.value})})}))}handlePressureTypeChange(e,t,i){const s=this.mappings[e];this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[Ke]:i.target.value})})}))}handleAggregateChange(e,t,i){const s=this.mappings[e];this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[it]:i.target.value})})}))}renderAggregateOptionsForMapping(e,t){if(!this.hass||!this.config)return Z``;let i="average";return e===Re&&(i="delta"),e===Be&&(i="average"),t[it]&&(i=t[it]),Z`
      ${st.map(e=>this.renderAggregateOption(e,i))}
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return Z`<option value="${e}" ?selected="${e===t}">
      ...
      </option>`}return Z``}renderPressureTypes(e,t){if(this.hass&&this.config){let e=Z``;const i=t[Ke];return e=Z`${e}
        <option
          value="${Ve}"
          ?selected="${i===Ve}"
        >
        ...
        </option>`,e}return Z``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return Z``;const i=function(e){switch(e){case Ie:case Fe:return[{unit:"°C",system:Ne},{unit:"°F",system:He}];case Re:case Pe:return[{unit:lt,system:Ne},{unit:dt,system:He}];case Be:return[{unit:pt,system:Ne},{unit:gt,system:He}];case Le:return[{unit:"%",system:[Ne,He]}];case Ue:return[{unit:"millibar",system:Ne},{unit:"hPa",system:Ne},{unit:"psi",system:He},{unit:ct,system:He}];case We:return[{unit:"km/h",system:Ne},{unit:ut,system:Ne},{unit:ht,system:He}];case je:return[{unit:"W/m2",system:Ne},{unit:"MJ/day/m2",system:Ne},{unit:"W/sq ft",system:He},{unit:"MJ/day/sq ft",system:He}];default:return[]}}(e);let s=t[tt];const a=this.config.units;if(!t[tt])for(const e of i)if("string"==typeof e.system){if(a===e.system){s=e.unit;break}}else{for(const t of e.system)if(a===t.system){s=e.unit;break}if(s===e.unit)break}return Z`
      ${i.map(e=>Z`
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach(e=>{clearTimeout(e)}),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};t([me()],On.prototype,"config",void 0),t([me({type:Array})],On.prototype,"zones",void 0),t([me({type:Array})],On.prototype,"mappings",void 0),t([me({type:Boolean})],On.prototype,"isLoading",void 0),t([me({type:Boolean})],On.prototype,"isSaving",void 0),t([fe("#mappingNameInput")],On.prototype,"mappingNameInput",void 0),On=t([ue("irrigation-plus-view-mappings")],On);const Dn="06:00",Mn=90;function Hn(e){switch(e){case pi:return{mode:e,time:Dn};case gi:case mi:return{mode:e,offset:0};case vi:return{mode:e,azimuth:Mn};default:return{mode:ui}}}function Nn(e,t,i,s){const a=function(e){return e===ui||e===pi||e===gi||e===mi||e===vi}(e)?e:ui,n=Hn(a);return a===pi&&void 0!==t&&(n.time=t),a!==gi&&a!==mi||void 0===i||(n.offset=i),a===vi&&void 0!==s&&(n.azimuth=s),n}function In(e){var t,i,s;return{mode:e.mode,time:e.mode===pi?null!==(t=e.time)&&void 0!==t?t:Dn:void 0,offset:e.mode===gi||e.mode===mi?null!==(i=e.offset)&&void 0!==i?i:0:void 0,azimuth:e.mode===vi?null!==(s=e.azimuth)&&void 0!==s?s:Mn:void 0}}function Pn(e){return{start:Nn(e.start_mode,e.start_time,e.start_offset,e.start_azimuth),finish:Nn(e.finish_mode,e.finish_time,e.finish_offset,e.finish_azimuth),anchor:e.anchor===_i?_i:bi}}function Ln(e,t){const i=e.start.mode!==ui,s=e.finish.mode!==ui;if(!i&&!s)return{start:"error",finish:"error",valid:!1};return function(e,t,i){if(!(null==i?void 0:i.start)&&!(null==i?void 0:i.finish))return t;const s=e.start.mode!==ui,a=e.finish.mode!==ui,n=s&&a?e.anchor:s?_i:bi,o=e=>e===n?"unreachable_no_run":"unreachable_ignored";return Object.assign(Object.assign({},t),{start:i.start?o(_i):t.start,finish:i.finish?o(bi):t.finish})}(e,i?s?e.anchor===bi?{start:"demand_floored",finish:"exact_deferred",valid:!0}:{start:"exact",finish:"demand_capped_deferred",valid:!0}:{start:"exact",finish:"demand_open",valid:!0}:{start:"demand_open",finish:"exact",valid:!0},t)}function Rn(e){if(e.recurrence===li&&0===(e.days_of_week||[]).length)return"no_days";if(e.recurrence!==ci){const t=Pn(e);if(t.start.mode===ui&&t.finish.mode===ui)return"no_window"}return Array.isArray(e.zones)&&0===e.zones.length?"no_zones":null}function Bn(e,t){const i=Rn(e);if(i)return{text:Wa(`panels.schedules.summary.${"no_window"===i?"invalid":i}`,t),isError:!0};const s=function(e,t){if("all"===e||!Array.isArray(e))return Wa("panels.schedules.summary.zones_all",t);return Wa("panels.schedules.summary.zones_some",t,"count",e.length)}(e.zones,t),a=function(e,t){switch(e.recurrence){case li:{const i=(e.days_of_week||[]).map(e=>Wa(`panels.schedules.days.${e}`,t)).join(", ");return Wa("panels.schedules.summary.recurrence_weekly",t,"days",i)}case di:return Wa("panels.schedules.summary.recurrence_monthly",t,"day",e.day_of_month||1);case ci:{const i=e.interval_hours||24;return e.start_time?Wa("panels.schedules.summary.recurrence_interval_at",t,"hours",i,"time",e.start_time):Wa("panels.schedules.summary.recurrence_interval",t,"hours",i)}default:return Wa("panels.schedules.summary.recurrence_daily",t)}}(e,t);if(e.recurrence===ci){return{text:`${a}, ${Wa("panels.schedules.summary.watering",t,"zones",s)}.`,isError:!1}}const n=Pn(e),o=n.start.mode!==ui,r=n.finish.mode!==ui,l=Wa("panels.schedules.summary.watering",t,"zones",s);let d;return d=o?r?n.anchor===bi?Wa("panels.schedules.summary.anchor_finish",t,"finish",Un(n.finish,t),"start",Un(n.start,t)):Wa("panels.schedules.summary.anchor_start",t,"start",Un(n.start,t),"finish",Un(n.finish,t)):Wa("panels.schedules.summary.start_only",t,"when",Un(n.start,t)):Wa("panels.schedules.summary.finish_only",t,"when",Un(n.finish,t)),{text:`${a}, ${l}, ${d}.`,isError:!1}}function Un(e,t){var i,s,a;switch(e.mode){case pi:return null!==(i=e.time)&&void 0!==i?i:"";case gi:case mi:{const i=Wa(`panels.schedules.summary.${e.mode}`,t),a=null!==(s=e.offset)&&void 0!==s?s:0;if(0===a)return i;return Wa(a<0?"panels.schedules.summary.offset_before":"panels.schedules.summary.offset_after",t,"minutes",Math.abs(a),"event",i)}case vi:return Wa("panels.schedules.summary.at_azimuth",t,"degrees",null!==(a=e.azimuth)&&void 0!==a?a:Mn);default:return""}}function jn(e){return(e%360+360)%360}const Fn=Math.PI/180;function Wn(e,t,i){const s=e*Fn,a=23.45*Math.sin(360*(284+function(e){const t=Date.UTC(e.getUTCFullYear(),0,1),i=Date.UTC(e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate());return Math.floor((i-t)/864e5)+1}(i))/365*Fn)*Fn,n=15*(i.getUTCHours()+i.getUTCMinutes()/60+i.getUTCSeconds()/3600+t/15-12)*Fn;return jn(Math.atan2(Math.sin(n),Math.cos(n)*Math.sin(s)-Math.tan(a)*Math.cos(s))/Fn+180)}function Zn(e,t,i){return Math.abs(e-t)>180?e>t?i>=e||i<=t:i<=e||i>=t:Math.min(e,t)<=i&&i<=Math.max(e,t)}const qn=9e5;function Gn(e,t,i,s,a){let n=s,o=a;for(;o-n>6e4;){const s=n+(o-n)/2,a=Wn(e,t,new Date(s));Zn(Wn(e,t,new Date(n)),a,i)?o=s:n=s}return new Date(n)}const Kn={hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"};function Vn(e,t){if(!e)return Yn(t);let i;try{i=new Intl.DateTimeFormat("en-US",Object.assign(Object.assign({},Kn),{timeZone:e})).formatToParts(t)}catch(e){return Yn(t)}const s=e=>{var t,s;return parseInt(null!==(s=null===(t=i.find(t=>t.type===e))||void 0===t?void 0:t.value)&&void 0!==s?s:"0",10)},a=s("hour")%24;return new Date(Date.UTC(s("year"),s("month")-1,s("day"),a,s("minute"),s("second")))}function Yn(e){return new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours(),e.getMinutes(),e.getSeconds()))}function Xn(e){return 60*e.getUTCHours()+e.getUTCMinutes()}function Jn(e,t){if("number"!=typeof(null==e?void 0:e.latitude)||"number"!=typeof(null==e?void 0:e.longitude))return;const{latitude:i,longitude:s,time_zone:a}=e;return e=>function(e,t,i,s,a){const n=Vn(s,a),o=new Date(Date.UTC(n.getUTCFullYear(),n.getUTCMonth(),n.getUTCDate())),r=function(e,t,i,s,a=1){const n=s.getTime(),o=n+864e5*a;let r=n,l=Wn(e,t,s);for(;r<o;){r+=qn;const s=Wn(e,t,new Date(r));if(Zn(l,s,i))return Gn(e,t,i,r-qn,r);l=s}return null}(e,t,jn(i),function(e,t){let i=e.getTime();for(let s=0;s<2;s++){const s=Vn(t,new Date(i)).getTime()-i;i=e.getTime()-s}return new Date(i)}(o,s));return null===r?null:Xn(Vn(s,r))}(i,s,e,a,t)}const Qn=1440,eo=44,to=260;function io(e){return(e%Qn+Qn)%Qn}function so(e){const t=io(Math.round(e)),i=Math.floor(t/60),s=t%60;return`${String(i).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function ao(e){const t=Math.round(e),i=Math.floor(t/60),s=t%60;return i?`${i}h ${s}m`:`${s}m`}function no(e,t){const i=t/Qn*2*Math.PI+Math.PI/2;return[66+e*Math.cos(i),66+e*Math.sin(i)]}function oo(e,t,i){const s=i-t>=Qn?t+Qn-.5:i,[a,n]=no(e,t),[o,r]=no(e,s),l=s-t>720?1:0;return`M ${a.toFixed(2)} ${n.toFixed(2)} A ${e} ${e} 0 ${l} 1 ${o.toFixed(2)} ${r.toFixed(2)}`}function ro(e,t,i,s,a){const n=2*Math.PI*e/Qn,o=[[0,i]];for(let e=0;e<=10;e++){const t=Math.PI/2+e/10*(Math.PI/2);o.push([s*Math.cos(t),i-s+s*Math.sin(t)])}for(let e=0;e<=10;e++){const t=Math.PI+e/10*(Math.PI/2);o.push([s*Math.cos(t),s*Math.sin(t)-3.2])}return o.push([0,-i]),o.map(([i,s],o)=>{const[r,l]=no(e+s,(e=>t-a*e/n)(i));return`${o?"L":"M"} ${r.toFixed(2)} ${l.toFixed(2)}`}).join(" ")+" Z"}function lo(e,t,i,s,a){const n=(t-e)/48,o=[];for(let r=0;r<48;r++){const l=e+r*n,d=l+n/2;let c=1;i>0&&(c=Math.min(c,(d-e)/i)),s>0&&(c=Math.min(c,(t-d)/s)),c=Math.max(0,Math.min(1,c)),o.push({d:oo(a,l,l+1.25*n),opacity:c})}return o}function co(e){const[t,i]=e.split(":").map(e=>parseInt(e,10));return 60*(t||0)+(i||0)}function ho(e,t,i,s){var a,n,o,r;switch(e.mode){case pi:return io(co(null!==(a=e.time)&&void 0!==a?a:"06:00"));case gi:return io(t+(null!==(n=e.offset)&&void 0!==n?n:0));case mi:return io(i+(null!==(o=e.offset)&&void 0!==o?o:0));case vi:{if(!s)return null;const t=s(null!==(r=e.azimuth)&&void 0!==r?r:Mn);return null===t?null:io(t)}default:return null}}function uo(e,t){return{wraps:!1,arc:oo(eo,e,t),capStart:ro(eo,e,5,1.8,-1),capEnd:ro(eo,t,5,1.8,1)}}function po(e){const{rows:t,recurrence:i,intervalHours:s,intervalStartTime:a,nominalDemandMinutes:n,sunriseMinutes:o,sunsetMinutes:r,azimuthResolver:l}=e,d=oo(eo,0,Qn),c=[0,360,720,1080].map(e=>{const[t,i]=no(38,e),[s,a]=no(50,e);return{x1:t,y1:i,x2:s,y2:a}}),[h,u]=no(57,o),[p,g]=no(57,r);if(i===ci){const{runs:e,overlaps:t,wrapAt:i}=function(e,t,i){const s=60*Math.max(1,Number(t)||24),a=i?co(i):0,n=[];for(let t=a;t<a+Qn&&n.length<24;t+=s)n.push([t,t+e]);const o=[];for(let e=0;e+1<n.length;e++)n[e][1]>n[e+1][0]&&o.push([n[e+1][0],Math.min(n[e][1],n[e+1][1])]);return{runs:n,overlaps:o,wrapAt:a+Qn}}(n,s,a),l=e.map(([e,t])=>{if(t<=i)return uo(e,t);const s=i-8,a=s-e,n=Math.min(a,120);return{wraps:!0,capStart:ro(eo,e,5,1.8,-1),fade:lo(e,s,0,n,eo)}});return{trackPath:d,windowArc:null,dottedPath:null,runs:l,overlaps:t.map(([e,t])=>({d:oo(eo,e,t),fromMinutes:e,toMinutes:t})),ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:e.map(([e,t])=>{const[i,s]=no(57,(e+t)/2);return{x:i,y:s,fromMinutes:e,toMinutes:t}}),centre:{kind:"interval",perDay:e.length,intervalHours:Math.max(1,Number(s)||24)}}}const m=ho(t.start,o,r,l);let v=ho(t.finish,o,r,l);null!==m&&null!==v&&v<=m&&(v+=Qn);if(null===m&&null===v)return{trackPath:d,windowArc:null,dottedPath:null,runs:[],overlaps:[],ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:[],centre:{kind:"invalid"}};const f=null!==m&&null!==v?v-m:null;let _,b,y=0;if(null!==m&&null!==v){const e=f;b=Math.min(n,e),y=Math.max(0,n-e),_=t.anchor===bi?v-b:m}else null!==m?(_=m,b=n):(b=n,_=v-b);const w=_+b;let $=null!=m?m:_,x=null!=v?v:w,k=0,z=0;null===m&&($=_-to,k=to),null===v&&(x=w+to,z=to);const S=null!==f&&f<60,A=null===m||null===v?{kind:"faded",segments:lo($,x,k,z,eo)}:{kind:"solid",d:oo(eo,$,S?$+60:x)},C=y>1?oo(eo,_-y,_):null,[E,T]=no(57,(_+w)/2),O=null===f?{kind:"run",minutes:b}:{kind:"window",minutes:f};return{trackPath:d,windowArc:A,dottedPath:C,runs:[uo(_,w)],overlaps:[],ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:[{x:E,y:T,fromMinutes:_,toMinutes:w}],centre:O}}const go=q`<circle cx="12" cy="12" r="4.4" />
  ${Array.from({length:8},(e,t)=>{const i=t*Math.PI/4,s=(12+6.6*Math.cos(i)).toFixed(1),a=(12+6.6*Math.sin(i)).toFixed(1),n=(12+9.2*Math.cos(i)).toFixed(1),o=(12+9.2*Math.sin(i)).toFixed(1);return q`<line x1="${s}" y1="${a}" x2="${n}" y2="${o}" />`})}`,mo=q`<path d="M13.5,2.5A9.5,9.5 0 1,0 21.5,14 7.6,7.6 0 0,1 13.5,2.5Z" />`,vo=q`<path d="M12,2.6C12,2.6 18.6,9.4 18.6,13.7A6.6,6.6 0 0,1 5.4,13.7C5.4,9.4 12,2.6 12,2.6Z" />`;let fo=class extends ce{constructor(){super(...arguments),this.recurrence="daily",this.nominalDemandSeconds=0}_sunTimes(){var e,t,i,s,a,n;const o=null===(t=null===(e=this.hass)||void 0===e?void 0:e.states)||void 0===t?void 0:t["sun.sun"],r=null===(i=null==o?void 0:o.attributes)||void 0===i?void 0:i.next_rising,l=null===(s=null==o?void 0:o.attributes)||void 0===s?void 0:s.next_setting,d=null===(n=null===(a=this.hass)||void 0===a?void 0:a.config)||void 0===n?void 0:n.time_zone,c=(e,t)=>{if(!e)return t;const i=new Date(e);return isNaN(i.getTime())?t:Xn(Vn(d,i))};return{sunrise:c(r,360),sunset:c(l,1200)}}_azimuthResolver(){var e;return Jn(null===(e=this.hass)||void 0===e?void 0:e.config,new Date)}_renderRun(e,t){return e.wraps?q`
    ...
    `:q`
      ...
      `}_t(e,t,i){return Wa(`panels.schedules.dial.${e}`,t,"{from}",so(i.fromMinutes),"{to}",so(i.toMinutes))}_note(e,t){var i;const s=this.nominalDemandSeconds/60;if(!s)return Z``;if("interval"===e.centre.kind){const i=e.overlaps.length>0;return Z`
        <div class="d-note ${i?"warn":""}">
          ${i?Wa("panels.schedules.dial.collision_note",t):Wa("panels.schedules.dial.runs_of",t,"{count}",e.runs.length,"{duration}",ao(s))}
        </div>
      `}if("window"!==e.centre.kind)return Z``;const a=s-(null!==(i=e.centre.minutes)&&void 0!==i?i:0);return a<=1?Z``:Z`
      <div class="d-note warn">
        ${Wa("panels.schedules.dial.shortfall",t,"{duration}",ao(a))}
      </div>
    `}_centreText(e,t){var i,s;const a=e.centre;switch(a.kind){case"invalid":return{val:"—",lbl:""};case"interval":return{val:Wa("panels.schedules.dial.every_hours",t,"{hours}",a.intervalHours),lbl:Wa("panels.schedules.dial.per_day",t,"{count}",a.perDay)};case"run":return{val:ao(null!==(i=a.minutes)&&void 0!==i?i:0),lbl:Wa("panels.schedules.dial.run_label",t)};default:return{val:ao(null!==(s=a.minutes)&&void 0!==s?s:0),lbl:Wa("panels.schedules.dial.window_label",t)}}}render(){if(!this.hass||!this.rows)return Z``;const e=this.hass.language,{sunrise:t,sunset:i}=this._sunTimes(),s=po({rows:this.rows,recurrence:this.recurrence,intervalHours:this.intervalHours,intervalStartTime:this.intervalStartTime,nominalDemandMinutes:this.nominalDemandSeconds/60,sunriseMinutes:t,sunsetMinutes:i,azimuthResolver:this._azimuthResolver()}),{val:a,lbl:n}=this._centreText(s,e),o=Wa("panels.schedules.dial.sunrise",e,"{time}",so(s.sun.minutes)),r=Wa("panels.schedules.dial.sunset",e,"{time}",so(s.moon.minutes));return Z`
      <div class="viz-dial">
        <div class="d-wrap">
          <svg
            viewBox="0 0 132 132"
    ...
    `}_renderRecurrenceFields(){const e=this.schedule,t=this.hass.language;switch(e.recurrence){case"weekly":return Z`
        ...
        `;default:return Z``}}_renderRowStepper(e,t){var i,s,a;const n=this.hass.language;switch(e.mode){case pi:return Z`
          <input
            type="time"
            .value="${null!==(i=e.time)&&void 0!==i?i:"06:00"}"
            @change=${i=>t(Object.assign(Object.assign({},e),{time:i.target.value}))}
          />
        `;case gi:case mi:return Z`
        ...
        `;case vi:return Z`
          <input
            ...
            @input=${i=>{var s;const a=parseInt(i.target.value);t(Object.assign(Object.assign({},e),{azimuth:isNaN(a)?null!==(s=e.azimuth)&&void 0!==s?s:Mn:(a%360+360)%360}))}}
          />
          <span class="row-inline">°</span>
        `;default:return Z``}}_renderWindowRow(e,t,i,s){const a=this.hass.language;return Z`
      <div class="field">
        <label>${Wa(`panels.schedules.fields.${e}_mode`,a)}</label>
        <div class="rowfields">
          <select
            @change=${e=>s(Hn(e.target.value))}
          >
            ${fi.map(e=>Z`
        ...
        <span
          ...
          >${Wa(`panels.schedules.help.${i}`,a)}</span
        >
      </div>
    `;var n}_renderAnchorRow(e,t){const i=this.hass.language;return Z`
      <div class="field">
        <div class="rowfields">
          <span class="row-inline"
            >${Wa("panels.schedules.fields.anchor_prefix",i)}</span
          >
          <select
          ...
          >
            ${[_i,bi].map(t=>Z`
                <option value="${t}" .selected="${e.anchor===t}">
                  ${Wa(`panels.schedules.anchor.${t}`,i)}
                </option>
              `)}
          </select>
          <span class="row-inline"
            >${Wa("panels.schedules.fields.anchor_suffix",i)}</span
          >
        </div>
      </div>
    `}_unresolvableEnds(e){var t;const i=Jn(null===(t=this.hass)||void 0===t?void 0:t.config,new Date);if(!i)return{};const s=e=>{var t;return e.mode===vi&&null===i(null!==(t=e.azimuth)&&void 0!==t?t:Mn)};return{start:s(e.start),finish:s(e.finish)}}_renderWindowRows(){const e=this.schedule;if(e.recurrence===ci)return Z``;const t=Pn(e),i=Ln(t,this._unresolvableEnds(t)),s=e=>this._emitChanged(function(e){const t=In(e.start),i=In(e.finish);return{start_mode:t.mode,start_time:t.time,start_offset:t.offset,start_azimuth:t.azimuth,finish_mode:i.mode,finish_time:i.time,finish_offset:i.offset,finish_azimuth:i.azimuth,anchor:e.anchor}}(e)),a=t.start.mode!==ui&&t.finish.mode!==ui;return Z`
    ...
    `}render(){var e;if(!this.hass||!this.schedule)return Z``;const t=this.schedule,i=this.hass.language;return Z`
      ...
      <ha-dialog open heading="${this.heading}" @closed=${this._cancel}>
        <div class="dialog-content">
          ...
          <div class="field">
            <label>${Wa("panels.schedules.fields.name",i)}</label>
            <input
              type="text"
              .value="${t.name}"
            ...
            ${this._nameMissing()?Z`<span class="field-help err"
                  >${Wa("panels.schedules.help.name_required",i)}</span
                >`:""}
          </div>
          ...
          ${this._renderSection("when",Z`
              <div class="field">
                <select
                  ...
                  aria-label="${Wa("panels.schedules.fields.recurrence",i)}"
              ...
              ${t.recurrence===ci?Z``:this._renderRecurrenceFields()}
              <div class="when-row">
                <div class="when-rows-col">
                  ${t.recurrence===ci?this._renderRecurrenceFields():Z``}
    ...
    ${this._renderButtons(e)}`;return"content"===this._actionSlot?Z`
      ...
      `]}};t([me({attribute:!1})],wo.prototype,"hass",void 0),t([me({attribute:!1})],wo.prototype,"schedule",void 0),t([me({attribute:!1})],wo.prototype,"zones",void 0),t([me({attribute:!1})],wo.prototype,"heading",void 0),t([ve()],wo.prototype,"_actionSlot",void 0),wo=t([ue("ip-schedule-dialog")],wo);let $o=class extends(nn(ce)){constructor(){super(...arguments),this._schedules=[],this._zones=[],this._isLoading=!0,this._loadFailed=!1,this._loaded=!1,this._showDialog=!1,this._editingSchedule=bo(),this._editingId=null}hassSubscribe(){return this._load(),[this.hass.connection.subscribeMessage(()=>this._load(),{type:be+"_config_updated"})]}async _load(){var e;if(this.hass)try{const[t,i]=await Promise.all([(e=this.hass,e.callWS({type:be+"/schedules"})),Ui(this.hass)]);this._schedules=t||[],this._zones=i||[],this._loaded=!0,this._loadFailed=!1}catch(e){console.error("Failed to load schedules",e),Qa(this,this.hass,"common.errors.load_failed",e),this._loaded||(this._loadFailed=!0)}finally{this._isLoading=!1}}_openAdd(){this._editingSchedule=bo(),this._editingId=null,this._showDialog=!0,this._refreshNominalDemand()}_openEdit(e){var t;this._editingSchedule=Object.assign({},e),this._editingId=null!==(t=e.id)&&void 0!==t?t:null,this._showDialog=!0}_closeDialog(){this._showDialog=!1}async _save(){const e=Object.assign({},this._editingSchedule);this._editingId&&(e.id=this._editingId);try{const t=await Vi(this.hass,e);if(t&&!1===t.success)throw new Error(t.error||"");this._closeDialog(),await this._load()}catch(e){console.error("Failed to save schedule",e),Qa(this,this.hass,"common.errors.save_failed",e)}}async _delete(e){try{await(t=this.hass,i=e,t.callWS({type:be+"/schedule_delete",schedule_id:i})),await this._load()}catch(e){console.error("Failed to delete schedule",e),Qa(this,this.hass,"common.errors.delete_failed",e)}var t,i}_onScheduleChanged(e){const t=this._editingSchedule.zones;this._editingSchedule=e.detail.value,JSON.stringify(t)!==JSON.stringify(this._editingSchedule.zones)&&this._refreshNominalDemand()}async _refreshNominalDemand(){const e=this._editingSchedule.zones;try{const{nominal_demand_seconds:t}=await((e,t)=>e.callWS({type:be+"/schedule_nominal_demand",zones:t}))(this.hass,"all"===e?"all":e);this._showDialog&&JSON.stringify(this._editingSchedule.zones)===JSON.stringify(e)&&(this._editingSchedule=Object.assign(Object.assign({},this._editingSchedule),{nominal_demand_seconds:t}))}catch(e){console.error("Failed to fetch nominal demand",e)}}_zonesLabel(e){if("all"===e)return Wa("panels.schedules.zones_all",this.hass.language);if(Array.isArray(e)){const t=e.map(e=>{const t=this._zones.find(t=>String(t.id)===String(e));return t?t.name:e}).join(", ");return t||e.join(", ")}return String(e)}_dialogTitle(){return this._editingId?Wa("panels.schedules.dialog.edit_title",this.hass.language):Wa("panels.schedules.dialog.add_title",this.hass.language)}render(){return this.hass?this._isLoading?Z`
        <ha-card
    ...
    `}_renderForecastDay(e,t){const i=(()=>{try{return new Intl.DateTimeFormat(t,{weekday:"short",month:"short",day:"numeric"}).format(new Date(e.date+"T00:00:00"))}catch(t){return e.date}})(),s=e=>{const t=vn(e,"temperature",this._metric);return t?`${Math.round(t.value)}°`:"-"};return Z`
    ...
    `:Z``}_renderToggleCard(e,t,i){if(!this.hass)return Z``;const s=`panels.experimental.${e}`;return Z`
      <ha-card header="${Wa(`${s}.title`,this.hass.language)}">
        <div class="card-content description-text">
          ${Wa(`${s}.description`,this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${Wa(`${s}.label`,this.hass.language)}</label>
            <ha-switch
              .checked="${i}"
              ?disabled="${this._saving}"
    ...
    `}};t([me()],ko.prototype,"narrow",void 0),t([ve()],ko.prototype,"config",void 0),t([ve()],ko.prototype,"_saving",void 0),ko=t([ue("irrigation-plus-view-experimental")],ko);var zo;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.Distributors="distributors",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}(zo||(zo={}));const So={[zo.WeatherLocation]:"panels.setup.tabs.weather_location",[zo.Zones]:"panels.setup.tabs.my_zones",[zo.Distributors]:"panels.setup.tabs.distributors",[zo.WhenToWater]:"panels.setup.tabs.when_to_water",[zo.Advanced]:"panels.setup.tabs.advanced",[zo.Experimental]:"panels.setup.tabs.experimental",[zo.Help]:"panels.help.title"};let Ao=class extends(nn(ce)){hassSubscribe(){return this._fetchConfig(),[this.hass.connection.subscribeMessage(()=>this._fetchConfig(),{type:be+"_config_updated"})]}async _fetchConfig(){if(this.hass)try{this.config=await Ri(this.hass)}catch(e){console.error("Failed to fetch setup config:",e)}}get _distributorsEnabled(){var e,t;return null!==(t=null===(e=this.config)||void 0===e?void 0:e.distributors_enabled)&&void 0!==t&&t}get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(zo).includes(null!=t?t:"")?t:zo.WeatherLocation}_selectTab(e){Va(0,tn("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return Z``;const e=this._distributorsEnabled,t=Object.values(zo).filter(t=>t!==zo.Distributors||e);let i=this._activeTab;return i!==zo.Distributors||e||(i=zo.WeatherLocation),Z`
    ...
    `}};var Co;t([me({attribute:!1})],Ao.prototype,"hass",void 0),t([me({type:Boolean})],Ao.prototype,"narrow",void 0),t([me({attribute:!1})],Ao.prototype,"path",void 0),t([ve()],Ao.prototype,"config",void 0),Ao=t([ue("irrigation-plus-view-setup")],Ao),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done"}(Co||(Co={}));let Eo=class extends ce{constructor(){super(...arguments),this._step=Co.Welcome,this._saving=!1,this._error="",this._confirmClose=!1,this._siConfig=null,this._useWeather=!1,this._weatherService=Ee,this._apiKey="",this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=Ze,this._humiditySource=Ze,this._precipSource=Ze,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="",this._scheduleTime="06:00",this._scheduleCreated=!1,this._creatingSchedule=!1}async connectedCallback(){super.connectedCallback(),await this._loadInitialData()}async _loadInitialData(){var e;if(this.hass){try{const[t,i,s]=await Promise.all([Wi(this.hass),Ji(this.hass),Ri(this.hass)]);this._availableModules=t,this._weatherConfig=i,this._siConfig=s,this._useWeather=i.use_weather_service,this._weatherService=null!==(e=i.weather_service)&&void 0!==e?e:Ee}catch(e){console.error("Wizard: failed to load initial data",e),this._error=Ya(e)}this.requestUpdate()}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}))}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}))}async _next(){this._error="";try{switch(this._saving=!0,this._step){case Co.Welcome:this._step=Co.Weather;break;case Co.Weather:await this._saveWeather(),this._step=Co.Module;break;case Co.Module:await this._saveModule(),this._step=Co.Mapping;break;case Co.Mapping:await this._saveMapping(),this._step=Co.Zone;break;case Co.Zone:await this._saveZone(),this._step=Co.Done;break;case Co.Done:this._close()}}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._saving=!1,this.requestUpdate()}}_back(){this._step>Co.Welcome&&(this._step=this._step-1,this._error="")}get _canSkipCurrentStep(){return this._step===Co.Weather}_skipStep(){this._canSkipCurrentStep&&this._step<Co.Done&&(this._step=this._step+1,this._error="")}async _saveWeather(){await Qi(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null)}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0}catch(e){return}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await Zi(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>Fi(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.")}async _saveMapping(){const e=this._useWeather?Ze:Xe,t={[Fe]:{[Je]:this._tempSource},[Le]:{[Je]:this._humiditySource},[Re]:{[Je]:this._precipSource}},i=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const s of i)t[s]={[Je]:e};const s=await Gi(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(s,()=>qi(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.")}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await ji(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:rn.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0})}async _createDefaultSchedule(){var e,t;if(!this._scheduleCreated&&!this._creatingSchedule){this._error="",this._creatingSchedule=!0;try{const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";await Vi(this.hass,{name:Wa("wizard.steps.done.schedule_name",i)||"Daily",recurrence:"daily",enabled:!0,start_mode:pi,start_time:this._scheduleTime||"06:00",finish_mode:ui,action:"irrigate",zones:"all"}),this._scheduleCreated=!0}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._creatingSchedule=!1,this.requestUpdate()}}}render(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return Z`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          <div class="wizard-header">
            <span class="wizard-title">${Wa("wizard.title",i)}</span>
            <button
              class="wizard-close-btn"
              @click="${this._close}"
              title="${Wa("wizard.close",i)}"
              aria-label="${Wa("wizard.close",i)}"
            >
    ...
    `}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>Co.Welcome&&this._step<Co.Done?this._confirmClose=!0:this._close())}_renderStepper(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",s=[Wa("wizard.stepper.weather",i),Wa("wizard.stepper.module",i),Wa("wizard.stepper.mapping",i),Wa("wizard.stepper.zone",i)];return Z`
    ...
    `}_renderMapping(e){const t=[{value:Ze,label:Wa("wizard.steps.mapping.use_weather_service",e)},{value:"sensor",label:Wa("wizard.steps.mapping.use_sensor",e)},{value:"static",label:Wa("wizard.steps.mapping.use_static",e)},{value:Xe,label:Wa("wizard.steps.mapping.use_none",e)}],i=(i,s,a)=>Z`
      <ip-field
        label="${Wa("wizard.steps.mapping.source_label",e)} ${i}"
      >
        <select
          class="wizard-input"
    ...
    `;return Z`
      ...
      ${i(Wa("panels.mappings.cards.mapping.items.temperature",e)||"Temperature",this._tempSource,e=>{this._tempSource=e,this.requestUpdate()})}
      ${i(Wa("panels.mappings.cards.mapping.items.humidity",e)||"Humidity",this._humiditySource,e=>{this._humiditySource=e,this.requestUpdate()})}
      ${i(Wa("panels.mappings.cards.mapping.items.precipitation",e)||"Precipitation",this._precipSource,e=>{this._precipSource=e,this.requestUpdate()})}

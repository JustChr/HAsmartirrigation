...
`;const Ga=e=>String(e).padStart(2,"0");function Ka(e){return e instanceof Date?e:new Date(e)}function Va(e){const t=Ka(e);return`${Ga(t.getHours())}:${Ga(t.getMinutes())}`}function Ya(e){const t=Ka(e);return`${t.getFullYear()}-${Ga(t.getMonth()+1)}-${Ga(t.getDate())} ${Ga(t.getHours())}:${Ga(t.getMinutes())}`}function Xa(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class Ja extends(Ua(le)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){Wi().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const i=Object.keys(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).length>0;i&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):i||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:fe+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[i,s,a,n]=await Promise.all([Si(this.hass),Ci(this.hass),(t=this.hass,t.callWS({type:fe+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),Li(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=i,this.zones=s,this._outlook=a,this._distributors=n,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),Ra(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",fe+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),Ra(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",fe+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),Ra(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const i="all"===t,s=i?void 0:this.zones.find(e=>{var i;return(null===(i=e.id)||void 0===i?void 0:i.toString())===t}),a=i?`(${this._linkedZoneCount})`:`: ${null!==(e=null==s?void 0:s.name)&&void 0!==e?e:t}`;try{await(n=this.hass,o=i?void 0:t,n.callWS(Object.assign({type:fe+"/irrigate_now"},void 0!==o?{zone_id:o}:{}))),La(this,`${Ea("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${a}`)}catch(e){const t=Ia(e);console.error("irrigate_now failed",e),La(this,`${Ea("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var n,o}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const i=new Date(t);return i.getTime()>Date.now()?i:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:fe+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),Ra(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:fe+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),Ra(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,i;const s=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(i=this._runMinutes[s])&&void 0!==i?i:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const i=this._zoneDistributor(e);return!!i&&Object.keys(null!==(t=i.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var i,s,a;if(t>0)try{await(i=this.hass,s=e.id.toString(),a=t,i.callWS({type:fe+"/run_zone",zone_id:s,duration:a})),La(this,`${Ea("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=Ia(e);console.error("run_zone failed",e),La(this,`${Ea("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===i?void 0:i[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,i;if(this.hass&&void 0!==e.id)try{await(t=this.hass,i=e.id.toString(),t.callWS({type:fe+"/stop_zone",zone_id:i})),La(this,`${Ea("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=Ia(e);console.error("stop_zone failed",e),La(this,`${Ea("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var i,s;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,s=t.id.toString(),i.callApi("POST",fe+"/zones",{id:s,calculate:!0,override_cache:!0})).catch(e=>{const t=Ia(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var i,s;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,s=t.id.toString(),i.callApi("POST",fe+"/zones",{id:s,update:!0})).catch(e=>{const t=Ia(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;Ma(0,t?Za("setup","zones",t):Za("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,i,s;const a=null!==(t=e.duration)&&void 0!==t?t:0,n=Number(null!==(i=e.bucket_threshold)&&void 0!==i?i:0),o=this._zoneEstimate(e),r=o&&o.available&&null!=o.live_deficit?o.live_deficit:Number(null!==(s=e.bucket)&&void 0!==s?s:0);return a>0&&r<n}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,i=new Date(e),s=Va(i),a=new Date;return Xa(i,a)?`${Ea("panels.zones.outlook.today",t)} ${s}`:Xa(i,function(e,t){const i=new Date(e.getTime());return i.setDate(i.getDate()+t),i}(a,1))?`${Ea("panels.zones.outlook.tomorrow",t)} ${s}`:function(e,t){const i=Ka(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(i)} ${Va(i)}`}(i,t)}_renderEstimatedTag(e){if(!this.hass||!e.estimated)return W``;const t=this.hass.language;return W`<span
      class="estimate-tag"
      title="${Ea("panels.zones.outlook.estimated_help",t)}"
      >${Ea("panels.zones.outlook.estimated",t)}<ha-icon
        icon="mdi:information-outline"
      ></ha-icon
    ></span>`}_guardLabel(e){return Ea(`panels.zones.outlook.checks.${e.id}`,this.hass.language)}_guardDetail(e){var t;return e.available&&null!==e.observed?Ea(`panels.zones.outlook.check_detail.${e.id}`,this.hass.language,"{observed}",String(e.observed),"{threshold}",String(null!==(t=e.threshold)&&void 0!==t?t:"")):""}_renderSkipReasons(){const e=this.hass.language;return W`
      ...
      <div class="outlook-line outlook-dim skip-reasons-note">
        ${Ea("panels.zones.outlook.provisional",e)}
      </div>
    `}_openSchedules(){Ma(0,Za("setup","when-to-water"))}_runActionLabel(e){return Ea(`panels.zones.outlook.actions.${e.action}`,this.hass.language)}_runTargetsLabel(e){const t=this.hass.language;if("all"===e.zones)return Ea("panels.zones.outlook.targets_all",t);const i=Array.isArray(e.zones)?e.zones.length:0;return Ea("panels.zones.outlook.targets_zones",t,"{count}",String(i))}_renderOutlookBanner(){if(!this.hass||!this._outlook)return W``;const e=this.hass.language,t=this._nextIrrigateRun,i=this._triggeredGuards,s=this._outlook.last_skip_evaluation;return t&&t.next_run_utc?W`
      <ha-card class="outlook-card">
        <div class="outlook">
          <div class="outlook-line outlook-headline">
            ...
            <span>
              <strong
                >${Ea("panels.zones.outlook.next_run",e)}:</strong
              >
          ...
          ${i.length>0?W`
                <div class="outlook-line outlook-skip">
                  ...
                  <span
                    >${Ea("panels.zones.outlook.will_skip",e)}</span
                  >
                  <button
                    class="outlook-info-btn"
                    aria-expanded="${this._skipDetailsOpen}"
                    title="${Ea("panels.zones.outlook.why_skipped",e)}"
                  ...
                  >
                    ...
                    <span class="outlook-info-label"
                      >${Ea("panels.zones.outlook.why_skipped",e)}</span
                    >
                  </button>
                </div>
              ...
              `:W`
                <div class="outlook-line outlook-clear">
                  ...
                  <span
                    >${Ea("panels.zones.outlook.will_run",e)}</span
                  >
                </div>
              `}
    ...
    `:W`
        <ha-card class="outlook-card">
          <div class="outlook">
            <div class="outlook-line outlook-headline">
              ...
              <span>${Ea("panels.zones.outlook.no_schedule",e)}</span>
              ${this.hideSettingsLinks?"":W`
                    <button
                      class="outlook-link"
                      @click="${this._openSchedules}"
                    >
                      ${Ea("panels.zones.outlook.setup_schedule",e)}
                    </button>
                  `}
            </div>
            ${s?this._renderLastRunLine(s):""}
        ...
        <ha-card class="rain-delay-card paused">
          <div class="rain-delay">
            ...
            <span class="rain-delay-msg">
              <strong
                >${Ea("panels.zones.rain_delay.paused",e)}</strong
              >
              ${Ea("panels.zones.rain_delay.until",e)}
              ${Ya(t.toISOString())}
            </span>
            <button class="action-btn" @click="${()=>this._clearRainDelay()}">
              <ha-icon icon="mdi:play"></ha-icon>
              ${Ea("panels.zones.rain_delay.resume",e)}
            </button>
          </div>
        </ha-card>
      `:W`
      <div class="rain-delay-row">
        <span class="rain-delay-label">
          ...
          ${Ea("panels.zones.rain_delay.title",e)}
        </span>
        <button class="action-btn" @click="${()=>this._setRainDelay(24)}">
          ${Ea("panels.zones.rain_delay.delay_24h",e)}
        </button>
        <button class="action-btn" @click="${()=>this._setRainDelay(48)}">
          ${Ea("panels.zones.rain_delay.delay_48h",e)}
        </button>
      </div>
    `}_renderLastRunLine(e){const t=this.hass.language,i=function(e,t){const i=Ka(e).getTime()-Date.now(),s=new Intl.RelativeTimeFormat(t,{numeric:"auto"}),a=Math.round(i/1e3);if(Math.abs(a)<60)return s.format(a,"second");const n=Math.round(a/60);if(Math.abs(n)<60)return s.format(n,"minute");const o=Math.round(n/60);if(Math.abs(o)<24)return s.format(o,"hour");const r=Math.round(o/24);if(Math.abs(r)<30)return s.format(r,"day");const l=Math.round(r/30);return Math.abs(l)<12?s.format(l,"month"):s.format(Math.round(l/12),"year")}(e.timestamp,t),s=e.checks.filter(e=>e.enabled&&e.would_skip).map(e=>this._guardLabel(e).toLowerCase()).join(", "),a=e.would_skip?`${Ea("panels.zones.outlook.last_run_skipped",t)}${s?` (${s})`:""}`:Ea("panels.zones.outlook.last_run_ran",t);return W`
      <div class="outlook-line outlook-last">
        <span class="outlook-dim"
          >${Ea("panels.zones.outlook.last_run",t)}:</span
        >
        <span>${a} · ${i}</span>
      </div>
    `}_renderZoneDecision(e){var t;if(!this.hass)return W``;const i=this.hass.language,s=null!==(t=e.duration)&&void 0!==t?t:0;let a,n,o,r;if(e.state===Fa.Disabled)a=Ea("panels.zones.status.decision_disabled",i),n="neutral",o="mdi:power-off";else if(e.last_calculated)if(this._zoneHasDeficit(e)){const t=Na(s),l=this._triggeredGuards,d=this._nextIrrigateRunForZone(e);l.length>0?(a=Ea("panels.zones.status.decision_water_skip",i,"{duration}",t,"{reason}",this._guardLabel(l[0]).toLowerCase()),n="skip",o="mdi:weather-rainy"):d&&d.next_run_utc?(a=Ea("panels.zones.status.decision_water_at",i,"{duration}",t,"{time}",this._formatRunTime(d.next_run_utc)),n="water",o="mdi:water",r=d):(a=Ea("panels.zones.status.decision_water_no_schedule",i,"{duration}",t),n="water",o="mdi:water-alert")}else a=Ea("panels.zones.status.decision_no_water",i),n="ok",o="mdi:check-circle-outline";else a=Ea("panels.zones.status.decision_unknown",i),n="unknown",o="mdi:help-circle-outline";return W`
      <div class="zone-decision ${n}">
        <ha-icon icon="${o}"></ha-icon>
        <span>${a}</span>
        ${r?this._renderEstimatedTag(r):""}
      </div>
    `}_zoneEstimate(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_estimates)||void 0===i?void 0:i[String(e.id)]}_zoneFault(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_faults)||void 0===i?void 0:i[String(e.id)]}_renderZoneFault(e){if(!this.hass)return W``;const t=this._zoneFault(e);if(!t)return W``;const i=this.hass.language,s=Ea(`panels.zones.fault.${t.reason}`,i)||Ea("panels.zones.fault.generic",i),a=t.timestamp?Ya(t.timestamp):"";return W`
      <div class="zone-fault" title="${a}">
        <ha-icon icon="mdi:alert-circle"></ha-icon>
        <span>
          <strong>${Ea("panels.zones.fault.title",i)}</strong>
          — ${s}
        </span>
      </div>
    `}_zoneSkip(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_skips)||void 0===i?void 0:i[String(e.id)]}_renderZoneSkip(e){if(!this.hass)return W``;const t=this._zoneSkip(e);if(!t)return W``;const i=this.hass.language,s=Ea("panels.zones.skip.soil_moisture",i,"{observed}",String(t.observed),"{threshold}",String(t.threshold)),a=t.timestamp?Ya(t.timestamp):"";return W`
      <div class="zone-skip" title="${a}">
        <ha-icon icon="mdi:water-off"></ha-icon>
        <span>
          <strong>${Ea("panels.zones.skip.title",i)}</strong>
          — ${s}
        </span>
      </div>
    `}_durationClamped(e){var t,i;if(e.state!==Fa.Automatic)return!1;const s=e.maximum_duration;if(null==s||s<0)return!1;const a=null!==(t=e.duration)&&void 0!==t?t:0;return!(a<=0)&&a-(null!==(i=e.lead_time)&&void 0!==i?i:0)>=s}_renderDurationClamped(e){var t;if(!this.hass||!this._durationClamped(e))return W``;const i=this.hass.language,s=Ea("panels.zones.clamped.detail",i,"{maximum}",Na(null!==(t=e.maximum_duration)&&void 0!==t?t:0));return W`
      <div class="zone-clamped" title="${s}">
        <ha-icon icon="mdi:timer-alert-outline"></ha-icon>
        <span>
          <strong>${Ea("panels.zones.clamped.title",i)}</strong>
          <ha-icon
            class="clamped-hint"
            icon="mdi:information-outline"
          ></ha-icon>
    ...
    `}_renderZoneEstimate(e){if(!this.hass)return W``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return W``;const i=this.hass.language,s=Ha(this.config,ft),a=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",n=Ea(`panels.zones.status.estimate_method.${"proxy"===t.method||"hourly_sensor"===t.method?t.method:"hourly"}`,i)+(t.as_of?` · ${Va(t.as_of)}`:"");return W`
      <span class="status-sep">·</span>
      <span class="zone-estimate" title="${n}">
        ${Ea("panels.zones.status.estimate_now",i)}
        <strong style="color: ${a}"
          >≈ ${t.live_deficit.toFixed(2)} ${s}</strong
        >
        <span class="estimate-tag"
          >${Ea("panels.zones.status.estimate_tag",i)}</span
        >
      </span>
    `}_renderZoneNextRun(e){if(!this.hass)return W``;const t=this._nextIrrigateRunForZone(e);if(!t||!t.next_run_utc)return W``;return e.state!==Fa.Disabled&&e.last_calculated&&this._zoneHasDeficit(e)&&0===this._triggeredGuards.length?W``:W`
      <span class="status-sep">·</span>
      <span>
        ${Ea("panels.zones.outlook.next_run",this.hass.language)}:
        <strong>${this._formatRunTime(t.next_run_utc)}</strong>
        ${this._renderEstimatedTag(t)}
      </span>
    `}renderZone(e,t){var i;if(!this.hass)return W``;const s=Number(null!==(i=e.bucket)&&void 0!==i?i:0),a=s<0?"var(--warning-color)":"var(--success-color)",n=e.state===Fa.Automatic?"state-automatic":e.state===Fa.Manual?"state-manual":"state-disabled",o=e.last_calculated?Ya(e.last_calculated):Ea("panels.zones.status.never",this.hass.language);return W`
      <ha-card>
        <div class="card-header">
          <div class="name">${e.name}</div>
          <span class="zone-state-badge ${n}">
            ${Ea(`panels.zones.labels.states.${e.state}`,this.hass.language)}
          </span>
          ${this.hideSettingsLinks?"":W`
                <ha-icon-button
                  ...
                  title="${Ea("panels.zones.actions.open_settings",this.hass.language)}"
        ...
        <div class="card-content">
          <div class="zone-status-line">
            <span
              title="${Ea("panels.zones.help.bucket",this.hass.language)}"
            >
              ${Ea("panels.zones.labels.bucket",this.hass.language)}:
              <strong style="color: ${a}"
                >${s.toFixed(2)}
                ${Ha(this.config,ft)}</strong
              >
            </span>
            <span class="status-sep">·</span>
            <span>
              ${Ea("panels.zones.status.last_checked",this.hass.language)}:
              <strong>${o}</strong>
            </span>
        ...
        <div class="card-content zone-action-bar">
          ${"full"===this.actionsMode&&e.state===Fa.Automatic?W`
                <button
                  class="action-btn"
                  title="${Ea("panels.zones.help.update",this.hass.language)}"
                  @click="${()=>this.handleUpdateZone(t)}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:update"></ha-icon>
                  ${Ea("panels.zones.actions.update",this.hass.language)}
                </button>
                <button
                  class="action-btn"
                  title="${Ea("panels.zones.help.calculate",this.hass.language)}"
                  @click="${()=>this.handleCalculateZone(t)}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:calculator"></ha-icon>
                  ${Ea("panels.zones.actions.calculate",this.hass.language)}
                </button>
              `:""}
          ${"none"!==this.actionsMode&&this._canActuate(e)&&this._zoneHasDeficit(e)?W`
                ...
                >
                  ...
                  ${Ea("panels.zones.labels.irrigate_now",this.hass.language)}
                </button>
              `:this._canActuate(e)?"":W`
                  <button
                    class="action-btn"
                    disabled
                    title="${Ea("panels.zones.help.irrigate_link_entity",this.hass.language)}"
                  >
                    <ha-icon icon="mdi:water"></ha-icon>
                    ${Ea("panels.zones.labels.irrigate_now",this.hass.language)}
                  </button>
                  <span class="zones-top-note">
                    ${Ea("panels.zones.help.irrigate_link_entity",this.hass.language)}
                  </span>
                `}
    ...
    `}_renderRunZoneControl(e){if(!this.hass||"none"===this.actionsMode||!this._canActuate(e)||void 0===e.id)return W``;const t=this.hass.language,i=String(e.id),s=this._activeRun(e);if(s){const i=this._runSecondsLeft(s);return W`
        <div class="run-zone-control running">
          <span class="run-zone-countdown">
            ...
            ${null===i?Ea("panels.zones.stop_zone.watering",t):this._formatCountdown(i)}
          </span>
          <button
          ...
          >
            ...
            ${Ea("panels.zones.stop_zone.stop",t)}
          </button>
        </div>
      ...
      <div class="run-zone-control-wrap">
        <div
          ...
          title="${Ea("panels.zones.run_zone.help",t)}"
        >
          <input
          ...
          <span class="run-zone-unit"
            >${Ea("panels.zones.run_zone.minutes",t)}</span
          >
          <button
            class="action-btn"
          ...
          >
            ...
            ${Ea("panels.zones.run_zone.run",t)}
          </button>
        </div>
        ${a?W`<span class="run-zone-busy-hint">
              ${Ea("panels.zones.run_zone.busy_hint",t)}
            </span>`:""}
      </div>
    `}_formatCountdown(e){const t=Math.max(0,e),i=Math.floor(t/3600),s=Math.floor(t%3600/60),a=t%60,n=e=>String(e).padStart(2,"0");return i>0?`${i}:${n(s)}:${n(a)}`:`${s}:${n(a)}`}render(){var e,t;if(!this.hass)return W``;if(this.isLoading)return W`
        <ha-card header="${Ea("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            <div class="loading-indicator">
              ${Ea("common.loading-messages.general",this.hass.language)}
            </div>
          </div>
        </ha-card>
      ...
      ${s?this.hideSettingsLinks?W`
              <ha-card>
                <div class="card-content description-text">
                  ${Ea("panels.zones.no_items",this.hass.language)}
                </div>
              </ha-card>
            `:W`
                ...
                <div class="setup-banner">
                  ...
                  <div class="setup-banner-content">
                    <div class="setup-banner-title">
                      ${Ea("wizard.title",this.hass.language)}
                    </div>
                    <div class="setup-banner-desc">
                      ${Ea("wizard.setup_complete_banner",this.hass.language)}
                    </div>
                  </div>
                  <button
                  ...
                  >
                    ${Ea("wizard.open_wizard",this.hass.language)}
                  </button>
                </div>
              </ha-card>
            `:""}
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${Ea("panels.zones.title",this.hass.language)}
          </div>
        </div>
        <div class="card-content zones-top-actions">
          ${"full"===this.actionsMode?W`
                <button
                  class="action-btn"
                  title="${Ea("panels.zones.help.update_all",this.hass.language)}"
                  @click="${this.handleUpdateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:update"></ha-icon>
                  ${Ea("panels.zones.cards.zone-actions.actions.update-all",this.hass.language)}
                </button>
                <button
                  class="action-btn"
                  title="${Ea("panels.zones.help.calculate_all",this.hass.language)}"
                  @click="${this.handleCalculateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:calculator"></ha-icon>
                  ${Ea("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language)}
                </button>
              `:""}
          ${"none"!==this.actionsMode?W`
                <button
                  class="action-btn"
                  raised
                  title="${Ea("panels.zones.help.irrigate_all",this.hass.language)}"
                  @click="${()=>{this._confirmIrrigate="all"}}"
                  ?disabled="${!i||this.isSaving}"
                >
                  <ha-icon icon="mdi:water"></ha-icon>
                  ${Ea("panels.zones.actions.irrigate_all",this.hass.language)}
                </button>
              `:""}
          ${i?"":W`<span class="zones-top-note"
                >${Ea("panels.info.cards.irrigate_now.no_linked_zones",this.hass.language)}</span
              >`}
        </div>
      </ha-card>
      ...
      ${null!==this._confirmIrrigate?W`
            <ha-dialog
              ...
              heading="${Ea("panels.zones.confirm_irrigate.title",this.hass.language)}"
            >
              <p>
                ${Ea("panels.zones.confirm_irrigate.body",this.hass.language)}
              </p>
              <p>
                <strong>
                  ${"all"===this._confirmIrrigate?`${Ea("panels.zones.confirm_irrigate.all_linked_zones",this.hass.language)} (${this._linkedZoneCount})`:null!==(t=null===(e=this.zones.find(e=>{var t;return(null===(t=e.id)||void 0===t?void 0:t.toString())===this._confirmIrrigate}))||void 0===e?void 0:e.name)&&void 0!==t?t:this._confirmIrrigate}
                </strong>
              </p>
              <div class="dialog-footer">
                ...
                >
                  ${Ea("common.actions.cancel",this.hass.language)}
                </button>
                <button
            ...
            <ha-card class="error-banner-card">
              <div class="error-banner">
                ...
                <ha-icon-button
                  ...
                  aria-label="${Ea("common.actions.cancel",this.hass.language)}"
                ></ha-icon-button>
              </div>
            </ha-card>
          `:""}
    ...
    `}}t([pe()],Ja.prototype,"config",void 0),t([pe({type:Boolean})],Ja.prototype,"hideSettingsLinks",void 0),t([pe({attribute:!1})],Ja.prototype,"actionsMode",void 0),t([pe({type:Array})],Ja.prototype,"zones",void 0),t([ge()],Ja.prototype,"_outlook",void 0),t([ge()],Ja.prototype,"_distributors",void 0),t([pe({type:Boolean})],Ja.prototype,"isLoading",void 0),t([pe({type:Boolean})],Ja.prototype,"isSaving",void 0),t([ge()],Ja.prototype,"_operationError",void 0),t([ge()],Ja.prototype,"_confirmIrrigate",void 0),t([ge()],Ja.prototype,"_skipDetailsOpen",void 0),t([ge()],Ja.prototype,"_runMinutes",void 0),t([ge()],Ja.prototype,"_now",void 0),customElements.get("smart-irrigation-view-zones")||customElements.define("smart-irrigation-view-zones",Ja)
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */;const Qa={},en=Vi(class extends Yi{constructor(e){if(super(e),e.type!==Gi&&e.type!==Zi&&e.type!==Ki)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===Z||t===q)return t;const i=e.element,s=e.name;if(e.type===Gi){if(t===i[s])return Z}else if(e.type===Ki){if(!!t===i.hasAttribute(s))return Z}else if(e.type===Zi&&i.getAttribute(s)===t+"")return Z;return((e,t=Qa)=>{e._$AH=t;
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */})(e),t}});let tn=class extends le{constructor(){super(...arguments),this.label="",this.unit="",this.help="",this.required=!1,this._helpOpen=!1}_toggleHelp(){this._helpOpen=!this._helpOpen}render(){return W`
      <div class="si-field">
    ...
    `}_renderServiceAndKey(e){return W`
      <si-field
        label="${Ea("weather_service_config.service_label",e)}"
      >
        <select
          class="si-input"
          .value="${en(this.service||ze)}"
        ...
        >
          ...
          >
            ${Ea("weather_service_config.openmeteo",e)}
          </option>
          <option
            value="${xe}"
            ?selected="${this.service===xe}"
          >
            ${Ea("weather_service_config.owm",e)}
          </option>
          <option
            value="${ke}"
            ?selected="${this.service===ke}"
          >
            ${Ea("weather_service_config.pw",e)}
          </option>
          <option
            value="${Se}"
            ?selected="${this.service===Se}"
          >
            ${Ea("weather_service_config.met",e)}
          </option>
        </select>
      </si-field>

      ${this._needsKey?this._renderKeyField(e):W`<div class="info-note">
            ${Ea("weather_service_config.no_api_key_needed",e)}
          </div>`}
    `}_renderKeyField(e){var t;const i=this._hasStoredKey;return W`
      <si-field
        label="${Ea("weather_service_config.api_key_label",e)}"
        help="${Ea("weather_service_config.api_key_help",e)}"
      >
        <span class="api-badge ${i?"configured":"missing"}"
          >${Ea(i?"weather_service_config.api_key_configured":"weather_service_config.api_key_not_configured",e)}</span
        >
        <div class="api-row">
          <input
            type="password"
            class="si-input flex1"
            placeholder="${Ea("weather_service_config.api_key_placeholder",e)}"
            .value="${this.apiKey}"
          ...
          >
            ${this._testing?Ea("weather_service_config.test_button_testing",e):Ea("weather_service_config.test_button",e)}
          </button>
        </div>
        ${null!==this._testResult?W`<div
              class="test-result ${this._testResult.success?"success":"error"}"
            >
              ${this._testResult.success?Ea("weather_service_config.test_success",e):Ea("weather_service_config.test_error_"+(null!==(t=this._testResult.error)&&void 0!==t?t:"unknown"),e)}
            </div>`:""}
      </si-field>
    `}static get styles(){return r`
      :host {
    ...
    `}};t([pe({attribute:!1})],sn.prototype,"hass",void 0),t([pe({type:Boolean})],sn.prototype,"useWeather",void 0),t([pe()],sn.prototype,"service",void 0),t([pe()],sn.prototype,"apiKey",void 0),t([pe({attribute:!1})],sn.prototype,"weatherConfig",void 0),t([ge()],sn.prototype,"_testing",void 0),t([ge()],sn.prototype,"_testResult",void 0),sn=t([ce("si-weather-source-config")],sn);let an=class extends(Ua(le)){constructor(){super(...arguments),this.section="all",this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._weatherConfig=null,this._weatherService=null,this._useWeatherService=!1,this._newApiKey="",this._weatherSaving=!1,this._coords=null,this._coordsEnabled=!1,this._coordsLat="",this._coordsLon="",this._coordsElev="",this._coordsSaving=!1,this._saveStatus="idle",this._savedResetTimer=null,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null,t={};return i=>{t=Object.assign(Object.assign({},t),i),e&&clearTimeout(e),e=window.setTimeout(()=>{const i=t;t={},e=null,this.saveData(i)},500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:fe+"_config_updated"})]}async _fetchData(){var e;if(!this.hass)return;const t=!this._initialLoadDone;t&&(this.isLoading=!0,this._scheduleUpdate());try{const[t,a,n]=await Promise.all([Si(this.hass),Pi(this.hass),Ui(this.hass)]);this.config=t,this._weatherConfig=a,this._useWeatherService=a.use_weather_service,this._weatherService=null!==(e=a.weather_service)&&void 0!==e?e:ze,this._applyCoordinates(n),this.data=(i=this.config,s=["calctime","autocalcenabled","autocalcmode","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","days_between_irrigation"],i?Object.entries(i).filter(([e])=>s.includes(e)).reduce((e,[t,i])=>Object.assign(e,{[t]:i}),{}):{}),this._initialLoadDone=!0}catch(e){console.error("Error fetching data:",e),Ra(this,this.hass,"common.errors.load_failed",e)}finally{t&&(this.isLoading=!1),this._scheduleUpdate()}var i,s}firstUpdated(){Wi().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}render(){var e,t;return this.hass&&this.config&&this.data?this.isLoading?W`<div class="loading-indicator">
        ${Ea("common.loading-messages.general",this.hass.language)}
      </div>`:W`${this._renderSaveStatus()} ${this._renderCards()}`:W`<div class="loading-indicator">
        ${Ea("common.loading-messages.configuration",null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en")}
      ...
      <div class="settings-section-header">
        ${Ea(`panels.general.sections.${e}`,this.hass.language)}
      </div>
    `:W``}async _saveWeatherConfig(){if(this.hass){this._weatherSaving=!0,this._scheduleUpdate();try{await Bi(this.hass,this._useWeatherService,this._useWeatherService?this._weatherService:null,this._newApiKey||null),this._newApiKey="",await this._fetchData()}catch(e){console.error("Failed to save weather config:",e),Ra(this,this.hass,"common.errors.save_failed",e)}finally{this._weatherSaving=!1,this._scheduleUpdate()}}}_renderWeatherServiceCard(){var e;return this.hass?W`
      <ha-card
        header="${Ea("weather_service_config.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Ea("weather_service_config.description",this.hass.language)}
        </div>
        <div class="card-content">
          ...
          <div style="margin-top: 12px;">
            ...
            >
              ${this._weatherSaving?Ea("common.saving-messages.saving",this.hass.language):Ea("weather_service_config.save_button",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    `:W``}_renderAutoUpdateCard(){var e,t;return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${Ea("panels.general.cards.automatic-update.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Ea("panels.general.cards.automatic-update.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Ea("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}
            </label>
            <ha-switch
          ...
          ${this.data.autoupdateenabled?W`
                <div class="setting-row">
                  <label>
                    ${Ea("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}
                  </label>
                  <div class="inline-row">
                    ...
                    <select
                      ...
                      .value="${en(this.data.autoupdateschedule||Ce)}"
                    ...
                    >
                      ...
                      >
                        ${Ea("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
                      </option>
                      <option
                        value="${Ce}"
                        ?selected="${(this.data.autoupdateschedule||Ce)===Ce}"
                      >
                        ${Ea("panels.general.cards.automatic-update.options.hours",this.hass.language)}
                      </option>
                      <option
                        value="${Ee}"
                        ?selected="${this.data.autoupdateschedule===Ee}"
                      >
                        ${Ea("panels.general.cards.automatic-update.options.days",this.hass.language)}
                      </option>
                    </select>
                  </div>
                </div>
                <div class="setting-row">
                  <label>
                    ${Ea("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language)}
                    (s)
                  </label>
                  <input
                    type="number"
    ...
    `:W``}_renderAutoCalcCard(){return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${Ea("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Ea("panels.general.cards.automatic-duration-calculation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Ea("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}
            </label>
            <ha-switch
    ...
    `:W``}_renderAutoCalcMode(){if(!this.hass||!this.config)return W``;const e=this.hass.language,t=ye.includes(this.config.autocalcmode)?this.config.autocalcmode:be;return W`
      <div class="setting-row">
        <label>
          ${Ea("panels.general.cards.automatic-duration-calculation.labels.calc-mode",e)}
        </label>
        <select
          class="settings-input"
          .value="${en(t)}"
        ...
        >
          ${ye.map(i=>W`
              <option value="${i}" ?selected="${t===i}">
                ${Ea(`panels.general.cards.automatic-duration-calculation.modes.${i}`,e)}
              </option>
            `)}
        </select>
      </div>
      ${t===be?W`
            <div class="setting-row">
              <label>
                ${Ea("panels.general.cards.automatic-duration-calculation.labels.calc-time",e)}
              </label>
              <input
                type="text"
                class="settings-input shortfield"
          ...
          `:W`
            <div class="card-content description-text">
              ${Ea("panels.general.cards.automatic-duration-calculation.help.before-run",e)}
            </div>
          `}
    `}_renderRunHistoryLoggingCard(){return this.hass&&this.config?W`
      <ha-card
        header="${Ea("panels.general.cards.run-history-logging.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Ea("panels.general.cards.run-history-logging.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Ea("panels.general.cards.run-history-logging.labels.log-no-demand",this.hass.language)}
            </label>
            <ha-switch
    ...
    `:W``}_renderWeatherSkipCard(){var e,t,i,s,a;if(!this.hass||!this.config||!this.data)return W``;const n=this.hass.language,o=this.config.skip_irrigation_on_precipitation?"skip":this.config.forecast_weighting_enabled?"water_less":"ignore";return W`
      <ha-card header="${Ea("weather_skip.title",this.hass.language)}">
        <div class="card-content description-text">
          ${Ea("weather_skip.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Ea("weather_skip.forecast_rain_label",n)}
            </label>
            <select
              class="settings-input"
              .value="${en(o)}"
            ...
            >
              ${["ignore","water_less","skip"].map(e=>W`
                  <option value="${e}" ?selected="${o===e}">
                    ${Ea(`weather_skip.forecast_rain_options.${e}`,n)}
                  </option>
                `)}
            </select>
          </div>
          <div class="description-text">
            ${Ea(`weather_skip.forecast_rain_help.${o}`,n)}
          </div>
          ${"ignore"!==o?W`
                <div class="setting-row">
                  <label>
                    ${Ea("weather_skip.lookahead_label",n)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="description-text">
                  ${Ea("weather_skip.lookahead_help",n)}
                </div>
              `:""}
          ${"skip"===o?W`
                <div class="setting-row">
                  <label>
                    ${Ea("weather_skip.threshold_label",n)}
                    (${Ha(this.config,we)})
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Ea("weather_skip.temp_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Ea("weather_skip.temp_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_temp_enabled?W`
                <div class="setting-row">
                  <label>
                    ${Ea("weather_skip.temp_threshold_label",this.hass.language)}
                    (°C)
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Ea("weather_skip.wind_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Ea("weather_skip.wind_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_wind_enabled?W`
                <div class="setting-row">
                  <label>
                    ${Ea("weather_skip.wind_threshold_label",this.hass.language)}
                    (m/s)
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Ea("weather_skip.freeze_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Ea("weather_skip.freeze_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_freeze_enabled?W`
                <div class="setting-row">
                  <label>
                    ${Ea("weather_skip.freeze_threshold_label",this.hass.language)}
                    (°C)
                  </label>
                  <input
                    type="number"
                ...
                <div class="description-text">
                  ${Ea("weather_skip.freeze_help",this.hass.language)}
                </div>
              `:""}

          <div class="section-divider">
            ${Ea("weather_skip.rain_sensor_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Ea("weather_skip.rain_sensor_label",this.hass.language)}
            </label>
            <ha-entity-picker
              .hass="${this.hass}"
    ...
    `}_applyCoordinates(e){this._coords=e,this._coordsEnabled=e.manual_coordinates_enabled;const t=(e,t)=>null!=e?String(e):null!=t?String(t):"";this._coordsLat=t(e.manual_latitude,e.ha_latitude),this._coordsLon=t(e.manual_longitude,e.ha_longitude),this._coordsElev=t(e.manual_elevation,e.ha_elevation)}async _saveCoordinates(){if(this.hass){this._coordsSaving=!0,this._scheduleUpdate();try{await(e=this.hass,t=this._coordsEnabled,i=this._coordsEnabled?parseFloat(this._coordsLat):null,s=this._coordsEnabled?parseFloat(this._coordsLon):null,a=this._coordsEnabled?parseFloat(this._coordsElev):null,e.callWS({type:fe+"/coordinates_save",manual_coordinates_enabled:t,manual_latitude:null!=i?i:null,manual_longitude:null!=s?s:null,manual_elevation:null!=a?a:null})),this._applyCoordinates(await Ui(this.hass))}catch(e){console.error("Failed to save coordinates:",e),Ra(this,this.hass,"common.errors.save_failed",e)}finally{this._coordsSaving=!1,this._scheduleUpdate()}var e,t,i,s,a}}_renderCoordinateCard(){var e,t,i;if(!this.hass||!this._coords)return W``;const s=this._coords;return W`
      <ha-card
        header="${Ea("coordinate_config.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Ea("coordinate_config.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Ea("coordinate_config.manual_enabled",this.hass.language)}
            </label>
            <ha-switch
          ...
          ${this._coordsEnabled?W`
                <div class="setting-row">
                  <label>
                    ${Ea("coordinate_config.latitude",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="setting-row">
                  <label>
                    ${Ea("coordinate_config.longitude",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="setting-row">
                  <label>
                    ${Ea("coordinate_config.elevation",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
              ...
              `:W`
                ...
                >
                  ${Ea("coordinate_config.current_ha_coords",this.hass.language)}:
                  ${Ea("coordinate_config.latitude",this.hass.language)}:
          ...
          <div style="margin-top: 12px;">
            ...
            >
              ${this._coordsSaving?Ea("common.saving-messages.saving",this.hass.language):Ea("common.actions.save",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    `}_renderDaysBetweenIrrigationCard(){var e;return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${Ea("days_between_irrigation.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Ea("days_between_irrigation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Ea("days_between_irrigation.label",this.hass.language)}
              <div class="setting-description">
                ${Ea("days_between_irrigation.help_text",this.hass.language)}
              </div>
            </label>
            <input
              type="number"
    ...
    `:W``}_renderZoneSequencingCard(){var e,t;if(!this.hass||!this.config||!this.data)return W``;const i=(this.config.zone_sequencing||Ft)===Wt;return W`
      <ha-card
        header="${Ea("zone_sequencing.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Ea("zone_sequencing.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Ea("zone_sequencing.title",this.hass.language)}
            </label>
            <select
              class="settings-input"
              .value="${en(this.config.zone_sequencing||Ft)}"
            ...
            >
              ...
              >
                ${Ea("zone_sequencing.parallel",this.hass.language)}
              </option>
              <option
                value="${jt}"
                ?selected="${this.config.zone_sequencing===jt}"
              >
                ${Ea("zone_sequencing.sequential",this.hass.language)}
              </option>
              <option
                value="${Wt}"
                ?selected="${this.config.zone_sequencing===Wt}"
              >
                ${Ea("zone_sequencing.rotating",this.hass.language)}
              </option>
            </select>
          </div>
          ${i?W`
                <div class="setting-row">
                  <label>
                    ${Ea("zone_sequencing.max_consecutive_duration_label",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    min="1"
                  ...
                  <span class="unit-label">
                    ${Ea("zone_sequencing.max_consecutive_duration_unit",this.hass.language)}
                  </span>
                </div>
                <div class="setting-row">
                  <label>
                    ${Ea("zone_sequencing.min_absorption_time_label",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    min="0"
                  ...
                  />
                  <span class="unit-label">
                    ${Ea("zone_sequencing.min_absorption_time_unit",this.hass.language)}
                  </span>
                </div>
              `:""}
        </div>
    ...
    `}_renderMasterSwitchCard(){var e,t;if(!this.hass||!this.config)return W``;const i=!!this.config.master_kick_enabled;return W`
      <ha-card header="${Ea("master.title",this.hass.language)}">
        <div class="card-content description-text">
          ${Ea("master.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${Ea("master.entity",this.hass.language)}</label>
            <ha-entity-picker
              .hass="${this.hass}"
          ...
          ${this.config.master_entity?W`
                <div class="setting-row">
                  <label
                    >${Ea("master.kick_enabled",this.hass.language)}</label
                  >
                  <ha-switch
                    .checked="${i}"
                ...
                ${i?W`
                      <div class="setting-row">
                        <label>
                          ${Ea("master.kick_pause",this.hass.language)}
                        </label>
                        <input
                          type="number"
                          min="0"
                        ...
                        />
                        <span class="unit-label">
                          ${Ea("master.seconds_unit",this.hass.language)}
                        </span>
                      </div>
                    `:""}
                <div class="setting-row">
                  <label
                    >${Ea("master.settle",this.hass.language)}</label
                  >
                  <input
                    type="number"
                    min="0"
                ...
                <div class="setting-row">
                  <label
                    >${Ea("master.off_after",this.hass.language)}</label
                  >
                  <ha-switch
    ...
    `}};t([pe()],an.prototype,"narrow",void 0),t([pe()],an.prototype,"path",void 0),t([pe()],an.prototype,"section",void 0),t([pe()],an.prototype,"data",void 0),t([pe()],an.prototype,"config",void 0),t([pe({type:Boolean})],an.prototype,"isLoading",void 0),t([pe({type:Boolean})],an.prototype,"isSaving",void 0),t([pe()],an.prototype,"_weatherConfig",void 0),t([pe()],an.prototype,"_weatherService",void 0),t([pe({type:Boolean})],an.prototype,"_useWeatherService",void 0),t([pe()],an.prototype,"_newApiKey",void 0),t([pe({type:Boolean})],an.prototype,"_weatherSaving",void 0),t([ge()],an.prototype,"_coords",void 0),t([ge()],an.prototype,"_coordsEnabled",void 0),t([ge()],an.prototype,"_coordsLat",void 0),t([ge()],an.prototype,"_coordsLon",void 0),t([ge()],an.prototype,"_coordsElev",void 0),t([ge()],an.prototype,"_coordsSaving",void 0),t([ge()],an.prototype,"_saveStatus",void 0),an=t([ce("smart-irrigation-view-general")],an);const nn=e=>9*e/5+32;function on(e,t,i){if(null==e||Number.isNaN(e))return null;switch(t){case"temperature":return i?{value:e,unit:"°C"}:{value:nn(e),unit:"°F"};case"precipitation":return i?{value:e,unit:at}:{value:(n=e,n/25.4),unit:nt};case"windspeed":return i?{value:e,unit:lt}:{value:(a=e,2.2369362920544*a),unit:rt};case"pressure":return i?{value:e,unit:"hPa"}:{value:(s=e,.0295299830714*s),unit:ot}}var s,a,n}function rn(e,t,i,s){const a=on(e,t,i);if(!a)return"-";const n=function(e,t){return"pressure"===e?t?0:2:"precipitation"===e?t?1:2:1}(t,i);return`${a.value.toFixed(n)} ${a.unit}`}function ln(e,t){return null==e||Number.isNaN(e)?"-":t?`${e.toFixed(0)} L`:`${(e=>.264172052*e)(e).toFixed(1)} gal`}let dn=class extends le{constructor(){super(...arguments),this.metric=!0,this.name="",this.size="",this.throughput="",this.linkedEntity="",this.showEntity=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{value:t},bubbles:!0,composed:!0}))}render(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",s=this.metric?"m²":et,a=this.metric?tt:it;return W`
      <si-field label="${Ea("panels.zones.labels.name",i)}" required>
        <input
          type="text"
          class="si-input"
          .value="${this.name}"
      ...
      <si-field
        label="${Ea("panels.zones.labels.size",i)}"
        unit="${s}"
        help="${Ea("field_help.zone_size",i)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      <si-field
        label="${Ea("panels.zones.labels.throughput",i)}"
        unit="${a}"
        help="${Ea("field_help.zone_throughput",i)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      ${this.showEntity?W`
            <si-field
              label="${Ea("panels.zones.labels.linked_entity",i)}"
              help="${Ea("field_help.zone_linked_entity",i)}"
            >
              <ha-entity-picker
                .hass="${this.hass}"
    ...
    `}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await Ei(this.hass,e)}_renderModuleOptions(e){if(!this.hass)return W``;const t=null!=e?String(e):"";return W`
      <option value="" ?selected="${""===t}">
        ---${Ea("common.labels.select",this.hass.language)}---
      </option>
    ...
    `}_renderDistributorSelector(e,t){var i,s;if(!this.hass)return W``;if(!(null===(i=this.config)||void 0===i?void 0:i.distributors_enabled))return W``;const a=this.hass.language,n=null!=e.distributor_id;return W`
      <ha-settings-row>
        <span slot="heading"
          >${Ea("panels.zones.labels.distributor",a)}</span
        >
        <span slot="description"
          >${Ea("panels.zones.labels.distributor_help",a)}</span
        >
        <select
          class="settings-input"
          .value="${en(n?String(e.distributor_id):"")}"
          @change="${i=>this._onZoneDistributorChange(t,e,i)}"
        >
          <option value="" ?selected="${!n}">
            ${Ea("panels.zones.labels.distributor_none",a)}
          </option>
      ...
      ${n?W`
            <ha-settings-row>
              <span slot="heading"
                >${Ea("panels.zones.labels.outlet_number",a)}</span
              >
              <span slot="description"
                >${Ea("panels.zones.labels.outlet_number_readonly_help",a)}</span
              >
        ...
        ${b?W`
             ...
             used to sit alongside it moved to the Weather & Location tab). -->
              <div class="card-content zone-settings">
                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.name",this.hass.language)}</span
                  >
                  <input
                    type="text"
                    class="settings-input"
                    .value="${e.name}"
                    @input="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ht]:i.target.value}))}"
                  />
                </ha-settings-row>

                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.size",this.hass.language)}
                    (${Ha(this.config,ut)})</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.throughput",this.hass.language)}
                    (${Ha(this.config,pt)})</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                    ...
                    @input="${i=>{const s=Math.round(100*i.target.valueAsNumber)/100;isNaN(s)||this.handleEditZone(t,Object.assign(Object.assign({},e),{[pt]:s}))}}"
                  />
                </ha-settings-row>

                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.soil_type",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Ea("field_help.zone_soil_type",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${en(null!==(s=Object.keys(Bt).find(t=>Bt[t]===e.drainage_rate))&&void 0!==s?s:"custom")}"
                    @change="${i=>{const s=i.target.value;"custom"!==s&&void 0!==Bt[s]&&this.handleEditZone(t,Object.assign(Object.assign({},e),{[xt]:Bt[s]}))}}"
                  >
                    <option
                      value="custom"
                      ?selected="${!Object.values(Bt).includes(null!==(a=e.drainage_rate)&&void 0!==a?a:-1)}"
                    >
                      ${Ea("panels.zones.labels.soil_types.custom",this.hass.language)}
                    </option>
                    ${Object.keys(Bt).map(t=>W`
                        ...
                        >
                          ${Ea(`panels.zones.labels.soil_types.${t}`,this.hass.language)}
                        </option>
                      `)}
                  </select>
                </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.drainage_rate",this.hass.language)}
                    (${Ha(this.config,xt)})</span
                  >
                  <span slot="description"
                    >${Ea("field_help.zone_drainage_rate",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                    ...
                    @input="${i=>{const s=Math.round(100*i.target.valueAsNumber)/100;isNaN(s)||this.handleEditZone(t,Object.assign(Object.assign({},e),{[xt]:s}))}}"
                  />
                </ha-settings-row>

                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.plant_type",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Ea("field_help.zone_plant_type",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${en(null!==(o=e.plant_type)&&void 0!==o?o:"custom")}"
                    @change="${i=>{const s=i.target.value,a={[zt]:s};"custom"!==s&&void 0!==Pt[s]&&(a.kc=Pt[s]),this.handleEditZone(t,Object.assign(Object.assign({},e),a))}}"
                  >
                    <option
                      value="custom"
                      ?selected="${"custom"===(null!==(r=e.plant_type)&&void 0!==r?r:"custom")}"
                    >
                      ${Ea("panels.zones.labels.plant_types.custom",this.hass.language)}
                    </option>
                    ${Object.keys(Pt).map(t=>W`
                        ...
                        >
                          ${Ea(`panels.zones.labels.plant_types.${t}`,this.hass.language)}
                        </option>
                      `)}
                  </select>
                </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.kc",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Ea("field_help.zone_kc",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                    ...
                    @input="${i=>{const s=Math.round(100*i.target.valueAsNumber)/100;isNaN(s)||this.handleEditZone(t,Object.assign(Object.assign({},e),{[kt]:s,[zt]:"custom"}))}}"
                  />
                </ha-settings-row>

                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.state",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${en(e.state)}"
                    @change="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[gt]:i.target.value,[mt]:0}))}"
                  >
                    <option
                      value="${Fa.Automatic}"
                      ?selected="${e.state===Fa.Automatic}"
                    >
                      ${Ea("panels.zones.labels.states.automatic",this.hass.language)}
                    </option>
                    <option
                      value="${Fa.Manual}"
                      ?selected="${e.state===Fa.Manual}"
                    >
                      ${Ea("panels.zones.labels.states.manual",this.hass.language)}
                    </option>
                    <option
                      value="${Fa.Disabled}"
                      ?selected="${e.state===Fa.Disabled}"
                    >
                      ${Ea("panels.zones.labels.states.disabled",this.hass.language)}
                    </option>
                  </select>
                </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("common.labels.module",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${en(void 0!==e.module?String(e.module):"")}"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.mapping",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${en(void 0!==e.mapping?String(e.mapping):"")}"
                ...
                ${null!=e.distributor_id?W`<div class="distributor-managed">
                      ${Ea("panels.zones.labels.distributor_managed_note",this.hass.language)}
                    </div>`:W`
                      <ha-settings-row>
                        <span slot="heading"
                          >${Ea("panels.zones.labels.watering_mode",this.hass.language)}</span
                        >
                        <span slot="description"
                          >${Ea("panels.zones.labels.watering_mode_description",this.hass.language)}</span
                        >
                        <select
                          class="settings-input"
                          .value="${en(null!==(d=e.watering_mode)&&void 0!==d?d:"classic")}"
                        ...
                        >
                          ...
                          >
                            ${Ea("panels.zones.labels.watering_modes.classic",this.hass.language)}
                          </option>
                          <option
                            value="service"
                            ?selected="${"service"===e.watering_mode}"
                          >
                            ${Ea("panels.zones.labels.watering_modes.service",this.hass.language)}
                          </option>
                          <option
                            value="${xi}"
                            ?selected="${e.watering_mode===xi}"
                          >
                            ${Ea("panels.zones.labels.watering_modes.opensprinkler",this.hass.language)}
                          </option>
                        </select>
                      </ha-settings-row>
                      ...
                      ${"service"===e.watering_mode?W`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ea("panels.zones.labels.run_service",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ea("panels.zones.labels.run_service_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                                .value="${e.run_service||""}"
                            ...
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ea("panels.zones.labels.duration_field",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ea("panels.zones.labels.duration_field_help",this.hass.language)}</span
                              >
                              <input
                                type="text"
                                class="settings-input"
                                placeholder="${Ea("panels.zones.labels.duration_field_placeholder",this.hass.language)}"
                                .value="${e.duration_field||"duration"}"
                                @input="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Ht]:i.target.value||void 0}))}"
                              />
                            </ha-settings-row>
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ea("panels.zones.labels.duration_unit",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ea("panels.zones.labels.duration_unit_help",this.hass.language)}</span
                              >
                              <select
                                class="settings-input"
                                .value="${en(null!==(h=e.duration_unit)&&void 0!==h?h:"seconds")}"
                                @change="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Dt]:i.target.value}))}"
                              >
                                <option
                                  value="seconds"
                                  ?selected="${"seconds"===(null!==(u=e.duration_unit)&&void 0!==u?u:"seconds")}"
                                >
                                  ${Ea("panels.zones.labels.duration_units.seconds",this.hass.language)}
                                </option>
                                <option
                                  value="minutes"
                                  ?selected="${"minutes"===e.duration_unit}"
                                >
                                  ${Ea("panels.zones.labels.duration_units.minutes",this.hass.language)}
                                </option>
                              </select>
                            </ha-settings-row>
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ea("panels.zones.labels.stop_service",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ea("panels.zones.labels.stop_service_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                            ...
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ea("panels.zones.labels.confirm_entity",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ea("panels.zones.labels.confirm_entity_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                            ...
                            ${(null===(p=this.config)||void 0===p?void 0:p.observed_watering_enabled)?W`
                                  <ha-settings-row>
                                    <span slot="heading"
                                      >${Ea("panels.zones.labels.observed_entity",this.hass.language)}</span
                                    >
                                    <span slot="description"
                                      >${Ea("panels.zones.labels.observed_entity_help",this.hass.language)}</span
                                    >
                                    <ha-entity-picker
                                      .hass="${this.hass}"
                                ...
                                `:""}
                          `:""}
                      ${e.watering_mode===xi?W`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ea("panels.zones.labels.opensprinkler_station",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ea("panels.zones.labels.opensprinkler_station_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                            ...
                            ${this._hasOpenSprinklerStations()?"":W`<div class="distributor-managed">
                                  ${Ea("panels.zones.labels.opensprinkler_no_stations",this.hass.language)}
                                </div>`}
                          `:"service"!==e.watering_mode?W`
                              <ha-settings-row>
                                <span slot="heading"
                                  >${Ea("panels.zones.labels.linked_entity",this.hass.language)}</span
                                >
                                <ha-entity-picker
                                  .hass="${this.hass}"
                                  .value="${e.linked_entity||""}"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.soil_moisture_sensor",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Ea("panels.zones.labels.soil_moisture_sensor_help",this.hass.language)}</span
                  >
                  <ha-entity-picker
                    .hass="${this.hass}"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.soil_moisture_threshold",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Ea("panels.zones.labels.soil_moisture_threshold_help",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                    ...
                    @input="${i=>{const s=i.target.value,a=""===s?null:Number(s);this.handleEditZone(t,Object.assign(Object.assign({},e),{[Rt]:null===a||isNaN(a)?null:a}))}}"
                  />
                </ha-settings-row>
                ...
                ${null==e.distributor_id?W`
                      <ha-settings-row>
                        <span slot="heading"
                          >${Ea("panels.zones.labels.flow_sensor",this.hass.language)}</span
                        >
                        <ha-entity-picker
                          .hass="${this.hass}"
                          .value="${e.flow_sensor||""}"
                      ...
                      ${this._flowSensorIsTotalizer(e)?W`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ea("panels.zones.labels.flow_counter_type",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ea("panels.zones.labels.flow_counter_type_help",this.hass.language)}</span
                              >
                              <select
                                class="settings-input"
                                .value="${en(e.flow_counter_type||"auto")}"
                                @change="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Et]:i.target.value||"auto"}))}"
                              >
                                ${["auto","per_run","lifetime"].map(t=>W`
                                    ...
                                    >
                                      ${Ea(`panels.zones.labels.flow_counter_type_${t}`,this.hass.language)}
                                    </option>
                                  `)}
                              </select>
                            </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.maximum-bucket",this.hass.language)}
                    (${Ha(this.config,ft)})</span
                  >
                  <input
                    type="number"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.multiplier",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                    ...
                    @input="${i=>{const s=Math.round(100*i.target.valueAsNumber)/100;isNaN(s)||this.handleEditZone(t,Object.assign(Object.assign({},e),{[_t]:s}))}}"
                  />
                </ha-settings-row>

                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.lead-time",this.hass.language)}
                    (${st})</span
                  >
                  <input
                    type="number"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.maximum-duration",this.hass.language)}
                    (${st})</span
                  >
                  <input
                    type="number"
                    ...
                    @input="${i=>{const s=i.target.valueAsNumber;isNaN(s)||this.handleEditZone(t,Object.assign(Object.assign({},e),{[wt]:Math.round(s)}))}}"
                  />
                </ha-settings-row>

                <ha-settings-row>
                  <span slot="heading"
                    >${Ea("panels.zones.labels.bucket_threshold",this.hass.language)}
                    (${Ha(this.config,ft)})</span
                  >
                  <input
                    type="number"
                    ...
                    @input="${i=>{const s=Math.round(10*i.target.valueAsNumber)/10;isNaN(s)||this.handleEditZone(t,Object.assign(Object.assign({},e),{[At]:Math.min(s,0)}))}}"
                  />
                </ha-settings-row>
                ...
                ${e.state===Fa.Manual?W`
                      <ha-settings-row>
                        <span slot="heading"
                          >${Ea("panels.zones.labels.duration",this.hass.language)}
                          (${st})</span
                        >
                        <input
                          type="number"
                          ...
                          @input="${i=>{const s=i.target.valueAsNumber;isNaN(s)||this.handleEditZone(t,Object.assign(Object.assign({},e),{[mt]:Math.round(s)}))}}"
                        />
                      </ha-settings-row>
                    `:""}
                ...
                <div class="settings-danger-row">
                  <button
                    class="action-btn"
                    @click="${()=>{this._pendingConfirm={title:Ea("panels.zones.confirm_action.reset_bucket_title",this.hass.language),body:Ea("panels.zones.confirm_action.reset_bucket_body",this.hass.language),confirmLabel:Ea("panels.zones.actions.reset-bucket",this.hass.language),onConfirm:()=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ft]:0}))}}}"
                    ?disabled="${this.isSaving}"
                  >
                    ${Ea("panels.zones.actions.reset-bucket",this.hass.language)}
                  </button>
                  <button
                  ...
                  >
                    ...
                    ${Ea("common.actions.delete",this.hass.language)}
                  </button>
                </div>
              </div>
              ...
              ${e.explanation&&e.explanation.length>0?W`
                    <ha-expansion-panel
                      .header="${Ea("panels.zones.actions.information",this.hass.language)}"
                    >
                      <div class="card-content">
                        ${Ji(e.explanation)}
                      </div>
    ...
    `}_renderRunHistory(e){var t,i,s;if(!this.hass)return W``;const a=(null===(t=this.config)||void 0===t?void 0:t.units)===Oe,n=null!==(i=e.run_log)&&void 0!==i?i:[],o=this.hass.language;return W`
      <ha-expansion-panel
        .header="${Ea("panels.zones.history.title",o)}"
      >
        <div class="card-content">
          <div class="history-usage">
            <span class="history-usage-label"
              >${Ea("panels.zones.history.total_used",o)}</span
            >
            <span class="history-usage-value"
              >${ln(null!==(s=e.water_used_total)&&void 0!==s?s:0,a)}</span
            >
          </div>
          ${0===n.length?W`<div class="weather-note">
                ${Ea("panels.zones.history.empty",o)}
              </div>`:W`
                <table class="history-table">
                  <thead>
                    <tr>
                      <th>${Ea("panels.zones.history.when",o)}</th>
                      <th>${Ea("panels.zones.history.result",o)}</th>
                      <th class="num">
                        ${Ea("panels.zones.history.volume",o)}
                      </th>
                      <th>${Ea("panels.zones.history.detail",o)}</th>
                    </tr>
                  </thead>
                  <tbody>
    ...
    `}_renderRunLogRow(e,t){const i=this.hass.language,s=Ea(`panels.zones.history.results.${e.result}`,i);let a="";return e.detail&&(a="skipped"===e.result?e.detail.split(",").map(e=>Ea(`panels.zones.outlook.checks.${e}`,i)||e).join(", "):Ea(`panels.zones.fault.${e.detail}`,i)||e.detail),W`
      <tr>
        <td>${Ya(e.ts)}</td>
        <td>
        ...
        <td class="num">
          ${e.volume_l>0?ln(e.volume_l,t):"-"}
        </td>
        <td class="history-detail">${Ji(a)}</td>
      </tr>
    `}render(){var e;if(!this.hass)return W``;if(this.isLoading)return W`
      ...
      <ha-card>
        <div class="card-header">
          ...
          <ha-icon-button
            .path="${Ba}"
            title="${Ea("panels.zones.cards.add-zone.header",this.hass.language)}"
      ...
      <ha-dialog
        ...
        heading="${Ea("panels.zones.cards.add-zone.header",this.hass.language)}"
      >
        ...
        <div class="dialog-footer">
          ...
          >
            ${this.isSaving?Ea("common.saving-messages.adding",this.hass.language):Ea("panels.zones.cards.add-zone.actions.add",this.hass.language)}
          </button>
        </div>
      </ha-dialog>
      ...
      ${t?W`
            <ha-dialog
              ...
              heading="${Ea("common.actions.confirm_delete",this.hass.language)}"
            >
              <p>
                ${Ea("common.actions.confirm_delete_zone",this.hass.language)}
              </p>
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${Ea("common.labels.bulk_actions",this.hass.language)}
          </div>
        </div>
        <div class="card-content bulk-actions">
          <button
            class="action-btn danger-button"
            @click="${()=>{this._pendingConfirm={title:Ea("panels.zones.confirm_action.reset_all_buckets_title",this.hass.language),body:Ea("panels.zones.confirm_action.reset_all_buckets_body",this.hass.language),confirmLabel:Ea("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language),onConfirm:()=>this.handleResetAllBuckets()}}}"
            ?disabled="${this.isSaving}"
          >
            ${Ea("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language)}
          </button>
          <button
            class="action-btn danger-button"
            @click="${()=>{this._pendingConfirm={title:Ea("panels.zones.confirm_action.clear_weather_title",this.hass.language),body:Ea("panels.zones.confirm_action.clear_weather_body",this.hass.language),confirmLabel:Ea("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language),onConfirm:()=>this.handleClearAllWeatherdata()}}}"
            ?disabled="${this.isSaving}"
          >
            ${Ea("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language)}
          </button>
        </div>
      </ha-card>
    ...
    `}};t([pe()],cn.prototype,"config",void 0),t([pe({attribute:!1})],cn.prototype,"path",void 0),t([pe({type:Array})],cn.prototype,"zones",void 0),t([pe({type:Array})],cn.prototype,"modules",void 0),t([pe({type:Array})],cn.prototype,"mappings",void 0),t([pe({type:Array})],cn.prototype,"distributors",void 0),t([pe({type:Boolean})],cn.prototype,"isLoading",void 0),t([ge()],cn.prototype,"_expanded",void 0),t([pe({type:Boolean})],cn.prototype,"isSaving",void 0),t([pe({type:Boolean})],cn.prototype,"_showAddZone",void 0),t([ge()],cn.prototype,"_pendingConfirm",void 0),t([ge()],cn.prototype,"_saveStatus",void 0),t([pe()],cn.prototype,"_confirmDeleteZoneId",void 0),t([pe()],cn.prototype,"_newZoneName",void 0),t([pe()],cn.prototype,"_newZoneSize",void 0),t([pe()],cn.prototype,"_newZoneThroughput",void 0),t([pe()],cn.prototype,"_newZoneEntity",void 0),cn=t([ce("smart-irrigation-view-zone-settings")],cn);let hn=class extends le{_emit(e){this.dispatchEvent(new CustomEvent("distributor-changed",{detail:{value:Object.assign(Object.assign({},this.distributor),e)},bubbles:!0,composed:!0}))}_onNumber(e,t){const i=t.target.valueAsNumber;isNaN(i)||this._emit({[e]:Math.max(0,Math.round(i))})}render(){var e,t,i,s;if(!this.hass||!this.distributor)return W``;const a=this.hass.language,n=this.distributor,o=n.watering_mode===$i;return W`
      <ha-settings-row>
        <span slot="heading"
          >${Ea("panels.distributors.labels.name",a)}</span
        >
        <input
          type="text"
          class="settings-input"
          .value="${null!==(e=n.name)&&void 0!==e?e:""}"
          @input="${e=>this._emit({[li]:e.target.value})}"
        />
      </ha-settings-row>

      <ha-settings-row>
        <span slot="heading"
          >${Ea("panels.zones.labels.watering_mode",a)}</span
        >
        <span slot="description"
          >${Ea("panels.distributors.labels.watering_mode_help",a)}</span
        >
        <select
          class="settings-input"
          .value="${en(null!==(t=n.watering_mode)&&void 0!==t?t:wi)}"
          @change="${e=>this._emit({[di]:e.target.value})}"
        >
          <option
            value="${wi}"
            ?selected="${(null!==(i=n.watering_mode)&&void 0!==i?i:wi)===wi}"
          >
            ${Ea("panels.zones.labels.watering_modes.classic",a)}
          </option>
          <option
            value="${$i}"
            ?selected="${n.watering_mode===$i}"
          >
            ${Ea("panels.zones.labels.watering_modes.service",a)}
          </option>
        </select>
      </ha-settings-row>
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Ea("panels.distributors.labels.notify_target",a)}</span
        >
        <span slot="description"
          >${Ea("panels.distributors.labels.notify_target_help",a)}</span
        >
        <input
          type="text"
          class="settings-input"
          placeholder="${Ea("panels.distributors.labels.notify_target_placeholder",a)}"
          .value="${null!==(s=n.notify_target)&&void 0!==s?s:""}"
          @input="${e=>this._emit({[_i]:e.target.value||null})}"
        />
      </ha-settings-row>
    `}_renderInletWatchRows(e){var t;const i=this.distributor,s=i.watering_mode===$i?"panels.distributors.labels.inlet_entity_help_service":"panels.distributors.labels.inlet_entity_help",a=null!==(t=i.watch_mode)&&void 0!==t?t:"ignore";return W`
      <ha-settings-row>
        <span slot="heading"
          >${Ea("panels.distributors.labels.inlet_entity",e)}</span
        >
        <span slot="description">${Ea(s,e)}</span>
        <ha-entity-picker
          .hass="${this.hass}"
      ...
      ${i.inlet_entity?W`
            <ha-settings-row>
              <span slot="heading"
                >${Ea("panels.distributors.labels.watch_mode",e)}</span
              >
              <span slot="description"
                >${Ea("panels.distributors.labels.watch_mode_help",e)}</span
              >
              <select
                class="settings-input"
                .value="${en(a)}"
              ...
              >
                ${yi.map(t=>W`
                    <option value="${t}" ?selected="${a===t}">
                      ${Ea(`panels.distributors.labels.watch_mode_${t}`,e)}
                    </option>
                  `)}
              </select>
            </ha-settings-row>
    ...
    `}_renderServiceRows(e){var t,i;const s=this.distributor;return W`
      <ha-settings-row>
        <span slot="heading"
          >${Ea("panels.distributors.labels.run_service",e)}</span
        >
        <span slot="description"
          >${Ea("panels.distributors.labels.run_service_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
          .value="${s.run_service||""}"
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Ea("panels.distributors.labels.duration_field",e)}</span
        >
        <span slot="description"
          >${Ea("panels.distributors.labels.duration_field_help",e)}</span
        >
        <input
          type="text"
          class="settings-input"
          placeholder="${Ea("panels.distributors.labels.duration_field_placeholder",e)}"
          .value="${s.duration_field||"duration"}"
          @input="${e=>this._emit({[gi]:e.target.value||"duration"})}"
        />
      </ha-settings-row>

      <ha-settings-row>
        <span slot="heading"
          >${Ea("panels.distributors.labels.duration_unit",e)}</span
        >
        <select
          class="settings-input"
          .value="${en(null!==(t=s.duration_unit)&&void 0!==t?t:"seconds")}"
          @change="${e=>this._emit({[mi]:e.target.value})}"
        >
          <option
            value="seconds"
            ?selected="${"seconds"===(null!==(i=s.duration_unit)&&void 0!==i?i:"seconds")}"
          >
            ${Ea("panels.distributors.labels.duration_units.seconds",e)}
          </option>
          <option value="minutes" ?selected="${"minutes"===s.duration_unit}">
            ${Ea("panels.distributors.labels.duration_units.minutes",e)}
          </option>
        </select>
      </ha-settings-row>
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Ea("panels.distributors.labels.stop_service",e)}</span
        >
        <span slot="description"
          >${Ea("panels.distributors.labels.stop_service_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
          ...
          .includeDomains="${["script"]}"
          allow-custom-entity
          @value-changed="${e=>this._emit({[pi]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>
    `}_renderSensorRows(e){const t=this.distributor;return W`
      <ha-settings-row>
        <span slot="heading"
          >${Ea("panels.distributors.labels.confirm_entity",e)}</span
        >
        <span slot="description"
          >${Ea("panels.distributors.labels.confirm_entity_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
          ...
          allow-custom-entity
          @value-changed="${e=>this._emit({[vi]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>

      <ha-settings-row>
        <span slot="heading"
          >${Ea("panels.distributors.labels.flow_sensor",e)}</span
        >
        <span slot="description"
          >${Ea("panels.distributors.labels.flow_sensor_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
          .value="${t.flow_sensor||""}"
          .includeDomains="${["sensor"]}"
          allow-custom-entity
          @value-changed="${e=>this._emit({[fi]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>
    `}_renderTimingRows(e){var t,i,s,a;const n=this.distributor,o=(null!==(t=n.pause_seconds)&&void 0!==t?t:0)<10,r=(null!==(i=n.skip_pulse_seconds)&&void 0!==i?i:0)<10;return W`
      <ha-settings-row>
        <span slot="heading"
          >${Ea("panels.distributors.labels.pause_seconds",e)}
          (${st})</span
        >
        <span slot="description"
          >${Ea("field_help.distributor_pause_seconds",e)}</span
        >
        <input
          type="number"
          class="settings-input shortfield"
      ...
      ${o?W`<div class="timing-warning">
            ${Ea("panels.distributors.hints.below_floor_pause",e)}
          </div>`:""}

      <ha-settings-row>
        <span slot="heading"
          >${Ea("panels.distributors.labels.skip_pulse_seconds",e)}
          (${st})</span
        >
        <span slot="description"
          >${Ea("field_help.distributor_skip_pulse_seconds",e)}</span
        >
        <input
          type="number"
          class="settings-input shortfield"
      ...
      ${r?W`<div class="timing-warning">
            ${Ea("panels.distributors.hints.below_floor_skip",e)}
          </div>`:""}
    `}static get styles(){return r`
      ${qa}
      ...
      <div class="outlet-config">
        <div class="commissioning-head">
          <span class="section-title"
            >${Ea("panels.distributors.outlets.title",t)}</span
          >
        </div>
        <div class="item-description">
          ${Ea("panels.distributors.outlets.help",t)}
        </div>
        ${0===this.zones.length?W`<div class="weather-note">
              ${Ea("panels.distributors.outlets.no_zones",t)}
            </div>`:W`
              <ha-settings-row>
                <span slot="heading"
                  >${Ea("panels.distributors.outlets.count",t)}</span
                >
                <select
                  class="settings-input shortfield"
                  .value="${en(String(s))}"
              ...
              ${o?W`<div class="timing-warning">
                    ${Ea("panels.distributors.outlets.gap_warning",t)}
                  </div>`:""}
              <div class="commissioning-note">
                ${Ea("panels.distributors.hints.outlet_change",t)}
              </div>
            `}
      </div>
    `}_renderAdvisories(){var e,t;if(!this.hass)return W``;const i=this.hass.language,s=null===(e=this.config)||void 0===e?void 0:e.zone_sequencing,a=s===Ft,n=s===jt||s===Wt,o=!!(null===(t=this.config)||void 0===t?void 0:t.master_off_after);return W`
      <div class="advisories">
        <div class="advisory">
          <ha-icon icon="mdi:flask-outline"></ha-icon>
          <span
            >${Ea("panels.distributors.hints.experimental",i)}</span
          >
        </div>
        <div class="advisory">
          <ha-icon icon="mdi:water-alert-outline"></ha-icon>
          <span>${Ea("panels.distributors.hints.pressure",i)}</span>
        </div>
        ${a?W`<div class="advisory">
              <ha-icon icon="mdi:information-outline"></ha-icon>
              <span
                >${Ea("panels.distributors.hints.parallel_draw",i)}</span
              >
            </div>`:""}
        ${n&&o?W`<div class="advisory">
              <ha-icon icon="mdi:information-outline"></ha-icon>
              <span
                >${Ea("panels.distributors.hints.master_off_after",i)}</span
              >
            </div>`:""}
      </div>
    `}_renderCommissioning(e){var t;if(!this.hass)return W``;const i=this.hass.language,s="synced"===e.position_state,a=!!e.commissioning_confirmed,n=!!e.active_cycle&&Object.keys(e.active_cycle).length>0,o=e.id;return W`
      <div class="commissioning">
        <div class="commissioning-head">
          <span class="section-title"
            >${Ea("panels.distributors.commissioning.title",i)}</span
          >
          <span class="pos-badge pos-${e.position_state}">
            ${Ea("panels.distributors.commissioning.outlet",i)}
            ${e.current_outlet} ·
            ${Ea(`panels.distributors.commissioning.states.${e.position_state}`,i)}
          </span>
        </div>
        ...
        <ha-settings-row>
          <span slot="heading"
            >${Ea("panels.distributors.commissioning.set_outlet",i)}</span
          >
          <span slot="description"
            >${Ea("panels.distributors.commissioning.set_outlet_help",i)}</span
          >
          <div class="inline-controls">
            <input
              ...
              max="${6}"
              step="1"
              .value="${en(String(null!==(t=this._outletDraft[o])&&void 0!==t?t:e.current_outlet))}"
            ...
            >
              ${Ea("panels.distributors.commissioning.set_outlet",i)}
            </button>
            <button
              class="action-btn secondary"
              ?disabled="${this.isSaving}"
            ...
            >
              ${Ea("panels.distributors.commissioning.resync_home",i)}
            </button>
          </div>
        </ha-settings-row>
        <div class="commissioning-note">
          ${Ea("panels.distributors.hints.undetectable",i)}
        </div>

        <!-- Test run -->
        <ha-settings-row>
          <span slot="heading"
            >${Ea("panels.distributors.commissioning.test_run",i)}</span
          >
          <span slot="description"
            >${Ea("panels.distributors.commissioning.test_run_help",i)}</span
          >
          <button
            class="action-btn secondary"
          ...
          >
            ...
            ${Ea("panels.distributors.commissioning.test_run",i)}
          </button>
        </ha-settings-row>
        ...
        <ha-settings-row>
          <span slot="heading"
            >${Ea("panels.distributors.commissioning.confirmed",i)}</span
          >
          <span slot="description"
            >${Ea(s?"panels.distributors.commissioning.confirmed_help":"panels.distributors.commissioning.needs_sync",i)}</span
          >
          <ha-switch
            .checked="${en(a)}"
        ...
        <div class="run-now-row">
          ...
          >
            <ha-icon icon="mdi:play"></ha-icon>
            ${Ea("panels.distributors.commissioning.run_now",i)}
          </button>
          <span class="run-now-hint">
            ${Ea(n?"panels.distributors.commissioning.run_now_active":"panels.distributors.commissioning.run_now_help",i)}
          </span>
        </div>
      </div>
    `}renderDistributor(e,t){var i;if(!this.hass)return W``;const s=this._isExpanded(e),a=this.hass.language;return W`
      <ha-card id="distributor-${null!==(i=e.id)&&void 0!==i?i:"new"}">
        ...
        >
          <div class="name">${e.name}</div>
          <span class="pos-badge pos-${e.position_state}">
            ${Ea(`panels.distributors.commissioning.states.${e.position_state}`,a)}
          </span>
          <ha-icon
            class="dist-chevron"
    ...
    `}render(){var e;if(!this.hass)return W``;const t=this.hass.language;if(this.isLoading)return W`
        <ha-card header="${Ea("panels.distributors.title",t)}">
          <div class="card-content">
            <div class="loading-indicator">
              ${Ea("common.loading-messages.general",t)}
            </div>
          </div>
        </ha-card>
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">${Ea("panels.distributors.title",t)}</div>
          ${this._renderSaveStatus()}
          <ha-icon-button
            .path="${Ba}"
            title="${Ea("panels.distributors.add.header",t)}"
            @click="${()=>{this._showAdd=!0}}"
          ></ha-icon-button>
        </div>
        <div class="card-content">
          <div class="item-description">
            ${Ea("panels.distributors.description",t)}
          </div>
          ${this._renderAdvisories()}
          ${0===this.distributors.length?W`<div class="weather-note">
                ${Ea("panels.distributors.no_items",t)}
              </div>`:""}
        </div>
      </ha-card>
      ...
      <ha-dialog
        ...
        heading="${Ea("panels.distributors.add.header",t)}"
      >
        <div class="add-form">
          <si-field
            label="${Ea("panels.distributors.labels.name",t)}"
            required
          >
            <input
              type="text"
              class="settings-input"
              placeholder="${Ea("panels.distributors.add.name_placeholder",t)}"
              .value="${this._newName}"
        ...
        <div class="dialog-footer">
          ...
          >
            ${this.isSaving?Ea("common.saving-messages.adding",t):Ea("panels.distributors.add.actions.add",t)}
          </button>
        </div>
      </ha-dialog>
      ...
      ${i?W`
            <ha-dialog
              ...
              heading="${Ea("common.actions.confirm_delete",t)}"
            >
              <p>${Ea("panels.distributors.confirm_delete",t)}</p>
      ...
      ${s?W`
            <ha-dialog
              ...
              heading="${Ea("panels.distributors.commissioning.confirm_dialog.title",t)}"
            >
              <p>
                ${Ea("panels.distributors.commissioning.confirm_dialog.body",t)}
              </p>
              ...
              <div class="dialog-footer">
                ...
                >
                  ${Ea("panels.distributors.commissioning.confirm_dialog.confirm",t)}
                </button>
              </div>
            </ha-dialog>
          `:""}
      ...
      ${a?W`
            <ha-dialog
              ...
              heading="${Ea("panels.distributors.commissioning.confirm_resync.title",t)}"
            >
              <p>
                ${Ea("panels.distributors.commissioning.confirm_resync.body",t)}
              </p>
              ...
              <div class="dialog-footer">
                ...
                >
                  ${Ea("panels.distributors.commissioning.resync_home",t)}
                </button>
              </div>
            </ha-dialog>
          `:""}
      ...
      ${n?W`
            <ha-dialog
              ...
              heading="${Ea("panels.distributors.commissioning.confirm_set_outlet.title",t)}"
            >
              <p>
                ${Ea("panels.distributors.commissioning.confirm_set_outlet.body",t)}
              </p>
              <p>
                <strong
                  >${n.name} ·
              ...
              <div class="dialog-footer">
                ...
                >
                  ${Ea("panels.distributors.commissioning.set_outlet",t)}
                </button>
              </div>
            </ha-dialog>
          `:""}
    ...
    `}};t([pe()],un.prototype,"config",void 0),t([pe({attribute:!1})],un.prototype,"path",void 0),t([pe({type:Array})],un.prototype,"distributors",void 0),t([pe({type:Array})],un.prototype,"zones",void 0),t([pe({type:Boolean})],un.prototype,"isLoading",void 0),t([pe({type:Boolean})],un.prototype,"isSaving",void 0),t([ge()],un.prototype,"_expanded",void 0),t([pe({type:Boolean})],un.prototype,"_showAdd",void 0),t([pe()],un.prototype,"_newName",void 0),t([pe()],un.prototype,"_confirmDeleteId",void 0),t([ge()],un.prototype,"_armConfirmId",void 0),t([ge()],un.prototype,"_confirmResyncHomeId",void 0),t([ge()],un.prototype,"_confirmSetOutletId",void 0),t([ge()],un.prototype,"_outletDraft",void 0),t([ge()],un.prototype,"_outletRows",void 0),t([ge()],un.prototype,"_saveStatus",void 0),un=t([ce("smart-irrigation-view-distributor-settings")],un);let pn=class extends(Ua(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.moduleCache=new Map,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout(()=>{this.saveToHA(t),e=null},500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){Wi().catch(e=>{console.error("Failed to load HA form:",e)})}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:fe+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;e&&(this.isLoading=!0,this._scheduleUpdate());try{const[e,t,i,s]=await Promise.all([Si(this.hass),Ci(this.hass),Ti(this.hass),Oi(this.hass)]);this.config=e,this.zones=t,this.modules=i,this.allmodules=s,this._initialLoadDone=!0,this.moduleCache.clear()}catch(e){console.error("Error fetching data:",e),Ra(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}}async handleAddModule(){var e,t;if((null===(t=null===(e=this.moduleInput)||void 0===e?void 0:e.selectedOptions)||void 0===t?void 0:t[0])&&!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.moduleInput.selectedOptions[0].text,t=this.allmodules.find(t=>t.name===e);if(!t)return;const i={name:e,description:t.description,config:t.config,schema:t.schema};this.modules=[...this.modules,i],this.moduleCache.clear(),this._scheduleUpdate(),await this.saveToHA(i),await this._fetchData()}catch(e){console.error("Error adding module:",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}}}async handleRemoveModule(e,t){if(!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.modules[t],a=null==e?void 0:e.id;this.modules;this.modules=this.modules.filter((e,i)=>i!==t),this.moduleCache.clear(),this._scheduleUpdate(),this.hass&&void 0!==a&&await(i=this.hass,s=a.toString(),i.callApi("POST",fe+"/modules",{id:s,remove:!0}))}catch(e){console.error("Error removing module:",e),Ra(this,this.hass,"common.errors.delete_failed",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}var i,s}}async saveToHA(e){if(this.hass)try{await Hi(this.hass,e)}catch(e){throw console.error("Error saving module:",e),Ra(this,this.hass,"common.errors.save_failed",e),e}}renderModule(e,t){if(!this.hass)return W``;const i=this.zones.filter(t=>t.module===e.id).length,s=`module-${e.id||t}-${i}-${JSON.stringify(e)}`;if(this.moduleCache.has(s))return this.moduleCache.get(s);const a=W`
      <ha-card>
        <div class="card-header">
          <div class="name">${e.name}</div>
        ...
        <div class="card-content">
          ...
          <div class="moduleconfig">
            <label class="subheader"
              >${Ea("panels.modules.cards.module.labels.configuration",this.hass.language)}
              (*
              ${Ea("panels.modules.cards.module.labels.required",this.hass.language)})</label
            >
            ${e.schema?Object.entries(e.schema).map(([e])=>this.renderConfig(t,e)):null}
          </div>
          <div class="card-footer">
            ${i?W`<div class="weather-note">
                  ${Ea("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}
                </div>`:W`<button
                  class="action-btn danger"
    ...
    `;return this.moduleCache.set(s,a),a}renderUsageChip(e){return this.hass?e?W`<span class="usage-chip"
      ...
      >
        ${Object.entries(n.options).map(([e,i])=>W`<option
              ...
              ?selected="${h===Oa(i,0)}"
            >
              ${Ea("panels.modules.cards.module.translated-options."+Oa(i,1),t)}
            </option>`)}
      ...
      <ha-card header="${Ea("panels.modules.title",this.hass.language)}">
        <div class="card-content">
          ${Ea("panels.modules.description",this.hass.language)}
          ${this.isLoading?W`<div class="loading-indicator">
                ...
                <div class="add-row">
                  <select
                    id="moduleInput"
                    class="settings-input"
                    aria-label="${Ea("common.labels.module",this.hass.language)}"
                    ?disabled="${this.isSaving}"
                  >
                  ...
                  >
                    ...
                    ${this.isSaving?Ea("common.saving-messages.adding",this.hass.language):Ea("panels.modules.cards.add-module.actions.add",this.hass.language)}
                  </button>
                </div>
              `}
        </div>
    ...
    `}};t([pe()],pn.prototype,"config",void 0),t([pe({type:Array})],pn.prototype,"zones",void 0),t([pe({type:Array})],pn.prototype,"modules",void 0),t([pe({type:Array})],pn.prototype,"allmodules",void 0),t([pe({type:Boolean})],pn.prototype,"isLoading",void 0),t([pe({type:Boolean})],pn.prototype,"isSaving",void 0),t([me("#moduleInput")],pn.prototype,"moduleInput",void 0),pn=t([ce("smart-irrigation-view-modules")],pn);let gn=class extends(Ua(le)){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this.debounceTimers=new Map,this.globalDebounceTimer=null,this.mappingCache=new Map,this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()},this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()}))}firstUpdated(){Wi().catch(e=>{console.error("Failed to load HA form:",e)})}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:fe+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[t,i,s]=await Promise.all([Si(this.hass),Ci(this.hass),Di(this.hass)]);this.config=t,this.zones=i,this.mappings=s,this._initialLoadDone=!0,this.mappingCache.clear()}catch(e){console.error("Error fetching data:",e),Ra(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}}handleAddMapping(){if(!this.mappingNameInput.value.trim())return;const e={[He]:"",[De]:"",[Me]:"",[Ie]:"",[Ne]:"",[Le]:"",[Re]:"",[Pe]:"",[Be]:""},t={name:this.mappingNameInput.value.trim(),mappings:e};this.mappings=[...this.mappings,t],this.isSaving=!0,this.saveToHA(t).then(()=>(this.mappingNameInput.value="",this._fetchData())).catch(e=>{console.error("Failed to add mapping:",e),Ra(this,this.hass,"common.errors.save_failed",e),this.mappings=this.mappings.slice(0,-1)}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()})}handleRemoveMapping(e,t){const i=this.mappings[t].id;if(null==i)return;const s=[...this.mappings];var a,n;(this.mappings=this.mappings.filter((e,i)=>i!==t),this.mappingCache.delete(i.toString()),this.hass)&&(this.isSaving=!0,(a=this.hass,n=i.toString(),a.callApi("POST",fe+"/mappings",{id:n,remove:!0})).catch(e=>{console.error("Failed to delete mapping:",e),Ra(this,this.hass,"common.errors.delete_failed",e),this.mappings=s,this._fetchData().catch(e=>{console.error("Failed to refresh data after delete error:",e)})}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditMapping(e,t){this.mappings[e]=t,t.id&&this.mappingCache.delete(t.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout(()=>{this.isSaving=!0,this.saveToHA(t).catch(e=>{console.error("Failed to save mapping:",e),Ra(this,this.hass,"common.errors.save_failed",e)}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()}),this.globalDebounceTimer=null},500),this._scheduleUpdate()}async saveToHA(e){var t;if(!this.hass)throw new Error("Home Assistant connection not available");const i=[],s=this.hass.states;for(const t in e.mappings){const a=e.mappings[t].sensorentity;if(a&&""!==a.trim()){const n=a.trim();e.mappings[t].sensorentity=n,n in s||i.push(n)}}if(i.length>0){const e=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("ha-card");throw e&&Da({body:{message:Ea("panels.mappings.cards.mapping.errors.source_does_not_exist",this.hass.language)+": "+i.join(", ")},error:Ea("panels.mappings.cards.mapping.errors.invalid_source",this.hass.language)},e),new Error("Invalid sensor entities found")}const{id:a,name:n,mappings:o}=e;await Mi(this.hass,{id:a,name:n,mappings:o})}renderMappingSetting(e,t){const i=this.mappings[e];if(!i||!this.hass)return W``;const s=i.mappings[t];return W`
      <div class="mappingline">
        <div class="mappingsettingname">
          <label for="${`${t}_${e}`}">
            ${Ea(`panels.mappings.cards.mapping.items.${t.toLowerCase()}`,this.hass.language)}
          </label>
        </div>
        <div class="mappingsettingline">
          <label
            >${Ea("panels.mappings.cards.mapping.source",this.hass.language)}:</label
          >
    ...
    `}renderSimpleRadioOptions(e,t,i){if(!this.hass||!this.config)return W``;const s=t===De||t===Re,a=i[Ke];return W`
      ${!s&&this.config.use_weather_service?W`
            <label>
              ...
              />
              ${Ea("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}
            </label>
          `:""}
      ${s?W`
            <label>
              <input
                ...
                @change="${i=>this.handleSimpleSourceChange(e,t,i)}"
              />
              ${Ea("panels.mappings.cards.mapping.sources.none",this.hass.language)}
            </label>
          `:""}
      ...
      <label>
        <input
          ...
          @change="${i=>this.handleSimpleSourceChange(e,t,i)}"
        />
        ${Ea("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}
      </label>
    ...
    `}renderSensorInput(e,t,i){if(!this.hass)return W``;const s=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${s}_sensor_entity">
          ${Ea("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}:
        </label>
        <input
          type="text"
          class="settings-input"
    ...
    `}renderStaticValueInput(e,t,i){if(!this.hass)return W``;const s=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${s}_static_value">
          ${Ea("panels.mappings.cards.mapping.static_value",this.hass.language)}:
        </label>
        <input
          type="text"
          class="settings-input"
    ...
    `}renderUnitSelect(e,t,i){if(!this.hass||!this.config)return W``;const s=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${s}_unit">
          ${Ea("panels.mappings.cards.mapping.input-units",this.hass.language)}:
        </label>
        <select
          id="${s}_unit"
          class="settings-input"
    ...
    `}renderPressureTypeSelect(e,t,i){if(!this.hass)return W``;const s=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${s}_pressure_type">
          ${Ea("panels.mappings.cards.mapping.pressure-type",this.hass.language)}:
        </label>
        <select
          id="${s}_pressure_type"
          class="settings-input"
    ...
    `}renderAggregateSelect(e,t,i){if(!this.hass)return W``;const s=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${s}_aggregate">
          ${Ea("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
        </label>
        <select
          id="${s}_aggregate"
          class="settings-input"
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return W`<option value="${e}" ?selected="${e===t}">
        ${Ea("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return W``}renderPressureTypes(e,t){if(this.hass&&this.config){let e=W``;const i=t[We];return e=W`${e}
        <option
          value="${Ze}"
          ?selected="${i===Ze}"
        >
          ${Ea("panels.mappings.cards.mapping.pressure_types."+Ze,this.hass.language)}
        </option>
        <option
          value="${qe}"
          ?selected="${i===qe}"
        >
          ${Ea("panels.mappings.cards.mapping.pressure_types."+qe,this.hass.language)}
        </option>`,e}return W``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return W``;const i=function(e){switch(e){case He:case Pe:return[{unit:"°C",system:Oe},{unit:"°F",system:Te}];case Ie:case De:return[{unit:at,system:Oe},{unit:nt,system:Te}];case Ne:return[{unit:dt,system:Oe},{unit:ct,system:Te}];case Me:return[{unit:"%",system:[Oe,Te]}];case Le:return[{unit:"millibar",system:Oe},{unit:"hPa",system:Oe},{unit:"psi",system:Te},{unit:ot,system:Te}];case Be:return[{unit:"km/h",system:Oe},{unit:lt,system:Oe},{unit:rt,system:Te}];case Re:return[{unit:"W/m2",system:Oe},{unit:"MJ/day/m2",system:Oe},{unit:"W/sq ft",system:Te},{unit:"MJ/day/sq ft",system:Te}];default:return[]}}(e);let s=t[Xe];const a=this.config.units;if(!t[Xe])for(const e of i)if("string"==typeof e.system){if(a===e.system){s=e.unit;break}}else{for(const t of e.system)if(a===t.system){s=e.unit;break}if(s===e.unit)break}return W`
      ${i.map(e=>W`
    ...
    `}render(){return this.hass?this.isLoading?W`
        <ha-card
          header="${Ea("panels.mappings.title",this.hass.language)}"
        >
          <div class="card-content">
            <div class="loading-indicator">
              ${Ea("common.loading-messages.general",this.hass.language)}
      ...
      >
        <div class="card-content">
          ${Ea("panels.mappings.description",this.hass.language)}
          <div class="add-row">
            <input
              id="mappingNameInput"
              class="settings-input"
              type="text"
              placeholder="${Ea("panels.mappings.labels.mapping-name",this.hass.language)}"
            />
            <button
              class="action-btn ${this.isSaving?"saving":""}"
              ?disabled="${this.isSaving}"
            ...
            >
              <ha-icon icon="mdi:plus"></ha-icon>
              ${Ea("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    ...
    `}renderMappingCard(e,t){if(!this.hass)return W``;const i=this.zones.filter(t=>t.mapping===e.id).length;return W`
      <ha-card>
        ...
        <div class="card-content">
          <ha-settings-row>
            <span slot="heading"
              >${Ea("panels.mappings.labels.mapping-name",this.hass.language)}</span
            >
            <input
              id="name${e.id}"
              class="settings-input"
          ...
          <div class="card-footer">
            ${i?W`<div class="weather-note">
                  ${Ea("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}
                </div>`:W`<button
                  class="action-btn danger"
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach(e=>{clearTimeout(e)}),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};t([pe()],gn.prototype,"config",void 0),t([pe({type:Array})],gn.prototype,"zones",void 0),t([pe({type:Array})],gn.prototype,"mappings",void 0),t([pe({type:Boolean})],gn.prototype,"isLoading",void 0),t([pe({type:Boolean})],gn.prototype,"isSaving",void 0),t([me("#mappingNameInput")],gn.prototype,"mappingNameInput",void 0),gn=t([ce("smart-irrigation-view-mappings")],gn);const mn="06:00";function vn(e){switch(e){case ti:return{mode:e,time:mn};case ii:case si:return{mode:e,offset:0};case ai:return{mode:e,azimuth:90};default:return{mode:ei}}}function fn(e,t,i,s){const a=function(e){return e===ei||e===ti||e===ii||e===si||e===ai}(e)?e:ei,n=vn(a);return a===ti&&void 0!==t&&(n.time=t),a!==ii&&a!==si||void 0===i||(n.offset=i),a===ai&&void 0!==s&&(n.azimuth=s),n}function _n(e){var t,i,s;return{mode:e.mode,time:e.mode===ti?null!==(t=e.time)&&void 0!==t?t:mn:void 0,offset:e.mode===ii||e.mode===si?null!==(i=e.offset)&&void 0!==i?i:0:void 0,azimuth:e.mode===ai?null!==(s=e.azimuth)&&void 0!==s?s:90:void 0}}function bn(e){return{start:fn(e.start_mode,e.start_time,e.start_offset,e.start_azimuth),finish:fn(e.finish_mode,e.finish_time,e.finish_offset,e.finish_azimuth),anchor:e.anchor===oi?oi:ri}}function yn(e){const t=e.start.mode!==ei,i=e.finish.mode!==ei;return t||i?t?i?e.anchor===ri?{start:"demand_floored",finish:"exact_deferred",valid:!0}:{start:"exact",finish:"demand_capped_deferred",valid:!0}:{start:"exact",finish:"demand_open",valid:!0}:{start:"demand_open",finish:"exact",valid:!0}:{start:"error",finish:"error",valid:!1}}const wn=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"];function $n(){return{name:"",recurrence:"daily",enabled:!0,start_mode:ti,start_time:"06:00",finish_mode:ei,action:"irrigate",zones:"all"}}function xn(e,t){return Ea(`panels.schedules.types.${e}`,t)||e}let kn=class extends le{constructor(){super(...arguments),this.zones=[],this.heading="",this._save=()=>{this.dispatchEvent(new CustomEvent("save",{detail:{value:this.schedule},bubbles:!0,composed:!0}))},this._cancel=()=>{this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}}_emitChanged(e){this.dispatchEvent(new CustomEvent("schedule-changed",{detail:{value:Object.assign(Object.assign({},this.schedule),e)},bubbles:!0,composed:!0}))}_renderZonePicker(){const e="all"===this.schedule.zones||!Array.isArray(this.schedule.zones),t=e?[]:this.schedule.zones.map(String);return W`
      <div class="field">
        <label
          >${Ea("panels.schedules.fields.zones",this.hass.language)}</label
        >
        <div class="switch-container">
          ...
          />
          <label for="zones_all"
            >${Ea("panels.schedules.zones_all",this.hass.language)}</label
          >
          <input
            type="radio"
            id="zones_specific"
          ...
          <label for="zones_specific"
            >${Ea("panels.schedules.zones_specific",this.hass.language)}</label
          >
        </div>
        ${e?"":W`
    ...
    `}_renderRecurrenceFields(){const e=this.schedule,t=this.hass.language;switch(e.recurrence){case"weekly":return W`
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.days_of_week",t)}</label
            >
        ...
        `;case"monthly":return W`
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.day_of_month",t)}</label
            >
            <input
              type="number"
              min="1"
        ...
        `;case"interval":return W`
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.interval_hours",t)}</label
            >
            <div class="input-suffix-row">
              ...
              />
              <span class="suffix"
                >${Ea("panels.schedules.hours",t)}</span
              >
            </div>
          </div>
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.start_time",t)}</label
            >
            <input
              type="time"
              .value="${e.start_time||""}"
        ...
        `;default:return W``}}_renderRowStepper(e,t){var i,s,a;const n=this.hass.language;switch(e.mode){case ti:return W`
          <input
            type="time"
            .value="${null!==(i=e.time)&&void 0!==i?i:"06:00"}"
            @change=${i=>t(Object.assign(Object.assign({},e),{time:i.target.value}))}
          />
        `;case ii:case si:return W`
      ...
      <div class="window-row">
        <label>${Ea(`panels.schedules.fields.${e}_mode`,a)}</label>
        <select
          @change=${e=>s(vn(e.target.value))}
        >
          ${ni.map(e=>W`
              <option value="${e}" ?selected="${t.mode===e}">
                ${Ea(`panels.schedules.bound_mode.${e}`,a)}
              </option>
            `)}
        </select>
      ...
      <div class="window-row-help ${"error"===i?"is-error":""}">
        ...
        <span class="help-text"
          >${Ea(`panels.schedules.help.${i}`,a)}</span
        >
      </div>
    `}_renderAnchorRow(e,t){const i=this.hass.language;return W`
      <div class="window-row">
        <label>${Ea("panels.schedules.fields.anchor",i)}</label>
        <select
          @change=${i=>t(Object.assign(Object.assign({},e),{anchor:i.target.value}))}
        >
          ${[oi,ri].map(t=>W`
              <option value="${t}" ?selected="${e.anchor===t}">
                ${Ea(`panels.schedules.anchor.${t}`,i)}
              </option>
            `)}
        </select>
      </div>
    `}_renderWindowRows(){const e=this.schedule;if(e.recurrence===Jt)return W``;const t=bn(e),i=yn(t),s=e=>this._emitChanged(function(e){const t=_n(e.start),i=_n(e.finish);return{start_mode:t.mode,start_time:t.time,start_offset:t.offset,start_azimuth:t.azimuth,finish_mode:i.mode,finish_time:i.time,finish_offset:i.offset,finish_azimuth:i.azimuth,anchor:e.anchor}}(e)),a=t.start.mode!==ei&&t.finish.mode!==ei;return W`
    ...
    `}_canSave(){const e=this.schedule;return e.recurrence===Jt||yn(bn(e)).valid}render(){if(!this.hass||!this.schedule)return W``;const e=this.schedule;return W`
      <ha-dialog open heading="${this.heading}" @closed=${this._cancel}>
        <div class="dialog-content">
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.name",this.hass.language)}</label
            >
            <input
              type="text"
              .value="${e.name}"
          ...
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.recurrence",this.hass.language)}</label
            >
            <select
              @change=${e=>this._emitChanged({recurrence:e.target.value})}
            >
              ${Qt.map(t=>W`
                  <option value="${t}" ?selected="${e.recurrence===t}">
          ...
          <div class="field-row">
            <label
              >${Ea("panels.schedules.fields.enabled",this.hass.language)}</label
            >
            <input
              type="checkbox"
              ?checked="${e.enabled}"
          ...
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.start_date",this.hass.language)}</label
            >
            <input
              type="date"
              .value="${e.start_date||""}"
          ...
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.end_date",this.hass.language)}</label
            >
            <input
              type="date"
              .value="${e.end_date||""}"
        ...
        <button
          ...
          @click=${this._save}
        >
          ${Ea("common.actions.save",this.hass.language)}
        </button>
      </ha-dialog>
    `}static get styles(){return[qa,r`
      ...
      `]}};t([pe({attribute:!1})],kn.prototype,"hass",void 0),t([pe({attribute:!1})],kn.prototype,"schedule",void 0),t([pe({attribute:!1})],kn.prototype,"zones",void 0),t([pe({attribute:!1})],kn.prototype,"heading",void 0),kn=t([ce("si-schedule-dialog")],kn);let zn=class extends(Ua(le)){constructor(){super(...arguments),this._schedules=[],this._zones=[],this._isLoading=!0,this._showDialog=!1,this._editingSchedule=$n(),this._editingId=null}hassSubscribe(){return this._load(),[this.hass.connection.subscribeMessage(()=>this._load(),{type:fe+"_config_updated"})]}async _load(){var e;if(this.hass)try{const[t,i]=await Promise.all([(e=this.hass,e.callWS({type:fe+"/schedules"})),Ci(this.hass)]);this._schedules=t||[],this._zones=i||[]}catch(e){console.error("Failed to load schedules",e),Ra(this,this.hass,"common.errors.load_failed",e)}finally{this._isLoading=!1}}_openAdd(){this._editingSchedule=$n(),this._editingId=null,this._showDialog=!0}_openEdit(e){var t;this._editingSchedule=Object.assign({},e),this._editingId=null!==(t=e.id)&&void 0!==t?t:null,this._showDialog=!0}_closeDialog(){this._showDialog=!1}async _save(){const e=Object.assign({},this._editingSchedule);this._editingId&&(e.id=this._editingId);try{const t=await Ni(this.hass,e);if(t&&!1===t.success)throw new Error(t.error||"");this._closeDialog(),await this._load()}catch(e){console.error("Failed to save schedule",e),Ra(this,this.hass,"common.errors.save_failed",e)}}async _delete(e){try{await(t=this.hass,i=e,t.callWS({type:fe+"/schedule_delete",schedule_id:i})),await this._load()}catch(e){console.error("Failed to delete schedule",e),Ra(this,this.hass,"common.errors.delete_failed",e)}var t,i}_onScheduleChanged(e){this._editingSchedule=e.detail.value}_zonesLabel(e){if("all"===e)return Ea("panels.schedules.zones_all",this.hass.language);if(Array.isArray(e)){const t=e.map(e=>{const t=this._zones.find(t=>String(t.id)===String(e));return t?t.name:e}).join(", ");return t||e.join(", ")}return String(e)}_dialogTitle(){return this._editingId?Ea("panels.schedules.dialog.edit_title",this.hass.language):Ea("panels.schedules.dialog.add_title",this.hass.language)}render(){return this.hass?this._isLoading?W`
        <ha-card
          header="${Ea("panels.schedules.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Ea("common.loading",this.hass.language)}...
          </div>
        </ha-card>
      `:W`
      ${this._showDialog?W`
      ...
      >
        <div class="card-content">
          ${Ea("panels.schedules.description",this.hass.language)}
        </div>
        <div class="card-content">
          <button class="add-btn" @click=${this._openAdd}>
            <svg style="width:20px;height:20px" viewBox="0 0 24 24">
              <path fill="currentColor" d="${Ba}" />
            </svg>
            ${Ea("panels.schedules.add",this.hass.language)}
          </button>
        </div>
      </ha-card>
      ...
      ${0===this._schedules.length?W`
            <ha-card>
              <div class="card-content">
                ${Ea("panels.schedules.no_items",this.hass.language)}
              </div>
            </ha-card>
              ...
              <ha-card header="${e.name}">
                <div class="card-content">
                  <div class="info-row">
                    <span class="info-label"
                      >${Ea("panels.schedules.fields.recurrence",this.hass.language)}:</span
                    >
                    <span
                      >${xn(e.recurrence,this.hass.language)}</span
                    >
                  </div>
                  ${"interval"!==e.recurrence&&"time"===e.start_mode&&e.start_time?W`
                        <div class="info-row">
                          <span class="info-label"
                            >${Ea("panels.schedules.fields.start_time",this.hass.language)}:</span
                          >
                  ...
                  ${"interval"!==e.recurrence&&"time"===e.finish_mode&&e.finish_time?W`
                        <div class="info-row">
                          <span class="info-label"
                            >${Ea("panels.schedules.fields.finish_time",this.hass.language)}:</span
                          >
                  ...
                  ${e.interval_hours?W`
                        <div class="info-row">
                          <span class="info-label"
                            >${Ea("panels.schedules.fields.interval_hours",this.hass.language)}:</span
                          >
                          <span
                            >${e.interval_hours}
                            ${Ea("panels.schedules.hours",this.hass.language)}</span
                          >
                        </div>
                      `:""}
                  ...
                  <div class="info-row">
                    <span class="info-label"
                      >${Ea("panels.schedules.fields.zones",this.hass.language)}:</span
                    >
                    <span>${this._zonesLabel(e.zones)}</span>
                  </div>
                  <div class="info-row">
                    <span class="info-label"
                      >${Ea("panels.schedules.fields.enabled",this.hass.language)}:</span
                    >
                    <span
                      >${e.enabled?Ea("common.labels.yes",this.hass.language):Ea("common.labels.no",this.hass.language)}</span
                    >
                  </div>
                </div>
                <div class="card-content action-buttons">
                  <div class="action-buttons-left">
                    ...
                    >
                      ...
                      <span class="action-button-label"
                        >${Ea("common.actions.edit",this.hass.language)}</span
                      >
                    </div>
                  </div>
                  <div class="action-buttons-right">
                    ...
                    >
                      <span class="action-button-label"
                        >${Ea("common.actions.delete",this.hass.language)}</span
                      >
                      <svg style="width:20px;height:20px" viewBox="0 0 24 24">
    ...
    `:W``}static get styles(){return[qa,r`
      ...
      `]}};t([pe({attribute:!1})],zn.prototype,"hass",void 0),t([ge()],zn.prototype,"_schedules",void 0),t([ge()],zn.prototype,"_zones",void 0),t([ge()],zn.prototype,"_isLoading",void 0),t([ge()],zn.prototype,"_showDialog",void 0),t([ge()],zn.prototype,"_editingSchedule",void 0),t([ge()],zn.prototype,"_editingId",void 0),zn=t([ce("smart-irrigation-view-schedules")],zn);let Sn=class extends(Ua(le)){constructor(){super(...arguments),this._forecast=null,this._mappings=[],this._records=new Map,this._loading=!0,this._metric=!0,this._climate=[]}hassSubscribe(){return this._fetch(),[this.hass.connection.subscribeMessage(()=>this._fetch(),{type:fe+"_config_updated"})]}async _fetch(){var e,t;if(this.hass)try{const[i,s,a,n]=await Promise.all([(t=this.hass,t.callWS({type:fe+"/weather_forecast"})),Di(this.hass),Si(this.hass),Ii(this.hass)]);this._forecast=i,this._mappings=s||[],this._metric=(null==a?void 0:a.units)!==Te;const o=n?Object.values(n):[];this._climate=o.length>0&&(null===(e=o[0])||void 0===e?void 0:e.monthly_estimates)||[];const r=new Map;await Promise.all(this._mappings.map(async e=>{if(void 0!==e.id)try{r.set(e.id,await((e,t,i=10)=>e.callWS({type:fe+"/weather_records",mapping_id:t,limit:i}))(this.hass,e.id.toString(),0)||[])}catch(e){}})),this._records=r}catch(e){console.error("Failed to fetch weather data",e)}finally{this._loading=!1}}render(){return this.hass?W`${this._renderForecast()} ${this._renderRecords()}
    ${this._renderSeasonal()}`:W``}_renderSeasonal(){if(!this.hass)return W``;const e=this.hass.language;return W`
      <ha-card
        header="${Ea("panels.setup.weather_data.seasonal_title",e)}"
      >
        <div class="card-content">
          ${0===this._climate.length?W`<div class="weather-note">
                ${Ea("panels.zones.calendar.no_data",e)}
              </div>`:W`
                <div class="seasonal-table">
                  <div class="weather-header">
                    <span
                      >${Ea("panels.zones.calendar.month",e)}</span
                    >
                    <span>${Ea("panels.zones.calendar.et",e)}</span>
                    <span
                      >${Ea("panels.zones.calendar.precipitation",e)}</span
                    >
                    <span
                      >${Ea("panels.zones.calendar.avg_temp",e)}</span
                    >
                  </div>
                  ${this._climate.map(e=>W`
                      <div class="weather-row">
                        ...
                        >
                        <span
                          >${rn(e.estimated_et_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${rn(e.average_precipitation_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${rn(e.average_temperature_c,"temperature",this._metric)}</span
                        >
                      </div>
                    `)}
                </div>
    ...
    `}_renderForecast(){if(!this.hass)return W``;const e=this.hass.language,t=this._forecast;return W`
      <ha-card
        header="${Ea("panels.setup.weather_data.forecast_title",e)}"
      >
        <div class="card-content">
          ${t&&t.available&&0!==t.days.length?W`
              ...
              `:W`<div class="weather-note">
                ${Ea("panels.setup.weather_data.forecast_none",e)}
              </div>`}
        </div>
      </ha-card>
    `}_renderForecastDay(e,t){const i=(()=>{try{return new Intl.DateTimeFormat(t,{weekday:"short",month:"short",day:"numeric"}).format(new Date(e.date+"T00:00:00"))}catch(t){return e.date}})(),s=e=>{const t=on(e,"temperature",this._metric);return t?`${Math.round(t.value)}°`:"-"};return W`
      <div class="forecast-day">
        ...
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-rainy"></ha-icon>${rn(e.precipitation,"precipitation",this._metric)}
        </div>
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-windy"></ha-icon>${rn(e.windspeed,"windspeed",this._metric)}
        </div>
      </div>
    `}_renderRecords(){if(!this.hass)return W``;const e=this.hass.language;return this._loading&&0===this._mappings.length?W`<ha-card
        header="${Ea("panels.mappings.weather-records.title",e)}"
      >
        <div class="card-content">
          <div class="loading-indicator">
            ${Ea("common.loading-messages.general",e)}
          </div>
        </div>
      ...
      >
        <div class="card-content">
          <div class="weather-note">
            ${Ea("panels.mappings.no_items",e)}
          </div>
        </div>
      </ha-card>`:W`${this._mappings.map(t=>this._renderMappingRecords(t,e))}`}_renderMappingRecords(e,t){const i=void 0!==e.id&&this._records.get(e.id)||[],s=`${Ea("panels.mappings.weather-records.title",t)} — ${e.name}`,a=e=>{try{return t=e,Number.isNaN(Ka(t).getTime())?"-":function(e){const t=Ka(e);return`${Ga(t.getMonth()+1)}-${Ga(t.getDate())} ${Ga(t.getHours())}:${Ga(t.getMinutes())}`}(e)}catch(e){return"-"}var t};return W`
      <ha-card header="${s}">
        <div class="card-content">
          ${0===i.length?W`<div class="weather-note">
                ${Ea("panels.mappings.weather-records.no-data",t)}
              </div>`:W`
                <div class="weather-table">
                  <div class="weather-header">
                    <span
                      >${Ea("panels.mappings.weather-records.timestamp",t)}</span
                    >
                    <span
                      >${Ea("panels.mappings.weather-records.temperature",t)}</span
                    >
                    <span
                      >${Ea("panels.mappings.weather-records.humidity",t)}</span
                    >
                    <span
                      >${Ea("panels.mappings.weather-records.dewpoint",t)}</span
                    >
                    <span
                      >${Ea("panels.mappings.weather-records.wind",t)}</span
                    >
                    <span
                      >${Ea("panels.mappings.weather-records.pressure",t)}</span
                    >
                    <span
                      >${Ea("panels.mappings.weather-records.precipitation",t)}</span
                    >
                    <span
                      >${Ea("panels.mappings.weather-records.retrieval-time",t)}</span
                    >
                  </div>
                  ${i.map(e=>W`
                      <div class="weather-row">
                        ...
                        <span
                          >${rn(e.temperature,"temperature",this._metric)}</span
                        >
                        <span>${(e=>null!=e?e.toFixed(1)+" %":"-")(e.humidity)}</span>
                        <span
                          >${rn(e.dewpoint,"temperature",this._metric)}</span
                        >
                        <span
                          >${rn(e.wind_speed,"windspeed",this._metric)}</span
                        >
                        <span
                          >${rn(e.pressure,"pressure",this._metric)}</span
                        >
                        <span
                          >${rn(e.precipitation,"precipitation",this._metric)}</span
                        >
    ...
    `}};t([pe()],Sn.prototype,"narrow",void 0),t([ge()],Sn.prototype,"_forecast",void 0),t([ge()],Sn.prototype,"_mappings",void 0),t([ge()],Sn.prototype,"_records",void 0),t([ge()],Sn.prototype,"_loading",void 0),t([ge()],Sn.prototype,"_metric",void 0),t([ge()],Sn.prototype,"_climate",void 0),Sn=t([ce("smart-irrigation-view-weather-data")],Sn);let An=class extends(Ua(le)){constructor(){super(...arguments),this._saving=!1}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch experimental config:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to refresh experimental config:",e)})},{type:fe+"_config_updated"})]}async _fetchData(){if(this.hass)try{this.config=await Si(this.hass)}catch(e){console.error("Error fetching config:",e),Ra(this,this.hass,"common.errors.load_failed",e)}}async _toggle(e,t){if(this.hass&&this.config){this.config=Object.assign(Object.assign({},this.config),{[e]:t}),this._saving=!0;try{await Ai(this.hass,{[e]:t})}catch(e){console.error("Error saving experimental config:",e),Ra(this,this.hass,"common.errors.save_failed",e),await this._fetchData()}finally{this._saving=!1}}}render(){var e,t;return this.hass&&this.config?W`
      ${this._renderIntro()}
    ...
    `:W`<div class="loading-indicator">
      ...
      <ha-card header="${Ea(`${e}.title`,this.hass.language)}">
        <div class="card-content description-text">
          ${Ea(`${e}.description`,this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${Ea(`${e}.label`,this.hass.language)}</label>
            <ha-switch
              .checked="${t}"
          ...
          ${t?W`<div class="setting-row">
                <label>
                  ${Ea(`${e}.debounce_label`,this.hass.language)}
                </label>
                <input
                  type="number"
                  class="settings-input shortfield"
    ...
    `}};t([pe()],An.prototype,"narrow",void 0),t([ge()],An.prototype,"config",void 0),t([ge()],An.prototype,"_saving",void 0),An=t([ce("smart-irrigation-view-experimental")],An);var Cn;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.Distributors="distributors",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}(Cn||(Cn={}));const En={[Cn.WeatherLocation]:"panels.setup.tabs.weather_location",[Cn.Zones]:"panels.setup.tabs.my_zones",[Cn.Distributors]:"panels.setup.tabs.distributors",[Cn.WhenToWater]:"panels.setup.tabs.when_to_water",[Cn.Advanced]:"panels.setup.tabs.advanced",[Cn.Experimental]:"panels.setup.tabs.experimental",[Cn.Help]:"panels.help.title"};let Tn=class extends(Ua(le)){hassSubscribe(){return this._fetchConfig(),[this.hass.connection.subscribeMessage(()=>this._fetchConfig(),{type:fe+"_config_updated"})]}async _fetchConfig(){if(this.hass)try{this.config=await Si(this.hass)}catch(e){console.error("Failed to fetch setup config:",e)}}get _distributorsEnabled(){var e,t;return null!==(t=null===(e=this.config)||void 0===e?void 0:e.distributors_enabled)&&void 0!==t&&t}get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(Cn).includes(null!=t?t:"")?t:Cn.WeatherLocation}_selectTab(e){Ma(0,Za("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return W``;const e=this._distributorsEnabled,t=Object.values(Cn).filter(t=>t!==Cn.Distributors||e);let i=this._activeTab;return i!==Cn.Distributors||e||(i=Cn.WeatherLocation),W`
      <div class="setup-container">
        <nav class="setup-nav">
          ${t.map(e=>W`
              ...
              >
                ${Ea(En[e],this.hass.language)}
              </button>
            `)}
          <button
            class="setup-nav-btn wizard-btn"
            @click="${this._openWizard}"
            title="${Ea("wizard.title",this.hass.language)}"
          >
            <ha-icon icon="mdi:creation"></ha-icon>
            ${Ea("wizard.open_button",this.hass.language)}
          </button>
        </nav>
        <div class="setup-content">${this._renderContent(i)}</div>
      </div>
    `}_renderContent(e){if(!this.hass)return W``;switch(e){case Cn.WeatherLocation:return W`
          ...
          <smart-irrigation-view-weather-data
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-weather-data>
        `;case Cn.Zones:return W`<smart-irrigation-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-zone-settings>`;case Cn.Distributors:return W`<smart-irrigation-view-distributor-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-distributor-settings>`;case Cn.WhenToWater:return W`
          <smart-irrigation-view-general
            .hass="${this.hass}"
            .narrow="${this.narrow}"
        ...
        `;case Cn.Advanced:return W`
          ...
          <smart-irrigation-view-mappings
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-mappings>
        `;case Cn.Experimental:return W`<smart-irrigation-view-experimental
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-experimental>`;case Cn.Help:return this._renderHelp()}}_renderHelp(){return this.hass?W`
      <ha-card
        header="${Ea("panels.help.cards.how-to-get-help.title",this.hass.language)}"
      >
        <div class="card-content">
          ${Ea("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)}
          <a href="${"https://justchr.github.io/HAsmartirrigation/"}" target="_blank" rel="noopener noreferrer"
            >${Ea("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
          >.
          ${Ea("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
          <a
            href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
            target="_blank"
            rel="noopener noreferrer"
            >${Ea("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
          >
          ${Ea("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
          <a href="${"https://github.com/JustChr/HAsmartirrigation/issues"}" target="_blank" rel="noopener noreferrer"
            >${Ea("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
          >
          (${Ea("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
        </div>
      </ha-card>
    ...
    `}};var On;t([pe({attribute:!1})],Tn.prototype,"hass",void 0),t([pe({type:Boolean})],Tn.prototype,"narrow",void 0),t([pe({attribute:!1})],Tn.prototype,"path",void 0),t([ge()],Tn.prototype,"config",void 0),Tn=t([ce("smart-irrigation-view-setup")],Tn),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done"}(On||(On={}));let Hn=class extends le{constructor(){super(...arguments),this._step=On.Welcome,this._saving=!1,this._error="",this._confirmClose=!1,this._siConfig=null,this._useWeather=!1,this._weatherService=ze,this._apiKey="",this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=Ue,this._humiditySource=Ue,this._precipSource=Ue,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="",this._scheduleTime="06:00",this._scheduleCreated=!1,this._creatingSchedule=!1}async connectedCallback(){super.connectedCallback(),await this._loadInitialData()}async _loadInitialData(){var e;if(this.hass){try{const[t,i,s]=await Promise.all([Oi(this.hass),Pi(this.hass),Si(this.hass)]);this._availableModules=t,this._weatherConfig=i,this._siConfig=s,this._useWeather=i.use_weather_service,this._weatherService=null!==(e=i.weather_service)&&void 0!==e?e:ze}catch(e){console.error("Wizard: failed to load initial data",e),this._error=Ia(e)}this.requestUpdate()}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}))}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}))}async _next(){this._error="";try{switch(this._saving=!0,this._step){case On.Welcome:this._step=On.Weather;break;case On.Weather:await this._saveWeather(),this._step=On.Module;break;case On.Module:await this._saveModule(),this._step=On.Mapping;break;case On.Mapping:await this._saveMapping(),this._step=On.Zone;break;case On.Zone:await this._saveZone(),this._step=On.Done;break;case On.Done:this._close()}}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._saving=!1,this.requestUpdate()}}_back(){this._step>On.Welcome&&(this._step=this._step-1,this._error="")}get _canSkipCurrentStep(){return this._step===On.Weather}_skipStep(){this._canSkipCurrentStep&&this._step<On.Done&&(this._step=this._step+1,this._error="")}async _saveWeather(){await Bi(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null)}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0}catch(e){return}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await Hi(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>Ti(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.")}async _saveMapping(){const e=this._useWeather?Ue:Ge,t={[Pe]:{[Ke]:this._tempSource},[Me]:{[Ke]:this._humiditySource},[Ie]:{[Ke]:this._precipSource}},i=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const s of i)t[s]={[Ke]:e};const s=await Mi(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(s,()=>Di(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.")}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await Ei(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:Fa.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0})}async _createDefaultSchedule(){var e,t;if(!this._scheduleCreated&&!this._creatingSchedule){this._error="",this._creatingSchedule=!0;try{const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";await Ni(this.hass,{name:Ea("wizard.steps.done.schedule_name",i)||"Daily",type:"daily",enabled:!0,time:this._scheduleTime||"06:00",action:"irrigate",zones:"all"}),this._scheduleCreated=!0}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._creatingSchedule=!1,this.requestUpdate()}}}render(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return W`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          <div class="wizard-header">
            <span class="wizard-title">${Ea("wizard.title",i)}</span>
            <button
              class="wizard-close-btn"
              @click="${this._close}"
              title="${Ea("wizard.close",i)}"
              aria-label="${Ea("wizard.close",i)}"
            >
              <ha-icon icon="mdi:close"></ha-icon>
            </button>
          </div>
          ${this._step!==On.Welcome&&this._step!==On.Done?W`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>On.Welcome&&this._step<On.Done?this._confirmClose=!0:this._close())}_renderStepper(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",s=[Ea("wizard.stepper.weather",i),Ea("wizard.stepper.module",i),Ea("wizard.stepper.mapping",i),Ea("wizard.stepper.zone",i)];return W`
      ${s.map((e,t)=>{const i=t+1,a=this._step===i,n=this._step>i;return W`
        ...
        `})}
    `}_renderStep(e){switch(this._step){case On.Welcome:return this._renderWelcome(e);case On.Weather:return this._renderWeather(e);case On.Module:return this._renderModule(e);case On.Mapping:return this._renderMapping(e);case On.Zone:return this._renderZone(e);case On.Done:return this._renderDone(e);default:return W``}}_renderFooter(e){return this._step===On.Done?W``:W`
      <div class="footer-left">
        ${this._step>On.Welcome?W`<button
              class="wizard-btn secondary"
              @click="${this._back}"
              ?disabled="${this._saving}"
            >
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Ea("common.saving-messages.saving",e):this._step===On.Welcome||this._step<On.Zone?Ea("wizard.next",e):Ea("wizard.finish",e)}
      </button>
    `}_renderWelcome(e){return W`
      <h2 class="step-title">
        ${Ea("wizard.steps.welcome.title",e)}
      </h2>
      <p class="step-desc">${Ea("wizard.steps.welcome.intro",e)}</p>
      <ul class="step-list">
        <li>① ${Ea("wizard.steps.welcome.step1_label",e)}</li>
        <li>② ${Ea("wizard.steps.welcome.step2_label",e)}</li>
        <li>③ ${Ea("wizard.steps.welcome.step3_label",e)}</li>
        <li>④ ${Ea("wizard.steps.welcome.step4_label",e)}</li>
      </ul>
      <p class="step-tip">${Ea("wizard.steps.welcome.tip",e)}</p>
    `}_renderWeather(e){return W`
      <h2 class="step-title">
        ${Ea("wizard.steps.weather.title",e)}
      </h2>
      <p class="step-desc">
        ${Ea("wizard.steps.weather.description",e)}
      </p>
    ...
    `}_renderModule(e){if(0===this._availableModules.length)return W`
        <h2 class="step-title">
          ${Ea("wizard.steps.module.title",e)}
        </h2>
        <p class="step-desc">
          ${Ea("wizard.steps.module.no_modules",e)}
        </p>
      `;const t=this._availableModules[this._selectedModuleIndex];return W`
      <h2 class="step-title">${Ea("wizard.steps.module.title",e)}</h2>
      <p class="step-desc">
        ${Ea("wizard.steps.module.description",e)}
      </p>

      <si-field
        label="${Ea("wizard.steps.module.pick_label",e)}"
        required
      >
        <select
          class="wizard-input"
    ...
    `}_renderMapping(e){const t=[{value:Ue,label:Ea("wizard.steps.mapping.use_weather_service",e)},{value:"sensor",label:Ea("wizard.steps.mapping.use_sensor",e)},{value:"static",label:Ea("wizard.steps.mapping.use_static",e)},{value:Ge,label:Ea("wizard.steps.mapping.use_none",e)}],i=(i,s,a)=>W`
      <si-field
        label="${Ea("wizard.steps.mapping.source_label",e)} ${i}"
      >
        <select
          class="wizard-input"
    ...
    `;return W`
      <h2 class="step-title">
        ${Ea("wizard.steps.mapping.title",e)}
      </h2>
      <p class="step-desc">
        ${Ea("wizard.steps.mapping.description",e)}
      </p>

      <si-field
        label="${Ea("wizard.steps.mapping.name_label",e)}"
        required
      >
        <input
          type="text"
      ...
      ${i(Ea("panels.mappings.cards.mapping.items.temperature",e)||"Temperature",this._tempSource,e=>{this._tempSource=e,this.requestUpdate()})}
      ${i(Ea("panels.mappings.cards.mapping.items.humidity",e)||"Humidity",this._humiditySource,e=>{this._humiditySource=e,this.requestUpdate()})}
      ${i(Ea("panels.mappings.cards.mapping.items.precipitation",e)||"Precipitation",this._precipSource,e=>{this._precipSource=e,this.requestUpdate()})}

      <p class="step-tip">
        ${Ea("wizard.steps.mapping.description",e)}
      </p>
    `}_renderZone(e){var t;const i="imperial"!==(null===(t=this._siConfig)||void 0===t?void 0:t.units);return W`
      <h2 class="step-title">${Ea("wizard.steps.zone.title",e)}</h2>
      <p class="step-desc">
        ${Ea("wizard.steps.zone.description",e)}
      </p>
    ...
    `}_renderDone(e){return W`
      <div class="done-wrapper">
        ...
        <h2 class="step-title">${Ea("wizard.steps.done.title",e)}</h2>
        <p class="step-desc">
          ${Ea("wizard.steps.done.description",e)}
        </p>
        <ul class="step-list">
          <li>${Ea("wizard.steps.done.tip1",e)}</li>
          <li>${Ea("wizard.steps.done.tip2",e)}</li>
          <li>${Ea("wizard.steps.done.tip3",e)}</li>
        </ul>
        ...
        <div class="schedule-offer">
          ${this._scheduleCreated?W`
                <div class="schedule-created">
                  ...
                  <span
                    >${Ea("wizard.steps.done.schedule_created",e)}</span
                  >
                </div>
              `:W`
                <p class="schedule-offer-title">
                  ${Ea("wizard.steps.done.schedule_title",e)}
                </p>
                <p class="schedule-offer-desc">
                  ${Ea("wizard.steps.done.schedule_desc",e)}
                </p>
                <div class="schedule-offer-row">
                  ...
                  >
                    ${this._creatingSchedule?Ea("common.saving-messages.saving",e):Ea("wizard.steps.done.schedule_create",e)}
                  </button>
                </div>
              `}
        </div>
        ...
        <div class="done-actions">
          ...
          >
            ${Ea("wizard.steps.done.go_zones",e)}
          </button>
          <button
            class="wizard-btn secondary"
            @click="${()=>{this._close(),this._navigate("setup")}}"
          >
            ${Ea("wizard.steps.done.go_setup",e)}
          </button>
        </div>
      </div>
    `}static get styles(){return r`
      ...
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            ...
            .narrow=${this.narrow}
          ></ha-menu-button>
          <div class="main-title">${Ea("title",this.hass.language)}</div>
        ...
        ${s&&a?W`
              <ha-tab-group @wa-tab-show=${this.handlePageSelected}>
                ${Object.values(Mn).map(e=>W`
                    <ha-tab-group-tab
                      slot="nav"
                      panel="${e}"
                      .active=${i.page===e}
                    >
                      ${Ea(`panels.${e}.title`,this.hass.language)}
                    </ha-tab-group-tab>
                  `)}
              </ha-tab-group>
            `:W`
    ...
    `}getView(e){switch(e.page){case"zones":default:return W`
        ...
        `;case"setup":return W`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0}}"
          ></smart-irrigation-view-setup>
        `}}navigateToPage(e){if(e!==Wa().page){const t=Za(e);Ma(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==Wa().page){const e=Za(t);Ma(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[Dn,r`
        :host {
          color: var(--primary-text-color);

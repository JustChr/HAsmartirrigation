...
/**
    ...
    `}_renderRunLogRow(e,t){const s=this.hass.language,i=_a(`panels.zones.history.results.${e.result}`,s);let a="";return e.detail&&(a="skipped"===e.result?e.detail.split(",").map(e=>_a(`panels.zones.outlook.checks.${e}`,s)||e).join(", "):_a(`panels.zones.fault.${e.detail}`,s)||e.detail),Z`
      <tr>
        <td>${La(e.ts)}</td>
        <td>

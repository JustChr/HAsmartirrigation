!function(e){"use strict";var t=function(e,a){return t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t;}||function(e,t){for(var a in t)Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);},t(e,a);};function a(e,a){if("function"!=typeof a&&null!==a)throw new TypeError("Class extends value "+String(a)+" is not a constructor or null");function i(){this.constructor=e;}t(e,a),e.prototype=null===a?Object.create(a):(i.prototype=a.prototype,new i());}var i=function(){return i=Object.assign||function(e){for(var t,a=1,i=arguments.length;a<i;a++)for(var n in t=arguments[a])Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e;},i.apply(this,arguments);};function n(e,t,a,i){var n,s=arguments.length,r=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,a,i);else for(var o=e.length-1;o>=0;o--)(n=e[o])&&(r=(s<3?n(r):s>3?n(t,a,r):n(t,a))||r);return s>3&&r&&Object.defineProperty(t,a,r),r;}function s(e,t,a){if(a||2===arguments.length)for(var i,n=0,s=t.length;n<s;n++)!i&&n in t||(i||(i=Array.prototype.slice.call(t,0,n)),i[n]=t[n]);return e.concat(i||Array.prototype.slice.call(t));}"function"==typeof SuppressedError&&SuppressedError;/**
  ...
  `);}const Bt=(e,t,a=!1)=>{a?history.replaceState(null,"",t):history.pushState(null,"",t),ke(window,"location-changed",{replace:a});},Ut={},Rt=Ot(class extends Ct{constructor(e){if(super(e),e.type!==Dt&&e.type!==Et&&e.type!==jt)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression");}render(e){return e;}update(e,[t]){if(t===F||t===q)return t;const a=e.element,i=e.name;if(e.type===Dt){if(t===a[i])return F;}else if(e.type===jt){if(!!t===a.hasAttribute(i))return F;}else if(e.type===Et&&a.getAttribute(i)===t+"")return F;return((e,t=Ut)=>{e._$AH=t;/**
     * @license
...
i.version="2.30.1",n(Ya),i.fn=ls,i.min=Ja,i.max=Qa,i.now=ei,i.utc=g,i.unix=ds,i.months=vs,i.isDate=c,i.locale=ga,i.invalid=_,i.duration=Ai,i.isMoment=z,i.weekdays=_s,i.parseZone=us,i.localeData=fa,i.isDuration=ri,i.monthsShort=fs,i.weekdaysMin=ys,i.defineLocale=ma,i.updateLocale=va,i.locales=_a,i.weekdaysShort=bs,i.normalizeUnits=ae,i.relativeTimeRounding=nr,i.relativeTimeThreshold=sr,i.calendarFormat=Bi,i.prototype=ls,i.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},i;}();}(ir)),ir.exports),sr=er(nr);let rr=class extends de{constructor(){super(...arguments),this.label="",this.unit="",this.help="",this.required=!1,this._helpOpen=!1;}_toggleHelp(){this._helpOpen=!this._helpOpen;}render(){return W`
    ...
    `:W``;}static get styles(){return[ra,c`
      ...
      `];}};n([he({attribute:!1})],pr.prototype,"hass",void 0),n([ge()],pr.prototype,"_schedules",void 0),n([ge()],pr.prototype,"_zones",void 0),n([ge()],pr.prototype,"_isLoading",void 0),n([ge()],pr.prototype,"_showDialog",void 0),n([ge()],pr.prototype,"_editingSchedule",void 0),n([ge()],pr.prototype,"_editingId",void 0),pr=n([ce("smart-irrigation-view-schedules")],pr);const hr=()=>{const e=e=>{let t={};for(let a=0;a<e.length;a+=2){const i=e[a],n=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:n});}return t;},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex(e=>"filter"==e),n=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(n)});}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})));}return a;},gr=(e,...t)=>{let a={page:e,params:{}};t.forEach(e=>{"string"==typeof e?a=Object.assign(Object.assign({},a),{subpage:e}):"params"in e?a=Object.assign(Object.assign({},a),{params:e.params}):"filter"in e&&(a=Object.assign(Object.assign({},a),{filter:e.filter}));});const i=e=>{let t=Object.keys(e);t=t.filter(t=>e[t]),t.sort();let a="";return t.forEach(t=>{const i=e[t];a=a.length?`${a}/${t}/${i}`:`${t}/${i}`;}),a;};let n=`/${Se}/${a.page}`;return a.subpage&&(n=`${n}/${a.subpage}`),i(a.params).length&&(n=`${n}/${i(a.params)}`),a.filter&&(n=`${n}/filter/${i(a.filter)}`),n;};var mr;!function(e){e.General="general",e.Modules="modules",e.Mappings="mappings",e.Schedules="schedules",e.Help="help";}(mr||(mr={}));const vr={[mr.General]:"panels.general.title",[mr.Modules]:"panels.modules.title",[mr.Mappings]:"panels.mappings.title",[mr.Schedules]:"panels.schedules.title",[mr.Help]:"panels.help.title"};let fr=class extends de{get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(mr).includes(null!=t?t:"")?t:mr.General;}_selectTab(e){Bt(0,gr("setup",e));}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}));}render(){if(!this.hass)return W``;const e=this._activeTab;return W`
      <div class="setup-container">
        <nav class="setup-nav">
          ${Object.values(mr).map(t=>W`
              <button
                class="setup-nav-btn ${e===t?"active":""}"
                @click="${()=>this._selectTab(t)}"
              >
                ${Qs(vr[t],this.hass.language)}
              </button>
            `)}
          <button
    ...
    `;}_renderContent(e){if(!this.hass)return W``;switch(e){case mr.General:return W`<smart-irrigation-view-general
          .hass="${this.hass}"
          .narrow="${this.narrow}"
    ...
    `;}};var _r;n([he({attribute:!1})],fr.prototype,"hass",void 0),n([he({type:Boolean})],fr.prototype,"narrow",void 0),n([he({attribute:!1})],fr.prototype,"path",void 0),fr=n([ce("smart-irrigation-view-setup")],fr),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done";}(_r||(_r={}));let br=class extends de{constructor(){super(...arguments),this._step=_r.Welcome,this._saving=!1,this._error="",this._siConfig=null,this._useWeather=!1,this._weatherService=Me,this._apiKey="",this._testingApi=!1,this._testResult=null,this._testResultTimer=null,this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=We,this._humiditySource=We,this._precipSource=We,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="";}async connectedCallback(){super.connectedCallback(),await this._loadInitialData();}async _loadInitialData(){var e;if(this.hass){try{const[t,a,i]=await Promise.all([Gt(this.hass),ea(this.hass),qt(this.hass)]);this._availableModules=t,this._weatherConfig=a,this._siConfig=i,this._useWeather=a.use_weather_service,this._weatherService=null!==(e=a.weather_service)&&void 0!==e?e:Me;}catch(e){console.error("Wizard: failed to load initial data",e);}this.requestUpdate();}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}));}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}));}async _next(){this._error="";try{switch(this._saving=!0,this._step){case _r.Welcome:this._step=_r.Weather;break;case _r.Weather:await this._saveWeather(),this._step=_r.Module;break;case _r.Module:await this._saveModule(),this._step=_r.Mapping;break;case _r.Mapping:await this._saveMapping(),this._step=_r.Zone;break;case _r.Zone:await this._saveZone(),this._step=_r.Done;break;case _r.Done:this._close();}}catch(e){this._error=e instanceof Error?e.message:String(e);}finally{this._saving=!1,this.requestUpdate();}}_back(){this._step>_r.Welcome&&(this._step=this._step-1,this._error="");}_skipStep(){this._step<_r.Done&&(this._step=this._step+1,this._error="");}async _saveWeather(){await aa(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null);}async _saveModule(){if(0===this._availableModules.length)return;const e=this._availableModules[this._selectedModuleIndex],t=await Kt(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});this._savedModuleId="object"==typeof t&&(null==t?void 0:t.id)?t.id:void 0;}async _saveMapping(){const e=this._useWeather?We:Ge,t={[Ue]:{[Ke]:this._tempSource},[Ne]:{[Ke]:this._humiditySource},[He]:{[Ke]:this._precipSource}},a=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const i of a)t[i]={[Ke]:e};const i=await Jt(this.hass,{name:this._mappingName,mappings:t});this._savedMappingId="object"==typeof i&&(null==i?void 0:i.id)?i.id:void 0;}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");await Zt(this.hass,{name:this._zoneName.trim(),size:parseFloat(this._zoneSize)||0,throughput:parseFloat(this._zoneThroughput)||0,state:sa.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0});}async _testApiKey(){if(this.hass&&!this._testingApi){this._testingApi=!0,this._testResult=null,this._testResultTimer&&clearTimeout(this._testResultTimer),this.requestUpdate();try{const e=await ta(this.hass,this._weatherService,this._apiKey||null);this._testResult=e,this._testResultTimer=window.setTimeout(()=>{this._testResult=null,this.requestUpdate();},12e3);}catch(e){this._testResult={success:!1,error:"unknown"};}finally{this._testingApi=!1,this.requestUpdate();}}}render(){var e,t;const a=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return W`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          ...
          ${this._step!==_r.Welcome&&this._step!==_r.Done?W`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `;}_onOverlayClick(e){e.target===e.currentTarget&&this._close();}_renderStepper(){const e=["Weather","Module","Sensor Group","Zone"];return W`
      ${e.map((t,a)=>{const i=a+1,n=this._step===i,s=this._step>i;return W`
        ...
        `;})}
    `;}_renderStep(e){switch(this._step){case _r.Welcome:return this._renderWelcome(e);case _r.Weather:return this._renderWeather(e);case _r.Module:return this._renderModule(e);case _r.Mapping:return this._renderMapping(e);case _r.Zone:return this._renderZone(e);case _r.Done:return this._renderDone(e);default:return W``;}}_renderFooter(e){return this._step===_r.Done?W``:W`
      <div class="footer-left">
        ${this._step>_r.Welcome?W`<button
        ...
        ${this._step>_r.Welcome&&this._step<_r.Done?W`<button
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Qs("common.saving-messages.saving",e):this._step===_r.Welcome||this._step<_r.Zone?Qs("wizard.next",e):Qs("wizard.finish",e)}
      </button>
    ...
    `;}};n([he({attribute:!1})],br.prototype,"hass",void 0),n([ge()],br.prototype,"_step",void 0),n([ge()],br.prototype,"_saving",void 0),n([ge()],br.prototype,"_error",void 0),n([ge()],br.prototype,"_siConfig",void 0),n([ge()],br.prototype,"_useWeather",void 0),n([ge()],br.prototype,"_weatherService",void 0),n([ge()],br.prototype,"_apiKey",void 0),n([ge()],br.prototype,"_testingApi",void 0),n([ge()],br.prototype,"_testResult",void 0),n([ge()],br.prototype,"_availableModules",void 0),n([ge()],br.prototype,"_selectedModuleIndex",void 0),n([ge()],br.prototype,"_moduleConfig",void 0),n([ge()],br.prototype,"_mappingName",void 0),n([ge()],br.prototype,"_tempSource",void 0),n([ge()],br.prototype,"_humiditySource",void 0),n([ge()],br.prototype,"_precipSource",void 0),n([ge()],br.prototype,"_zoneName",void 0),n([ge()],br.prototype,"_zoneSize",void 0),n([ge()],br.prototype,"_zoneThroughput",void 0),n([ge()],br.prototype,"_zoneEntity",void 0),br=n([ce("si-setup-wizard")],br);const yr=ra;var wr;!function(e){e.Zones="zones",e.Setup="setup";}(wr||(wr={})),e.SmartIrrigationPanel=class extends de{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100;}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate();}));}async firstUpdated(){Bt(0,gr(wr.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate());}),be().then(()=>{this._scheduleUpdate();}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate();});}render(){const e=hr(),t=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return W`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
    ...
    `;}getView(e){switch(e.page){case"zones":default:return W`
        ...
        `;case"setup":return W`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0;}}"
          ></smart-irrigation-view-setup>
        `;}}navigateToPage(e){if(e!==hr().page){const t=gr(e);Bt(0,t),this.requestUpdate();}else scrollTo(0,0);}handlePageSelected(e){const t=e.detail.name;if(t!==hr().page){const e=gr(t);Bt(0,e),this.requestUpdate();}else scrollTo(0,0);}static get styles(){return[yr,c`
        :host {
          color: var(--primary-text-color);

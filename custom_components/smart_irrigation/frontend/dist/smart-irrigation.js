...
`;const on=e=>String(e).padStart(2,"0");function rn(e){return e instanceof Date?e:new Date(e)}function ln(e){const t=rn(e);return`${on(t.getHours())}:${on(t.getMinutes())}`}function dn(e){const t=rn(e);return`${t.getFullYear()}-${on(t.getMonth()+1)}-${on(t.getDate())} ${on(t.getHours())}:${on(t.getMinutes())}`}function cn(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class hn extends(Qa(ce)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){ei().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const s=Object.values(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).some(e=>!0!==e.queued&&!0!==e.paused);s&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):s||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:be+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[s,i,a,n]=await Promise.all([Ns(this.hass),Rs(this.hass),(t=this.hass,t.callWS({type:be+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),Gs(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=s,this.zones=i,this._outlook=a,this._distributors=n,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),Ya(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",be+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),Ya(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",be+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),Ya(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const s="all"===t,i=s?void 0:this.zones.find(e=>{var s;return(null===(s=e.id)||void 0===s?void 0:s.toString())===t}),a=s?`(${this._linkedZoneCount})`:`: ${null!==(e=null==i?void 0:i.name)&&void 0!==e?e:t}`;try{await(n=this.hass,o=s?void 0:t,n.callWS(Object.assign({type:be+"/irrigate_now"},void 0!==o?{zone_id:o}:{}))),Va(this,`${Ua("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${a}`)}catch(e){const t=Ga(e);console.error("irrigate_now failed",e),Va(this,`${Ua("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var n,o}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const s=new Date(t);return s.getTime()>Date.now()?s:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:be+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),Ya(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:be+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),Ya(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,s;const i=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(s=this._runMinutes[i])&&void 0!==s?s:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const s=this._zoneDistributor(e);return!!s&&Object.keys(null!==(t=s.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var s,i,a;if(t>0)try{await(s=this.hass,i=e.id.toString(),a=t,s.callWS({type:be+"/run_zone",zone_id:i,duration:a})),Va(this,`${Ua("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=Ga(e);console.error("run_zone failed",e),Va(this,`${Ua("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===s?void 0:s[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,s;if(this.hass&&void 0!==e.id)try{await(t=this.hass,s=e.id.toString(),t.callWS({type:be+"/stop_zone",zone_id:s})),Va(this,`${Ua("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=Ga(e);console.error("stop_zone failed",e),Va(this,`${Ua("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",be+"/zones",{id:i,calculate:!0,override_cache:!0})).catch(e=>{const t=Ga(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",be+"/zones",{id:i,update:!0})).catch(e=>{const t=Ga(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;qa(0,t?an("setup","zones",t):an("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,s,i;const a=null!==(t=e.duration)&&void 0!==t?t:0,n=Number(null!==(s=e.bucket_threshold)&&void 0!==s?s:0),o=this._zoneEstimate(e),r=o&&o.available&&null!=o.live_deficit?o.live_deficit:Number(null!==(i=e.bucket)&&void 0!==i?i:0);return a>0&&r<n}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,s=new Date(e),i=ln(s),a=new Date;return cn(s,a)?`${Ua("panels.zones.outlook.today",t)} ${i}`:cn(s,function(e,t){const s=new Date(e.getTime());return s.setDate(s.getDate()+t),s}(a,1))?`${Ua("panels.zones.outlook.tomorrow",t)} ${i}`:function(e,t){const s=rn(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(s)} ${ln(s)}`}(s,t)}_renderEstimatedTag(e){if(!this.hass||!e.estimated)return W``;const t=this.hass.language;return W`<span
    ...
    `}_zoneSkip(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.zone_skips)||void 0===s?void 0:s[String(e.id)]}_renderZoneSkip(e){if(!this.hass)return W``;const t=this._zoneSkip(e);if(!t)return W``;const s=this.hass.language,i=Ua("panels.zones.skip.soil_moisture",s,"{observed}",String(t.observed),"{threshold}",String(t.threshold)),a=t.timestamp?dn(t.timestamp):"";return W`
    ...
    `}_durationClamped(e){var t,s;if(e.state!==tn.Automatic)return!1;const i=e.maximum_duration;if(null==i||i<0)return!1;const a=null!==(t=e.duration)&&void 0!==t?t:0;return!(a<=0)&&a-(null!==(s=e.lead_time)&&void 0!==s?s:0)>=i}_renderDurationClamped(e){var t;if(!this.hass||!this._durationClamped(e))return W``;const s=this.hass.language,i=Ua("panels.zones.clamped.detail",s,"{maximum}",Ka(null!==(t=e.maximum_duration)&&void 0!==t?t:0));return W`
    ...
    `}_renderZoneEstimate(e){if(!this.hass)return W``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return W``;const s=this.hass.language,i=Za(this.config,bt),a=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",n=Ua(`panels.zones.status.estimate_method.${"proxy"===t.method||"hourly_sensor"===t.method?t.method:"hourly"}`,s)+(t.as_of?` · ${ln(t.as_of)}`:"");return W`
    ...
    `}_renderZoneNextRun(e){if(!this.hass)return W``;const t=this._nextIrrigateRunForZone(e);if(!t||!t.next_run_utc)return W``;return e.state!==tn.Disabled&&e.last_calculated&&this._zoneHasDeficit(e)&&0===this._triggeredGuards.length?W``:W`
      <span class="status-sep">·</span>
      <span>
    ...
    `}renderZone(e,t){var s;if(!this.hass)return W``;const i=Number(null!==(s=e.bucket)&&void 0!==s?s:0),a=i<0?"var(--warning-color)":"var(--success-color)",n=e.state===tn.Automatic?"state-automatic":e.state===tn.Manual?"state-manual":"state-disabled",o=e.last_calculated?dn(e.last_calculated):Ua("panels.zones.status.never",this.hass.language);return W`
      <ha-card>
        ...
        <div class="card-content zone-action-bar">
          ${"full"===this.actionsMode&&e.state===tn.Automatic?W`
                <button
                  class="action-btn"
    ...
    `}_renderRunZoneControl(e){if(!this.hass||"none"===this.actionsMode||!this._canActuate(e)||void 0===e.id)return W``;const t=this.hass.language,s=String(e.id),i=this._activeRun(e);if(i){const s=!0===i.queued,a=!s&&!0===i.paused,n=s||a?null:this._runSecondsLeft(i);return W`
        <div
    ...
    `}}t([me()],hn.prototype,"config",void 0),t([me({type:Boolean})],hn.prototype,"hideSettingsLinks",void 0),t([me({attribute:!1})],hn.prototype,"actionsMode",void 0),t([me({type:Array})],hn.prototype,"zones",void 0),t([ve()],hn.prototype,"_outlook",void 0),t([ve()],hn.prototype,"_distributors",void 0),t([me({type:Boolean})],hn.prototype,"isLoading",void 0),t([me({type:Boolean})],hn.prototype,"isSaving",void 0),t([ve()],hn.prototype,"_operationError",void 0),t([ve()],hn.prototype,"_confirmIrrigate",void 0),t([ve()],hn.prototype,"_skipDetailsOpen",void 0),t([ve()],hn.prototype,"_runMinutes",void 0),t([ve()],hn.prototype,"_now",void 0),customElements.get("smart-irrigation-view-zones")||customElements.define("smart-irrigation-view-zones",hn);const un=e=>9*e/5+32;function pn(e,t,s){if(null==e||Number.isNaN(e))return null;switch(t){case"temperature":return s?{value:e,unit:"°C"}:{value:un(e),unit:"°F"};case"precipitation":return s?{value:e,unit:ot}:{value:(n=e,n/25.4),unit:rt};case"windspeed":return s?{value:e,unit:ct}:{value:(a=e,2.2369362920544*a),unit:dt};case"pressure":return s?{value:e,unit:"hPa"}:{value:(i=e,.0295299830714*i),unit:lt}}var i,a,n}function gn(e,t,s,i){const a=pn(e,t,s);if(!a)return"-";const n=function(e,t){return"pressure"===e?t?0:2:"precipitation"===e?t?1:2:1}(t,s);return`${a.value.toFixed(n)} ${a.unit}`}function mn(e,t){return null==e||Number.isNaN(e)?"-":t?`${e.toFixed(0)} L`:`${(e=>.264172052*e)(e).toFixed(1)} gal`}let vn=class extends ce{render(){var e,t,s;if(!this.hass||!this.zone)return W``;const i=(null===(e=this.config)||void 0===e?void 0:e.units)===Me,a=null!==(t=this.zone.run_log)&&void 0!==t?t:[],n=this.hass.language;return W`
      <div class="history-usage">
        <span class="history-usage-label"
          >${Ua("panels.zones.history.total_used",n)}</span
        >
        <span class="history-usage-value"
          >${mn(null!==(s=this.zone.water_used_total)&&void 0!==s?s:0,i)}</span
        >
      </div>
      ${0===a.length?W`<div class="weather-note">
            ${Ua("panels.zones.history.empty",n)}
          </div>`:W`
            <table class="history-table">
              <thead>
                <tr>
                  <th>${Ua("panels.zones.history.when",n)}</th>
                  <th>${Ua("panels.zones.history.result",n)}</th>
                  <th class="num">
                    ${Ua("panels.zones.history.volume",n)}
                  </th>
                  <th>${Ua("panels.zones.history.detail",n)}</th>
                </tr>
              </thead>
              <tbody>
          ...
          `}
    `}_renderRow(e,t){const s=this.hass.language,i=Ua(`panels.zones.history.results.${e.result}`,s);let a="";return e.detail&&(a="skipped"===e.result?e.detail.split(",").map(e=>Ua(`panels.zones.outlook.checks.${e}`,s)||e).join(", "):/^[A-Za-z0-9_-]+$/.test(e.detail)&&Ua(`panels.zones.fault.${e.detail}`,s)||e.detail),W`
      <tr>
        <td>${dn(e.ts)}</td>
        <td>
    ...
    `}static get styles(){return[nn,r`
      ...
      `]}};t([me({attribute:!1})],vn.prototype,"hass",void 0),t([me({attribute:!1})],vn.prototype,"zone",void 0),t([me({attribute:!1})],vn.prototype,"config",void 0),vn=t([ue("si-zone-history")],vn);let fn=class extends(Qa(ce)){constructor(){super(...arguments),this._zones=[]}hassSubscribe(){return this._fetchData().catch(()=>{}),[this.hass.connection.subscribeMessage(()=>this._fetchData().catch(()=>{}),{type:be+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const[e,t]=await Promise.all([Ns(this.hass),Rs(this.hass)]);this._config=e,this._zones=t}_effectiveZone(){var e;if(this._zones.length)return null!==(e=this._zones.find(e=>e.id===this._selectedZoneId))&&void 0!==e?e:this._zones[0]}render(){if(!this.hass)return W``;const e=this.hass.language;if(!this._zones.length)return W`
        <ha-card header="${Ua("panels.history.title",e)}">
          <div class="card-content">
            <div class="weather-note">
              ${Ua("panels.history.no_zones",e)}
            </div>
          </div>
        </ha-card>
        ...
        <div class="card-content">
          <div class="zone-picker">
            <label for="zone-select"
              >${Ua("panels.history.select_zone",e)}</label
            >
            <select
              id="zone-select"
            ...
            >
              ${this._zones.map(e=>W`
                  <option value="${e.id}" ?selected=${e.id===t.id}>
                    ${e.name}
                  </option>
                `)}
            </select>
    ...
    `}static get styles(){return[nn,r`
      ...
      `]}};t([me({attribute:!1})],fn.prototype,"hass",void 0),t([me({type:Boolean})],fn.prototype,"narrow",void 0),t([me({attribute:!1})],fn.prototype,"path",void 0),t([ve()],fn.prototype,"_zones",void 0),t([ve()],fn.prototype,"_config",void 0),t([ve()],fn.prototype,"_selectedZoneId",void 0),fn=t([ue("smart-irrigation-view-history")],fn);
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */
const _n={},bn=ni(class extends oi{constructor(e){if(super(e),e.type!==ii&&e.type!==ti&&e.type!==ai)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===G||t===K)return t;const s=e.element,i=e.name;if(e.type===ii){if(t===s[i])return G}else if(e.type===ai){if(!!t===s.hasAttribute(i))return G}else if(e.type===ti&&s.getAttribute(i)===t+"")return G;return((e,t=_n)=>{e._$AH=t;
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */})(e),t}});let yn=class extends ce{constructor(){super(...arguments),this.label="",this.unit="",this.help="",this.required=!1,this._helpOpen=!1}_toggleHelp(){this._helpOpen=!this._helpOpen}render(){return W`
      <div class="si-field">
    ...
    `:W``}async _saveWeatherConfig(){if(this.hass){this._weatherSaving=!0,this._scheduleUpdate();try{await Ys(this.hass,this._useWeatherService,this._useWeatherService?this._weatherService:null,this._newApiKey||null),this._newApiKey="",await this._fetchData()}catch(e){console.error("Failed to save weather config:",e),Ya(this,this.hass,"common.errors.save_failed",e)}finally{this._weatherSaving=!1,this._scheduleUpdate()}}}_renderWeatherServiceCard(){var e;return this.hass?W`
      <ha-card
                ...
                <div class="setting-row">
                  ...
                  <div class="inline-row">
                    ...
                    <select
                      ...
                      .value="${bn(this.data.autoupdateschedule||Te)}"
    ...
    `:W``}_renderZoneSequencingCard(){var e,t;if(!this.hass||!this.config||!this.data)return W``;const s=(this.config.zone_sequencing||Wt)===qt;return W`
      <ha-card
      ...
      >
        ...
        <div class="card-content">
          <div class="setting-row">
            ...
            <select
              class="settings-input"
              .value="${bn(this.config.zone_sequencing||Wt)}"
    ...
    `}_renderBatchCard(){var e;if(!this.hass||!this.config)return W``;const t=!!this.config.batch_run_service,s=this.config.batch_paused_entity;return W`
    ...
    `}};t([me()],$n.prototype,"narrow",void 0),t([me()],$n.prototype,"path",void 0),t([me()],$n.prototype,"section",void 0),t([me()],$n.prototype,"data",void 0),t([me()],$n.prototype,"config",void 0),t([me({type:Boolean})],$n.prototype,"isLoading",void 0),t([me({type:Boolean})],$n.prototype,"isSaving",void 0),t([me()],$n.prototype,"_weatherConfig",void 0),t([me()],$n.prototype,"_weatherService",void 0),t([me({type:Boolean})],$n.prototype,"_useWeatherService",void 0),t([me()],$n.prototype,"_newApiKey",void 0),t([me({type:Boolean})],$n.prototype,"_weatherSaving",void 0),t([ve()],$n.prototype,"_coords",void 0),t([ve()],$n.prototype,"_coordsEnabled",void 0),t([ve()],$n.prototype,"_coordsLat",void 0),t([ve()],$n.prototype,"_coordsLon",void 0),t([ve()],$n.prototype,"_coordsElev",void 0),t([ve()],$n.prototype,"_coordsSaving",void 0),t([ve()],$n.prototype,"_saveStatus",void 0),$n=t([ue("smart-irrigation-view-general")],$n);let xn=class extends ce{constructor(){super(...arguments),this.metric=!0,this.name="",this.size="",this.throughput="",this.linkedEntity="",this.showEntity=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{value:t},bubbles:!0,composed:!0}))}render(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=this.metric?"m²":st,a=this.metric?it:at;return W`
    ...
    `}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await Ls(this.hass,e)}_renderModuleOptions(e){if(!this.hass)return W``;const t=null!=e?String(e):"";return W`
    ...
    `}_renderDistributorSelector(e,t){var s,i;if(!this.hass)return W``;if(!(null===(s=this.config)||void 0===s?void 0:s.distributors_enabled))return W``;const a=this.hass.language,n=null!=e.distributor_id;return W`
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${bn(n?String(e.distributor_id):"")}"
             ...
             used to sit alongside it moved to the Weather & Location tab). -->
              <div class="card-content zone-settings">
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${bn(null!==(i=Object.keys(jt).find(t=>jt[t]===e.drainage_rate))&&void 0!==i?i:"custom")}"
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${bn(null!==(o=e.plant_type)&&void 0!==o?o:"custom")}"
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${bn(void 0!==e.module?String(e.module):"")}"
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${bn(void 0!==e.mapping?String(e.mapping):"")}"
                ...
                ${null!=e.distributor_id?W`<div class="distributor-managed">
                      ...
                      <ha-settings-row>
                        ...
                        <select
                          class="settings-input"
                          .value="${bn(null!==(d=e.watering_mode)&&void 0!==d?d:"classic")}"
                      ...
                      ${"service"===e.watering_mode?W`
                            ...
                            <ha-settings-row>
                              ...
                              <select
                                class="settings-input"
                                .value="${bn(null!==(h=e.duration_unit)&&void 0!==h?h:"seconds")}"
                ...
                ${null==e.distributor_id?W`
                      ...
                      ${this._flowSensorIsTotalizer(e)?W`
                            <ha-settings-row>
                              ...
                              <select
                                class="settings-input"
                                .value="${bn(e.flow_counter_type||"auto")}"
    ...
    `}};t([me()],kn.prototype,"config",void 0),t([me({attribute:!1})],kn.prototype,"path",void 0),t([me({type:Array})],kn.prototype,"zones",void 0),t([me({type:Array})],kn.prototype,"modules",void 0),t([me({type:Array})],kn.prototype,"mappings",void 0),t([me({type:Array})],kn.prototype,"distributors",void 0),t([me({type:Boolean})],kn.prototype,"isLoading",void 0),t([ve()],kn.prototype,"_expanded",void 0),t([me({type:Boolean})],kn.prototype,"isSaving",void 0),t([me({type:Boolean})],kn.prototype,"_showAddZone",void 0),t([ve()],kn.prototype,"_pendingConfirm",void 0),t([ve()],kn.prototype,"_saveStatus",void 0),t([me()],kn.prototype,"_confirmDeleteZoneId",void 0),t([me()],kn.prototype,"_newZoneName",void 0),t([me()],kn.prototype,"_newZoneSize",void 0),t([me()],kn.prototype,"_newZoneThroughput",void 0),t([me()],kn.prototype,"_newZoneEntity",void 0),kn=t([ue("smart-irrigation-view-zone-settings")],kn);let zn=class extends ce{_emit(e){this.dispatchEvent(new CustomEvent("distributor-changed",{detail:{value:Object.assign(Object.assign({},this.distributor),e)},bubbles:!0,composed:!0}))}_onNumber(e,t){const s=t.target.valueAsNumber;isNaN(s)||this._emit({[e]:Math.max(0,Math.round(s))})}render(){var e,t,s,i;if(!this.hass||!this.distributor)return W``;const a=this.hass.language,n=this.distributor,o=n.watering_mode===Os;return W`
      <ha-settings-row>
        <span slot="heading"
      ...
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${bn(null!==(t=n.watering_mode)&&void 0!==t?t:Ts)}"
    ...
    `}_renderInletWatchRows(e){var t;const s=this.distributor,i=s.watering_mode===Os?"panels.distributors.labels.inlet_entity_help_service":"panels.distributors.labels.inlet_entity_help",a=null!==(t=s.watch_mode)&&void 0!==t?t:"ignore";return W`
      <ha-settings-row>
        <span slot="heading"
    ...
    `}_renderServiceRows(e){var t,s;const i=this.distributor;return W`
      ...
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${bn(null!==(t=i.duration_unit)&&void 0!==t?t:"seconds")}"
    ...
    `}_hasOwnActuation(e){return!!(e.linked_entity||e.run_service||e.stop_service)}_membersByOutlet(e){const t=new Map;if(void 0===e)return t;for(const s of this.zones)s.distributor_id===e&&null!=s.outlet_number&&void 0!==s.id&&t.set(s.outlet_number,s);return t}_outletCount(e){const t=this._membersByOutlet(e.id),s=t.size?Math.max(...t.keys()):0,i=Math.max(2,s),a=void 0!==e.id?this._outletRows[e.id]:void 0;return Math.min(6,Math.max(i,null!=a?a:i))}_assignZone(e,t,s){return Ls(this.hass,{id:e.id,[Hs]:t,[Is]:s})}_optimisticZone(e,t,s){void 0!==e&&(this.zones=this.zones.map(i=>i.id===e?Object.assign(Object.assign({},i),{distributor_id:t,outlet_number:s}):i))}_runAssign(e){e.length&&(this.isSaving=!0,this._saveStatus="saving",this._scheduleUpdate(),Promise.all(e).then(()=>this._markSaved()).catch(e=>{console.error("Failed to assign zone to outlet:",e),this._saveStatus="idle",Ya(this,this.hass,"common.errors.save_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(()=>{})}))}_setOutletCount(e,t){if(void 0===e.id)return;const s=this._membersByOutlet(e.id),i=[];for(const[e,a]of s)e>t&&i.push(a);this._outletRows=Object.assign(Object.assign({},this._outletRows),{[e.id]:t}),i.length?(i.forEach(e=>this._optimisticZone(e.id,null,null)),this._runAssign(i.map(e=>this._assignZone(e,null,null)))):this._scheduleUpdate()}_onOutletZoneChange(e,t,s){const i=s.target.value,a=i?parseInt(i):null,n=this._membersByOutlet(e.id).get(t),o=null!==a?this.zones.find(e=>e.id===a):null,r=[];n&&n.id!==a&&(r.push(this._assignZone(n,null,null)),this._optimisticZone(n.id,null,null)),o&&(r.push(this._assignZone(o,e.id,t)),this._optimisticZone(o.id,e.id,t)),this._runAssign(r)}_renderOutletConfig(e){if(!this.hass)return W``;const t=this.hass.language,s=this._membersByOutlet(e.id),i=this._outletCount(e),a=this.zones.filter(e=>void 0!==e.id&&null==e.distributor_id&&!this._hasOwnActuation(e)),n=[...s.keys()].sort((e,t)=>e-t),o=n.some((e,t)=>e!==t+1),r=[];for(let n=1;n<=i;n++){const i=s.get(n),o=i?[...a,i]:[...a];o.sort((e,t)=>(e.name||"").localeCompare(t.name||"")),r.push(W`
        <div class="outlet-row">
          ...
          <select
            class="settings-input"
            .value="${bn(null!=(null==i?void 0:i.id)?String(i.id):"")}"
    ...
    `}_renderAdvisories(){var e,t;if(!this.hass)return W``;const s=this.hass.language,i=null===(e=this.config)||void 0===e?void 0:e.zone_sequencing,a=i===Wt,n=i===Zt||i===qt,o=!!(null===(t=this.config)||void 0===t?void 0:t.master_off_after);return W`
        ...
        <ha-settings-row>
          ...
          <div class="inline-controls">
            <input
              ...
              max="${6}"
              step="1"
              .value="${bn(String(null!==(t=this._outletDraft[o])&&void 0!==t?t:e.current_outlet))}"
    ...
    `}renderSimpleRadioOptions(e,t,s){if(!this.hass||!this.config)return W``;const i=t===Ie||t===Be,a=s[Ye];return W`
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach(e=>{clearTimeout(e)}),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};t([me()],An.prototype,"config",void 0),t([me({type:Array})],An.prototype,"zones",void 0),t([me({type:Array})],An.prototype,"mappings",void 0),t([me({type:Boolean})],An.prototype,"isLoading",void 0),t([me({type:Boolean})],An.prototype,"isSaving",void 0),t([fe("#mappingNameInput")],An.prototype,"mappingNameInput",void 0),An=t([ue("smart-irrigation-view-mappings")],An);const En="06:00",Tn=90;function On(e){switch(e){case cs:return{mode:e,time:En};case hs:case us:return{mode:e,offset:0};case ps:return{mode:e,azimuth:Tn};default:return{mode:ds}}}function Dn(e,t,s,i){const a=function(e){return e===ds||e===cs||e===hs||e===us||e===ps}(e)?e:ds,n=On(a);return a===cs&&void 0!==t&&(n.time=t),a!==hs&&a!==us||void 0===s||(n.offset=s),a===ps&&void 0!==i&&(n.azimuth=i),n}function Mn(e){var t,s,i;return{mode:e.mode,time:e.mode===cs?null!==(t=e.time)&&void 0!==t?t:En:void 0,offset:e.mode===hs||e.mode===us?null!==(s=e.offset)&&void 0!==s?s:0:void 0,azimuth:e.mode===ps?null!==(i=e.azimuth)&&void 0!==i?i:Tn:void 0}}function Hn(e){return{start:Dn(e.start_mode,e.start_time,e.start_offset,e.start_azimuth),finish:Dn(e.finish_mode,e.finish_time,e.finish_offset,e.finish_azimuth),anchor:e.anchor===ms?ms:vs}}function In(e,t){const s=e.start.mode!==ds,i=e.finish.mode!==ds;if(!s&&!i)return{start:"error",finish:"error",valid:!1};return function(e,t,s){if(!(null==s?void 0:s.start)&&!(null==s?void 0:s.finish))return t;const i=e.start.mode!==ds,a=e.finish.mode!==ds,n=i&&a?e.anchor:i?ms:vs,o=e=>e===n?"unreachable_no_run":"unreachable_ignored";return Object.assign(Object.assign({},t),{start:s.start?o(ms):t.start,finish:s.finish?o(vs):t.finish})}(e,s?i?e.anchor===vs?{start:"demand_floored",finish:"exact_deferred",valid:!0}:{start:"exact",finish:"demand_capped_deferred",valid:!0}:{start:"exact",finish:"demand_open",valid:!0}:{start:"demand_open",finish:"exact",valid:!0},t)}function Nn(e){if(e.recurrence===ns&&0===(e.days_of_week||[]).length)return"no_days";if(e.recurrence!==rs){const t=Hn(e);if(t.start.mode===ds&&t.finish.mode===ds)return"no_window"}return Array.isArray(e.zones)&&0===e.zones.length?"no_zones":null}function Pn(e,t){const s=Nn(e);if(s)return{text:Ua(`panels.schedules.summary.${"no_window"===s?"invalid":s}`,t),isError:!0};const i=function(e,t){if("all"===e||!Array.isArray(e))return Ua("panels.schedules.summary.zones_all",t);return Ua("panels.schedules.summary.zones_some",t,"count",e.length)}(e.zones,t),a=function(e,t){switch(e.recurrence){case ns:{const s=(e.days_of_week||[]).map(e=>Ua(`panels.schedules.days.${e}`,t)).join(", ");return Ua("panels.schedules.summary.recurrence_weekly",t,"days",s)}case os:return Ua("panels.schedules.summary.recurrence_monthly",t,"day",e.day_of_month||1);case rs:{const s=e.interval_hours||24;return e.start_time?Ua("panels.schedules.summary.recurrence_interval_at",t,"hours",s,"time",e.start_time):Ua("panels.schedules.summary.recurrence_interval",t,"hours",s)}default:return Ua("panels.schedules.summary.recurrence_daily",t)}}(e,t);if(e.recurrence===rs){return{text:`${a}, ${Ua("panels.schedules.summary.watering",t,"zones",i)}.`,isError:!1}}const n=Hn(e),o=n.start.mode!==ds,r=n.finish.mode!==ds,l=Ua("panels.schedules.summary.watering",t,"zones",i);let d;return d=o?r?n.anchor===vs?Ua("panels.schedules.summary.anchor_finish",t,"finish",Rn(n.finish,t),"start",Rn(n.start,t)):Ua("panels.schedules.summary.anchor_start",t,"start",Rn(n.start,t),"finish",Rn(n.finish,t)):Ua("panels.schedules.summary.start_only",t,"when",Rn(n.start,t)):Ua("panels.schedules.summary.finish_only",t,"when",Rn(n.finish,t)),{text:`${a}, ${l}, ${d}.`,isError:!1}}function Rn(e,t){var s,i,a;switch(e.mode){case cs:return null!==(s=e.time)&&void 0!==s?s:"";case hs:case us:{const s=Ua(`panels.schedules.summary.${e.mode}`,t),a=null!==(i=e.offset)&&void 0!==i?i:0;if(0===a)return s;return Ua(a<0?"panels.schedules.summary.offset_before":"panels.schedules.summary.offset_after",t,"minutes",Math.abs(a),"event",s)}case ps:return Ua("panels.schedules.summary.at_azimuth",t,"degrees",null!==(a=e.azimuth)&&void 0!==a?a:Tn);default:return""}}function Ln(e){return(e%360+360)%360}const Bn=Math.PI/180;function Un(e,t,s){const i=e*Bn,a=23.45*Math.sin(360*(284+function(e){const t=Date.UTC(e.getUTCFullYear(),0,1),s=Date.UTC(e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate());return Math.floor((s-t)/864e5)+1}(s))/365*Bn)*Bn,n=15*(s.getUTCHours()+s.getUTCMinutes()/60+s.getUTCSeconds()/3600+t/15-12)*Bn;return Ln(Math.atan2(Math.sin(n),Math.cos(n)*Math.sin(i)-Math.tan(a)*Math.cos(i))/Bn+180)}function jn(e,t,s){return Math.abs(e-t)>180?e>t?s>=e||s<=t:s<=e||s>=t:Math.min(e,t)<=s&&s<=Math.max(e,t)}const Fn=9e5;function Zn(e,t,s,i,a){let n=i,o=a;for(;o-n>6e4;){const i=n+(o-n)/2,a=Un(e,t,new Date(i));jn(Un(e,t,new Date(n)),a,s)?o=i:n=i}return new Date(n)}const Wn={hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"};function qn(e,t){if(!e)return Gn(t);let s;try{s=new Intl.DateTimeFormat("en-US",Object.assign(Object.assign({},Wn),{timeZone:e})).formatToParts(t)}catch(e){return Gn(t)}const i=e=>{var t,i;return parseInt(null!==(i=null===(t=s.find(t=>t.type===e))||void 0===t?void 0:t.value)&&void 0!==i?i:"0",10)},a=i("hour")%24;return new Date(Date.UTC(i("year"),i("month")-1,i("day"),a,i("minute"),i("second")))}function Gn(e){return new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours(),e.getMinutes(),e.getSeconds()))}function Kn(e){return 60*e.getUTCHours()+e.getUTCMinutes()}function Vn(e,t){if("number"!=typeof(null==e?void 0:e.latitude)||"number"!=typeof(null==e?void 0:e.longitude))return;const{latitude:s,longitude:i,time_zone:a}=e;return e=>function(e,t,s,i,a){const n=qn(i,a),o=new Date(Date.UTC(n.getUTCFullYear(),n.getUTCMonth(),n.getUTCDate())),r=function(e,t,s,i,a=1){const n=i.getTime(),o=n+864e5*a;let r=n,l=Un(e,t,i);for(;r<o;){r+=Fn;const i=Un(e,t,new Date(r));if(jn(l,i,s))return Zn(e,t,s,r-Fn,r);l=i}return null}(e,t,Ln(s),function(e,t){let s=e.getTime();for(let i=0;i<2;i++){const i=qn(t,new Date(s)).getTime()-s;s=e.getTime()-i}return new Date(s)}(o,i));return null===r?null:Kn(qn(i,r))}(s,i,e,a,t)}const Yn=1440,Xn=44,Jn=260;function Qn(e){return(e%Yn+Yn)%Yn}function eo(e){const t=Qn(Math.round(e)),s=Math.floor(t/60),i=t%60;return`${String(s).padStart(2,"0")}:${String(i).padStart(2,"0")}`}function to(e){const t=Math.round(e),s=Math.floor(t/60),i=t%60;return s?`${s}h ${i}m`:`${i}m`}function so(e,t){const s=t/Yn*2*Math.PI+Math.PI/2;return[66+e*Math.cos(s),66+e*Math.sin(s)]}function io(e,t,s){const i=s-t>=Yn?t+Yn-.5:s,[a,n]=so(e,t),[o,r]=so(e,i),l=i-t>720?1:0;return`M ${a.toFixed(2)} ${n.toFixed(2)} A ${e} ${e} 0 ${l} 1 ${o.toFixed(2)} ${r.toFixed(2)}`}function ao(e,t,s,i,a){const n=2*Math.PI*e/Yn,o=[[0,s]];for(let e=0;e<=10;e++){const t=Math.PI/2+e/10*(Math.PI/2);o.push([i*Math.cos(t),s-i+i*Math.sin(t)])}for(let e=0;e<=10;e++){const t=Math.PI+e/10*(Math.PI/2);o.push([i*Math.cos(t),i*Math.sin(t)-3.2])}return o.push([0,-s]),o.map(([s,i],o)=>{const[r,l]=so(e+i,(e=>t-a*e/n)(s));return`${o?"L":"M"} ${r.toFixed(2)} ${l.toFixed(2)}`}).join(" ")+" Z"}function no(e,t,s,i,a){const n=(t-e)/48,o=[];for(let r=0;r<48;r++){const l=e+r*n,d=l+n/2;let c=1;s>0&&(c=Math.min(c,(d-e)/s)),i>0&&(c=Math.min(c,(t-d)/i)),c=Math.max(0,Math.min(1,c)),o.push({d:io(a,l,l+1.25*n),opacity:c})}return o}function oo(e){const[t,s]=e.split(":").map(e=>parseInt(e,10));return 60*(t||0)+(s||0)}function ro(e,t,s,i){var a,n,o,r;switch(e.mode){case cs:return Qn(oo(null!==(a=e.time)&&void 0!==a?a:"06:00"));case hs:return Qn(t+(null!==(n=e.offset)&&void 0!==n?n:0));case us:return Qn(s+(null!==(o=e.offset)&&void 0!==o?o:0));case ps:{if(!i)return null;const t=i(null!==(r=e.azimuth)&&void 0!==r?r:Tn);return null===t?null:Qn(t)}default:return null}}function lo(e,t){return{wraps:!1,arc:io(Xn,e,t),capStart:ao(Xn,e,5,1.8,-1),capEnd:ao(Xn,t,5,1.8,1)}}function co(e){const{rows:t,recurrence:s,intervalHours:i,intervalStartTime:a,nominalDemandMinutes:n,sunriseMinutes:o,sunsetMinutes:r,azimuthResolver:l}=e,d=io(Xn,0,Yn),c=[0,360,720,1080].map(e=>{const[t,s]=so(38,e),[i,a]=so(50,e);return{x1:t,y1:s,x2:i,y2:a}}),[h,u]=so(57,o),[p,g]=so(57,r);if(s===rs){const{runs:e,overlaps:t,wrapAt:s}=function(e,t,s){const i=60*Math.max(1,Number(t)||24),a=s?oo(s):0,n=[];for(let t=a;t<a+Yn&&n.length<24;t+=i)n.push([t,t+e]);const o=[];for(let e=0;e+1<n.length;e++)n[e][1]>n[e+1][0]&&o.push([n[e+1][0],Math.min(n[e][1],n[e+1][1])]);return{runs:n,overlaps:o,wrapAt:a+Yn}}(n,i,a),l=e.map(([e,t])=>{if(t<=s)return lo(e,t);const i=s-8,a=i-e,n=Math.min(a,120);return{wraps:!0,capStart:ao(Xn,e,5,1.8,-1),fade:no(e,i,0,n,Xn)}});return{trackPath:d,windowArc:null,dottedPath:null,runs:l,overlaps:t.map(([e,t])=>({d:io(Xn,e,t),fromMinutes:e,toMinutes:t})),ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:e.map(([e,t])=>{const[s,i]=so(57,(e+t)/2);return{x:s,y:i,fromMinutes:e,toMinutes:t}}),centre:{kind:"interval",perDay:e.length,intervalHours:Math.max(1,Number(i)||24)}}}const m=ro(t.start,o,r,l);let v=ro(t.finish,o,r,l);null!==m&&null!==v&&v<=m&&(v+=Yn);if(null===m&&null===v)return{trackPath:d,windowArc:null,dottedPath:null,runs:[],overlaps:[],ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:[],centre:{kind:"invalid"}};const f=null!==m&&null!==v?v-m:null;let _,b,y=0;if(null!==m&&null!==v){const e=f;b=Math.min(n,e),y=Math.max(0,n-e),_=t.anchor===vs?v-b:m}else null!==m?(_=m,b=n):(b=n,_=v-b);const w=_+b;let $=null!=m?m:_,x=null!=v?v:w,k=0,z=0;null===m&&($=_-Jn,k=Jn),null===v&&(x=w+Jn,z=Jn);const S=null!==f&&f<60,C=null===m||null===v?{kind:"faded",segments:no($,x,k,z,Xn)}:{kind:"solid",d:io(Xn,$,S?$+60:x)},A=y>1?io(Xn,_-y,_):null,[E,T]=so(57,(_+w)/2),O=null===f?{kind:"run",minutes:b}:{kind:"window",minutes:f};return{trackPath:d,windowArc:C,dottedPath:A,runs:[lo(_,w)],overlaps:[],ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:[{x:E,y:T,fromMinutes:_,toMinutes:w}],centre:O}}const ho=q`<circle cx="12" cy="12" r="4.4" />
  ${Array.from({length:8},(e,t)=>{const s=t*Math.PI/4,i=(12+6.6*Math.cos(s)).toFixed(1),a=(12+6.6*Math.sin(s)).toFixed(1),n=(12+9.2*Math.cos(s)).toFixed(1),o=(12+9.2*Math.sin(s)).toFixed(1);return q`<line x1="${i}" y1="${a}" x2="${n}" y2="${o}" />`})}`,uo=q`<path d="M13.5,2.5A9.5,9.5 0 1,0 21.5,14 7.6,7.6 0 0,1 13.5,2.5Z" />`,po=q`<path d="M12,2.6C12,2.6 18.6,9.4 18.6,13.7A6.6,6.6 0 0,1 5.4,13.7C5.4,9.4 12,2.6 12,2.6Z" />`;let go=class extends ce{constructor(){super(...arguments),this.recurrence="daily",this.nominalDemandSeconds=0}_sunTimes(){var e,t,s,i,a,n;const o=null===(t=null===(e=this.hass)||void 0===e?void 0:e.states)||void 0===t?void 0:t["sun.sun"],r=null===(s=null==o?void 0:o.attributes)||void 0===s?void 0:s.next_rising,l=null===(i=null==o?void 0:o.attributes)||void 0===i?void 0:i.next_setting,d=null===(n=null===(a=this.hass)||void 0===a?void 0:a.config)||void 0===n?void 0:n.time_zone,c=(e,t)=>{if(!e)return t;const s=new Date(e);return isNaN(s.getTime())?t:Kn(qn(d,s))};return{sunrise:c(r,360),sunset:c(l,1200)}}_azimuthResolver(){var e;return Vn(null===(e=this.hass)||void 0===e?void 0:e.config,new Date)}_renderRun(e,t){return e.wraps?q`
    ...
    `:q`
      ...
      `}_t(e,t,s){return Ua(`panels.schedules.dial.${e}`,t,"{from}",eo(s.fromMinutes),"{to}",eo(s.toMinutes))}_note(e,t){var s;const i=this.nominalDemandSeconds/60;if(!i)return W``;if("interval"===e.centre.kind){const s=e.overlaps.length>0;return W`
        <div class="d-note ${s?"warn":""}">
          ${s?Ua("panels.schedules.dial.collision_note",t):Ua("panels.schedules.dial.runs_of",t,"{count}",e.runs.length,"{duration}",to(i))}
        </div>
      `}if("window"!==e.centre.kind)return W``;const a=i-(null!==(s=e.centre.minutes)&&void 0!==s?s:0);return a<=1?W``:W`
      <div class="d-note warn">
        ${Ua("panels.schedules.dial.shortfall",t,"{duration}",to(a))}
      </div>
    `}_centreText(e,t){var s,i;const a=e.centre;switch(a.kind){case"invalid":return{val:"—",lbl:""};case"interval":return{val:Ua("panels.schedules.dial.every_hours",t,"{hours}",a.intervalHours),lbl:Ua("panels.schedules.dial.per_day",t,"{count}",a.perDay)};case"run":return{val:to(null!==(s=a.minutes)&&void 0!==s?s:0),lbl:Ua("panels.schedules.dial.run_label",t)};default:return{val:to(null!==(i=a.minutes)&&void 0!==i?i:0),lbl:Ua("panels.schedules.dial.window_label",t)}}}render(){if(!this.hass||!this.rows)return W``;const e=this.hass.language,{sunrise:t,sunset:s}=this._sunTimes(),i=co({rows:this.rows,recurrence:this.recurrence,intervalHours:this.intervalHours,intervalStartTime:this.intervalStartTime,nominalDemandMinutes:this.nominalDemandSeconds/60,sunriseMinutes:t,sunsetMinutes:s,azimuthResolver:this._azimuthResolver()}),{val:a,lbl:n}=this._centreText(i,e),o=Ua("panels.schedules.dial.sunrise",e,"{time}",eo(i.sun.minutes)),r=Ua("panels.schedules.dial.sunset",e,"{time}",eo(i.moon.minutes));return W`
      <div class="viz-dial">
        <div class="d-wrap">
          <svg
            viewBox="0 0 132 132"
    ...
    `}};t([me({attribute:!1})],go.prototype,"hass",void 0),t([me({attribute:!1})],go.prototype,"rows",void 0),t([me({attribute:!1})],go.prototype,"recurrence",void 0),t([me({attribute:!1})],go.prototype,"intervalHours",void 0),t([me({attribute:!1})],go.prototype,"intervalStartTime",void 0),t([me({attribute:!1})],go.prototype,"nominalDemandSeconds",void 0),go=t([ue("si-run-window-dial")],go);const mo=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"];function vo(){return{name:"",recurrence:"daily",enabled:!0,start_mode:cs,start_time:"06:00",finish_mode:ds,action:"irrigate",zones:"all"}}function fo(e,t){return Ua(`panels.schedules.types.${e}`,t)||e}let _o=class extends ce{constructor(){super(...arguments),this.zones=[],this.heading="",this._hasFooterSlot=!1,this._save=()=>{this.dispatchEvent(new CustomEvent("save",{detail:{value:this.schedule},bubbles:!0,composed:!0}))},this._cancel=()=>{this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}}firstUpdated(){var e;const t=null===(e=this.renderRoot.querySelector("ha-dialog"))||void 0===e?void 0:e.shadowRoot;this._hasFooterSlot=!!(null==t?void 0:t.querySelector('slot[name="footer"]'))}_emitChanged(e){this.dispatchEvent(new CustomEvent("schedule-changed",{detail:{value:Object.assign(Object.assign({},this.schedule),e)},bubbles:!0,composed:!0}))}_renderZonePicker(){const e="all"===this.schedule.zones||!Array.isArray(this.schedule.zones),t=e?[]:this.schedule.zones.map(String);return W`
      <div class="field">
    ...
    `}_renderRecurrenceFields(){const e=this.schedule,t=this.hass.language;switch(e.recurrence){case"weekly":return W`
        ...
        `;default:return W``}}_renderRowStepper(e,t){var s,i,a;const n=this.hass.language;switch(e.mode){case cs:return W`
          <input
            type="time"
            .value="${null!==(s=e.time)&&void 0!==s?s:"06:00"}"
            @change=${s=>t(Object.assign(Object.assign({},e),{time:s.target.value}))}
          />
        `;case hs:case us:return W`
        ...
        `;case ps:return W`
          <input
            type="number"
            step="1"
            .value="${String(null!==(a=e.azimuth)&&void 0!==a?a:Tn)}"
            @input=${s=>{var i;const a=parseInt(s.target.value);t(Object.assign(Object.assign({},e),{azimuth:isNaN(a)?null!==(i=e.azimuth)&&void 0!==i?i:Tn:(a%360+360)%360}))}}
          />
    ...
    `}_unresolvableEnds(e){var t;const s=Vn(null===(t=this.hass)||void 0===t?void 0:t.config,new Date);if(!s)return{};const i=e=>{var t;return e.mode===ps&&null===s(null!==(t=e.azimuth)&&void 0!==t?t:Tn)};return{start:i(e.start),finish:i(e.finish)}}_renderWindowRows(){const e=this.schedule;if(e.recurrence===rs)return W``;const t=Hn(e),s=In(t,this._unresolvableEnds(t)),i=e=>this._emitChanged(function(e){const t=Mn(e.start),s=Mn(e.finish);return{start_mode:t.mode,start_time:t.time,start_offset:t.offset,start_azimuth:t.azimuth,finish_mode:s.mode,finish_time:s.time,finish_offset:s.offset,finish_azimuth:s.azimuth,anchor:e.anchor}}(e)),a=t.start.mode!==ds&&t.finish.mode!==ds;return W`
    ...
    `}_nameMissing(){return!(this.schedule.name||"").trim()}_canSave(){return!this._nameMissing()&&null===Nn(this.schedule)}_renderSection(e,t){return W`
      <div class="sect-card">
        <h4>
    ...
    `}_renderSummary(){const e=Pn(this.schedule,this.hass.language);return W`
      ...
      <ha-dialog open heading="${this.heading}" @closed=${this._cancel}>
        <div class="dialog-content">
          ...
          ${this._renderSection("when",W`
              ...
              ${t.recurrence===rs?W``:this._renderRecurrenceFields()}
              <div class="when-row">
                <div class="when-rows-col">
                  ${t.recurrence===rs?this._renderRecurrenceFields():W``}
    ...
    `}static get styles(){return[nn,r`
      ...
      ${0===this._schedules.length?W`
          ...
          `:this._schedules.map(e=>W`
              <ha-card header="${e.name}">
                <div class="card-content">
                  ...
                  <div class="info-row">
                    ...
                    >
                    <span
                      >${fo(e.recurrence,this.hass.language)}</span
                    >
                  </div>
            ...
            `)}
    `:W``}static get styles(){return[nn,r`
                ...
                <div class="seasonal-table">
                  ...
                  ${this._climate.map(e=>W`
                      <div class="weather-row">
                        ...
                        >
                        <span
                          >${gn(e.estimated_et_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${gn(e.average_precipitation_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${gn(e.average_temperature_c,"temperature",this._metric)}</span
                        >
                      </div>
                    `)}
                </div>
    ...
    `}_renderForecastDay(e,t){const s=(()=>{try{return new Intl.DateTimeFormat(t,{weekday:"short",month:"short",day:"numeric"}).format(new Date(e.date+"T00:00:00"))}catch(t){return e.date}})(),i=e=>{const t=pn(e,"temperature",this._metric);return t?`${Math.round(t.value)}°`:"-"};return W`
      <div class="forecast-day">
        ...
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-rainy"></ha-icon>${gn(e.precipitation,"precipitation",this._metric)}
        </div>
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-windy"></ha-icon>${gn(e.windspeed,"windspeed",this._metric)}
        </div>
      </div>
    `}_renderRecords(){if(!this.hass)return W``;const e=this.hass.language;return this._loading&&0===this._mappings.length?W`<ha-card
      ...
      </ha-card>`:W`${this._mappings.map(t=>this._renderMappingRecords(t,e))}`}_renderMappingRecords(e,t){const s=void 0!==e.id&&this._records.get(e.id)||[],i=`${Ua("panels.mappings.weather-records.title",t)} — ${e.name}`,a=e=>{try{return t=e,Number.isNaN(rn(t).getTime())?"-":function(e){const t=rn(e);return`${on(t.getMonth()+1)}-${on(t.getDate())} ${on(t.getHours())}:${on(t.getMinutes())}`}(e)}catch(e){return"-"}var t};return W`
      <ha-card header="${i}">
        <div class="card-content">
                ...
                <div class="weather-table">
                  ...
                  ${s.map(e=>W`
                      <div class="weather-row">
                        ...
                        <span
                          >${gn(e.temperature,"temperature",this._metric)}</span
                        >
                        <span>${(e=>null!=e?e.toFixed(1)+" %":"-")(e.humidity)}</span>
                        <span
                          >${gn(e.dewpoint,"temperature",this._metric)}</span
                        >
                        <span
                          >${gn(e.wind_speed,"windspeed",this._metric)}</span
                        >
                        <span
                          >${gn(e.pressure,"pressure",this._metric)}</span
                        >
                        <span
                          >${gn(e.precipitation,"precipitation",this._metric)}</span
                        >
    ...
    `}};t([me()],wo.prototype,"narrow",void 0),t([ve()],wo.prototype,"config",void 0),t([ve()],wo.prototype,"_saving",void 0),wo=t([ue("smart-irrigation-view-experimental")],wo);var $o;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.Distributors="distributors",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}($o||($o={}));const xo={[$o.WeatherLocation]:"panels.setup.tabs.weather_location",[$o.Zones]:"panels.setup.tabs.my_zones",[$o.Distributors]:"panels.setup.tabs.distributors",[$o.WhenToWater]:"panels.setup.tabs.when_to_water",[$o.Advanced]:"panels.setup.tabs.advanced",[$o.Experimental]:"panels.setup.tabs.experimental",[$o.Help]:"panels.help.title"};let ko=class extends(Qa(ce)){hassSubscribe(){return this._fetchConfig(),[this.hass.connection.subscribeMessage(()=>this._fetchConfig(),{type:be+"_config_updated"})]}async _fetchConfig(){if(this.hass)try{this.config=await Ns(this.hass)}catch(e){console.error("Failed to fetch setup config:",e)}}get _distributorsEnabled(){var e,t;return null!==(t=null===(e=this.config)||void 0===e?void 0:e.distributors_enabled)&&void 0!==t&&t}get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values($o).includes(null!=t?t:"")?t:$o.WeatherLocation}_selectTab(e){qa(0,an("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return W``;const e=this._distributorsEnabled,t=Object.values($o).filter(t=>t!==$o.Distributors||e);let s=this._activeTab;return s!==$o.Distributors||e||(s=$o.WeatherLocation),W`
    ...
    `}_renderContent(e){if(!this.hass)return W``;switch(e){case $o.WeatherLocation:return W`
          ...
          <smart-irrigation-view-weather-data
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-weather-data>
        `;case $o.Zones:return W`<smart-irrigation-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-zone-settings>`;case $o.Distributors:return W`<smart-irrigation-view-distributor-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-distributor-settings>`;case $o.WhenToWater:return W`
          <smart-irrigation-view-general
            .hass="${this.hass}"
            .narrow="${this.narrow}"
        ...
        `;case $o.Advanced:return W`
          ...
          <smart-irrigation-view-mappings
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-mappings>
        `;case $o.Experimental:return W`<smart-irrigation-view-experimental
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-experimental>`;case $o.Help:return this._renderHelp()}}_renderHelp(){return this.hass?W`
      <ha-card
    ...
    `}};var zo;t([me({attribute:!1})],ko.prototype,"hass",void 0),t([me({type:Boolean})],ko.prototype,"narrow",void 0),t([me({attribute:!1})],ko.prototype,"path",void 0),t([ve()],ko.prototype,"config",void 0),ko=t([ue("smart-irrigation-view-setup")],ko),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done"}(zo||(zo={}));let So=class extends ce{constructor(){super(...arguments),this._step=zo.Welcome,this._saving=!1,this._error="",this._confirmClose=!1,this._siConfig=null,this._useWeather=!1,this._weatherService=Ce,this._apiKey="",this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=Fe,this._humiditySource=Fe,this._precipSource=Fe,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="",this._scheduleTime="06:00",this._scheduleCreated=!1,this._creatingSchedule=!1}async connectedCallback(){super.connectedCallback(),await this._loadInitialData()}async _loadInitialData(){var e;if(this.hass){try{const[t,s,i]=await Promise.all([Us(this.hass),Vs(this.hass),Ns(this.hass)]);this._availableModules=t,this._weatherConfig=s,this._siConfig=i,this._useWeather=s.use_weather_service,this._weatherService=null!==(e=s.weather_service)&&void 0!==e?e:Ce}catch(e){console.error("Wizard: failed to load initial data",e),this._error=Ga(e)}this.requestUpdate()}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}))}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}))}async _next(){this._error="";try{switch(this._saving=!0,this._step){case zo.Welcome:this._step=zo.Weather;break;case zo.Weather:await this._saveWeather(),this._step=zo.Module;break;case zo.Module:await this._saveModule(),this._step=zo.Mapping;break;case zo.Mapping:await this._saveMapping(),this._step=zo.Zone;break;case zo.Zone:await this._saveZone(),this._step=zo.Done;break;case zo.Done:this._close()}}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._saving=!1,this.requestUpdate()}}_back(){this._step>zo.Welcome&&(this._step=this._step-1,this._error="")}get _canSkipCurrentStep(){return this._step===zo.Weather}_skipStep(){this._canSkipCurrentStep&&this._step<zo.Done&&(this._step=this._step+1,this._error="")}async _saveWeather(){await Ys(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null)}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0}catch(e){return}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await js(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>Bs(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.")}async _saveMapping(){const e=this._useWeather?Fe:Ve,t={[Ue]:{[Ye]:this._tempSource},[Ne]:{[Ye]:this._humiditySource},[Pe]:{[Ye]:this._precipSource}},s=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const i of s)t[i]={[Ye]:e};const i=await Zs(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(i,()=>Fs(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.")}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await Ls(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:tn.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0})}async _createDefaultSchedule(){var e,t;if(!this._scheduleCreated&&!this._creatingSchedule){this._error="",this._creatingSchedule=!0;try{const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";await qs(this.hass,{name:Ua("wizard.steps.done.schedule_name",s)||"Daily",recurrence:"daily",enabled:!0,start_mode:cs,start_time:this._scheduleTime||"06:00",finish_mode:ds,action:"irrigate",zones:"all"}),this._scheduleCreated=!0}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._creatingSchedule=!1,this.requestUpdate()}}}render(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return W`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          ...
          ${this._step!==zo.Welcome&&this._step!==zo.Done?W`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>zo.Welcome&&this._step<zo.Done?this._confirmClose=!0:this._close())}_renderStepper(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=[Ua("wizard.stepper.weather",s),Ua("wizard.stepper.module",s),Ua("wizard.stepper.mapping",s),Ua("wizard.stepper.zone",s)];return W`
      ${i.map((e,t)=>{const s=t+1,a=this._step===s,n=this._step>s;return W`
        ...
        `})}
    `}_renderStep(e){switch(this._step){case zo.Welcome:return this._renderWelcome(e);case zo.Weather:return this._renderWeather(e);case zo.Module:return this._renderModule(e);case zo.Mapping:return this._renderMapping(e);case zo.Zone:return this._renderZone(e);case zo.Done:return this._renderDone(e);default:return W``}}_renderFooter(e){return this._step===zo.Done?W``:W`
      <div class="footer-left">
        ${this._step>zo.Welcome?W`<button
              class="wizard-btn secondary"
              @click="${this._back}"
              ?disabled="${this._saving}"
            >
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Ua("common.saving-messages.saving",e):this._step===zo.Welcome||this._step<zo.Zone?Ua("wizard.next",e):Ua("wizard.finish",e)}
      </button>
    ...
    `}_renderMapping(e){const t=[{value:Fe,label:Ua("wizard.steps.mapping.use_weather_service",e)},{value:"sensor",label:Ua("wizard.steps.mapping.use_sensor",e)},{value:"static",label:Ua("wizard.steps.mapping.use_static",e)},{value:Ve,label:Ua("wizard.steps.mapping.use_none",e)}],s=(s,i,a)=>W`
      <si-field
    ...
    `}};t([me({attribute:!1})],So.prototype,"hass",void 0),t([ve()],So.prototype,"_step",void 0),t([ve()],So.prototype,"_saving",void 0),t([ve()],So.prototype,"_error",void 0),t([ve()],So.prototype,"_confirmClose",void 0),t([ve()],So.prototype,"_siConfig",void 0),t([ve()],So.prototype,"_useWeather",void 0),t([ve()],So.prototype,"_weatherService",void 0),t([ve()],So.prototype,"_apiKey",void 0),t([ve()],So.prototype,"_weatherConfig",void 0),t([ve()],So.prototype,"_availableModules",void 0),t([ve()],So.prototype,"_selectedModuleIndex",void 0),t([ve()],So.prototype,"_moduleConfig",void 0),t([ve()],So.prototype,"_mappingName",void 0),t([ve()],So.prototype,"_tempSource",void 0),t([ve()],So.prototype,"_humiditySource",void 0),t([ve()],So.prototype,"_precipSource",void 0),t([ve()],So.prototype,"_zoneName",void 0),t([ve()],So.prototype,"_zoneSize",void 0),t([ve()],So.prototype,"_zoneThroughput",void 0),t([ve()],So.prototype,"_zoneEntity",void 0),t([ve()],So.prototype,"_scheduleTime",void 0),t([ve()],So.prototype,"_scheduleCreated",void 0),t([ve()],So.prototype,"_creatingSchedule",void 0),So=t([ue("si-setup-wizard")],So);const Co=nn;var Ao;!function(e){e.Zones="zones",e.History="history",e.Setup="setup"}(Ao||(Ao={})),e.SmartIrrigationPanel=class extends ce{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}async firstUpdated(){const e=sn().page;Object.values(Ao).includes(e)||qa(0,an(Ao.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())}),ei().then(()=>{this._scheduleUpdate()}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}),this.hass&&Ns(this.hass).then(e=>{this._config=e,this._scheduleUpdate()}).catch(e=>{console.error("Failed to fetch config for version display:",e)})}_ensureLanguage(){this.hass&&!La(this.hass.language)&&function(e){const t=Ra(e);return La(e)?Promise.resolve():(Pa[t]||(Pa[t]=fetch(`/smart_irrigation_static/languages/${t}.json?v=${_e}`).then(e=>e.ok?e.json():Promise.reject(e.status)).then(e=>{Na[t]=e}).catch(()=>{Na[t]=Na.en})),Pa[t])}(this.hass.language).then(()=>this.requestUpdate())}render(){var e,t;if(this.hass&&!La(this.hass.language))return this._ensureLanguage(),W``;const s=sn(),i=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return W`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
    ...
    `}getView(e){switch(e.page){case"zones":default:return W`
        ...
        `;case"setup":return W`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0}}"
          ></smart-irrigation-view-setup>
        `}}navigateToPage(e){if(e!==sn().page){const t=an(e);qa(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==sn().page){const e=an(t);qa(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[Co,r`
        :host {
          color: var(--primary-text-color);
    ...
    `}};t([me({attribute:!1})],Eo.prototype,"hass",void 0),t([ve()],Eo.prototype,"_params",void 0),Eo=t([ue("error-dialog")],Eo);var To=Object.freeze({__proto__:null,get ErrorDialog(){return Eo}})}({});

    ...
    `}_renderRunZoneControl(e){if(!this.hass||"none"===this.actionsMode||!this._canActuate(e)||void 0===e.id)return Z``;const t=this.hass.language,s=String(e.id),i=this._activeRun(e);if(i){const s=!0===i.queued,a=!s&&!0===i.paused,n=s||a?null:this._runSecondsLeft(i);return Z`
        ...
        >
          <span class="run-zone-countdown">
            ...
            ${s?Ua("panels.zones.stop_zone.queued",t):a?Ua("panels.zones.stop_zone.paused",t):null===n?Ua("panels.zones.stop_zone.watering",t):this._formatCountdown(n)}
          </span>
          <button
...
/**
              ...
              <div class="card-content zone-settings">
                ...
                <ha-settings-row>
                  ...
                  <select
                    ...
                    @change="${s=>{const i=s.target.value,a={[At]:i};"custom"!==i&&void 0!==Ut[i]&&(a.kc=Ut[i]),this.handleEditZone(t,Object.assign(Object.assign({},e),a))}}"
                  >
                    <option
                      value="custom"
                ...
                <ha-settings-row>
                  ...
                  <input
                    ...
                    @input="${s=>{const i=Math.round(100*s.target.valueAsNumber)/100;isNaN(i)||this.handleEditZone(t,Object.assign(Object.assign({},e),{[St]:i,[At]:"custom"}))}}"
                  />
                </ha-settings-row>
    ...
    `}};t([me()],$n.prototype,"config",void 0),t([me({attribute:!1})],$n.prototype,"path",void 0),t([me({type:Array})],$n.prototype,"zones",void 0),t([me({type:Array})],$n.prototype,"modules",void 0),t([me({type:Array})],$n.prototype,"mappings",void 0),t([me({type:Array})],$n.prototype,"distributors",void 0),t([me({type:Boolean})],$n.prototype,"isLoading",void 0),t([ve()],$n.prototype,"_expanded",void 0),t([me({type:Boolean})],$n.prototype,"isSaving",void 0),t([me({type:Boolean})],$n.prototype,"_showAddZone",void 0),t([ve()],$n.prototype,"_pendingConfirm",void 0),t([ve()],$n.prototype,"_saveStatus",void 0),t([me()],$n.prototype,"_confirmDeleteZoneId",void 0),t([me()],$n.prototype,"_newZoneName",void 0),t([me()],$n.prototype,"_newZoneSize",void 0),t([me()],$n.prototype,"_newZoneThroughput",void 0),t([me()],$n.prototype,"_newZoneEntity",void 0),$n=t([ue("smart-irrigation-view-zone-settings")],$n);let xn=class extends ce{_emit(e){this.dispatchEvent(new CustomEvent("distributor-changed",{detail:{value:Object.assign(Object.assign({},this.distributor),e)},bubbles:!0,composed:!0}))}_onNumber(e,t){const s=t.target.valueAsNumber;isNaN(s)||this._emit({[e]:Math.max(0,Math.round(s))})}render(){var e,t,s,i;if(!this.hass||!this.distributor)return Z``;const a=this.hass.language,n=this.distributor,o=n.watering_mode===Os;return Z`
      ...
      <ha-settings-row>
        ...
        <input
          ...
          @input="${e=>this._emit({[As]:e.target.value||null})}"
        />
      </ha-settings-row>
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach(e=>{clearTimeout(e)}),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};t([me()],Sn.prototype,"config",void 0),t([me({type:Array})],Sn.prototype,"zones",void 0),t([me({type:Array})],Sn.prototype,"mappings",void 0),t([me({type:Boolean})],Sn.prototype,"isLoading",void 0),t([me({type:Boolean})],Sn.prototype,"isSaving",void 0),t([fe("#mappingNameInput")],Sn.prototype,"mappingNameInput",void 0),Sn=t([ue("smart-irrigation-view-mappings")],Sn);const An="06:00",Cn=90;function En(e){switch(e){case cs:return{mode:e,time:An};case hs:case us:return{mode:e,offset:0};case ps:return{mode:e,azimuth:Cn};default:return{mode:ds}}}function Tn(e,t,s,i){const a=function(e){return e===ds||e===cs||e===hs||e===us||e===ps}(e)?e:ds,n=En(a);return a===cs&&void 0!==t&&(n.time=t),a!==hs&&a!==us||void 0===s||(n.offset=s),a===ps&&void 0!==i&&(n.azimuth=i),n}function On(e){var t,s,i;return{mode:e.mode,time:e.mode===cs?null!==(t=e.time)&&void 0!==t?t:An:void 0,offset:e.mode===hs||e.mode===us?null!==(s=e.offset)&&void 0!==s?s:0:void 0,azimuth:e.mode===ps?null!==(i=e.azimuth)&&void 0!==i?i:Cn:void 0}}function Dn(e){return{start:Tn(e.start_mode,e.start_time,e.start_offset,e.start_azimuth),finish:Tn(e.finish_mode,e.finish_time,e.finish_offset,e.finish_azimuth),anchor:e.anchor===ms?ms:vs}}function Mn(e,t){const s=e.start.mode!==ds,i=e.finish.mode!==ds;if(!s&&!i)return{start:"error",finish:"error",valid:!1};return function(e,t,s){if(!(null==s?void 0:s.start)&&!(null==s?void 0:s.finish))return t;const i=e.start.mode!==ds,a=e.finish.mode!==ds,n=i&&a?e.anchor:i?ms:vs,o=e=>e===n?"unreachable_no_run":"unreachable_ignored";return Object.assign(Object.assign({},t),{start:s.start?o(ms):t.start,finish:s.finish?o(vs):t.finish})}(e,s?i?e.anchor===vs?{start:"demand_floored",finish:"exact_deferred",valid:!0}:{start:"exact",finish:"demand_capped_deferred",valid:!0}:{start:"exact",finish:"demand_open",valid:!0}:{start:"demand_open",finish:"exact",valid:!0},t)}function Hn(e){if(e.recurrence===ns&&0===(e.days_of_week||[]).length)return"no_days";if(e.recurrence!==rs){const t=Dn(e);if(t.start.mode===ds&&t.finish.mode===ds)return"no_window"}return Array.isArray(e.zones)&&0===e.zones.length?"no_zones":null}function In(e,t){const s=Hn(e);if(s)return{text:Ua(`panels.schedules.summary.${"no_window"===s?"invalid":s}`,t),isError:!0};const i=function(e,t){if("all"===e||!Array.isArray(e))return Ua("panels.schedules.summary.zones_all",t);return Ua("panels.schedules.summary.zones_some",t,"count",e.length)}(e.zones,t),a=function(e,t){switch(e.recurrence){case ns:{const s=(e.days_of_week||[]).map(e=>Ua(`panels.schedules.days.${e}`,t)).join(", ");return Ua("panels.schedules.summary.recurrence_weekly",t,"days",s)}case os:return Ua("panels.schedules.summary.recurrence_monthly",t,"day",e.day_of_month||1);case rs:{const s=e.interval_hours||24;return e.start_time?Ua("panels.schedules.summary.recurrence_interval_at",t,"hours",s,"time",e.start_time):Ua("panels.schedules.summary.recurrence_interval",t,"hours",s)}default:return Ua("panels.schedules.summary.recurrence_daily",t)}}(e,t);if(e.recurrence===rs){return{text:`${a}, ${Ua("panels.schedules.summary.watering",t,"zones",i)}.`,isError:!1}}const n=Dn(e),o=n.start.mode!==ds,r=n.finish.mode!==ds,l=Ua("panels.schedules.summary.watering",t,"zones",i);let d;return d=o?r?n.anchor===vs?Ua("panels.schedules.summary.anchor_finish",t,"finish",Nn(n.finish,t),"start",Nn(n.start,t)):Ua("panels.schedules.summary.anchor_start",t,"start",Nn(n.start,t),"finish",Nn(n.finish,t)):Ua("panels.schedules.summary.start_only",t,"when",Nn(n.start,t)):Ua("panels.schedules.summary.finish_only",t,"when",Nn(n.finish,t)),{text:`${a}, ${l}, ${d}.`,isError:!1}}function Nn(e,t){var s,i,a;switch(e.mode){case cs:return null!==(s=e.time)&&void 0!==s?s:"";case hs:case us:{const s=Ua(`panels.schedules.summary.${e.mode}`,t),a=null!==(i=e.offset)&&void 0!==i?i:0;if(0===a)return s;return Ua(a<0?"panels.schedules.summary.offset_before":"panels.schedules.summary.offset_after",t,"minutes",Math.abs(a),"event",s)}case ps:return Ua("panels.schedules.summary.at_azimuth",t,"degrees",null!==(a=e.azimuth)&&void 0!==a?a:Cn);default:return""}}function Pn(e){return(e%360+360)%360}const Rn=Math.PI/180;function Ln(e,t,s){const i=e*Rn,a=23.45*Math.sin(360*(284+function(e){const t=Date.UTC(e.getUTCFullYear(),0,1),s=Date.UTC(e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate());return Math.floor((s-t)/864e5)+1}(s))/365*Rn)*Rn,n=15*(s.getUTCHours()+s.getUTCMinutes()/60+s.getUTCSeconds()/3600+t/15-12)*Rn;return Pn(Math.atan2(Math.sin(n),Math.cos(n)*Math.sin(i)-Math.tan(a)*Math.cos(i))/Rn+180)}function Bn(e,t,s){return Math.abs(e-t)>180?e>t?s>=e||s<=t:s<=e||s>=t:Math.min(e,t)<=s&&s<=Math.max(e,t)}const Un=9e5;function jn(e,t,s,i,a){let n=i,o=a;for(;o-n>6e4;){const i=n+(o-n)/2,a=Ln(e,t,new Date(i));Bn(Ln(e,t,new Date(n)),a,s)?o=i:n=i}return new Date(n)}const Fn={hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"};function Wn(e,t){if(!e)return Zn(t);let s;try{s=new Intl.DateTimeFormat("en-US",Object.assign(Object.assign({},Fn),{timeZone:e})).formatToParts(t)}catch(e){return Zn(t)}const i=e=>{var t,i;return parseInt(null!==(i=null===(t=s.find(t=>t.type===e))||void 0===t?void 0:t.value)&&void 0!==i?i:"0",10)},a=i("hour")%24;return new Date(Date.UTC(i("year"),i("month")-1,i("day"),a,i("minute"),i("second")))}function Zn(e){return new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours(),e.getMinutes(),e.getSeconds()))}function qn(e){return 60*e.getUTCHours()+e.getUTCMinutes()}function Gn(e,t){if("number"!=typeof(null==e?void 0:e.latitude)||"number"!=typeof(null==e?void 0:e.longitude))return;const{latitude:s,longitude:i,time_zone:a}=e;return e=>function(e,t,s,i,a){const n=Wn(i,a),o=new Date(Date.UTC(n.getUTCFullYear(),n.getUTCMonth(),n.getUTCDate())),r=function(e,t,s,i,a=1){const n=i.getTime(),o=n+864e5*a;let r=n,l=Ln(e,t,i);for(;r<o;){r+=Un;const i=Ln(e,t,new Date(r));if(Bn(l,i,s))return jn(e,t,s,r-Un,r);l=i}return null}(e,t,Pn(s),function(e,t){let s=e.getTime();for(let i=0;i<2;i++){const i=Wn(t,new Date(s)).getTime()-s;s=e.getTime()-i}return new Date(s)}(o,i));return null===r?null:qn(Wn(i,r))}(s,i,e,a,t)}const Kn=1440,Vn=44,Yn=260;function Xn(e){return(e%Kn+Kn)%Kn}function Jn(e){const t=Xn(Math.round(e)),s=Math.floor(t/60),i=t%60;return`${String(s).padStart(2,"0")}:${String(i).padStart(2,"0")}`}function Qn(e){const t=Math.round(e),s=Math.floor(t/60),i=t%60;return s?`${s}h ${i}m`:`${i}m`}function eo(e,t){const s=t/Kn*2*Math.PI+Math.PI/2;return[66+e*Math.cos(s),66+e*Math.sin(s)]}function to(e,t,s){const i=s-t>=Kn?t+Kn-.5:s,[a,n]=eo(e,t),[o,r]=eo(e,i),l=i-t>720?1:0;return`M ${a.toFixed(2)} ${n.toFixed(2)} A ${e} ${e} 0 ${l} 1 ${o.toFixed(2)} ${r.toFixed(2)}`}function so(e,t,s,i,a){const n=2*Math.PI*e/Kn,o=[[0,s]];for(let e=0;e<=10;e++){const t=Math.PI/2+e/10*(Math.PI/2);o.push([i*Math.cos(t),s-i+i*Math.sin(t)])}for(let e=0;e<=10;e++){const t=Math.PI+e/10*(Math.PI/2);o.push([i*Math.cos(t),i*Math.sin(t)-3.2])}return o.push([0,-s]),o.map(([s,i],o)=>{const[r,l]=eo(e+i,(e=>t-a*e/n)(s));return`${o?"L":"M"} ${r.toFixed(2)} ${l.toFixed(2)}`}).join(" ")+" Z"}function io(e,t,s,i,a){const n=(t-e)/48,o=[];for(let r=0;r<48;r++){const l=e+r*n,d=l+n/2;let c=1;s>0&&(c=Math.min(c,(d-e)/s)),i>0&&(c=Math.min(c,(t-d)/i)),c=Math.max(0,Math.min(1,c)),o.push({d:to(a,l,l+1.25*n),opacity:c})}return o}function ao(e){const[t,s]=e.split(":").map(e=>parseInt(e,10));return 60*(t||0)+(s||0)}function no(e,t,s,i){var a,n,o,r;switch(e.mode){case cs:return Xn(ao(null!==(a=e.time)&&void 0!==a?a:"06:00"));case hs:return Xn(t+(null!==(n=e.offset)&&void 0!==n?n:0));case us:return Xn(s+(null!==(o=e.offset)&&void 0!==o?o:0));case ps:{if(!i)return null;const t=i(null!==(r=e.azimuth)&&void 0!==r?r:Cn);return null===t?null:Xn(t)}default:return null}}function oo(e,t){return{wraps:!1,arc:to(Vn,e,t),capStart:so(Vn,e,5,1.8,-1),capEnd:so(Vn,t,5,1.8,1)}}function ro(e){const{rows:t,recurrence:s,intervalHours:i,intervalStartTime:a,nominalDemandMinutes:n,sunriseMinutes:o,sunsetMinutes:r,azimuthResolver:l}=e,d=to(Vn,0,Kn),c=[0,360,720,1080].map(e=>{const[t,s]=eo(38,e),[i,a]=eo(50,e);return{x1:t,y1:s,x2:i,y2:a}}),[h,u]=eo(57,o),[p,g]=eo(57,r);if(s===rs){const{runs:e,overlaps:t,wrapAt:s}=function(e,t,s){const i=60*Math.max(1,Number(t)||24),a=s?ao(s):0,n=[];for(let t=a;t<a+Kn&&n.length<24;t+=i)n.push([t,t+e]);const o=[];for(let e=0;e+1<n.length;e++)n[e][1]>n[e+1][0]&&o.push([n[e+1][0],Math.min(n[e][1],n[e+1][1])]);return{runs:n,overlaps:o,wrapAt:a+Kn}}(n,i,a),l=e.map(([e,t])=>{if(t<=s)return oo(e,t);const i=s-8,a=i-e,n=Math.min(a,120);return{wraps:!0,capStart:so(Vn,e,5,1.8,-1),fade:io(e,i,0,n,Vn)}});return{trackPath:d,windowArc:null,dottedPath:null,runs:l,overlaps:t.map(([e,t])=>({d:to(Vn,e,t),fromMinutes:e,toMinutes:t})),ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:e.map(([e,t])=>{const[s,i]=eo(57,(e+t)/2);return{x:s,y:i,fromMinutes:e,toMinutes:t}}),centre:{kind:"interval",perDay:e.length,intervalHours:Math.max(1,Number(i)||24)}}}const m=no(t.start,o,r,l);let v=no(t.finish,o,r,l);null!==m&&null!==v&&v<=m&&(v+=Kn);if(null===m&&null===v)return{trackPath:d,windowArc:null,dottedPath:null,runs:[],overlaps:[],ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:[],centre:{kind:"invalid"}};const f=null!==m&&null!==v?v-m:null;let _,b,y=0;if(null!==m&&null!==v){const e=f;b=Math.min(n,e),y=Math.max(0,n-e),_=t.anchor===vs?v-b:m}else null!==m?(_=m,b=n):(b=n,_=v-b);const w=_+b;let $=null!=m?m:_,x=null!=v?v:w,k=0,z=0;null===m&&($=_-Yn,k=Yn),null===v&&(x=w+Yn,z=Yn);const S=null!==f&&f<60,A=null===m||null===v?{kind:"faded",segments:io($,x,k,z,Vn)}:{kind:"solid",d:to(Vn,$,S?$+60:x)},C=y>1?to(Vn,_-y,_):null,[E,T]=eo(57,(_+w)/2),O=null===f?{kind:"run",minutes:b}:{kind:"window",minutes:f};return{trackPath:d,windowArc:A,dottedPath:C,runs:[oo(_,w)],overlaps:[],ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:[{x:E,y:T,fromMinutes:_,toMinutes:w}],centre:O}}const lo=q`<circle cx="12" cy="12" r="4.4" />
  ${Array.from({length:8},(e,t)=>{const s=t*Math.PI/4,i=(12+6.6*Math.cos(s)).toFixed(1),a=(12+6.6*Math.sin(s)).toFixed(1),n=(12+9.2*Math.cos(s)).toFixed(1),o=(12+9.2*Math.sin(s)).toFixed(1);return q`<line x1="${i}" y1="${a}" x2="${n}" y2="${o}" />`})}`,co=q`<path d="M13.5,2.5A9.5,9.5 0 1,0 21.5,14 7.6,7.6 0 0,1 13.5,2.5Z" />`,ho=q`<path d="M12,2.6C12,2.6 18.6,9.4 18.6,13.7A6.6,6.6 0 0,1 5.4,13.7C5.4,9.4 12,2.6 12,2.6Z" />`;let uo=class extends ce{constructor(){super(...arguments),this.recurrence="daily",this.nominalDemandSeconds=0}_sunTimes(){var e,t,s,i,a,n;const o=null===(t=null===(e=this.hass)||void 0===e?void 0:e.states)||void 0===t?void 0:t["sun.sun"],r=null===(s=null==o?void 0:o.attributes)||void 0===s?void 0:s.next_rising,l=null===(i=null==o?void 0:o.attributes)||void 0===i?void 0:i.next_setting,d=null===(n=null===(a=this.hass)||void 0===a?void 0:a.config)||void 0===n?void 0:n.time_zone,c=(e,t)=>{if(!e)return t;const s=new Date(e);return isNaN(s.getTime())?t:qn(Wn(d,s))};return{sunrise:c(r,360),sunset:c(l,1200)}}_azimuthResolver(){var e;return Gn(null===(e=this.hass)||void 0===e?void 0:e.config,new Date)}_renderRun(e,t){return e.wraps?q`
    ...
    `:q`
      ...
      `}_t(e,t,s){return Ua(`panels.schedules.dial.${e}`,t,"{from}",Jn(s.fromMinutes),"{to}",Jn(s.toMinutes))}_note(e,t){var s;const i=this.nominalDemandSeconds/60;if(!i)return Z``;if("interval"===e.centre.kind){const s=e.overlaps.length>0;return Z`
        <div class="d-note ${s?"warn":""}">
          ${s?Ua("panels.schedules.dial.collision_note",t):Ua("panels.schedules.dial.runs_of",t,"{count}",e.runs.length,"{duration}",Qn(i))}
        </div>
      `}if("window"!==e.centre.kind)return Z``;const a=i-(null!==(s=e.centre.minutes)&&void 0!==s?s:0);return a<=1?Z``:Z`
      <div class="d-note warn">
        ${Ua("panels.schedules.dial.shortfall",t,"{duration}",Qn(a))}
      </div>
    `}_centreText(e,t){var s,i;const a=e.centre;switch(a.kind){case"invalid":return{val:"—",lbl:""};case"interval":return{val:Ua("panels.schedules.dial.every_hours",t,"{hours}",a.intervalHours),lbl:Ua("panels.schedules.dial.per_day",t,"{count}",a.perDay)};case"run":return{val:Qn(null!==(s=a.minutes)&&void 0!==s?s:0),lbl:Ua("panels.schedules.dial.run_label",t)};default:return{val:Qn(null!==(i=a.minutes)&&void 0!==i?i:0),lbl:Ua("panels.schedules.dial.window_label",t)}}}render(){if(!this.hass||!this.rows)return Z``;const e=this.hass.language,{sunrise:t,sunset:s}=this._sunTimes(),i=ro({rows:this.rows,recurrence:this.recurrence,intervalHours:this.intervalHours,intervalStartTime:this.intervalStartTime,nominalDemandMinutes:this.nominalDemandSeconds/60,sunriseMinutes:t,sunsetMinutes:s,azimuthResolver:this._azimuthResolver()}),{val:a,lbl:n}=this._centreText(i,e),o=Ua("panels.schedules.dial.sunrise",e,"{time}",Jn(i.sun.minutes)),r=Ua("panels.schedules.dial.sunset",e,"{time}",Jn(i.moon.minutes));return Z`
      <div class="viz-dial">
        <div class="d-wrap">
          <svg
            viewBox="0 0 132 132"
    ...
    `}_renderRecurrenceFields(){const e=this.schedule,t=this.hass.language;switch(e.recurrence){case"weekly":return Z`
        ...
        `;case ps:return Z`
          <input
            type="number"
            step="1"
            .value="${String(null!==(a=e.azimuth)&&void 0!==a?a:Cn)}"
            @input=${s=>{var i;const a=parseInt(s.target.value);t(Object.assign(Object.assign({},e),{azimuth:isNaN(a)?null!==(i=e.azimuth)&&void 0!==i?i:Cn:(a%360+360)%360}))}}
          />
    ...
    `}_nameMissing(){return!(this.schedule.name||"").trim()}_canSave(){return!this._nameMissing()&&null===Hn(this.schedule)}_renderSection(e,t){return Z`
      <div class="sect-card">
        <h4>
    ...
    `}_renderSummary(){const e=In(this.schedule,this.hass.language);return Z`
        ...
        <div class="dialog-content">
          ...
          <div class="field">
            ...
            ${this._nameMissing()?Z`<span class="field-help err"
                  >${Ua("panels.schedules.help.name_required",s)}</span
                >`:""}
          </div>
    ...
    ${this._renderButtons(e)}`;return"content"===this._actionSlot?Z`
      ...
      `:Z` <div slot="footer" class="dialog-footer">${t}</div> `}static get styles(){return[nn,r`
              ...
              <ha-card header="${e.name}">
                <div class="card-content">
                  ...
                  <div class="info-row">
                    ...
                    >
                    <span
                      >${mo(e.recurrence,this.hass.language)}</span
                    >
                  </div>
    ...
    `}};t([me()],bo.prototype,"narrow",void 0),t([ve()],bo.prototype,"config",void 0),t([ve()],bo.prototype,"_saving",void 0),bo=t([ue("smart-irrigation-view-experimental")],bo);var yo;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.Distributors="distributors",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}(yo||(yo={}));const wo={[yo.WeatherLocation]:"panels.setup.tabs.weather_location",[yo.Zones]:"panels.setup.tabs.my_zones",[yo.Distributors]:"panels.setup.tabs.distributors",[yo.WhenToWater]:"panels.setup.tabs.when_to_water",[yo.Advanced]:"panels.setup.tabs.advanced",[yo.Experimental]:"panels.setup.tabs.experimental",[yo.Help]:"panels.help.title"};let $o=class extends(Qa(ce)){hassSubscribe(){return this._fetchConfig(),[this.hass.connection.subscribeMessage(()=>this._fetchConfig(),{type:be+"_config_updated"})]}async _fetchConfig(){if(this.hass)try{this.config=await Ns(this.hass)}catch(e){console.error("Failed to fetch setup config:",e)}}get _distributorsEnabled(){var e,t;return null!==(t=null===(e=this.config)||void 0===e?void 0:e.distributors_enabled)&&void 0!==t&&t}get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(yo).includes(null!=t?t:"")?t:yo.WeatherLocation}_selectTab(e){qa(0,an("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return Z``;const e=this._distributorsEnabled,t=Object.values(yo).filter(t=>t!==yo.Distributors||e);let s=this._activeTab;return s!==yo.Distributors||e||(s=yo.WeatherLocation),Z`
    ...
    `}_renderContent(e){if(!this.hass)return Z``;switch(e){case yo.WeatherLocation:return Z`
          ...
          <smart-irrigation-view-weather-data
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-weather-data>
        `;case yo.Zones:return Z`<smart-irrigation-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-zone-settings>`;case yo.Distributors:return Z`<smart-irrigation-view-distributor-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-distributor-settings>`;case yo.WhenToWater:return Z`
          <smart-irrigation-view-general
            .hass="${this.hass}"
            .narrow="${this.narrow}"
        ...
        `;case yo.Advanced:return Z`
          ...
          <smart-irrigation-view-mappings
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-mappings>
        `;case yo.Experimental:return Z`<smart-irrigation-view-experimental
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-experimental>`;case yo.Help:return this._renderHelp()}}_renderHelp(){return this.hass?Z`
      <ha-card
    ...
    `}};var xo;t([me({attribute:!1})],$o.prototype,"hass",void 0),t([me({type:Boolean})],$o.prototype,"narrow",void 0),t([me({attribute:!1})],$o.prototype,"path",void 0),t([ve()],$o.prototype,"config",void 0),$o=t([ue("smart-irrigation-view-setup")],$o),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done"}(xo||(xo={}));let ko=class extends ce{constructor(){super(...arguments),this._step=xo.Welcome,this._saving=!1,this._error="",this._confirmClose=!1,this._siConfig=null,this._useWeather=!1,this._weatherService=Ae,this._apiKey="",this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=Fe,this._humiditySource=Fe,this._precipSource=Fe,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="",this._scheduleTime="06:00",this._scheduleCreated=!1,this._creatingSchedule=!1}async connectedCallback(){super.connectedCallback(),await this._loadInitialData()}async _loadInitialData(){var e;if(this.hass){try{const[t,s,i]=await Promise.all([Us(this.hass),Vs(this.hass),Ns(this.hass)]);this._availableModules=t,this._weatherConfig=s,this._siConfig=i,this._useWeather=s.use_weather_service,this._weatherService=null!==(e=s.weather_service)&&void 0!==e?e:Ae}catch(e){console.error("Wizard: failed to load initial data",e),this._error=Ga(e)}this.requestUpdate()}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}))}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}))}async _next(){this._error="";try{switch(this._saving=!0,this._step){case xo.Welcome:this._step=xo.Weather;break;case xo.Weather:await this._saveWeather(),this._step=xo.Module;break;case xo.Module:await this._saveModule(),this._step=xo.Mapping;break;case xo.Mapping:await this._saveMapping(),this._step=xo.Zone;break;case xo.Zone:await this._saveZone(),this._step=xo.Done;break;case xo.Done:this._close()}}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._saving=!1,this.requestUpdate()}}_back(){this._step>xo.Welcome&&(this._step=this._step-1,this._error="")}get _canSkipCurrentStep(){return this._step===xo.Weather}_skipStep(){this._canSkipCurrentStep&&this._step<xo.Done&&(this._step=this._step+1,this._error="")}async _saveWeather(){await Ys(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null)}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0}catch(e){return}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await js(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>Bs(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.")}async _saveMapping(){const e=this._useWeather?Fe:Ve,t={[Ue]:{[Ye]:this._tempSource},[Ne]:{[Ye]:this._humiditySource},[Pe]:{[Ye]:this._precipSource}},s=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const i of s)t[i]={[Ye]:e};const i=await Ws(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(i,()=>Fs(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.")}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await Ls(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:tn.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0})}async _createDefaultSchedule(){var e,t;if(!this._scheduleCreated&&!this._creatingSchedule){this._error="",this._creatingSchedule=!0;try{const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";await qs(this.hass,{name:Ua("wizard.steps.done.schedule_name",s)||"Daily",recurrence:"daily",enabled:!0,start_mode:cs,start_time:this._scheduleTime||"06:00",finish_mode:ds,action:"irrigate",zones:"all"}),this._scheduleCreated=!0}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._creatingSchedule=!1,this.requestUpdate()}}}render(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return Z`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          ...
          ${this._step!==xo.Welcome&&this._step!==xo.Done?Z`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>xo.Welcome&&this._step<xo.Done?this._confirmClose=!0:this._close())}_renderStepper(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=[Ua("wizard.stepper.weather",s),Ua("wizard.stepper.module",s),Ua("wizard.stepper.mapping",s),Ua("wizard.stepper.zone",s)];return Z`
      ${i.map((e,t)=>{const s=t+1,a=this._step===s,n=this._step>s;return Z`
        ...
        `})}
    `}_renderStep(e){switch(this._step){case xo.Welcome:return this._renderWelcome(e);case xo.Weather:return this._renderWeather(e);case xo.Module:return this._renderModule(e);case xo.Mapping:return this._renderMapping(e);case xo.Zone:return this._renderZone(e);case xo.Done:return this._renderDone(e);default:return Z``}}_renderFooter(e){return this._step===xo.Done?Z``:Z`
      <div class="footer-left">
        ${this._step>xo.Welcome?Z`<button
              class="wizard-btn secondary"
              @click="${this._back}"
              ?disabled="${this._saving}"
            >
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Ua("common.saving-messages.saving",e):this._step===xo.Welcome||this._step<xo.Zone?Ua("wizard.next",e):Ua("wizard.finish",e)}
      </button>
    ...
    `}};t([me({attribute:!1})],ko.prototype,"hass",void 0),t([ve()],ko.prototype,"_step",void 0),t([ve()],ko.prototype,"_saving",void 0),t([ve()],ko.prototype,"_error",void 0),t([ve()],ko.prototype,"_confirmClose",void 0),t([ve()],ko.prototype,"_siConfig",void 0),t([ve()],ko.prototype,"_useWeather",void 0),t([ve()],ko.prototype,"_weatherService",void 0),t([ve()],ko.prototype,"_apiKey",void 0),t([ve()],ko.prototype,"_weatherConfig",void 0),t([ve()],ko.prototype,"_availableModules",void 0),t([ve()],ko.prototype,"_selectedModuleIndex",void 0),t([ve()],ko.prototype,"_moduleConfig",void 0),t([ve()],ko.prototype,"_mappingName",void 0),t([ve()],ko.prototype,"_tempSource",void 0),t([ve()],ko.prototype,"_humiditySource",void 0),t([ve()],ko.prototype,"_precipSource",void 0),t([ve()],ko.prototype,"_zoneName",void 0),t([ve()],ko.prototype,"_zoneSize",void 0),t([ve()],ko.prototype,"_zoneThroughput",void 0),t([ve()],ko.prototype,"_zoneEntity",void 0),t([ve()],ko.prototype,"_scheduleTime",void 0),t([ve()],ko.prototype,"_scheduleCreated",void 0),t([ve()],ko.prototype,"_creatingSchedule",void 0),ko=t([ue("si-setup-wizard")],ko);const zo=nn;var So;!function(e){e.Zones="zones",e.Setup="setup"}(So||(So={})),e.SmartIrrigationPanel=class extends ce{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}async firstUpdated(){const e=sn().page;Object.values(So).includes(e)||qa(0,an(So.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())}),ei().then(()=>{this._scheduleUpdate()}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}),this.hass&&Ns(this.hass).then(e=>{this._config=e,this._scheduleUpdate()}).catch(e=>{console.error("Failed to fetch config for version display:",e)})}_ensureLanguage(){this.hass&&!La(this.hass.language)&&function(e){const t=Ra(e);return La(e)?Promise.resolve():(Pa[t]||(Pa[t]=fetch(`/smart_irrigation_static/languages/${t}.json?v=${_e}`).then(e=>e.ok?e.json():Promise.reject(e.status)).then(e=>{Na[t]=e}).catch(()=>{Na[t]=Na.en})),Pa[t])}(this.hass.language).then(()=>this.requestUpdate())}render(){var e,t;if(this.hass&&!La(this.hass.language))return this._ensureLanguage(),Z``;const s=sn(),i=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return Z`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
    ...
    `}getView(e){switch(e.page){case"zones":default:return Z`
        ...
        `;case"setup":return Z`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0}}"
          ></smart-irrigation-view-setup>
        `}}navigateToPage(e){if(e!==sn().page){const t=an(e);qa(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==sn().page){const e=an(t);qa(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[zo,r`
        :host {
          color: var(--primary-text-color);
    ...
    `}};t([me({attribute:!1})],Ao.prototype,"hass",void 0),t([ve()],Ao.prototype,"_params",void 0),Ao=t([ue("error-dialog")],Ao);var Co=Object.freeze({__proto__:null,get ErrorDialog(){return Ao}})}({});

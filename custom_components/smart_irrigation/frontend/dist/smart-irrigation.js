...
/**
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return W`<option value="${e}" ?selected="${e===t}">
        ...
        </option>`,e}return W``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return W``;const i=function(e){switch(e){case He:case Be:return[{unit:"°C",system:Oe},{unit:"°F",system:Te}];case Le:case Me:return[{unit:st,system:Oe},{unit:at,system:Te}];case Ne:return[{unit:lt,system:Oe},{unit:ct,system:Te}];case De:return[{unit:"%",system:[Oe,Te]}];case Ie:return[{unit:"millibar",system:Oe},{unit:"hPa",system:Oe},{unit:"psi",system:Te},{unit:nt,system:Te}];case Re:return[{unit:"km/h",system:Oe},{unit:rt,system:Oe},{unit:ot,system:Te}];case Pe:return[{unit:"W/m2",system:Oe},{unit:"MJ/day/m2",system:Oe},{unit:"W/sq ft",system:Te},{unit:"MJ/day/sq ft",system:Te}];default:return[]}}(e);let s=t[Xe];const a=this.config.units;if(!t[Xe])for(const e of i)if("string"==typeof e.system){if(a===e.system){s=e.unit;break}}else{for(const t of e.system)if(a===t.system){s=e.unit;break}if(s===e.unit)break}return W`
      ${i.map(e=>W`

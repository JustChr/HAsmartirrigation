...
`;const Xa=e=>String(e).padStart(2,"0");function Ja(e){return e instanceof Date?e:new Date(e)}function Qa(e){const t=Ja(e);return`${Xa(t.getHours())}:${Xa(t.getMinutes())}`}function en(e){const t=Ja(e);return`${t.getFullYear()}-${Xa(t.getMonth()+1)}-${Xa(t.getDate())} ${Xa(t.getHours())}:${Xa(t.getMinutes())}`}function tn(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class sn extends(Wa(ce)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){Ks().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const s=Object.keys(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).length>0;s&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):s||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:be+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[s,i,a,n]=await Promise.all([Ts(this.hass),Ds(this.hass),(t=this.hass,t.callWS({type:be+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),Us(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=s,this.zones=i,this._outlook=a,this._distributors=n,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),ja(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",be+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),ja(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",be+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),ja(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const s="all"===t,i=s?void 0:this.zones.find(e=>{var s;return(null===(s=e.id)||void 0===s?void 0:s.toString())===t}),a=s?`(${this._linkedZoneCount})`:`: ${null!==(e=null==i?void 0:i.name)&&void 0!==e?e:t}`;try{await(n=this.hass,o=s?void 0:t,n.callWS(Object.assign({type:be+"/irrigate_now"},void 0!==o?{zone_id:o}:{}))),Ua(this,`${Ma("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${a}`)}catch(e){const t=Pa(e);console.error("irrigate_now failed",e),Ua(this,`${Ma("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var n,o}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const s=new Date(t);return s.getTime()>Date.now()?s:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:be+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),ja(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:be+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),ja(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,s;const i=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(s=this._runMinutes[i])&&void 0!==s?s:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const s=this._zoneDistributor(e);return!!s&&Object.keys(null!==(t=s.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var s,i,a;if(t>0)try{await(s=this.hass,i=e.id.toString(),a=t,s.callWS({type:be+"/run_zone",zone_id:i,duration:a})),Ua(this,`${Ma("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=Pa(e);console.error("run_zone failed",e),Ua(this,`${Ma("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===s?void 0:s[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,s;if(this.hass&&void 0!==e.id)try{await(t=this.hass,s=e.id.toString(),t.callWS({type:be+"/stop_zone",zone_id:s})),Ua(this,`${Ma("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=Pa(e);console.error("stop_zone failed",e),Ua(this,`${Ma("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",be+"/zones",{id:i,calculate:!0,override_cache:!0})).catch(e=>{const t=Pa(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",be+"/zones",{id:i,update:!0})).catch(e=>{const t=Pa(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;Ra(0,t?Va("setup","zones",t):Va("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,s,i;const a=null!==(t=e.duration)&&void 0!==t?t:0,n=Number(null!==(s=e.bucket_threshold)&&void 0!==s?s:0),o=this._zoneEstimate(e),r=o&&o.available&&null!=o.live_deficit?o.live_deficit:Number(null!==(i=e.bucket)&&void 0!==i?i:0);return a>0&&r<n}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,s=new Date(e),i=Qa(s),a=new Date;return tn(s,a)?`${Ma("panels.zones.outlook.today",t)} ${i}`:tn(s,function(e,t){const s=new Date(e.getTime());return s.setDate(s.getDate()+t),s}(a,1))?`${Ma("panels.zones.outlook.tomorrow",t)} ${i}`:function(e,t){const s=Ja(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(s)} ${Qa(s)}`}(s,t)}_renderEstimatedTag(e){if(!this.hass||!e.estimated)return W``;const t=this.hass.language;return W`<span
    ...
    `}_renderZoneNextRun(e){if(!this.hass)return W``;const t=this._nextIrrigateRunForZone(e);if(!t||!t.next_run_utc)return W``;return e.state!==Ga.Disabled&&e.last_calculated&&this._zoneHasDeficit(e)&&0===this._triggeredGuards.length?W``:W`
      <span class="status-sep">·</span>
      <span>
    ...
    `}renderZone(e,t){var s;if(!this.hass)return W``;const i=Number(null!==(s=e.bucket)&&void 0!==s?s:0),a=i<0?"var(--warning-color)":"var(--success-color)",n=e.state===Ga.Automatic?"state-automatic":e.state===Ga.Manual?"state-manual":"state-disabled",o=e.last_calculated?en(e.last_calculated):Ma("panels.zones.status.never",this.hass.language);return W`
      <ha-card>
        ...
        <div class="card-content zone-action-bar">
          ${"full"===this.actionsMode&&e.state===Ga.Automatic?W`
                <button
                  class="action-btn"
    ...
    `}}t([me()],sn.prototype,"config",void 0),t([me({type:Boolean})],sn.prototype,"hideSettingsLinks",void 0),t([me({attribute:!1})],sn.prototype,"actionsMode",void 0),t([me({type:Array})],sn.prototype,"zones",void 0),t([ve()],sn.prototype,"_outlook",void 0),t([ve()],sn.prototype,"_distributors",void 0),t([me({type:Boolean})],sn.prototype,"isLoading",void 0),t([me({type:Boolean})],sn.prototype,"isSaving",void 0),t([ve()],sn.prototype,"_operationError",void 0),t([ve()],sn.prototype,"_confirmIrrigate",void 0),t([ve()],sn.prototype,"_skipDetailsOpen",void 0),t([ve()],sn.prototype,"_runMinutes",void 0),t([ve()],sn.prototype,"_now",void 0),customElements.get("smart-irrigation-view-zones")||customElements.define("smart-irrigation-view-zones",sn)
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */;const an={},nn=Qs(class extends ei{constructor(e){if(super(e),e.type!==Xs&&e.type!==Vs&&e.type!==Js)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===G||t===K)return t;const s=e.element,i=e.name;if(e.type===Xs){if(t===s[i])return G}else if(e.type===Js){if(!!t===s.hasAttribute(i))return G}else if(e.type===Vs&&s.getAttribute(i)===t+"")return G;return((e,t=an)=>{e._$AH=t;
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */})(e),t}});let on=class extends ce{constructor(){super(...arguments),this.label="",this.unit="",this.help="",this.required=!1,this._helpOpen=!1}_toggleHelp(){this._helpOpen=!this._helpOpen}render(){return W`
      <div class="si-field">
                ...
                <div class="setting-row">
                  ...
                  <div class="inline-row">
                    ...
                    <select
                      ...
                      .value="${nn(this.data.autoupdateschedule||Te)}"
      ...
      >
        ...
        <div class="card-content">
          <div class="setting-row">
            ...
            <select
              class="settings-input"
              .value="${nn(this.config.zone_sequencing||Wt)}"
    ...
    `}_renderDistributorSelector(e,t){var s,i;if(!this.hass)return W``;if(!(null===(s=this.config)||void 0===s?void 0:s.distributors_enabled))return W``;const a=this.hass.language,n=null!=e.distributor_id;return W`
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${nn(n?String(e.distributor_id):"")}"
             ...
             used to sit alongside it moved to the Weather & Location tab). -->
              <div class="card-content zone-settings">
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${nn(null!==(i=Object.keys(jt).find(t=>jt[t]===e.drainage_rate))&&void 0!==i?i:"custom")}"
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${nn(null!==(o=e.plant_type)&&void 0!==o?o:"custom")}"
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${nn(void 0!==e.module?String(e.module):"")}"
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${nn(void 0!==e.mapping?String(e.mapping):"")}"
                ...
                ${null!=e.distributor_id?W`<div class="distributor-managed">
                      ...
                      <ha-settings-row>
                        ...
                        <select
                          class="settings-input"
                          .value="${nn(null!==(d=e.watering_mode)&&void 0!==d?d:"classic")}"
                      ...
                      ${"service"===e.watering_mode?W`
                            ...
                            <ha-settings-row>
                              ...
                              <select
                                class="settings-input"
                                .value="${nn(null!==(h=e.duration_unit)&&void 0!==h?h:"seconds")}"
                ...
                ${null==e.distributor_id?W`
                      ...
                      ${this._flowSensorIsTotalizer(e)?W`
                            <ha-settings-row>
                              ...
                              <select
                                class="settings-input"
                                .value="${nn(e.flow_counter_type||"auto")}"
        ...
        <div class="card-content">
          <div class="history-usage">
            ...
            <span class="history-usage-value"
              >${un(null!==(i=e.water_used_total)&&void 0!==i?i:0,a)}</span
            >
          </div>
    ...
    `}};t([me()],gn.prototype,"config",void 0),t([me({attribute:!1})],gn.prototype,"path",void 0),t([me({type:Array})],gn.prototype,"zones",void 0),t([me({type:Array})],gn.prototype,"modules",void 0),t([me({type:Array})],gn.prototype,"mappings",void 0),t([me({type:Array})],gn.prototype,"distributors",void 0),t([me({type:Boolean})],gn.prototype,"isLoading",void 0),t([ve()],gn.prototype,"_expanded",void 0),t([me({type:Boolean})],gn.prototype,"isSaving",void 0),t([me({type:Boolean})],gn.prototype,"_showAddZone",void 0),t([ve()],gn.prototype,"_pendingConfirm",void 0),t([ve()],gn.prototype,"_saveStatus",void 0),t([me()],gn.prototype,"_confirmDeleteZoneId",void 0),t([me()],gn.prototype,"_newZoneName",void 0),t([me()],gn.prototype,"_newZoneSize",void 0),t([me()],gn.prototype,"_newZoneThroughput",void 0),t([me()],gn.prototype,"_newZoneEntity",void 0),gn=t([ue("smart-irrigation-view-zone-settings")],gn);let mn=class extends ce{_emit(e){this.dispatchEvent(new CustomEvent("distributor-changed",{detail:{value:Object.assign(Object.assign({},this.distributor),e)},bubbles:!0,composed:!0}))}_onNumber(e,t){const s=t.target.valueAsNumber;isNaN(s)||this._emit({[e]:Math.max(0,Math.round(s))})}render(){var e,t,s,i;if(!this.hass||!this.distributor)return W``;const a=this.hass.language,n=this.distributor,o=n.watering_mode===Ss;return W`
      <ha-settings-row>
        <span slot="heading"
      ...
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${nn(null!==(t=n.watering_mode)&&void 0!==t?t:zs)}"
    ...
    `}_renderServiceRows(e){var t,s;const i=this.distributor;return W`
      ...
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${nn(null!==(t=i.duration_unit)&&void 0!==t?t:"seconds")}"
    ...
    `}_hasOwnActuation(e){return!!(e.linked_entity||e.run_service||e.stop_service)}_membersByOutlet(e){const t=new Map;if(void 0===e)return t;for(const s of this.zones)s.distributor_id===e&&null!=s.outlet_number&&void 0!==s.id&&t.set(s.outlet_number,s);return t}_outletCount(e){const t=this._membersByOutlet(e.id),s=t.size?Math.max(...t.keys()):0,i=Math.max(2,s),a=void 0!==e.id?this._outletRows[e.id]:void 0;return Math.min(6,Math.max(i,null!=a?a:i))}_assignZone(e,t,s){return Ms(this.hass,{id:e.id,[Cs]:t,[Es]:s})}_optimisticZone(e,t,s){void 0!==e&&(this.zones=this.zones.map(i=>i.id===e?Object.assign(Object.assign({},i),{distributor_id:t,outlet_number:s}):i))}_runAssign(e){e.length&&(this.isSaving=!0,this._saveStatus="saving",this._scheduleUpdate(),Promise.all(e).then(()=>this._markSaved()).catch(e=>{console.error("Failed to assign zone to outlet:",e),this._saveStatus="idle",ja(this,this.hass,"common.errors.save_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(()=>{})}))}_setOutletCount(e,t){if(void 0===e.id)return;const s=this._membersByOutlet(e.id),i=[];for(const[e,a]of s)e>t&&i.push(a);this._outletRows=Object.assign(Object.assign({},this._outletRows),{[e.id]:t}),i.length?(i.forEach(e=>this._optimisticZone(e.id,null,null)),this._runAssign(i.map(e=>this._assignZone(e,null,null)))):this._scheduleUpdate()}_onOutletZoneChange(e,t,s){const i=s.target.value,a=i?parseInt(i):null,n=this._membersByOutlet(e.id).get(t),o=null!==a?this.zones.find(e=>e.id===a):null,r=[];n&&n.id!==a&&(r.push(this._assignZone(n,null,null)),this._optimisticZone(n.id,null,null)),o&&(r.push(this._assignZone(o,e.id,t)),this._optimisticZone(o.id,e.id,t)),this._runAssign(r)}_renderOutletConfig(e){if(!this.hass)return W``;const t=this.hass.language,s=this._membersByOutlet(e.id),i=this._outletCount(e),a=this.zones.filter(e=>void 0!==e.id&&null==e.distributor_id&&!this._hasOwnActuation(e)),n=[...s.keys()].sort((e,t)=>e-t),o=n.some((e,t)=>e!==t+1),r=[];for(let n=1;n<=i;n++){const i=s.get(n),o=i?[...a,i]:[...a];o.sort((e,t)=>(e.name||"").localeCompare(t.name||"")),r.push(W`
        <div class="outlet-row">
          ...
          <select
            class="settings-input"
            .value="${nn(null!=(null==i?void 0:i.id)?String(i.id):"")}"
        ...
        <ha-settings-row>
          ...
          <div class="inline-controls">
            <input
              ...
              max="${6}"
              step="1"
              .value="${nn(String(null!==(t=this._outletDraft[o])&&void 0!==t?t:e.current_outlet))}"
  ...
  ${Array.from({length:8},(e,t)=>{const s=t*Math.PI/4,i=(12+6.6*Math.cos(s)).toFixed(1),a=(12+6.6*Math.sin(s)).toFixed(1),n=(12+9.2*Math.cos(s)).toFixed(1),o=(12+9.2*Math.sin(s)).toFixed(1);return q`<line x1="${i}" y1="${a}" x2="${n}" y2="${o}" />`})}`,eo=q`<path d="M13.5,2.5A9.5,9.5 0 1,0 21.5,14 7.6,7.6 0 0,1 13.5,2.5Z" />`,to=q`<path d="M12,2.6C12,2.6 18.6,9.4 18.6,13.7A6.6,6.6 0 0,1 5.4,13.7C5.4,9.4 12,2.6 12,2.6Z" />`;let so=class extends ce{constructor(){super(...arguments),this.recurrence="daily",this.nominalDemandSeconds=0}_sunTimes(){var e,t,s,i,a,n;const o=null===(t=null===(e=this.hass)||void 0===e?void 0:e.states)||void 0===t?void 0:t["sun.sun"],r=null===(s=null==o?void 0:o.attributes)||void 0===s?void 0:s.next_rising,l=null===(i=null==o?void 0:o.attributes)||void 0===i?void 0:i.next_setting,d=null===(n=null===(a=this.hass)||void 0===a?void 0:a.config)||void 0===n?void 0:n.time_zone,c=(e,t)=>{if(!e)return t;const s=new Date(e);return isNaN(s.getTime())?t:Ln(In(d,s))};return{sunrise:c(r,360),sunset:c(l,1200)}}_azimuthResolver(){var e;return Rn(null===(e=this.hass)||void 0===e?void 0:e.config,new Date)}_renderRun(e,t){return e.wraps?q`
    ...
    `:q`
      ...
      `}_t(e,t,s){return Ma(`panels.schedules.dial.${e}`,t,"{from}",Fn(s.fromMinutes),"{to}",Fn(s.toMinutes))}_note(e,t){var s;const i=this.nominalDemandSeconds/60;if(!i)return W``;if("interval"===e.centre.kind){const s=e.overlaps.length>0;return W`
        <div class="d-note ${s?"warn":""}">
          ${s?Ma("panels.schedules.dial.collision_note",t):Ma("panels.schedules.dial.runs_of",t,"{count}",e.runs.length,"{duration}",Zn(i))}
        </div>
      `}if("window"!==e.centre.kind)return W``;const a=i-(null!==(s=e.centre.minutes)&&void 0!==s?s:0);return a<=1?W``:W`
      <div class="d-note warn">
        ${Ma("panels.schedules.dial.shortfall",t,"{duration}",Zn(a))}
      </div>
    `}_centreText(e,t){var s,i;const a=e.centre;switch(a.kind){case"invalid":return{val:"—",lbl:""};case"interval":return{val:Ma("panels.schedules.dial.every_hours",t,"{hours}",a.intervalHours),lbl:Ma("panels.schedules.dial.per_day",t,"{count}",a.perDay)};case"run":return{val:Zn(null!==(s=a.minutes)&&void 0!==s?s:0),lbl:Ma("panels.schedules.dial.run_label",t)};default:return{val:Zn(null!==(i=a.minutes)&&void 0!==i?i:0),lbl:Ma("panels.schedules.dial.window_label",t)}}}render(){if(!this.hass||!this.rows)return W``;const e=this.hass.language,{sunrise:t,sunset:s}=this._sunTimes(),i=Jn({rows:this.rows,recurrence:this.recurrence,intervalHours:this.intervalHours,intervalStartTime:this.intervalStartTime,nominalDemandMinutes:this.nominalDemandSeconds/60,sunriseMinutes:t,sunsetMinutes:s,azimuthResolver:this._azimuthResolver()}),{val:a,lbl:n}=this._centreText(i,e),o=Ma("panels.schedules.dial.sunrise",e,"{time}",Fn(i.sun.minutes)),r=Ma("panels.schedules.dial.sunset",e,"{time}",Fn(i.moon.minutes));return W`
      <div class="viz-dial">
        <div class="d-wrap">
          <svg
            viewBox="0 0 132 132"
    ...
    `}};t([me({attribute:!1})],so.prototype,"hass",void 0),t([me({attribute:!1})],so.prototype,"rows",void 0),t([me({attribute:!1})],so.prototype,"recurrence",void 0),t([me({attribute:!1})],so.prototype,"intervalHours",void 0),t([me({attribute:!1})],so.prototype,"intervalStartTime",void 0),t([me({attribute:!1})],so.prototype,"nominalDemandSeconds",void 0),so=t([ue("si-run-window-dial")],so);const io=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"];function ao(){return{name:"",recurrence:"daily",enabled:!0,start_mode:ns,start_time:"06:00",finish_mode:as,action:"irrigate",zones:"all"}}function no(e,t){return Ma(`panels.schedules.types.${e}`,t)||e}let oo=class extends ce{constructor(){super(...arguments),this.zones=[],this.heading="",this._save=()=>{this.dispatchEvent(new CustomEvent("save",{detail:{value:this.schedule},bubbles:!0,composed:!0}))},this._cancel=()=>{this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}}_emitChanged(e){this.dispatchEvent(new CustomEvent("schedule-changed",{detail:{value:Object.assign(Object.assign({},this.schedule),e)},bubbles:!0,composed:!0}))}_renderZonePicker(){const e="all"===this.schedule.zones||!Array.isArray(this.schedule.zones),t=e?[]:this.schedule.zones.map(String);return W`
      <div class="field">
        ...
        `;case"interval":return W`
          ...
          <div class="field">
            ...
            <span class="field-help"
              >${Ma("panels.schedules.help.interval_start",t)}</span
            >
          </div>
    ...
    `;var n}_renderAnchorRow(e,t){const s=this.hass.language;return W`
      <div class="field">
        <div class="rowfields">
          <span class="row-inline"
            >${Ma("panels.schedules.fields.anchor_prefix",s)}</span
          >
          <select
    ...
    `}static get styles(){return[Ya,r`
      ...
      ${0===this._schedules.length?W`
          ...
          `:this._schedules.map(e=>W`
              <ha-card header="${e.name}">
                <div class="card-content">
                  ...
                  <div class="info-row">
                    ...
                    >
                    <span
                      >${no(e.recurrence,this.hass.language)}</span
                    >
                  </div>
            ...
            `)}
    `:W``}static get styles(){return[Ya,r`
                ...
                <div class="seasonal-table">
                  ...
                  ${this._climate.map(e=>W`
                      <div class="weather-row">
                        ...
                        >
                        <span
                          >${hn(e.estimated_et_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${hn(e.average_precipitation_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${hn(e.average_temperature_c,"temperature",this._metric)}</span
                        >
                      </div>
                    `)}
                </div>
    ...
    `}_renderForecastDay(e,t){const s=(()=>{try{return new Intl.DateTimeFormat(t,{weekday:"short",month:"short",day:"numeric"}).format(new Date(e.date+"T00:00:00"))}catch(t){return e.date}})(),i=e=>{const t=cn(e,"temperature",this._metric);return t?`${Math.round(t.value)}°`:"-"};return W`
      <div class="forecast-day">
        ...
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-rainy"></ha-icon>${hn(e.precipitation,"precipitation",this._metric)}
        </div>
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-windy"></ha-icon>${hn(e.windspeed,"windspeed",this._metric)}
        </div>
      </div>
                ...
                <div class="weather-table">
                  ...
                  ${s.map(e=>W`
                      <div class="weather-row">
                        ...
                        <span
                          >${hn(e.temperature,"temperature",this._metric)}</span
                        >
                        <span>${(e=>null!=e?e.toFixed(1)+" %":"-")(e.humidity)}</span>
                        <span
                          >${hn(e.dewpoint,"temperature",this._metric)}</span
                        >
                        <span
                          >${hn(e.wind_speed,"windspeed",this._metric)}</span
                        >
                        <span
                          >${hn(e.pressure,"pressure",this._metric)}</span
                        >
                        <span
                          >${hn(e.precipitation,"precipitation",this._metric)}</span
                        >
    ...
    `}};t([me()],co.prototype,"narrow",void 0),t([ve()],co.prototype,"config",void 0),t([ve()],co.prototype,"_saving",void 0),co=t([ue("smart-irrigation-view-experimental")],co);var ho;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.Distributors="distributors",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}(ho||(ho={}));const uo={[ho.WeatherLocation]:"panels.setup.tabs.weather_location",[ho.Zones]:"panels.setup.tabs.my_zones",[ho.Distributors]:"panels.setup.tabs.distributors",[ho.WhenToWater]:"panels.setup.tabs.when_to_water",[ho.Advanced]:"panels.setup.tabs.advanced",[ho.Experimental]:"panels.setup.tabs.experimental",[ho.Help]:"panels.help.title"};let po=class extends(Wa(ce)){hassSubscribe(){return this._fetchConfig(),[this.hass.connection.subscribeMessage(()=>this._fetchConfig(),{type:be+"_config_updated"})]}async _fetchConfig(){if(this.hass)try{this.config=await Ts(this.hass)}catch(e){console.error("Failed to fetch setup config:",e)}}get _distributorsEnabled(){var e,t;return null!==(t=null===(e=this.config)||void 0===e?void 0:e.distributors_enabled)&&void 0!==t&&t}get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(ho).includes(null!=t?t:"")?t:ho.WeatherLocation}_selectTab(e){Ra(0,Va("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return W``;const e=this._distributorsEnabled,t=Object.values(ho).filter(t=>t!==ho.Distributors||e);let s=this._activeTab;return s!==ho.Distributors||e||(s=ho.WeatherLocation),W`
    ...
    `}_renderContent(e){if(!this.hass)return W``;switch(e){case ho.WeatherLocation:return W`
          ...
          <smart-irrigation-view-weather-data
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-weather-data>
        `;case ho.Zones:return W`<smart-irrigation-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-zone-settings>`;case ho.Distributors:return W`<smart-irrigation-view-distributor-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-distributor-settings>`;case ho.WhenToWater:return W`
          <smart-irrigation-view-general
            .hass="${this.hass}"
            .narrow="${this.narrow}"
        ...
        `;case ho.Advanced:return W`
          ...
          <smart-irrigation-view-mappings
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-mappings>
        `;case ho.Experimental:return W`<smart-irrigation-view-experimental
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-experimental>`;case ho.Help:return this._renderHelp()}}_renderHelp(){return this.hass?W`
      <ha-card
    ...
    `}};var go;t([me({attribute:!1})],po.prototype,"hass",void 0),t([me({type:Boolean})],po.prototype,"narrow",void 0),t([me({attribute:!1})],po.prototype,"path",void 0),t([ve()],po.prototype,"config",void 0),po=t([ue("smart-irrigation-view-setup")],po),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done"}(go||(go={}));let mo=class extends ce{constructor(){super(...arguments),this._step=go.Welcome,this._saving=!1,this._error="",this._confirmClose=!1,this._siConfig=null,this._useWeather=!1,this._weatherService=Ae,this._apiKey="",this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=Fe,this._humiditySource=Fe,this._precipSource=Fe,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="",this._scheduleTime="06:00",this._scheduleCreated=!1,this._creatingSchedule=!1}async connectedCallback(){super.connectedCallback(),await this._loadInitialData()}async _loadInitialData(){var e;if(this.hass){try{const[t,s,i]=await Promise.all([Is(this.hass),Fs(this.hass),Ts(this.hass)]);this._availableModules=t,this._weatherConfig=s,this._siConfig=i,this._useWeather=s.use_weather_service,this._weatherService=null!==(e=s.weather_service)&&void 0!==e?e:Ae}catch(e){console.error("Wizard: failed to load initial data",e),this._error=Pa(e)}this.requestUpdate()}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}))}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}))}async _next(){this._error="";try{switch(this._saving=!0,this._step){case go.Welcome:this._step=go.Weather;break;case go.Weather:await this._saveWeather(),this._step=go.Module;break;case go.Module:await this._saveModule(),this._step=go.Mapping;break;case go.Mapping:await this._saveMapping(),this._step=go.Zone;break;case go.Zone:await this._saveZone(),this._step=go.Done;break;case go.Done:this._close()}}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._saving=!1,this.requestUpdate()}}_back(){this._step>go.Welcome&&(this._step=this._step-1,this._error="")}get _canSkipCurrentStep(){return this._step===go.Weather}_skipStep(){this._canSkipCurrentStep&&this._step<go.Done&&(this._step=this._step+1,this._error="")}async _saveWeather(){await Zs(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null)}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0}catch(e){return}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await Ns(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>Hs(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.")}async _saveMapping(){const e=this._useWeather?Fe:Ve,t={[Ue]:{[Ye]:this._tempSource},[Ne]:{[Ye]:this._humiditySource},[Le]:{[Ye]:this._precipSource}},s=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const i of s)t[i]={[Ye]:e};const i=await Rs(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(i,()=>Ls(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.")}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await Ms(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:Ga.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0})}async _createDefaultSchedule(){var e,t;if(!this._scheduleCreated&&!this._creatingSchedule){this._error="",this._creatingSchedule=!0;try{const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";await Bs(this.hass,{name:Ma("wizard.steps.done.schedule_name",s)||"Daily",type:"daily",enabled:!0,time:this._scheduleTime||"06:00",action:"irrigate",zones:"all"}),this._scheduleCreated=!0}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._creatingSchedule=!1,this.requestUpdate()}}}render(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return W`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          ...
          ${this._step!==go.Welcome&&this._step!==go.Done?W`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>go.Welcome&&this._step<go.Done?this._confirmClose=!0:this._close())}_renderStepper(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=[Ma("wizard.stepper.weather",s),Ma("wizard.stepper.module",s),Ma("wizard.stepper.mapping",s),Ma("wizard.stepper.zone",s)];return W`
      ${i.map((e,t)=>{const s=t+1,a=this._step===s,n=this._step>s;return W`
        ...
        `})}
    `}_renderStep(e){switch(this._step){case go.Welcome:return this._renderWelcome(e);case go.Weather:return this._renderWeather(e);case go.Module:return this._renderModule(e);case go.Mapping:return this._renderMapping(e);case go.Zone:return this._renderZone(e);case go.Done:return this._renderDone(e);default:return W``}}_renderFooter(e){return this._step===go.Done?W``:W`
      <div class="footer-left">
        ${this._step>go.Welcome?W`<button
              class="wizard-btn secondary"
              @click="${this._back}"
              ?disabled="${this._saving}"
            >
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Ma("common.saving-messages.saving",e):this._step===go.Welcome||this._step<go.Zone?Ma("wizard.next",e):Ma("wizard.finish",e)}
      </button>
    ...
    `}};t([me({attribute:!1})],mo.prototype,"hass",void 0),t([ve()],mo.prototype,"_step",void 0),t([ve()],mo.prototype,"_saving",void 0),t([ve()],mo.prototype,"_error",void 0),t([ve()],mo.prototype,"_confirmClose",void 0),t([ve()],mo.prototype,"_siConfig",void 0),t([ve()],mo.prototype,"_useWeather",void 0),t([ve()],mo.prototype,"_weatherService",void 0),t([ve()],mo.prototype,"_apiKey",void 0),t([ve()],mo.prototype,"_weatherConfig",void 0),t([ve()],mo.prototype,"_availableModules",void 0),t([ve()],mo.prototype,"_selectedModuleIndex",void 0),t([ve()],mo.prototype,"_moduleConfig",void 0),t([ve()],mo.prototype,"_mappingName",void 0),t([ve()],mo.prototype,"_tempSource",void 0),t([ve()],mo.prototype,"_humiditySource",void 0),t([ve()],mo.prototype,"_precipSource",void 0),t([ve()],mo.prototype,"_zoneName",void 0),t([ve()],mo.prototype,"_zoneSize",void 0),t([ve()],mo.prototype,"_zoneThroughput",void 0),t([ve()],mo.prototype,"_zoneEntity",void 0),t([ve()],mo.prototype,"_scheduleTime",void 0),t([ve()],mo.prototype,"_scheduleCreated",void 0),t([ve()],mo.prototype,"_creatingSchedule",void 0),mo=t([ue("si-setup-wizard")],mo);const vo=Ya;var fo;!function(e){e.Zones="zones",e.Setup="setup"}(fo||(fo={})),e.SmartIrrigationPanel=class extends ce{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}async firstUpdated(){const e=Ka().page;Object.values(fo).includes(e)||Ra(0,Va(fo.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())}),Ks().then(()=>{this._scheduleUpdate()}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}),this.hass&&Ts(this.hass).then(e=>{this._config=e,this._scheduleUpdate()}).catch(e=>{console.error("Failed to fetch config for version display:",e)})}_ensureLanguage(){this.hass&&!Da(this.hass.language)&&function(e){const t=Oa(e);return Da(e)?Promise.resolve():(Ta[t]||(Ta[t]=fetch(`/smart_irrigation_static/languages/${t}.json?v=${_e}`).then(e=>e.ok?e.json():Promise.reject(e.status)).then(e=>{Ea[t]=e}).catch(()=>{Ea[t]=Ea.en})),Ta[t])}(this.hass.language).then(()=>this.requestUpdate())}render(){var e,t;if(this.hass&&!Da(this.hass.language))return this._ensureLanguage(),W``;const s=Ka(),i=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return W`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
    ...
    `}getView(e){switch(e.page){case"zones":default:return W`
        ...
        `;case"setup":return W`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0}}"
          ></smart-irrigation-view-setup>
        `}}navigateToPage(e){if(e!==Ka().page){const t=Va(e);Ra(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==Ka().page){const e=Va(t);Ra(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[vo,r`
        :host {
          color: var(--primary-text-color);
    ...
    `}};t([me({attribute:!1})],_o.prototype,"hass",void 0),t([ve()],_o.prototype,"_params",void 0),_o=t([ue("error-dialog")],_o);var bo=Object.freeze({__proto__:null,get ErrorDialog(){return _o}})}({});

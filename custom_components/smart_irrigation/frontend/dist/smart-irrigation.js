...
/**
                ...
                <div class="setting-row">
                  ...
                  <div class="inline-row">
                    ...
                    <select
                      ...
                      .value="${on(this.data.autoupdateschedule||Ce)}"
    ...
    `}_renderDialog(){if(!this._showDialog)return Z``;const e=this._editingSchedule,t=this._editingId?Ia("panels.schedules.dialog.edit_title",this.hass.language):Ia("panels.schedules.dialog.add_title",this.hass.language);return Z`
    ...
    `}};t([pe()],zn.prototype,"narrow",void 0),t([ge()],zn.prototype,"config",void 0),t([ge()],zn.prototype,"_saving",void 0),zn=t([ce("smart-irrigation-view-experimental")],zn);var Sn;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.Distributors="distributors",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}(Sn||(Sn={}));const An={[Sn.WeatherLocation]:"panels.setup.tabs.weather_location",[Sn.Zones]:"panels.setup.tabs.my_zones",[Sn.Distributors]:"panels.setup.tabs.distributors",[Sn.WhenToWater]:"panels.setup.tabs.when_to_water",[Sn.Advanced]:"panels.setup.tabs.advanced",[Sn.Experimental]:"panels.setup.tabs.experimental",[Sn.Help]:"panels.help.title"};let Cn=class extends(qa(le)){hassSubscribe(){return this._fetchConfig(),[this.hass.connection.subscribeMessage(()=>this._fetchConfig(),{type:_e+"_config_updated"})]}async _fetchConfig(){if(this.hass)try{this.config=await Ts(this.hass)}catch(e){console.error("Failed to fetch setup config:",e)}}get _distributorsEnabled(){var e,t;return null!==(t=null===(e=this.config)||void 0===e?void 0:e.distributors_enabled)&&void 0!==t&&t}get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(Sn).includes(null!=t?t:"")?t:Sn.WeatherLocation}_selectTab(e){Ra(0,Ya("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return Z``;const e=this._distributorsEnabled,t=Object.values(Sn).filter(t=>t!==Sn.Distributors||e);let s=this._activeTab;return s!==Sn.Distributors||e||(s=Sn.WeatherLocation),Z`
    ...
    `}_renderContent(e){if(!this.hass)return Z``;switch(e){case Sn.WeatherLocation:return Z`
          ...
          <smart-irrigation-view-weather-data
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-weather-data>
        `;case Sn.Zones:return Z`<smart-irrigation-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-zone-settings>`;case Sn.Distributors:return Z`<smart-irrigation-view-distributor-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-distributor-settings>`;case Sn.WhenToWater:return Z`
          <smart-irrigation-view-general
            .hass="${this.hass}"
            .narrow="${this.narrow}"
        ...
        `;case Sn.Advanced:return Z`
          ...
          <smart-irrigation-view-mappings
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-mappings>
        `;case Sn.Experimental:return Z`<smart-irrigation-view-experimental
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-experimental>`;case Sn.Help:return this._renderHelp()}}_renderHelp(){return this.hass?Z`
      <ha-card
    ...
    `}};var En;t([pe({attribute:!1})],Cn.prototype,"hass",void 0),t([pe({type:Boolean})],Cn.prototype,"narrow",void 0),t([pe({attribute:!1})],Cn.prototype,"path",void 0),t([ge()],Cn.prototype,"config",void 0),Cn=t([ce("smart-irrigation-view-setup")],Cn),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done"}(En||(En={}));let Tn=class extends le{constructor(){super(...arguments),this._step=En.Welcome,this._saving=!1,this._error="",this._confirmClose=!1,this._siConfig=null,this._useWeather=!1,this._weatherService=ze,this._apiKey="",this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=Ue,this._humiditySource=Ue,this._precipSource=Ue,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="",this._scheduleTime="06:00",this._scheduleCreated=!1,this._creatingSchedule=!1}async connectedCallback(){super.connectedCallback(),await this._loadInitialData()}async _loadInitialData(){var e;if(this.hass){try{const[t,s,i]=await Promise.all([Is(this.hass),Fs(this.hass),Ts(this.hass)]);this._availableModules=t,this._weatherConfig=s,this._siConfig=i,this._useWeather=s.use_weather_service,this._weatherService=null!==(e=s.weather_service)&&void 0!==e?e:ze}catch(e){console.error("Wizard: failed to load initial data",e),this._error=Ua(e)}this.requestUpdate()}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}))}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}))}async _next(){this._error="";try{switch(this._saving=!0,this._step){case En.Welcome:this._step=En.Weather;break;case En.Weather:await this._saveWeather(),this._step=En.Module;break;case En.Module:await this._saveModule(),this._step=En.Mapping;break;case En.Mapping:await this._saveMapping(),this._step=En.Zone;break;case En.Zone:await this._saveZone(),this._step=En.Done;break;case En.Done:this._close()}}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._saving=!1,this.requestUpdate()}}_back(){this._step>En.Welcome&&(this._step=this._step-1,this._error="")}get _canSkipCurrentStep(){return this._step===En.Weather}_skipStep(){this._canSkipCurrentStep&&this._step<En.Done&&(this._step=this._step+1,this._error="")}async _saveWeather(){await Zs(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null)}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0}catch(e){return}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await Ns(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>Ms(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.")}async _saveMapping(){const e=this._useWeather?Ue:Ge,t={[Be]:{[Ke]:this._tempSource},[Me]:{[Ke]:this._humiditySource},[Ie]:{[Ke]:this._precipSource}},s=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const i of s)t[i]={[Ke]:e};const i=await Ps(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(i,()=>Ls(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.")}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await Ds(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:Ka.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0})}async _createDefaultSchedule(){var e,t;if(!this._scheduleCreated&&!this._creatingSchedule){this._error="",this._creatingSchedule=!0;try{const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";await Rs(this.hass,{name:Ia("wizard.steps.done.schedule_name",s)||"Daily",recurrence:"daily",enabled:!0,start_mode:ns,start_time:this._scheduleTime||"06:00",finish_mode:as,action:"irrigate",zones:"all"}),this._scheduleCreated=!0}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._creatingSchedule=!1,this.requestUpdate()}}}render(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return Z`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          ...
          ${this._step!==En.Welcome&&this._step!==En.Done?Z`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>En.Welcome&&this._step<En.Done?this._confirmClose=!0:this._close())}_renderStepper(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=[Ia("wizard.stepper.weather",s),Ia("wizard.stepper.module",s),Ia("wizard.stepper.mapping",s),Ia("wizard.stepper.zone",s)];return Z`
      ${i.map((e,t)=>{const s=t+1,a=this._step===s,n=this._step>s;return Z`
        ...
        `})}
    `}_renderStep(e){switch(this._step){case En.Welcome:return this._renderWelcome(e);case En.Weather:return this._renderWeather(e);case En.Module:return this._renderModule(e);case En.Mapping:return this._renderMapping(e);case En.Zone:return this._renderZone(e);case En.Done:return this._renderDone(e);default:return Z``}}_renderFooter(e){return this._step===En.Done?Z``:Z`
      <div class="footer-left">
        ${this._step>En.Welcome?Z`<button
              class="wizard-btn secondary"
              @click="${this._back}"
              ?disabled="${this._saving}"
            >
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Ia("common.saving-messages.saving",e):this._step===En.Welcome||this._step<En.Zone?Ia("wizard.next",e):Ia("wizard.finish",e)}
      </button>
    ...
    `}};t([pe({attribute:!1})],Tn.prototype,"hass",void 0),t([ge()],Tn.prototype,"_step",void 0),t([ge()],Tn.prototype,"_saving",void 0),t([ge()],Tn.prototype,"_error",void 0),t([ge()],Tn.prototype,"_confirmClose",void 0),t([ge()],Tn.prototype,"_siConfig",void 0),t([ge()],Tn.prototype,"_useWeather",void 0),t([ge()],Tn.prototype,"_weatherService",void 0),t([ge()],Tn.prototype,"_apiKey",void 0),t([ge()],Tn.prototype,"_weatherConfig",void 0),t([ge()],Tn.prototype,"_availableModules",void 0),t([ge()],Tn.prototype,"_selectedModuleIndex",void 0),t([ge()],Tn.prototype,"_moduleConfig",void 0),t([ge()],Tn.prototype,"_mappingName",void 0),t([ge()],Tn.prototype,"_tempSource",void 0),t([ge()],Tn.prototype,"_humiditySource",void 0),t([ge()],Tn.prototype,"_precipSource",void 0),t([ge()],Tn.prototype,"_zoneName",void 0),t([ge()],Tn.prototype,"_zoneSize",void 0),t([ge()],Tn.prototype,"_zoneThroughput",void 0),t([ge()],Tn.prototype,"_zoneEntity",void 0),t([ge()],Tn.prototype,"_scheduleTime",void 0),t([ge()],Tn.prototype,"_scheduleCreated",void 0),t([ge()],Tn.prototype,"_creatingSchedule",void 0),Tn=t([ce("si-setup-wizard")],Tn);const On=Xa;var Hn;!function(e){e.Zones="zones",e.Setup="setup"}(Hn||(Hn={})),e.SmartIrrigationPanel=class extends le{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}async firstUpdated(){const e=Va().page;Object.values(Hn).includes(e)||Ra(0,Ya(Hn.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())}),Ks().then(()=>{this._scheduleUpdate()}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}),this.hass&&Ts(this.hass).then(e=>{this._config=e,this._scheduleUpdate()}).catch(e=>{console.error("Failed to fetch config for version display:",e)})}_ensureLanguage(){this.hass&&!Da(this.hass.language)&&function(e){const t=Ha(e);return Da(e)?Promise.resolve():(Oa[t]||(Oa[t]=fetch(`/smart_irrigation_static/languages/${t}.json?v=${ve}`).then(e=>e.ok?e.json():Promise.reject(e.status)).then(e=>{Ta[t]=e}).catch(()=>{Ta[t]=Ta.en})),Oa[t])}(this.hass.language).then(()=>this.requestUpdate())}render(){var e,t;if(this.hass&&!Da(this.hass.language))return this._ensureLanguage(),Z``;const s=Va(),i=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return Z`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
    ...
    `}getView(e){switch(e.page){case"zones":default:return Z`
        ...
        `;case"setup":return Z`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0}}"
          ></smart-irrigation-view-setup>
        `}}navigateToPage(e){if(e!==Va().page){const t=Ya(e);Ra(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==Va().page){const e=Ya(t);Ra(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[On,r`
        :host {
          color: var(--primary-text-color);
    ...
    `}};t([pe({attribute:!1})],Dn.prototype,"hass",void 0),t([ge()],Dn.prototype,"_params",void 0),Dn=t([ce("error-dialog")],Dn);var Mn=Object.freeze({__proto__:null,get ErrorDialog(){return Dn}})}({});

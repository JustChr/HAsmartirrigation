    ...
    `;}getView(e){switch(e.page){case"zones":default:return W`
        ...
        `;case"setup":return W`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0;}}"
          ></smart-irrigation-view-setup>
        `;}}navigateToPage(e){if(e!==vr().page){const t=fr(e);js(0,t),this.requestUpdate();}else scrollTo(0,0);}handlePageSelected(e){const t=e.detail.name;if(t!==vr().page){const e=fr(t);js(0,e),this.requestUpdate();}else scrollTo(0,0);}static get styles(){return[zr,c`
        :host {
          color: var(--primary-text-color);

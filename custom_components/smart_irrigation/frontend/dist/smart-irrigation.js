...
`;function nr(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e;}function sr(e){throw new Error('Could not dynamically require "'+e+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.');}c`
  /* ha-dialog styles */
  ha-dialog {
...
i.version="2.30.1",n(Ga),i.fn=ls,i.min=Ja,i.max=Qa,i.now=ei,i.utc=g,i.unix=ds,i.months=vs,i.isDate=c,i.locale=ga,i.invalid=f,i.duration=Ai,i.isMoment=z,i.weekdays=fs,i.parseZone=us,i.localeData=_a,i.isDuration=ri,i.monthsShort=_s,i.weekdaysMin=ys,i.defineLocale=ma,i.updateLocale=va,i.locales=fa,i.weekdaysShort=bs,i.normalizeUnits=ae,i.relativeTimeRounding=ir,i.relativeTimeThreshold=nr,i.calendarFormat=Bi,i.prototype=ls,i.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},i;}();}(or)),or.exports),dr=nr(lr);class ur extends Js(de){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._updateScheduled=!1;}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate();}));}firstUpdated(){be().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate();});}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e);}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e);});},{type:Se+"_config_updated"})];}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[a,i,n]=await Promise.all([Bs(this.hass),Rs(this.hass),(t=this.hass,t.callWS({type:Se+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e);})]);this.config=a,this.zones=i,this._outlook=n,this._initialLoadDone=!0;}catch(e){console.error("Error fetching data:",e),Ns(this,this.hass,"common.errors.load_failed",e);}finally{e&&(this.isLoading=!1),this._scheduleUpdate();}var t;}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",Se+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),Ns(this,this.hass,"common.errors.action_failed",e);}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e));}));}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",Se+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),Ns(this,this.hass,"common.errors.action_failed",e);}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e));}));}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return e.linked_entity&&(null!==(t=e.duration)&&void 0!==t?t:0)>0;}).length;}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const a="all"===t,i=a?void 0:this.zones.find(e=>{var a;return(null===(a=e.id)||void 0===a?void 0:a.toString())===t;}),n=a?`(${this._linkedZoneCount})`:`: ${null!==(e=null==i?void 0:i.name)&&void 0!==e?e:t}`;try{await(s=this.hass,r=a?void 0:t,s.callWS(Object.assign({type:Se+"/irrigate_now"},void 0!==r?{zone_id:r}:{}))),Ps(this,`${Es("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${n}`);}catch(e){const t=Os(e);console.error("irrigate_now failed",e),Ps(this,`${Es("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`);}var s,r;}handleCalculateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(a=this.hass,i=t.id.toString(),a.callApi("POST",Se+"/zones",{id:i,calculate:!0,override_cache:!0})).catch(e=>{const t=Os(e);console.error("calculateZone failed:",e),this._operationError=t;}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e));}));}handleUpdateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(a=this.hass,i=t.id.toString(),a.callApi("POST",Se+"/zones",{id:i,update:!0})).catch(e=>{const t=Os(e);console.error("updateZone failed:",e),this._operationError=t;}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e));}));}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;js(0,t?ar("setup","zones",t):ar("setup","zones"));}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id));}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc);}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e));}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[];}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip);}_zoneHasDeficit(e){var t,a,i;const n=null!==(t=e.duration)&&void 0!==t?t:0,s=Number(null!==(a=e.bucket)&&void 0!==a?a:0),r=Number(null!==(i=e.bucket_threshold)&&void 0!==i?i:0);return n>0&&s<r;}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,a=dr(e),i=a.format("HH:mm"),n=dr();return a.isSame(n,"day")?`${Es("panels.zones.outlook.today",t)} ${i}`:a.isSame(n.clone().add(1,"day"),"day")?`${Es("panels.zones.outlook.tomorrow",t)} ${i}`:a.format("ddd HH:mm");}_guardLabel(e){return Es(`panels.zones.outlook.checks.${e.id}`,this.hass.language);}_guardDetail(e){var t;return e.available&&null!==e.observed?Es(`panels.zones.outlook.check_detail.${e.id}`,this.hass.language,"{observed}",String(e.observed),"{threshold}",String(null!==(t=e.threshold)&&void 0!==t?t:"")):"";}_renderSkipReasons(){const e=this.hass.language;return W`
      ...
      <div class="outlook-line outlook-dim skip-reasons-note">
        ${Es("panels.zones.outlook.provisional",e)}
      </div>
    `;}_openSchedules(){js(0,ar("setup","schedules"));}_runActionLabel(e){return Es(`panels.zones.outlook.actions.${e.action}`,this.hass.language);}_runTargetsLabel(e){const t=this.hass.language;if("all"===e.zones)return Es("panels.zones.outlook.targets_all",t);const a=Array.isArray(e.zones)?e.zones.length:0;return Es("panels.zones.outlook.targets_zones",t,"{count}",String(a));}_renderOutlookBanner(){if(!this.hass||!this._outlook)return W``;const e=this.hass.language,t=this._nextIrrigateRun,a=this._triggeredGuards,i=this._outlook.last_skip_evaluation;return t&&t.next_run_utc?W`
      <ha-card class="outlook-card">
        <div class="outlook">
          <div class="outlook-line outlook-headline">
            ...
            <span>
              <strong
                >${Es("panels.zones.outlook.next_run",e)}:</strong
              >
          ...
          ${a.length>0?W`
                <div class="outlook-line outlook-skip">
                  ...
                  <span
                    >${Es("panels.zones.outlook.will_skip",e)}</span
                  >
                  <button
                    class="outlook-info-btn"
                    aria-expanded="${this._skipDetailsOpen}"
                    title="${Es("panels.zones.outlook.why_skipped",e)}"
                  ...
                  >
                    ...
                    <span class="outlook-info-label"
                      >${Es("panels.zones.outlook.why_skipped",e)}</span
                    >
                  </button>
                </div>
              ...
              `:W`
                <div class="outlook-line outlook-clear">
                  ...
                  <span
                    >${Es("panels.zones.outlook.will_run",e)}</span
                  >
                </div>
              `}
    ...
    `:W`
        <ha-card class="outlook-card">
          <div class="outlook">
            <div class="outlook-line outlook-headline">
              ...
              <span>${Es("panels.zones.outlook.no_schedule",e)}</span>
              ${this.hideSettingsLinks?"":W`
                    <button
                      class="outlook-link"
                      @click="${this._openSchedules}"
                    >
                      ${Es("panels.zones.outlook.setup_schedule",e)}
                    </button>
                  `}
            </div>
            ${i?this._renderLastRunLine(i):""}
      ...
      `;}_renderLastRunLine(e){const t=this.hass.language,a=dr(e.timestamp).fromNow(),i=e.checks.filter(e=>e.enabled&&e.would_skip).map(e=>this._guardLabel(e).toLowerCase()).join(", "),n=e.would_skip?`${Es("panels.zones.outlook.last_run_skipped",t)}${i?` (${i})`:""}`:Es("panels.zones.outlook.last_run_ran",t);return W`
      <div class="outlook-line outlook-last">
        <span class="outlook-dim"
          >${Es("panels.zones.outlook.last_run",t)}:</span
        >
        <span>${n} · ${a}</span>
      </div>
    `;}_renderZoneDecision(e){var t;if(!this.hass)return W``;const a=this.hass.language,i=null!==(t=e.duration)&&void 0!==t?t:0;let n,s,r;if(e.state===er.Disabled)n=Es("panels.zones.status.decision_disabled",a),s="neutral",r="mdi:power-off";else if(e.last_calculated){if(this._zoneHasDeficit(e)){const t=function(e){const t=Math.round(e);if(t<60)return`${t} s`;const a=Math.floor(t/60),i=t%60;return i?`${a} min ${i} s`:`${a} min`;}(i),o=this._triggeredGuards,l=this._nextIrrigateRunForZone(e);o.length>0?(n=Es("panels.zones.status.decision_water_skip",a,"{duration}",t,"{reason}",this._guardLabel(o[0]).toLowerCase()),s="skip",r="mdi:weather-rainy"):l&&l.next_run_utc?(n=Es("panels.zones.status.decision_water_at",a,"{duration}",t,"{time}",this._formatRunTime(l.next_run_utc)),s="water",r="mdi:water"):(n=Es("panels.zones.status.decision_water_no_schedule",a,"{duration}",t),s="water",r="mdi:water-alert");}else n=Es("panels.zones.status.decision_no_water",a),s="ok",r="mdi:check-circle-outline";}else n=Es("panels.zones.status.decision_unknown",a),s="unknown",r="mdi:help-circle-outline";return W`
      <div class="zone-decision ${s}">
        <ha-icon icon="${r}"></ha-icon>
        <span>${n}</span>
      </div>
    `;}_zoneEstimate(e){var t,a;if(void 0!==e.id)return null===(a=null===(t=this._outlook)||void 0===t?void 0:t.zone_estimates)||void 0===a?void 0:a[String(e.id)];}_renderZoneEstimate(e){if(!this.hass)return W``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return W``;const a=this.hass.language,i=Ds(this.config,ht),n=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",s=Es(`panels.zones.status.estimate_method.${"proxy"===t.method?"proxy":"hourly"}`,a)+(t.as_of?` · ${dr(t.as_of).format("HH:mm")}`:"");return W`
      <span class="status-sep">·</span>
      <span class="zone-estimate" title="${s}">
        ${Es("panels.zones.status.estimate_now",a)}
        <strong style="color: ${n}"
          >≈ ${t.live_deficit.toFixed(2)} ${i}</strong
        >
        <span class="estimate-tag"
          >${Es("panels.zones.status.estimate_tag",a)}</span
        >
      </span>
    `;}_renderZoneNextRun(e){if(!this.hass)return W``;const t=this._nextIrrigateRunForZone(e);if(!t||!t.next_run_utc)return W``;return e.state!==er.Disabled&&e.last_calculated&&this._zoneHasDeficit(e)&&0===this._triggeredGuards.length?W``:W`
      <span class="status-sep">·</span>
      <span>
        ${Es("panels.zones.outlook.next_run",this.hass.language)}:
        <strong>${this._formatRunTime(t.next_run_utc)}</strong>
      </span>
    `;}renderZone(e,t){var a,i;if(!this.hass)return W``;const n=Number(null!==(a=e.bucket)&&void 0!==a?a:0),s=n<0?"var(--warning-color)":"var(--success-color)",r=e.state===er.Automatic?"state-automatic":e.state===er.Manual?"state-manual":"state-disabled",o=e.last_calculated?dr(e.last_calculated).format("YYYY-MM-DD HH:mm"):Es("panels.zones.status.never",this.hass.language);return W`
      <ha-card>
        <div class="card-header">
          ...
          ${this.hideSettingsLinks?"":W`
                <ha-icon-button
                  ...
                  title="${Es("panels.zones.actions.open_settings",this.hass.language)}"
        ...
        <div class="card-content">
          <div class="zone-status-line">
            <span
              title="${Es("panels.zones.help.bucket",this.hass.language)}"
            >
              ${Es("panels.zones.labels.bucket",this.hass.language)}:
              <strong style="color: ${s}"
                >${n.toFixed(2)}
                ${Ds(this.config,ht)}</strong
              >
            </span>
            <span class="status-sep">·</span>
            <span>
              ${Es("panels.zones.status.last_checked",this.hass.language)}:
              <strong>${o}</strong>
            </span>
        ...
        <div class="card-content zone-action-bar">
          ${"full"===this.actionsMode&&e.state===er.Automatic?W`
                <button
                  class="action-btn"
                  title="${Es("panels.zones.help.update",this.hass.language)}"
                ...
                <button
                  class="action-btn"
                  title="${Es("panels.zones.help.calculate",this.hass.language)}"
          ...
          ${"none"!==this.actionsMode&&e.linked_entity&&(null!==(i=e.duration)&&void 0!==i?i:0)>0?W`
              ...
              `:e.linked_entity?"":W`
                  <button
                    class="action-btn"
                    disabled
                    title="${Es("panels.zones.help.irrigate_link_entity",this.hass.language)}"
                  >
                    <ha-icon icon="mdi:water"></ha-icon>
                    ${Es("panels.zones.labels.irrigate_now",this.hass.language)}
                  </button>
                  <span class="zones-top-note">
                    ${Es("panels.zones.help.irrigate_link_entity",this.hass.language)}
                  </span>
                `}
        </div>
      </ha-card>
    `;}render(){var e,t;if(!this.hass)return W``;if(this.isLoading)return W`
      ...
      ${i?this.hideSettingsLinks?W`
              <ha-card>
                <div class="card-content description-text">
                  ${Es("panels.zones.no_items",this.hass.language)}
                </div>
              </ha-card>
            `:W`
      ...
      <ha-card>
        ...
        <div class="card-content zones-top-actions">
          ${"full"===this.actionsMode?W`
                <button
                  class="action-btn"
                  title="${Es("panels.zones.help.update_all",this.hass.language)}"
                ...
                <button
                  class="action-btn"
                  title="${Es("panels.zones.help.calculate_all",this.hass.language)}"
          ...
          ${"none"!==this.actionsMode?W`
                <button
                  class="action-btn"
                  raised
                  title="${Es("panels.zones.help.irrigate_all",this.hass.language)}"
      ...
      ${null!==this._confirmIrrigate?W`
            ...
            >
              ...
              <p>
                <strong>
                  ${"all"===this._confirmIrrigate?`${Es("panels.zones.confirm_irrigate.all_linked_zones",this.hass.language)} (${this._linkedZoneCount})`:null!==(t=null===(e=this.zones.find(e=>{var t;return(null===(t=e.id)||void 0===t?void 0:t.toString())===this._confirmIrrigate;}))||void 0===e?void 0:e.name)&&void 0!==t?t:this._confirmIrrigate}
                </strong>
              </p>
            ...
            <ha-card class="error-banner-card">
              <div class="error-banner">
                ...
                <ha-icon-button
                  ...
                  aria-label="${Es("common.actions.cancel",this.hass.language)}"
                ></ha-icon-button>
              </div>
            </ha-card>
          `:""}
    ...
    `;}}n([he()],ur.prototype,"config",void 0),n([he({type:Boolean})],ur.prototype,"hideSettingsLinks",void 0),n([he({attribute:!1})],ur.prototype,"actionsMode",void 0),n([he({type:Array})],ur.prototype,"zones",void 0),n([ge()],ur.prototype,"_outlook",void 0),n([he({type:Boolean})],ur.prototype,"isLoading",void 0),n([he({type:Boolean})],ur.prototype,"isSaving",void 0),n([ge()],ur.prototype,"_operationError",void 0),n([ge()],ur.prototype,"_confirmIrrigate",void 0),n([ge()],ur.prototype,"_skipDetailsOpen",void 0),customElements.get("smart-irrigation-view-zones")||customElements.define("smart-irrigation-view-zones",ur)/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */;const cr={},pr=jt(class extends Ot{constructor(e){if(super(e),e.type!==Dt&&e.type!==Et&&e.type!==Ct)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression");}render(e){return e;}update(e,[t]){if(t===F||t===Z)return t;const a=e.element,i=e.name;if(e.type===Dt){if(t===a[i])return F;}else if(e.type===Ct){if(!!t===a.hasAttribute(i))return F;}else if(e.type===Et&&a.getAttribute(i)===t+"")return F;return((e,t=cr)=>{e._$AH=t;/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */})(e),t;}});let hr=class extends de{constructor(){super(...arguments),this.label="",this.unit="",this.help="",this.required=!1,this._helpOpen=!1;}_toggleHelp(){this._helpOpen=!this._helpOpen;}render(){return W`
      <div class="si-field">
          ...
          ${this._useWeatherService?W`
                <div class="setting-row">
                  ...
                  <select
                    ...
                    .value="${pr(this._weatherService||Me)}"
          ...
          ${this.data.autoupdateenabled?W`
                <div class="setting-row">
                  ...
                  <div class="inline-row">
                    ...
                    <select
                      class="settings-input"
                      .value="${pr(this.data.autoupdateschedule||Te)}"
      ...
      <ha-card header="${Es("weather_skip.title",this.hass.language)}">
        ...
        <div class="card-content">
          ...
          ${this.config.skip_irrigation_on_precipitation?W`
                ...
                <div class="setting-row">
                  <label>
                    ${Es("weather_skip.lookahead_label",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="description-text">
                  ${Es("weather_skip.lookahead_help",this.hass.language)}
                </div>
              `:""}
      ...
      >
        ...
        <div class="card-content">
          <div class="setting-row">
            ...
            <select
              class="settings-input"
              .value="${pr(this.config.zone_sequencing||xt)}"
          ...
          ${a?W`
                <div class="setting-row">
                  ...
                  <input
                    ...
                    min="1"
                    class="settings-input"
                    .value="${pr(null!==(e=this.config.zone_sequencing_max_consecutive_duration)&&void 0!==e?e:5)}"
                ...
                <div class="setting-row">
                  ...
                  <input
                    ...
                    min="0"
                    class="settings-input"
                    .value="${pr(null!==(t=this.config.zone_sequencing_min_absorption_time)&&void 0!==t?t:0)}"
        ...
        ${0===t.length?W`
            ...
            `:W`
              <div class="weather-table">
                ...
                ${t.map(e=>{const t=e=>{try{const t=dr(e);return t.isValid()?t.format("MM-DD HH:mm"):"-";}catch(e){return"-";}},a=(e,t,a=1)=>null!=e?e.toFixed(a)+t:"-";return W`
      ...
      <div class="card-content">
        ${0===i.length?W`
              <div class="calendar-note">
                ${(null==a?void 0:a.error)?`${Es("panels.zones.calendar.error_prefix",this.hass.language)} ${a.error}`:Es("panels.zones.calendar.no_data",this.hass.language)}
              </div>
            `:W`
              <div class="calendar-table">
                <div class="calendar-header">
                  <span
                    >${Es("panels.zones.calendar.month",this.hass.language)}</span
                  >
                  <span
                    >${Es("panels.zones.calendar.et",this.hass.language)}</span
                  >
                  <span
                    >${Es("panels.zones.calendar.precipitation",this.hass.language)}</span
                  >
                  <span
                    >${Es("panels.zones.calendar.watering",this.hass.language)}</span
                  >
                  <span
                    >${Es("panels.zones.calendar.avg_temp",this.hass.language)}</span
                  >
                </div>
                ${i.map(e=>W`
              ...
              ${(null==a?void 0:a.calculation_method)?W`
                    <div class="calendar-info">
                      ${Es("panels.zones.calendar.method_prefix",this.hass.language)}
                      ${a.calculation_method}
                    </div>
                  `:""}
            `}
      </div>
    `;}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await Us(this.hass,e);}_renderModuleOptions(e){if(!this.hass)return W``;const t=null!=e?String(e):"";return W`
    ...
    `;}_renderMappingOptions(e){if(!this.hass)return W``;const t=null!=e?String(e):"";return W`
      ...
      ${this.mappings.map(e=>W`
        ...
        `)}
    `;}renderZone(e,t){var a,i,n,s,r,o;if(!this.hass)return W``;const l=void 0!==e.id&&e.id===this._targetZoneId;return W`
      <ha-card id="zone-${null!==(a=e.id)&&void 0!==a?a:"new"}">
        ...
        >
          ...
          <ha-settings-row>
            ...
            <select
              class="settings-input"
              .value="${pr(void 0!==e.module?String(e.module):"")}"
          ...
          <ha-settings-row>
            ...
            <select
              class="settings-input"
              .value="${pr(void 0!==e.mapping?String(e.mapping):"")}"
          ...
          <ha-settings-row>
            ...
            <input
              ...
              min="0"
              inputmode="numeric"
              .value="${null!==(s=e.maximum_duration)&&void 0!==s?s:""}"
          ...
          <div class="settings-danger-row">
            <button
              class="action-btn"
              @click="${()=>{this._pendingConfirm={title:Es("panels.zones.confirm_action.reset_bucket_title",this.hass.language),body:Es("panels.zones.confirm_action.reset_bucket_body",this.hass.language),confirmLabel:Es("panels.zones.actions.reset-bucket",this.hass.language),onConfirm:()=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ht]:0}))};}}"
              ?disabled="${this.isSaving}"
            >
    ...
    `;}render(){var e,t;if(!this.hass)return W``;if(this.isLoading)return W`
      ...
      <ha-card>
        <div class="card-header">
          ...
          <ha-icon-button
            .path="${Is}"
            title="${Es("panels.zones.cards.add-zone.header",this.hass.language)}"
      ...
      <ha-card>
        ...
        <div class="card-content bulk-actions">
          <button
            class="action-btn danger-button"
            @click="${()=>{this._pendingConfirm={title:Es("panels.zones.confirm_action.reset_all_buckets_title",this.hass.language),body:Es("panels.zones.confirm_action.reset_all_buckets_body",this.hass.language),confirmLabel:Es("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language),onConfirm:()=>this.handleResetAllBuckets()};}}"
            ?disabled="${this.isSaving}"
          >
          ...
          <button
            class="action-btn danger-button"
            @click="${()=>{this._pendingConfirm={title:Es("panels.zones.confirm_action.clear_weather_title",this.hass.language),body:Es("panels.zones.confirm_action.clear_weather_body",this.hass.language),confirmLabel:Es("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language),onConfirm:()=>this.handleClearAllWeatherdata()};}}"
            ?disabled="${this.isSaving}"
          >
    ...
    `;}};n([he()],mr.prototype,"config",void 0),n([he({attribute:!1})],mr.prototype,"path",void 0),n([he({type:Array})],mr.prototype,"zones",void 0),n([he({type:Array})],mr.prototype,"modules",void 0),n([he({type:Array})],mr.prototype,"mappings",void 0),n([he({type:Map})],mr.prototype,"wateringCalendars",void 0),n([he({type:Map})],mr.prototype,"weatherRecords",void 0),n([he({type:Boolean})],mr.prototype,"isLoading",void 0),n([he({type:Boolean})],mr.prototype,"isSaving",void 0),n([he({type:Boolean})],mr.prototype,"_showAddZone",void 0),n([ge()],mr.prototype,"_pendingConfirm",void 0),n([ge()],mr.prototype,"_saveStatus",void 0),n([he()],mr.prototype,"_confirmDeleteZoneId",void 0),n([he()],mr.prototype,"_newZoneName",void 0),n([he()],mr.prototype,"_newZoneSize",void 0),n([he()],mr.prototype,"_newZoneThroughput",void 0),mr=n([ce("smart-irrigation-view-zone-settings")],mr);let vr=class extends Js(de){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.moduleCache=new Map(),this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout(()=>{this.saveToHA(t),e=null;},500);};})();}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate();}));}firstUpdated(){be().catch(e=>{console.error("Failed to load HA form:",e);});}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e);}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e);});},{type:Se+"_config_updated"})];}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;e&&(this.isLoading=!0,this._scheduleUpdate());try{const[e,t,a,i]=await Promise.all([Bs(this.hass),Rs(this.hass),Ws(this.hass),Fs(this.hass)]);this.config=e,this.zones=t,this.modules=a,this.allmodules=i,this._initialLoadDone=!0,this.moduleCache.clear();}catch(e){console.error("Error fetching data:",e),Ns(this,this.hass,"common.errors.load_failed",e);}finally{e&&(this.isLoading=!1),this._scheduleUpdate();}}async handleAddModule(){var e,t;if((null===(t=null===(e=this.moduleInput)||void 0===e?void 0:e.selectedOptions)||void 0===t?void 0:t[0])&&!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.moduleInput.selectedOptions[0].text,t=this.allmodules.find(t=>t.name===e);if(!t)return;const a={name:e,description:t.description,config:t.config,schema:t.schema};this.modules=[...this.modules,a],this.moduleCache.clear(),this._scheduleUpdate(),await this.saveToHA(a),await this._fetchData();}catch(e){console.error("Error adding module:",e),await this._fetchData();}finally{this.isSaving=!1,this._scheduleUpdate();}}}async handleRemoveModule(e,t){if(!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.modules[t],n=null==e?void 0:e.id;this.modules;this.modules=this.modules.filter((e,a)=>a!==t),this.moduleCache.clear(),this._scheduleUpdate(),this.hass&&void 0!==n&&(await(a=this.hass,i=n.toString(),a.callApi("POST",Se+"/modules",{id:i,remove:!0})));}catch(e){console.error("Error removing module:",e),Ns(this,this.hass,"common.errors.delete_failed",e),await this._fetchData();}finally{this.isSaving=!1,this._scheduleUpdate();}var a,i;}}async saveToHA(e){if(this.hass)try{await Zs(this.hass,e);}catch(e){throw console.error("Error saving module:",e),Ns(this,this.hass,"common.errors.save_failed",e),e;}}renderModule(e,t){if(!this.hass)return W``;const a=`module-${e.id||t}-${JSON.stringify(e)}`;if(this.moduleCache.has(a))return this.moduleCache.get(a);const i=this.zones.filter(t=>t.module===e.id).length,n=W`
    ...
    `;}};n([he()],vr.prototype,"config",void 0),n([he({type:Array})],vr.prototype,"zones",void 0),n([he({type:Array})],vr.prototype,"modules",void 0),n([he({type:Array})],vr.prototype,"allmodules",void 0),n([he({type:Boolean})],vr.prototype,"isLoading",void 0),n([he({type:Boolean})],vr.prototype,"isSaving",void 0),n([me("#moduleInput")],vr.prototype,"moduleInput",void 0),vr=n([ce("smart-irrigation-view-modules")],vr);let _r=class extends Js(de){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.weatherRecords=new Map(),this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this.debounceTimers=new Map(),this.globalDebounceTimer=null,this.mappingCache=new Map(),this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16;}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate();},this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate();}));}firstUpdated(){be().catch(e=>{console.error("Failed to load HA form:",e);});}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e);}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e);});},{type:Se+"_config_updated"})];}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[t,a,i]=await Promise.all([Bs(this.hass),Rs(this.hass),Vs(this.hass)]);this.config=t,this.zones=a,this.mappings=i,this._initialLoadDone=!0,this._fetchWeatherRecords(),this.mappingCache.clear();}catch(e){console.error("Error fetching data:",e),Ns(this,this.hass,"common.errors.load_failed",e);}finally{e&&(this.isLoading=!1),this._scheduleUpdate();}}async _fetchWeatherRecords(){if(this.hass){for(const e of this.mappings)if(void 0!==e.id)try{const t=await Gs(this.hass,e.id.toString(),0);this.weatherRecords.set(e.id,t);}catch(t){console.error(`Failed to fetch weather records for mapping ${e.id}:`,t),this.weatherRecords.set(e.id,[]);}this._scheduleUpdate();}}renderWeatherRecords(e){if(!this.hass)return W``;const t=void 0!==e.id&&this.weatherRecords.get(e.id)||[];return W`
    ...
    `;}renderAggregateOption(e,t){if(this.hass&&this.config){return W`<option value="${e}" ?selected="${e===t}">
        ...
        <option
          ...
          ?selected="${a===qe}"
        >
          ${Es("panels.mappings.cards.mapping.pressure_types."+qe,this.hass.language)}
        </option>
        <option
          value="${Ge}"
          ?selected="${a===Ge}"
        >
          ${Es("panels.mappings.cards.mapping.pressure_types."+Ge,this.hass.language)}
        </option>`,e;}return W``;}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return W``;const a=function(e){switch(e){case Oe:case Re:return[{unit:"°C",system:je},{unit:"°F",system:Ce}];case He:case Pe:return[{unit:"mm",system:je},{unit:"in",system:Ce}];case Le:return[{unit:st,system:je},{unit:rt,system:Ce}];case Ne:return[{unit:"%",system:[je,Ce]}];case Ie:return[{unit:"millibar",system:je},{unit:"hPa",system:je},{unit:"psi",system:Ce},{unit:"inch Hg",system:Ce}];case Ue:return[{unit:"km/h",system:je},{unit:"meter/s",system:je},{unit:"mile/h",system:Ce}];case Be:return[{unit:"W/m2",system:je},{unit:"MJ/day/m2",system:je},{unit:"W/sq ft",system:Ce},{unit:"MJ/day/sq ft",system:Ce}];default:return[];}}(e);let i=t[Qe];const n=this.config.units;if(!t[Qe])for(const e of a)if("string"==typeof e.system){if(n===e.system){i=e.unit;break;}}else{for(const t of e.system)if(n===t.system){i=e.unit;break;}if(i===e.unit)break;}return W`
      ${a.map(e=>W`
    ...
    `;}_renderTimeAnchorField(){var e;const t=this._editingSchedule;if("irrigate"!==t.action||"interval"===t.type)return W``;const a=["sunrise","sunset","solar_azimuth"].includes(t.type)&&!1!==t.account_for_duration,i=null!==(e=t.time_anchor)&&void 0!==e?e:a?"finish":"start";return W`
      <div class="field">
        <label
          >${Es("panels.schedules.fields.time_anchor",this.hass.language)}</label
        >
        <select
        ...
        >
          ${["start","finish"].map(e=>W`
              <option value="${e}" ?selected="${i===e}">
                ${Es(`panels.schedules.time_anchor.${e}`,this.hass.language)}
              </option>
            `)}
        </select>
      </div>
    ...
    `;}render(){return this.hass?this._isLoading?W`
      ...
      ${0===this._schedules.length?W`
          ...
          `:this._schedules.map(e=>W`
            ...
            `)}
    `:W``;}static get styles(){return[ir,c`
        .dialog-content {
          display: flex;
          flex-direction: column;
          gap: 14px;
      ...
      `];}};n([he({attribute:!1})],br.prototype,"hass",void 0),n([ge()],br.prototype,"_schedules",void 0),n([ge()],br.prototype,"_zones",void 0),n([ge()],br.prototype,"_isLoading",void 0),n([ge()],br.prototype,"_showDialog",void 0),n([ge()],br.prototype,"_editingSchedule",void 0),n([ge()],br.prototype,"_editingId",void 0),br=n([ce("smart-irrigation-view-schedules")],br);var yr;!function(e){e.General="general",e.Zones="zones",e.Modules="modules",e.Mappings="mappings",e.Schedules="schedules",e.Help="help";}(yr||(yr={}));const kr={[yr.General]:"panels.general.title",[yr.Zones]:"panels.zones.title",[yr.Modules]:"panels.modules.title",[yr.Mappings]:"panels.mappings.title",[yr.Schedules]:"panels.schedules.title",[yr.Help]:"panels.help.title"};let wr=class extends de{get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(yr).includes(null!=t?t:"")?t:yr.General;}_selectTab(e){js(0,ar("setup",e));}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}));}render(){if(!this.hass)return W``;const e=this._activeTab;return W`
      <div class="setup-container">
        <nav class="setup-nav">
          ${Object.values(yr).map(t=>W`
              <button
                class="setup-nav-btn ${e===t?"active":""}"
                @click="${()=>this._selectTab(t)}"
              >
                ${Es(kr[t],this.hass.language)}
              </button>
            `)}
          <button
    ...
    `;}_renderContent(e){if(!this.hass)return W``;switch(e){case yr.General:return W`<smart-irrigation-view-general
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-general>`;case yr.Zones:return W`<smart-irrigation-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-zone-settings>`;case yr.Modules:return W`<smart-irrigation-view-modules
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-modules>`;case yr.Mappings:return W`<smart-irrigation-view-mappings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-mappings>`;case yr.Schedules:return W`<smart-irrigation-view-schedules
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-schedules>`;case yr.Help:return this._renderHelp();}}_renderHelp(){return this.hass?W`
      <ha-card
    ...
    `;}};var zr;n([he({attribute:!1})],wr.prototype,"hass",void 0),n([he({type:Boolean})],wr.prototype,"narrow",void 0),n([he({attribute:!1})],wr.prototype,"path",void 0),wr=n([ce("smart-irrigation-view-setup")],wr),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done";}(zr||(zr={}));let Sr=class extends de{constructor(){super(...arguments),this._step=zr.Welcome,this._saving=!1,this._error="",this._confirmClose=!1,this._siConfig=null,this._useWeather=!1,this._weatherService=Me,this._apiKey="",this._testingApi=!1,this._testResult=null,this._testResultTimer=null,this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=We,this._humiditySource=We,this._precipSource=We,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="";}async connectedCallback(){super.connectedCallback(),await this._loadInitialData();}async _loadInitialData(){var e;if(this.hass){try{const[t,a,i]=await Promise.all([Fs(this.hass),Ys(this.hass),Bs(this.hass)]);this._availableModules=t,this._weatherConfig=a,this._siConfig=i,this._useWeather=a.use_weather_service,this._weatherService=null!==(e=a.weather_service)&&void 0!==e?e:Me;}catch(e){console.error("Wizard: failed to load initial data",e),this._error=Os(e);}this.requestUpdate();}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}));}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}));}async _next(){this._error="";try{switch(this._saving=!0,this._step){case zr.Welcome:this._step=zr.Weather;break;case zr.Weather:await this._saveWeather(),this._step=zr.Module;break;case zr.Module:await this._saveModule(),this._step=zr.Mapping;break;case zr.Mapping:await this._saveMapping(),this._step=zr.Zone;break;case zr.Zone:await this._saveZone(),this._step=zr.Done;break;case zr.Done:this._close();}}catch(e){this._error=e instanceof Error?e.message:String(e);}finally{this._saving=!1,this.requestUpdate();}}_back(){this._step>zr.Welcome&&(this._step=this._step-1,this._error="");}get _canSkipCurrentStep(){return this._step===zr.Weather;}_skipStep(){this._canSkipCurrentStep&&this._step<zr.Done&&(this._step=this._step+1,this._error="");}async _saveWeather(){await Xs(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null);}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0;}catch(e){return;}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await Zs(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>Ws(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.");}async _saveMapping(){const e=this._useWeather?We:Ye,t={[Re]:{[Ke]:this._tempSource},[Ne]:{[Ke]:this._humiditySource},[He]:{[Ke]:this._precipSource}},a=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const i of a)t[i]={[Ke]:e};const i=await qs(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(i,()=>Vs(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.");}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await Us(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:er.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0});}async _testApiKey(){if(this.hass&&!this._testingApi){this._testingApi=!0,this._testResult=null,this._testResultTimer&&clearTimeout(this._testResultTimer),this.requestUpdate();try{const e=await Ks(this.hass,this._weatherService,this._apiKey||null);this._testResult=e,this._testResultTimer=window.setTimeout(()=>{this._testResult=null,this.requestUpdate();},12e3);}catch(e){this._testResult={success:!1,error:"unknown"};}finally{this._testingApi=!1,this.requestUpdate();}}}render(){var e,t;const a=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return W`
        ...
        >
          <div class="wizard-header">
            ...
            <button
              ...
              aria-label="${Es("wizard.close",a)}"
            >
              <ha-icon icon="mdi:close"></ha-icon>
            </button>
          </div>
          ${this._step!==zr.Welcome&&this._step!==zr.Done?W`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `;}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>zr.Welcome&&this._step<zr.Done?this._confirmClose=!0:this._close());}_renderStepper(){var e,t;const a=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=[Es("wizard.stepper.weather",a),Es("wizard.stepper.module",a),Es("wizard.stepper.mapping",a),Es("wizard.stepper.zone",a)];return W`
      ${i.map((e,t)=>{const a=t+1,n=this._step===a,s=this._step>a;return W`
          <div
            class="stepper-step ${n?"active":""} ${s?"done":""}"
          >
            <div class="stepper-circle">${s?"✓":a}</div>
            <span class="stepper-label">${e}</span>
          </div>
          ${t<i.length-1?W`<div class="stepper-line ${s?"done":""}"></div>`:""}
        `;})}
    `;}_renderStep(e){switch(this._step){case zr.Welcome:return this._renderWelcome(e);case zr.Weather:return this._renderWeather(e);case zr.Module:return this._renderModule(e);case zr.Mapping:return this._renderMapping(e);case zr.Zone:return this._renderZone(e);case zr.Done:return this._renderDone(e);default:return W``;}}_renderFooter(e){return this._step===zr.Done?W``:W`
      <div class="footer-left">
        ${this._step>zr.Welcome?W`<button
              class="wizard-btn secondary"
              @click="${this._back}"
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Es("common.saving-messages.saving",e):this._step===zr.Welcome||this._step<zr.Zone?Es("wizard.next",e):Es("wizard.finish",e)}
      </button>
    ...
    `;}_renderMapping(e){const t=[{value:We,label:Es("wizard.steps.mapping.use_weather_service",e)},{value:"sensor",label:Es("wizard.steps.mapping.use_sensor",e)},{value:"static",label:Es("wizard.steps.mapping.use_static",e)},{value:Ye,label:Es("wizard.steps.mapping.use_none",e)}],a=(a,i,n)=>W`
      <si-field
    ...
    `;}};n([he({attribute:!1})],Sr.prototype,"hass",void 0),n([ge()],Sr.prototype,"_step",void 0),n([ge()],Sr.prototype,"_saving",void 0),n([ge()],Sr.prototype,"_error",void 0),n([ge()],Sr.prototype,"_confirmClose",void 0),n([ge()],Sr.prototype,"_siConfig",void 0),n([ge()],Sr.prototype,"_useWeather",void 0),n([ge()],Sr.prototype,"_weatherService",void 0),n([ge()],Sr.prototype,"_apiKey",void 0),n([ge()],Sr.prototype,"_testingApi",void 0),n([ge()],Sr.prototype,"_testResult",void 0),n([ge()],Sr.prototype,"_availableModules",void 0),n([ge()],Sr.prototype,"_selectedModuleIndex",void 0),n([ge()],Sr.prototype,"_moduleConfig",void 0),n([ge()],Sr.prototype,"_mappingName",void 0),n([ge()],Sr.prototype,"_tempSource",void 0),n([ge()],Sr.prototype,"_humiditySource",void 0),n([ge()],Sr.prototype,"_precipSource",void 0),n([ge()],Sr.prototype,"_zoneName",void 0),n([ge()],Sr.prototype,"_zoneSize",void 0),n([ge()],Sr.prototype,"_zoneThroughput",void 0),n([ge()],Sr.prototype,"_zoneEntity",void 0),Sr=n([ce("si-setup-wizard")],Sr);const xr=ir;var $r;!function(e){e.Zones="zones",e.Setup="setup";}($r||($r={})),e.SmartIrrigationPanel=class extends de{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100;}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate();}));}async firstUpdated(){const e=tr().page;Object.values($r).includes(e)||js(0,ar($r.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate());}),be().then(()=>{this._scheduleUpdate();}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate();});}render(){const e=tr(),t=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return W`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
    ...
    `;}getView(e){switch(e.page){case"zones":default:return W`
        ...
        `;case"setup":return W`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0;}}"
          ></smart-irrigation-view-setup>
        `;}}navigateToPage(e){if(e!==tr().page){const t=ar(e);js(0,t),this.requestUpdate();}else scrollTo(0,0);}handlePageSelected(e){const t=e.detail.name;if(t!==tr().page){const e=ar(t);js(0,e),this.requestUpdate();}else scrollTo(0,0);}static get styles(){return[xr,c`
        :host {
          color: var(--primary-text-color);
    ...
    `;}};n([he({attribute:!1})],Ar.prototype,"hass",void 0),n([ge()],Ar.prototype,"_params",void 0),Ar=n([ce("error-dialog")],Ar);var Mr=Object.freeze({__proto__:null,get ErrorDialog(){return Ar;}});Object.defineProperty(e,"__esModule",{value:!0});}({});

...
/**
    ...
    `:W``}_renderZoneSequencingCard(){var e,t;if(!this.hass||!this.config||!this.data)return W``;const i=(this.config.zone_sequencing||Pt)===Bt;return W`
      <ha-card
      ...
      >
        ...
        <div class="card-content">
          <div class="setting-row">
            ...
            <select
              class="settings-input"
              .value="${gs(this.config.zone_sequencing||Pt)}"
            ...
            >
              ...
              <option
                value="${It}"
                ?selected="${this.config.zone_sequencing===It}"
              >
                ...
                ${i?W`
                      <div class="setting-row">
                        ...
                        <input
                          ...
                          @input="${e=>{const t=parseFloat(e.target.value);isNaN(t)||this.handleConfigChange({[Zt]:t})}}"
                        />
                        <span class="unit-label">
    ...
    `}renderSimpleRadioOptions(e,t,i){if(!this.hass||!this.config)return W``;const a=t===Me||t===Pe,s=i[Ke];return W`
    ...
    `}handleSimpleSourceChange(e,t,i){const a=this.mappings[e],s=i.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},a),{mappings:Object.assign(Object.assign({},a.mappings),{[t]:Object.assign(Object.assign({},a.mappings[t]),{[Ke]:s,[Ve]:""})})}))}handleSimpleInputChange(e,t,i,a){const s=this.mappings[e],n=a.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[i]:n})})}))}renderMappingInputs(e,t,i){if(!this.hass)return W``;const a=i[Ke];return W`
      ...
      ${t!==Ie||a!==je&&a!==Fe?"":this.renderPressureTypeSelect(e,t,i)}
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return W`<option value="${e}" ?selected="${e===t}">
        ...
        </option>`,e}return W``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return W``;const i=function(e){switch(e){case Oe:case Be:return[{unit:"°C",system:He},{unit:"°F",system:Te}];case Le:case Me:return[{unit:at,system:He},{unit:st,system:Te}];case Ne:return[{unit:lt,system:He},{unit:ct,system:Te}];case De:return[{unit:"%",system:[He,Te]}];case Ie:return[{unit:"millibar",system:He},{unit:"hPa",system:He},{unit:"psi",system:Te},{unit:nt,system:Te}];case Re:return[{unit:"km/h",system:He},{unit:rt,system:He},{unit:ot,system:Te}];case Pe:return[{unit:"W/m2",system:He},{unit:"MJ/day/m2",system:He},{unit:"W/sq ft",system:Te},{unit:"MJ/day/sq ft",system:Te}];default:return[]}}(e);let a=t[Xe];const s=this.config.units;if(!t[Xe])for(const e of i)if("string"==typeof e.system){if(s===e.system){a=e.unit;break}}else{for(const t of e.system)if(s===t.system){a=e.unit;break}if(a===e.unit)break}return W`
      ${i.map(e=>W`
    ...
    `}};t([pe({attribute:!1})],Is.prototype,"hass",void 0),t([ge()],Is.prototype,"_params",void 0),Is=t([de("error-dialog")],Is);var Ps=Object.freeze({__proto__:null,get ErrorDialog(){return Is}})}({});

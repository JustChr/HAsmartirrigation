  ...
  const q = (e, t) => {
    ...
    for (let t = 0; t < a; t++) {
      ...
      let o,
        ...
        d = -1,
        u = 0;
      for (; u < a.length && (r.lastIndex = u, l = r.exec(a), null !== l);) u = r.lastIndex, r === P ? "!--" === l[1] ? r = H : void 0 !== l[1] ? r = L : void 0 !== l[2] ? (B.test(l[2]) && (n = RegExp("</" + l[2], "g")), r = I) : void 0 !== l[3] && (r = I) : r === I ? ">" === l[0] ? (r = null != n ? n : P, d = -1) : void 0 === l[1] ? d = -2 : (d = r.lastIndex - l[2].length, o = l[1], r = void 0 === l[3] ? I : '"' === l[3] ? R : U) : r === R || r === U ? r = I : r === H || r === L ? r = P : (r = I, n = void 0);
...
`;
  ...
  function Bn(e) {
    ...
    if ("E" === e[0] && "E" === e[1] ? (t = {
      ...
      var a = e.slice(0, 2);
      if ("+!" === a ? (t.signDisplay = "always", e = e.slice(2)) : "+?" === a && (t.signDisplay = "exceptZero", e = e.slice(2)), !In.test(e)) throw new Error("Malformed concise eng/scientific notation");
  ...
  function Fn(e) {
    for (var t = {}, a = 0, n = e; a < n.length; a++) {
      ...
      if (In.test(s.stem)) t.minimumIntegerDigits = s.stem.length;else if (Pn.test(s.stem)) {
  ...
  var Is = (Hs || (Hs = 1, function (e) {
      e.exports = function () {
        ...
        function W(e, t) {
          return e.isValid() ? (t = F(t, e.localeData()), L[t] = L[t] || B(t), L[t](e)) : e.localeData().invalidDate();
        }
        function F(e, t) {
          var a = 5;
          function i(e) {
        ...
        function ba(e) {
          var t,
            a = e._a;
          return a && -2 === f(e).overflow && (t = a[Le] < 0 || a[Le] > 11 ? Le : a[Ie] < 1 || a[Ie] > at(a[He], a[Le]) ? Ie : a[Ue] < 0 || a[Ue] > 24 || 24 === a[Ue] && (0 !== a[Re] || 0 !== a[Be] || 0 !== a[We]) ? Ue : a[Re] < 0 || a[Re] > 59 ? Re : a[Be] < 0 || a[Be] > 59 ? Be : a[We] < 0 || a[We] > 999 ? We : -1, f(e)._overflowDayOfYear && (t < He || t > Ie) && (t = Ie), f(e)._overflowWeeks && -1 === t && (t = Fe), f(e)._overflowWeekday && -1 === t && (t = Ye), f(e).overflow = t), e;
        }
        ...
        function La(e) {
          var t,
            ...
            r = [];
          if (!e._d) {
            for (i = Ha(e), e._w && null == e._a[Ie] && null == e._a[Le] && Ia(e), null != e._dayOfYear && (s = Pa(e._a[He], i[He]), (e._dayOfYear > Ze(s) || 0 === e._dayOfYear) && (f(e)._overflowDayOfYear = !0), a = bt(s, 0, e._dayOfYear), e._a[Le] = a.getUTCMonth(), e._a[Ie] = a.getUTCDate()), t = 0; t < 3 && null == e._a[t]; ++t) e._a[t] = r[t] = i[t];
          ...
          if (e._f !== i.ISO_8601) {
            if (e._f !== i.RFC_2822) {
              ...
              var t,
                ...
                u = d.length,
                c = 0;
              for (l = (n = F(e._f, e._locale).match(P) || []).length, t = 0; t < l; t++) s = n[t], (a = (d.match(Ae(s, e)) || [])[0]) && ((r = d.substr(0, d.indexOf(a))).length > 0 && f(e).unusedInput.push(r), d = d.slice(d.indexOf(a) + a.length), c += a.length), I[s] ? (a ? f(e).empty = !1 : f(e).unusedTokens.push(s), je(s, a, e)) : e._strict && !a && f(e).unusedTokens.push(s);
              f(e).charsLeftOver = u - c, d.length > 0 && f(e).unusedInput.push(d), e._a[Ue] <= 12 && !0 === f(e).bigHour && e._a[Ue] > 0 && (f(e).bigHour = void 0), f(e).parsedDateParts = e._a.slice(0), f(e).meridiem = e._meridiem, e._a[Ue] = Ra(e._locale, e._a[Ue], e._meridiem), null !== (o = f(e).era) && (e._a[He] = e._locale.erasConvertYear(o, e._a[He])), La(e), ba(e);
            } else Na(e);
          } else Ta(e);
        }
        function Ra(e, t, a) {
        ...
        function Za(e) {
          ...
          }), La(e)) : r(t) ? Wa(e) : u(t) ? e._d = new Date(t) : i.createFromInputFallback(e);
        }
        ...
        function Pi(e) {
          return z(e) || c(e) || ji(e) || u(e) || Li(e) || Hi(e) || null == e;
        }
        function Hi(e) {
          var t,
            a,
        ...
        hs.calendar = N, hs.longDateFormat = Z, hs.invalidDate = G, hs.ordinal = X, hs.preparse = cs, hs.postformat = cs, hs.relativeTime = Q, hs.pastFuture = ee, hs.set = M, hs.eras = Tn, hs.erasParse = En, hs.erasConvertYear = Mn, hs.erasAbbrRegex = Pn, hs.erasNameRegex = jn, hs.erasNarrowRegex = Hn, hs.months = lt, hs.monthsShort = dt, hs.monthsParse = ct, hs.monthsRegex = ft, hs.monthsShortRegex = mt, hs.week = $t, hs.firstDayOfYear = At, hs.firstDayOfWeek = xt, hs.weekdays = It, hs.weekdaysMin = Rt, hs.weekdaysShort = Ut, hs.weekdaysParse = Wt, hs.weekdaysRegex = Vt, hs.weekdaysShortRegex = Gt, hs.weekdaysMinRegex = qt, hs.isPM = ta, hs.meridiem = na, ga("en", {
          eras: [{
            since: "0001-01-01",
            until: 1 / 0,
            offset: 1,
  ...
  let Bs = class extends sa(de) {
    constructor() {
      super(...arguments), this.zones = [], this.modules = [], this.mappings = [], this.wateringCalendars = new Map(), this.weatherRecords = new Map(), this.isLoading = !0, this._initialLoadDone = !1, this.isSaving = !1, this._showAddZone = !1, this._operationError = null, this._confirmDeleteZoneId = null, this._newZoneName = "", this._newZoneSize = "", this._newZoneThroughput = "", this._updateScheduled = !1, this.globalDebounceTimer = null;
    }
    ...
    async _fetchData() {
      ...
      try {
        e && (this.isLoading = !0);
        const [t, a, i, n] = await Promise.all([Zt(this.hass), Vt(this.hass), qt(this.hass), Jt(this.hass)]);
        this.config = t, this.zones = a, this.modules = i, this.mappings = n, this._initialLoadDone = !0, this._fetchWateringCalendars(), this._fetchWeatherRecords();
      } catch (e) {
    ...
    render() {
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${Ns("common.labels.bulk_actions", this.hass.language)}
          </div>
        </div>
  ...
  let Ws = class extends sa(de) {
    constructor() {
      super(...arguments), this.isLoading = !0, this._initialLoadDone = !1, this.isSaving = !1, this._weatherConfig = null, this._weatherService = null, this._useWeatherService = !1, this._newApiKey = "", this._weatherSaving = !1, this._testingApi = !1, this._testResult = null, this._testResultTimer = null, this._updateScheduled = !1, this.debouncedSave = (() => {
        let e = null;
        return t => {
    ...
    async _fetchData() {
      ...
      try {
        const [t, n] = await Promise.all([Zt(this.hass), aa(this.hass)]);
        this.config = t, this._weatherConfig = n, this._useWeatherService = n.use_weather_service, this._weatherService = null !== (e = n.weather_service) && void 0 !== e ? e : Te, this.data = (a = this.config, i = ["calctime", "autocalcenabled", "autoupdateenabled", "autoupdateschedule", "autoupdatefirsttime", "autoupdateinterval", "autoclearenabled", "cleardatatime", "continuousupdates", "sensor_debounce", "manual_coordinates_enabled", "manual_latitude", "manual_longitude", "manual_elevation", "days_between_irrigation"], a ? Object.entries(a).filter(([e]) => i.includes(e)).reduce((e, [t, a]) => Object.assign(e, {
          [t]: a
    ...
    async saveData(e) {
      if (this.hass && this.data) {
        ...
        try {
          ...
          console.error("Error saving config:", e), It(e, this.shadowRoot.querySelector("ha-card")), await this._fetchData();
        } finally {
          this.isSaving = !1, this._scheduleUpdate();
        }
        var t, a;
  ...
  let Fs = class extends sa(de) {
    ...
    async _fetchData() {
      ...
      try {
        ...
        this.config = e, this.zones = t, this.modules = a, this.allmodules = i, this._initialLoadDone = !0, this.moduleCache.clear();
      } catch (e) {
        console.error("Error fetching data:", e);
      } finally {
        e && (this.isLoading = !1), this._scheduleUpdate();
  ...
  let Ys = class extends sa(de) {
    ...
    async _fetchData() {
      ...
      try {
        t && (this.isLoading = !0);
        const [e, a, i] = await Promise.all([Zt(this.hass), Vt(this.hass), Jt(this.hass)]);
        this.config = e, this.zones = a, this.mappings = i, this._initialLoadDone = !0, this._fetchWeatherRecords(), this.mappingCache.clear();
      } catch (t) {
        console.error("Error fetching data:", t), It({
          body: {
    ...
    renderAggregateOptionsForMapping(e, t) {
      if (!this.hass || !this.config) return W``;
      let a = "average";
      return e === He && (a = "delta"), e === Le && (a = "average"), t[et] && (a = t[et]), W`

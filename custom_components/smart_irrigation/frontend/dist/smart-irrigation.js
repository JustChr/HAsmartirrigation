!function(e){"use strict";var t=function(e,a){return t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t;}||function(e,t){for(var a in t)Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);},t(e,a);};function a(e,a){if("function"!=typeof a&&null!==a)throw new TypeError("Class extends value "+String(a)+" is not a constructor or null");function i(){this.constructor=e;}t(e,a),e.prototype=null===a?Object.create(a):(i.prototype=a.prototype,new i());}var i=function(){return i=Object.assign||function(e){for(var t,a=1,i=arguments.length;a<i;a++)for(var n in t=arguments[a])Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e;},i.apply(this,arguments);};function n(e,t,a,i){var n,s=arguments.length,r=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,a,i);else for(var o=e.length-1;o>=0;o--)(n=e[o])&&(r=(s<3?n(r):s>3?n(t,a,r):n(t,a))||r);return s>3&&r&&Object.defineProperty(t,a,r),r;}function s(e,t,a){if(a||2===arguments.length)for(var i,n=0,s=t.length;n<s;n++)!i&&n in t||(i||(i=Array.prototype.slice.call(t,0,n)),i[n]=t[n]);return e.concat(i||Array.prototype.slice.call(t));}"function"==typeof SuppressedError&&SuppressedError;/**
  ...
  `);}const Bt=(e,t,a=!1)=>{a?history.replaceState(null,"",t):history.pushState(null,"",t),ke(window,"location-changed",{replace:a});},Ut={},Rt=jt(class extends Ct{constructor(e){if(super(e),e.type!==Dt&&e.type!==Et&&e.type!==Ot)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression");}render(e){return e;}update(e,[t]){if(t===F||t===q)return t;const a=e.element,i=e.name;if(e.type===Dt){if(t===a[i])return F;}else if(e.type===Ot){if(!!t===a.hasAttribute(i))return F;}else if(e.type===Et&&a.getAttribute(i)===t+"")return F;return((e,t=Ut)=>{e._$AH=t;/**
     ...
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */var Wt="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z",Ft="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z";const qt=e=>e.callWS({type:Se+"/config"}),Vt=e=>e.callWS({type:Se+"/zones"}),Zt=(e,t)=>e.callApi("POST",Se+"/zones",t),Yt=e=>e.callWS({type:Se+"/modules"}),Gt=e=>e.callWS({type:Se+"/allmodules"}),Kt=(e,t)=>e.callApi("POST",Se+"/modules",t),Xt=e=>e.callWS({type:Se+"/mappings"}),Jt=(e,t)=>e.callApi("POST",Se+"/mappings",t),Qt=(e,t,a=10)=>e.callWS({type:Se+"/weather_records",mapping_id:t,limit:a}),ea=(e,t)=>e.callWS(Object.assign({type:Se+"/irrigate_now"},void 0!==t?{zone_id:t}:{})),ta=e=>e.callWS({type:Se+"/weather_config"}),aa=(e,t,a)=>e.callWS({type:Se+"/weather_config_test",weather_service:null!=t?t:null,api_key:null!=a?a:null}),ia=(e,t,a,i)=>e.callWS({type:Se+"/weather_config_save",use_weather_service:t,weather_service:null!=a?a:null,api_key:null!=i?i:null}),na=e=>{class t extends e{connectedCallback(){super.connectedCallback(),this.__checkSubscribed();}disconnectedCallback(){if(super.disconnectedCallback(),this.__unsubs){for(;this.__unsubs.length;){const e=this.__unsubs.pop();e instanceof Promise?e.then(e=>e()):e();}this.__unsubs=void 0;}}updated(e){super.updated(e),e.has("hass")&&this.__checkSubscribed();}hassSubscribe(){return[];}__checkSubscribed(){void 0===this.__unsubs&&this.isConnected&&void 0!==this.hass&&(this.__unsubs=this.hassSubscribe());}}return n([he({attribute:!1})],t.prototype,"hass",void 0),t;};var sa,ra;!function(e){e.Sunrise="sunrise",e.Sunset="sunset",e.SolarAzimuth="solar_azimuth";}(sa||(sa={})),function(e){e.Disabled="disabled",e.Manual="manual",e.Automatic="automatic";}(ra||(ra={}));const oa=c`
...
i.version="2.30.1",n(Ya),i.fn=ls,i.min=Ja,i.max=Qa,i.now=ei,i.utc=g,i.unix=ds,i.months=vs,i.isDate=c,i.locale=ga,i.invalid=_,i.duration=Ai,i.isMoment=z,i.weekdays=_s,i.parseZone=us,i.localeData=fa,i.isDuration=ri,i.monthsShort=fs,i.weekdaysMin=ys,i.defineLocale=ma,i.updateLocale=va,i.locales=_a,i.weekdaysShort=bs,i.normalizeUnits=ae,i.relativeTimeRounding=nr,i.relativeTimeThreshold=sr,i.calendarFormat=Bi,i.prototype=ls,i.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},i;}();}(nr)),nr.exports),rr=tr(sr);let or=class extends de{constructor(){super(...arguments),this.label="",this.unit="",this.help="",this.required=!1,this._helpOpen=!1;}_toggleHelp(){this._helpOpen=!this._helpOpen;}render(){return W`
        ...
        ${0===t.length?W`
            ...
            `:W`
              <div class="weather-table">
                ...
                ${t.map(e=>{const t=e=>{try{const t=rr(e);return t.isValid()?t.format("MM-DD HH:mm"):"-";}catch(e){return"-";}},a=(e,t,a=1)=>null!=e?e.toFixed(a)+t:"-";return W`
    ...
    `;}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await Zt(this.hass,e);}_renderModuleOptions(e){if(!this.hass)return W``;const t=null!=e?String(e):"";return W`
    ...
    `;}_renderMappingOptions(e){if(!this.hass)return W``;const t=null!=e?String(e):"";return W`
      ...
      ${this.mappings.map(e=>W`
        ...
        `)}
    `;}renderZone(e,t){var a,i,n,s,r,o,l,d,u;if(!this.hass)return W``;const c=Number(null!==(a=e.bucket)&&void 0!==a?a:0),p=c<0?"var(--warning-color)":"var(--success-color)",h=e.state===ra.Automatic?"state-automatic":e.state===ra.Manual?"state-manual":"state-disabled";return W`
      <ha-card>
          ...
          <div class="zone-status-grid">
            <div class="status-item">
              <span class="status-label"
                >${er("panels.zones.labels.bucket",this.hass.language)}</span
              >
            ...
            <div class="status-item">
              <span class="status-label"
                >${er("panels.zones.labels.duration",this.hass.language)}</span
              >
            ...
            <div class="status-item">
              <span class="status-label"
                >${er("panels.zones.labels.last_calculated",this.hass.language)}</span
              >
              <span class="status-value">
                ${e.last_calculated?rr(e.last_calculated).format("YYYY-MM-DD HH:mm"):"–"}
              </span>
            </div>
            <div class="status-item">
              <span class="status-label"
                >${er("panels.zones.labels.data-number-of-data-points",this.hass.language)}</span
              >
              <span class="status-value"
        ...
        <div class="card-content zone-action-bar">
          ...
          ${e.linked_entity&&(null!==(s=e.duration)&&void 0!==s?s:0)>0?W`
                <button
                  class="action-btn"
                  raised
                  @click="${()=>{this.hass&&ea(this.hass,void 0!==e.id?e.id.toString():void 0).catch(e=>console.error("irrigate_now failed",e));}}"
                  ?disabled="${this.isSaving}"
                >
      ...
      <ha-card>
        ...
        <div class="card-content zones-top-actions">
          <button
            class="action-btn"
            raised
            @click="${()=>{this.hass&&ea(this.hass).catch(e=>console.error("irrigate_now failed",e));}}"
    ...
    `;}};n([he()],lr.prototype,"config",void 0),n([he({type:Array})],lr.prototype,"zones",void 0),n([he({type:Array})],lr.prototype,"modules",void 0),n([he({type:Array})],lr.prototype,"mappings",void 0),n([he({type:Map})],lr.prototype,"wateringCalendars",void 0),n([he({type:Map})],lr.prototype,"weatherRecords",void 0),n([he({type:Boolean})],lr.prototype,"isLoading",void 0),n([he({type:Boolean})],lr.prototype,"isSaving",void 0),n([he({type:Boolean})],lr.prototype,"_showAddZone",void 0),n([ge()],lr.prototype,"_operationError",void 0),n([he()],lr.prototype,"_confirmDeleteZoneId",void 0),n([he()],lr.prototype,"_newZoneName",void 0),n([he()],lr.prototype,"_newZoneSize",void 0),n([he()],lr.prototype,"_newZoneThroughput",void 0),lr=n([ce("smart-irrigation-view-zones")],lr);let dr=class extends na(de){constructor(){super(...arguments),this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._weatherConfig=null,this._weatherService=null,this._useWeatherService=!1,this._newApiKey="",this._weatherSaving=!1,this._testingApi=!1,this._testResult=null,this._testResultTimer=null,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout(()=>{this.saveData(t),e=null;},500);};})();}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate();}));}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e);}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e);});},{type:Se+"_config_updated"})];}async _fetchData(){var e;if(!this.hass)return;const t=!this._initialLoadDone;t&&(this.isLoading=!0,this._scheduleUpdate());try{const[t,n]=await Promise.all([qt(this.hass),ta(this.hass)]);this.config=t,this._weatherConfig=n,this._useWeatherService=n.use_weather_service,this._weatherService=null!==(e=n.weather_service)&&void 0!==e?e:Me,this.data=(a=this.config,i=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime","continuousupdates","sensor_debounce","manual_coordinates_enabled","manual_latitude","manual_longitude","manual_elevation","days_between_irrigation"],a?Object.entries(a).filter(([e])=>i.includes(e)).reduce((e,[t,a])=>Object.assign(e,{[t]:a}),{}):{}),this._initialLoadDone=!0;}catch(e){console.error("Error fetching data:",e);}finally{t&&(this.isLoading=!1),this._scheduleUpdate();}var a,i;}firstUpdated(){be().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate();});}render(){var e,t;return this.hass&&this.config&&this.data?this.isLoading?W`<div class="loading-indicator">
        ${er("common.loading-messages.general",this.hass.language)}
      </div>`:W`
          ...
          ${this.data.autoupdateenabled?W`
                <div class="setting-row">
                  ...
                  <div class="inline-row">
                    ...
                    <select
                      class="settings-input"
                      .value="${Rt(this.data.autoupdateschedule||Te)}"
    ...
    `;}};n([he()],dr.prototype,"narrow",void 0),n([he()],dr.prototype,"path",void 0),n([he()],dr.prototype,"data",void 0),n([he()],dr.prototype,"config",void 0),n([he({type:Boolean})],dr.prototype,"isLoading",void 0),n([he({type:Boolean})],dr.prototype,"isSaving",void 0),n([he()],dr.prototype,"_weatherConfig",void 0),n([he()],dr.prototype,"_weatherService",void 0),n([he({type:Boolean})],dr.prototype,"_useWeatherService",void 0),n([he()],dr.prototype,"_newApiKey",void 0),n([he({type:Boolean})],dr.prototype,"_weatherSaving",void 0),n([ge()],dr.prototype,"_testingApi",void 0),n([ge()],dr.prototype,"_testResult",void 0),dr=n([ce("smart-irrigation-view-general")],dr);let ur=class extends na(de){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.moduleCache=new Map(),this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout(()=>{this.saveToHA(t),e=null;},500);};})();}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate();}));}firstUpdated(){be().catch(e=>{console.error("Failed to load HA form:",e);});}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e);}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e);});},{type:Se+"_config_updated"})];}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;e&&(this.isLoading=!0,this._scheduleUpdate());try{const[e,t,a,i]=await Promise.all([qt(this.hass),Vt(this.hass),Yt(this.hass),Gt(this.hass)]);this.config=e,this.zones=t,this.modules=a,this.allmodules=i,this._initialLoadDone=!0,this.moduleCache.clear();}catch(e){console.error("Error fetching data:",e);}finally{e&&(this.isLoading=!1),this._scheduleUpdate();}}async handleAddModule(){var e,t;if((null===(t=null===(e=this.moduleInput)||void 0===e?void 0:e.selectedOptions)||void 0===t?void 0:t[0])&&!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.moduleInput.selectedOptions[0].text,t=this.allmodules.find(t=>t.name===e);if(!t)return;const a={name:e,description:t.description,config:t.config,schema:t.schema};this.modules=[...this.modules,a],this.moduleCache.clear(),this._scheduleUpdate(),await this.saveToHA(a),await this._fetchData();}catch(e){console.error("Error adding module:",e),await this._fetchData();}finally{this.isSaving=!1,this._scheduleUpdate();}}}async handleRemoveModule(e,t){if(!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.modules[t],n=null==e?void 0:e.id;this.modules;this.modules=this.modules.filter((e,a)=>a!==t),this.moduleCache.clear(),this._scheduleUpdate(),this.hass&&void 0!==n&&(await(a=this.hass,i=n.toString(),a.callApi("POST",Se+"/modules",{id:i,remove:!0})));}catch(e){console.error("Error removing module:",e),await this._fetchData();}finally{this.isSaving=!1,this._scheduleUpdate();}var a,i;}}async saveToHA(e){if(this.hass)try{await Kt(this.hass,e);}catch(e){throw console.error("Error saving module:",e),e;}}renderModule(e,t){if(!this.hass)return W``;const a=`module-${e.id||t}-${JSON.stringify(e)}`;if(this.moduleCache.has(a))return this.moduleCache.get(a);const i=this.zones.filter(t=>t.module===e.id).length,n=W`
    ...
    `;if("boolean"==i.type)o=W`${o}<input
        ...
        >
          ${Object.entries(i.options).map(([e,a])=>W`<option
                ...
                ?selected="${r===Ht(a,0)}"
              >
                ${er("panels.modules.cards.module.translated-options."+Ht(a,1),t)}
              </option>`)}
    ...
    `;}};n([he()],ur.prototype,"config",void 0),n([he({type:Array})],ur.prototype,"zones",void 0),n([he({type:Array})],ur.prototype,"modules",void 0),n([he({type:Array})],ur.prototype,"allmodules",void 0),n([he({type:Boolean})],ur.prototype,"isLoading",void 0),n([he({type:Boolean})],ur.prototype,"isSaving",void 0),n([me("#moduleInput")],ur.prototype,"moduleInput",void 0),ur=n([ce("smart-irrigation-view-modules")],ur);let cr=class extends na(de){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.weatherRecords=new Map(),this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this.debounceTimers=new Map(),this.globalDebounceTimer=null,this.mappingCache=new Map(),this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16;}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate();},this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate();}));}firstUpdated(){be().catch(e=>{console.error("Failed to load HA form:",e);});}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e);}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e);});},{type:Se+"_config_updated"})];}async _fetchData(){var e;if(!this.hass)return;const t=!this._initialLoadDone;try{t&&(this.isLoading=!0);const[e,a,i]=await Promise.all([qt(this.hass),Vt(this.hass),Xt(this.hass)]);this.config=e,this.zones=a,this.mappings=i,this._initialLoadDone=!0,this._fetchWeatherRecords(),this.mappingCache.clear();}catch(t){console.error("Error fetching data:",t),Lt({body:{message:"Failed to load mapping data"},error:"Data fetch error"},null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-card"));}finally{t&&(this.isLoading=!1),this._scheduleUpdate();}}async _fetchWeatherRecords(){if(this.hass){for(const e of this.mappings)if(void 0!==e.id)try{const t=await Qt(this.hass,e.id.toString(),0);this.weatherRecords.set(e.id,t);}catch(t){console.error(`Failed to fetch weather records for mapping ${e.id}:`,t),this.weatherRecords.set(e.id,[]);}this._scheduleUpdate();}}renderWeatherRecords(e){if(!this.hass)return W``;const t=void 0!==e.id&&this.weatherRecords.get(e.id)||[];return W`
    ...
    `;}renderAggregateOption(e,t){if(this.hass&&this.config){return W`<option value="${e}" ?selected="${e===t}">
        ...
        <option
          ...
          ?selected="${a===Ze}"
        >
          ${er("panels.mappings.cards.mapping.pressure_types."+Ze,this.hass.language)}
        </option>
        <option
          value="${Ye}"
          ?selected="${a===Ye}"
        >
          ${er("panels.mappings.cards.mapping.pressure_types."+Ye,this.hass.language)}
        </option>`,e;}return W``;}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return W``;const a=function(e){switch(e){case Ce:case Ue:return[{unit:"°C",system:je},{unit:"°F",system:Oe}];case He:case Pe:return[{unit:"mm",system:je},{unit:"in",system:Oe}];case Ie:return[{unit:st,system:je},{unit:rt,system:Oe}];case Ne:return[{unit:"%",system:[je,Oe]}];case Le:return[{unit:"millibar",system:je},{unit:"hPa",system:je},{unit:"psi",system:Oe},{unit:"inch Hg",system:Oe}];case Re:return[{unit:"km/h",system:je},{unit:"meter/s",system:je},{unit:"mile/h",system:Oe}];case Be:return[{unit:"W/m2",system:je},{unit:"MJ/day/m2",system:je},{unit:"W/sq ft",system:Oe},{unit:"MJ/day/sq ft",system:Oe}];default:return[];}}(e);let i=t[Qe];const n=this.config.units;if(!t[Qe])for(const e of a)if("string"==typeof e.system){if(n===e.system){i=e.unit;break;}}else{for(const t of e.system)if(n===t.system){i=e.unit;break;}if(i===e.unit)break;}return W`
      ${a.map(e=>W`
    ...
    `;}_renderTypeFields(){var e;const t=this._editingSchedule;switch(t.type){case"daily":return W`
      ...
      <div class="field-row">
        <label
          >${er("panels.schedules.fields.account_for_duration",this.hass.language)}</label
        >
        <input
          type="checkbox"
    ...
    `;}render(){return this.hass?this._isLoading?W`
      ...
      ${0===this._schedules.length?W`
          ...
          `:this._schedules.map(e=>W`
            ...
            `)}
    `:W``;}static get styles(){return[oa,c`
        .dialog-content {
          display: flex;
          flex-direction: column;
          gap: 14px;
      ...
      `];}};var gr;n([he({attribute:!1})],hr.prototype,"hass",void 0),n([ge()],hr.prototype,"_schedules",void 0),n([ge()],hr.prototype,"_zones",void 0),n([ge()],hr.prototype,"_isLoading",void 0),n([ge()],hr.prototype,"_showDialog",void 0),n([ge()],hr.prototype,"_editingSchedule",void 0),n([ge()],hr.prototype,"_editingId",void 0),hr=n([ce("smart-irrigation-view-schedules")],hr),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done";}(gr||(gr={}));let mr=class extends de{constructor(){super(...arguments),this._step=gr.Welcome,this._saving=!1,this._error="",this._siConfig=null,this._useWeather=!1,this._weatherService=Me,this._apiKey="",this._testingApi=!1,this._testResult=null,this._testResultTimer=null,this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=We,this._humiditySource=We,this._precipSource=We,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="";}async connectedCallback(){super.connectedCallback(),await this._loadInitialData();}async _loadInitialData(){var e;if(this.hass){try{const[t,a,i]=await Promise.all([Gt(this.hass),ta(this.hass),qt(this.hass)]);this._availableModules=t,this._weatherConfig=a,this._siConfig=i,this._useWeather=a.use_weather_service,this._weatherService=null!==(e=a.weather_service)&&void 0!==e?e:Me;}catch(e){console.error("Wizard: failed to load initial data",e);}this.requestUpdate();}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}));}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}));}async _next(){this._error="";try{switch(this._saving=!0,this._step){case gr.Welcome:this._step=gr.Weather;break;case gr.Weather:await this._saveWeather(),this._step=gr.Module;break;case gr.Module:await this._saveModule(),this._step=gr.Mapping;break;case gr.Mapping:await this._saveMapping(),this._step=gr.Zone;break;case gr.Zone:await this._saveZone(),this._step=gr.Done;break;case gr.Done:this._close();}}catch(e){this._error=e instanceof Error?e.message:String(e);}finally{this._saving=!1,this.requestUpdate();}}_back(){this._step>gr.Welcome&&(this._step=this._step-1,this._error="");}_skipStep(){this._step<gr.Done&&(this._step=this._step+1,this._error="");}async _saveWeather(){await ia(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null);}async _saveModule(){if(0===this._availableModules.length)return;const e=this._availableModules[this._selectedModuleIndex],t=await Kt(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});this._savedModuleId="object"==typeof t&&(null==t?void 0:t.id)?t.id:void 0;}async _saveMapping(){const e=this._useWeather?We:Ge,t={[Ue]:{[Ke]:this._tempSource},[Ne]:{[Ke]:this._humiditySource},[He]:{[Ke]:this._precipSource}},a=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const i of a)t[i]={[Ke]:e};const i=await Jt(this.hass,{name:this._mappingName,mappings:t});this._savedMappingId="object"==typeof i&&(null==i?void 0:i.id)?i.id:void 0;}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");await Zt(this.hass,{name:this._zoneName.trim(),size:parseFloat(this._zoneSize)||0,throughput:parseFloat(this._zoneThroughput)||0,state:ra.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0});}async _testApiKey(){if(this.hass&&!this._testingApi){this._testingApi=!0,this._testResult=null,this._testResultTimer&&clearTimeout(this._testResultTimer),this.requestUpdate();try{const e=await aa(this.hass,this._weatherService,this._apiKey||null);this._testResult=e,this._testResultTimer=window.setTimeout(()=>{this._testResult=null,this.requestUpdate();},12e3);}catch(e){this._testResult={success:!1,error:"unknown"};}finally{this._testingApi=!1,this.requestUpdate();}}}render(){var e,t;const a=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return W`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          ...
          ${this._step!==gr.Welcome&&this._step!==gr.Done?W`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `;}_onOverlayClick(e){e.target===e.currentTarget&&this._close();}_renderStepper(){const e=["Weather","Module","Sensor Group","Zone"];return W`
      ${e.map((t,a)=>{const i=a+1,n=this._step===i,s=this._step>i;return W`
        ...
        `;})}
    `;}_renderStep(e){switch(this._step){case gr.Welcome:return this._renderWelcome(e);case gr.Weather:return this._renderWeather(e);case gr.Module:return this._renderModule(e);case gr.Mapping:return this._renderMapping(e);case gr.Zone:return this._renderZone(e);case gr.Done:return this._renderDone(e);default:return W``;}}_renderFooter(e){return this._step===gr.Done?W``:W`
      <div class="footer-left">
        ${this._step>gr.Welcome?W`<button
        ...
        ${this._step>gr.Welcome&&this._step<gr.Done?W`<button
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?er("common.saving-messages.saving",e):this._step===gr.Welcome||this._step<gr.Zone?er("wizard.next",e):er("wizard.finish",e)}
      </button>
                  ...
                  >
                    ...
                    ${null!==this._testResult?W`
                          <div
                            class="test-result ${this._testResult.success?"success":"error"}"
                          >
                            ${this._testResult.success?er("weather_service_config.test_success",e):er("weather_service_config.test_error_"+(null!==(s=this._testResult.error)&&void 0!==s?s:"unknown"),e)}
                          </div>
                        `:""}
                  </si-field>
                `:W`
    ...
    `;}_renderMapping(e){const t=[{value:We,label:er("wizard.steps.mapping.use_weather_service",e)},{value:"sensor",label:er("wizard.steps.mapping.use_sensor",e)},{value:"static",label:er("wizard.steps.mapping.use_static",e)},{value:Ge,label:er("wizard.steps.mapping.use_none",e)}],a=(a,i,n)=>W`
      <si-field
    ...
    `;}};n([he({attribute:!1})],mr.prototype,"hass",void 0),n([ge()],mr.prototype,"_step",void 0),n([ge()],mr.prototype,"_saving",void 0),n([ge()],mr.prototype,"_error",void 0),n([ge()],mr.prototype,"_siConfig",void 0),n([ge()],mr.prototype,"_useWeather",void 0),n([ge()],mr.prototype,"_weatherService",void 0),n([ge()],mr.prototype,"_apiKey",void 0),n([ge()],mr.prototype,"_testingApi",void 0),n([ge()],mr.prototype,"_testResult",void 0),n([ge()],mr.prototype,"_availableModules",void 0),n([ge()],mr.prototype,"_selectedModuleIndex",void 0),n([ge()],mr.prototype,"_moduleConfig",void 0),n([ge()],mr.prototype,"_mappingName",void 0),n([ge()],mr.prototype,"_tempSource",void 0),n([ge()],mr.prototype,"_humiditySource",void 0),n([ge()],mr.prototype,"_precipSource",void 0),n([ge()],mr.prototype,"_zoneName",void 0),n([ge()],mr.prototype,"_zoneSize",void 0),n([ge()],mr.prototype,"_zoneThroughput",void 0),n([ge()],mr.prototype,"_zoneEntity",void 0),mr=n([ce("si-setup-wizard")],mr);var vr;!function(e){e.General="general",e.Modules="modules",e.Mappings="mappings",e.Schedules="schedules",e.Help="help";}(vr||(vr={}));const fr={[vr.General]:"panels.general.title",[vr.Modules]:"panels.modules.title",[vr.Mappings]:"panels.mappings.title",[vr.Schedules]:"panels.schedules.title",[vr.Help]:"panels.help.title"};let _r=class extends de{constructor(){super(...arguments),this._activeTab=vr.General,this._wizardOpen=!1;}_openWizard(){this._wizardOpen=!0;}_onWizardClose(){this._wizardOpen=!1;}_onWizardNavigate(e){const{page:t}=e.detail;this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:t},bubbles:!0,composed:!0})),this._wizardOpen=!1;}render(){return this.hass?W`
      ${this._wizardOpen?W`
            <si-setup-wizard
              .hass="${this.hass}"
    ...
    `:W``;}_renderContent(){if(!this.hass)return W``;switch(this._activeTab){case vr.General:return W`<smart-irrigation-view-general
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-general>`;case vr.Modules:return W`<smart-irrigation-view-modules
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-modules>`;case vr.Mappings:return W`<smart-irrigation-view-mappings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-mappings>`;case vr.Schedules:return W`<smart-irrigation-view-schedules
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-schedules>`;case vr.Help:return this._renderHelp();}}_renderHelp(){return this.hass?W`
      <ha-card
    ...
    `;}};n([he({attribute:!1})],_r.prototype,"hass",void 0),n([he({type:Boolean})],_r.prototype,"narrow",void 0),n([he()],_r.prototype,"_activeTab",void 0),n([ge()],_r.prototype,"_wizardOpen",void 0),_r=n([ce("smart-irrigation-view-setup")],_r);const br=oa,yr=()=>{const e=e=>{let t={};for(let a=0;a<e.length;a+=2){const i=e[a],n=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:n});}return t;},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex(e=>"filter"==e),n=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(n)});}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})));}return a;},wr=(e,...t)=>{let a={page:e,params:{}};t.forEach(e=>{"string"==typeof e?a=Object.assign(Object.assign({},a),{subpage:e}):"params"in e?a=Object.assign(Object.assign({},a),{params:e.params}):"filter"in e&&(a=Object.assign(Object.assign({},a),{filter:e.filter}));});const i=e=>{let t=Object.keys(e);t=t.filter(t=>e[t]),t.sort();let a="";return t.forEach(t=>{const i=e[t];a=a.length?`${a}/${t}/${i}`:`${t}/${i}`;}),a;};let n=`/${Se}/${a.page}`;return a.subpage&&(n=`${n}/${a.subpage}`),i(a.params).length&&(n=`${n}/${i(a.params)}`),a.filter&&(n=`${n}/filter/${i(a.filter)}`),n;};var kr;!function(e){e.Zones="zones",e.Setup="setup";}(kr||(kr={})),e.SmartIrrigationPanel=class extends de{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100;}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate();}));}async firstUpdated(){Bt(0,wr(kr.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate());}),be().then(()=>{this._scheduleUpdate();}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate();});}render(){const e=yr(),t=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return W`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
    ...
    `;}getView(e){switch(e.page){case"zones":default:return W`
        ...
        `;case"setup":return W`
          ...
          ></smart-irrigation-view-setup>
        `;}}navigateToPage(e){if(e!==yr().page){const t=wr(e);Bt(0,t),this.requestUpdate();}else scrollTo(0,0);}handlePageSelected(e){const t=e.detail.name;if(t!==yr().page){const e=wr(t);Bt(0,e),this.requestUpdate();}else scrollTo(0,0);}static get styles(){return[br,c`
        :host {
          color: var(--primary-text-color);
    ...
    `;}};n([he({attribute:!1})],zr.prototype,"hass",void 0),n([ge()],zr.prototype,"_params",void 0),zr=n([ce("error-dialog")],zr);var Sr=Object.freeze({__proto__:null,get ErrorDialog(){return zr;}});Object.defineProperty(e,"__esModule",{value:!0});}({});

...
`;const Ga=e=>String(e).padStart(2,"0");function Ka(e){return e instanceof Date?e:new Date(e)}function Va(e){const t=Ka(e);return`${Ga(t.getHours())}:${Ga(t.getMinutes())}`}function Ya(e){const t=Ka(e);return`${t.getFullYear()}-${Ga(t.getMonth()+1)}-${Ga(t.getDate())} ${Ga(t.getHours())}:${Ga(t.getMinutes())}`}function Xa(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class Ja extends(Ua(le)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){Zi().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const i=Object.keys(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).length>0;i&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):i||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[i,s,a,n]=await Promise.all([Si(this.hass),Ci(this.hass),(t=this.hass,t.callWS({type:_e+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),Li(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=i,this.zones=s,this._outlook=a,this._distributors=n,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),Pa(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),Pa(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),Pa(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const i="all"===t,s=i?void 0:this.zones.find(e=>{var i;return(null===(i=e.id)||void 0===i?void 0:i.toString())===t}),a=i?`(${this._linkedZoneCount})`:`: ${null!==(e=null==s?void 0:s.name)&&void 0!==e?e:t}`;try{await(n=this.hass,o=i?void 0:t,n.callWS(Object.assign({type:_e+"/irrigate_now"},void 0!==o?{zone_id:o}:{}))),La(this,`${Ea("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${a}`)}catch(e){const t=Ia(e);console.error("irrigate_now failed",e),La(this,`${Ea("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var n,o}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const i=new Date(t);return i.getTime()>Date.now()?i:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:_e+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),Pa(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:_e+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),Pa(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,i;const s=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(i=this._runMinutes[s])&&void 0!==i?i:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const i=this._zoneDistributor(e);return!!i&&Object.keys(null!==(t=i.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var i,s,a;if(t>0)try{await(i=this.hass,s=e.id.toString(),a=t,i.callWS({type:_e+"/run_zone",zone_id:s,duration:a})),La(this,`${Ea("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=Ia(e);console.error("run_zone failed",e),La(this,`${Ea("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===i?void 0:i[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,i;if(this.hass&&void 0!==e.id)try{await(t=this.hass,i=e.id.toString(),t.callWS({type:_e+"/stop_zone",zone_id:i})),La(this,`${Ea("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=Ia(e);console.error("stop_zone failed",e),La(this,`${Ea("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var i,s;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,s=t.id.toString(),i.callApi("POST",_e+"/zones",{id:s,calculate:!0,override_cache:!0})).catch(e=>{const t=Ia(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var i,s;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,s=t.id.toString(),i.callApi("POST",_e+"/zones",{id:s,update:!0})).catch(e=>{const t=Ia(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;Ma(0,t?Wa("setup","zones",t):Wa("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,i,s;const a=null!==(t=e.duration)&&void 0!==t?t:0,n=Number(null!==(i=e.bucket_threshold)&&void 0!==i?i:0),o=this._zoneEstimate(e),r=o&&o.available&&null!=o.live_deficit?o.live_deficit:Number(null!==(s=e.bucket)&&void 0!==s?s:0);return a>0&&r<n}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,i=new Date(e),s=Va(i),a=new Date;return Xa(i,a)?`${Ea("panels.zones.outlook.today",t)} ${s}`:Xa(i,function(e,t){const i=new Date(e.getTime());return i.setDate(i.getDate()+t),i}(a,1))?`${Ea("panels.zones.outlook.tomorrow",t)} ${s}`:function(e,t){const i=Ka(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(i)} ${Va(i)}`}(i,t)}_renderEstimatedTag(e){if(!this.hass||!e.estimated)return Z``;const t=this.hass.language;return Z`<span
    ...
    `}_zoneEstimate(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_estimates)||void 0===i?void 0:i[String(e.id)]}_zoneFault(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_faults)||void 0===i?void 0:i[String(e.id)]}_renderZoneFault(e){if(!this.hass)return Z``;const t=this._zoneFault(e);if(!t)return Z``;const i=this.hass.language,s=Ea(`panels.zones.fault.${t.reason}`,i)||Ea("panels.zones.fault.generic",i),a=t.timestamp?Ya(t.timestamp):"";return Z`
    ...
    `}_zoneSkip(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_skips)||void 0===i?void 0:i[String(e.id)]}_renderZoneSkip(e){if(!this.hass)return Z``;const t=this._zoneSkip(e);if(!t)return Z``;const i=this.hass.language,s=Ea("panels.zones.skip.soil_moisture",i,"{observed}",String(t.observed),"{threshold}",String(t.threshold)),a=t.timestamp?Ya(t.timestamp):"";return Z`
    ...
    `}_renderZoneEstimate(e){if(!this.hass)return Z``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return Z``;const i=this.hass.language,s=Da(this.config,_t),a=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",n=Ea(`panels.zones.status.estimate_method.${"proxy"===t.method||"hourly_sensor"===t.method?t.method:"hourly"}`,i)+(t.as_of?` · ${Va(t.as_of)}`:"");return Z`
    ...
    `}_renderZoneNextRun(e){if(!this.hass)return Z``;const t=this._nextIrrigateRunForZone(e);if(!t||!t.next_run_utc)return Z``;return e.state!==Fa.Disabled&&e.last_calculated&&this._zoneHasDeficit(e)&&0===this._triggeredGuards.length?Z``:Z`
      <span class="status-sep">·</span>
      <span>
    ...
    `}renderZone(e,t){var i;if(!this.hass)return Z``;const s=Number(null!==(i=e.bucket)&&void 0!==i?i:0),a=s<0?"var(--warning-color)":"var(--success-color)",n=e.state===Fa.Automatic?"state-automatic":e.state===Fa.Manual?"state-manual":"state-disabled",o=e.last_calculated?Ya(e.last_calculated):Ea("panels.zones.status.never",this.hass.language);return Z`
      <ha-card>
        ...
        <div class="card-content zone-action-bar">
          ${"full"===this.actionsMode&&e.state===Fa.Automatic?Z`
                <button
                  class="action-btn"
...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */;const Qa={},en=Vi(class extends Yi{constructor(e){if(super(e),e.type!==Gi&&e.type!==Wi&&e.type!==Ki)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===W||t===q)return t;const i=e.element,s=e.name;if(e.type===Gi){if(t===i[s])return W}else if(e.type===Ki){if(!!t===i.hasAttribute(s))return W}else if(e.type===Wi&&i.getAttribute(s)===t+"")return W;return((e,t=Qa)=>{e._$AH=t;
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */})(e),t}});let tn=class extends le{constructor(){super(...arguments),this.label="",this.unit="",this.help="",this.required=!1,this._helpOpen=!1}_toggleHelp(){this._helpOpen=!this._helpOpen}render(){return Z`
      <div class="si-field">
    ...
    `:Z``}async _saveWeatherConfig(){if(this.hass){this._weatherSaving=!0,this._scheduleUpdate();try{await Ri(this.hass,this._useWeatherService,this._useWeatherService?this._weatherService:null,this._newApiKey||null),this._newApiKey="",await this._fetchData()}catch(e){console.error("Failed to save weather config:",e),Pa(this,this.hass,"common.errors.save_failed",e)}finally{this._weatherSaving=!1,this._scheduleUpdate()}}}_renderWeatherServiceCard(){var e;return this.hass?Z`
      <ha-card
    ...
    `:Z``}_renderZoneSequencingCard(){var e,t;if(!this.hass||!this.config||!this.data)return Z``;const i=(this.config.zone_sequencing||Ft)===Zt;return Z`
      <ha-card
    ...
    `}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await Ei(this.hass,e)}_renderModuleOptions(e){if(!this.hass)return Z``;const t=null!=e?String(e):"";return Z`
             ...
             used to sit alongside it moved to the Weather & Location tab). -->
              <div class="card-content zone-settings">
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${en(null!==(s=Object.keys(Rt).find(t=>Rt[t]===e.drainage_rate))&&void 0!==s?s:"custom")}"
                    @change="${i=>{const s=i.target.value;"custom"!==s&&void 0!==Rt[s]&&this.handleEditZone(t,Object.assign(Object.assign({},e),{[xt]:Rt[s]}))}}"
                  >
                    <option
                      value="custom"
                ...
                <ha-settings-row>
                  ...
                  <select
                    ...
                    @change="${i=>{const s=i.target.value,a={[zt]:s};"custom"!==s&&void 0!==Bt[s]&&(a.kc=Bt[s]),this.handleEditZone(t,Object.assign(Object.assign({},e),a))}}"
                  >
                    <option
                      value="custom"
                      ...
                      ${"service"===e.watering_mode?Z`
                            ...
                            <ha-settings-row>
                              ...
                              <input
                                ...
                                @input="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Dt]:i.target.value||void 0}))}"
                              />
                            </ha-settings-row>
                            <ha-settings-row>
                              <span slot="heading"
                ...
                <ha-settings-row>
                  ...
                  <input
                    ...
                    @input="${i=>{const s=i.target.value,a=""===s?null:Number(s);this.handleEditZone(t,Object.assign(Object.assign({},e),{[Pt]:null===a||isNaN(a)?null:a}))}}"
                  />
                </ha-settings-row>
    ...
    `}_renderRunLogRow(e,t){const i=this.hass.language,s=Ea(`panels.zones.history.results.${e.result}`,i);let a="";return e.detail&&(a="skipped"===e.result?e.detail.split(",").map(e=>Ea(`panels.zones.outlook.checks.${e}`,i)||e).join(", "):Ea(`panels.zones.fault.${e.detail}`,i)||e.detail),Z`
      <tr>
        <td>${Ya(e.ts)}</td>
        <td>
    ...
    `}};t([pe()],cn.prototype,"config",void 0),t([pe({attribute:!1})],cn.prototype,"path",void 0),t([pe({type:Array})],cn.prototype,"zones",void 0),t([pe({type:Array})],cn.prototype,"modules",void 0),t([pe({type:Array})],cn.prototype,"mappings",void 0),t([pe({type:Array})],cn.prototype,"distributors",void 0),t([pe({type:Boolean})],cn.prototype,"isLoading",void 0),t([ge()],cn.prototype,"_expanded",void 0),t([pe({type:Boolean})],cn.prototype,"isSaving",void 0),t([pe({type:Boolean})],cn.prototype,"_showAddZone",void 0),t([ge()],cn.prototype,"_pendingConfirm",void 0),t([ge()],cn.prototype,"_saveStatus",void 0),t([pe()],cn.prototype,"_confirmDeleteZoneId",void 0),t([pe()],cn.prototype,"_newZoneName",void 0),t([pe()],cn.prototype,"_newZoneSize",void 0),t([pe()],cn.prototype,"_newZoneThroughput",void 0),t([pe()],cn.prototype,"_newZoneEntity",void 0),cn=t([ce("smart-irrigation-view-zone-settings")],cn);let hn=class extends le{_emit(e){this.dispatchEvent(new CustomEvent("distributor-changed",{detail:{value:Object.assign(Object.assign({},this.distributor),e)},bubbles:!0,composed:!0}))}_onNumber(e,t){const i=t.target.valueAsNumber;isNaN(i)||this._emit({[e]:Math.max(0,Math.round(i))})}render(){var e,t,i,s;if(!this.hass||!this.distributor)return Z``;const a=this.hass.language,n=this.distributor,o=n.watering_mode===$i;return Z`
      ...
      <ha-settings-row>
        ...
        <input
          ...
          @input="${e=>this._emit({[fi]:e.target.value||null})}"
        />
      </ha-settings-row>
    `}_renderInletWatchRows(e){var t;const i=this.distributor,s=i.watering_mode===$i?"panels.distributors.labels.inlet_entity_help_service":"panels.distributors.labels.inlet_entity_help",a=null!==(t=i.watch_mode)&&void 0!==t?t:"ignore";return Z`
      <ha-settings-row>
        <span slot="heading"
    ...
    `}_renderAdvisories(){var e,t;if(!this.hass)return Z``;const i=this.hass.language,s=null===(e=this.config)||void 0===e?void 0:e.zone_sequencing,a=s===Ft,n=s===jt||s===Zt,o=!!(null===(t=this.config)||void 0===t?void 0:t.master_off_after);return Z`
    ...
    `}renderSimpleRadioOptions(e,t,i){if(!this.hass||!this.config)return Z``;const s=t===He||t===Pe,a=i[Ke];return Z`
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return Z`<option value="${e}" ?selected="${e===t}">
        ...
        <option
          ...
          ?selected="${i===We}"
        >
          ${Ea("panels.mappings.cards.mapping.pressure_types."+We,this.hass.language)}
        </option>
        <option
          value="${qe}"
          ?selected="${i===qe}"
        ...
        </option>`,e}return Z``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return Z``;const i=function(e){switch(e){case De:case Be:return[{unit:"°C",system:Oe},{unit:"°F",system:Te}];case Ie:case He:return[{unit:at,system:Oe},{unit:nt,system:Te}];case Ne:return[{unit:dt,system:Oe},{unit:ct,system:Te}];case Me:return[{unit:"%",system:[Oe,Te]}];case Le:return[{unit:"millibar",system:Oe},{unit:"hPa",system:Oe},{unit:"psi",system:Te},{unit:ot,system:Te}];case Re:return[{unit:"km/h",system:Oe},{unit:lt,system:Oe},{unit:rt,system:Te}];case Pe:return[{unit:"W/m2",system:Oe},{unit:"MJ/day/m2",system:Oe},{unit:"W/sq ft",system:Te},{unit:"MJ/day/sq ft",system:Te}];default:return[]}}(e);let s=t[Xe];const a=this.config.units;if(!t[Xe])for(const e of i)if("string"==typeof e.system){if(a===e.system){s=e.unit;break}}else{for(const t of e.system)if(a===t.system){s=e.unit;break}if(s===e.unit)break}return Z`
      ${i.map(e=>Z`
    ...
    `}_renderRecurrenceFields(){const e=this.schedule,t=this.hass.language;switch(e.recurrence){case"weekly":return Z`
        ...
        `;default:return Z``}}_renderBoundFields(e){const{end:t,mode:i,time:s,offset:a,azimuth:n,emitMode:o,emitTime:r,emitOffset:l,emitAzimuth:d}=e,c=this.hass.language;return Z`
      <div class="field">
        <label>${Ea(`panels.schedules.fields.${t}_mode`,c)}</label>
        <select
          @change=${e=>o(e.target.value)}
        >
          ${ni.map(e=>Z`
              <option value="${e}" ?selected="${i===e}">
                ${Ea(`panels.schedules.bound_mode.${e}`,c)}
              </option>
            `)}
        </select>
      </div>
      ${i===ti?Z`
            <div class="field">
              <label
                >${Ea(`panels.schedules.fields.${t}_time`,c)}</label
              >
              <input
                type="time"
                .value="${s||"06:00"}"
      ...
      ${i===ai?Z`
            <div class="field">
              <label
                >${Ea("panels.schedules.fields.azimuth_angle",c)}</label
              >
              <div class="input-suffix-row">
                <input
                  type="number"
                  ...
                  max="359"
                  step="1"
                  .value="${String(null!=n?n:90)}"
                  @input=${e=>d(parseInt(e.target.value))}
                />
      ...
      ${i===ii||i===si||i===ai?Z`
            <div class="field">
              <label
                >${Ea("panels.schedules.fields.offset_minutes",c)}</label
              >
              <div class="input-suffix-row">
                <input
                  type="number"
                  step="1"
                  .value="${String(null!=a?a:0)}"
                  @input=${e=>{const t=parseInt(e.target.value);l(isNaN(t)?0:t)}}
                />
                <span class="suffix"
                  >${Ea("panels.schedules.minutes",c)}</span
                >
              </div>
            </div>
          `:""}
    `}_bothBounded(e){var t,i;return(null!==(t=e.start_mode)&&void 0!==t?t:ei)!==ei&&(null!==(i=e.finish_mode)&&void 0!==i?i:ei)!==ei}_renderAnchorField(){const e=this.schedule;if(!this._bothBounded(e))return Z``;const t=this.hass.language,i=e.anchor===oi?oi:ri;return Z`
      <div class="field">
        <label>${Ea("panels.schedules.fields.anchor",t)}</label>
        <select
          @change=${e=>this._emitChanged({anchor:e.target.value})}
        >
          ${[oi,ri].map(e=>Z`
              <option value="${e}" ?selected="${i===e}">
                ${Ea(`panels.schedules.anchor.${e}`,t)}
              </option>
            `)}
        </select>
      </div>
    `}_renderStartFinishFields(){var e,t;const i=this.schedule;return i.recurrence===Jt?Z``:Z`
      ${this._renderBoundFields({end:"start",mode:null!==(e=i.start_mode)&&void 0!==e?e:ei,time:i.start_time,offset:i.start_offset,azimuth:i.start_azimuth,emitMode:e=>this._emitChanged({start_mode:e}),emitTime:e=>this._emitChanged({start_time:e}),emitOffset:e=>this._emitChanged({start_offset:e}),emitAzimuth:e=>this._emitChanged({start_azimuth:e})})}
      ${this._renderBoundFields({end:"finish",mode:null!==(t=i.finish_mode)&&void 0!==t?t:ei,time:i.finish_time,offset:i.finish_offset,azimuth:i.finish_azimuth,emitMode:e=>this._emitChanged({finish_mode:e}),emitTime:e=>this._emitChanged({finish_time:e}),emitOffset:e=>this._emitChanged({finish_offset:e}),emitAzimuth:e=>this._emitChanged({finish_azimuth:e})})}
    ...
    `}static get styles(){return[qa,r`
      ...
      `]}};t([pe({attribute:!1})],fn.prototype,"hass",void 0),t([pe({attribute:!1})],fn.prototype,"schedule",void 0),t([pe({attribute:!1})],fn.prototype,"zones",void 0),t([pe({attribute:!1})],fn.prototype,"heading",void 0),fn=t([ce("si-schedule-dialog")],fn);let bn=class extends(Ua(le)){constructor(){super(...arguments),this._schedules=[],this._zones=[],this._isLoading=!0,this._showDialog=!1,this._editingSchedule=vn(),this._editingId=null}hassSubscribe(){return this._load(),[this.hass.connection.subscribeMessage(()=>this._load(),{type:_e+"_config_updated"})]}async _load(){var e;if(this.hass)try{const[t,i]=await Promise.all([(e=this.hass,e.callWS({type:_e+"/schedules"})),Ci(this.hass)]);this._schedules=t||[],this._zones=i||[]}catch(e){console.error("Failed to load schedules",e),Pa(this,this.hass,"common.errors.load_failed",e)}finally{this._isLoading=!1}}_openAdd(){this._editingSchedule=vn(),this._editingId=null,this._showDialog=!0}_openEdit(e){var t;this._editingSchedule=Object.assign({},e),this._editingId=null!==(t=e.id)&&void 0!==t?t:null,this._showDialog=!0}_closeDialog(){this._showDialog=!1}async _save(){const e=Object.assign({},this._editingSchedule);this._editingId&&(e.id=this._editingId);try{const t=await Ni(this.hass,e);if(t&&!1===t.success)throw new Error(t.error||"");this._closeDialog(),await this._load()}catch(e){console.error("Failed to save schedule",e),Pa(this,this.hass,"common.errors.save_failed",e)}}async _delete(e){try{await(t=this.hass,i=e,t.callWS({type:_e+"/schedule_delete",schedule_id:i})),await this._load()}catch(e){console.error("Failed to delete schedule",e),Pa(this,this.hass,"common.errors.delete_failed",e)}var t,i}_onScheduleChanged(e){this._editingSchedule=e.detail.value}_zonesLabel(e){if("all"===e)return Ea("panels.schedules.zones_all",this.hass.language);if(Array.isArray(e)){const t=e.map(e=>{const t=this._zones.find(t=>String(t.id)===String(e));return t?t.name:e}).join(", ");return t||e.join(", ")}return String(e)}_dialogTitle(){return this._editingId?Ea("panels.schedules.dialog.edit_title",this.hass.language):Ea("panels.schedules.dialog.add_title",this.hass.language)}render(){return this.hass?this._isLoading?Z`
        <ha-card
      ...
      ${0===this._schedules.length?Z`
          ...
          `:this._schedules.map(e=>Z`
              <ha-card header="${e.name}">
                <div class="card-content">
                  <div class="info-row">
                    ...
                    >
                    <span
                      >${_n(e.recurrence,this.hass.language)}</span
                    >
                  </div>
            ...
            `)}
    `:Z``}static get styles(){return[qa,r`
        .info-row {
          display: flex;
          gap: 8px;
          margin-bottom: 4px;
      ...
      `]}};t([pe({attribute:!1})],bn.prototype,"hass",void 0),t([ge()],bn.prototype,"_schedules",void 0),t([ge()],bn.prototype,"_zones",void 0),t([ge()],bn.prototype,"_isLoading",void 0),t([ge()],bn.prototype,"_showDialog",void 0),t([ge()],bn.prototype,"_editingSchedule",void 0),t([ge()],bn.prototype,"_editingId",void 0),bn=t([ce("smart-irrigation-view-schedules")],bn);let yn=class extends(Ua(le)){constructor(){super(...arguments),this._forecast=null,this._mappings=[],this._records=new Map,this._loading=!0,this._metric=!0,this._climate=[]}hassSubscribe(){return this._fetch(),[this.hass.connection.subscribeMessage(()=>this._fetch(),{type:_e+"_config_updated"})]}async _fetch(){var e,t;if(this.hass)try{const[i,s,a,n]=await Promise.all([(t=this.hass,t.callWS({type:_e+"/weather_forecast"})),Hi(this.hass),Si(this.hass),Ii(this.hass)]);this._forecast=i,this._mappings=s||[],this._metric=(null==a?void 0:a.units)!==Te;const o=n?Object.values(n):[];this._climate=o.length>0&&(null===(e=o[0])||void 0===e?void 0:e.monthly_estimates)||[];const r=new Map;await Promise.all(this._mappings.map(async e=>{if(void 0!==e.id)try{r.set(e.id,await((e,t,i=10)=>e.callWS({type:_e+"/weather_records",mapping_id:t,limit:i}))(this.hass,e.id.toString(),0)||[])}catch(e){}})),this._records=r}catch(e){console.error("Failed to fetch weather data",e)}finally{this._loading=!1}}render(){return this.hass?Z`${this._renderForecast()} ${this._renderRecords()}
    ...
    `}_renderForecastDay(e,t){const i=(()=>{try{return new Intl.DateTimeFormat(t,{weekday:"short",month:"short",day:"numeric"}).format(new Date(e.date+"T00:00:00"))}catch(t){return e.date}})(),s=e=>{const t=on(e,"temperature",this._metric);return t?`${Math.round(t.value)}°`:"-"};return Z`
    ...
    `}_renderRecords(){if(!this.hass)return Z``;const e=this.hass.language;return this._loading&&0===this._mappings.length?Z`<ha-card
      ...
      </ha-card>`:Z`${this._mappings.map(t=>this._renderMappingRecords(t,e))}`}_renderMappingRecords(e,t){const i=void 0!==e.id&&this._records.get(e.id)||[],s=`${Ea("panels.mappings.weather-records.title",t)} — ${e.name}`,a=e=>{try{return t=e,Number.isNaN(Ka(t).getTime())?"-":function(e){const t=Ka(e);return`${Ga(t.getMonth()+1)}-${Ga(t.getDate())} ${Ga(t.getHours())}:${Ga(t.getMinutes())}`}(e)}catch(e){return"-"}var t};return Z`
      <ha-card header="${s}">
        <div class="card-content">
    ...
    `}};t([pe()],yn.prototype,"narrow",void 0),t([ge()],yn.prototype,"_forecast",void 0),t([ge()],yn.prototype,"_mappings",void 0),t([ge()],yn.prototype,"_records",void 0),t([ge()],yn.prototype,"_loading",void 0),t([ge()],yn.prototype,"_metric",void 0),t([ge()],yn.prototype,"_climate",void 0),yn=t([ce("smart-irrigation-view-weather-data")],yn);let wn=class extends(Ua(le)){constructor(){super(...arguments),this._saving=!1}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch experimental config:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to refresh experimental config:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(this.hass)try{this.config=await Si(this.hass)}catch(e){console.error("Error fetching config:",e),Pa(this,this.hass,"common.errors.load_failed",e)}}async _toggle(e,t){if(this.hass&&this.config){this.config=Object.assign(Object.assign({},this.config),{[e]:t}),this._saving=!0;try{await Ai(this.hass,{[e]:t})}catch(e){console.error("Error saving experimental config:",e),Pa(this,this.hass,"common.errors.save_failed",e),await this._fetchData()}finally{this._saving=!1}}}render(){var e,t;return this.hass&&this.config?Z`
      ${this._renderIntro()}
    ...
    `}};t([pe()],wn.prototype,"narrow",void 0),t([ge()],wn.prototype,"config",void 0),t([ge()],wn.prototype,"_saving",void 0),wn=t([ce("smart-irrigation-view-experimental")],wn);var $n;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.Distributors="distributors",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}($n||($n={}));const xn={[$n.WeatherLocation]:"panels.setup.tabs.weather_location",[$n.Zones]:"panels.setup.tabs.my_zones",[$n.Distributors]:"panels.setup.tabs.distributors",[$n.WhenToWater]:"panels.setup.tabs.when_to_water",[$n.Advanced]:"panels.setup.tabs.advanced",[$n.Experimental]:"panels.setup.tabs.experimental",[$n.Help]:"panels.help.title"};let kn=class extends(Ua(le)){hassSubscribe(){return this._fetchConfig(),[this.hass.connection.subscribeMessage(()=>this._fetchConfig(),{type:_e+"_config_updated"})]}async _fetchConfig(){if(this.hass)try{this.config=await Si(this.hass)}catch(e){console.error("Failed to fetch setup config:",e)}}get _distributorsEnabled(){var e,t;return null!==(t=null===(e=this.config)||void 0===e?void 0:e.distributors_enabled)&&void 0!==t&&t}get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values($n).includes(null!=t?t:"")?t:$n.WeatherLocation}_selectTab(e){Ma(0,Wa("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return Z``;const e=this._distributorsEnabled,t=Object.values($n).filter(t=>t!==$n.Distributors||e);let i=this._activeTab;return i!==$n.Distributors||e||(i=$n.WeatherLocation),Z`
    ...
    `}_renderContent(e){if(!this.hass)return Z``;switch(e){case $n.WeatherLocation:return Z`
          ...
          <smart-irrigation-view-weather-data
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-weather-data>
        `;case $n.Zones:return Z`<smart-irrigation-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-zone-settings>`;case $n.Distributors:return Z`<smart-irrigation-view-distributor-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-distributor-settings>`;case $n.WhenToWater:return Z`
          <smart-irrigation-view-general
            .hass="${this.hass}"
            .narrow="${this.narrow}"
        ...
        `;case $n.Advanced:return Z`
          ...
          <smart-irrigation-view-mappings
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-mappings>
        `;case $n.Experimental:return Z`<smart-irrigation-view-experimental
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-experimental>`;case $n.Help:return this._renderHelp()}}_renderHelp(){return this.hass?Z`
      <ha-card
    ...
    `}};var zn;t([pe({attribute:!1})],kn.prototype,"hass",void 0),t([pe({type:Boolean})],kn.prototype,"narrow",void 0),t([pe({attribute:!1})],kn.prototype,"path",void 0),t([ge()],kn.prototype,"config",void 0),kn=t([ce("smart-irrigation-view-setup")],kn),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done"}(zn||(zn={}));let Sn=class extends le{constructor(){super(...arguments),this._step=zn.Welcome,this._saving=!1,this._error="",this._confirmClose=!1,this._siConfig=null,this._useWeather=!1,this._weatherService=ze,this._apiKey="",this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=Ue,this._humiditySource=Ue,this._precipSource=Ue,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="",this._scheduleTime="06:00",this._scheduleCreated=!1,this._creatingSchedule=!1}async connectedCallback(){super.connectedCallback(),await this._loadInitialData()}async _loadInitialData(){var e;if(this.hass){try{const[t,i,s]=await Promise.all([Oi(this.hass),Bi(this.hass),Si(this.hass)]);this._availableModules=t,this._weatherConfig=i,this._siConfig=s,this._useWeather=i.use_weather_service,this._weatherService=null!==(e=i.weather_service)&&void 0!==e?e:ze}catch(e){console.error("Wizard: failed to load initial data",e),this._error=Ia(e)}this.requestUpdate()}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}))}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}))}async _next(){this._error="";try{switch(this._saving=!0,this._step){case zn.Welcome:this._step=zn.Weather;break;case zn.Weather:await this._saveWeather(),this._step=zn.Module;break;case zn.Module:await this._saveModule(),this._step=zn.Mapping;break;case zn.Mapping:await this._saveMapping(),this._step=zn.Zone;break;case zn.Zone:await this._saveZone(),this._step=zn.Done;break;case zn.Done:this._close()}}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._saving=!1,this.requestUpdate()}}_back(){this._step>zn.Welcome&&(this._step=this._step-1,this._error="")}get _canSkipCurrentStep(){return this._step===zn.Weather}_skipStep(){this._canSkipCurrentStep&&this._step<zn.Done&&(this._step=this._step+1,this._error="")}async _saveWeather(){await Ri(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null)}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0}catch(e){return}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await Di(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>Ti(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.")}async _saveMapping(){const e=this._useWeather?Ue:Ge,t={[Be]:{[Ke]:this._tempSource},[Me]:{[Ke]:this._humiditySource},[Ie]:{[Ke]:this._precipSource}},i=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const s of i)t[s]={[Ke]:e};const s=await Mi(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(s,()=>Hi(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.")}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await Ei(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:Fa.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0})}async _createDefaultSchedule(){var e,t;if(!this._scheduleCreated&&!this._creatingSchedule){this._error="",this._creatingSchedule=!0;try{const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";await Ni(this.hass,{name:Ea("wizard.steps.done.schedule_name",i)||"Daily",type:"daily",enabled:!0,time:this._scheduleTime||"06:00",action:"irrigate",zones:"all"}),this._scheduleCreated=!0}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._creatingSchedule=!1,this.requestUpdate()}}}render(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return Z`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          ...
          ${this._step!==zn.Welcome&&this._step!==zn.Done?Z`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>zn.Welcome&&this._step<zn.Done?this._confirmClose=!0:this._close())}_renderStepper(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",s=[Ea("wizard.stepper.weather",i),Ea("wizard.stepper.module",i),Ea("wizard.stepper.mapping",i),Ea("wizard.stepper.zone",i)];return Z`
      ${s.map((e,t)=>{const i=t+1,a=this._step===i,n=this._step>i;return Z`
        ...
        `})}
    `}_renderStep(e){switch(this._step){case zn.Welcome:return this._renderWelcome(e);case zn.Weather:return this._renderWeather(e);case zn.Module:return this._renderModule(e);case zn.Mapping:return this._renderMapping(e);case zn.Zone:return this._renderZone(e);case zn.Done:return this._renderDone(e);default:return Z``}}_renderFooter(e){return this._step===zn.Done?Z``:Z`
      <div class="footer-left">
        ${this._step>zn.Welcome?Z`<button
              class="wizard-btn secondary"
              @click="${this._back}"
              ?disabled="${this._saving}"
            >
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Ea("common.saving-messages.saving",e):this._step===zn.Welcome||this._step<zn.Zone?Ea("wizard.next",e):Ea("wizard.finish",e)}
      </button>
    ...
    `}_renderMapping(e){const t=[{value:Ue,label:Ea("wizard.steps.mapping.use_weather_service",e)},{value:"sensor",label:Ea("wizard.steps.mapping.use_sensor",e)},{value:"static",label:Ea("wizard.steps.mapping.use_static",e)},{value:Ge,label:Ea("wizard.steps.mapping.use_none",e)}],i=(i,s,a)=>Z`
      <si-field
    ...
    `}};t([pe({attribute:!1})],Sn.prototype,"hass",void 0),t([ge()],Sn.prototype,"_step",void 0),t([ge()],Sn.prototype,"_saving",void 0),t([ge()],Sn.prototype,"_error",void 0),t([ge()],Sn.prototype,"_confirmClose",void 0),t([ge()],Sn.prototype,"_siConfig",void 0),t([ge()],Sn.prototype,"_useWeather",void 0),t([ge()],Sn.prototype,"_weatherService",void 0),t([ge()],Sn.prototype,"_apiKey",void 0),t([ge()],Sn.prototype,"_weatherConfig",void 0),t([ge()],Sn.prototype,"_availableModules",void 0),t([ge()],Sn.prototype,"_selectedModuleIndex",void 0),t([ge()],Sn.prototype,"_moduleConfig",void 0),t([ge()],Sn.prototype,"_mappingName",void 0),t([ge()],Sn.prototype,"_tempSource",void 0),t([ge()],Sn.prototype,"_humiditySource",void 0),t([ge()],Sn.prototype,"_precipSource",void 0),t([ge()],Sn.prototype,"_zoneName",void 0),t([ge()],Sn.prototype,"_zoneSize",void 0),t([ge()],Sn.prototype,"_zoneThroughput",void 0),t([ge()],Sn.prototype,"_zoneEntity",void 0),t([ge()],Sn.prototype,"_scheduleTime",void 0),t([ge()],Sn.prototype,"_scheduleCreated",void 0),t([ge()],Sn.prototype,"_creatingSchedule",void 0),Sn=t([ce("si-setup-wizard")],Sn);const An=qa;var Cn;!function(e){e.Zones="zones",e.Setup="setup"}(Cn||(Cn={})),e.SmartIrrigationPanel=class extends le{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}async firstUpdated(){const e=Za().page;Object.values(Cn).includes(e)||Ma(0,Wa(Cn.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())}),Zi().then(()=>{this._scheduleUpdate()}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}),this.hass&&Si(this.hass).then(e=>{this._config=e,this._scheduleUpdate()}).catch(e=>{console.error("Failed to fetch config for version display:",e)})}_ensureLanguage(){this.hass&&!Ca(this.hass.language)&&function(e){const t=Aa(e);return Ca(e)?Promise.resolve():(Sa[t]||(Sa[t]=fetch(`/smart_irrigation_static/languages/${t}.json?v=${ve}`).then(e=>e.ok?e.json():Promise.reject(e.status)).then(e=>{za[t]=e}).catch(()=>{za[t]=za.en})),Sa[t])}(this.hass.language).then(()=>this.requestUpdate())}render(){var e,t;if(this.hass&&!Ca(this.hass.language))return this._ensureLanguage(),Z``;const i=Za(),s=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return Z`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
    ...
    `}getView(e){switch(e.page){case"zones":default:return Z`
        ...
        `;case"setup":return Z`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0}}"
          ></smart-irrigation-view-setup>
        `}}navigateToPage(e){if(e!==Za().page){const t=Wa(e);Ma(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==Za().page){const e=Wa(t);Ma(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[An,r`
        :host {
          color: var(--primary-text-color);
    ...
    `}};t([pe({attribute:!1})],En.prototype,"hass",void 0),t([ge()],En.prototype,"_params",void 0),En=t([ce("error-dialog")],En);var Tn=Object.freeze({__proto__:null,get ErrorDialog(){return En}})}({});

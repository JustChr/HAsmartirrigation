...
`;const Za=e=>String(e).padStart(2,"0");function Wa(e){return e instanceof Date?e:new Date(e)}function qa(e){const t=Wa(e);return`${Za(t.getHours())}:${Za(t.getMinutes())}`}function Ga(e){const t=Wa(e);return`${t.getFullYear()}-${Za(t.getMonth()+1)}-${Za(t.getDate())} ${Za(t.getHours())}:${Za(t.getMinutes())}`}function Ka(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class Va extends(Pa(le)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){Rs().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const s=Object.values(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).some(e=>!0!==e.queued&&!0!==e.paused);s&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):s||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[s,i,a,n]=await Promise.all([$s(this.hass),ks(this.hass),(t=this.hass,t.callWS({type:_e+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),Ds(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=s,this.zones=i,this._outlook=a,this._distributors=n,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),Ia(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),Ia(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),Ia(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const s="all"===t,i=s?void 0:this.zones.find(e=>{var s;return(null===(s=e.id)||void 0===s?void 0:s.toString())===t}),a=s?`(${this._linkedZoneCount})`:`: ${null!==(e=null==i?void 0:i.name)&&void 0!==e?e:t}`;try{await(n=this.hass,o=s?void 0:t,n.callWS(Object.assign({type:_e+"/irrigate_now"},void 0!==o?{zone_id:o}:{}))),Ma(this,`${Aa("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${a}`)}catch(e){const t=Da(e);console.error("irrigate_now failed",e),Ma(this,`${Aa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var n,o}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const s=new Date(t);return s.getTime()>Date.now()?s:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:_e+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),Ia(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:_e+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),Ia(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,s;const i=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(s=this._runMinutes[i])&&void 0!==s?s:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const s=this._zoneDistributor(e);return!!s&&Object.keys(null!==(t=s.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var s,i,a;if(t>0)try{await(s=this.hass,i=e.id.toString(),a=t,s.callWS({type:_e+"/run_zone",zone_id:i,duration:a})),Ma(this,`${Aa("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=Da(e);console.error("run_zone failed",e),Ma(this,`${Aa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===s?void 0:s[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,s;if(this.hass&&void 0!==e.id)try{await(t=this.hass,s=e.id.toString(),t.callWS({type:_e+"/stop_zone",zone_id:s})),Ma(this,`${Aa("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=Da(e);console.error("stop_zone failed",e),Ma(this,`${Aa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",_e+"/zones",{id:i,calculate:!0,override_cache:!0})).catch(e=>{const t=Da(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",_e+"/zones",{id:i,update:!0})).catch(e=>{const t=Da(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;Ha(0,t?ja("setup","zones",t):ja("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,s,i;const a=null!==(t=e.duration)&&void 0!==t?t:0,n=Number(null!==(s=e.bucket_threshold)&&void 0!==s?s:0),o=this._zoneEstimate(e),r=o&&o.available&&null!=o.live_deficit?o.live_deficit:Number(null!==(i=e.bucket)&&void 0!==i?i:0);return a>0&&r<n}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,s=new Date(e),i=qa(s),a=new Date;return Ka(s,a)?`${Aa("panels.zones.outlook.today",t)} ${i}`:Ka(s,function(e,t){const s=new Date(e.getTime());return s.setDate(s.getDate()+t),s}(a,1))?`${Aa("panels.zones.outlook.tomorrow",t)} ${i}`:function(e,t){const s=Wa(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(s)} ${qa(s)}`}(s,t)}_guardLabel(e){return Aa(`panels.zones.outlook.checks.${e.id}`,this.hass.language)}_guardDetail(e){var t;return e.available&&null!==e.observed?Aa(`panels.zones.outlook.check_detail.${e.id}`,this.hass.language,"{observed}",String(e.observed),"{threshold}",String(null!==(t=e.threshold)&&void 0!==t?t:"")):""}_renderSkipReasons(){const e=this.hass.language;return Z`
      ...
      <div class="outlook-line outlook-dim skip-reasons-note">
        ${Aa("panels.zones.outlook.provisional",e)}
      </div>
    `}_openSchedules(){Ha(0,ja("setup","when-to-water"))}_runActionLabel(e){return Aa(`panels.zones.outlook.actions.${e.action}`,this.hass.language)}_runTargetsLabel(e){const t=this.hass.language;if("all"===e.zones)return Aa("panels.zones.outlook.targets_all",t);const s=Array.isArray(e.zones)?e.zones.length:0;return Aa("panels.zones.outlook.targets_zones",t,"{count}",String(s))}_renderOutlookBanner(){if(!this.hass||!this._outlook)return Z``;const e=this.hass.language,t=this._nextIrrigateRun,s=this._triggeredGuards,i=this._outlook.last_skip_evaluation;return t&&t.next_run_utc?Z`
      <ha-card class="outlook-card">
        <div class="outlook">
          <div class="outlook-line outlook-headline">
            ...
            <span>
              <strong
                >${Aa("panels.zones.outlook.next_run",e)}:</strong
              >
          ...
          ${s.length>0?Z`
                <div class="outlook-line outlook-skip">
                  ...
                  <span
                    >${Aa("panels.zones.outlook.will_skip",e)}</span
                  >
                  <button
                    class="outlook-info-btn"
                    aria-expanded="${this._skipDetailsOpen}"
                    title="${Aa("panels.zones.outlook.why_skipped",e)}"
                  ...
                  >
                    ...
                    <span class="outlook-info-label"
                      >${Aa("panels.zones.outlook.why_skipped",e)}</span
                    >
                  </button>
                </div>
              ...
              `:Z`
                <div class="outlook-line outlook-clear">
                  ...
                  <span
                    >${Aa("panels.zones.outlook.will_run",e)}</span
                  >
                </div>
              `}
    ...
    `:Z`
        <ha-card class="outlook-card">
          <div class="outlook">
            <div class="outlook-line outlook-headline">
              ...
              <span>${Aa("panels.zones.outlook.no_schedule",e)}</span>
              ${this.hideSettingsLinks?"":Z`
                    <button
                      class="outlook-link"
                      @click="${this._openSchedules}"
                    >
                      ${Aa("panels.zones.outlook.setup_schedule",e)}
                    </button>
                  `}
            </div>
            ${i?this._renderLastRunLine(i):""}
        ...
        <ha-card class="rain-delay-card paused">
          <div class="rain-delay">
            ...
            <span class="rain-delay-msg">
              <strong
                >${Aa("panels.zones.rain_delay.paused",e)}</strong
              >
              ${Aa("panels.zones.rain_delay.until",e)}
              ${Ga(t.toISOString())}
            </span>
            <button class="action-btn" @click="${()=>this._clearRainDelay()}">
              <ha-icon icon="mdi:play"></ha-icon>
              ${Aa("panels.zones.rain_delay.resume",e)}
            </button>
          </div>
        </ha-card>
      `:Z`
      <div class="rain-delay-row">
        <span class="rain-delay-label">
          ...
          ${Aa("panels.zones.rain_delay.title",e)}
        </span>
        <button class="action-btn" @click="${()=>this._setRainDelay(24)}">
          ${Aa("panels.zones.rain_delay.delay_24h",e)}
        </button>
        <button class="action-btn" @click="${()=>this._setRainDelay(48)}">
          ${Aa("panels.zones.rain_delay.delay_48h",e)}
        </button>
      </div>
    `}_renderLastRunLine(e){const t=this.hass.language,s=function(e,t){const s=Wa(e).getTime()-Date.now(),i=new Intl.RelativeTimeFormat(t,{numeric:"auto"}),a=Math.round(s/1e3);if(Math.abs(a)<60)return i.format(a,"second");const n=Math.round(a/60);if(Math.abs(n)<60)return i.format(n,"minute");const o=Math.round(n/60);if(Math.abs(o)<24)return i.format(o,"hour");const r=Math.round(o/24);if(Math.abs(r)<30)return i.format(r,"day");const l=Math.round(r/30);return Math.abs(l)<12?i.format(l,"month"):i.format(Math.round(l/12),"year")}(e.timestamp,t),i=e.checks.filter(e=>e.enabled&&e.would_skip).map(e=>this._guardLabel(e).toLowerCase()).join(", "),a=e.would_skip?`${Aa("panels.zones.outlook.last_run_skipped",t)}${i?` (${i})`:""}`:Aa("panels.zones.outlook.last_run_ran",t);return Z`
      <div class="outlook-line outlook-last">
        <span class="outlook-dim"
          >${Aa("panels.zones.outlook.last_run",t)}:</span
        >
        <span>${a} · ${s}</span>
      </div>
    `}_renderZoneDecision(e){var t;if(!this.hass)return Z``;const s=this.hass.language,i=null!==(t=e.duration)&&void 0!==t?t:0;let a,n,o;if(e.state===Ra.Disabled)a=Aa("panels.zones.status.decision_disabled",s),n="neutral",o="mdi:power-off";else if(e.last_calculated)if(this._zoneHasDeficit(e)){const t=function(e){const t=Math.round(e);if(t<60)return`${t} s`;const s=Math.floor(t/60),i=t%60;return i?`${s} min ${i} s`:`${s} min`}(i),r=this._triggeredGuards,l=this._nextIrrigateRunForZone(e);r.length>0?(a=Aa("panels.zones.status.decision_water_skip",s,"{duration}",t,"{reason}",this._guardLabel(r[0]).toLowerCase()),n="skip",o="mdi:weather-rainy"):l&&l.next_run_utc?(a=Aa("panels.zones.status.decision_water_at",s,"{duration}",t,"{time}",this._formatRunTime(l.next_run_utc)),n="water",o="mdi:water"):(a=Aa("panels.zones.status.decision_water_no_schedule",s,"{duration}",t),n="water",o="mdi:water-alert")}else a=Aa("panels.zones.status.decision_no_water",s),n="ok",o="mdi:check-circle-outline";else a=Aa("panels.zones.status.decision_unknown",s),n="unknown",o="mdi:help-circle-outline";return Z`
      <div class="zone-decision ${n}">
        <ha-icon icon="${o}"></ha-icon>
        <span>${a}</span>
      </div>
    `}_zoneEstimate(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.zone_estimates)||void 0===s?void 0:s[String(e.id)]}_zoneFault(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.zone_faults)||void 0===s?void 0:s[String(e.id)]}_renderZoneFault(e){if(!this.hass)return Z``;const t=this._zoneFault(e);if(!t)return Z``;const s=this.hass.language,i=Aa(`panels.zones.fault.${t.reason}`,s)||Aa("panels.zones.fault.generic",s),a=t.timestamp?Ga(t.timestamp):"";return Z`
      <div class="zone-fault" title="${a}">
        <ha-icon icon="mdi:alert-circle"></ha-icon>
        <span>
          <strong>${Aa("panels.zones.fault.title",s)}</strong>
          — ${i}
        </span>
      </div>
    `}_zoneSkip(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.zone_skips)||void 0===s?void 0:s[String(e.id)]}_renderZoneSkip(e){if(!this.hass)return Z``;const t=this._zoneSkip(e);if(!t)return Z``;const s=this.hass.language,i=Aa("panels.zones.skip.soil_moisture",s,"{observed}",String(t.observed),"{threshold}",String(t.threshold)),a=t.timestamp?Ga(t.timestamp):"";return Z`
      <div class="zone-skip" title="${a}">
        <ha-icon icon="mdi:water-off"></ha-icon>
        <span>
          <strong>${Aa("panels.zones.skip.title",s)}</strong>
          — ${i}
        </span>
      </div>
    `}_renderZoneEstimate(e){if(!this.hass)return Z``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return Z``;const s=this.hass.language,i=Ta(this.config,_t),a=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",n=Aa(`panels.zones.status.estimate_method.${"proxy"===t.method||"hourly_sensor"===t.method?t.method:"hourly"}`,s)+(t.as_of?` · ${qa(t.as_of)}`:"");return Z`
      <span class="status-sep">·</span>
      <span class="zone-estimate" title="${n}">
        ${Aa("panels.zones.status.estimate_now",s)}
        <strong style="color: ${a}"
          >≈ ${t.live_deficit.toFixed(2)} ${i}</strong
        >
        <span class="estimate-tag"
          >${Aa("panels.zones.status.estimate_tag",s)}</span
        >
      </span>
    `}_renderZoneNextRun(e){if(!this.hass)return Z``;const t=this._nextIrrigateRunForZone(e);if(!t||!t.next_run_utc)return Z``;return e.state!==Ra.Disabled&&e.last_calculated&&this._zoneHasDeficit(e)&&0===this._triggeredGuards.length?Z``:Z`
      <span class="status-sep">·</span>
      <span>
        ${Aa("panels.zones.outlook.next_run",this.hass.language)}:
        <strong>${this._formatRunTime(t.next_run_utc)}</strong>
      </span>
    `}renderZone(e,t){var s;if(!this.hass)return Z``;const i=Number(null!==(s=e.bucket)&&void 0!==s?s:0),a=i<0?"var(--warning-color)":"var(--success-color)",n=e.state===Ra.Automatic?"state-automatic":e.state===Ra.Manual?"state-manual":"state-disabled",o=e.last_calculated?Ga(e.last_calculated):Aa("panels.zones.status.never",this.hass.language);return Z`
      <ha-card>
        <div class="card-header">
          <div class="name">${e.name}</div>
          <span class="zone-state-badge ${n}">
            ${Aa(`panels.zones.labels.states.${e.state}`,this.hass.language)}
          </span>
          ${this.hideSettingsLinks?"":Z`
                <ha-icon-button
                  ...
                  title="${Aa("panels.zones.actions.open_settings",this.hass.language)}"
        ...
        <div class="card-content">
          <div class="zone-status-line">
            <span
              title="${Aa("panels.zones.help.bucket",this.hass.language)}"
            >
              ${Aa("panels.zones.labels.bucket",this.hass.language)}:
              <strong style="color: ${a}"
                >${i.toFixed(2)}
                ${Ta(this.config,_t)}</strong
              >
            </span>
            <span class="status-sep">·</span>
            <span>
              ${Aa("panels.zones.status.last_checked",this.hass.language)}:
              <strong>${o}</strong>
            </span>
        ...
        <div class="card-content zone-action-bar">
          ${"full"===this.actionsMode&&e.state===Ra.Automatic?Z`
                <button
                  class="action-btn"
                  title="${Aa("panels.zones.help.update",this.hass.language)}"
                  @click="${()=>this.handleUpdateZone(t)}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:update"></ha-icon>
                  ${Aa("panels.zones.actions.update",this.hass.language)}
                </button>
                <button
                  class="action-btn"
                  title="${Aa("panels.zones.help.calculate",this.hass.language)}"
                  @click="${()=>this.handleCalculateZone(t)}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:calculator"></ha-icon>
                  ${Aa("panels.zones.actions.calculate",this.hass.language)}
                </button>
              `:""}
          ${"none"!==this.actionsMode&&this._canActuate(e)&&this._zoneHasDeficit(e)?Z`
                ...
                >
                  ...
                  ${Aa("panels.zones.labels.irrigate_now",this.hass.language)}
                </button>
              `:this._canActuate(e)?"":Z`
                  <button
                    class="action-btn"
                    disabled
                    title="${Aa("panels.zones.help.irrigate_link_entity",this.hass.language)}"
                  >
                    <ha-icon icon="mdi:water"></ha-icon>
                    ${Aa("panels.zones.labels.irrigate_now",this.hass.language)}
                  </button>
                  <span class="zones-top-note">
                    ${Aa("panels.zones.help.irrigate_link_entity",this.hass.language)}
                  </span>
                `}
    ...
    `}_renderRunZoneControl(e){if(!this.hass||"none"===this.actionsMode||!this._canActuate(e)||void 0===e.id)return Z``;const t=this.hass.language,s=String(e.id),i=this._activeRun(e);if(i){const s=!0===i.queued,a=!s&&!0===i.paused,n=s||a?null:this._runSecondsLeft(i);return Z`
        ...
        >
          <span class="run-zone-countdown">
            ...
            ${s?Aa("panels.zones.stop_zone.queued",t):a?Aa("panels.zones.stop_zone.paused",t):null===n?Aa("panels.zones.stop_zone.watering",t):this._formatCountdown(n)}
          </span>
          <button
          ...
          >
            ...
            ${Aa("panels.zones.stop_zone.stop",t)}
          </button>
        </div>
      ...
      <div class="run-zone-control-wrap">
        <div
          ...
          title="${Aa("panels.zones.run_zone.help",t)}"
        >
          <input
          ...
          <span class="run-zone-unit"
            >${Aa("panels.zones.run_zone.minutes",t)}</span
          >
          <button
            class="action-btn"
          ...
          >
            ...
            ${Aa("panels.zones.run_zone.run",t)}
          </button>
        </div>
        ${a?Z`<span class="run-zone-busy-hint">
              ${Aa("panels.zones.run_zone.busy_hint",t)}
            </span>`:""}
      </div>
    `}_formatCountdown(e){const t=Math.max(0,e),s=Math.floor(t/3600),i=Math.floor(t%3600/60),a=t%60,n=e=>String(e).padStart(2,"0");return s>0?`${s}:${n(i)}:${n(a)}`:`${i}:${n(a)}`}render(){var e,t;if(!this.hass)return Z``;if(this.isLoading)return Z`
        <ha-card header="${Aa("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            <div class="loading-indicator">
              ${Aa("common.loading-messages.general",this.hass.language)}
            </div>
          </div>
        </ha-card>
      ...
      ${i?this.hideSettingsLinks?Z`
              <ha-card>
                <div class="card-content description-text">
                  ${Aa("panels.zones.no_items",this.hass.language)}
                </div>
              </ha-card>
            `:Z`
                ...
                <div class="setup-banner">
                  ...
                  <div class="setup-banner-content">
                    <div class="setup-banner-title">
                      ${Aa("wizard.title",this.hass.language)}
                    </div>
                    <div class="setup-banner-desc">
                      ${Aa("wizard.setup_complete_banner",this.hass.language)}
                    </div>
                  </div>
                  <button
                  ...
                  >
                    ${Aa("wizard.open_wizard",this.hass.language)}
                  </button>
                </div>
              </ha-card>
            `:""}
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${Aa("panels.zones.title",this.hass.language)}
          </div>
        </div>
        <div class="card-content zones-top-actions">
          ${"full"===this.actionsMode?Z`
                <button
                  class="action-btn"
                  title="${Aa("panels.zones.help.update_all",this.hass.language)}"
                  @click="${this.handleUpdateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:update"></ha-icon>
                  ${Aa("panels.zones.cards.zone-actions.actions.update-all",this.hass.language)}
                </button>
                <button
                  class="action-btn"
                  title="${Aa("panels.zones.help.calculate_all",this.hass.language)}"
                  @click="${this.handleCalculateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:calculator"></ha-icon>
                  ${Aa("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language)}
                </button>
              `:""}
          ${"none"!==this.actionsMode?Z`
                <button
                  class="action-btn"
                  raised
                  title="${Aa("panels.zones.help.irrigate_all",this.hass.language)}"
                  @click="${()=>{this._confirmIrrigate="all"}}"
                  ?disabled="${!s||this.isSaving}"
                >
                  <ha-icon icon="mdi:water"></ha-icon>
                  ${Aa("panels.zones.actions.irrigate_all",this.hass.language)}
                </button>
              `:""}
          ${s?"":Z`<span class="zones-top-note"
                >${Aa("panels.info.cards.irrigate_now.no_linked_zones",this.hass.language)}</span
              >`}
        </div>
      </ha-card>
      ...
      ${null!==this._confirmIrrigate?Z`
            <ha-dialog
              ...
              heading="${Aa("panels.zones.confirm_irrigate.title",this.hass.language)}"
            >
              <p>
                ${Aa("panels.zones.confirm_irrigate.body",this.hass.language)}
              </p>
              <p>
                <strong>
                  ${"all"===this._confirmIrrigate?`${Aa("panels.zones.confirm_irrigate.all_linked_zones",this.hass.language)} (${this._linkedZoneCount})`:null!==(t=null===(e=this.zones.find(e=>{var t;return(null===(t=e.id)||void 0===t?void 0:t.toString())===this._confirmIrrigate}))||void 0===e?void 0:e.name)&&void 0!==t?t:this._confirmIrrigate}
                </strong>
              </p>
              <div class="dialog-footer">
                ...
                >
                  ${Aa("common.actions.cancel",this.hass.language)}
                </button>
                <button
            ...
            <ha-card class="error-banner-card">
              <div class="error-banner">
                ...
                <ha-icon-button
                  ...
                  aria-label="${Aa("common.actions.cancel",this.hass.language)}"
                ></ha-icon-button>
              </div>
            </ha-card>
          `:""}
    ...
    `}}t([pe()],Va.prototype,"config",void 0),t([pe({type:Boolean})],Va.prototype,"hideSettingsLinks",void 0),t([pe({attribute:!1})],Va.prototype,"actionsMode",void 0),t([pe({type:Array})],Va.prototype,"zones",void 0),t([ge()],Va.prototype,"_outlook",void 0),t([ge()],Va.prototype,"_distributors",void 0),t([pe({type:Boolean})],Va.prototype,"isLoading",void 0),t([pe({type:Boolean})],Va.prototype,"isSaving",void 0),t([ge()],Va.prototype,"_operationError",void 0),t([ge()],Va.prototype,"_confirmIrrigate",void 0),t([ge()],Va.prototype,"_skipDetailsOpen",void 0),t([ge()],Va.prototype,"_runMinutes",void 0),t([ge()],Va.prototype,"_now",void 0),customElements.get("smart-irrigation-view-zones")||customElements.define("smart-irrigation-view-zones",Va)
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */;const Ya={},Xa=Ws(class extends qs{constructor(e){if(super(e),e.type!==Fs&&e.type!==Us&&e.type!==Zs)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===W||t===q)return t;const s=e.element,i=e.name;if(e.type===Fs){if(t===s[i])return W}else if(e.type===Zs){if(!!t===s.hasAttribute(i))return W}else if(e.type===Us&&s.getAttribute(i)===t+"")return W;return((e,t=Ya)=>{e._$AH=t;
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */})(e),t}});let Ja=class extends le{constructor(){super(...arguments),this.label="",this.unit="",this.help="",this.required=!1,this._helpOpen=!1}_toggleHelp(){this._helpOpen=!this._helpOpen}render(){return Z`
      <div class="si-field">
    ...
    `}_renderServiceAndKey(e){return Z`
      <si-field
        label="${Aa("weather_service_config.service_label",e)}"
      >
        <select
          class="si-input"
          .value="${Xa(this.service||ze)}"
        ...
        >
          ...
          >
            ${Aa("weather_service_config.openmeteo",e)}
          </option>
          <option
            value="${xe}"
            ?selected="${this.service===xe}"
          >
            ${Aa("weather_service_config.owm",e)}
          </option>
          <option
            value="${ke}"
            ?selected="${this.service===ke}"
          >
            ${Aa("weather_service_config.pw",e)}
          </option>
          <option
            value="${Se}"
            ?selected="${this.service===Se}"
          >
            ${Aa("weather_service_config.met",e)}
          </option>
        </select>
      </si-field>

      ${this._needsKey?this._renderKeyField(e):Z`<div class="info-note">
            ${Aa("weather_service_config.no_api_key_needed",e)}
          </div>`}
    `}_renderKeyField(e){var t;const s=this._hasStoredKey;return Z`
      <si-field
        label="${Aa("weather_service_config.api_key_label",e)}"
        help="${Aa("weather_service_config.api_key_help",e)}"
      >
        <span class="api-badge ${s?"configured":"missing"}"
          >${Aa(s?"weather_service_config.api_key_configured":"weather_service_config.api_key_not_configured",e)}</span
        >
        <div class="api-row">
          <input
            type="password"
            class="si-input flex1"
            placeholder="${Aa("weather_service_config.api_key_placeholder",e)}"
            .value="${this.apiKey}"
          ...
          >
            ${this._testing?Aa("weather_service_config.test_button_testing",e):Aa("weather_service_config.test_button",e)}
          </button>
        </div>
        ${null!==this._testResult?Z`<div
              class="test-result ${this._testResult.success?"success":"error"}"
            >
              ${this._testResult.success?Aa("weather_service_config.test_success",e):Aa("weather_service_config.test_error_"+(null!==(t=this._testResult.error)&&void 0!==t?t:"unknown"),e)}
            </div>`:""}
      </si-field>
    `}static get styles(){return r`
      :host {
    ...
    `}};t([pe({attribute:!1})],Qa.prototype,"hass",void 0),t([pe({type:Boolean})],Qa.prototype,"useWeather",void 0),t([pe()],Qa.prototype,"service",void 0),t([pe()],Qa.prototype,"apiKey",void 0),t([pe({attribute:!1})],Qa.prototype,"weatherConfig",void 0),t([ge()],Qa.prototype,"_testing",void 0),t([ge()],Qa.prototype,"_testResult",void 0),Qa=t([ce("si-weather-source-config")],Qa);let en=class extends(Pa(le)){constructor(){super(...arguments),this.section="all",this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._weatherConfig=null,this._weatherService=null,this._useWeatherService=!1,this._newApiKey="",this._weatherSaving=!1,this._coords=null,this._coordsEnabled=!1,this._coordsLat="",this._coordsLon="",this._coordsElev="",this._coordsSaving=!1,this._saveStatus="idle",this._savedResetTimer=null,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null,t={};return s=>{t=Object.assign(Object.assign({},t),s),e&&clearTimeout(e),e=window.setTimeout(()=>{const s=t;t={},e=null,this.saveData(s)},500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){var e;if(!this.hass)return;const t=!this._initialLoadDone;t&&(this.isLoading=!0,this._scheduleUpdate());try{const[t,a,n]=await Promise.all([$s(this.hass),Is(this.hass),Ls(this.hass)]);this.config=t,this._weatherConfig=a,this._useWeatherService=a.use_weather_service,this._weatherService=null!==(e=a.weather_service)&&void 0!==e?e:ze,this._applyCoordinates(n),this.data=(s=this.config,i=["calctime","autocalcenabled","autocalcmode","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","days_between_irrigation"],s?Object.entries(s).filter(([e])=>i.includes(e)).reduce((e,[t,s])=>Object.assign(e,{[t]:s}),{}):{}),this._initialLoadDone=!0}catch(e){console.error("Error fetching data:",e),Ia(this,this.hass,"common.errors.load_failed",e)}finally{t&&(this.isLoading=!1),this._scheduleUpdate()}var s,i}firstUpdated(){Rs().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}render(){var e,t;return this.hass&&this.config&&this.data?this.isLoading?Z`<div class="loading-indicator">
        ${Aa("common.loading-messages.general",this.hass.language)}
      </div>`:Z`${this._renderSaveStatus()} ${this._renderCards()}`:Z`<div class="loading-indicator">
        ${Aa("common.loading-messages.configuration",null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en")}
      ...
      <div class="settings-section-header">
        ${Aa(`panels.general.sections.${e}`,this.hass.language)}
      </div>
    `:Z``}async _saveWeatherConfig(){if(this.hass){this._weatherSaving=!0,this._scheduleUpdate();try{await Ns(this.hass,this._useWeatherService,this._useWeatherService?this._weatherService:null,this._newApiKey||null),this._newApiKey="",await this._fetchData()}catch(e){console.error("Failed to save weather config:",e),Ia(this,this.hass,"common.errors.save_failed",e)}finally{this._weatherSaving=!1,this._scheduleUpdate()}}}_renderWeatherServiceCard(){var e;return this.hass?Z`
      <ha-card
        header="${Aa("weather_service_config.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Aa("weather_service_config.description",this.hass.language)}
        </div>
        <div class="card-content">
          ...
          <div style="margin-top: 12px;">
            ...
            >
              ${this._weatherSaving?Aa("common.saving-messages.saving",this.hass.language):Aa("weather_service_config.save_button",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    `:Z``}_renderAutoUpdateCard(){var e,t;return this.hass&&this.config&&this.data?Z`
      <ha-card
        header="${Aa("panels.general.cards.automatic-update.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Aa("panels.general.cards.automatic-update.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Aa("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}
            </label>
            <ha-switch
          ...
          ${this.data.autoupdateenabled?Z`
                <div class="setting-row">
                  <label>
                    ${Aa("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}
                  </label>
                  <div class="inline-row">
                    ...
                    <select
                      ...
                      .value="${Xa(this.data.autoupdateschedule||Ce)}"
                      @change="${e=>this.handleConfigChange({autoupdateschedule:e.target.value})}"
                    >
                      <option
                        value="${Ae}"
                        ?selected="${(this.data.autoupdateschedule||Ce)===Ae}"
                      >
                        ${Aa("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
                      </option>
                      <option
                        value="${Ce}"
                        ?selected="${(this.data.autoupdateschedule||Ce)===Ce}"
                      >
                        ${Aa("panels.general.cards.automatic-update.options.hours",this.hass.language)}
                      </option>
                      <option
                        value="${Ee}"
                        ?selected="${this.data.autoupdateschedule===Ee}"
                      >
                        ${Aa("panels.general.cards.automatic-update.options.days",this.hass.language)}
                      </option>
                    </select>
                  </div>
                </div>
                <div class="setting-row">
                  <label>
                    ${Aa("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language)}
                    (s)
                  </label>
                  <input
                    type="number"
    ...
    `:Z``}_renderAutoCalcCard(){return this.hass&&this.config&&this.data?Z`
      <ha-card
        header="${Aa("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Aa("panels.general.cards.automatic-duration-calculation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Aa("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}
            </label>
            <ha-switch
    ...
    `:Z``}_renderAutoCalcMode(){if(!this.hass||!this.config)return Z``;const e=this.hass.language,t=ye.includes(this.config.autocalcmode)?this.config.autocalcmode:be;return Z`
      <div class="setting-row">
        <label>
          ${Aa("panels.general.cards.automatic-duration-calculation.labels.calc-mode",e)}
        </label>
        <select
          class="settings-input"
          .value="${Xa(t)}"
        ...
        >
          ${ye.map(s=>Z`
              <option value="${s}" ?selected="${t===s}">
                ${Aa(`panels.general.cards.automatic-duration-calculation.modes.${s}`,e)}
              </option>
            `)}
        </select>
      </div>
      ${t===be?Z`
            <div class="setting-row">
              <label>
                ${Aa("panels.general.cards.automatic-duration-calculation.labels.calc-time",e)}
              </label>
              <input
                type="text"
                class="settings-input shortfield"
          ...
          `:Z`
            <div class="card-content description-text">
              ${Aa("panels.general.cards.automatic-duration-calculation.help.before-run",e)}
            </div>
          `}
    `}_renderRunHistoryLoggingCard(){return this.hass&&this.config?Z`
      <ha-card
        header="${Aa("panels.general.cards.run-history-logging.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Aa("panels.general.cards.run-history-logging.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Aa("panels.general.cards.run-history-logging.labels.log-no-demand",this.hass.language)}
            </label>
            <ha-switch
    ...
    `:Z``}_renderWeatherSkipCard(){var e,t,s,i,a;if(!this.hass||!this.config||!this.data)return Z``;const n=this.hass.language,o=this.config.skip_irrigation_on_precipitation?"skip":this.config.forecast_weighting_enabled?"water_less":"ignore";return Z`
      <ha-card header="${Aa("weather_skip.title",this.hass.language)}">
        <div class="card-content description-text">
          ${Aa("weather_skip.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Aa("weather_skip.forecast_rain_label",n)}
            </label>
            <select
              class="settings-input"
              .value="${Xa(o)}"
            ...
            >
              ${["ignore","water_less","skip"].map(e=>Z`
                  <option value="${e}" ?selected="${o===e}">
                    ${Aa(`weather_skip.forecast_rain_options.${e}`,n)}
                  </option>
                `)}
            </select>
          </div>
          <div class="description-text">
            ${Aa(`weather_skip.forecast_rain_help.${o}`,n)}
          </div>
          ${"ignore"!==o?Z`
                <div class="setting-row">
                  <label>
                    ${Aa("weather_skip.lookahead_label",n)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="description-text">
                  ${Aa("weather_skip.lookahead_help",n)}
                </div>
              `:""}
          ${"skip"===o?Z`
                <div class="setting-row">
                  <label>
                    ${Aa("weather_skip.threshold_label",n)}
                    (${Ta(this.config,we)})
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Aa("weather_skip.temp_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Aa("weather_skip.temp_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_temp_enabled?Z`
                <div class="setting-row">
                  <label>
                    ${Aa("weather_skip.temp_threshold_label",this.hass.language)}
                    (°C)
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Aa("weather_skip.wind_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Aa("weather_skip.wind_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_wind_enabled?Z`
                <div class="setting-row">
                  <label>
                    ${Aa("weather_skip.wind_threshold_label",this.hass.language)}
                    (m/s)
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Aa("weather_skip.freeze_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Aa("weather_skip.freeze_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_freeze_enabled?Z`
                <div class="setting-row">
                  <label>
                    ${Aa("weather_skip.freeze_threshold_label",this.hass.language)}
                    (°C)
                  </label>
                  <input
                    type="number"
                ...
                <div class="description-text">
                  ${Aa("weather_skip.freeze_help",this.hass.language)}
                </div>
              `:""}

          <div class="section-divider">
            ${Aa("weather_skip.rain_sensor_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Aa("weather_skip.rain_sensor_label",this.hass.language)}
            </label>
            <ha-entity-picker
              .hass="${this.hass}"
      ...
      >
        ...
        <div class="card-content">
          ...
          ${this._coordsEnabled?Z`
                <div class="setting-row">
                  <label>
                    ${Aa("coordinate_config.latitude",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="setting-row">
                  <label>
                    ${Aa("coordinate_config.longitude",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="setting-row">
                  <label>
                    ${Aa("coordinate_config.elevation",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
              ...
              `:Z`
                ...
                >
                  ${Aa("coordinate_config.current_ha_coords",this.hass.language)}:
                  ${Aa("coordinate_config.latitude",this.hass.language)}:
          ...
          <div style="margin-top: 12px;">
            ...
            >
              ${this._coordsSaving?Aa("common.saving-messages.saving",this.hass.language):Aa("common.actions.save",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    `}_renderDaysBetweenIrrigationCard(){var e;return this.hass&&this.config&&this.data?Z`
      <ha-card
        header="${Aa("days_between_irrigation.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Aa("days_between_irrigation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Aa("days_between_irrigation.label",this.hass.language)}
              <div class="setting-description">
                ${Aa("days_between_irrigation.help_text",this.hass.language)}
              </div>
            </label>
            <input
              type="number"
    ...
    `:Z``}_renderZoneSequencingCard(){var e,t;if(!this.hass||!this.config||!this.data)return Z``;const s=(this.config.zone_sequencing||Ft)===Zt;return Z`
      <ha-card
        header="${Aa("zone_sequencing.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Aa("zone_sequencing.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Aa("zone_sequencing.title",this.hass.language)}
            </label>
            <select
              class="settings-input"
              .value="${Xa(this.config.zone_sequencing||Ft)}"
            ...
            >
              ...
              >
                ${Aa("zone_sequencing.parallel",this.hass.language)}
              </option>
              <option
                value="${jt}"
                ?selected="${this.config.zone_sequencing===jt}"
              >
                ${Aa("zone_sequencing.sequential",this.hass.language)}
              </option>
              <option
                value="${Zt}"
                ?selected="${this.config.zone_sequencing===Zt}"
              >
                ${Aa("zone_sequencing.rotating",this.hass.language)}
              </option>
            </select>
          </div>
          ${s?Z`
                <div class="setting-row">
                  <label>
                    ${Aa("zone_sequencing.max_consecutive_duration_label",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    min="1"
                  ...
                  <span class="unit-label">
                    ${Aa("zone_sequencing.max_consecutive_duration_unit",this.hass.language)}
                  </span>
                </div>
                <div class="setting-row">
                  <label>
                    ${Aa("zone_sequencing.min_absorption_time_label",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    min="0"
                  ...
                  />
                  <span class="unit-label">
                    ${Aa("zone_sequencing.min_absorption_time_unit",this.hass.language)}
                  </span>
                </div>
              `:""}
        </div>
    ...
    `}_renderBatchCard(){var e;if(!this.hass||!this.config)return Z``;const t=!!this.config.batch_run_service,s=this.config.batch_paused_entity;return Z`
      <ha-card header="${Aa("batch.title",this.hass.language)}">
        <div class="card-content description-text">
          ${Aa("batch.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${Aa("batch.run_service",this.hass.language)}</label>
            <ha-entity-picker
              .hass="${this.hass}"
          ...
          <div class="description-text">
            ${Aa("batch.run_service_help",this.hass.language)}
          </div>
          ${t?Z`
                <div class="setting-row">
                  <label
                    >${Aa("batch.stop_service",this.hass.language)}</label
                  >
                  <ha-entity-picker
                    .hass="${this.hass}"
                ...
                <div class="description-text">
                  ${Aa("batch.stop_service_help",this.hass.language)}
                </div>
                ${this.config.batch_stop_service?"":Z`<div class="batch-warning">
                      ${Aa("batch.stop_service_missing",this.hass.language)}
                    </div>`}
                <div class="setting-row">
                  <label
                    >${Aa("batch.paused_entity",this.hass.language)}</label
                  >
                  <ha-entity-picker
                    .hass="${this.hass}"
                    .value="${s||""}"
                ...
                <div class="description-text">
                  ${Aa("batch.paused_entity_help",this.hass.language)}
                </div>
                ${s?Z`
                      <div class="setting-row">
                        <label>
                          ${Aa("batch.pause_timeout",this.hass.language)}
                        </label>
                        <input
                          type="number"
                          min="0"
                          ...
                          @change="${e=>{const t=parseInt(e.target.value,10);isNaN(t)||this.handleConfigChange({[Xt]:Math.max(0,t)})}}"
                        />
                        <span class="unit-label">
                          ${Aa("batch.pause_timeout_unit",this.hass.language)}
                        </span>
                      </div>
                      <div class="description-text">
                        ${Aa("batch.pause_timeout_help",this.hass.language)}
                      </div>
                      <div class="setting-row">
                        <label>
                          ${Aa("batch.pause_timeout_service",this.hass.language)}
                        </label>
                        <ha-entity-picker
                          .hass="${this.hass}"
                      ...
                      <div class="description-text">
                        ${Aa("batch.pause_timeout_service_help",this.hass.language)}
                      </div>
                    `:""}
                <div class="batch-warning">
                  ${Aa("batch.master_warning",this.hass.language)}
                </div>
              `:""}
        </div>
      </ha-card>
    `}_renderMasterSwitchCard(){var e,t;if(!this.hass||!this.config)return Z``;const s=!!this.config.master_kick_enabled;return Z`
      <ha-card header="${Aa("master.title",this.hass.language)}">
        <div class="card-content description-text">
          ${Aa("master.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${Aa("master.entity",this.hass.language)}</label>
            <ha-entity-picker
              .hass="${this.hass}"
          ...
          ${this.config.master_entity?Z`
                <div class="setting-row">
                  <label
                    >${Aa("master.kick_enabled",this.hass.language)}</label
                  >
                  <ha-switch
                    .checked="${s}"
                ...
                ${s?Z`
                      <div class="setting-row">
                        <label>
                          ${Aa("master.kick_pause",this.hass.language)}
                        </label>
                        <input
                          type="number"
                          min="0"
                          ...
                          @input="${e=>{const t=parseFloat(e.target.value);isNaN(t)||this.handleConfigChange({[ts]:t})}}"
                        />
                        <span class="unit-label">
                          ${Aa("master.seconds_unit",this.hass.language)}
                        </span>
                      </div>
                    `:""}
                <div class="setting-row">
                  <label
                    >${Aa("master.settle",this.hass.language)}</label
                  >
                  <input
                    type="number"
                    min="0"
                ...
                <div class="setting-row">
                  <label
                    >${Aa("master.off_after",this.hass.language)}</label
                  >
                  <ha-switch
    ...
    `}};t([pe()],en.prototype,"narrow",void 0),t([pe()],en.prototype,"path",void 0),t([pe()],en.prototype,"section",void 0),t([pe()],en.prototype,"data",void 0),t([pe()],en.prototype,"config",void 0),t([pe({type:Boolean})],en.prototype,"isLoading",void 0),t([pe({type:Boolean})],en.prototype,"isSaving",void 0),t([pe()],en.prototype,"_weatherConfig",void 0),t([pe()],en.prototype,"_weatherService",void 0),t([pe({type:Boolean})],en.prototype,"_useWeatherService",void 0),t([pe()],en.prototype,"_newApiKey",void 0),t([pe({type:Boolean})],en.prototype,"_weatherSaving",void 0),t([ge()],en.prototype,"_coords",void 0),t([ge()],en.prototype,"_coordsEnabled",void 0),t([ge()],en.prototype,"_coordsLat",void 0),t([ge()],en.prototype,"_coordsLon",void 0),t([ge()],en.prototype,"_coordsElev",void 0),t([ge()],en.prototype,"_coordsSaving",void 0),t([ge()],en.prototype,"_saveStatus",void 0),en=t([ce("smart-irrigation-view-general")],en);const tn=e=>9*e/5+32;function sn(e,t,s){if(null==e||Number.isNaN(e))return null;switch(t){case"temperature":return s?{value:e,unit:"°C"}:{value:tn(e),unit:"°F"};case"precipitation":return s?{value:e,unit:at}:{value:(n=e,n/25.4),unit:nt};case"windspeed":return s?{value:e,unit:lt}:{value:(a=e,2.2369362920544*a),unit:rt};case"pressure":return s?{value:e,unit:"hPa"}:{value:(i=e,.0295299830714*i),unit:ot}}var i,a,n}function an(e,t,s,i){const a=sn(e,t,s);if(!a)return"-";const n=function(e,t){return"pressure"===e?t?0:2:"precipitation"===e?t?1:2:1}(t,s);return`${a.value.toFixed(n)} ${a.unit}`}function nn(e,t){return null==e||Number.isNaN(e)?"-":t?`${e.toFixed(0)} L`:`${(e=>.264172052*e)(e).toFixed(1)} gal`}let on=class extends le{constructor(){super(...arguments),this.metric=!0,this.name="",this.size="",this.throughput="",this.linkedEntity="",this.showEntity=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{value:t},bubbles:!0,composed:!0}))}render(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=this.metric?"m²":et,a=this.metric?tt:st;return Z`
      <si-field label="${Aa("panels.zones.labels.name",s)}" required>
        <input
          type="text"
          class="si-input"
          .value="${this.name}"
      ...
      <si-field
        label="${Aa("panels.zones.labels.size",s)}"
        unit="${i}"
        help="${Aa("field_help.zone_size",s)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      <si-field
        label="${Aa("panels.zones.labels.throughput",s)}"
        unit="${a}"
        help="${Aa("field_help.zone_throughput",s)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      ${this.showEntity?Z`
            <si-field
              label="${Aa("panels.zones.labels.linked_entity",s)}"
              help="${Aa("field_help.zone_linked_entity",s)}"
            >
              <ha-entity-picker
                .hass="${this.hass}"
    ...
    `}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await zs(this.hass,e)}_renderModuleOptions(e){if(!this.hass)return Z``;const t=null!=e?String(e):"";return Z`
      <option value="" ?selected="${""===t}">
        ---${Aa("common.labels.select",this.hass.language)}---
      </option>
    ...
    `}_renderDistributorSelector(e,t){var s,i;if(!this.hass)return Z``;if(!(null===(s=this.config)||void 0===s?void 0:s.distributors_enabled))return Z``;const a=this.hass.language,n=null!=e.distributor_id;return Z`
      <ha-settings-row>
        <span slot="heading"
          >${Aa("panels.zones.labels.distributor",a)}</span
        >
        <span slot="description"
          >${Aa("panels.zones.labels.distributor_help",a)}</span
        >
        <select
          class="settings-input"
          .value="${Xa(n?String(e.distributor_id):"")}"
          @change="${s=>this._onZoneDistributorChange(t,e,s)}"
        >
          <option value="" ?selected="${!n}">
            ${Aa("panels.zones.labels.distributor_none",a)}
          </option>
      ...
      ${n?Z`
            <ha-settings-row>
              <span slot="heading"
                >${Aa("panels.zones.labels.outlet_number",a)}</span
              >
              <span slot="description"
                >${Aa("panels.zones.labels.outlet_number_readonly_help",a)}</span
              >
        ...
        ${b?Z`
             ...
             used to sit alongside it moved to the Weather & Location tab). -->
              <div class="card-content zone-settings">
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.name",this.hass.language)}</span
                  >
                  <input
                    type="text"
                    class="settings-input"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.size",this.hass.language)}
                    (${Ta(this.config,ut)})</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.throughput",this.hass.language)}
                    (${Ta(this.config,pt)})</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.soil_type",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Aa("field_help.zone_soil_type",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${Xa(null!==(i=Object.keys(Rt).find(t=>Rt[t]===e.drainage_rate))&&void 0!==i?i:"custom")}"
                    @change="${s=>{const i=s.target.value;"custom"!==i&&void 0!==Rt[i]&&this.handleEditZone(t,Object.assign(Object.assign({},e),{[xt]:Rt[i]}))}}"
                  >
                    <option
                      value="custom"
                      ?selected="${!Object.values(Rt).includes(null!==(a=e.drainage_rate)&&void 0!==a?a:-1)}"
                    >
                      ${Aa("panels.zones.labels.soil_types.custom",this.hass.language)}
                    </option>
                    ${Object.keys(Rt).map(t=>Z`
                        <option
                          value="${t}"
                          ?selected="${Rt[t]===e.drainage_rate}"
                        >
                          ${Aa(`panels.zones.labels.soil_types.${t}`,this.hass.language)}
                        </option>
                      `)}
                  </select>
                </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.drainage_rate",this.hass.language)}
                    (${Ta(this.config,xt)})</span
                  >
                  <span slot="description"
                    >${Aa("field_help.zone_drainage_rate",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.plant_type",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Aa("field_help.zone_plant_type",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${Xa(null!==(o=e.plant_type)&&void 0!==o?o:"custom")}"
                    @change="${s=>{const i=s.target.value,a={[zt]:i};"custom"!==i&&void 0!==Bt[i]&&(a.kc=Bt[i]),this.handleEditZone(t,Object.assign(Object.assign({},e),a))}}"
                  >
                    <option
                      value="custom"
                      ?selected="${"custom"===(null!==(r=e.plant_type)&&void 0!==r?r:"custom")}"
                    >
                      ${Aa("panels.zones.labels.plant_types.custom",this.hass.language)}
                    </option>
                    ${Object.keys(Bt).map(t=>Z`
                        <option
                          value="${t}"
                          ?selected="${e.plant_type===t}"
                        >
                          ${Aa(`panels.zones.labels.plant_types.${t}`,this.hass.language)}
                        </option>
                      `)}
                  </select>
                </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.kc",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Aa("field_help.zone_kc",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.state",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${Xa(e.state)}"
                  ...
                  >
                    <option
                      value="${Ra.Automatic}"
                      ?selected="${e.state===Ra.Automatic}"
                    >
                      ${Aa("panels.zones.labels.states.automatic",this.hass.language)}
                    </option>
                    <option
                      value="${Ra.Manual}"
                      ?selected="${e.state===Ra.Manual}"
                    >
                      ${Aa("panels.zones.labels.states.manual",this.hass.language)}
                    </option>
                    <option
                      value="${Ra.Disabled}"
                      ?selected="${e.state===Ra.Disabled}"
                    >
                      ${Aa("panels.zones.labels.states.disabled",this.hass.language)}
                    </option>
                  </select>
                </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("common.labels.module",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${Xa(void 0!==e.module?String(e.module):"")}"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.mapping",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${Xa(void 0!==e.mapping?String(e.mapping):"")}"
                ...
                ${null!=e.distributor_id?Z`<div class="distributor-managed">
                      ${Aa("panels.zones.labels.distributor_managed_note",this.hass.language)}
                    </div>`:Z`
                      <ha-settings-row>
                        <span slot="heading"
                          >${Aa("panels.zones.labels.watering_mode",this.hass.language)}</span
                        >
                        <span slot="description"
                          >${Aa("panels.zones.labels.watering_mode_description",this.hass.language)}</span
                        >
                        <select
                          class="settings-input"
                          .value="${Xa(null!==(d=e.watering_mode)&&void 0!==d?d:"classic")}"
                        ...
                        >
                          ...
                          >
                            ${Aa("panels.zones.labels.watering_modes.classic",this.hass.language)}
                          </option>
                          <option
                            value="service"
                            ?selected="${"service"===e.watering_mode}"
                          >
                            ${Aa("panels.zones.labels.watering_modes.service",this.hass.language)}
                          </option>
                          <option
                            value="${fs}"
                            ?selected="${e.watering_mode===fs}"
                          >
                            ${Aa("panels.zones.labels.watering_modes.opensprinkler",this.hass.language)}
                          </option>
                          <option
                            value="${bs}"
                            ?selected="${e.watering_mode===bs}"
                          >
                            ${Aa("panels.zones.labels.watering_modes.batch",this.hass.language)}
                          </option>
                        </select>
                      </ha-settings-row>

                      ${e.watering_mode===bs?Z`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Aa("panels.zones.labels.batch_valve",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Aa("panels.zones.labels.batch_valve_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                            ...
                            ${e.confirm_entity?"":Z`<div class="zone-warning">
                                  ${Aa("panels.zones.labels.batch_valve_missing",this.hass.language)}
                                </div>`}
                          `:""}
                      ${"service"===e.watering_mode?Z`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Aa("panels.zones.labels.run_service",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Aa("panels.zones.labels.run_service_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                                .value="${e.run_service||""}"
                            ...
                            <ha-settings-row>
                              <span slot="heading"
                                >${Aa("panels.zones.labels.duration_field",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Aa("panels.zones.labels.duration_field_help",this.hass.language)}</span
                              >
                              <input
                                type="text"
                                class="settings-input"
                                placeholder="${Aa("panels.zones.labels.duration_field_placeholder",this.hass.language)}"
                            ...
                            <ha-settings-row>
                              <span slot="heading"
                                >${Aa("panels.zones.labels.duration_unit",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Aa("panels.zones.labels.duration_unit_help",this.hass.language)}</span
                              >
                              <select
                                class="settings-input"
                                .value="${Xa(null!==(h=e.duration_unit)&&void 0!==h?h:"seconds")}"
                              ...
                              >
                                ...
                                >
                                  ${Aa("panels.zones.labels.duration_units.seconds",this.hass.language)}
                                </option>
                                <option
                                  value="minutes"
                                  ?selected="${"minutes"===e.duration_unit}"
                                >
                                  ${Aa("panels.zones.labels.duration_units.minutes",this.hass.language)}
                                </option>
                              </select>
                            </ha-settings-row>
                            <ha-settings-row>
                              <span slot="heading"
                                >${Aa("panels.zones.labels.stop_service",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Aa("panels.zones.labels.stop_service_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                            ...
                            <ha-settings-row>
                              <span slot="heading"
                                >${Aa("panels.zones.labels.confirm_entity",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Aa("panels.zones.labels.confirm_entity_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                                .value="${e.confirm_entity||""}"
                            ...
                            ${(null===(p=this.config)||void 0===p?void 0:p.observed_watering_enabled)?Z`
                                  <ha-settings-row>
                                    <span slot="heading"
                                      >${Aa("panels.zones.labels.observed_entity",this.hass.language)}</span
                                    >
                                    <span slot="description"
                                      >${Aa("panels.zones.labels.observed_entity_help",this.hass.language)}</span
                                    >
                                    <ha-entity-picker
                                      .hass="${this.hass}"
                                ...
                                `:""}
                          `:""}
                      ${e.watering_mode===fs?Z`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Aa("panels.zones.labels.opensprinkler_station",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Aa("panels.zones.labels.opensprinkler_station_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                            ...
                            ${this._hasOpenSprinklerStations()?"":Z`<div class="distributor-managed">
                                  ${Aa("panels.zones.labels.opensprinkler_no_stations",this.hass.language)}
                                </div>`}
                          `:"service"!==e.watering_mode?Z`
                              <ha-settings-row>
                                <span slot="heading"
                                  >${Aa("panels.zones.labels.linked_entity",this.hass.language)}</span
                                >
                                <ha-entity-picker
                                  .hass="${this.hass}"
                                  .value="${e.linked_entity||""}"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.soil_moisture_sensor",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Aa("panels.zones.labels.soil_moisture_sensor_help",this.hass.language)}</span
                  >
                  <ha-entity-picker
                    .hass="${this.hass}"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.soil_moisture_threshold",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Aa("panels.zones.labels.soil_moisture_threshold_help",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                    ...
                    @input="${s=>{const i=s.target.value,a=""===i?null:Number(i);this.handleEditZone(t,Object.assign(Object.assign({},e),{[Pt]:null===a||isNaN(a)?null:a}))}}"
                  />
                </ha-settings-row>
                ...
                ${null==e.distributor_id?Z`
                      <ha-settings-row>
                        <span slot="heading"
                          >${Aa("panels.zones.labels.flow_sensor",this.hass.language)}</span
                        >
                        <ha-entity-picker
                          .hass="${this.hass}"
                          .value="${e.flow_sensor||""}"
                      ...
                      ${this._flowSensorIsTotalizer(e)?Z`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Aa("panels.zones.labels.flow_counter_type",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Aa("panels.zones.labels.flow_counter_type_help",this.hass.language)}</span
                              >
                              <select
                                class="settings-input"
                                .value="${Xa(e.flow_counter_type||"auto")}"
                                @change="${s=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Et]:s.target.value||"auto"}))}"
                              >
                                ${["auto","per_run","lifetime"].map(t=>Z`
                                    ...
                                    >
                                      ${Aa(`panels.zones.labels.flow_counter_type_${t}`,this.hass.language)}
                                    </option>
                                  `)}
                              </select>
                            </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.maximum-bucket",this.hass.language)}
                    (${Ta(this.config,_t)})</span
                  >
                  <input
                    type="number"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.multiplier",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.lead-time",this.hass.language)}
                    (${it})</span
                  >
                  <input
                    type="number"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.maximum-duration",this.hass.language)}
                    (${it})</span
                  >
                  <input
                    type="number"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Aa("panels.zones.labels.bucket_threshold",this.hass.language)}
                    (${Ta(this.config,_t)})</span
                  >
                  <input
                    type="number"
                ...
                ${e.state===Ra.Manual?Z`
                      <ha-settings-row>
                        <span slot="heading"
                          >${Aa("panels.zones.labels.duration",this.hass.language)}
                          (${it})</span
                        >
                        <input
                          type="number"
                ...
                <div class="settings-danger-row">
                  <button
                    class="action-btn"
                    @click="${()=>{this._pendingConfirm={title:Aa("panels.zones.confirm_action.reset_bucket_title",this.hass.language),body:Aa("panels.zones.confirm_action.reset_bucket_body",this.hass.language),confirmLabel:Aa("panels.zones.actions.reset-bucket",this.hass.language),onConfirm:()=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[_t]:0}))}}}"
                    ?disabled="${this.isSaving}"
                  >
                    ${Aa("panels.zones.actions.reset-bucket",this.hass.language)}
                  </button>
                  <button
                  ...
                  >
                    ...
                    ${Aa("common.actions.delete",this.hass.language)}
                  </button>
                </div>
              </div>
              ...
              ${e.explanation&&e.explanation.length>0?Z`
                    <ha-expansion-panel
                      .header="${Aa("panels.zones.actions.information",this.hass.language)}"
                    >
                      <div class="card-content">
                        ${Ks(e.explanation)}
                      </div>
    ...
    `}_renderRunHistory(e){var t,s,i;if(!this.hass)return Z``;const a=(null===(t=this.config)||void 0===t?void 0:t.units)===Oe,n=null!==(s=e.run_log)&&void 0!==s?s:[],o=this.hass.language;return Z`
      <ha-expansion-panel
        .header="${Aa("panels.zones.history.title",o)}"
      >
        <div class="card-content">
          <div class="history-usage">
            <span class="history-usage-label"
              >${Aa("panels.zones.history.total_used",o)}</span
            >
            <span class="history-usage-value"
              >${nn(null!==(i=e.water_used_total)&&void 0!==i?i:0,a)}</span
            >
          </div>
          ${0===n.length?Z`<div class="weather-note">
                ${Aa("panels.zones.history.empty",o)}
              </div>`:Z`
                <table class="history-table">
                  <thead>
                    <tr>
                      <th>${Aa("panels.zones.history.when",o)}</th>
                      <th>${Aa("panels.zones.history.result",o)}</th>
                      <th class="num">
                        ${Aa("panels.zones.history.volume",o)}
                      </th>
                      <th>${Aa("panels.zones.history.detail",o)}</th>
                    </tr>
                  </thead>
                  <tbody>
    ...
    `}_renderRunLogRow(e,t){const s=this.hass.language,i=Aa(`panels.zones.history.results.${e.result}`,s);let a="";return e.detail&&(a="skipped"===e.result?e.detail.split(",").map(e=>Aa(`panels.zones.outlook.checks.${e}`,s)||e).join(", "):/^[A-Za-z0-9_-]+$/.test(e.detail)&&Aa(`panels.zones.fault.${e.detail}`,s)||e.detail),Z`
      <tr>
        <td>${Ga(e.ts)}</td>
        <td>
        ...
        <td class="num">
          ${e.volume_l>0?nn(e.volume_l,t):"-"}
        </td>
        <td class="history-detail">${Ks(a)}</td>
      </tr>
    `}render(){var e;if(!this.hass)return Z``;if(this.isLoading)return Z`
      ...
      <ha-card>
        <div class="card-header">
          ...
          <ha-icon-button
            .path="${La}"
            title="${Aa("panels.zones.cards.add-zone.header",this.hass.language)}"
      ...
      <ha-dialog
        ...
        heading="${Aa("panels.zones.cards.add-zone.header",this.hass.language)}"
      >
        ...
        <div class="dialog-footer">
          ...
          >
            ${this.isSaving?Aa("common.saving-messages.adding",this.hass.language):Aa("panels.zones.cards.add-zone.actions.add",this.hass.language)}
          </button>
        </div>
      </ha-dialog>
      ...
      ${t?Z`
            <ha-dialog
              ...
              heading="${Aa("common.actions.confirm_delete",this.hass.language)}"
            >
              <p>
                ${Aa("common.actions.confirm_delete_zone",this.hass.language)}
              </p>
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${Aa("common.labels.bulk_actions",this.hass.language)}
          </div>
        </div>
        <div class="card-content bulk-actions">
          <button
            class="action-btn danger-button"
            @click="${()=>{this._pendingConfirm={title:Aa("panels.zones.confirm_action.reset_all_buckets_title",this.hass.language),body:Aa("panels.zones.confirm_action.reset_all_buckets_body",this.hass.language),confirmLabel:Aa("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language),onConfirm:()=>this.handleResetAllBuckets()}}}"
            ?disabled="${this.isSaving}"
          >
            ${Aa("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language)}
          </button>
          <button
            class="action-btn danger-button"
            @click="${()=>{this._pendingConfirm={title:Aa("panels.zones.confirm_action.clear_weather_title",this.hass.language),body:Aa("panels.zones.confirm_action.clear_weather_body",this.hass.language),confirmLabel:Aa("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language),onConfirm:()=>this.handleClearAllWeatherdata()}}}"
            ?disabled="${this.isSaving}"
          >
            ${Aa("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language)}
          </button>
        </div>
      </ha-card>
    ...
    `}};t([pe()],rn.prototype,"config",void 0),t([pe({attribute:!1})],rn.prototype,"path",void 0),t([pe({type:Array})],rn.prototype,"zones",void 0),t([pe({type:Array})],rn.prototype,"modules",void 0),t([pe({type:Array})],rn.prototype,"mappings",void 0),t([pe({type:Array})],rn.prototype,"distributors",void 0),t([pe({type:Boolean})],rn.prototype,"isLoading",void 0),t([ge()],rn.prototype,"_expanded",void 0),t([pe({type:Boolean})],rn.prototype,"isSaving",void 0),t([pe({type:Boolean})],rn.prototype,"_showAddZone",void 0),t([ge()],rn.prototype,"_pendingConfirm",void 0),t([ge()],rn.prototype,"_saveStatus",void 0),t([pe()],rn.prototype,"_confirmDeleteZoneId",void 0),t([pe()],rn.prototype,"_newZoneName",void 0),t([pe()],rn.prototype,"_newZoneSize",void 0),t([pe()],rn.prototype,"_newZoneThroughput",void 0),t([pe()],rn.prototype,"_newZoneEntity",void 0),rn=t([ce("smart-irrigation-view-zone-settings")],rn);let ln=class extends le{_emit(e){this.dispatchEvent(new CustomEvent("distributor-changed",{detail:{value:Object.assign(Object.assign({},this.distributor),e)},bubbles:!0,composed:!0}))}_onNumber(e,t){const s=t.target.valueAsNumber;isNaN(s)||this._emit({[e]:Math.max(0,Math.round(s))})}render(){var e,t,s,i;if(!this.hass||!this.distributor)return Z``;const a=this.hass.language,n=this.distributor,o=n.watering_mode===_s;return Z`
      <ha-settings-row>
        <span slot="heading"
          >${Aa("panels.distributors.labels.name",a)}</span
        >
        <input
          type="text"
          class="settings-input"
          .value="${null!==(e=n.name)&&void 0!==e?e:""}"
          @input="${e=>this._emit({[is]:e.target.value})}"
        />
      </ha-settings-row>

      <ha-settings-row>
        <span slot="heading"
          >${Aa("panels.zones.labels.watering_mode",a)}</span
        >
        <span slot="description"
          >${Aa("panels.distributors.labels.watering_mode_help",a)}</span
        >
        <select
          class="settings-input"
          .value="${Xa(null!==(t=n.watering_mode)&&void 0!==t?t:vs)}"
          @change="${e=>this._emit({[as]:e.target.value})}"
        >
          <option
            value="${vs}"
            ?selected="${(null!==(s=n.watering_mode)&&void 0!==s?s:vs)===vs}"
          >
            ${Aa("panels.zones.labels.watering_modes.classic",a)}
          </option>
          <option
            value="${_s}"
            ?selected="${n.watering_mode===_s}"
          >
            ${Aa("panels.zones.labels.watering_modes.service",a)}
          </option>
        </select>
      </ha-settings-row>
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Aa("panels.distributors.labels.notify_target",a)}</span
        >
        <span slot="description"
          >${Aa("panels.distributors.labels.notify_target_help",a)}</span
        >
        <input
          type="text"
          class="settings-input"
          placeholder="${Aa("panels.distributors.labels.notify_target_placeholder",a)}"
          .value="${null!==(i=n.notify_target)&&void 0!==i?i:""}"
          @input="${e=>this._emit({[ps]:e.target.value||null})}"
        />
      </ha-settings-row>
    `}_renderInletWatchRows(e){var t;const s=this.distributor,i=s.watering_mode===_s?"panels.distributors.labels.inlet_entity_help_service":"panels.distributors.labels.inlet_entity_help",a=null!==(t=s.watch_mode)&&void 0!==t?t:"ignore";return Z`
      <ha-settings-row>
        <span slot="heading"
          >${Aa("panels.distributors.labels.inlet_entity",e)}</span
        >
        <span slot="description">${Aa(i,e)}</span>
        <ha-entity-picker
          .hass="${this.hass}"
      ...
      ${s.inlet_entity?Z`
            <ha-settings-row>
              <span slot="heading"
                >${Aa("panels.distributors.labels.watch_mode",e)}</span
              >
              <span slot="description"
                >${Aa("panels.distributors.labels.watch_mode_help",e)}</span
              >
              <select
                class="settings-input"
                .value="${Xa(a)}"
                @change="${e=>this._emit({[os]:e.target.value})}"
              >
                ${ms.map(t=>Z`
                    <option value="${t}" ?selected="${a===t}">
                      ${Aa(`panels.distributors.labels.watch_mode_${t}`,e)}
                    </option>
                  `)}
              </select>
            </ha-settings-row>
    ...
    `}_renderServiceRows(e){var t,s;const i=this.distributor;return Z`
      <ha-settings-row>
        <span slot="heading"
          >${Aa("panels.distributors.labels.run_service",e)}</span
        >
        <span slot="description"
          >${Aa("panels.distributors.labels.run_service_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
          .value="${i.run_service||""}"
          .includeDomains="${["script"]}"
          allow-custom-entity
          @value-changed="${e=>this._emit({[rs]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>

      <ha-settings-row>
        <span slot="heading"
          >${Aa("panels.distributors.labels.duration_field",e)}</span
        >
        <span slot="description"
          >${Aa("panels.distributors.labels.duration_field_help",e)}</span
        >
        <input
          type="text"
          class="settings-input"
          placeholder="${Aa("panels.distributors.labels.duration_field_placeholder",e)}"
          .value="${i.duration_field||"duration"}"
          @input="${e=>this._emit({[ds]:e.target.value||"duration"})}"
        />
      </ha-settings-row>

      <ha-settings-row>
        <span slot="heading"
          >${Aa("panels.distributors.labels.duration_unit",e)}</span
        >
        <select
          class="settings-input"
          .value="${Xa(null!==(t=i.duration_unit)&&void 0!==t?t:"seconds")}"
          @change="${e=>this._emit({[cs]:e.target.value})}"
        >
          <option
            value="seconds"
            ?selected="${"seconds"===(null!==(s=i.duration_unit)&&void 0!==s?s:"seconds")}"
          >
            ${Aa("panels.distributors.labels.duration_units.seconds",e)}
          </option>
          <option value="minutes" ?selected="${"minutes"===i.duration_unit}">
            ${Aa("panels.distributors.labels.duration_units.minutes",e)}
          </option>
        </select>
      </ha-settings-row>
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Aa("panels.distributors.labels.stop_service",e)}</span
        >
        <span slot="description"
          >${Aa("panels.distributors.labels.stop_service_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
          ...
          .includeDomains="${["script"]}"
          allow-custom-entity
          @value-changed="${e=>this._emit({[ls]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>
    `}_renderSensorRows(e){const t=this.distributor;return Z`
      <ha-settings-row>
        <span slot="heading"
          >${Aa("panels.distributors.labels.confirm_entity",e)}</span
        >
        <span slot="description"
          >${Aa("panels.distributors.labels.confirm_entity_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
          ...
          allow-custom-entity
          @value-changed="${e=>this._emit({[hs]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>

      <ha-settings-row>
        <span slot="heading"
          >${Aa("panels.distributors.labels.flow_sensor",e)}</span
        >
        <span slot="description"
          >${Aa("panels.distributors.labels.flow_sensor_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
          .value="${t.flow_sensor||""}"
    ...
    `}_renderTimingRows(e){var t,s,i,a;const n=this.distributor,o=(null!==(t=n.pause_seconds)&&void 0!==t?t:0)<10,r=(null!==(s=n.skip_pulse_seconds)&&void 0!==s?s:0)<10;return Z`
      <ha-settings-row>
        <span slot="heading"
          >${Aa("panels.distributors.labels.pause_seconds",e)}
          (${it})</span
        >
        <span slot="description"
          >${Aa("field_help.distributor_pause_seconds",e)}</span
        >
        <input
          type="number"
          class="settings-input shortfield"
      ...
      ${o?Z`<div class="timing-warning">
            ${Aa("panels.distributors.hints.below_floor_pause",e)}
          </div>`:""}

      <ha-settings-row>
        <span slot="heading"
          >${Aa("panels.distributors.labels.skip_pulse_seconds",e)}
          (${it})</span
        >
        <span slot="description"
          >${Aa("field_help.distributor_skip_pulse_seconds",e)}</span
        >
        <input
          type="number"
          class="settings-input shortfield"
      ...
      ${r?Z`<div class="timing-warning">
            ${Aa("panels.distributors.hints.below_floor_skip",e)}
          </div>`:""}
    `}static get styles(){return r`
      ${Fa}
      ...
      <div class="outlet-config">
        <div class="commissioning-head">
          <span class="section-title"
            >${Aa("panels.distributors.outlets.title",t)}</span
          >
        </div>
        <div class="item-description">
          ${Aa("panels.distributors.outlets.help",t)}
        </div>
        ${0===this.zones.length?Z`<div class="weather-note">
              ${Aa("panels.distributors.outlets.no_zones",t)}
            </div>`:Z`
              <ha-settings-row>
                <span slot="heading"
                  >${Aa("panels.distributors.outlets.count",t)}</span
                >
                <select
                  class="settings-input shortfield"
                  .value="${Xa(String(i))}"
              ...
              ${o?Z`<div class="timing-warning">
                    ${Aa("panels.distributors.outlets.gap_warning",t)}
                  </div>`:""}
              <div class="commissioning-note">
                ${Aa("panels.distributors.hints.outlet_change",t)}
              </div>
            `}
      </div>
    `}_renderAdvisories(){var e,t;if(!this.hass)return Z``;const s=this.hass.language,i=null===(e=this.config)||void 0===e?void 0:e.zone_sequencing,a=i===Ft,n=i===jt||i===Zt,o=!!(null===(t=this.config)||void 0===t?void 0:t.master_off_after);return Z`
      <div class="advisories">
        <div class="advisory">
          <ha-icon icon="mdi:flask-outline"></ha-icon>
          <span
            >${Aa("panels.distributors.hints.experimental",s)}</span
          >
        </div>
        <div class="advisory">
          <ha-icon icon="mdi:water-alert-outline"></ha-icon>
          <span>${Aa("panels.distributors.hints.pressure",s)}</span>
        </div>
        ${a?Z`<div class="advisory">
              <ha-icon icon="mdi:information-outline"></ha-icon>
              <span
                >${Aa("panels.distributors.hints.parallel_draw",s)}</span
              >
            </div>`:""}
        ${n&&o?Z`<div class="advisory">
              <ha-icon icon="mdi:information-outline"></ha-icon>
              <span
                >${Aa("panels.distributors.hints.master_off_after",s)}</span
              >
            </div>`:""}
      </div>
    `}_renderCommissioning(e){var t;if(!this.hass)return Z``;const s=this.hass.language,i="synced"===e.position_state,a=!!e.commissioning_confirmed,n=!!e.active_cycle&&Object.keys(e.active_cycle).length>0,o=e.id;return Z`
      <div class="commissioning">
        <div class="commissioning-head">
          <span class="section-title"
            >${Aa("panels.distributors.commissioning.title",s)}</span
          >
          <span class="pos-badge pos-${e.position_state}">
            ${Aa("panels.distributors.commissioning.outlet",s)}
            ${e.current_outlet} ·
            ${Aa(`panels.distributors.commissioning.states.${e.position_state}`,s)}
          </span>
        </div>
        ...
        <ha-settings-row>
          <span slot="heading"
            >${Aa("panels.distributors.commissioning.set_outlet",s)}</span
          >
          <span slot="description"
            >${Aa("panels.distributors.commissioning.set_outlet_help",s)}</span
          >
          <div class="inline-controls">
            <input
              ...
              max="${6}"
              step="1"
              .value="${Xa(String(null!==(t=this._outletDraft[o])&&void 0!==t?t:e.current_outlet))}"
            ...
            >
              ${Aa("panels.distributors.commissioning.set_outlet",s)}
            </button>
            <button
              class="action-btn secondary"
              ?disabled="${this.isSaving}"
            ...
            >
              ${Aa("panels.distributors.commissioning.resync_home",s)}
            </button>
          </div>
        </ha-settings-row>
        <div class="commissioning-note">
          ${Aa("panels.distributors.hints.undetectable",s)}
        </div>

        <!-- Test run -->
        <ha-settings-row>
          <span slot="heading"
            >${Aa("panels.distributors.commissioning.test_run",s)}</span
          >
          <span slot="description"
            >${Aa("panels.distributors.commissioning.test_run_help",s)}</span
          >
          <button
            class="action-btn secondary"
          ...
          >
            ...
            ${Aa("panels.distributors.commissioning.test_run",s)}
          </button>
        </ha-settings-row>
        ...
        <ha-settings-row>
          <span slot="heading"
            >${Aa("panels.distributors.commissioning.confirmed",s)}</span
          >
          <span slot="description"
            >${Aa(i?"panels.distributors.commissioning.confirmed_help":"panels.distributors.commissioning.needs_sync",s)}</span
          >
          <ha-switch
            .checked="${Xa(a)}"
        ...
        <div class="run-now-row">
          ...
          >
            <ha-icon icon="mdi:play"></ha-icon>
            ${Aa("panels.distributors.commissioning.run_now",s)}
          </button>
          <span class="run-now-hint">
            ${Aa(n?"panels.distributors.commissioning.run_now_active":"panels.distributors.commissioning.run_now_help",s)}
          </span>
        </div>
      </div>
    `}renderDistributor(e,t){var s;if(!this.hass)return Z``;const i=this._isExpanded(e),a=this.hass.language;return Z`
      <ha-card id="distributor-${null!==(s=e.id)&&void 0!==s?s:"new"}">
        ...
        >
          <div class="name">${e.name}</div>
          <span class="pos-badge pos-${e.position_state}">
            ${Aa(`panels.distributors.commissioning.states.${e.position_state}`,a)}
          </span>
          <ha-icon
            class="dist-chevron"
    ...
    `}render(){var e;if(!this.hass)return Z``;const t=this.hass.language;if(this.isLoading)return Z`
        <ha-card header="${Aa("panels.distributors.title",t)}">
          <div class="card-content">
            <div class="loading-indicator">
              ${Aa("common.loading-messages.general",t)}
            </div>
          </div>
        </ha-card>
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">${Aa("panels.distributors.title",t)}</div>
          ${this._renderSaveStatus()}
          <ha-icon-button
            .path="${La}"
            title="${Aa("panels.distributors.add.header",t)}"
            @click="${()=>{this._showAdd=!0}}"
          ></ha-icon-button>
        </div>
        <div class="card-content">
          <div class="item-description">
            ${Aa("panels.distributors.description",t)}
          </div>
          ${this._renderAdvisories()}
          ${0===this.distributors.length?Z`<div class="weather-note">
                ${Aa("panels.distributors.no_items",t)}
              </div>`:""}
        </div>
      </ha-card>
      ...
      <ha-dialog
        ...
        heading="${Aa("panels.distributors.add.header",t)}"
      >
        <div class="add-form">
          <si-field
            label="${Aa("panels.distributors.labels.name",t)}"
            required
          >
            <input
              type="text"
              class="settings-input"
              placeholder="${Aa("panels.distributors.add.name_placeholder",t)}"
              .value="${this._newName}"
        ...
        <div class="dialog-footer">
          ...
          >
            ${this.isSaving?Aa("common.saving-messages.adding",t):Aa("panels.distributors.add.actions.add",t)}
          </button>
        </div>
      </ha-dialog>
      ...
      ${s?Z`
            <ha-dialog
              ...
              heading="${Aa("common.actions.confirm_delete",t)}"
            >
              <p>${Aa("panels.distributors.confirm_delete",t)}</p>
      ...
      ${i?Z`
            <ha-dialog
              ...
              heading="${Aa("panels.distributors.commissioning.confirm_dialog.title",t)}"
            >
              <p>
                ${Aa("panels.distributors.commissioning.confirm_dialog.body",t)}
              </p>
              ...
              <div class="dialog-footer">
                ...
                >
                  ${Aa("panels.distributors.commissioning.confirm_dialog.confirm",t)}
                </button>
              </div>
            </ha-dialog>
          `:""}
      ...
      ${a?Z`
            <ha-dialog
              ...
              heading="${Aa("panels.distributors.commissioning.confirm_resync.title",t)}"
            >
              <p>
                ${Aa("panels.distributors.commissioning.confirm_resync.body",t)}
              </p>
              ...
              <div class="dialog-footer">
                ...
                >
                  ${Aa("panels.distributors.commissioning.resync_home",t)}
                </button>
              </div>
            </ha-dialog>
          `:""}
      ...
      ${n?Z`
            <ha-dialog
              ...
              heading="${Aa("panels.distributors.commissioning.confirm_set_outlet.title",t)}"
            >
              <p>
                ${Aa("panels.distributors.commissioning.confirm_set_outlet.body",t)}
              </p>
              <p>
                <strong
                  >${n.name} ·
              ...
              <div class="dialog-footer">
                ...
                >
                  ${Aa("panels.distributors.commissioning.set_outlet",t)}
                </button>
              </div>
            </ha-dialog>
          `:""}
    ...
    `}};t([pe()],dn.prototype,"config",void 0),t([pe({attribute:!1})],dn.prototype,"path",void 0),t([pe({type:Array})],dn.prototype,"distributors",void 0),t([pe({type:Array})],dn.prototype,"zones",void 0),t([pe({type:Boolean})],dn.prototype,"isLoading",void 0),t([pe({type:Boolean})],dn.prototype,"isSaving",void 0),t([ge()],dn.prototype,"_expanded",void 0),t([pe({type:Boolean})],dn.prototype,"_showAdd",void 0),t([pe()],dn.prototype,"_newName",void 0),t([pe()],dn.prototype,"_confirmDeleteId",void 0),t([ge()],dn.prototype,"_armConfirmId",void 0),t([ge()],dn.prototype,"_confirmResyncHomeId",void 0),t([ge()],dn.prototype,"_confirmSetOutletId",void 0),t([ge()],dn.prototype,"_outletDraft",void 0),t([ge()],dn.prototype,"_outletRows",void 0),t([ge()],dn.prototype,"_saveStatus",void 0),dn=t([ce("smart-irrigation-view-distributor-settings")],dn);let cn=class extends(Pa(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.moduleCache=new Map,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout(()=>{this.saveToHA(t),e=null},500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){Rs().catch(e=>{console.error("Failed to load HA form:",e)})}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;e&&(this.isLoading=!0,this._scheduleUpdate());try{const[e,t,s,i]=await Promise.all([$s(this.hass),ks(this.hass),Ss(this.hass),As(this.hass)]);this.config=e,this.zones=t,this.modules=s,this.allmodules=i,this._initialLoadDone=!0,this.moduleCache.clear()}catch(e){console.error("Error fetching data:",e),Ia(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}}async handleAddModule(){var e,t;if((null===(t=null===(e=this.moduleInput)||void 0===e?void 0:e.selectedOptions)||void 0===t?void 0:t[0])&&!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.moduleInput.selectedOptions[0].text,t=this.allmodules.find(t=>t.name===e);if(!t)return;const s={name:e,description:t.description,config:t.config,schema:t.schema};this.modules=[...this.modules,s],this.moduleCache.clear(),this._scheduleUpdate(),await this.saveToHA(s),await this._fetchData()}catch(e){console.error("Error adding module:",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}}}async handleRemoveModule(e,t){if(!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.modules[t],a=null==e?void 0:e.id;this.modules;this.modules=this.modules.filter((e,s)=>s!==t),this.moduleCache.clear(),this._scheduleUpdate(),this.hass&&void 0!==a&&await(s=this.hass,i=a.toString(),s.callApi("POST",_e+"/modules",{id:i,remove:!0}))}catch(e){console.error("Error removing module:",e),Ia(this,this.hass,"common.errors.delete_failed",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}var s,i}}async saveToHA(e){if(this.hass)try{await Cs(this.hass,e)}catch(e){throw console.error("Error saving module:",e),Ia(this,this.hass,"common.errors.save_failed",e),e}}renderModule(e,t){if(!this.hass)return Z``;const s=this.zones.filter(t=>t.module===e.id).length,i=`module-${e.id||t}-${s}-${JSON.stringify(e)}`;if(this.moduleCache.has(i))return this.moduleCache.get(i);const a=Z`
      <ha-card>
        <div class="card-header">
          <div class="name">${e.name}</div>
        ...
        <div class="card-content">
          ...
          <div class="moduleconfig">
            <label class="subheader"
              >${Aa("panels.modules.cards.module.labels.configuration",this.hass.language)}
              (*
              ${Aa("panels.modules.cards.module.labels.required",this.hass.language)})</label
            >
            ${e.schema?Object.entries(e.schema).map(([e])=>this.renderConfig(t,e)):null}
          </div>
          <div class="card-footer">
            ${s?Z`<div class="weather-note">
                  ${Aa("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}
                </div>`:Z`<button
                  class="action-btn danger"
    ...
    `;return this.moduleCache.set(i,a),a}renderUsageChip(e){return this.hass?e?Z`<span class="usage-chip"
      ...
      >
        ${Object.entries(n.options).map(([e,s])=>Z`<option
              ...
              ?selected="${h===Ea(s,0)}"
            >
              ${Aa("panels.modules.cards.module.translated-options."+Ea(s,1),t)}
            </option>`)}
      ...
      <ha-card header="${Aa("panels.modules.title",this.hass.language)}">
        <div class="card-content">
          ${Aa("panels.modules.description",this.hass.language)}
          ${this.isLoading?Z`<div class="loading-indicator">
                ...
                <div class="add-row">
                  <select
                    id="moduleInput"
                    class="settings-input"
                    aria-label="${Aa("common.labels.module",this.hass.language)}"
                    ?disabled="${this.isSaving}"
                  >
                  ...
                  >
                    ...
                    ${this.isSaving?Aa("common.saving-messages.adding",this.hass.language):Aa("panels.modules.cards.add-module.actions.add",this.hass.language)}
                  </button>
                </div>
              `}
        </div>
    ...
    `}};t([pe()],cn.prototype,"config",void 0),t([pe({type:Array})],cn.prototype,"zones",void 0),t([pe({type:Array})],cn.prototype,"modules",void 0),t([pe({type:Array})],cn.prototype,"allmodules",void 0),t([pe({type:Boolean})],cn.prototype,"isLoading",void 0),t([pe({type:Boolean})],cn.prototype,"isSaving",void 0),t([me("#moduleInput")],cn.prototype,"moduleInput",void 0),cn=t([ce("smart-irrigation-view-modules")],cn);let hn=class extends(Pa(le)){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this.debounceTimers=new Map,this.globalDebounceTimer=null,this.mappingCache=new Map,this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()},this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()}))}firstUpdated(){Rs().catch(e=>{console.error("Failed to load HA form:",e)})}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[t,s,i]=await Promise.all([$s(this.hass),ks(this.hass),Es(this.hass)]);this.config=t,this.zones=s,this.mappings=i,this._initialLoadDone=!0,this.mappingCache.clear()}catch(e){console.error("Error fetching data:",e),Ia(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}}handleAddMapping(){if(!this.mappingNameInput.value.trim())return;const e={[He]:"",[De]:"",[Me]:"",[Ie]:"",[Ne]:"",[Le]:"",[Pe]:"",[Be]:"",[Re]:""},t={name:this.mappingNameInput.value.trim(),mappings:e};this.mappings=[...this.mappings,t],this.isSaving=!0,this.saveToHA(t).then(()=>(this.mappingNameInput.value="",this._fetchData())).catch(e=>{console.error("Failed to add mapping:",e),Ia(this,this.hass,"common.errors.save_failed",e),this.mappings=this.mappings.slice(0,-1)}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()})}handleRemoveMapping(e,t){const s=this.mappings[t].id;if(null==s)return;const i=[...this.mappings];var a,n;(this.mappings=this.mappings.filter((e,s)=>s!==t),this.mappingCache.delete(s.toString()),this.hass)&&(this.isSaving=!0,(a=this.hass,n=s.toString(),a.callApi("POST",_e+"/mappings",{id:n,remove:!0})).catch(e=>{console.error("Failed to delete mapping:",e),Ia(this,this.hass,"common.errors.delete_failed",e),this.mappings=i,this._fetchData().catch(e=>{console.error("Failed to refresh data after delete error:",e)})}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditMapping(e,t){this.mappings[e]=t,t.id&&this.mappingCache.delete(t.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout(()=>{this.isSaving=!0,this.saveToHA(t).catch(e=>{console.error("Failed to save mapping:",e),Ia(this,this.hass,"common.errors.save_failed",e)}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()}),this.globalDebounceTimer=null},500),this._scheduleUpdate()}async saveToHA(e){var t;if(!this.hass)throw new Error("Home Assistant connection not available");const s=[],i=this.hass.states;for(const t in e.mappings){const a=e.mappings[t].sensorentity;if(a&&""!==a.trim()){const n=a.trim();e.mappings[t].sensorentity=n,n in i||s.push(n)}}if(s.length>0){const e=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("ha-card");throw e&&Oa({body:{message:Aa("panels.mappings.cards.mapping.errors.source_does_not_exist",this.hass.language)+": "+s.join(", ")},error:Aa("panels.mappings.cards.mapping.errors.invalid_source",this.hass.language)},e),new Error("Invalid sensor entities found")}const{id:a,name:n,mappings:o}=e;await Ts(this.hass,{id:a,name:n,mappings:o})}renderMappingSetting(e,t){const s=this.mappings[e];if(!s||!this.hass)return Z``;const i=s.mappings[t];return Z`
      <div class="mappingline">
        <div class="mappingsettingname">
          <label for="${`${t}_${e}`}">
            ${Aa(`panels.mappings.cards.mapping.items.${t.toLowerCase()}`,this.hass.language)}
          </label>
        </div>
        <div class="mappingsettingline">
          <label
            >${Aa("panels.mappings.cards.mapping.source",this.hass.language)}:</label
          >
    ...
    `}renderSimpleRadioOptions(e,t,s){if(!this.hass||!this.config)return Z``;const i=t===De||t===Pe,a=s[Ke];return Z`
      ${!i&&this.config.use_weather_service?Z`
            <label>
              ...
              />
              ${Aa("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}
            </label>
          `:""}
      ${i?Z`
            <label>
              <input
                ...
                @change="${s=>this.handleSimpleSourceChange(e,t,s)}"
              />
              ${Aa("panels.mappings.cards.mapping.sources.none",this.hass.language)}
            </label>
          `:""}
      ...
      <label>
        <input
          ...
          @change="${s=>this.handleSimpleSourceChange(e,t,s)}"
        />
        ${Aa("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}
      </label>
    ...
    `}renderSensorInput(e,t,s){if(!this.hass)return Z``;const i=`${t}_${e}`;return Z`
      <div class="mappingsettingline">
        <label for="${i}_sensor_entity">
          ${Aa("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}:
        </label>
        <input
          type="text"
          class="settings-input"
    ...
    `}renderStaticValueInput(e,t,s){if(!this.hass)return Z``;const i=`${t}_${e}`;return Z`
      <div class="mappingsettingline">
        <label for="${i}_static_value">
          ${Aa("panels.mappings.cards.mapping.static_value",this.hass.language)}:
        </label>
        <input
          type="text"
          class="settings-input"
    ...
    `}renderUnitSelect(e,t,s){if(!this.hass||!this.config)return Z``;const i=`${t}_${e}`;return Z`
      <div class="mappingsettingline">
        <label for="${i}_unit">
          ${Aa("panels.mappings.cards.mapping.input-units",this.hass.language)}:
        </label>
        <select
          id="${i}_unit"
          class="settings-input"
    ...
    `}renderPressureTypeSelect(e,t,s){if(!this.hass)return Z``;const i=`${t}_${e}`;return Z`
      <div class="mappingsettingline">
        <label for="${i}_pressure_type">
          ${Aa("panels.mappings.cards.mapping.pressure-type",this.hass.language)}:
        </label>
        <select
          id="${i}_pressure_type"
          class="settings-input"
    ...
    `}renderAggregateSelect(e,t,s){if(!this.hass)return Z``;const i=`${t}_${e}`;return Z`
      <div class="mappingsettingline">
        <label for="${i}_aggregate">
          ${Aa("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
        </label>
        <select
          id="${i}_aggregate"
          class="settings-input"
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return Z`<option value="${e}" ?selected="${e===t}">
        ${Aa("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return Z``}renderPressureTypes(e,t){if(this.hass&&this.config){let e=Z``;const s=t[Ze];return e=Z`${e}
        <option
          value="${We}"
          ?selected="${s===We}"
        >
          ${Aa("panels.mappings.cards.mapping.pressure_types."+We,this.hass.language)}
        </option>
        <option
          value="${qe}"
          ?selected="${s===qe}"
        >
          ${Aa("panels.mappings.cards.mapping.pressure_types."+qe,this.hass.language)}
        </option>`,e}return Z``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return Z``;const s=function(e){switch(e){case He:case Be:return[{unit:"°C",system:Oe},{unit:"°F",system:Te}];case Ie:case De:return[{unit:at,system:Oe},{unit:nt,system:Te}];case Ne:return[{unit:dt,system:Oe},{unit:ct,system:Te}];case Me:return[{unit:"%",system:[Oe,Te]}];case Le:return[{unit:"millibar",system:Oe},{unit:"hPa",system:Oe},{unit:"psi",system:Te},{unit:ot,system:Te}];case Re:return[{unit:"km/h",system:Oe},{unit:lt,system:Oe},{unit:rt,system:Te}];case Pe:return[{unit:"W/m2",system:Oe},{unit:"MJ/day/m2",system:Oe},{unit:"W/sq ft",system:Te},{unit:"MJ/day/sq ft",system:Te}];default:return[]}}(e);let i=t[Xe];const a=this.config.units;if(!t[Xe])for(const e of s)if("string"==typeof e.system){if(a===e.system){i=e.unit;break}}else{for(const t of e.system)if(a===t.system){i=e.unit;break}if(i===e.unit)break}return Z`
      ${s.map(e=>Z`
    ...
    `}render(){return this.hass?this.isLoading?Z`
        <ha-card
          header="${Aa("panels.mappings.title",this.hass.language)}"
        >
          <div class="card-content">
            <div class="loading-indicator">
              ${Aa("common.loading-messages.general",this.hass.language)}
      ...
      >
        <div class="card-content">
          ${Aa("panels.mappings.description",this.hass.language)}
          <div class="add-row">
            <input
              id="mappingNameInput"
              class="settings-input"
              type="text"
              placeholder="${Aa("panels.mappings.labels.mapping-name",this.hass.language)}"
            />
            <button
              class="action-btn ${this.isSaving?"saving":""}"
              ?disabled="${this.isSaving}"
            ...
            >
              <ha-icon icon="mdi:plus"></ha-icon>
              ${Aa("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    ...
    `}renderMappingCard(e,t){if(!this.hass)return Z``;const s=this.zones.filter(t=>t.mapping===e.id).length;return Z`
      <ha-card>
        ...
        <div class="card-content">
          <ha-settings-row>
            <span slot="heading"
              >${Aa("panels.mappings.labels.mapping-name",this.hass.language)}</span
            >
            <input
              id="name${e.id}"
              class="settings-input"
          ...
          <div class="card-footer">
            ${s?Z`<div class="weather-note">
                  ${Aa("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}
                </div>`:Z`<button
                  class="action-btn danger"
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach(e=>{clearTimeout(e)}),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};t([pe()],hn.prototype,"config",void 0),t([pe({type:Array})],hn.prototype,"zones",void 0),t([pe({type:Array})],hn.prototype,"mappings",void 0),t([pe({type:Boolean})],hn.prototype,"isLoading",void 0),t([pe({type:Boolean})],hn.prototype,"isSaving",void 0),t([me("#mappingNameInput")],hn.prototype,"mappingNameInput",void 0),hn=t([ce("smart-irrigation-view-mappings")],hn);const un=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"];let pn=class extends(Pa(le)){constructor(){super(...arguments),this._schedules=[],this._zones=[],this._isLoading=!0,this._showDialog=!1,this._editingSchedule={name:"",type:"daily",enabled:!0,time:"06:00",action:"irrigate",zones:"all"},this._editingId=null}hassSubscribe(){return this._load(),[this.hass.connection.subscribeMessage(()=>this._load(),{type:_e+"_config_updated"})]}async _load(){var e;if(this.hass)try{const[t,s]=await Promise.all([(e=this.hass,e.callWS({type:_e+"/schedules"})),ks(this.hass)]);this._schedules=t||[],this._zones=s||[]}catch(e){console.error("Failed to load schedules",e),Ia(this,this.hass,"common.errors.load_failed",e)}finally{this._isLoading=!1}}_openAdd(){this._editingSchedule={name:"",type:"daily",enabled:!0,time:"06:00",action:"irrigate",zones:"all"},this._editingId=null,this._showDialog=!0}_openEdit(e){var t;this._editingSchedule=Object.assign({},e),this._editingId=null!==(t=e.id)&&void 0!==t?t:null,this._showDialog=!0}_closeDialog(){this._showDialog=!1}async _save(){const e=Object.assign({},this._editingSchedule);this._editingId&&(e.id=this._editingId);try{await Hs(this.hass,e),this._closeDialog(),await this._load()}catch(e){console.error("Failed to save schedule",e),Ia(this,this.hass,"common.errors.save_failed",e)}}async _delete(e){try{await(t=this.hass,s=e,t.callWS({type:_e+"/schedule_delete",schedule_id:s})),await this._load()}catch(e){console.error("Failed to delete schedule",e),Ia(this,this.hass,"common.errors.delete_failed",e)}var t,s}_update(e){this._editingSchedule=Object.assign(Object.assign({},this._editingSchedule),e)}_typeLabel(e){return Aa(`panels.schedules.types.${e}`,this.hass.language)||e}_zonesLabel(e){if("all"===e)return Aa("panels.schedules.zones_all",this.hass.language);if(Array.isArray(e)){const t=e.map(e=>{const t=this._zones.find(t=>String(t.id)===String(e));return t?t.name:e}).join(", ");return t||e.join(", ")}return String(e)}_renderZonePicker(){const e="all"===this._editingSchedule.zones||!Array.isArray(this._editingSchedule.zones),t=e?[]:this._editingSchedule.zones.map(String);return Z`
      <div class="field">
        <label
          >${Aa("panels.schedules.fields.zones",this.hass.language)}</label
        >
        <div class="switch-container">
          ...
          />
          <label for="zones_all"
            >${Aa("panels.schedules.zones_all",this.hass.language)}</label
          >
          <input
            type="radio"
            id="zones_specific"
          ...
          <label for="zones_specific"
            >${Aa("panels.schedules.zones_specific",this.hass.language)}</label
          >
        </div>
        ${e?"":Z`
    ...
    `}_renderTypeFields(){var e;const t=this._editingSchedule;switch(t.type){case"daily":return Z`
          <div class="field">
            <label
              >${Aa("panels.schedules.fields.time",this.hass.language)}</label
            >
            <input
              type="time"
              .value="${t.time||"06:00"}"
        ...
        `;case"weekly":return Z`
          ...
          <div class="field">
            <label
              >${Aa("panels.schedules.fields.days_of_week",this.hass.language)}</label
            >
            <div class="day-checkboxes">
              ${un.map(e=>Z`
                  <label class="day-check">
                    ...
                    />
                    ${Aa(`panels.schedules.days.${e}`,this.hass.language)}
                  </label>
                `)}
            </div>
          </div>
        `;case"monthly":return Z`
          ...
          <div class="field">
            <label
              >${Aa("panels.schedules.fields.day_of_month",this.hass.language)}</label
            >
            <input
              type="number"
              min="1"
        ...
        `;case"interval":return Z`
          <div class="field">
            <label
              >${Aa("panels.schedules.fields.interval_hours",this.hass.language)}</label
            >
            <div class="input-suffix-row">
              ...
              />
              <span class="suffix"
                >${Aa("panels.schedules.hours",this.hass.language)}</span
              >
            </div>
          </div>
          <div class="field">
            <label
              >${Aa("panels.schedules.fields.start_time",this.hass.language)}</label
            >
            <input
              type="time"
              .value="${t.start_time||""}"
        ...
        `;case"sunrise":case"sunset":return Z`${this._renderSunOffsetFields()}`;case"solar_azimuth":return Z`
          <div class="field">
            <label
              >${Aa("panels.schedules.fields.azimuth_angle",this.hass.language)}</label
            >
            <div class="input-suffix-row">
              <input
                type="number"
      ...
      <div class="field">
        <label
          >${Aa("panels.schedules.fields.offset_minutes",this.hass.language)}</label
        >
        <div class="input-suffix-row">
          <input
            type="number"
          ...
          />
          <span class="suffix"
            >${Aa("panels.schedules.minutes",this.hass.language)}</span
          >
        </div>
      </div>
    `}_renderTimeAnchorField(){var e;const t=this._editingSchedule;if("irrigate"!==t.action||"interval"===t.type)return Z``;const s=["sunrise","sunset","solar_azimuth"].includes(t.type)&&!1!==t.account_for_duration,i=null!==(e=t.time_anchor)&&void 0!==e?e:s?"finish":"start";return Z`
      <div class="field">
        <label
          >${Aa("panels.schedules.fields.time_anchor",this.hass.language)}</label
        >
        <select
        ...
        >
          ${["start","finish"].map(e=>Z`
              <option value="${e}" ?selected="${i===e}">
                ${Aa(`panels.schedules.time_anchor.${e}`,this.hass.language)}
              </option>
            `)}
        </select>
      </div>
    `}_renderDialog(){if(!this._showDialog)return Z``;const e=this._editingSchedule,t=this._editingId?Aa("panels.schedules.dialog.edit_title",this.hass.language):Aa("panels.schedules.dialog.add_title",this.hass.language);return Z`
      <ha-dialog open .heading=${!0} @closed=${this._closeDialog}>
        ...
        <div class="dialog-content">
          <div class="field">
            <label
              >${Aa("panels.schedules.fields.name",this.hass.language)}</label
            >
            <input
              type="text"
              .value="${e.name}"
          ...
          <div class="field">
            <label
              >${Aa("panels.schedules.fields.type",this.hass.language)}</label
            >
            <select
          ...
          <div class="field-row">
            <label
              >${Aa("panels.schedules.fields.enabled",this.hass.language)}</label
            >
            <input
              type="checkbox"
              ?checked="${e.enabled}"
          ...
          <div class="field">
            <label
              >${Aa("panels.schedules.fields.start_date",this.hass.language)}</label
            >
            <input
              type="date"
              .value="${e.start_date||""}"
          ...
          <div class="field">
            <label
              >${Aa("panels.schedules.fields.end_date",this.hass.language)}</label
            >
            <input
              type="date"
              .value="${e.end_date||""}"
        ...
        <div class="dialog-footer">
          ...
          <button class="dialog-btn dialog-btn-primary" @click=${this._save}>
            ${Aa("common.actions.save",this.hass.language)}
          </button>
        </div>
      </ha-dialog>
    `}render(){return this.hass?this._isLoading?Z`
        <ha-card
          header="${Aa("panels.schedules.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Aa("common.loading",this.hass.language)}...
          </div>
        </ha-card>
      `:Z`
      ${this._renderDialog()}
      ...
      >
        <div class="card-content">
          ${Aa("panels.schedules.description",this.hass.language)}
        </div>
        <div class="card-content">
          <button class="add-btn" @click=${this._openAdd}>
            <svg style="width:20px;height:20px" viewBox="0 0 24 24">
              <path fill="currentColor" d="${La}" />
            </svg>
            ${Aa("panels.schedules.add",this.hass.language)}
          </button>
        </div>
      </ha-card>
      ...
      ${0===this._schedules.length?Z`
            <ha-card>
              <div class="card-content">
                ${Aa("panels.schedules.no_items",this.hass.language)}
              </div>
            </ha-card>
          `:this._schedules.map(e=>Z`
              <ha-card header="${e.name}">
                <div class="card-content">
                  <div class="info-row">
                    <span class="info-label"
                      >${Aa("panels.schedules.fields.type",this.hass.language)}:</span
                    >
                  ...
                  ${e.time&&["daily","weekly","monthly"].includes(e.type)?Z`
                        <div class="info-row">
                          <span class="info-label"
                            >${Aa("panels.schedules.fields.time",this.hass.language)}:</span
                          >
                          <span>${e.time}</span>
                        </div>
                      `:""}
                  ${e.interval_hours?Z`
                        <div class="info-row">
                          <span class="info-label"
                            >${Aa("panels.schedules.fields.interval_hours",this.hass.language)}:</span
                          >
                          <span
                            >${e.interval_hours}
                            ${Aa("panels.schedules.hours",this.hass.language)}</span
                  ...
                  ${"interval"===e.type&&e.start_time?Z`
                        <div class="info-row">
                          <span class="info-label"
                            >${Aa("panels.schedules.fields.start_time",this.hass.language)}:</span
                          >
                  ...
                  <div class="info-row">
                    <span class="info-label"
                      >${Aa("panels.schedules.fields.zones",this.hass.language)}:</span
                    >
                    <span>${this._zonesLabel(e.zones)}</span>
                  </div>
                  <div class="info-row">
                    <span class="info-label"
                      >${Aa("panels.schedules.fields.enabled",this.hass.language)}:</span
                    >
                    <span
                      >${e.enabled?Aa("common.labels.yes",this.hass.language):Aa("common.labels.no",this.hass.language)}</span
                    >
                  </div>
                </div>
                <div class="card-content action-buttons">
                  <div class="action-buttons-left">
                    ...
                    >
                      ...
                      <span class="action-button-label"
                        >${Aa("common.actions.edit",this.hass.language)}</span
                      >
                    </div>
                  </div>
                  <div class="action-buttons-right">
                    ...
                    >
                      <span class="action-button-label"
                        >${Aa("common.actions.delete",this.hass.language)}</span
                      >
                      <svg style="width:20px;height:20px" viewBox="0 0 24 24">
            ...
            `)}
    `:Z``}static get styles(){return[Fa,r`
        .dialog-content {
          display: flex;
          flex-direction: column;
          gap: 14px;
      ...
      `]}};t([pe({attribute:!1})],pn.prototype,"hass",void 0),t([ge()],pn.prototype,"_schedules",void 0),t([ge()],pn.prototype,"_zones",void 0),t([ge()],pn.prototype,"_isLoading",void 0),t([ge()],pn.prototype,"_showDialog",void 0),t([ge()],pn.prototype,"_editingSchedule",void 0),t([ge()],pn.prototype,"_editingId",void 0),pn=t([ce("smart-irrigation-view-schedules")],pn);let gn=class extends(Pa(le)){constructor(){super(...arguments),this._forecast=null,this._mappings=[],this._records=new Map,this._loading=!0,this._metric=!0,this._climate=[]}hassSubscribe(){return this._fetch(),[this.hass.connection.subscribeMessage(()=>this._fetch(),{type:_e+"_config_updated"})]}async _fetch(){var e,t;if(this.hass)try{const[s,i,a,n]=await Promise.all([(t=this.hass,t.callWS({type:_e+"/weather_forecast"})),Es(this.hass),$s(this.hass),Os(this.hass)]);this._forecast=s,this._mappings=i||[],this._metric=(null==a?void 0:a.units)!==Te;const o=n?Object.values(n):[];this._climate=o.length>0&&(null===(e=o[0])||void 0===e?void 0:e.monthly_estimates)||[];const r=new Map;await Promise.all(this._mappings.map(async e=>{if(void 0!==e.id)try{r.set(e.id,await((e,t,s=10)=>e.callWS({type:_e+"/weather_records",mapping_id:t,limit:s}))(this.hass,e.id.toString(),0)||[])}catch(e){}})),this._records=r}catch(e){console.error("Failed to fetch weather data",e)}finally{this._loading=!1}}render(){return this.hass?Z`${this._renderForecast()} ${this._renderRecords()}
    ${this._renderSeasonal()}`:Z``}_renderSeasonal(){if(!this.hass)return Z``;const e=this.hass.language;return Z`
      <ha-card
        header="${Aa("panels.setup.weather_data.seasonal_title",e)}"
      >
        <div class="card-content">
          ${0===this._climate.length?Z`<div class="weather-note">
                ${Aa("panels.zones.calendar.no_data",e)}
              </div>`:Z`
                <div class="seasonal-table">
                  <div class="weather-header">
                    <span
                      >${Aa("panels.zones.calendar.month",e)}</span
                    >
                    <span>${Aa("panels.zones.calendar.et",e)}</span>
                    <span
                      >${Aa("panels.zones.calendar.precipitation",e)}</span
                    >
                    <span
                      >${Aa("panels.zones.calendar.avg_temp",e)}</span
                    >
                  </div>
                  ${this._climate.map(e=>Z`
                      <div class="weather-row">
                        ...
                        >
                        <span
                          >${an(e.estimated_et_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${an(e.average_precipitation_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${an(e.average_temperature_c,"temperature",this._metric)}</span
                        >
                      </div>
                    `)}
                </div>
    ...
    `}_renderForecast(){if(!this.hass)return Z``;const e=this.hass.language,t=this._forecast;return Z`
      <ha-card
        header="${Aa("panels.setup.weather_data.forecast_title",e)}"
      >
        <div class="card-content">
          ${t&&t.available&&0!==t.days.length?Z`
              ...
              `:Z`<div class="weather-note">
                ${Aa("panels.setup.weather_data.forecast_none",e)}
              </div>`}
        </div>
      </ha-card>
    `}_renderForecastDay(e,t){const s=(()=>{try{return new Intl.DateTimeFormat(t,{weekday:"short",month:"short",day:"numeric"}).format(new Date(e.date+"T00:00:00"))}catch(t){return e.date}})(),i=e=>{const t=sn(e,"temperature",this._metric);return t?`${Math.round(t.value)}°`:"-"};return Z`
      <div class="forecast-day">
        ...
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-rainy"></ha-icon>${an(e.precipitation,"precipitation",this._metric)}
        </div>
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-windy"></ha-icon>${an(e.windspeed,"windspeed",this._metric)}
        </div>
      </div>
    `}_renderRecords(){if(!this.hass)return Z``;const e=this.hass.language;return this._loading&&0===this._mappings.length?Z`<ha-card
        header="${Aa("panels.mappings.weather-records.title",e)}"
      >
        <div class="card-content">
          <div class="loading-indicator">
            ${Aa("common.loading-messages.general",e)}
          </div>
        </div>
      ...
      >
        <div class="card-content">
          <div class="weather-note">
            ${Aa("panels.mappings.no_items",e)}
          </div>
        </div>
      </ha-card>`:Z`${this._mappings.map(t=>this._renderMappingRecords(t,e))}`}_renderMappingRecords(e,t){const s=void 0!==e.id&&this._records.get(e.id)||[],i=`${Aa("panels.mappings.weather-records.title",t)} — ${e.name}`,a=e=>{try{return t=e,Number.isNaN(Wa(t).getTime())?"-":function(e){const t=Wa(e);return`${Za(t.getMonth()+1)}-${Za(t.getDate())} ${Za(t.getHours())}:${Za(t.getMinutes())}`}(e)}catch(e){return"-"}var t};return Z`
      <ha-card header="${i}">
        <div class="card-content">
          ${0===s.length?Z`<div class="weather-note">
                ${Aa("panels.mappings.weather-records.no-data",t)}
              </div>`:Z`
                <div class="weather-table">
                  <div class="weather-header">
                    <span
                      >${Aa("panels.mappings.weather-records.timestamp",t)}</span
                    >
                    <span
                      >${Aa("panels.mappings.weather-records.temperature",t)}</span
                    >
                    <span
                      >${Aa("panels.mappings.weather-records.humidity",t)}</span
                    >
                    <span
                      >${Aa("panels.mappings.weather-records.dewpoint",t)}</span
                    >
                    <span
                      >${Aa("panels.mappings.weather-records.wind",t)}</span
                    >
                    <span
                      >${Aa("panels.mappings.weather-records.pressure",t)}</span
                    >
                    <span
                      >${Aa("panels.mappings.weather-records.precipitation",t)}</span
                    >
                    <span
                      >${Aa("panels.mappings.weather-records.retrieval-time",t)}</span
                    >
                  </div>
                  ${s.map(e=>Z`
                      <div class="weather-row">
                        ...
                        <span
                          >${an(e.temperature,"temperature",this._metric)}</span
                        >
                        <span>${(e=>null!=e?e.toFixed(1)+" %":"-")(e.humidity)}</span>
                        <span
                          >${an(e.dewpoint,"temperature",this._metric)}</span
                        >
                        <span
                          >${an(e.wind_speed,"windspeed",this._metric)}</span
                        >
                        <span
                          >${an(e.pressure,"pressure",this._metric)}</span
                        >
                        <span
                          >${an(e.precipitation,"precipitation",this._metric)}</span
                        >
    ...
    `}};t([pe()],gn.prototype,"narrow",void 0),t([ge()],gn.prototype,"_forecast",void 0),t([ge()],gn.prototype,"_mappings",void 0),t([ge()],gn.prototype,"_records",void 0),t([ge()],gn.prototype,"_loading",void 0),t([ge()],gn.prototype,"_metric",void 0),t([ge()],gn.prototype,"_climate",void 0),gn=t([ce("smart-irrigation-view-weather-data")],gn);let mn=class extends(Pa(le)){constructor(){super(...arguments),this._saving=!1}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch experimental config:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to refresh experimental config:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(this.hass)try{this.config=await $s(this.hass)}catch(e){console.error("Error fetching config:",e),Ia(this,this.hass,"common.errors.load_failed",e)}}async _toggle(e,t){if(this.hass&&this.config){this.config=Object.assign(Object.assign({},this.config),{[e]:t}),this._saving=!0;try{await xs(this.hass,{[e]:t})}catch(e){console.error("Error saving experimental config:",e),Ia(this,this.hass,"common.errors.save_failed",e),await this._fetchData()}finally{this._saving=!1}}}render(){var e,t;return this.hass&&this.config?Z`
      ${this._renderIntro()}
    ...
    `:Z`<div class="loading-indicator">
      ...
      <ha-card header="${Aa(`${e}.title`,this.hass.language)}">
        <div class="card-content description-text">
          ${Aa(`${e}.description`,this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${Aa(`${e}.label`,this.hass.language)}</label>
            <ha-switch
              .checked="${t}"
          ...
          ${t?Z`<div class="setting-row">
                <label>
                  ${Aa(`${e}.debounce_label`,this.hass.language)}
                </label>
                <input
                  type="number"
                  class="settings-input shortfield"
    ...
    `}};t([pe()],mn.prototype,"narrow",void 0),t([ge()],mn.prototype,"config",void 0),t([ge()],mn.prototype,"_saving",void 0),mn=t([ce("smart-irrigation-view-experimental")],mn);var vn;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.Distributors="distributors",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}(vn||(vn={}));const _n={[vn.WeatherLocation]:"panels.setup.tabs.weather_location",[vn.Zones]:"panels.setup.tabs.my_zones",[vn.Distributors]:"panels.setup.tabs.distributors",[vn.WhenToWater]:"panels.setup.tabs.when_to_water",[vn.Advanced]:"panels.setup.tabs.advanced",[vn.Experimental]:"panels.setup.tabs.experimental",[vn.Help]:"panels.help.title"};let fn=class extends(Pa(le)){hassSubscribe(){return this._fetchConfig(),[this.hass.connection.subscribeMessage(()=>this._fetchConfig(),{type:_e+"_config_updated"})]}async _fetchConfig(){if(this.hass)try{this.config=await $s(this.hass)}catch(e){console.error("Failed to fetch setup config:",e)}}get _distributorsEnabled(){var e,t;return null!==(t=null===(e=this.config)||void 0===e?void 0:e.distributors_enabled)&&void 0!==t&&t}get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(vn).includes(null!=t?t:"")?t:vn.WeatherLocation}_selectTab(e){Ha(0,ja("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return Z``;const e=this._distributorsEnabled,t=Object.values(vn).filter(t=>t!==vn.Distributors||e);let s=this._activeTab;return s!==vn.Distributors||e||(s=vn.WeatherLocation),Z`
      <div class="setup-container">
        <nav class="setup-nav">
          ${t.map(e=>Z`
              ...
              >
                ${Aa(_n[e],this.hass.language)}
              </button>
            `)}
          <button
            class="setup-nav-btn wizard-btn"
            @click="${this._openWizard}"
            title="${Aa("wizard.title",this.hass.language)}"
          >
            <ha-icon icon="mdi:creation"></ha-icon>
            ${Aa("wizard.open_button",this.hass.language)}
          </button>
        </nav>
        <div class="setup-content">${this._renderContent(s)}</div>
      </div>
    `}_renderContent(e){if(!this.hass)return Z``;switch(e){case vn.WeatherLocation:return Z`
          ...
          <smart-irrigation-view-weather-data
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-weather-data>
        `;case vn.Zones:return Z`<smart-irrigation-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-zone-settings>`;case vn.Distributors:return Z`<smart-irrigation-view-distributor-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-distributor-settings>`;case vn.WhenToWater:return Z`
          <smart-irrigation-view-general
            .hass="${this.hass}"
            .narrow="${this.narrow}"
        ...
        `;case vn.Advanced:return Z`
          ...
          <smart-irrigation-view-mappings
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-mappings>
        `;case vn.Experimental:return Z`<smart-irrigation-view-experimental
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-experimental>`;case vn.Help:return this._renderHelp()}}_renderHelp(){return this.hass?Z`
      <ha-card
        header="${Aa("panels.help.cards.how-to-get-help.title",this.hass.language)}"
      >
        <div class="card-content">
          ${Aa("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)}
          <a href="${"https://justchr.github.io/HAsmartirrigation/"}" target="_blank" rel="noopener noreferrer"
            >${Aa("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
          >.
          ${Aa("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
          <a
            href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
            target="_blank"
            rel="noopener noreferrer"
            >${Aa("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
          >
          ${Aa("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
          <a href="${"https://github.com/JustChr/HAsmartirrigation/issues"}" target="_blank" rel="noopener noreferrer"
            >${Aa("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
          >
          (${Aa("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
        </div>
      </ha-card>
    ...
    `}};var bn;t([pe({attribute:!1})],fn.prototype,"hass",void 0),t([pe({type:Boolean})],fn.prototype,"narrow",void 0),t([pe({attribute:!1})],fn.prototype,"path",void 0),t([ge()],fn.prototype,"config",void 0),fn=t([ce("smart-irrigation-view-setup")],fn),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done"}(bn||(bn={}));let yn=class extends le{constructor(){super(...arguments),this._step=bn.Welcome,this._saving=!1,this._error="",this._confirmClose=!1,this._siConfig=null,this._useWeather=!1,this._weatherService=ze,this._apiKey="",this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=Ue,this._humiditySource=Ue,this._precipSource=Ue,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="",this._scheduleTime="06:00",this._scheduleCreated=!1,this._creatingSchedule=!1}async connectedCallback(){super.connectedCallback(),await this._loadInitialData()}async _loadInitialData(){var e;if(this.hass){try{const[t,s,i]=await Promise.all([As(this.hass),Is(this.hass),$s(this.hass)]);this._availableModules=t,this._weatherConfig=s,this._siConfig=i,this._useWeather=s.use_weather_service,this._weatherService=null!==(e=s.weather_service)&&void 0!==e?e:ze}catch(e){console.error("Wizard: failed to load initial data",e),this._error=Da(e)}this.requestUpdate()}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}))}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}))}async _next(){this._error="";try{switch(this._saving=!0,this._step){case bn.Welcome:this._step=bn.Weather;break;case bn.Weather:await this._saveWeather(),this._step=bn.Module;break;case bn.Module:await this._saveModule(),this._step=bn.Mapping;break;case bn.Mapping:await this._saveMapping(),this._step=bn.Zone;break;case bn.Zone:await this._saveZone(),this._step=bn.Done;break;case bn.Done:this._close()}}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._saving=!1,this.requestUpdate()}}_back(){this._step>bn.Welcome&&(this._step=this._step-1,this._error="")}get _canSkipCurrentStep(){return this._step===bn.Weather}_skipStep(){this._canSkipCurrentStep&&this._step<bn.Done&&(this._step=this._step+1,this._error="")}async _saveWeather(){await Ns(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null)}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0}catch(e){return}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await Cs(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>Ss(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.")}async _saveMapping(){const e=this._useWeather?Ue:Ge,t={[Be]:{[Ke]:this._tempSource},[Me]:{[Ke]:this._humiditySource},[Ie]:{[Ke]:this._precipSource}},s=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const i of s)t[i]={[Ke]:e};const i=await Ts(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(i,()=>Es(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.")}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await zs(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:Ra.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0})}async _createDefaultSchedule(){var e,t;if(!this._scheduleCreated&&!this._creatingSchedule){this._error="",this._creatingSchedule=!0;try{const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";await Hs(this.hass,{name:Aa("wizard.steps.done.schedule_name",s)||"Daily",type:"daily",enabled:!0,time:this._scheduleTime||"06:00",action:"irrigate",zones:"all"}),this._scheduleCreated=!0}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._creatingSchedule=!1,this.requestUpdate()}}}render(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return Z`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          <div class="wizard-header">
            <span class="wizard-title">${Aa("wizard.title",s)}</span>
            <button
              class="wizard-close-btn"
              @click="${this._close}"
              title="${Aa("wizard.close",s)}"
              aria-label="${Aa("wizard.close",s)}"
            >
              <ha-icon icon="mdi:close"></ha-icon>
            </button>
          </div>
          ${this._step!==bn.Welcome&&this._step!==bn.Done?Z`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>bn.Welcome&&this._step<bn.Done?this._confirmClose=!0:this._close())}_renderStepper(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=[Aa("wizard.stepper.weather",s),Aa("wizard.stepper.module",s),Aa("wizard.stepper.mapping",s),Aa("wizard.stepper.zone",s)];return Z`
      ${i.map((e,t)=>{const s=t+1,a=this._step===s,n=this._step>s;return Z`
        ...
        `})}
    `}_renderStep(e){switch(this._step){case bn.Welcome:return this._renderWelcome(e);case bn.Weather:return this._renderWeather(e);case bn.Module:return this._renderModule(e);case bn.Mapping:return this._renderMapping(e);case bn.Zone:return this._renderZone(e);case bn.Done:return this._renderDone(e);default:return Z``}}_renderFooter(e){return this._step===bn.Done?Z``:Z`
      <div class="footer-left">
        ${this._step>bn.Welcome?Z`<button
              class="wizard-btn secondary"
              @click="${this._back}"
              ?disabled="${this._saving}"
            >
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Aa("common.saving-messages.saving",e):this._step===bn.Welcome||this._step<bn.Zone?Aa("wizard.next",e):Aa("wizard.finish",e)}
      </button>
    `}_renderWelcome(e){return Z`
      <h2 class="step-title">
        ${Aa("wizard.steps.welcome.title",e)}
      </h2>
      <p class="step-desc">${Aa("wizard.steps.welcome.intro",e)}</p>
      <ul class="step-list">
        <li>① ${Aa("wizard.steps.welcome.step1_label",e)}</li>
        <li>② ${Aa("wizard.steps.welcome.step2_label",e)}</li>
        <li>③ ${Aa("wizard.steps.welcome.step3_label",e)}</li>
        <li>④ ${Aa("wizard.steps.welcome.step4_label",e)}</li>
      </ul>
      <p class="step-tip">${Aa("wizard.steps.welcome.tip",e)}</p>
    `}_renderWeather(e){return Z`
      <h2 class="step-title">
        ${Aa("wizard.steps.weather.title",e)}
      </h2>
      <p class="step-desc">
        ${Aa("wizard.steps.weather.description",e)}
      </p>
    ...
    `}_renderModule(e){if(0===this._availableModules.length)return Z`
        <h2 class="step-title">
          ${Aa("wizard.steps.module.title",e)}
        </h2>
        <p class="step-desc">
          ${Aa("wizard.steps.module.no_modules",e)}
        </p>
      `;const t=this._availableModules[this._selectedModuleIndex];return Z`
      <h2 class="step-title">${Aa("wizard.steps.module.title",e)}</h2>
      <p class="step-desc">
        ${Aa("wizard.steps.module.description",e)}
      </p>

      <si-field
        label="${Aa("wizard.steps.module.pick_label",e)}"
        required
      >
        <select
          class="wizard-input"
    ...
    `}_renderMapping(e){const t=[{value:Ue,label:Aa("wizard.steps.mapping.use_weather_service",e)},{value:"sensor",label:Aa("wizard.steps.mapping.use_sensor",e)},{value:"static",label:Aa("wizard.steps.mapping.use_static",e)},{value:Ge,label:Aa("wizard.steps.mapping.use_none",e)}],s=(s,i,a)=>Z`
      <si-field
        label="${Aa("wizard.steps.mapping.source_label",e)} ${s}"
      >
        <select
          class="wizard-input"
    ...
    `;return Z`
      <h2 class="step-title">
        ${Aa("wizard.steps.mapping.title",e)}
      </h2>
      <p class="step-desc">
        ${Aa("wizard.steps.mapping.description",e)}
      </p>

      <si-field
        label="${Aa("wizard.steps.mapping.name_label",e)}"
        required
      >
        <input
          type="text"
      ...
      ${s(Aa("panels.mappings.cards.mapping.items.temperature",e)||"Temperature",this._tempSource,e=>{this._tempSource=e,this.requestUpdate()})}
      ${s(Aa("panels.mappings.cards.mapping.items.humidity",e)||"Humidity",this._humiditySource,e=>{this._humiditySource=e,this.requestUpdate()})}
      ${s(Aa("panels.mappings.cards.mapping.items.precipitation",e)||"Precipitation",this._precipSource,e=>{this._precipSource=e,this.requestUpdate()})}

      <p class="step-tip">
        ${Aa("wizard.steps.mapping.description",e)}
      </p>
    `}_renderZone(e){var t;const s="imperial"!==(null===(t=this._siConfig)||void 0===t?void 0:t.units);return Z`
      <h2 class="step-title">${Aa("wizard.steps.zone.title",e)}</h2>
      <p class="step-desc">
        ${Aa("wizard.steps.zone.description",e)}
      </p>
    ...
    `}_renderDone(e){return Z`
      <div class="done-wrapper">
        ...
        <h2 class="step-title">${Aa("wizard.steps.done.title",e)}</h2>
        <p class="step-desc">
          ${Aa("wizard.steps.done.description",e)}
        </p>
        <ul class="step-list">
          <li>${Aa("wizard.steps.done.tip1",e)}</li>
          <li>${Aa("wizard.steps.done.tip2",e)}</li>
          <li>${Aa("wizard.steps.done.tip3",e)}</li>
        </ul>
        ...
        <div class="schedule-offer">
          ${this._scheduleCreated?Z`
                <div class="schedule-created">
                  ...
                  <span
                    >${Aa("wizard.steps.done.schedule_created",e)}</span
                  >
                </div>
              `:Z`
                <p class="schedule-offer-title">
                  ${Aa("wizard.steps.done.schedule_title",e)}
                </p>
                <p class="schedule-offer-desc">
                  ${Aa("wizard.steps.done.schedule_desc",e)}
                </p>
                <div class="schedule-offer-row">
                  ...
                  >
                    ${this._creatingSchedule?Aa("common.saving-messages.saving",e):Aa("wizard.steps.done.schedule_create",e)}
                  </button>
                </div>
              `}
        </div>
        ...
        <div class="done-actions">
          ...
          >
            ${Aa("wizard.steps.done.go_zones",e)}
          </button>
          <button
            class="wizard-btn secondary"
            @click="${()=>{this._close(),this._navigate("setup")}}"
          >
            ${Aa("wizard.steps.done.go_setup",e)}
          </button>
        </div>
      </div>
    `}static get styles(){return r`
    ...
    `}};t([pe({attribute:!1})],yn.prototype,"hass",void 0),t([ge()],yn.prototype,"_step",void 0),t([ge()],yn.prototype,"_saving",void 0),t([ge()],yn.prototype,"_error",void 0),t([ge()],yn.prototype,"_confirmClose",void 0),t([ge()],yn.prototype,"_siConfig",void 0),t([ge()],yn.prototype,"_useWeather",void 0),t([ge()],yn.prototype,"_weatherService",void 0),t([ge()],yn.prototype,"_apiKey",void 0),t([ge()],yn.prototype,"_weatherConfig",void 0),t([ge()],yn.prototype,"_availableModules",void 0),t([ge()],yn.prototype,"_selectedModuleIndex",void 0),t([ge()],yn.prototype,"_moduleConfig",void 0),t([ge()],yn.prototype,"_mappingName",void 0),t([ge()],yn.prototype,"_tempSource",void 0),t([ge()],yn.prototype,"_humiditySource",void 0),t([ge()],yn.prototype,"_precipSource",void 0),t([ge()],yn.prototype,"_zoneName",void 0),t([ge()],yn.prototype,"_zoneSize",void 0),t([ge()],yn.prototype,"_zoneThroughput",void 0),t([ge()],yn.prototype,"_zoneEntity",void 0),t([ge()],yn.prototype,"_scheduleTime",void 0),t([ge()],yn.prototype,"_scheduleCreated",void 0),t([ge()],yn.prototype,"_creatingSchedule",void 0),yn=t([ce("si-setup-wizard")],yn);const wn=Fa;var $n;!function(e){e.Zones="zones",e.Setup="setup"}($n||($n={})),e.SmartIrrigationPanel=class extends le{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}async firstUpdated(){const e=Ua().page;Object.values($n).includes(e)||Ha(0,ja($n.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())}),Rs().then(()=>{this._scheduleUpdate()}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}),this.hass&&$s(this.hass).then(e=>{this._config=e,this._scheduleUpdate()}).catch(e=>{console.error("Failed to fetch config for version display:",e)})}_ensureLanguage(){this.hass&&!za(this.hass.language)&&function(e){const t=ka(e);return za(e)?Promise.resolve():(xa[t]||(xa[t]=fetch(`/smart_irrigation_static/languages/${t}.json?v=${ve}`).then(e=>e.ok?e.json():Promise.reject(e.status)).then(e=>{$a[t]=e}).catch(()=>{$a[t]=$a.en})),xa[t])}(this.hass.language).then(()=>this.requestUpdate())}render(){var e,t;if(this.hass&&!za(this.hass.language))return this._ensureLanguage(),Z``;const s=Ua(),i=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return Z`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
            .narrow=${this.narrow}
          ></ha-menu-button>
          <div class="main-title">${Aa("title",this.hass.language)}</div>
        ...
        ${i&&a?Z`
              <ha-tab-group @wa-tab-show=${this.handlePageSelected}>
                ${Object.values($n).map(e=>Z`
                    <ha-tab-group-tab
                      slot="nav"
                      panel="${e}"
                      .active=${s.page===e}
                    >
                      ${Aa(`panels.${e}.title`,this.hass.language)}
                    </ha-tab-group-tab>
                  `)}
              </ha-tab-group>
            `:Z`
    ...
    `}getView(e){switch(e.page){case"zones":default:return Z`
        ...
        `;case"setup":return Z`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0}}"
          ></smart-irrigation-view-setup>
        `}}navigateToPage(e){if(e!==Ua().page){const t=ja(e);Ha(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==Ua().page){const e=ja(t);Ha(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[wn,r`
        :host {
          color: var(--primary-text-color);
    ...
    `}};t([pe({attribute:!1})],xn.prototype,"hass",void 0),t([ge()],xn.prototype,"_params",void 0),xn=t([ce("error-dialog")],xn);var kn=Object.freeze({__proto__:null,get ErrorDialog(){return xn}})}({});

...
`;const qa=e=>String(e).padStart(2,"0");function Ga(e){return e instanceof Date?e:new Date(e)}function Ka(e){const t=Ga(e);return`${qa(t.getHours())}:${qa(t.getMinutes())}`}function Va(e){const t=Ga(e);return`${t.getFullYear()}-${qa(t.getMonth()+1)}-${qa(t.getDate())} ${qa(t.getHours())}:${qa(t.getMinutes())}`}function Ya(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class Xa extends(Ba(le)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){Fs().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const s=Object.keys(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).length>0;s&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):s||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[s,i,a,n]=await Promise.all([zs(this.hass),Cs(this.hass),(t=this.hass,t.callWS({type:_e+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),Ns(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=s,this.zones=i,this._outlook=a,this._distributors=n,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),La(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),La(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),La(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const s="all"===t,i=s?void 0:this.zones.find(e=>{var s;return(null===(s=e.id)||void 0===s?void 0:s.toString())===t}),a=s?`(${this._linkedZoneCount})`:`: ${null!==(e=null==i?void 0:i.name)&&void 0!==e?e:t}`;try{await(n=this.hass,o=s?void 0:t,n.callWS(Object.assign({type:_e+"/irrigate_now"},void 0!==o?{zone_id:o}:{}))),Na(this,`${Aa("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${a}`)}catch(e){const t=Ma(e);console.error("irrigate_now failed",e),Na(this,`${Aa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var n,o}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const s=new Date(t);return s.getTime()>Date.now()?s:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:_e+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),La(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:_e+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),La(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,s;const i=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(s=this._runMinutes[i])&&void 0!==s?s:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const s=this._zoneDistributor(e);return!!s&&Object.keys(null!==(t=s.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var s,i,a;if(t>0)try{await(s=this.hass,i=e.id.toString(),a=t,s.callWS({type:_e+"/run_zone",zone_id:i,duration:a})),Na(this,`${Aa("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=Ma(e);console.error("run_zone failed",e),Na(this,`${Aa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===s?void 0:s[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,s;if(this.hass&&void 0!==e.id)try{await(t=this.hass,s=e.id.toString(),t.callWS({type:_e+"/stop_zone",zone_id:s})),Na(this,`${Aa("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=Ma(e);console.error("stop_zone failed",e),Na(this,`${Aa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",_e+"/zones",{id:i,calculate:!0,override_cache:!0})).catch(e=>{const t=Ma(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",_e+"/zones",{id:i,update:!0})).catch(e=>{const t=Ma(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;Da(0,t?Wa("setup","zones",t):Wa("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,s,i;const a=null!==(t=e.duration)&&void 0!==t?t:0,n=Number(null!==(s=e.bucket_threshold)&&void 0!==s?s:0),o=this._zoneEstimate(e),r=o&&o.available&&null!=o.live_deficit?o.live_deficit:Number(null!==(i=e.bucket)&&void 0!==i?i:0);return a>0&&r<n}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,s=new Date(e),i=Ka(s),a=new Date;return Ya(s,a)?`${Aa("panels.zones.outlook.today",t)} ${i}`:Ya(s,function(e,t){const s=new Date(e.getTime());return s.setDate(s.getDate()+t),s}(a,1))?`${Aa("panels.zones.outlook.tomorrow",t)} ${i}`:function(e,t){const s=Ga(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(s)} ${Ka(s)}`}(s,t)}_renderEstimatedTag(e){if(!this.hass||!e.estimated)return W``;const t=this.hass.language;return W`<span
      class="estimate-tag"
      title="${Aa("panels.zones.outlook.estimated_help",t)}"
      >${Aa("panels.zones.outlook.estimated",t)}<ha-icon
        icon="mdi:information-outline"
      ></ha-icon
    ></span>`}_guardLabel(e){return Aa(`panels.zones.outlook.checks.${e.id}`,this.hass.language)}_guardDetail(e){var t;return e.available&&null!==e.observed?Aa(`panels.zones.outlook.check_detail.${e.id}`,this.hass.language,"{observed}",String(e.observed),"{threshold}",String(null!==(t=e.threshold)&&void 0!==t?t:"")):""}_renderSkipReasons(){const e=this.hass.language;return W`
    ...
    `}_renderLastRunLine(e){const t=this.hass.language,s=function(e,t){const s=Ga(e).getTime()-Date.now(),i=new Intl.RelativeTimeFormat(t,{numeric:"auto"}),a=Math.round(s/1e3);if(Math.abs(a)<60)return i.format(a,"second");const n=Math.round(a/60);if(Math.abs(n)<60)return i.format(n,"minute");const o=Math.round(n/60);if(Math.abs(o)<24)return i.format(o,"hour");const r=Math.round(o/24);if(Math.abs(r)<30)return i.format(r,"day");const l=Math.round(r/30);return Math.abs(l)<12?i.format(l,"month"):i.format(Math.round(l/12),"year")}(e.timestamp,t),i=e.checks.filter(e=>e.enabled&&e.would_skip).map(e=>this._guardLabel(e).toLowerCase()).join(", "),a=e.would_skip?`${Aa("panels.zones.outlook.last_run_skipped",t)}${i?` (${i})`:""}`:Aa("panels.zones.outlook.last_run_ran",t);return W`
    ...
    `}_renderZoneDecision(e){var t;if(!this.hass)return W``;const s=this.hass.language,i=null!==(t=e.duration)&&void 0!==t?t:0;let a,n,o,r;if(e.state===ja.Disabled)a=Aa("panels.zones.status.decision_disabled",s),n="neutral",o="mdi:power-off";else if(e.last_calculated)if(this._zoneHasDeficit(e)){const t=Ia(i),l=this._triggeredGuards,d=this._nextIrrigateRunForZone(e);l.length>0?(a=Aa("panels.zones.status.decision_water_skip",s,"{duration}",t,"{reason}",this._guardLabel(l[0]).toLowerCase()),n="skip",o="mdi:weather-rainy"):d&&d.next_run_utc?(a=Aa("panels.zones.status.decision_water_at",s,"{duration}",t,"{time}",this._formatRunTime(d.next_run_utc)),n="water",o="mdi:water",r=d):(a=Aa("panels.zones.status.decision_water_no_schedule",s,"{duration}",t),n="water",o="mdi:water-alert")}else a=Aa("panels.zones.status.decision_no_water",s),n="ok",o="mdi:check-circle-outline";else a=Aa("panels.zones.status.decision_unknown",s),n="unknown",o="mdi:help-circle-outline";return W`
      <div class="zone-decision ${n}">
        <ha-icon icon="${o}"></ha-icon>
        <span>${a}</span>
        ${r?this._renderEstimatedTag(r):""}
      </div>
    `}_zoneEstimate(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.zone_estimates)||void 0===s?void 0:s[String(e.id)]}_zoneFault(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.zone_faults)||void 0===s?void 0:s[String(e.id)]}_renderZoneFault(e){if(!this.hass)return W``;const t=this._zoneFault(e);if(!t)return W``;const s=this.hass.language,i=Aa(`panels.zones.fault.${t.reason}`,s)||Aa("panels.zones.fault.generic",s),a=t.timestamp?Va(t.timestamp):"";return W`
    ...
    `}_zoneSkip(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.zone_skips)||void 0===s?void 0:s[String(e.id)]}_renderZoneSkip(e){if(!this.hass)return W``;const t=this._zoneSkip(e);if(!t)return W``;const s=this.hass.language,i=Aa("panels.zones.skip.soil_moisture",s,"{observed}",String(t.observed),"{threshold}",String(t.threshold)),a=t.timestamp?Va(t.timestamp):"";return W`
    ...
    `}_durationClamped(e){var t,s;if(e.state!==ja.Automatic)return!1;const i=e.maximum_duration;if(null==i||i<0)return!1;const a=null!==(t=e.duration)&&void 0!==t?t:0;return!(a<=0)&&a-(null!==(s=e.lead_time)&&void 0!==s?s:0)>=i}_renderDurationClamped(e){var t;if(!this.hass||!this._durationClamped(e))return W``;const s=this.hass.language,i=Aa("panels.zones.clamped.detail",s,"{maximum}",Ia(null!==(t=e.maximum_duration)&&void 0!==t?t:0));return W`
      <div class="zone-clamped" title="${i}">
        <ha-icon icon="mdi:timer-alert-outline"></ha-icon>
        <span>
          <strong>${Aa("panels.zones.clamped.title",s)}</strong>
          <ha-icon
            class="clamped-hint"
            icon="mdi:information-outline"
          ></ha-icon>
    ...
    `}_renderZoneEstimate(e){if(!this.hass)return W``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return W``;const s=this.hass.language,i=Oa(this.config,_t),a=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",n=Aa(`panels.zones.status.estimate_method.${"proxy"===t.method||"hourly_sensor"===t.method?t.method:"hourly"}`,s)+(t.as_of?` · ${Ka(t.as_of)}`:"");return W`
    ...
    `}_renderZoneNextRun(e){if(!this.hass)return W``;const t=this._nextIrrigateRunForZone(e);if(!t||!t.next_run_utc)return W``;return e.state!==ja.Disabled&&e.last_calculated&&this._zoneHasDeficit(e)&&0===this._triggeredGuards.length?W``:W`
      <span class="status-sep">·</span>
      <span>
    ...
    `}renderZone(e,t){var s;if(!this.hass)return W``;const i=Number(null!==(s=e.bucket)&&void 0!==s?s:0),a=i<0?"var(--warning-color)":"var(--success-color)",n=e.state===ja.Automatic?"state-automatic":e.state===ja.Manual?"state-manual":"state-disabled",o=e.last_calculated?Va(e.last_calculated):Aa("panels.zones.status.never",this.hass.language);return W`
      <ha-card>
        ...
        <div class="card-content zone-action-bar">
          ${"full"===this.actionsMode&&e.state===ja.Automatic?W`
                <button
                  class="action-btn"
    ...
    `}_renderRunZoneControl(e){if(!this.hass||"none"===this.actionsMode||!this._canActuate(e)||void 0===e.id)return W``;const t=this.hass.language,s=String(e.id),i=this._activeRun(e);if(i){const s=this._runSecondsLeft(i);return W`
        <div class="run-zone-control running">
          <span class="run-zone-countdown">
            ...
            ${null===s?Aa("panels.zones.stop_zone.watering",t):this._formatCountdown(s)}
          </span>
          <button
    ...
    `}}t([pe()],Xa.prototype,"config",void 0),t([pe({type:Boolean})],Xa.prototype,"hideSettingsLinks",void 0),t([pe({attribute:!1})],Xa.prototype,"actionsMode",void 0),t([pe({type:Array})],Xa.prototype,"zones",void 0),t([ge()],Xa.prototype,"_outlook",void 0),t([ge()],Xa.prototype,"_distributors",void 0),t([pe({type:Boolean})],Xa.prototype,"isLoading",void 0),t([pe({type:Boolean})],Xa.prototype,"isSaving",void 0),t([ge()],Xa.prototype,"_operationError",void 0),t([ge()],Xa.prototype,"_confirmIrrigate",void 0),t([ge()],Xa.prototype,"_skipDetailsOpen",void 0),t([ge()],Xa.prototype,"_runMinutes",void 0),t([ge()],Xa.prototype,"_now",void 0),customElements.get("smart-irrigation-view-zones")||customElements.define("smart-irrigation-view-zones",Xa)
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */;const Ja={},Qa=Ks(class extends Vs{constructor(e){if(super(e),e.type!==qs&&e.type!==Ws&&e.type!==Gs)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===Z||t===q)return t;const s=e.element,i=e.name;if(e.type===qs){if(t===s[i])return Z}else if(e.type===Gs){if(!!t===s.hasAttribute(i))return Z}else if(e.type===Ws&&s.getAttribute(i)===t+"")return Z;return((e,t=Ja)=>{e._$AH=t;
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */})(e),t}});let en=class extends le{constructor(){super(...arguments),this.label="",this.unit="",this.help="",this.required=!1,this._helpOpen=!1}_toggleHelp(){this._helpOpen=!this._helpOpen}render(){return W`
      <div class="si-field">
    ...
    `}};t([pe({attribute:!1})],tn.prototype,"hass",void 0),t([pe({type:Boolean})],tn.prototype,"useWeather",void 0),t([pe()],tn.prototype,"service",void 0),t([pe()],tn.prototype,"apiKey",void 0),t([pe({attribute:!1})],tn.prototype,"weatherConfig",void 0),t([ge()],tn.prototype,"_testing",void 0),t([ge()],tn.prototype,"_testResult",void 0),tn=t([ce("si-weather-source-config")],tn);let sn=class extends(Ba(le)){constructor(){super(...arguments),this.section="all",this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._weatherConfig=null,this._weatherService=null,this._useWeatherService=!1,this._newApiKey="",this._weatherSaving=!1,this._coords=null,this._coordsEnabled=!1,this._coordsLat="",this._coordsLon="",this._coordsElev="",this._coordsSaving=!1,this._saveStatus="idle",this._savedResetTimer=null,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null,t={};return s=>{t=Object.assign(Object.assign({},t),s),e&&clearTimeout(e),e=window.setTimeout(()=>{const s=t;t={},e=null,this.saveData(s)},500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){var e;if(!this.hass)return;const t=!this._initialLoadDone;t&&(this.isLoading=!0,this._scheduleUpdate());try{const[t,a,n]=await Promise.all([zs(this.hass),Ps(this.hass),Bs(this.hass)]);this.config=t,this._weatherConfig=a,this._useWeatherService=a.use_weather_service,this._weatherService=null!==(e=a.weather_service)&&void 0!==e?e:ze,this._applyCoordinates(n),this.data=(s=this.config,i=["calctime","autocalcenabled","autocalcmode","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","days_between_irrigation"],s?Object.entries(s).filter(([e])=>i.includes(e)).reduce((e,[t,s])=>Object.assign(e,{[t]:s}),{}):{}),this._initialLoadDone=!0}catch(e){console.error("Error fetching data:",e),La(this,this.hass,"common.errors.load_failed",e)}finally{t&&(this.isLoading=!1),this._scheduleUpdate()}var s,i}firstUpdated(){Fs().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}render(){var e,t;return this.hass&&this.config&&this.data?this.isLoading?W`<div class="loading-indicator">
        ${Aa("common.loading-messages.general",this.hass.language)}
    ...
    `:W``}async _saveWeatherConfig(){if(this.hass){this._weatherSaving=!0,this._scheduleUpdate();try{await Rs(this.hass,this._useWeatherService,this._useWeatherService?this._weatherService:null,this._newApiKey||null),this._newApiKey="",await this._fetchData()}catch(e){console.error("Failed to save weather config:",e),La(this,this.hass,"common.errors.save_failed",e)}finally{this._weatherSaving=!1,this._scheduleUpdate()}}}_renderWeatherServiceCard(){var e;return this.hass?W`
      <ha-card
                ...
                <div class="setting-row">
                  ...
                  <div class="inline-row">
                    ...
                    <select
                      ...
                      .value="${Qa(this.data.autoupdateschedule||Ae)}"
      ...
      >
        ...
        <div class="card-content">
          <div class="setting-row">
            ...
            <select
              class="settings-input"
              .value="${Qa(this.config.zone_sequencing||Ft)}"
    ...
    `}};t([pe()],sn.prototype,"narrow",void 0),t([pe()],sn.prototype,"path",void 0),t([pe()],sn.prototype,"section",void 0),t([pe()],sn.prototype,"data",void 0),t([pe()],sn.prototype,"config",void 0),t([pe({type:Boolean})],sn.prototype,"isLoading",void 0),t([pe({type:Boolean})],sn.prototype,"isSaving",void 0),t([pe()],sn.prototype,"_weatherConfig",void 0),t([pe()],sn.prototype,"_weatherService",void 0),t([pe({type:Boolean})],sn.prototype,"_useWeatherService",void 0),t([pe()],sn.prototype,"_newApiKey",void 0),t([pe({type:Boolean})],sn.prototype,"_weatherSaving",void 0),t([ge()],sn.prototype,"_coords",void 0),t([ge()],sn.prototype,"_coordsEnabled",void 0),t([ge()],sn.prototype,"_coordsLat",void 0),t([ge()],sn.prototype,"_coordsLon",void 0),t([ge()],sn.prototype,"_coordsElev",void 0),t([ge()],sn.prototype,"_coordsSaving",void 0),t([ge()],sn.prototype,"_saveStatus",void 0),sn=t([ce("smart-irrigation-view-general")],sn);const an=e=>9*e/5+32;function nn(e,t,s){if(null==e||Number.isNaN(e))return null;switch(t){case"temperature":return s?{value:e,unit:"°C"}:{value:an(e),unit:"°F"};case"precipitation":return s?{value:e,unit:at}:{value:(n=e,n/25.4),unit:nt};case"windspeed":return s?{value:e,unit:lt}:{value:(a=e,2.2369362920544*a),unit:rt};case"pressure":return s?{value:e,unit:"hPa"}:{value:(i=e,.0295299830714*i),unit:ot}}var i,a,n}function on(e,t,s,i){const a=nn(e,t,s);if(!a)return"-";const n=function(e,t){return"pressure"===e?t?0:2:"precipitation"===e?t?1:2:1}(t,s);return`${a.value.toFixed(n)} ${a.unit}`}function rn(e,t){return null==e||Number.isNaN(e)?"-":t?`${e.toFixed(0)} L`:`${(e=>.264172052*e)(e).toFixed(1)} gal`}let ln=class extends le{constructor(){super(...arguments),this.metric=!0,this.name="",this.size="",this.throughput="",this.linkedEntity="",this.showEntity=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{value:t},bubbles:!0,composed:!0}))}render(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=this.metric?"m²":et,a=this.metric?tt:st;return W`
    ...
    `}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await As(this.hass,e)}_renderModuleOptions(e){if(!this.hass)return W``;const t=null!=e?String(e):"";return W`
    ...
    `}_renderDistributorSelector(e,t){var s,i;if(!this.hass)return W``;if(!(null===(s=this.config)||void 0===s?void 0:s.distributors_enabled))return W``;const a=this.hass.language,n=null!=e.distributor_id;return W`
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${Qa(n?String(e.distributor_id):"")}"
             ...
             used to sit alongside it moved to the Weather & Location tab). -->
              <div class="card-content zone-settings">
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${Qa(null!==(i=Object.keys(Bt).find(t=>Bt[t]===e.drainage_rate))&&void 0!==i?i:"custom")}"
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${Qa(null!==(o=e.plant_type)&&void 0!==o?o:"custom")}"
                    @change="${s=>{const i=s.target.value,a={[zt]:i};"custom"!==i&&void 0!==Rt[i]&&(a.kc=Rt[i]),this.handleEditZone(t,Object.assign(Object.assign({},e),a))}}"
                  >
                    <option
                      value="custom"
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${Qa(void 0!==e.module?String(e.module):"")}"
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${Qa(void 0!==e.mapping?String(e.mapping):"")}"
                ...
                ${null!=e.distributor_id?W`<div class="distributor-managed">
                      ...
                      <ha-settings-row>
                        ...
                        <select
                          class="settings-input"
                          .value="${Qa(null!==(d=e.watering_mode)&&void 0!==d?d:"classic")}"
                      ...
                      ${"service"===e.watering_mode?W`
                            ...
                            <ha-settings-row>
                              ...
                              <select
                                class="settings-input"
                                .value="${Qa(null!==(h=e.duration_unit)&&void 0!==h?h:"seconds")}"
                ...
                ${null==e.distributor_id?W`
                      ...
                      ${this._flowSensorIsTotalizer(e)?W`
                            <ha-settings-row>
                              ...
                              <select
                                class="settings-input"
                                .value="${Qa(e.flow_counter_type||"auto")}"
        ...
        <div class="card-content">
          <div class="history-usage">
            ...
            <span class="history-usage-value"
              >${rn(null!==(i=e.water_used_total)&&void 0!==i?i:0,a)}</span
            >
          </div>
    ...
    `}_renderRunLogRow(e,t){const s=this.hass.language,i=Aa(`panels.zones.history.results.${e.result}`,s);let a="";return e.detail&&(a="skipped"===e.result?e.detail.split(",").map(e=>Aa(`panels.zones.outlook.checks.${e}`,s)||e).join(", "):Aa(`panels.zones.fault.${e.detail}`,s)||e.detail),W`
      <tr>
        <td>${Va(e.ts)}</td>
        <td>
        ...
        <td class="num">
          ${e.volume_l>0?rn(e.volume_l,t):"-"}
        </td>
        <td class="history-detail">${Xs(a)}</td>
      </tr>
    ...
    `}};t([pe()],dn.prototype,"config",void 0),t([pe({attribute:!1})],dn.prototype,"path",void 0),t([pe({type:Array})],dn.prototype,"zones",void 0),t([pe({type:Array})],dn.prototype,"modules",void 0),t([pe({type:Array})],dn.prototype,"mappings",void 0),t([pe({type:Array})],dn.prototype,"distributors",void 0),t([pe({type:Boolean})],dn.prototype,"isLoading",void 0),t([ge()],dn.prototype,"_expanded",void 0),t([pe({type:Boolean})],dn.prototype,"isSaving",void 0),t([pe({type:Boolean})],dn.prototype,"_showAddZone",void 0),t([ge()],dn.prototype,"_pendingConfirm",void 0),t([ge()],dn.prototype,"_saveStatus",void 0),t([pe()],dn.prototype,"_confirmDeleteZoneId",void 0),t([pe()],dn.prototype,"_newZoneName",void 0),t([pe()],dn.prototype,"_newZoneSize",void 0),t([pe()],dn.prototype,"_newZoneThroughput",void 0),t([pe()],dn.prototype,"_newZoneEntity",void 0),dn=t([ce("smart-irrigation-view-zone-settings")],dn);let cn=class extends le{_emit(e){this.dispatchEvent(new CustomEvent("distributor-changed",{detail:{value:Object.assign(Object.assign({},this.distributor),e)},bubbles:!0,composed:!0}))}_onNumber(e,t){const s=t.target.valueAsNumber;isNaN(s)||this._emit({[e]:Math.max(0,Math.round(s))})}render(){var e,t,s,i;if(!this.hass||!this.distributor)return W``;const a=this.hass.language,n=this.distributor,o=n.watering_mode===ws;return W`
      <ha-settings-row>
        <span slot="heading"
        ...
        <input
          ...
          @input="${e=>this._emit({[rs]:e.target.value})}"
        />
      </ha-settings-row>
      ...
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${Qa(null!==(t=n.watering_mode)&&void 0!==t?t:ys)}"
          @change="${e=>this._emit({[ls]:e.target.value})}"
        >
          <option
            value="${ys}"
            ?selected="${(null!==(s=n.watering_mode)&&void 0!==s?s:ys)===ys}"
          >
            ${Aa("panels.zones.labels.watering_modes.classic",a)}
          </option>
          <option
            value="${ws}"
            ?selected="${n.watering_mode===ws}"
          >
      ...
      <ha-settings-row>
        ...
        <input
          ...
          @input="${e=>this._emit({[_s]:e.target.value||null})}"
        />
      </ha-settings-row>
    `}_renderInletWatchRows(e){var t;const s=this.distributor,i=s.watering_mode===ws?"panels.distributors.labels.inlet_entity_help_service":"panels.distributors.labels.inlet_entity_help",a=null!==(t=s.watch_mode)&&void 0!==t?t:"ignore";return W`
      <ha-settings-row>
        <span slot="heading"
    ...
    `}_renderServiceRows(e){var t,s;const i=this.distributor;return W`
      ...
      <ha-settings-row>
        ...
        <input
          ...
          @input="${e=>this._emit({[ps]:e.target.value||"duration"})}"
        />
      </ha-settings-row>
      ...
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${Qa(null!==(t=i.duration_unit)&&void 0!==t?t:"seconds")}"
    ...
    `}_hasOwnActuation(e){return!!(e.linked_entity||e.run_service||e.stop_service)}_membersByOutlet(e){const t=new Map;if(void 0===e)return t;for(const s of this.zones)s.distributor_id===e&&null!=s.outlet_number&&void 0!==s.id&&t.set(s.outlet_number,s);return t}_outletCount(e){const t=this._membersByOutlet(e.id),s=t.size?Math.max(...t.keys()):0,i=Math.max(2,s),a=void 0!==e.id?this._outletRows[e.id]:void 0;return Math.min(6,Math.max(i,null!=a?a:i))}_assignZone(e,t,s){return As(this.hass,{id:e.id,[xs]:t,[ks]:s})}_optimisticZone(e,t,s){void 0!==e&&(this.zones=this.zones.map(i=>i.id===e?Object.assign(Object.assign({},i),{distributor_id:t,outlet_number:s}):i))}_runAssign(e){e.length&&(this.isSaving=!0,this._saveStatus="saving",this._scheduleUpdate(),Promise.all(e).then(()=>this._markSaved()).catch(e=>{console.error("Failed to assign zone to outlet:",e),this._saveStatus="idle",La(this,this.hass,"common.errors.save_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(()=>{})}))}_setOutletCount(e,t){if(void 0===e.id)return;const s=this._membersByOutlet(e.id),i=[];for(const[e,a]of s)e>t&&i.push(a);this._outletRows=Object.assign(Object.assign({},this._outletRows),{[e.id]:t}),i.length?(i.forEach(e=>this._optimisticZone(e.id,null,null)),this._runAssign(i.map(e=>this._assignZone(e,null,null)))):this._scheduleUpdate()}_onOutletZoneChange(e,t,s){const i=s.target.value,a=i?parseInt(i):null,n=this._membersByOutlet(e.id).get(t),o=null!==a?this.zones.find(e=>e.id===a):null,r=[];n&&n.id!==a&&(r.push(this._assignZone(n,null,null)),this._optimisticZone(n.id,null,null)),o&&(r.push(this._assignZone(o,e.id,t)),this._optimisticZone(o.id,e.id,t)),this._runAssign(r)}_renderOutletConfig(e){if(!this.hass)return W``;const t=this.hass.language,s=this._membersByOutlet(e.id),i=this._outletCount(e),a=this.zones.filter(e=>void 0!==e.id&&null==e.distributor_id&&!this._hasOwnActuation(e)),n=[...s.keys()].sort((e,t)=>e-t),o=n.some((e,t)=>e!==t+1),r=[];for(let n=1;n<=i;n++){const i=s.get(n),o=i?[...a,i]:[...a];o.sort((e,t)=>(e.name||"").localeCompare(t.name||"")),r.push(W`
        <div class="outlet-row">
          ...
          <select
            class="settings-input"
            .value="${Qa(null!=(null==i?void 0:i.id)?String(i.id):"")}"
        ...
        <ha-settings-row>
          ...
          <div class="inline-controls">
            <input
              ...
              max="${6}"
              step="1"
              .value="${Qa(String(null!==(t=this._outletDraft[o])&&void 0!==t?t:e.current_outlet))}"
    ...
    `}};t([pe()],hn.prototype,"config",void 0),t([pe({attribute:!1})],hn.prototype,"path",void 0),t([pe({type:Array})],hn.prototype,"distributors",void 0),t([pe({type:Array})],hn.prototype,"zones",void 0),t([pe({type:Boolean})],hn.prototype,"isLoading",void 0),t([pe({type:Boolean})],hn.prototype,"isSaving",void 0),t([ge()],hn.prototype,"_expanded",void 0),t([pe({type:Boolean})],hn.prototype,"_showAdd",void 0),t([pe()],hn.prototype,"_newName",void 0),t([pe()],hn.prototype,"_confirmDeleteId",void 0),t([ge()],hn.prototype,"_armConfirmId",void 0),t([ge()],hn.prototype,"_confirmResyncHomeId",void 0),t([ge()],hn.prototype,"_confirmSetOutletId",void 0),t([ge()],hn.prototype,"_outletDraft",void 0),t([ge()],hn.prototype,"_outletRows",void 0),t([ge()],hn.prototype,"_saveStatus",void 0),hn=t([ce("smart-irrigation-view-distributor-settings")],hn);let un=class extends(Ba(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.moduleCache=new Map,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout(()=>{this.saveToHA(t),e=null},500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){Fs().catch(e=>{console.error("Failed to load HA form:",e)})}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;e&&(this.isLoading=!0,this._scheduleUpdate());try{const[e,t,s,i]=await Promise.all([zs(this.hass),Cs(this.hass),Es(this.hass),Ts(this.hass)]);this.config=e,this.zones=t,this.modules=s,this.allmodules=i,this._initialLoadDone=!0,this.moduleCache.clear()}catch(e){console.error("Error fetching data:",e),La(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}}async handleAddModule(){var e,t;if((null===(t=null===(e=this.moduleInput)||void 0===e?void 0:e.selectedOptions)||void 0===t?void 0:t[0])&&!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.moduleInput.selectedOptions[0].text,t=this.allmodules.find(t=>t.name===e);if(!t)return;const s={name:e,description:t.description,config:t.config,schema:t.schema};this.modules=[...this.modules,s],this.moduleCache.clear(),this._scheduleUpdate(),await this.saveToHA(s),await this._fetchData()}catch(e){console.error("Error adding module:",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}}}async handleRemoveModule(e,t){if(!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.modules[t],a=null==e?void 0:e.id;this.modules;this.modules=this.modules.filter((e,s)=>s!==t),this.moduleCache.clear(),this._scheduleUpdate(),this.hass&&void 0!==a&&await(s=this.hass,i=a.toString(),s.callApi("POST",_e+"/modules",{id:i,remove:!0}))}catch(e){console.error("Error removing module:",e),La(this,this.hass,"common.errors.delete_failed",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}var s,i}}async saveToHA(e){if(this.hass)try{await Os(this.hass,e)}catch(e){throw console.error("Error saving module:",e),La(this,this.hass,"common.errors.save_failed",e),e}}renderModule(e,t){if(!this.hass)return W``;const s=this.zones.filter(t=>t.module===e.id).length,i=`module-${e.id||t}-${s}-${JSON.stringify(e)}`;if(this.moduleCache.has(i))return this.moduleCache.get(i);const a=W`
      <ha-card>
        <div class="card-header">
          <div class="name">${e.name}</div>
    ...
    `;return this.moduleCache.set(i,a),a}renderUsageChip(e){return this.hass?e?W`<span class="usage-chip"
      ...
      >
        ${Object.entries(n.options).map(([e,s])=>W`<option
              ...
              ?selected="${h===Ta(s,0)}"
            >
              ${Aa("panels.modules.cards.module.translated-options."+Ta(s,1),t)}
            </option>`)}
    ...
    `}};t([pe()],un.prototype,"config",void 0),t([pe({type:Array})],un.prototype,"zones",void 0),t([pe({type:Array})],un.prototype,"modules",void 0),t([pe({type:Array})],un.prototype,"allmodules",void 0),t([pe({type:Boolean})],un.prototype,"isLoading",void 0),t([pe({type:Boolean})],un.prototype,"isSaving",void 0),t([me("#moduleInput")],un.prototype,"moduleInput",void 0),un=t([ce("smart-irrigation-view-modules")],un);let pn=class extends(Ba(le)){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this.debounceTimers=new Map,this.globalDebounceTimer=null,this.mappingCache=new Map,this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()},this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()}))}firstUpdated(){Fs().catch(e=>{console.error("Failed to load HA form:",e)})}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[t,s,i]=await Promise.all([zs(this.hass),Cs(this.hass),Hs(this.hass)]);this.config=t,this.zones=s,this.mappings=i,this._initialLoadDone=!0,this.mappingCache.clear()}catch(e){console.error("Error fetching data:",e),La(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}}handleAddMapping(){if(!this.mappingNameInput.value.trim())return;const e={[He]:"",[De]:"",[Me]:"",[Ie]:"",[Ne]:"",[Le]:"",[Pe]:"",[Re]:"",[Be]:""},t={name:this.mappingNameInput.value.trim(),mappings:e};this.mappings=[...this.mappings,t],this.isSaving=!0,this.saveToHA(t).then(()=>(this.mappingNameInput.value="",this._fetchData())).catch(e=>{console.error("Failed to add mapping:",e),La(this,this.hass,"common.errors.save_failed",e),this.mappings=this.mappings.slice(0,-1)}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()})}handleRemoveMapping(e,t){const s=this.mappings[t].id;if(null==s)return;const i=[...this.mappings];var a,n;(this.mappings=this.mappings.filter((e,s)=>s!==t),this.mappingCache.delete(s.toString()),this.hass)&&(this.isSaving=!0,(a=this.hass,n=s.toString(),a.callApi("POST",_e+"/mappings",{id:n,remove:!0})).catch(e=>{console.error("Failed to delete mapping:",e),La(this,this.hass,"common.errors.delete_failed",e),this.mappings=i,this._fetchData().catch(e=>{console.error("Failed to refresh data after delete error:",e)})}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditMapping(e,t){this.mappings[e]=t,t.id&&this.mappingCache.delete(t.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout(()=>{this.isSaving=!0,this.saveToHA(t).catch(e=>{console.error("Failed to save mapping:",e),La(this,this.hass,"common.errors.save_failed",e)}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()}),this.globalDebounceTimer=null},500),this._scheduleUpdate()}async saveToHA(e){var t;if(!this.hass)throw new Error("Home Assistant connection not available");const s=[],i=this.hass.states;for(const t in e.mappings){const a=e.mappings[t].sensorentity;if(a&&""!==a.trim()){const n=a.trim();e.mappings[t].sensorentity=n,n in i||s.push(n)}}if(s.length>0){const e=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("ha-card");throw e&&Ha({body:{message:Aa("panels.mappings.cards.mapping.errors.source_does_not_exist",this.hass.language)+": "+s.join(", ")},error:Aa("panels.mappings.cards.mapping.errors.invalid_source",this.hass.language)},e),new Error("Invalid sensor entities found")}const{id:a,name:n,mappings:o}=e;await Ds(this.hass,{id:a,name:n,mappings:o})}renderMappingSetting(e,t){const s=this.mappings[e];if(!s||!this.hass)return W``;const i=s.mappings[t];return W`
    ...
    `}renderSimpleRadioOptions(e,t,s){if(!this.hass||!this.config)return W``;const i=t===De||t===Pe,a=s[Ke];return W`
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return W`<option value="${e}" ?selected="${e===t}">
        ...
        <option
          ...
          ?selected="${s===Ze}"
        >
          ${Aa("panels.mappings.cards.mapping.pressure_types."+Ze,this.hass.language)}
        </option>
        <option
          value="${qe}"
          ?selected="${s===qe}"
        ...
        </option>`,e}return W``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return W``;const s=function(e){switch(e){case He:case Re:return[{unit:"°C",system:Oe},{unit:"°F",system:Te}];case Ie:case De:return[{unit:at,system:Oe},{unit:nt,system:Te}];case Ne:return[{unit:dt,system:Oe},{unit:ct,system:Te}];case Me:return[{unit:"%",system:[Oe,Te]}];case Le:return[{unit:"millibar",system:Oe},{unit:"hPa",system:Oe},{unit:"psi",system:Te},{unit:ot,system:Te}];case Be:return[{unit:"km/h",system:Oe},{unit:lt,system:Oe},{unit:rt,system:Te}];case Pe:return[{unit:"W/m2",system:Oe},{unit:"MJ/day/m2",system:Oe},{unit:"W/sq ft",system:Te},{unit:"MJ/day/sq ft",system:Te}];default:return[]}}(e);let i=t[Xe];const a=this.config.units;if(!t[Xe])for(const e of s)if("string"==typeof e.system){if(a===e.system){i=e.unit;break}}else{for(const t of e.system)if(a===t.system){i=e.unit;break}if(i===e.unit)break}return W`
      ${s.map(e=>W`
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach(e=>{clearTimeout(e)}),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};t([pe()],pn.prototype,"config",void 0),t([pe({type:Array})],pn.prototype,"zones",void 0),t([pe({type:Array})],pn.prototype,"mappings",void 0),t([pe({type:Boolean})],pn.prototype,"isLoading",void 0),t([pe({type:Boolean})],pn.prototype,"isSaving",void 0),t([me("#mappingNameInput")],pn.prototype,"mappingNameInput",void 0),pn=t([ce("smart-irrigation-view-mappings")],pn);const gn=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"];function mn(e,t){return Aa(`panels.schedules.types.${e}`,t)||e}let vn=class extends le{constructor(){super(...arguments),this.zones=[],this.heading="",this._save=()=>{this.dispatchEvent(new CustomEvent("save",{detail:{value:this.schedule},bubbles:!0,composed:!0}))},this._cancel=()=>{this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}}_emitChanged(e){this.dispatchEvent(new CustomEvent("schedule-changed",{detail:{value:Object.assign(Object.assign({},this.schedule),e)},bubbles:!0,composed:!0}))}_renderZonePicker(){const e="all"===this.schedule.zones||!Array.isArray(this.schedule.zones),t=e?[]:this.schedule.zones.map(String);return W`
      <div class="field">
        <label
    ...
    `}_renderTypeFields(){var e;const t=this.schedule;switch(t.type){case"daily":return W`
          <div class="field">
            <label
        ...
        `;case Jt:case Qt:return W`${this._renderSunOffsetFields()}`;case es:return W`
          <div class="field">
            <label
        ...
        `;default:return W``}}_renderSunOffsetFields(){var e;const t=this.schedule;return W`
      <div class="field">
        <label
    ...
    `}_timeAnchor(e){var t;const s=[Jt,Qt,es].includes(e.type)&&!1!==e.account_for_duration;return null!==(t=e.time_anchor)&&void 0!==t?t:s?ts:"start"}_hasRunWindow(e){return"irrigate"===e.action&&"interval"!==e.type&&this._timeAnchor(e)===ts}_renderTimeAnchorField(){const e=this.schedule;if("irrigate"!==e.action||"interval"===e.type)return W``;const t=this._timeAnchor(e);return W`
      <div class="field">
        <label
    ...
    `}_renderRunWindowFields(){var e,t;const s=this.schedule;if(!this._hasRunWindow(s))return W``;const i=this.hass.language,a=ns.includes(null!==(e=s.earliest_start_mode)&&void 0!==e?e:"")?s.earliest_start_mode:ss;return W`
      <div class="field">
        <label
          >${Aa("panels.schedules.fields.earliest_start",i)}</label
        >
        <select
          @change=${e=>{const t=e.target.value;this._emitChanged({earliest_start_mode:t,earliest_start_time:t===is?s.earliest_start_time||os:s.earliest_start_time})}}
        >
          ${ns.map(e=>W`
              <option value="${e}" ?selected="${a===e}">
                ${Aa(`panels.schedules.earliest_start.${e}`,i)}
              </option>
            `)}
        </select>
        <span class="field-help"
          >${Aa("panels.schedules.help.earliest_start",i)}</span
        >
      </div>
      ...
      ${a===is?W`
            <div class="field">
              <label
                >${Aa("panels.schedules.fields.earliest_start_time",i)}</label
              >
              <input
                type="time"
                .value="${s.earliest_start_time||os}"
                @change=${e=>this._emitChanged({earliest_start_time:e.target.value})}
              />
            </div>
          `:""}
      ${a===as?W`
            <div class="field">
              <label
                >${Aa("panels.schedules.fields.earliest_start_offset",i)}</label
              >
              <div class="input-suffix-row">
                <input
                  type="number"
                  step="1"
                  .value="${String(null!==(t=s.earliest_start_offset_minutes)&&void 0!==t?t:0)}"
                  @input=${e=>{const t=parseInt(e.target.value);this._emitChanged({earliest_start_offset_minutes:isNaN(t)?0:t})}}
                />
                <span class="suffix"
                  >${Aa("panels.schedules.minutes",i)}</span
                >
              </div>
            </div>
          `:""}
      ...
      <div class="field">
        <div class="field-row">
          <label
            >${Aa("panels.schedules.fields.fit_to_window",i)}</label
          >
          <input
            type="checkbox"
            ?checked="${!0===s.fit_to_window}"
            @change=${e=>this._emitChanged({fit_to_window:e.target.checked})}
          />
        </div>
        <span class="field-help"
          >${Aa("panels.schedules.help.fit_to_window",i)}</span
        >
      </div>
    `}render(){if(!this.hass||!this.schedule)return W``;const e=this.schedule;return W`
    ...
    `}static get styles(){return[Za,r`
      ...
      `]}};t([pe({attribute:!1})],vn.prototype,"hass",void 0),t([pe({attribute:!1})],vn.prototype,"schedule",void 0),t([pe({attribute:!1})],vn.prototype,"zones",void 0),t([pe({attribute:!1})],vn.prototype,"heading",void 0),vn=t([ce("si-schedule-dialog")],vn);let _n=class extends(Ba(le)){constructor(){super(...arguments),this._schedules=[],this._zones=[],this._isLoading=!0,this._showDialog=!1,this._editingSchedule={name:"",type:"daily",enabled:!0,time:"06:00",action:"irrigate",zones:"all"},this._editingId=null}hassSubscribe(){return this._load(),[this.hass.connection.subscribeMessage(()=>this._load(),{type:_e+"_config_updated"})]}async _load(){var e;if(this.hass)try{const[t,s]=await Promise.all([(e=this.hass,e.callWS({type:_e+"/schedules"})),Cs(this.hass)]);this._schedules=t||[],this._zones=s||[]}catch(e){console.error("Failed to load schedules",e),La(this,this.hass,"common.errors.load_failed",e)}finally{this._isLoading=!1}}_openAdd(){this._editingSchedule={name:"",type:"daily",enabled:!0,time:"06:00",action:"irrigate",zones:"all"},this._editingId=null,this._showDialog=!0}_openEdit(e){var t;this._editingSchedule=Object.assign({},e),this._editingId=null!==(t=e.id)&&void 0!==t?t:null,this._showDialog=!0}_closeDialog(){this._showDialog=!1}async _save(){const e=Object.assign({},this._editingSchedule);this._editingId&&(e.id=this._editingId);try{const t=await Is(this.hass,e);if(t&&!1===t.success)throw new Error(t.error||"");this._closeDialog(),await this._load()}catch(e){console.error("Failed to save schedule",e),La(this,this.hass,"common.errors.save_failed",e)}}async _delete(e){try{await(t=this.hass,s=e,t.callWS({type:_e+"/schedule_delete",schedule_id:s})),await this._load()}catch(e){console.error("Failed to delete schedule",e),La(this,this.hass,"common.errors.delete_failed",e)}var t,s}_onScheduleChanged(e){this._editingSchedule=e.detail.value}_zonesLabel(e){if("all"===e)return Aa("panels.schedules.zones_all",this.hass.language);if(Array.isArray(e)){const t=e.map(e=>{const t=this._zones.find(t=>String(t.id)===String(e));return t?t.name:e}).join(", ");return t||e.join(", ")}return String(e)}_dialogTitle(){return this._editingId?Aa("panels.schedules.dialog.edit_title",this.hass.language):Aa("panels.schedules.dialog.add_title",this.hass.language)}render(){return this.hass?this._isLoading?W`
        <ha-card
      ...
      ${0===this._schedules.length?W`
          ...
          `:this._schedules.map(e=>W`
              <ha-card header="${e.name}">
                <div class="card-content">
                  <div class="info-row">
                    ...
                    >
                    <span>${mn(e.type,this.hass.language)}</span>
                  </div>
                  ...
                  ${e.interval_hours?W`
                      ...
                      `:""}
                  ${"interval"===e.type&&e.start_time?W`
                        <div class="info-row">
                          <span class="info-label"
            ...
            `)}
    `:W``}static get styles(){return[Za,r`
        .info-row {
          display: flex;
          gap: 8px;
          margin-bottom: 4px;
      ...
      `]}};t([pe({attribute:!1})],_n.prototype,"hass",void 0),t([ge()],_n.prototype,"_schedules",void 0),t([ge()],_n.prototype,"_zones",void 0),t([ge()],_n.prototype,"_isLoading",void 0),t([ge()],_n.prototype,"_showDialog",void 0),t([ge()],_n.prototype,"_editingSchedule",void 0),t([ge()],_n.prototype,"_editingId",void 0),_n=t([ce("smart-irrigation-view-schedules")],_n);let fn=class extends(Ba(le)){constructor(){super(...arguments),this._forecast=null,this._mappings=[],this._records=new Map,this._loading=!0,this._metric=!0,this._climate=[]}hassSubscribe(){return this._fetch(),[this.hass.connection.subscribeMessage(()=>this._fetch(),{type:_e+"_config_updated"})]}async _fetch(){var e,t;if(this.hass)try{const[s,i,a,n]=await Promise.all([(t=this.hass,t.callWS({type:_e+"/weather_forecast"})),Hs(this.hass),zs(this.hass),Ms(this.hass)]);this._forecast=s,this._mappings=i||[],this._metric=(null==a?void 0:a.units)!==Te;const o=n?Object.values(n):[];this._climate=o.length>0&&(null===(e=o[0])||void 0===e?void 0:e.monthly_estimates)||[];const r=new Map;await Promise.all(this._mappings.map(async e=>{if(void 0!==e.id)try{r.set(e.id,await((e,t,s=10)=>e.callWS({type:_e+"/weather_records",mapping_id:t,limit:s}))(this.hass,e.id.toString(),0)||[])}catch(e){}})),this._records=r}catch(e){console.error("Failed to fetch weather data",e)}finally{this._loading=!1}}render(){return this.hass?W`${this._renderForecast()} ${this._renderRecords()}
                ...
                <div class="seasonal-table">
                  ...
                  ${this._climate.map(e=>W`
                      <div class="weather-row">
                        ...
                        >
                        <span
                          >${on(e.estimated_et_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${on(e.average_precipitation_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${on(e.average_temperature_c,"temperature",this._metric)}</span
                        >
                      </div>
                    `)}
                </div>
    ...
    `}_renderForecastDay(e,t){const s=(()=>{try{return new Intl.DateTimeFormat(t,{weekday:"short",month:"short",day:"numeric"}).format(new Date(e.date+"T00:00:00"))}catch(t){return e.date}})(),i=e=>{const t=nn(e,"temperature",this._metric);return t?`${Math.round(t.value)}°`:"-"};return W`
      <div class="forecast-day">
        ...
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-rainy"></ha-icon>${on(e.precipitation,"precipitation",this._metric)}
        </div>
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-windy"></ha-icon>${on(e.windspeed,"windspeed",this._metric)}
        </div>
      </div>
    `}_renderRecords(){if(!this.hass)return W``;const e=this.hass.language;return this._loading&&0===this._mappings.length?W`<ha-card
      ...
      </ha-card>`:W`${this._mappings.map(t=>this._renderMappingRecords(t,e))}`}_renderMappingRecords(e,t){const s=void 0!==e.id&&this._records.get(e.id)||[],i=`${Aa("panels.mappings.weather-records.title",t)} — ${e.name}`,a=e=>{try{return t=e,Number.isNaN(Ga(t).getTime())?"-":function(e){const t=Ga(e);return`${qa(t.getMonth()+1)}-${qa(t.getDate())} ${qa(t.getHours())}:${qa(t.getMinutes())}`}(e)}catch(e){return"-"}var t};return W`
      <ha-card header="${i}">
        <div class="card-content">
                ...
                <div class="weather-table">
                  ...
                  ${s.map(e=>W`
                      <div class="weather-row">
                        ...
                        <span
                          >${on(e.temperature,"temperature",this._metric)}</span
                        >
                        <span>${(e=>null!=e?e.toFixed(1)+" %":"-")(e.humidity)}</span>
                        <span
                          >${on(e.dewpoint,"temperature",this._metric)}</span
                        >
                        <span
                          >${on(e.wind_speed,"windspeed",this._metric)}</span
                        >
                        <span
                          >${on(e.pressure,"pressure",this._metric)}</span
                        >
                        <span
                          >${on(e.precipitation,"precipitation",this._metric)}</span
                        >
    ...
    `}};t([pe()],fn.prototype,"narrow",void 0),t([ge()],fn.prototype,"_forecast",void 0),t([ge()],fn.prototype,"_mappings",void 0),t([ge()],fn.prototype,"_records",void 0),t([ge()],fn.prototype,"_loading",void 0),t([ge()],fn.prototype,"_metric",void 0),t([ge()],fn.prototype,"_climate",void 0),fn=t([ce("smart-irrigation-view-weather-data")],fn);let bn=class extends(Ba(le)){constructor(){super(...arguments),this._saving=!1}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch experimental config:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to refresh experimental config:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(this.hass)try{this.config=await zs(this.hass)}catch(e){console.error("Error fetching config:",e),La(this,this.hass,"common.errors.load_failed",e)}}async _toggle(e,t){if(this.hass&&this.config){this.config=Object.assign(Object.assign({},this.config),{[e]:t}),this._saving=!0;try{await Ss(this.hass,{[e]:t})}catch(e){console.error("Error saving experimental config:",e),La(this,this.hass,"common.errors.save_failed",e),await this._fetchData()}finally{this._saving=!1}}}render(){var e,t;return this.hass&&this.config?W`
      ${this._renderIntro()}
    ...
    `}};t([pe()],bn.prototype,"narrow",void 0),t([ge()],bn.prototype,"config",void 0),t([ge()],bn.prototype,"_saving",void 0),bn=t([ce("smart-irrigation-view-experimental")],bn);var yn;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.Distributors="distributors",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}(yn||(yn={}));const wn={[yn.WeatherLocation]:"panels.setup.tabs.weather_location",[yn.Zones]:"panels.setup.tabs.my_zones",[yn.Distributors]:"panels.setup.tabs.distributors",[yn.WhenToWater]:"panels.setup.tabs.when_to_water",[yn.Advanced]:"panels.setup.tabs.advanced",[yn.Experimental]:"panels.setup.tabs.experimental",[yn.Help]:"panels.help.title"};let $n=class extends(Ba(le)){hassSubscribe(){return this._fetchConfig(),[this.hass.connection.subscribeMessage(()=>this._fetchConfig(),{type:_e+"_config_updated"})]}async _fetchConfig(){if(this.hass)try{this.config=await zs(this.hass)}catch(e){console.error("Failed to fetch setup config:",e)}}get _distributorsEnabled(){var e,t;return null!==(t=null===(e=this.config)||void 0===e?void 0:e.distributors_enabled)&&void 0!==t&&t}get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(yn).includes(null!=t?t:"")?t:yn.WeatherLocation}_selectTab(e){Da(0,Wa("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return W``;const e=this._distributorsEnabled,t=Object.values(yn).filter(t=>t!==yn.Distributors||e);let s=this._activeTab;return s!==yn.Distributors||e||(s=yn.WeatherLocation),W`
    ...
    `}_renderContent(e){if(!this.hass)return W``;switch(e){case yn.WeatherLocation:return W`
          ...
          <smart-irrigation-view-weather-data
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-weather-data>
        `;case yn.Zones:return W`<smart-irrigation-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-zone-settings>`;case yn.Distributors:return W`<smart-irrigation-view-distributor-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-distributor-settings>`;case yn.WhenToWater:return W`
          <smart-irrigation-view-general
            .hass="${this.hass}"
            .narrow="${this.narrow}"
        ...
        `;case yn.Advanced:return W`
          ...
          <smart-irrigation-view-mappings
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-mappings>
        `;case yn.Experimental:return W`<smart-irrigation-view-experimental
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-experimental>`;case yn.Help:return this._renderHelp()}}_renderHelp(){return this.hass?W`
      <ha-card
    ...
    `}};var xn;t([pe({attribute:!1})],$n.prototype,"hass",void 0),t([pe({type:Boolean})],$n.prototype,"narrow",void 0),t([pe({attribute:!1})],$n.prototype,"path",void 0),t([ge()],$n.prototype,"config",void 0),$n=t([ce("smart-irrigation-view-setup")],$n),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done"}(xn||(xn={}));let kn=class extends le{constructor(){super(...arguments),this._step=xn.Welcome,this._saving=!1,this._error="",this._confirmClose=!1,this._siConfig=null,this._useWeather=!1,this._weatherService=ze,this._apiKey="",this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=Ue,this._humiditySource=Ue,this._precipSource=Ue,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="",this._scheduleTime="06:00",this._scheduleCreated=!1,this._creatingSchedule=!1}async connectedCallback(){super.connectedCallback(),await this._loadInitialData()}async _loadInitialData(){var e;if(this.hass){try{const[t,s,i]=await Promise.all([Ts(this.hass),Ps(this.hass),zs(this.hass)]);this._availableModules=t,this._weatherConfig=s,this._siConfig=i,this._useWeather=s.use_weather_service,this._weatherService=null!==(e=s.weather_service)&&void 0!==e?e:ze}catch(e){console.error("Wizard: failed to load initial data",e),this._error=Ma(e)}this.requestUpdate()}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}))}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}))}async _next(){this._error="";try{switch(this._saving=!0,this._step){case xn.Welcome:this._step=xn.Weather;break;case xn.Weather:await this._saveWeather(),this._step=xn.Module;break;case xn.Module:await this._saveModule(),this._step=xn.Mapping;break;case xn.Mapping:await this._saveMapping(),this._step=xn.Zone;break;case xn.Zone:await this._saveZone(),this._step=xn.Done;break;case xn.Done:this._close()}}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._saving=!1,this.requestUpdate()}}_back(){this._step>xn.Welcome&&(this._step=this._step-1,this._error="")}get _canSkipCurrentStep(){return this._step===xn.Weather}_skipStep(){this._canSkipCurrentStep&&this._step<xn.Done&&(this._step=this._step+1,this._error="")}async _saveWeather(){await Rs(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null)}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0}catch(e){return}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await Os(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>Es(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.")}async _saveMapping(){const e=this._useWeather?Ue:Ge,t={[Re]:{[Ke]:this._tempSource},[Me]:{[Ke]:this._humiditySource},[Ie]:{[Ke]:this._precipSource}},s=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const i of s)t[i]={[Ke]:e};const i=await Ds(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(i,()=>Hs(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.")}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await As(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:ja.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0})}async _createDefaultSchedule(){var e,t;if(!this._scheduleCreated&&!this._creatingSchedule){this._error="",this._creatingSchedule=!0;try{const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";await Is(this.hass,{name:Aa("wizard.steps.done.schedule_name",s)||"Daily",type:"daily",enabled:!0,time:this._scheduleTime||"06:00",action:"irrigate",zones:"all"}),this._scheduleCreated=!0}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._creatingSchedule=!1,this.requestUpdate()}}}render(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return W`
    ...
    `}_renderStep(e){switch(this._step){case xn.Welcome:return this._renderWelcome(e);case xn.Weather:return this._renderWeather(e);case xn.Module:return this._renderModule(e);case xn.Mapping:return this._renderMapping(e);case xn.Zone:return this._renderZone(e);case xn.Done:return this._renderDone(e);default:return W``}}_renderFooter(e){return this._step===xn.Done?W``:W`
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Aa("common.saving-messages.saving",e):this._step===xn.Welcome||this._step<xn.Zone?Aa("wizard.next",e):Aa("wizard.finish",e)}
      </button>
    ...
    `}_renderMapping(e){const t=[{value:Ue,label:Aa("wizard.steps.mapping.use_weather_service",e)},{value:"sensor",label:Aa("wizard.steps.mapping.use_sensor",e)},{value:"static",label:Aa("wizard.steps.mapping.use_static",e)},{value:Ge,label:Aa("wizard.steps.mapping.use_none",e)}],s=(s,i,a)=>W`
      <si-field
    ...
    `}};t([pe({attribute:!1})],kn.prototype,"hass",void 0),t([ge()],kn.prototype,"_step",void 0),t([ge()],kn.prototype,"_saving",void 0),t([ge()],kn.prototype,"_error",void 0),t([ge()],kn.prototype,"_confirmClose",void 0),t([ge()],kn.prototype,"_siConfig",void 0),t([ge()],kn.prototype,"_useWeather",void 0),t([ge()],kn.prototype,"_weatherService",void 0),t([ge()],kn.prototype,"_apiKey",void 0),t([ge()],kn.prototype,"_weatherConfig",void 0),t([ge()],kn.prototype,"_availableModules",void 0),t([ge()],kn.prototype,"_selectedModuleIndex",void 0),t([ge()],kn.prototype,"_moduleConfig",void 0),t([ge()],kn.prototype,"_mappingName",void 0),t([ge()],kn.prototype,"_tempSource",void 0),t([ge()],kn.prototype,"_humiditySource",void 0),t([ge()],kn.prototype,"_precipSource",void 0),t([ge()],kn.prototype,"_zoneName",void 0),t([ge()],kn.prototype,"_zoneSize",void 0),t([ge()],kn.prototype,"_zoneThroughput",void 0),t([ge()],kn.prototype,"_zoneEntity",void 0),t([ge()],kn.prototype,"_scheduleTime",void 0),t([ge()],kn.prototype,"_scheduleCreated",void 0),t([ge()],kn.prototype,"_creatingSchedule",void 0),kn=t([ce("si-setup-wizard")],kn);const zn=Za;var Sn;!function(e){e.Zones="zones",e.Setup="setup"}(Sn||(Sn={})),e.SmartIrrigationPanel=class extends le{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}async firstUpdated(){const e=Fa().page;Object.values(Sn).includes(e)||Da(0,Wa(Sn.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())}),Fs().then(()=>{this._scheduleUpdate()}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}),this.hass&&zs(this.hass).then(e=>{this._config=e,this._scheduleUpdate()}).catch(e=>{console.error("Failed to fetch config for version display:",e)})}_ensureLanguage(){this.hass&&!Ca(this.hass.language)&&function(e){const t=Sa(e);return Ca(e)?Promise.resolve():(za[t]||(za[t]=fetch(`/smart_irrigation_static/languages/${t}.json?v=${ve}`).then(e=>e.ok?e.json():Promise.reject(e.status)).then(e=>{ka[t]=e}).catch(()=>{ka[t]=ka.en})),za[t])}(this.hass.language).then(()=>this.requestUpdate())}render(){var e,t;if(this.hass&&!Ca(this.hass.language))return this._ensureLanguage(),W``;const s=Fa(),i=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return W`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
    ...
    `}getView(e){switch(e.page){case"zones":default:return W`
        ...
        `;case"setup":return W`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0}}"
          ></smart-irrigation-view-setup>
        `}}navigateToPage(e){if(e!==Fa().page){const t=Wa(e);Da(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==Fa().page){const e=Wa(t);Da(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[zn,r`
        :host {
          color: var(--primary-text-color);
    ...
    `}};t([pe({attribute:!1})],Cn.prototype,"hass",void 0),t([ge()],Cn.prototype,"_params",void 0),Cn=t([ce("error-dialog")],Cn);var An=Object.freeze({__proto__:null,get ErrorDialog(){return Cn}})}({});

...
`;const qa=e=>String(e).padStart(2,"0");function Ga(e){return e instanceof Date?e:new Date(e)}function Ka(e){const t=Ga(e);return`${qa(t.getHours())}:${qa(t.getMinutes())}`}function Va(e){const t=Ga(e);return`${t.getFullYear()}-${qa(t.getMonth()+1)}-${qa(t.getDate())} ${qa(t.getHours())}:${qa(t.getMinutes())}`}function Ya(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class Xa extends(Ba(le)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){Fi().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const i=Object.keys(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).length>0;i&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):i||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[i,s,a,n]=await Promise.all([zi(this.hass),Ai(this.hass),(t=this.hass,t.callWS({type:_e+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),Ni(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=i,this.zones=s,this._outlook=a,this._distributors=n,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),La(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),La(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),La(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const i="all"===t,s=i?void 0:this.zones.find(e=>{var i;return(null===(i=e.id)||void 0===i?void 0:i.toString())===t}),a=i?`(${this._linkedZoneCount})`:`: ${null!==(e=null==s?void 0:s.name)&&void 0!==e?e:t}`;try{await(n=this.hass,o=i?void 0:t,n.callWS(Object.assign({type:_e+"/irrigate_now"},void 0!==o?{zone_id:o}:{}))),Na(this,`${Ea("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${a}`)}catch(e){const t=Ma(e);console.error("irrigate_now failed",e),Na(this,`${Ea("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var n,o}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const i=new Date(t);return i.getTime()>Date.now()?i:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:_e+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),La(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:_e+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),La(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,i;const s=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(i=this._runMinutes[s])&&void 0!==i?i:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const i=this._zoneDistributor(e);return!!i&&Object.keys(null!==(t=i.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var i,s,a;if(t>0)try{await(i=this.hass,s=e.id.toString(),a=t,i.callWS({type:_e+"/run_zone",zone_id:s,duration:a})),Na(this,`${Ea("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=Ma(e);console.error("run_zone failed",e),Na(this,`${Ea("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===i?void 0:i[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,i;if(this.hass&&void 0!==e.id)try{await(t=this.hass,i=e.id.toString(),t.callWS({type:_e+"/stop_zone",zone_id:i})),Na(this,`${Ea("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=Ma(e);console.error("stop_zone failed",e),Na(this,`${Ea("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var i,s;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,s=t.id.toString(),i.callApi("POST",_e+"/zones",{id:s,calculate:!0,override_cache:!0})).catch(e=>{const t=Ma(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var i,s;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,s=t.id.toString(),i.callApi("POST",_e+"/zones",{id:s,update:!0})).catch(e=>{const t=Ma(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;Ha(0,t?Wa("setup","zones",t):Wa("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,i,s;const a=null!==(t=e.duration)&&void 0!==t?t:0,n=Number(null!==(i=e.bucket_threshold)&&void 0!==i?i:0),o=this._zoneEstimate(e),r=o&&o.available&&null!=o.live_deficit?o.live_deficit:Number(null!==(s=e.bucket)&&void 0!==s?s:0);return a>0&&r<n}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,i=new Date(e),s=Ka(i),a=new Date;return Ya(i,a)?`${Ea("panels.zones.outlook.today",t)} ${s}`:Ya(i,function(e,t){const i=new Date(e.getTime());return i.setDate(i.getDate()+t),i}(a,1))?`${Ea("panels.zones.outlook.tomorrow",t)} ${s}`:function(e,t){const i=Ga(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(i)} ${Ka(i)}`}(i,t)}_renderEstimatedTag(e){if(!this.hass||!e.estimated)return W``;const t=this.hass.language;return W`<span
    ...
    `}_renderZoneDecision(e){var t;if(!this.hass)return W``;const i=this.hass.language,s=null!==(t=e.duration)&&void 0!==t?t:0;let a,n,o,r;if(e.state===ja.Disabled)a=Ea("panels.zones.status.decision_disabled",i),n="neutral",o="mdi:power-off";else if(e.last_calculated)if(this._zoneHasDeficit(e)){const t=Ia(s),l=this._triggeredGuards,d=this._nextIrrigateRunForZone(e);l.length>0?(a=Ea("panels.zones.status.decision_water_skip",i,"{duration}",t,"{reason}",this._guardLabel(l[0]).toLowerCase()),n="skip",o="mdi:weather-rainy"):d&&d.next_run_utc?(a=Ea("panels.zones.status.decision_water_at",i,"{duration}",t,"{time}",this._formatRunTime(d.next_run_utc)),n="water",o="mdi:water",r=d):(a=Ea("panels.zones.status.decision_water_no_schedule",i,"{duration}",t),n="water",o="mdi:water-alert")}else a=Ea("panels.zones.status.decision_no_water",i),n="ok",o="mdi:check-circle-outline";else a=Ea("panels.zones.status.decision_unknown",i),n="unknown",o="mdi:help-circle-outline";return W`
      <div class="zone-decision ${n}">
        <ha-icon icon="${o}"></ha-icon>
        <span>${a}</span>
        ${r?this._renderEstimatedTag(r):""}
      </div>
    `}_zoneEstimate(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_estimates)||void 0===i?void 0:i[String(e.id)]}_zoneFault(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_faults)||void 0===i?void 0:i[String(e.id)]}_renderZoneFault(e){if(!this.hass)return W``;const t=this._zoneFault(e);if(!t)return W``;const i=this.hass.language,s=Ea(`panels.zones.fault.${t.reason}`,i)||Ea("panels.zones.fault.generic",i),a=t.timestamp?Va(t.timestamp):"";return W`
    ...
    `}_zoneSkip(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_skips)||void 0===i?void 0:i[String(e.id)]}_renderZoneSkip(e){if(!this.hass)return W``;const t=this._zoneSkip(e);if(!t)return W``;const i=this.hass.language,s=Ea("panels.zones.skip.soil_moisture",i,"{observed}",String(t.observed),"{threshold}",String(t.threshold)),a=t.timestamp?Va(t.timestamp):"";return W`
    ...
    `}_durationClamped(e){var t,i;if(e.state!==ja.Automatic)return!1;const s=e.maximum_duration;if(null==s||s<0)return!1;const a=null!==(t=e.duration)&&void 0!==t?t:0;return!(a<=0)&&a-(null!==(i=e.lead_time)&&void 0!==i?i:0)>=s}_renderDurationClamped(e){var t;if(!this.hass||!this._durationClamped(e))return W``;const i=this.hass.language,s=Ea("panels.zones.clamped.detail",i,"{maximum}",Ia(null!==(t=e.maximum_duration)&&void 0!==t?t:0));return W`
    ...
    `}_renderZoneEstimate(e){if(!this.hass)return W``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return W``;const i=this.hass.language,s=Oa(this.config,_t),a=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",n=Ea(`panels.zones.status.estimate_method.${"proxy"===t.method||"hourly_sensor"===t.method?t.method:"hourly"}`,i)+(t.as_of?` · ${Ka(t.as_of)}`:"");return W`
...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */;const Ja={},Qa=Ki(class extends Vi{constructor(e){if(super(e),e.type!==qi&&e.type!==Wi&&e.type!==Gi)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===Z||t===q)return t;const i=e.element,s=e.name;if(e.type===qi){if(t===i[s])return Z}else if(e.type===Gi){if(!!t===i.hasAttribute(s))return Z}else if(e.type===Wi&&i.getAttribute(s)===t+"")return Z;return((e,t=Ja)=>{e._$AH=t;
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
                ...
                <div class="setting-row">
                  ...
                  <div class="inline-row">
                    ...
                    <select
                      ...
                      .value="${Qa(this.data.autoupdateschedule||Ee)}"
    ...
    `}};t([pe()],sn.prototype,"narrow",void 0),t([pe()],sn.prototype,"path",void 0),t([pe()],sn.prototype,"section",void 0),t([pe()],sn.prototype,"data",void 0),t([pe()],sn.prototype,"config",void 0),t([pe({type:Boolean})],sn.prototype,"isLoading",void 0),t([pe({type:Boolean})],sn.prototype,"isSaving",void 0),t([pe()],sn.prototype,"_weatherConfig",void 0),t([pe()],sn.prototype,"_weatherService",void 0),t([pe({type:Boolean})],sn.prototype,"_useWeatherService",void 0),t([pe()],sn.prototype,"_newApiKey",void 0),t([pe({type:Boolean})],sn.prototype,"_weatherSaving",void 0),t([ge()],sn.prototype,"_coords",void 0),t([ge()],sn.prototype,"_coordsEnabled",void 0),t([ge()],sn.prototype,"_coordsLat",void 0),t([ge()],sn.prototype,"_coordsLon",void 0),t([ge()],sn.prototype,"_coordsElev",void 0),t([ge()],sn.prototype,"_coordsSaving",void 0),t([ge()],sn.prototype,"_saveStatus",void 0),sn=t([ce("smart-irrigation-view-general")],sn);const an=e=>9*e/5+32;function nn(e,t,i){if(null==e||Number.isNaN(e))return null;switch(t){case"temperature":return i?{value:e,unit:"°C"}:{value:an(e),unit:"°F"};case"precipitation":return i?{value:e,unit:at}:{value:(n=e,n/25.4),unit:nt};case"windspeed":return i?{value:e,unit:lt}:{value:(a=e,2.2369362920544*a),unit:rt};case"pressure":return i?{value:e,unit:"hPa"}:{value:(s=e,.0295299830714*s),unit:ot}}var s,a,n}function on(e,t,i,s){const a=nn(e,t,i);if(!a)return"-";const n=function(e,t){return"pressure"===e?t?0:2:"precipitation"===e?t?1:2:1}(t,i);return`${a.value.toFixed(n)} ${a.unit}`}function rn(e,t){return null==e||Number.isNaN(e)?"-":t?`${e.toFixed(0)} L`:`${(e=>.264172052*e)(e).toFixed(1)} gal`}let ln=class extends le{constructor(){super(...arguments),this.metric=!0,this.name="",this.size="",this.throughput="",this.linkedEntity="",this.showEntity=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{value:t},bubbles:!0,composed:!0}))}render(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",s=this.metric?"m²":et,a=this.metric?tt:it;return W`
             ...
             used to sit alongside it moved to the Weather & Location tab). -->
              <div class="card-content zone-settings">
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${Qa(null!==(s=Object.keys(Bt).find(t=>Bt[t]===e.drainage_rate))&&void 0!==s?s:"custom")}"
                ...
                <ha-settings-row>
                  ...
                  <select
                    ...
                    @change="${i=>{const s=i.target.value,a={[zt]:s};"custom"!==s&&void 0!==Rt[s]&&(a.kc=Rt[s]),this.handleEditZone(t,Object.assign(Object.assign({},e),a))}}"
                  >
                    <option
                      value="custom"
                      ...
                      ${this._flowSensorIsTotalizer(e)?W`
                            <ha-settings-row>
                              ...
                              <select
                                ...
                                @change="${i=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Ct]:i.target.value||"auto"}))}"
                              >
        ...
        <div class="card-content">
          <div class="history-usage">
            ...
            <span class="history-usage-value"
              >${rn(null!==(s=e.water_used_total)&&void 0!==s?s:0,a)}</span
            >
          </div>
    ...
    `}_renderRunLogRow(e,t){const i=this.hass.language,s=Ea(`panels.zones.history.results.${e.result}`,i);let a="";return e.detail&&(a="skipped"===e.result?e.detail.split(",").map(e=>Ea(`panels.zones.outlook.checks.${e}`,i)||e).join(", "):Ea(`panels.zones.fault.${e.detail}`,i)||e.detail),W`
      <tr>
        ...
        <td class="history-detail">${Xi(a)}</td>
      </tr>
    ...
    `}};t([pe()],dn.prototype,"config",void 0),t([pe({attribute:!1})],dn.prototype,"path",void 0),t([pe({type:Array})],dn.prototype,"zones",void 0),t([pe({type:Array})],dn.prototype,"modules",void 0),t([pe({type:Array})],dn.prototype,"mappings",void 0),t([pe({type:Array})],dn.prototype,"distributors",void 0),t([pe({type:Boolean})],dn.prototype,"isLoading",void 0),t([ge()],dn.prototype,"_expanded",void 0),t([pe({type:Boolean})],dn.prototype,"isSaving",void 0),t([pe({type:Boolean})],dn.prototype,"_showAddZone",void 0),t([ge()],dn.prototype,"_pendingConfirm",void 0),t([ge()],dn.prototype,"_saveStatus",void 0),t([pe()],dn.prototype,"_confirmDeleteZoneId",void 0),t([pe()],dn.prototype,"_newZoneName",void 0),t([pe()],dn.prototype,"_newZoneSize",void 0),t([pe()],dn.prototype,"_newZoneThroughput",void 0),t([pe()],dn.prototype,"_newZoneEntity",void 0),dn=t([ce("smart-irrigation-view-zone-settings")],dn);let cn=class extends le{_emit(e){this.dispatchEvent(new CustomEvent("distributor-changed",{detail:{value:Object.assign(Object.assign({},this.distributor),e)},bubbles:!0,composed:!0}))}_onNumber(e,t){const i=t.target.valueAsNumber;isNaN(i)||this._emit({[e]:Math.max(0,Math.round(i))})}render(){var e,t,i,s;if(!this.hass||!this.distributor)return W``;const a=this.hass.language,n=this.distributor,o=n.watering_mode===wi;return W`
      <ha-settings-row>
        ...
        <input
          ...
          @input="${e=>this._emit({[ri]:e.target.value})}"
        />
      </ha-settings-row>
      ...
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${Qa(null!==(t=n.watering_mode)&&void 0!==t?t:yi)}"
          @change="${e=>this._emit({[li]:e.target.value})}"
        >
          <option
            value="${yi}"
            ?selected="${(null!==(i=n.watering_mode)&&void 0!==i?i:yi)===yi}"
          >
            ${Ea("panels.zones.labels.watering_modes.classic",a)}
          </option>
          <option
            value="${wi}"
            ?selected="${n.watering_mode===wi}"
          >
    ...
    `}_renderInletWatchRows(e){var t;const i=this.distributor,s=i.watering_mode===wi?"panels.distributors.labels.inlet_entity_help_service":"panels.distributors.labels.inlet_entity_help",a=null!==(t=i.watch_mode)&&void 0!==t?t:"ignore";return W`
      <ha-settings-row>
        <span slot="heading"
        ...
        <ha-entity-picker
          ...
          .includeDomains="${["switch","valve","input_boolean"]}"
          allow-custom-entity
          @value-changed="${e=>this._emit({[di]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>
      ...
      ${i.inlet_entity?W`
            <ha-settings-row>
              ...
              <select
                class="settings-input"
                .value="${Qa(a)}"
                @change="${e=>this._emit({[ci]:e.target.value})}"
              >
                ${bi.map(t=>W`
    ...
    `}_renderServiceRows(e){var t,i;const s=this.distributor;return W`
      <ha-settings-row>
        ...
        <ha-entity-picker
          ...
          .includeDomains="${["script"]}"
          allow-custom-entity
          @value-changed="${e=>this._emit({[hi]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>
      ...
      <ha-settings-row>
        ...
        <input
          ...
          @input="${e=>this._emit({[pi]:e.target.value||"duration"})}"
        />
      </ha-settings-row>
      ...
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${Qa(null!==(t=s.duration_unit)&&void 0!==t?t:"seconds")}"
          @change="${e=>this._emit({[gi]:e.target.value})}"
        >
          <option
            value="seconds"
    ...
    `}_hasOwnActuation(e){return!!(e.linked_entity||e.run_service||e.stop_service)}_membersByOutlet(e){const t=new Map;if(void 0===e)return t;for(const i of this.zones)i.distributor_id===e&&null!=i.outlet_number&&void 0!==i.id&&t.set(i.outlet_number,i);return t}_outletCount(e){const t=this._membersByOutlet(e.id),i=t.size?Math.max(...t.keys()):0,s=Math.max(2,i),a=void 0!==e.id?this._outletRows[e.id]:void 0;return Math.min(6,Math.max(s,null!=a?a:s))}_assignZone(e,t,i){return Ei(this.hass,{id:e.id,[xi]:t,[ki]:i})}_optimisticZone(e,t,i){void 0!==e&&(this.zones=this.zones.map(s=>s.id===e?Object.assign(Object.assign({},s),{distributor_id:t,outlet_number:i}):s))}_runAssign(e){e.length&&(this.isSaving=!0,this._saveStatus="saving",this._scheduleUpdate(),Promise.all(e).then(()=>this._markSaved()).catch(e=>{console.error("Failed to assign zone to outlet:",e),this._saveStatus="idle",La(this,this.hass,"common.errors.save_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(()=>{})}))}_setOutletCount(e,t){if(void 0===e.id)return;const i=this._membersByOutlet(e.id),s=[];for(const[e,a]of i)e>t&&s.push(a);this._outletRows=Object.assign(Object.assign({},this._outletRows),{[e.id]:t}),s.length?(s.forEach(e=>this._optimisticZone(e.id,null,null)),this._runAssign(s.map(e=>this._assignZone(e,null,null)))):this._scheduleUpdate()}_onOutletZoneChange(e,t,i){const s=i.target.value,a=s?parseInt(s):null,n=this._membersByOutlet(e.id).get(t),o=null!==a?this.zones.find(e=>e.id===a):null,r=[];n&&n.id!==a&&(r.push(this._assignZone(n,null,null)),this._optimisticZone(n.id,null,null)),o&&(r.push(this._assignZone(o,e.id,t)),this._optimisticZone(o.id,e.id,t)),this._runAssign(r)}_renderOutletConfig(e){if(!this.hass)return W``;const t=this.hass.language,i=this._membersByOutlet(e.id),s=this._outletCount(e),a=this.zones.filter(e=>void 0!==e.id&&null==e.distributor_id&&!this._hasOwnActuation(e)),n=[...i.keys()].sort((e,t)=>e-t),o=n.some((e,t)=>e!==t+1),r=[];for(let n=1;n<=s;n++){const s=i.get(n),o=s?[...a,s]:[...a];o.sort((e,t)=>(e.name||"").localeCompare(t.name||"")),r.push(W`
        <div class="outlet-row">
          ...
          <select
            class="settings-input"
            .value="${Qa(null!=(null==s?void 0:s.id)?String(s.id):"")}"
    ...
    `;return this.moduleCache.set(s,a),a}renderUsageChip(e){return this.hass?e?W`<span class="usage-chip"
      ...
      >
        ${Object.entries(n.options).map(([e,i])=>W`<option
              ...
              ?selected="${h===Ta(i,0)}"
            >
              ${Ea("panels.modules.cards.module.translated-options."+Ta(i,1),t)}
            </option>`)}
    ...
    `}renderSimpleRadioOptions(e,t,i){if(!this.hass||!this.config)return W``;const s=t===He||t===Pe,a=i[Ke];return W`
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return W`<option value="${e}" ?selected="${e===t}">
        ...
        </option>`,e}return W``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return W``;const i=function(e){switch(e){case De:case Re:return[{unit:"°C",system:Oe},{unit:"°F",system:Te}];case Ie:case He:return[{unit:at,system:Oe},{unit:nt,system:Te}];case Ne:return[{unit:dt,system:Oe},{unit:ct,system:Te}];case Me:return[{unit:"%",system:[Oe,Te]}];case Le:return[{unit:"millibar",system:Oe},{unit:"hPa",system:Oe},{unit:"psi",system:Te},{unit:ot,system:Te}];case Be:return[{unit:"km/h",system:Oe},{unit:lt,system:Oe},{unit:rt,system:Te}];case Pe:return[{unit:"W/m2",system:Oe},{unit:"MJ/day/m2",system:Oe},{unit:"W/sq ft",system:Te},{unit:"MJ/day/sq ft",system:Te}];default:return[]}}(e);let s=t[Xe];const a=this.config.units;if(!t[Xe])for(const e of i)if("string"==typeof e.system){if(a===e.system){s=e.unit;break}}else{for(const t of e.system)if(a===t.system){s=e.unit;break}if(s===e.unit)break}return W`
      ${i.map(e=>W`
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach(e=>{clearTimeout(e)}),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};t([pe()],pn.prototype,"config",void 0),t([pe({type:Array})],pn.prototype,"zones",void 0),t([pe({type:Array})],pn.prototype,"mappings",void 0),t([pe({type:Boolean})],pn.prototype,"isLoading",void 0),t([pe({type:Boolean})],pn.prototype,"isSaving",void 0),t([me("#mappingNameInput")],pn.prototype,"mappingNameInput",void 0),pn=t([ce("smart-irrigation-view-mappings")],pn);const gn=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"];let mn=class extends(Ba(le)){constructor(){super(...arguments),this._schedules=[],this._zones=[],this._isLoading=!0,this._showDialog=!1,this._editingSchedule={name:"",type:"daily",enabled:!0,time:"06:00",action:"irrigate",zones:"all"},this._editingId=null}hassSubscribe(){return this._load(),[this.hass.connection.subscribeMessage(()=>this._load(),{type:_e+"_config_updated"})]}async _load(){var e;if(this.hass)try{const[t,i]=await Promise.all([(e=this.hass,e.callWS({type:_e+"/schedules"})),Ai(this.hass)]);this._schedules=t||[],this._zones=i||[]}catch(e){console.error("Failed to load schedules",e),La(this,this.hass,"common.errors.load_failed",e)}finally{this._isLoading=!1}}_openAdd(){this._editingSchedule={name:"",type:"daily",enabled:!0,time:"06:00",action:"irrigate",zones:"all"},this._editingId=null,this._showDialog=!0}_openEdit(e){var t;this._editingSchedule=Object.assign({},e),this._editingId=null!==(t=e.id)&&void 0!==t?t:null,this._showDialog=!0}_closeDialog(){this._showDialog=!1}async _save(){const e=Object.assign({},this._editingSchedule);this._editingId&&(e.id=this._editingId);try{const t=await Ii(this.hass,e);if(t&&!1===t.success)throw new Error(t.error||"");this._closeDialog(),await this._load()}catch(e){console.error("Failed to save schedule",e),La(this,this.hass,"common.errors.save_failed",e)}}async _delete(e){try{await(t=this.hass,i=e,t.callWS({type:_e+"/schedule_delete",schedule_id:i})),await this._load()}catch(e){console.error("Failed to delete schedule",e),La(this,this.hass,"common.errors.delete_failed",e)}var t,i}_update(e){this._editingSchedule=Object.assign(Object.assign({},this._editingSchedule),e)}_typeLabel(e){return Ea(`panels.schedules.types.${e}`,this.hass.language)||e}_zonesLabel(e){if("all"===e)return Ea("panels.schedules.zones_all",this.hass.language);if(Array.isArray(e)){const t=e.map(e=>{const t=this._zones.find(t=>String(t.id)===String(e));return t?t.name:e}).join(", ");return t||e.join(", ")}return String(e)}_renderZonePicker(){const e="all"===this._editingSchedule.zones||!Array.isArray(this._editingSchedule.zones),t=e?[]:this._editingSchedule.zones.map(String);return W`
      <div class="field">
        <label
    ...
    `}_renderTypeFields(){var e;const t=this._editingSchedule;switch(t.type){case"daily":return W`
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.time",this.hass.language)}</label
            >
            <input
              type="time"
              .value="${t.time||"06:00"}"
        ...
        `;case"weekly":return W`
          ...
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.days_of_week",this.hass.language)}</label
            >
            <div class="day-checkboxes">
              ${gn.map(e=>W`
                  <label class="day-check">
                    ...
                    />
                    ${Ea(`panels.schedules.days.${e}`,this.hass.language)}
                  </label>
                `)}
            </div>
          </div>
        `;case"monthly":return W`
          ...
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.day_of_month",this.hass.language)}</label
            >
            <input
              type="number"
              min="1"
        ...
        `;case"interval":return W`
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.interval_hours",this.hass.language)}</label
            >
          ...
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.start_time",this.hass.language)}</label
            >
            <input
              type="time"
              .value="${t.start_time||""}"
        ...
        `;case Jt:case Qt:return W`${this._renderSunOffsetFields()}`;case ei:return W`
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.azimuth_angle",this.hass.language)}</label
            >
            <div class="input-suffix-row">
              <input
                type="number"
      ...
      <div class="field">
        <label
          >${Ea("panels.schedules.fields.offset_minutes",this.hass.language)}</label
        >
        <div class="input-suffix-row">
          <input
            type="number"
          ...
          />
          <span class="suffix"
            >${Ea("panels.schedules.minutes",this.hass.language)}</span
          >
        </div>
      </div>
    `}_timeAnchor(e){var t;const i=[Jt,Qt,ei].includes(e.type)&&!1!==e.account_for_duration;return null!==(t=e.time_anchor)&&void 0!==t?t:i?ti:"start"}_hasRunWindow(e){return"irrigate"===e.action&&"interval"!==e.type&&this._timeAnchor(e)===ti}_renderTimeAnchorField(){const e=this._editingSchedule;if("irrigate"!==e.action||"interval"===e.type)return W``;const t=this._timeAnchor(e);return W`
      <div class="field">
        <label
          >${Ea("panels.schedules.fields.time_anchor",this.hass.language)}</label
        >
        <select
        ...
        >
          ${["start","finish"].map(e=>W`
              <option value="${e}" ?selected="${t===e}">
                ${Ea(`panels.schedules.time_anchor.${e}`,this.hass.language)}
              </option>
            `)}
        </select>
      </div>
    `}_renderRunWindowFields(){var e,t;const i=this._editingSchedule;if(!this._hasRunWindow(i))return W``;const s=this.hass.language,a=ni.includes(null!==(e=i.earliest_start_mode)&&void 0!==e?e:"")?i.earliest_start_mode:ii;return W`
      <div class="field">
        <label
          >${Ea("panels.schedules.fields.earliest_start",s)}</label
        >
        <select
          @change=${e=>{const t=e.target.value;this._update({earliest_start_mode:t,earliest_start_time:t===si?i.earliest_start_time||oi:i.earliest_start_time})}}
        >
          ${ni.map(e=>W`
              <option value="${e}" ?selected="${a===e}">
                ${Ea(`panels.schedules.earliest_start.${e}`,s)}
              </option>
            `)}
        </select>
        <span class="field-help"
          >${Ea("panels.schedules.help.earliest_start",s)}</span
        >
      </div>
      ...
      ${a===si?W`
            <div class="field">
              <label
                >${Ea("panels.schedules.fields.earliest_start_time",s)}</label
              >
              <input
                type="time"
                .value="${i.earliest_start_time||oi}"
                @change=${e=>this._update({earliest_start_time:e.target.value})}
              />
            </div>
          `:""}
      ${a===ai?W`
            <div class="field">
              <label
                >${Ea("panels.schedules.fields.earliest_start_offset",s)}</label
              >
              <div class="input-suffix-row">
                <input
                  type="number"
                  step="1"
                  .value="${String(null!==(t=i.earliest_start_offset_minutes)&&void 0!==t?t:0)}"
                  @input=${e=>{const t=parseInt(e.target.value);this._update({earliest_start_offset_minutes:isNaN(t)?0:t})}}
                />
                <span class="suffix"
                  >${Ea("panels.schedules.minutes",s)}</span
                >
              </div>
            </div>
          `:""}
      ...
      <div class="field">
        <div class="field-row">
          <label
            >${Ea("panels.schedules.fields.fit_to_window",s)}</label
          >
          <input
            type="checkbox"
            ?checked="${!0===i.fit_to_window}"
            @change=${e=>this._update({fit_to_window:e.target.checked})}
          />
        </div>
        <span class="field-help"
          >${Ea("panels.schedules.help.fit_to_window",s)}</span
        >
      </div>
    `}_renderDialog(){if(!this._showDialog)return W``;const e=this._editingSchedule,t=this._editingId?Ea("panels.schedules.dialog.edit_title",this.hass.language):Ea("panels.schedules.dialog.add_title",this.hass.language);return W`
      <ha-dialog open heading="${t}" @closed=${this._closeDialog}>
        <div class="dialog-content">
          ...
          <div class="field">
            <label
              >${Ea("panels.schedules.fields.type",this.hass.language)}</label
            >
            <select
                ...
                <div class="card-content">
                  <div class="info-row">
                    <span class="info-label"
                      >${Ea("panels.schedules.fields.type",this.hass.language)}:</span
                    >
                  ...
                  ${e.time&&["daily","weekly","monthly"].includes(e.type)?W`
                        <div class="info-row">
                          <span class="info-label"
                            >${Ea("panels.schedules.fields.time",this.hass.language)}:</span
                          >
                          <span>${e.time}</span>
                        </div>
                      `:""}
    ...
    `:W``}static get styles(){return[Za,r`
      ...
      `]}};t([pe({attribute:!1})],mn.prototype,"hass",void 0),t([ge()],mn.prototype,"_schedules",void 0),t([ge()],mn.prototype,"_zones",void 0),t([ge()],mn.prototype,"_isLoading",void 0),t([ge()],mn.prototype,"_showDialog",void 0),t([ge()],mn.prototype,"_editingSchedule",void 0),t([ge()],mn.prototype,"_editingId",void 0),mn=t([ce("smart-irrigation-view-schedules")],mn);let vn=class extends(Ba(le)){constructor(){super(...arguments),this._forecast=null,this._mappings=[],this._records=new Map,this._loading=!0,this._metric=!0,this._climate=[]}hassSubscribe(){return this._fetch(),[this.hass.connection.subscribeMessage(()=>this._fetch(),{type:_e+"_config_updated"})]}async _fetch(){var e,t;if(this.hass)try{const[i,s,a,n]=await Promise.all([(t=this.hass,t.callWS({type:_e+"/weather_forecast"})),Di(this.hass),zi(this.hass),Mi(this.hass)]);this._forecast=i,this._mappings=s||[],this._metric=(null==a?void 0:a.units)!==Te;const o=n?Object.values(n):[];this._climate=o.length>0&&(null===(e=o[0])||void 0===e?void 0:e.monthly_estimates)||[];const r=new Map;await Promise.all(this._mappings.map(async e=>{if(void 0!==e.id)try{r.set(e.id,await((e,t,i=10)=>e.callWS({type:_e+"/weather_records",mapping_id:t,limit:i}))(this.hass,e.id.toString(),0)||[])}catch(e){}})),this._records=r}catch(e){console.error("Failed to fetch weather data",e)}finally{this._loading=!1}}render(){return this.hass?W`${this._renderForecast()} ${this._renderRecords()}
    ...
    `}_renderForecastDay(e,t){const i=(()=>{try{return new Intl.DateTimeFormat(t,{weekday:"short",month:"short",day:"numeric"}).format(new Date(e.date+"T00:00:00"))}catch(t){return e.date}})(),s=e=>{const t=nn(e,"temperature",this._metric);return t?`${Math.round(t.value)}°`:"-"};return W`
    ...
    `}};t([pe()],vn.prototype,"narrow",void 0),t([ge()],vn.prototype,"_forecast",void 0),t([ge()],vn.prototype,"_mappings",void 0),t([ge()],vn.prototype,"_records",void 0),t([ge()],vn.prototype,"_loading",void 0),t([ge()],vn.prototype,"_metric",void 0),t([ge()],vn.prototype,"_climate",void 0),vn=t([ce("smart-irrigation-view-weather-data")],vn);let _n=class extends(Ba(le)){constructor(){super(...arguments),this._saving=!1}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch experimental config:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to refresh experimental config:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(this.hass)try{this.config=await zi(this.hass)}catch(e){console.error("Error fetching config:",e),La(this,this.hass,"common.errors.load_failed",e)}}async _toggle(e,t){if(this.hass&&this.config){this.config=Object.assign(Object.assign({},this.config),{[e]:t}),this._saving=!0;try{await Si(this.hass,{[e]:t})}catch(e){console.error("Error saving experimental config:",e),La(this,this.hass,"common.errors.save_failed",e),await this._fetchData()}finally{this._saving=!1}}}render(){var e,t;return this.hass&&this.config?W`
      ${this._renderIntro()}
    ...
    `}};t([pe()],_n.prototype,"narrow",void 0),t([ge()],_n.prototype,"config",void 0),t([ge()],_n.prototype,"_saving",void 0),_n=t([ce("smart-irrigation-view-experimental")],_n);var fn;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.Distributors="distributors",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}(fn||(fn={}));const bn={[fn.WeatherLocation]:"panels.setup.tabs.weather_location",[fn.Zones]:"panels.setup.tabs.my_zones",[fn.Distributors]:"panels.setup.tabs.distributors",[fn.WhenToWater]:"panels.setup.tabs.when_to_water",[fn.Advanced]:"panels.setup.tabs.advanced",[fn.Experimental]:"panels.setup.tabs.experimental",[fn.Help]:"panels.help.title"};let yn=class extends(Ba(le)){hassSubscribe(){return this._fetchConfig(),[this.hass.connection.subscribeMessage(()=>this._fetchConfig(),{type:_e+"_config_updated"})]}async _fetchConfig(){if(this.hass)try{this.config=await zi(this.hass)}catch(e){console.error("Failed to fetch setup config:",e)}}get _distributorsEnabled(){var e,t;return null!==(t=null===(e=this.config)||void 0===e?void 0:e.distributors_enabled)&&void 0!==t&&t}get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(fn).includes(null!=t?t:"")?t:fn.WeatherLocation}_selectTab(e){Ha(0,Wa("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return W``;const e=this._distributorsEnabled,t=Object.values(fn).filter(t=>t!==fn.Distributors||e);let i=this._activeTab;return i!==fn.Distributors||e||(i=fn.WeatherLocation),W`
    ...
    `}_renderContent(e){if(!this.hass)return W``;switch(e){case fn.WeatherLocation:return W`
          ...
          <smart-irrigation-view-weather-data
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-weather-data>
        `;case fn.Zones:return W`<smart-irrigation-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-zone-settings>`;case fn.Distributors:return W`<smart-irrigation-view-distributor-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-distributor-settings>`;case fn.WhenToWater:return W`
          <smart-irrigation-view-general
            .hass="${this.hass}"
            .narrow="${this.narrow}"
        ...
        `;case fn.Advanced:return W`
          ...
          <smart-irrigation-view-mappings
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-mappings>
        `;case fn.Experimental:return W`<smart-irrigation-view-experimental
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-experimental>`;case fn.Help:return this._renderHelp()}}_renderHelp(){return this.hass?W`
      <ha-card
    ...
    `}};var wn;t([pe({attribute:!1})],yn.prototype,"hass",void 0),t([pe({type:Boolean})],yn.prototype,"narrow",void 0),t([pe({attribute:!1})],yn.prototype,"path",void 0),t([ge()],yn.prototype,"config",void 0),yn=t([ce("smart-irrigation-view-setup")],yn),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done"}(wn||(wn={}));let $n=class extends le{constructor(){super(...arguments),this._step=wn.Welcome,this._saving=!1,this._error="",this._confirmClose=!1,this._siConfig=null,this._useWeather=!1,this._weatherService=ze,this._apiKey="",this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=Ue,this._humiditySource=Ue,this._precipSource=Ue,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="",this._scheduleTime="06:00",this._scheduleCreated=!1,this._creatingSchedule=!1}async connectedCallback(){super.connectedCallback(),await this._loadInitialData()}async _loadInitialData(){var e;if(this.hass){try{const[t,i,s]=await Promise.all([Ti(this.hass),Pi(this.hass),zi(this.hass)]);this._availableModules=t,this._weatherConfig=i,this._siConfig=s,this._useWeather=i.use_weather_service,this._weatherService=null!==(e=i.weather_service)&&void 0!==e?e:ze}catch(e){console.error("Wizard: failed to load initial data",e),this._error=Ma(e)}this.requestUpdate()}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}))}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}))}async _next(){this._error="";try{switch(this._saving=!0,this._step){case wn.Welcome:this._step=wn.Weather;break;case wn.Weather:await this._saveWeather(),this._step=wn.Module;break;case wn.Module:await this._saveModule(),this._step=wn.Mapping;break;case wn.Mapping:await this._saveMapping(),this._step=wn.Zone;break;case wn.Zone:await this._saveZone(),this._step=wn.Done;break;case wn.Done:this._close()}}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._saving=!1,this.requestUpdate()}}_back(){this._step>wn.Welcome&&(this._step=this._step-1,this._error="")}get _canSkipCurrentStep(){return this._step===wn.Weather}_skipStep(){this._canSkipCurrentStep&&this._step<wn.Done&&(this._step=this._step+1,this._error="")}async _saveWeather(){await Ri(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null)}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0}catch(e){return}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await Oi(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>Ci(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.")}async _saveMapping(){const e=this._useWeather?Ue:Ge,t={[Re]:{[Ke]:this._tempSource},[Me]:{[Ke]:this._humiditySource},[Ie]:{[Ke]:this._precipSource}},i=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const s of i)t[s]={[Ke]:e};const s=await Hi(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(s,()=>Di(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.")}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await Ei(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:ja.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0})}async _createDefaultSchedule(){var e,t;if(!this._scheduleCreated&&!this._creatingSchedule){this._error="",this._creatingSchedule=!0;try{const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";await Ii(this.hass,{name:Ea("wizard.steps.done.schedule_name",i)||"Daily",type:"daily",enabled:!0,time:this._scheduleTime||"06:00",action:"irrigate",zones:"all"}),this._scheduleCreated=!0}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._creatingSchedule=!1,this.requestUpdate()}}}render(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return W`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          ...
          ${this._step!==wn.Welcome&&this._step!==wn.Done?W`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>wn.Welcome&&this._step<wn.Done?this._confirmClose=!0:this._close())}_renderStepper(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",s=[Ea("wizard.stepper.weather",i),Ea("wizard.stepper.module",i),Ea("wizard.stepper.mapping",i),Ea("wizard.stepper.zone",i)];return W`
      ${s.map((e,t)=>{const i=t+1,a=this._step===i,n=this._step>i;return W`
        ...
        `})}
    `}_renderStep(e){switch(this._step){case wn.Welcome:return this._renderWelcome(e);case wn.Weather:return this._renderWeather(e);case wn.Module:return this._renderModule(e);case wn.Mapping:return this._renderMapping(e);case wn.Zone:return this._renderZone(e);case wn.Done:return this._renderDone(e);default:return W``}}_renderFooter(e){return this._step===wn.Done?W``:W`
      <div class="footer-left">
        ${this._step>wn.Welcome?W`<button
              class="wizard-btn secondary"
              @click="${this._back}"
              ?disabled="${this._saving}"
            >
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Ea("common.saving-messages.saving",e):this._step===wn.Welcome||this._step<wn.Zone?Ea("wizard.next",e):Ea("wizard.finish",e)}
      </button>
    ...
    `}};t([pe({attribute:!1})],$n.prototype,"hass",void 0),t([ge()],$n.prototype,"_step",void 0),t([ge()],$n.prototype,"_saving",void 0),t([ge()],$n.prototype,"_error",void 0),t([ge()],$n.prototype,"_confirmClose",void 0),t([ge()],$n.prototype,"_siConfig",void 0),t([ge()],$n.prototype,"_useWeather",void 0),t([ge()],$n.prototype,"_weatherService",void 0),t([ge()],$n.prototype,"_apiKey",void 0),t([ge()],$n.prototype,"_weatherConfig",void 0),t([ge()],$n.prototype,"_availableModules",void 0),t([ge()],$n.prototype,"_selectedModuleIndex",void 0),t([ge()],$n.prototype,"_moduleConfig",void 0),t([ge()],$n.prototype,"_mappingName",void 0),t([ge()],$n.prototype,"_tempSource",void 0),t([ge()],$n.prototype,"_humiditySource",void 0),t([ge()],$n.prototype,"_precipSource",void 0),t([ge()],$n.prototype,"_zoneName",void 0),t([ge()],$n.prototype,"_zoneSize",void 0),t([ge()],$n.prototype,"_zoneThroughput",void 0),t([ge()],$n.prototype,"_zoneEntity",void 0),t([ge()],$n.prototype,"_scheduleTime",void 0),t([ge()],$n.prototype,"_scheduleCreated",void 0),t([ge()],$n.prototype,"_creatingSchedule",void 0),$n=t([ce("si-setup-wizard")],$n);const xn=Za;var kn;!function(e){e.Zones="zones",e.Setup="setup"}(kn||(kn={})),e.SmartIrrigationPanel=class extends le{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}async firstUpdated(){const e=Fa().page;Object.values(kn).includes(e)||Ha(0,Wa(kn.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())}),Fi().then(()=>{this._scheduleUpdate()}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}),this.hass&&zi(this.hass).then(e=>{this._config=e,this._scheduleUpdate()}).catch(e=>{console.error("Failed to fetch config for version display:",e)})}_ensureLanguage(){this.hass&&!Aa(this.hass.language)&&function(e){const t=Sa(e);return Aa(e)?Promise.resolve():(za[t]||(za[t]=fetch(`/smart_irrigation_static/languages/${t}.json?v=${ve}`).then(e=>e.ok?e.json():Promise.reject(e.status)).then(e=>{ka[t]=e}).catch(()=>{ka[t]=ka.en})),za[t])}(this.hass.language).then(()=>this.requestUpdate())}render(){var e,t;if(this.hass&&!Aa(this.hass.language))return this._ensureLanguage(),W``;const i=Fa(),s=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return W`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
    ...
    `}getView(e){switch(e.page){case"zones":default:return W`
        ...
        `;case"setup":return W`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0}}"
          ></smart-irrigation-view-setup>
        `}}navigateToPage(e){if(e!==Fa().page){const t=Wa(e);Ha(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==Fa().page){const e=Wa(t);Ha(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[xn,r`
        :host {
          color: var(--primary-text-color);
    ...
    `}};t([pe({attribute:!1})],zn.prototype,"hass",void 0),t([ge()],zn.prototype,"_params",void 0),zn=t([ce("error-dialog")],zn);var Sn=Object.freeze({__proto__:null,get ErrorDialog(){return zn}})}({});

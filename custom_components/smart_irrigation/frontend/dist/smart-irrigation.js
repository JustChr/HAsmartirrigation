...
i.version="2.30.1",n(Ga),i.fn=ls,i.min=Ja,i.max=Qa,i.now=ei,i.utc=g,i.unix=ds,i.months=vs,i.isDate=c,i.locale=ga,i.invalid=f,i.duration=Ai,i.isMoment=z,i.weekdays=fs,i.parseZone=us,i.localeData=_a,i.isDuration=ri,i.monthsShort=_s,i.weekdaysMin=ys,i.defineLocale=ma,i.updateLocale=va,i.locales=fa,i.weekdaysShort=bs,i.normalizeUnits=ae,i.relativeTimeRounding=ir,i.relativeTimeThreshold=nr,i.calendarFormat=Bi,i.prototype=ls,i.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},i;}();}(or)),or.exports),dr=nr(lr);let ur=class extends Js(de){constructor(){super(...arguments),this.zones=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._updateScheduled=!1;}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate();}));}firstUpdated(){be().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate();});}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e);}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e);});},{type:Se+"_config_updated"})];}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[t,a]=await Promise.all([Bs(this.hass),Rs(this.hass)]);this.config=t,this.zones=a,this._initialLoadDone=!0;}catch(e){console.error("Error fetching data:",e),Ns(this,this.hass,"common.errors.load_failed",e);}finally{e&&(this.isLoading=!1),this._scheduleUpdate();}}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",Se+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),Ns(this,this.hass,"common.errors.action_failed",e);}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e));}));}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",Se+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),Ns(this,this.hass,"common.errors.action_failed",e);}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e));}));}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return e.linked_entity&&(null!==(t=e.duration)&&void 0!==t?t:0)>0;}).length;}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const a="all"===t,i=a?void 0:this.zones.find(e=>{var a;return(null===(a=e.id)||void 0===a?void 0:a.toString())===t;}),n=a?`(${this._linkedZoneCount})`:`: ${null!==(e=null==i?void 0:i.name)&&void 0!==e?e:t}`;try{await(s=this.hass,r=a?void 0:t,s.callWS(Object.assign({type:Se+"/irrigate_now"},void 0!==r?{zone_id:r}:{}))),Ps(this,`${Es("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${n}`);}catch(e){const t=Os(e);console.error("irrigate_now failed",e),Ps(this,`${Es("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`);}var s,r;}handleCalculateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(a=this.hass,i=t.id.toString(),a.callApi("POST",Se+"/zones",{id:i,calculate:!0,override_cache:!0})).catch(e=>{const t=Os(e);console.error("calculateZone failed:",e),this._operationError=t;}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e));}));}handleUpdateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(a=this.hass,i=t.id.toString(),a.callApi("POST",Se+"/zones",{id:i,update:!0})).catch(e=>{const t=Os(e);console.error("updateZone failed:",e),this._operationError=t;}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e));}));}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;js(0,t?ar("setup","zones",t):ar("setup","zones"));}_renderZoneDecision(e){var t;if(!this.hass)return W``;const a=this.hass.language,i=null!==(t=e.duration)&&void 0!==t?t:0;let n,s,r;return e.state===er.Disabled?(n=Es("panels.zones.status.decision_disabled",a),s="neutral",r="mdi:power-off"):i>0?(n=Es("panels.zones.status.decision_water",a,"{duration}",function(e){const t=Math.round(e);if(t<60)return`${t} s`;const a=Math.floor(t/60),i=t%60;return i?`${a} min ${i} s`:`${a} min`;}(i)),s="water",r="mdi:water"):e.last_calculated?(n=Es("panels.zones.status.decision_no_water",a),s="ok",r="mdi:check-circle-outline"):(n=Es("panels.zones.status.decision_unknown",a),s="unknown",r="mdi:help-circle-outline"),W`
    ...
    `;}_onOverlayClick(e){e.target===e.currentTarget&&this._close();}_renderStepper(){var e,t;const a=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=[Es("wizard.stepper.weather",a),Es("wizard.stepper.module",a),Es("wizard.stepper.mapping",a),Es("wizard.stepper.zone",a)];return W`

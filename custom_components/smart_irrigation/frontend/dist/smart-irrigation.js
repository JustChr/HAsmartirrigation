...
`;const Ja=e=>String(e).padStart(2,"0");function Qa(e){return e instanceof Date?e:new Date(e)}function en(e){const t=Qa(e);return`${Ja(t.getHours())}:${Ja(t.getMinutes())}`}function tn(e){const t=Qa(e);return`${t.getFullYear()}-${Ja(t.getMonth()+1)}-${Ja(t.getDate())} ${Ja(t.getHours())}:${Ja(t.getMinutes())}`}function sn(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class an extends(qa(ce)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){Ks().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const s=Object.keys(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).length>0;s&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):s||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:be+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[s,i,a,n]=await Promise.all([Ts(this.hass),Ds(this.hass),(t=this.hass,t.callWS({type:be+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),Us(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=s,this.zones=i,this._outlook=a,this._distributors=n,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),Fa(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",be+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),Fa(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",be+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),Fa(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const s="all"===t,i=s?void 0:this.zones.find(e=>{var s;return(null===(s=e.id)||void 0===s?void 0:s.toString())===t}),a=s?`(${this._linkedZoneCount})`:`: ${null!==(e=null==i?void 0:i.name)&&void 0!==e?e:t}`;try{await(n=this.hass,o=s?void 0:t,n.callWS(Object.assign({type:be+"/irrigate_now"},void 0!==o?{zone_id:o}:{}))),ja(this,`${Ha("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${a}`)}catch(e){const t=Ba(e);console.error("irrigate_now failed",e),ja(this,`${Ha("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var n,o}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const s=new Date(t);return s.getTime()>Date.now()?s:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:be+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),Fa(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:be+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),Fa(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,s;const i=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(s=this._runMinutes[i])&&void 0!==s?s:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const s=this._zoneDistributor(e);return!!s&&Object.keys(null!==(t=s.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var s,i,a;if(t>0)try{await(s=this.hass,i=e.id.toString(),a=t,s.callWS({type:be+"/run_zone",zone_id:i,duration:a})),ja(this,`${Ha("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=Ba(e);console.error("run_zone failed",e),ja(this,`${Ha("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===s?void 0:s[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,s;if(this.hass&&void 0!==e.id)try{await(t=this.hass,s=e.id.toString(),t.callWS({type:be+"/stop_zone",zone_id:s})),ja(this,`${Ha("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=Ba(e);console.error("stop_zone failed",e),ja(this,`${Ha("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",be+"/zones",{id:i,calculate:!0,override_cache:!0})).catch(e=>{const t=Ba(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",be+"/zones",{id:i,update:!0})).catch(e=>{const t=Ba(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;Pa(0,t?Ya("setup","zones",t):Ya("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,s,i;const a=null!==(t=e.duration)&&void 0!==t?t:0,n=Number(null!==(s=e.bucket_threshold)&&void 0!==s?s:0),o=this._zoneEstimate(e),r=o&&o.available&&null!=o.live_deficit?o.live_deficit:Number(null!==(i=e.bucket)&&void 0!==i?i:0);return a>0&&r<n}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,s=new Date(e),i=en(s),a=new Date;return sn(s,a)?`${Ha("panels.zones.outlook.today",t)} ${i}`:sn(s,function(e,t){const s=new Date(e.getTime());return s.setDate(s.getDate()+t),s}(a,1))?`${Ha("panels.zones.outlook.tomorrow",t)} ${i}`:function(e,t){const s=Qa(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(s)} ${en(s)}`}(s,t)}_renderEstimatedTag(e){if(!this.hass||!e.estimated)return Z``;const t=this.hass.language;return Z`<span
    ...
    ></span>`}_guardLabel(e){return Ha(`panels.zones.outlook.checks.${e.id}`,this.hass.language)}_guardDetail(e){var t;return e.available&&null!==e.observed?Ha(`panels.zones.outlook.check_detail.${e.id}`,this.hass.language,"{observed}",String(e.observed),"{threshold}",String(null!==(t=e.threshold)&&void 0!==t?t:"")):""}_renderSkipReasons(){const e=this.hass.language;return Z`
      ...
      <div class="outlook-line outlook-dim skip-reasons-note">
        ${Ha("panels.zones.outlook.provisional",e)}
      </div>
    `}_openSchedules(){Pa(0,Ya("setup","when-to-water"))}_runActionLabel(e){return Ha(`panels.zones.outlook.actions.${e.action}`,this.hass.language)}_runTargetsLabel(e){const t=this.hass.language;if("all"===e.zones)return Ha("panels.zones.outlook.targets_all",t);const s=Array.isArray(e.zones)?e.zones.length:0;return Ha("panels.zones.outlook.targets_zones",t,"{count}",String(s))}_renderOutlookBanner(){if(!this.hass||!this._outlook)return Z``;const e=this.hass.language,t=this._nextIrrigateRun,s=this._triggeredGuards,i=this._outlook.last_skip_evaluation;return t&&t.next_run_utc?Z`
      <ha-card class="outlook-card">
        <div class="outlook">
          <div class="outlook-line outlook-headline">
            ...
            <span>
              <strong
                >${Ha("panels.zones.outlook.next_run",e)}:</strong
              >
          ...
          ${s.length>0?Z`
                <div class="outlook-line outlook-skip">
                  ...
                  <span
                    >${Ha("panels.zones.outlook.will_skip",e)}</span
                  >
                  <button
                    class="outlook-info-btn"
                    aria-expanded="${this._skipDetailsOpen}"
                    title="${Ha("panels.zones.outlook.why_skipped",e)}"
                  ...
                  >
                    ...
                    <span class="outlook-info-label"
                      >${Ha("panels.zones.outlook.why_skipped",e)}</span
                    >
                  </button>
                </div>
              ...
              `:Z`
                <div class="outlook-line outlook-clear">
                  ...
                  <span
                    >${Ha("panels.zones.outlook.will_run",e)}</span
                  >
                </div>
              `}
    ...
    `:Z`
        <ha-card class="outlook-card">
          <div class="outlook">
            <div class="outlook-line outlook-headline">
              ...
              <span>${Ha("panels.zones.outlook.no_schedule",e)}</span>
              ${this.hideSettingsLinks?"":Z`
                    <button
                      class="outlook-link"
                      @click="${this._openSchedules}"
                    >
                      ${Ha("panels.zones.outlook.setup_schedule",e)}
                    </button>
                  `}
            </div>
            ${i?this._renderLastRunLine(i):""}
        ...
        <ha-card class="rain-delay-card paused">
          <div class="rain-delay">
            ...
            <span class="rain-delay-msg">
              <strong
                >${Ha("panels.zones.rain_delay.paused",e)}</strong
              >
              ${Ha("panels.zones.rain_delay.until",e)}
              ${tn(t.toISOString())}
            </span>
            <button class="action-btn" @click="${()=>this._clearRainDelay()}">
              <ha-icon icon="mdi:play"></ha-icon>
              ${Ha("panels.zones.rain_delay.resume",e)}
            </button>
          </div>
        </ha-card>
      `:Z`
      <div class="rain-delay-row">
        <span class="rain-delay-label">
          ...
          ${Ha("panels.zones.rain_delay.title",e)}
        </span>
        <button class="action-btn" @click="${()=>this._setRainDelay(24)}">
          ${Ha("panels.zones.rain_delay.delay_24h",e)}
        </button>
        <button class="action-btn" @click="${()=>this._setRainDelay(48)}">
          ${Ha("panels.zones.rain_delay.delay_48h",e)}
        </button>
      </div>
    `}_renderLastRunLine(e){const t=this.hass.language,s=function(e,t){const s=Qa(e).getTime()-Date.now(),i=new Intl.RelativeTimeFormat(t,{numeric:"auto"}),a=Math.round(s/1e3);if(Math.abs(a)<60)return i.format(a,"second");const n=Math.round(a/60);if(Math.abs(n)<60)return i.format(n,"minute");const o=Math.round(n/60);if(Math.abs(o)<24)return i.format(o,"hour");const r=Math.round(o/24);if(Math.abs(r)<30)return i.format(r,"day");const l=Math.round(r/30);return Math.abs(l)<12?i.format(l,"month"):i.format(Math.round(l/12),"year")}(e.timestamp,t),i=e.checks.filter(e=>e.enabled&&e.would_skip).map(e=>this._guardLabel(e).toLowerCase()).join(", "),a=e.would_skip?`${Ha("panels.zones.outlook.last_run_skipped",t)}${i?` (${i})`:""}`:Ha("panels.zones.outlook.last_run_ran",t);return Z`
      <div class="outlook-line outlook-last">
        <span class="outlook-dim"
          >${Ha("panels.zones.outlook.last_run",t)}:</span
        >
        <span>${a} · ${s}</span>
      </div>
    `}_renderZoneDecision(e){var t;if(!this.hass)return Z``;const s=this.hass.language,i=null!==(t=e.duration)&&void 0!==t?t:0;let a,n,o,r;if(e.state===Ka.Disabled)a=Ha("panels.zones.status.decision_disabled",s),n="neutral",o="mdi:power-off";else if(e.last_calculated)if(this._zoneHasDeficit(e)){const t=Ua(i),l=this._triggeredGuards,d=this._nextIrrigateRunForZone(e);l.length>0?(a=Ha("panels.zones.status.decision_water_skip",s,"{duration}",t,"{reason}",this._guardLabel(l[0]).toLowerCase()),n="skip",o="mdi:weather-rainy"):d&&d.next_run_utc?(a=Ha("panels.zones.status.decision_water_at",s,"{duration}",t,"{time}",this._formatRunTime(d.next_run_utc)),n="water",o="mdi:water",r=d):(a=Ha("panels.zones.status.decision_water_no_schedule",s,"{duration}",t),n="water",o="mdi:water-alert")}else a=Ha("panels.zones.status.decision_no_water",s),n="ok",o="mdi:check-circle-outline";else a=Ha("panels.zones.status.decision_unknown",s),n="unknown",o="mdi:help-circle-outline";return Z`
      <div class="zone-decision ${n}">
        <ha-icon icon="${o}"></ha-icon>
        <span>${a}</span>
        ${r?this._renderEstimatedTag(r):""}
      </div>
    `}_zoneEstimate(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.zone_estimates)||void 0===s?void 0:s[String(e.id)]}_zoneFault(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.zone_faults)||void 0===s?void 0:s[String(e.id)]}_renderZoneFault(e){if(!this.hass)return Z``;const t=this._zoneFault(e);if(!t)return Z``;const s=this.hass.language,i=Ha(`panels.zones.fault.${t.reason}`,s)||Ha("panels.zones.fault.generic",s),a=t.timestamp?tn(t.timestamp):"";return Z`
      <div class="zone-fault" title="${a}">
        <ha-icon icon="mdi:alert-circle"></ha-icon>
        <span>
          <strong>${Ha("panels.zones.fault.title",s)}</strong>
          — ${i}
        </span>
      </div>
    `}_zoneSkip(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.zone_skips)||void 0===s?void 0:s[String(e.id)]}_renderZoneSkip(e){if(!this.hass)return Z``;const t=this._zoneSkip(e);if(!t)return Z``;const s=this.hass.language,i=Ha("panels.zones.skip.soil_moisture",s,"{observed}",String(t.observed),"{threshold}",String(t.threshold)),a=t.timestamp?tn(t.timestamp):"";return Z`
      <div class="zone-skip" title="${a}">
        <ha-icon icon="mdi:water-off"></ha-icon>
        <span>
          <strong>${Ha("panels.zones.skip.title",s)}</strong>
          — ${i}
        </span>
      </div>
    `}_durationClamped(e){var t,s;if(e.state!==Ka.Automatic)return!1;const i=e.maximum_duration;if(null==i||i<0)return!1;const a=null!==(t=e.duration)&&void 0!==t?t:0;return!(a<=0)&&a-(null!==(s=e.lead_time)&&void 0!==s?s:0)>=i}_renderDurationClamped(e){var t;if(!this.hass||!this._durationClamped(e))return Z``;const s=this.hass.language,i=Ha("panels.zones.clamped.detail",s,"{maximum}",Ua(null!==(t=e.maximum_duration)&&void 0!==t?t:0));return Z`
      <div class="zone-clamped" title="${i}">
        <ha-icon icon="mdi:timer-alert-outline"></ha-icon>
        <span>
          <strong>${Ha("panels.zones.clamped.title",s)}</strong>
          <ha-icon
            class="clamped-hint"
            icon="mdi:information-outline"
          ></ha-icon>
    ...
    `}_renderZoneEstimate(e){if(!this.hass)return Z``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return Z``;const s=this.hass.language,i=Ra(this.config,bt),a=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",n=Ha(`panels.zones.status.estimate_method.${"proxy"===t.method||"hourly_sensor"===t.method?t.method:"hourly"}`,s)+(t.as_of?` · ${en(t.as_of)}`:"");return Z`
      <span class="status-sep">·</span>
      <span class="zone-estimate" title="${n}">
        ${Ha("panels.zones.status.estimate_now",s)}
        <strong style="color: ${a}"
          >≈ ${t.live_deficit.toFixed(2)} ${i}</strong
        >
        <span class="estimate-tag"
          >${Ha("panels.zones.status.estimate_tag",s)}</span
        >
      </span>
    `}_renderZoneNextRun(e){if(!this.hass)return Z``;const t=this._nextIrrigateRunForZone(e);if(!t||!t.next_run_utc)return Z``;return e.state!==Ka.Disabled&&e.last_calculated&&this._zoneHasDeficit(e)&&0===this._triggeredGuards.length?Z``:Z`
      <span class="status-sep">·</span>
      <span>
        ${Ha("panels.zones.outlook.next_run",this.hass.language)}:
      ...
      <ha-card>
        <div class="card-header">
          ...
          <span class="zone-state-badge ${n}">
            ${Ha(`panels.zones.labels.states.${e.state}`,this.hass.language)}
          </span>
          ${this.hideSettingsLinks?"":Z`
                <ha-icon-button
                  ...
                  title="${Ha("panels.zones.actions.open_settings",this.hass.language)}"
        ...
        <div class="card-content">
          <div class="zone-status-line">
            <span
              title="${Ha("panels.zones.help.bucket",this.hass.language)}"
            >
              ${Ha("panels.zones.labels.bucket",this.hass.language)}:
              <strong style="color: ${a}"
                >${i.toFixed(2)}
                ${Ra(this.config,bt)}</strong
              >
            </span>
            <span class="status-sep">·</span>
            <span>
              ${Ha("panels.zones.status.last_checked",this.hass.language)}:
              <strong>${o}</strong>
            </span>
        ...
        <div class="card-content zone-action-bar">
          ${"full"===this.actionsMode&&e.state===Ka.Automatic?Z`
                <button
                  class="action-btn"
                  title="${Ha("panels.zones.help.update",this.hass.language)}"
                  @click="${()=>this.handleUpdateZone(t)}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:update"></ha-icon>
                  ${Ha("panels.zones.actions.update",this.hass.language)}
                </button>
                <button
                  class="action-btn"
                  title="${Ha("panels.zones.help.calculate",this.hass.language)}"
                  @click="${()=>this.handleCalculateZone(t)}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:calculator"></ha-icon>
                  ${Ha("panels.zones.actions.calculate",this.hass.language)}
                </button>
              `:""}
          ${"none"!==this.actionsMode&&this._canActuate(e)&&this._zoneHasDeficit(e)?Z`
                ...
                >
                  ...
                  ${Ha("panels.zones.labels.irrigate_now",this.hass.language)}
                </button>
              `:this._canActuate(e)?"":Z`
                  <button
                    class="action-btn"
                    disabled
                    title="${Ha("panels.zones.help.irrigate_link_entity",this.hass.language)}"
                  >
                    <ha-icon icon="mdi:water"></ha-icon>
                    ${Ha("panels.zones.labels.irrigate_now",this.hass.language)}
                  </button>
                  <span class="zones-top-note">
                    ${Ha("panels.zones.help.irrigate_link_entity",this.hass.language)}
                  </span>
                `}
    ...
    `}_renderRunZoneControl(e){if(!this.hass||"none"===this.actionsMode||!this._canActuate(e)||void 0===e.id)return Z``;const t=this.hass.language,s=String(e.id),i=this._activeRun(e);if(i){const s=this._runSecondsLeft(i);return Z`
        <div class="run-zone-control running">
          <span class="run-zone-countdown">
            ...
            ${null===s?Ha("panels.zones.stop_zone.watering",t):this._formatCountdown(s)}
          </span>
          <button
          ...
          >
            ...
            ${Ha("panels.zones.stop_zone.stop",t)}
          </button>
        </div>
      ...
      <div class="run-zone-control-wrap">
        <div
          ...
          title="${Ha("panels.zones.run_zone.help",t)}"
        >
          <input
          ...
          <span class="run-zone-unit"
            >${Ha("panels.zones.run_zone.minutes",t)}</span
          >
          <button
            class="action-btn"
          ...
          >
            ...
            ${Ha("panels.zones.run_zone.run",t)}
          </button>
        </div>
        ${a?Z`<span class="run-zone-busy-hint">
              ${Ha("panels.zones.run_zone.busy_hint",t)}
            </span>`:""}
      </div>
    `}_formatCountdown(e){const t=Math.max(0,e),s=Math.floor(t/3600),i=Math.floor(t%3600/60),a=t%60,n=e=>String(e).padStart(2,"0");return s>0?`${s}:${n(i)}:${n(a)}`:`${i}:${n(a)}`}render(){var e,t;if(!this.hass)return Z``;if(this.isLoading)return Z`
        <ha-card header="${Ha("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            <div class="loading-indicator">
              ${Ha("common.loading-messages.general",this.hass.language)}
            </div>
          </div>
        </ha-card>
      ...
      ${i?this.hideSettingsLinks?Z`
              <ha-card>
                <div class="card-content description-text">
                  ${Ha("panels.zones.no_items",this.hass.language)}
                </div>
              </ha-card>
            `:Z`
                ...
                <div class="setup-banner">
                  ...
                  <div class="setup-banner-content">
                    <div class="setup-banner-title">
                      ${Ha("wizard.title",this.hass.language)}
                    </div>
                    <div class="setup-banner-desc">
                      ${Ha("wizard.setup_complete_banner",this.hass.language)}
                    </div>
                  </div>
                  <button
                  ...
                  >
                    ${Ha("wizard.open_wizard",this.hass.language)}
                  </button>
                </div>
              </ha-card>
            `:""}
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${Ha("panels.zones.title",this.hass.language)}
          </div>
        </div>
        <div class="card-content zones-top-actions">
          ${"full"===this.actionsMode?Z`
                <button
                  class="action-btn"
                  title="${Ha("panels.zones.help.update_all",this.hass.language)}"
                  @click="${this.handleUpdateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:update"></ha-icon>
                  ${Ha("panels.zones.cards.zone-actions.actions.update-all",this.hass.language)}
                </button>
                <button
                  class="action-btn"
                  title="${Ha("panels.zones.help.calculate_all",this.hass.language)}"
                  @click="${this.handleCalculateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:calculator"></ha-icon>
                  ${Ha("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language)}
                </button>
              `:""}
          ${"none"!==this.actionsMode?Z`
                <button
                  class="action-btn"
                  raised
                  title="${Ha("panels.zones.help.irrigate_all",this.hass.language)}"
                  @click="${()=>{this._confirmIrrigate="all"}}"
                  ?disabled="${!s||this.isSaving}"
                >
                  <ha-icon icon="mdi:water"></ha-icon>
                  ${Ha("panels.zones.actions.irrigate_all",this.hass.language)}
                </button>
              `:""}
          ${s?"":Z`<span class="zones-top-note"
                >${Ha("panels.info.cards.irrigate_now.no_linked_zones",this.hass.language)}</span
              >`}
        </div>
      </ha-card>
      ...
      ${null!==this._confirmIrrigate?Z`
            <ha-dialog
              ...
              heading="${Ha("panels.zones.confirm_irrigate.title",this.hass.language)}"
            >
              <p>
                ${Ha("panels.zones.confirm_irrigate.body",this.hass.language)}
              </p>
              <p>
                <strong>
                  ${"all"===this._confirmIrrigate?`${Ha("panels.zones.confirm_irrigate.all_linked_zones",this.hass.language)} (${this._linkedZoneCount})`:null!==(t=null===(e=this.zones.find(e=>{var t;return(null===(t=e.id)||void 0===t?void 0:t.toString())===this._confirmIrrigate}))||void 0===e?void 0:e.name)&&void 0!==t?t:this._confirmIrrigate}
                </strong>
              </p>
              <div class="dialog-footer">
                ...
                >
                  ${Ha("common.actions.cancel",this.hass.language)}
                </button>
                <button
            ...
            <ha-card class="error-banner-card">
              <div class="error-banner">
                ...
                <ha-icon-button
                  ...
                  aria-label="${Ha("common.actions.cancel",this.hass.language)}"
                ></ha-icon-button>
              </div>
            </ha-card>
          `:""}
    ...
    `}}t([me()],an.prototype,"config",void 0),t([me({type:Boolean})],an.prototype,"hideSettingsLinks",void 0),t([me({attribute:!1})],an.prototype,"actionsMode",void 0),t([me({type:Array})],an.prototype,"zones",void 0),t([ve()],an.prototype,"_outlook",void 0),t([ve()],an.prototype,"_distributors",void 0),t([me({type:Boolean})],an.prototype,"isLoading",void 0),t([me({type:Boolean})],an.prototype,"isSaving",void 0),t([ve()],an.prototype,"_operationError",void 0),t([ve()],an.prototype,"_confirmIrrigate",void 0),t([ve()],an.prototype,"_skipDetailsOpen",void 0),t([ve()],an.prototype,"_runMinutes",void 0),t([ve()],an.prototype,"_now",void 0),customElements.get("smart-irrigation-view-zones")||customElements.define("smart-irrigation-view-zones",an)
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */;const nn={},on=Qs(class extends ei{constructor(e){if(super(e),e.type!==Xs&&e.type!==Vs&&e.type!==Js)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===G||t===K)return t;const s=e.element,i=e.name;if(e.type===Xs){if(t===s[i])return G}else if(e.type===Js){if(!!t===s.hasAttribute(i))return G}else if(e.type===Vs&&s.getAttribute(i)===t+"")return G;return((e,t=nn)=>{e._$AH=t;
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */})(e),t}});let rn=class extends ce{constructor(){super(...arguments),this.label="",this.unit="",this.help="",this.required=!1,this._helpOpen=!1}_toggleHelp(){this._helpOpen=!this._helpOpen}render(){return Z`
      <div class="si-field">
    ...
    `}_renderServiceAndKey(e){return Z`
      <si-field
        label="${Ha("weather_service_config.service_label",e)}"
      >
        <select
          class="si-input"
          .value="${on(this.service||Ae)}"
        ...
        >
          ...
          >
            ${Ha("weather_service_config.openmeteo",e)}
          </option>
          <option
            value="${ze}"
            ?selected="${this.service===ze}"
          >
            ${Ha("weather_service_config.owm",e)}
          </option>
          <option
            value="${Se}"
            ?selected="${this.service===Se}"
          >
            ${Ha("weather_service_config.pw",e)}
          </option>
          <option
            value="${Ce}"
            ?selected="${this.service===Ce}"
          >
            ${Ha("weather_service_config.met",e)}
          </option>
        </select>
      </si-field>

      ${this._needsKey?this._renderKeyField(e):Z`<div class="info-note">
            ${Ha("weather_service_config.no_api_key_needed",e)}
          </div>`}
    `}_renderKeyField(e){var t;const s=this._hasStoredKey;return Z`
      <si-field
        label="${Ha("weather_service_config.api_key_label",e)}"
        help="${Ha("weather_service_config.api_key_help",e)}"
      >
        <span class="api-badge ${s?"configured":"missing"}"
          >${Ha(s?"weather_service_config.api_key_configured":"weather_service_config.api_key_not_configured",e)}</span
        >
        <div class="api-row">
          <input
            type="password"
            class="si-input flex1"
            placeholder="${Ha("weather_service_config.api_key_placeholder",e)}"
            .value="${this.apiKey}"
          ...
          >
            ${this._testing?Ha("weather_service_config.test_button_testing",e):Ha("weather_service_config.test_button",e)}
          </button>
        </div>
        ${null!==this._testResult?Z`<div
              class="test-result ${this._testResult.success?"success":"error"}"
            >
              ${this._testResult.success?Ha("weather_service_config.test_success",e):Ha("weather_service_config.test_error_"+(null!==(t=this._testResult.error)&&void 0!==t?t:"unknown"),e)}
            </div>`:""}
      </si-field>
    `}static get styles(){return r`
      :host {
      ...
      >
        ...
        <div class="card-content">
          ...
          <div style="margin-top: 12px;">
            ...
            >
              ${this._weatherSaving?Ha("common.saving-messages.saving",this.hass.language):Ha("weather_service_config.save_button",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    `:Z``}_renderAutoUpdateCard(){var e,t;return this.hass&&this.config&&this.data?Z`
      <ha-card
        header="${Ha("panels.general.cards.automatic-update.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Ha("panels.general.cards.automatic-update.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Ha("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}
            </label>
            <ha-switch
          ...
          ${this.data.autoupdateenabled?Z`
                <div class="setting-row">
                  <label>
                    ${Ha("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}
                  </label>
                  <div class="inline-row">
                    ...
                    <select
                      ...
                      .value="${on(this.data.autoupdateschedule||Te)}"
                    ...
                    >
                      ...
                      >
                        ${Ha("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
                      </option>
                      <option
                        value="${Te}"
                        ?selected="${(this.data.autoupdateschedule||Te)===Te}"
                      >
                        ${Ha("panels.general.cards.automatic-update.options.hours",this.hass.language)}
                      </option>
                      <option
                        value="${Oe}"
                        ?selected="${this.data.autoupdateschedule===Oe}"
                      >
                        ${Ha("panels.general.cards.automatic-update.options.days",this.hass.language)}
                      </option>
                    </select>
                  </div>
                </div>
                <div class="setting-row">
                  <label>
                    ${Ha("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language)}
                    (s)
                  </label>
                  <input
                    type="number"
    ...
    `:Z``}_renderAutoCalcCard(){return this.hass&&this.config&&this.data?Z`
      <ha-card
        header="${Ha("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Ha("panels.general.cards.automatic-duration-calculation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Ha("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}
            </label>
            <ha-switch
    ...
    `:Z``}_renderAutoCalcMode(){if(!this.hass||!this.config)return Z``;const e=this.hass.language,t=$e.includes(this.config.autocalcmode)?this.config.autocalcmode:we;return Z`
      <div class="setting-row">
        <label>
          ${Ha("panels.general.cards.automatic-duration-calculation.labels.calc-mode",e)}
        </label>
        <select
          class="settings-input"
          .value="${on(t)}"
        ...
        >
          ${$e.map(s=>Z`
              <option value="${s}" ?selected="${t===s}">
                ${Ha(`panels.general.cards.automatic-duration-calculation.modes.${s}`,e)}
              </option>
            `)}
        </select>
      </div>
      ${t===we?Z`
            <div class="setting-row">
              <label>
                ${Ha("panels.general.cards.automatic-duration-calculation.labels.calc-time",e)}
              </label>
              <input
                type="text"
                class="settings-input shortfield"
          ...
          `:Z`
            <div class="card-content description-text">
              ${Ha("panels.general.cards.automatic-duration-calculation.help.before-run",e)}
            </div>
          `}
    `}_renderRunHistoryLoggingCard(){return this.hass&&this.config?Z`
      <ha-card
        header="${Ha("panels.general.cards.run-history-logging.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Ha("panels.general.cards.run-history-logging.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Ha("panels.general.cards.run-history-logging.labels.log-no-demand",this.hass.language)}
            </label>
            <ha-switch
    ...
    `:Z``}_renderWeatherSkipCard(){var e,t,s,i,a;if(!this.hass||!this.config||!this.data)return Z``;const n=this.hass.language,o=this.config.skip_irrigation_on_precipitation?"skip":this.config.forecast_weighting_enabled?"water_less":"ignore";return Z`
      <ha-card header="${Ha("weather_skip.title",this.hass.language)}">
        <div class="card-content description-text">
          ${Ha("weather_skip.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Ha("weather_skip.forecast_rain_label",n)}
            </label>
            <select
              class="settings-input"
              .value="${on(o)}"
            ...
            >
              ${["ignore","water_less","skip"].map(e=>Z`
                  <option value="${e}" ?selected="${o===e}">
                    ${Ha(`weather_skip.forecast_rain_options.${e}`,n)}
                  </option>
                `)}
            </select>
          </div>
          <div class="description-text">
            ${Ha(`weather_skip.forecast_rain_help.${o}`,n)}
          </div>
          ${"ignore"!==o?Z`
                <div class="setting-row">
                  <label>
                    ${Ha("weather_skip.lookahead_label",n)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="description-text">
                  ${Ha("weather_skip.lookahead_help",n)}
                </div>
              `:""}
          ${"skip"===o?Z`
                <div class="setting-row">
                  <label>
                    ${Ha("weather_skip.threshold_label",n)}
                    (${Ra(this.config,xe)})
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Ha("weather_skip.temp_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Ha("weather_skip.temp_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_temp_enabled?Z`
                <div class="setting-row">
                  <label>
                    ${Ha("weather_skip.temp_threshold_label",this.hass.language)}
                    (°C)
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Ha("weather_skip.wind_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Ha("weather_skip.wind_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_wind_enabled?Z`
                <div class="setting-row">
                  <label>
                    ${Ha("weather_skip.wind_threshold_label",this.hass.language)}
                    (m/s)
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Ha("weather_skip.freeze_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Ha("weather_skip.freeze_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_freeze_enabled?Z`
                <div class="setting-row">
                  <label>
                    ${Ha("weather_skip.freeze_threshold_label",this.hass.language)}
                    (°C)
                  </label>
                  <input
                    type="number"
                ...
                <div class="description-text">
                  ${Ha("weather_skip.freeze_help",this.hass.language)}
                </div>
              `:""}

          <div class="section-divider">
            ${Ha("weather_skip.rain_sensor_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Ha("weather_skip.rain_sensor_label",this.hass.language)}
            </label>
            <ha-entity-picker
              .hass="${this.hass}"
      ...
      >
        ...
        <div class="card-content">
          ...
          ${this._coordsEnabled?Z`
                <div class="setting-row">
                  <label>
                    ${Ha("coordinate_config.latitude",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="setting-row">
                  <label>
                    ${Ha("coordinate_config.longitude",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="setting-row">
                  <label>
                    ${Ha("coordinate_config.elevation",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
              ...
              `:Z`
                ...
                >
                  ${Ha("coordinate_config.current_ha_coords",this.hass.language)}:
                  ${Ha("coordinate_config.latitude",this.hass.language)}:
          ...
          <div style="margin-top: 12px;">
            ...
            >
              ${this._coordsSaving?Ha("common.saving-messages.saving",this.hass.language):Ha("common.actions.save",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    `}_renderDaysBetweenIrrigationCard(){var e;return this.hass&&this.config&&this.data?Z`
      <ha-card
        header="${Ha("days_between_irrigation.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Ha("days_between_irrigation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Ha("days_between_irrigation.label",this.hass.language)}
              <div class="setting-description">
                ${Ha("days_between_irrigation.help_text",this.hass.language)}
              </div>
            </label>
            <input
              type="number"
    ...
    `:Z``}_renderZoneSequencingCard(){var e,t;if(!this.hass||!this.config||!this.data)return Z``;const s=(this.config.zone_sequencing||Zt)===qt;return Z`
      <ha-card
        header="${Ha("zone_sequencing.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Ha("zone_sequencing.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Ha("zone_sequencing.title",this.hass.language)}
            </label>
            <select
              class="settings-input"
              .value="${on(this.config.zone_sequencing||Zt)}"
            ...
            >
              ...
              >
                ${Ha("zone_sequencing.parallel",this.hass.language)}
              </option>
              <option
                value="${Wt}"
                ?selected="${this.config.zone_sequencing===Wt}"
              >
                ${Ha("zone_sequencing.sequential",this.hass.language)}
              </option>
              <option
                value="${qt}"
                ?selected="${this.config.zone_sequencing===qt}"
              >
                ${Ha("zone_sequencing.rotating",this.hass.language)}
              </option>
            </select>
          </div>
          ${s?Z`
                <div class="setting-row">
                  <label>
                    ${Ha("zone_sequencing.max_consecutive_duration_label",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    min="1"
                  ...
                  <span class="unit-label">
                    ${Ha("zone_sequencing.max_consecutive_duration_unit",this.hass.language)}
                  </span>
                </div>
                <div class="setting-row">
                  <label>
                    ${Ha("zone_sequencing.min_absorption_time_label",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    min="0"
                  ...
                  />
                  <span class="unit-label">
                    ${Ha("zone_sequencing.min_absorption_time_unit",this.hass.language)}
                  </span>
                </div>
              `:""}
        </div>
    ...
    `}_renderMasterSwitchCard(){var e,t;if(!this.hass||!this.config)return Z``;const s=!!this.config.master_kick_enabled;return Z`
      <ha-card header="${Ha("master.title",this.hass.language)}">
        <div class="card-content description-text">
          ${Ha("master.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${Ha("master.entity",this.hass.language)}</label>
            <ha-entity-picker
              .hass="${this.hass}"
          ...
          ${this.config.master_entity?Z`
                <div class="setting-row">
                  <label
                    >${Ha("master.kick_enabled",this.hass.language)}</label
                  >
                  <ha-switch
                    .checked="${s}"
                ...
                ${s?Z`
                      <div class="setting-row">
                        <label>
                          ${Ha("master.kick_pause",this.hass.language)}
                        </label>
                        <input
                          type="number"
                          min="0"
                        ...
                        />
                        <span class="unit-label">
                          ${Ha("master.seconds_unit",this.hass.language)}
                        </span>
                      </div>
                    `:""}
                <div class="setting-row">
                  <label
                    >${Ha("master.settle",this.hass.language)}</label
                  >
                  <input
                    type="number"
                    min="0"
                ...
                <div class="setting-row">
                  <label
                    >${Ha("master.off_after",this.hass.language)}</label
                  >
                  <ha-switch
    ...
    `}async saveData(e){if(this.hass&&this.data){this.isSaving=!0,this._saveStatus="saving",this._scheduleUpdate();try{this.data=Object.assign(Object.assign({},this.data),e),this._scheduleUpdate(),await Os(this.hass,this.data),this._markSaved()}catch(e){console.error("Error saving config:",e),this._saveStatus="idle",Fa(this,this.hass,"common.errors.save_failed",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}}}_markSaved(){this._saveStatus="saved",this._savedResetTimer&&clearTimeout(this._savedResetTimer),this._savedResetTimer=window.setTimeout(()=>{this._saveStatus="idle",this._scheduleUpdate()},2e3)}_renderSaveStatus(){if(!this.hass||"idle"===this._saveStatus)return Z``;const e="saving"===this._saveStatus;return Z`
      <div class="save-status-float ${this._saveStatus}">
        ...
        ></ha-icon>
        ${Ha(e?"common.saving-messages.saving":"panels.zones.status.saved",this.hass.language)}
      </div>
    ...
    `}};t([me()],dn.prototype,"narrow",void 0),t([me()],dn.prototype,"path",void 0),t([me()],dn.prototype,"section",void 0),t([me()],dn.prototype,"data",void 0),t([me()],dn.prototype,"config",void 0),t([me({type:Boolean})],dn.prototype,"isLoading",void 0),t([me({type:Boolean})],dn.prototype,"isSaving",void 0),t([me()],dn.prototype,"_weatherConfig",void 0),t([me()],dn.prototype,"_weatherService",void 0),t([me({type:Boolean})],dn.prototype,"_useWeatherService",void 0),t([me()],dn.prototype,"_newApiKey",void 0),t([me({type:Boolean})],dn.prototype,"_weatherSaving",void 0),t([ve()],dn.prototype,"_coords",void 0),t([ve()],dn.prototype,"_coordsEnabled",void 0),t([ve()],dn.prototype,"_coordsLat",void 0),t([ve()],dn.prototype,"_coordsLon",void 0),t([ve()],dn.prototype,"_coordsElev",void 0),t([ve()],dn.prototype,"_coordsSaving",void 0),t([ve()],dn.prototype,"_saveStatus",void 0),dn=t([ue("smart-irrigation-view-general")],dn);const cn=e=>9*e/5+32;function hn(e,t,s){if(null==e||Number.isNaN(e))return null;switch(t){case"temperature":return s?{value:e,unit:"°C"}:{value:cn(e),unit:"°F"};case"precipitation":return s?{value:e,unit:ot}:{value:(n=e,n/25.4),unit:rt};case"windspeed":return s?{value:e,unit:ct}:{value:(a=e,2.2369362920544*a),unit:dt};case"pressure":return s?{value:e,unit:"hPa"}:{value:(i=e,.0295299830714*i),unit:lt}}var i,a,n}function un(e,t,s,i){const a=hn(e,t,s);if(!a)return"-";const n=function(e,t){return"pressure"===e?t?0:2:"precipitation"===e?t?1:2:1}(t,s);return`${a.value.toFixed(n)} ${a.unit}`}function pn(e,t){return null==e||Number.isNaN(e)?"-":t?`${e.toFixed(0)} L`:`${(e=>.264172052*e)(e).toFixed(1)} gal`}let gn=class extends ce{constructor(){super(...arguments),this.metric=!0,this.name="",this.size="",this.throughput="",this.linkedEntity="",this.showEntity=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{value:t},bubbles:!0,composed:!0}))}render(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=this.metric?"m²":st,a=this.metric?it:at;return Z`
      <si-field label="${Ha("panels.zones.labels.name",s)}" required>
        <input
          type="text"
          class="si-input"
          .value="${this.name}"
      ...
      <si-field
        label="${Ha("panels.zones.labels.size",s)}"
        unit="${i}"
        help="${Ha("field_help.zone_size",s)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      <si-field
        label="${Ha("panels.zones.labels.throughput",s)}"
        unit="${a}"
        help="${Ha("field_help.zone_throughput",s)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      ${this.showEntity?Z`
            <si-field
              label="${Ha("panels.zones.labels.linked_entity",s)}"
              help="${Ha("field_help.zone_linked_entity",s)}"
            >
              <ha-entity-picker
                .hass="${this.hass}"
    ...
    `}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await Ms(this.hass,e)}_renderModuleOptions(e){if(!this.hass)return Z``;const t=null!=e?String(e):"";return Z`
      <option value="" ?selected="${""===t}">
        ---${Ha("common.labels.select",this.hass.language)}---
      </option>
    ...
    `}_renderDistributorSelector(e,t){var s,i;if(!this.hass)return Z``;if(!(null===(s=this.config)||void 0===s?void 0:s.distributors_enabled))return Z``;const a=this.hass.language,n=null!=e.distributor_id;return Z`
      <ha-settings-row>
        <span slot="heading"
          >${Ha("panels.zones.labels.distributor",a)}</span
        >
        <span slot="description"
          >${Ha("panels.zones.labels.distributor_help",a)}</span
        >
        <select
          class="settings-input"
        ...
        >
          <option value="" ?selected="${!n}">
            ${Ha("panels.zones.labels.distributor_none",a)}
          </option>
      ...
      ${n?Z`
            <ha-settings-row>
              <span slot="heading"
                >${Ha("panels.zones.labels.outlet_number",a)}</span
              >
              <span slot="description"
                >${Ha("panels.zones.labels.outlet_number_readonly_help",a)}</span
              >
        ...
        ${b?Z`
             ...
             used to sit alongside it moved to the Weather & Location tab). -->
              <div class="card-content zone-settings">
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.name",this.hass.language)}</span
                  >
                  <input
                    type="text"
                    class="settings-input"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.size",this.hass.language)}
                    (${Ra(this.config,gt)})</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.throughput",this.hass.language)}
                    (${Ra(this.config,mt)})</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.soil_type",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Ha("field_help.zone_soil_type",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${on(null!==(i=Object.keys(jt).find(t=>jt[t]===e.drainage_rate))&&void 0!==i?i:"custom")}"
                  ...
                  >
                    ...
                    >
                      ${Ha("panels.zones.labels.soil_types.custom",this.hass.language)}
                    </option>
                    ${Object.keys(jt).map(t=>Z`
                        ...
                        >
                          ${Ha(`panels.zones.labels.soil_types.${t}`,this.hass.language)}
                        </option>
                      `)}
                  </select>
                </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.drainage_rate",this.hass.language)}
                    (${Ra(this.config,zt)})</span
                  >
                  <span slot="description"
                    >${Ha("field_help.zone_drainage_rate",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.plant_type",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Ha("field_help.zone_plant_type",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                  ...
                  >
                    ...
                    >
                      ${Ha("panels.zones.labels.plant_types.custom",this.hass.language)}
                    </option>
                    ${Object.keys(Ut).map(t=>Z`
                        ...
                        >
                          ${Ha(`panels.zones.labels.plant_types.${t}`,this.hass.language)}
                        </option>
                      `)}
                  </select>
                </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.kc",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Ha("field_help.zone_kc",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.state",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                    .value="${on(e.state)}"
                  ...
                  >
                    ...
                    >
                      ${Ha("panels.zones.labels.states.automatic",this.hass.language)}
                    </option>
                    <option
                      value="${Ka.Manual}"
                      ?selected="${e.state===Ka.Manual}"
                    >
                      ${Ha("panels.zones.labels.states.manual",this.hass.language)}
                    </option>
                    <option
                      value="${Ka.Disabled}"
                      ?selected="${e.state===Ka.Disabled}"
                    >
                      ${Ha("panels.zones.labels.states.disabled",this.hass.language)}
                    </option>
                  </select>
                </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("common.labels.module",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.mapping",this.hass.language)}</span
                  >
                  <select
                    class="settings-input"
                ...
                ${null!=e.distributor_id?Z`<div class="distributor-managed">
                      ${Ha("panels.zones.labels.distributor_managed_note",this.hass.language)}
                    </div>`:Z`
                      <ha-settings-row>
                        <span slot="heading"
                          >${Ha("panels.zones.labels.watering_mode",this.hass.language)}</span
                        >
                        <span slot="description"
                          >${Ha("panels.zones.labels.watering_mode_description",this.hass.language)}</span
                        >
                        <select
                          class="settings-input"
                        ...
                        >
                          ...
                          >
                            ${Ha("panels.zones.labels.watering_modes.classic",this.hass.language)}
                          </option>
                          <option
                            value="service"
                            ?selected="${"service"===e.watering_mode}"
                          >
                            ${Ha("panels.zones.labels.watering_modes.service",this.hass.language)}
                          </option>
                          <option
                            value="${As}"
                            ?selected="${e.watering_mode===As}"
                          >
                            ${Ha("panels.zones.labels.watering_modes.opensprinkler",this.hass.language)}
                          </option>
                        </select>
                      </ha-settings-row>
                      ...
                      ${"service"===e.watering_mode?Z`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ha("panels.zones.labels.run_service",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ha("panels.zones.labels.run_service_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                                .value="${e.run_service||""}"
                            ...
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ha("panels.zones.labels.duration_field",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ha("panels.zones.labels.duration_field_help",this.hass.language)}</span
                              >
                              <input
                                type="text"
                                class="settings-input"
                                placeholder="${Ha("panels.zones.labels.duration_field_placeholder",this.hass.language)}"
                            ...
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ha("panels.zones.labels.duration_unit",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ha("panels.zones.labels.duration_unit_help",this.hass.language)}</span
                              >
                              <select
                                class="settings-input"
                              ...
                              >
                                ...
                                >
                                  ${Ha("panels.zones.labels.duration_units.seconds",this.hass.language)}
                                </option>
                                <option
                                  value="minutes"
                                  ?selected="${"minutes"===e.duration_unit}"
                                >
                                  ${Ha("panels.zones.labels.duration_units.minutes",this.hass.language)}
                                </option>
                              </select>
                            </ha-settings-row>
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ha("panels.zones.labels.stop_service",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ha("panels.zones.labels.stop_service_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                            ...
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ha("panels.zones.labels.confirm_entity",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ha("panels.zones.labels.confirm_entity_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                            ...
                            ${(null===(p=this.config)||void 0===p?void 0:p.observed_watering_enabled)?Z`
                                  <ha-settings-row>
                                    <span slot="heading"
                                      >${Ha("panels.zones.labels.observed_entity",this.hass.language)}</span
                                    >
                                    <span slot="description"
                                      >${Ha("panels.zones.labels.observed_entity_help",this.hass.language)}</span
                                    >
                                    <ha-entity-picker
                                      .hass="${this.hass}"
                      ...
                      ${e.watering_mode===As?Z`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ha("panels.zones.labels.opensprinkler_station",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ha("panels.zones.labels.opensprinkler_station_help",this.hass.language)}</span
                              >
                              <ha-entity-picker
                                .hass="${this.hass}"
                            ...
                            ${this._hasOpenSprinklerStations()?"":Z`<div class="distributor-managed">
                                  ${Ha("panels.zones.labels.opensprinkler_no_stations",this.hass.language)}
                                </div>`}
                          `:"service"!==e.watering_mode?Z`
                              <ha-settings-row>
                                <span slot="heading"
                                  >${Ha("panels.zones.labels.linked_entity",this.hass.language)}</span
                                >
                                <ha-entity-picker
                                  .hass="${this.hass}"
                                  .value="${e.linked_entity||""}"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.soil_moisture_sensor",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Ha("panels.zones.labels.soil_moisture_sensor_help",this.hass.language)}</span
                  >
                  <ha-entity-picker
                    .hass="${this.hass}"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.soil_moisture_threshold",this.hass.language)}</span
                  >
                  <span slot="description"
                    >${Ha("panels.zones.labels.soil_moisture_threshold_help",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                ${null==e.distributor_id?Z`
                      <ha-settings-row>
                        <span slot="heading"
                          >${Ha("panels.zones.labels.flow_sensor",this.hass.language)}</span
                        >
                        <ha-entity-picker
                          .hass="${this.hass}"
                          .value="${e.flow_sensor||""}"
                      ...
                      ${this._flowSensorIsTotalizer(e)?Z`
                            <ha-settings-row>
                              <span slot="heading"
                                >${Ha("panels.zones.labels.flow_counter_type",this.hass.language)}</span
                              >
                              <span slot="description"
                                >${Ha("panels.zones.labels.flow_counter_type_help",this.hass.language)}</span
                              >
                              <select
                                class="settings-input"
                              ...
                              >
                                ${["auto","per_run","lifetime"].map(t=>Z`
                                    ...
                                    >
                                      ${Ha(`panels.zones.labels.flow_counter_type_${t}`,this.hass.language)}
                                    </option>
                                  `)}
                              </select>
                            </ha-settings-row>
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.maximum-bucket",this.hass.language)}
                    (${Ra(this.config,bt)})</span
                  >
                  <input
                    type="number"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.multiplier",this.hass.language)}</span
                  >
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.lead-time",this.hass.language)}
                    (${nt})</span
                  >
                  <input
                    type="number"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.maximum-duration",this.hass.language)}
                    (${nt})</span
                  >
                  <input
                    type="number"
                ...
                <ha-settings-row>
                  <span slot="heading"
                    >${Ha("panels.zones.labels.bucket_threshold",this.hass.language)}
                    (${Ra(this.config,bt)})</span
                  >
                  <input
                    type="number"
                ...
                ${e.state===Ka.Manual?Z`
                      <ha-settings-row>
                        <span slot="heading"
                          >${Ha("panels.zones.labels.duration",this.hass.language)}
                          (${nt})</span
                        >
                        <input
                          type="number"
                ...
                <div class="settings-danger-row">
                  <button
                    class="action-btn"
                    @click="${()=>{this._pendingConfirm={title:Ha("panels.zones.confirm_action.reset_bucket_title",this.hass.language),body:Ha("panels.zones.confirm_action.reset_bucket_body",this.hass.language),confirmLabel:Ha("panels.zones.actions.reset-bucket",this.hass.language),onConfirm:()=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[bt]:0}))}}}"
                    ?disabled="${this.isSaving}"
                  >
                    ${Ha("panels.zones.actions.reset-bucket",this.hass.language)}
                  </button>
                  <button
                  ...
                  >
                    ...
                    ${Ha("common.actions.delete",this.hass.language)}
                  </button>
                </div>
              </div>
              ...
              ${e.explanation&&e.explanation.length>0?Z`
                    <ha-expansion-panel
                      .header="${Ha("panels.zones.actions.information",this.hass.language)}"
                    >
                      <div class="card-content">
                        ${si(e.explanation)}
                      </div>
    ...
    `}_renderRunHistory(e){var t,s,i;if(!this.hass)return Z``;const a=(null===(t=this.config)||void 0===t?void 0:t.units)===Me,n=null!==(s=e.run_log)&&void 0!==s?s:[],o=this.hass.language;return Z`
      <ha-expansion-panel
        .header="${Ha("panels.zones.history.title",o)}"
      >
        <div class="card-content">
          <div class="history-usage">
            <span class="history-usage-label"
              >${Ha("panels.zones.history.total_used",o)}</span
            >
          ...
          ${0===n.length?Z`<div class="weather-note">
                ${Ha("panels.zones.history.empty",o)}
              </div>`:Z`
                <table class="history-table">
                  <thead>
                    <tr>
                      <th>${Ha("panels.zones.history.when",o)}</th>
                      <th>${Ha("panels.zones.history.result",o)}</th>
                      <th class="num">
                        ${Ha("panels.zones.history.volume",o)}
                      </th>
                      <th>${Ha("panels.zones.history.detail",o)}</th>
                    </tr>
                  </thead>
                  <tbody>
    ...
    `}_renderRunLogRow(e,t){const s=this.hass.language,i=Ha(`panels.zones.history.results.${e.result}`,s);let a="";return e.detail&&(a="skipped"===e.result?e.detail.split(",").map(e=>Ha(`panels.zones.outlook.checks.${e}`,s)||e).join(", "):/^[A-Za-z0-9_-]+$/.test(e.detail)&&Ha(`panels.zones.fault.${e.detail}`,s)||e.detail),Z`
      <tr>
        <td>${tn(e.ts)}</td>
        <td>
    ...
    `}render(){var e;if(!this.hass)return Z``;if(this.isLoading)return Z`
      ...
      <ha-card>
        <div class="card-header">
          ...
          <ha-icon-button
            .path="${Za}"
            title="${Ha("panels.zones.cards.add-zone.header",this.hass.language)}"
      ...
      <ha-dialog
        ...
        heading="${Ha("panels.zones.cards.add-zone.header",this.hass.language)}"
      >
        ...
        <div class="dialog-footer">
          ...
          >
            ${this.isSaving?Ha("common.saving-messages.adding",this.hass.language):Ha("panels.zones.cards.add-zone.actions.add",this.hass.language)}
          </button>
        </div>
      </ha-dialog>
      ...
      ${t?Z`
            <ha-dialog
              ...
              heading="${Ha("common.actions.confirm_delete",this.hass.language)}"
            >
              <p>
                ${Ha("common.actions.confirm_delete_zone",this.hass.language)}
              </p>
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${Ha("common.labels.bulk_actions",this.hass.language)}
          </div>
        </div>
        <div class="card-content bulk-actions">
          <button
            class="action-btn danger-button"
            @click="${()=>{this._pendingConfirm={title:Ha("panels.zones.confirm_action.reset_all_buckets_title",this.hass.language),body:Ha("panels.zones.confirm_action.reset_all_buckets_body",this.hass.language),confirmLabel:Ha("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language),onConfirm:()=>this.handleResetAllBuckets()}}}"
            ?disabled="${this.isSaving}"
          >
            ${Ha("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language)}
          </button>
          <button
            class="action-btn danger-button"
            @click="${()=>{this._pendingConfirm={title:Ha("panels.zones.confirm_action.clear_weather_title",this.hass.language),body:Ha("panels.zones.confirm_action.clear_weather_body",this.hass.language),confirmLabel:Ha("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language),onConfirm:()=>this.handleClearAllWeatherdata()}}}"
            ?disabled="${this.isSaving}"
          >
            ${Ha("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language)}
          </button>
        </div>
      </ha-card>
    ...
    `}};t([me()],mn.prototype,"config",void 0),t([me({attribute:!1})],mn.prototype,"path",void 0),t([me({type:Array})],mn.prototype,"zones",void 0),t([me({type:Array})],mn.prototype,"modules",void 0),t([me({type:Array})],mn.prototype,"mappings",void 0),t([me({type:Array})],mn.prototype,"distributors",void 0),t([me({type:Boolean})],mn.prototype,"isLoading",void 0),t([ve()],mn.prototype,"_expanded",void 0),t([me({type:Boolean})],mn.prototype,"isSaving",void 0),t([me({type:Boolean})],mn.prototype,"_showAddZone",void 0),t([ve()],mn.prototype,"_pendingConfirm",void 0),t([ve()],mn.prototype,"_saveStatus",void 0),t([me()],mn.prototype,"_confirmDeleteZoneId",void 0),t([me()],mn.prototype,"_newZoneName",void 0),t([me()],mn.prototype,"_newZoneSize",void 0),t([me()],mn.prototype,"_newZoneThroughput",void 0),t([me()],mn.prototype,"_newZoneEntity",void 0),mn=t([ue("smart-irrigation-view-zone-settings")],mn);let vn=class extends ce{_emit(e){this.dispatchEvent(new CustomEvent("distributor-changed",{detail:{value:Object.assign(Object.assign({},this.distributor),e)},bubbles:!0,composed:!0}))}_onNumber(e,t){const s=t.target.valueAsNumber;isNaN(s)||this._emit({[e]:Math.max(0,Math.round(s))})}render(){var e,t,s,i;if(!this.hass||!this.distributor)return Z``;const a=this.hass.language,n=this.distributor,o=n.watering_mode===Ss;return Z`
      <ha-settings-row>
        <span slot="heading"
          >${Ha("panels.distributors.labels.name",a)}</span
        >
        <input
          type="text"
          class="settings-input"
          .value="${null!==(e=n.name)&&void 0!==e?e:""}"
          @input="${e=>this._emit({[us]:e.target.value})}"
        />
      </ha-settings-row>

      <ha-settings-row>
        <span slot="heading"
          >${Ha("panels.zones.labels.watering_mode",a)}</span
        >
        <span slot="description"
          >${Ha("panels.distributors.labels.watering_mode_help",a)}</span
        >
        <select
          class="settings-input"
          .value="${on(null!==(t=n.watering_mode)&&void 0!==t?t:zs)}"
          @change="${e=>this._emit({[ps]:e.target.value})}"
        >
          <option
            value="${zs}"
            ?selected="${(null!==(s=n.watering_mode)&&void 0!==s?s:zs)===zs}"
          >
            ${Ha("panels.zones.labels.watering_modes.classic",a)}
          </option>
          <option
            value="${Ss}"
            ?selected="${n.watering_mode===Ss}"
          >
            ${Ha("panels.zones.labels.watering_modes.service",a)}
          </option>
        </select>
      </ha-settings-row>
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Ha("panels.distributors.labels.notify_target",a)}</span
        >
        <span slot="description"
          >${Ha("panels.distributors.labels.notify_target_help",a)}</span
        >
        <input
          type="text"
          class="settings-input"
          placeholder="${Ha("panels.distributors.labels.notify_target_placeholder",a)}"
          .value="${null!==(i=n.notify_target)&&void 0!==i?i:""}"
          @input="${e=>this._emit({[$s]:e.target.value||null})}"
        />
      </ha-settings-row>
    `}_renderInletWatchRows(e){var t;const s=this.distributor,i=s.watering_mode===Ss?"panels.distributors.labels.inlet_entity_help_service":"panels.distributors.labels.inlet_entity_help",a=null!==(t=s.watch_mode)&&void 0!==t?t:"ignore";return Z`
      <ha-settings-row>
        <span slot="heading"
          >${Ha("panels.distributors.labels.inlet_entity",e)}</span
        >
        <span slot="description">${Ha(i,e)}</span>
        <ha-entity-picker
          .hass="${this.hass}"
      ...
      ${s.inlet_entity?Z`
            <ha-settings-row>
              <span slot="heading"
                >${Ha("panels.distributors.labels.watch_mode",e)}</span
              >
              <span slot="description"
                >${Ha("panels.distributors.labels.watch_mode_help",e)}</span
              >
              <select
                class="settings-input"
                .value="${on(a)}"
                @change="${e=>this._emit({[ms]:e.target.value})}"
              >
                ${ks.map(t=>Z`
                    <option value="${t}" ?selected="${a===t}">
                      ${Ha(`panels.distributors.labels.watch_mode_${t}`,e)}
                    </option>
                  `)}
              </select>
            </ha-settings-row>
    ...
    `}_renderServiceRows(e){var t,s;const i=this.distributor;return Z`
      <ha-settings-row>
        <span slot="heading"
          >${Ha("panels.distributors.labels.run_service",e)}</span
        >
        <span slot="description"
          >${Ha("panels.distributors.labels.run_service_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
          .value="${i.run_service||""}"
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Ha("panels.distributors.labels.duration_field",e)}</span
        >
        <span slot="description"
          >${Ha("panels.distributors.labels.duration_field_help",e)}</span
        >
        <input
          type="text"
          class="settings-input"
          placeholder="${Ha("panels.distributors.labels.duration_field_placeholder",e)}"
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Ha("panels.distributors.labels.duration_unit",e)}</span
        >
        <select
          class="settings-input"
          .value="${on(null!==(t=i.duration_unit)&&void 0!==t?t:"seconds")}"
          @change="${e=>this._emit({[bs]:e.target.value})}"
        >
          <option
            value="seconds"
            ?selected="${"seconds"===(null!==(s=i.duration_unit)&&void 0!==s?s:"seconds")}"
          >
            ${Ha("panels.distributors.labels.duration_units.seconds",e)}
          </option>
          <option value="minutes" ?selected="${"minutes"===i.duration_unit}">
            ${Ha("panels.distributors.labels.duration_units.minutes",e)}
          </option>
        </select>
      </ha-settings-row>
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Ha("panels.distributors.labels.stop_service",e)}</span
        >
        <span slot="description"
          >${Ha("panels.distributors.labels.stop_service_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
    ...
    `}_renderSensorRows(e){const t=this.distributor;return Z`
      <ha-settings-row>
        <span slot="heading"
          >${Ha("panels.distributors.labels.confirm_entity",e)}</span
        >
        <span slot="description"
          >${Ha("panels.distributors.labels.confirm_entity_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
      ...
      <ha-settings-row>
        <span slot="heading"
          >${Ha("panels.distributors.labels.flow_sensor",e)}</span
        >
        <span slot="description"
          >${Ha("panels.distributors.labels.flow_sensor_help",e)}</span
        >
        <ha-entity-picker
          .hass="${this.hass}"
          .value="${t.flow_sensor||""}"
    ...
    `}_renderTimingRows(e){var t,s,i,a;const n=this.distributor,o=(null!==(t=n.pause_seconds)&&void 0!==t?t:0)<10,r=(null!==(s=n.skip_pulse_seconds)&&void 0!==s?s:0)<10;return Z`
      <ha-settings-row>
        <span slot="heading"
          >${Ha("panels.distributors.labels.pause_seconds",e)}
          (${nt})</span
        >
        <span slot="description"
          >${Ha("field_help.distributor_pause_seconds",e)}</span
        >
        <input
          type="number"
          class="settings-input shortfield"
      ...
      ${o?Z`<div class="timing-warning">
            ${Ha("panels.distributors.hints.below_floor_pause",e)}
          </div>`:""}

      <ha-settings-row>
        <span slot="heading"
          >${Ha("panels.distributors.labels.skip_pulse_seconds",e)}
          (${nt})</span
        >
        <span slot="description"
          >${Ha("field_help.distributor_skip_pulse_seconds",e)}</span
        >
        <input
          type="number"
          class="settings-input shortfield"
      ...
      ${r?Z`<div class="timing-warning">
            ${Ha("panels.distributors.hints.below_floor_skip",e)}
          </div>`:""}
    `}static get styles(){return r`
      ${Xa}
    ...
    `}_hasOwnActuation(e){return!!(e.linked_entity||e.run_service||e.stop_service)}_membersByOutlet(e){const t=new Map;if(void 0===e)return t;for(const s of this.zones)s.distributor_id===e&&null!=s.outlet_number&&void 0!==s.id&&t.set(s.outlet_number,s);return t}_outletCount(e){const t=this._membersByOutlet(e.id),s=t.size?Math.max(...t.keys()):0,i=Math.max(2,s),a=void 0!==e.id?this._outletRows[e.id]:void 0;return Math.min(6,Math.max(i,null!=a?a:i))}_assignZone(e,t,s){return Ms(this.hass,{id:e.id,[Cs]:t,[Es]:s})}_optimisticZone(e,t,s){void 0!==e&&(this.zones=this.zones.map(i=>i.id===e?Object.assign(Object.assign({},i),{distributor_id:t,outlet_number:s}):i))}_runAssign(e){e.length&&(this.isSaving=!0,this._saveStatus="saving",this._scheduleUpdate(),Promise.all(e).then(()=>this._markSaved()).catch(e=>{console.error("Failed to assign zone to outlet:",e),this._saveStatus="idle",Fa(this,this.hass,"common.errors.save_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(()=>{})}))}_setOutletCount(e,t){if(void 0===e.id)return;const s=this._membersByOutlet(e.id),i=[];for(const[e,a]of s)e>t&&i.push(a);this._outletRows=Object.assign(Object.assign({},this._outletRows),{[e.id]:t}),i.length?(i.forEach(e=>this._optimisticZone(e.id,null,null)),this._runAssign(i.map(e=>this._assignZone(e,null,null)))):this._scheduleUpdate()}_onOutletZoneChange(e,t,s){const i=s.target.value,a=i?parseInt(i):null,n=this._membersByOutlet(e.id).get(t),o=null!==a?this.zones.find(e=>e.id===a):null,r=[];n&&n.id!==a&&(r.push(this._assignZone(n,null,null)),this._optimisticZone(n.id,null,null)),o&&(r.push(this._assignZone(o,e.id,t)),this._optimisticZone(o.id,e.id,t)),this._runAssign(r)}_renderOutletConfig(e){if(!this.hass)return Z``;const t=this.hass.language,s=this._membersByOutlet(e.id),i=this._outletCount(e),a=this.zones.filter(e=>void 0!==e.id&&null==e.distributor_id&&!this._hasOwnActuation(e)),n=[...s.keys()].sort((e,t)=>e-t),o=n.some((e,t)=>e!==t+1),r=[];for(let n=1;n<=i;n++){const i=s.get(n),o=i?[...a,i]:[...a];o.sort((e,t)=>(e.name||"").localeCompare(t.name||"")),r.push(Z`
        <div class="outlet-row">
          <span class="outlet-label"
            >${Ha("panels.distributors.commissioning.outlet",t)}
            ${n}</span
          >
          <select
            class="settings-input"
          ...
          >
            <option value="" ?selected="${!i}">
              ${Ha("panels.distributors.outlets.none",t)}
            </option>
            ${o.map(e=>Z`
      ...
      <div class="outlet-config">
        <div class="commissioning-head">
          <span class="section-title"
            >${Ha("panels.distributors.outlets.title",t)}</span
          >
        </div>
        <div class="item-description">
          ${Ha("panels.distributors.outlets.help",t)}
        </div>
        ${0===this.zones.length?Z`<div class="weather-note">
              ${Ha("panels.distributors.outlets.no_zones",t)}
            </div>`:Z`
              <ha-settings-row>
                <span slot="heading"
                  >${Ha("panels.distributors.outlets.count",t)}</span
                >
                <select
                  class="settings-input shortfield"
                  .value="${on(String(i))}"
              ...
              ${o?Z`<div class="timing-warning">
                    ${Ha("panels.distributors.outlets.gap_warning",t)}
                  </div>`:""}
              <div class="commissioning-note">
                ${Ha("panels.distributors.hints.outlet_change",t)}
              </div>
            `}
      </div>
    `}_renderAdvisories(){var e,t;if(!this.hass)return Z``;const s=this.hass.language,i=null===(e=this.config)||void 0===e?void 0:e.zone_sequencing,a=i===Zt,n=i===Wt||i===qt,o=!!(null===(t=this.config)||void 0===t?void 0:t.master_off_after);return Z`
      <div class="advisories">
        <div class="advisory">
          ...
          <span
            >${Ha("panels.distributors.hints.experimental",s)}</span
          >
        </div>
        <div class="advisory">
          <ha-icon icon="mdi:water-alert-outline"></ha-icon>
          <span>${Ha("panels.distributors.hints.pressure",s)}</span>
        </div>
        ${a?Z`<div class="advisory">
              <ha-icon icon="mdi:information-outline"></ha-icon>
              <span
                >${Ha("panels.distributors.hints.parallel_draw",s)}</span
              >
            </div>`:""}
        ${n&&o?Z`<div class="advisory">
              <ha-icon icon="mdi:information-outline"></ha-icon>
              <span
                >${Ha("panels.distributors.hints.master_off_after",s)}</span
              >
            </div>`:""}
      </div>
    `}_renderCommissioning(e){var t;if(!this.hass)return Z``;const s=this.hass.language,i="synced"===e.position_state,a=!!e.commissioning_confirmed,n=!!e.active_cycle&&Object.keys(e.active_cycle).length>0,o=e.id;return Z`
      <div class="commissioning">
        <div class="commissioning-head">
          <span class="section-title"
            >${Ha("panels.distributors.commissioning.title",s)}</span
          >
          <span class="pos-badge pos-${e.position_state}">
            ${Ha("panels.distributors.commissioning.outlet",s)}
            ${e.current_outlet} ·
            ${Ha(`panels.distributors.commissioning.states.${e.position_state}`,s)}
          </span>
        </div>
        ...
        <ha-settings-row>
          <span slot="heading"
            >${Ha("panels.distributors.commissioning.set_outlet",s)}</span
          >
          <span slot="description"
            >${Ha("panels.distributors.commissioning.set_outlet_help",s)}</span
          >
          <div class="inline-controls">
            ...
            >
              ${Ha("panels.distributors.commissioning.set_outlet",s)}
            </button>
            <button
              class="action-btn secondary"
              ?disabled="${this.isSaving}"
            ...
            >
              ${Ha("panels.distributors.commissioning.resync_home",s)}
            </button>
          </div>
        </ha-settings-row>
        <div class="commissioning-note">
          ${Ha("panels.distributors.hints.undetectable",s)}
        </div>

        <!-- Test run -->
        <ha-settings-row>
          <span slot="heading"
            >${Ha("panels.distributors.commissioning.test_run",s)}</span
          >
          <span slot="description"
            >${Ha("panels.distributors.commissioning.test_run_help",s)}</span
          >
          <button
            class="action-btn secondary"
          ...
          >
            ...
            ${Ha("panels.distributors.commissioning.test_run",s)}
          </button>
        </ha-settings-row>
        ...
        <ha-settings-row>
          <span slot="heading"
            >${Ha("panels.distributors.commissioning.confirmed",s)}</span
          >
          <span slot="description"
            >${Ha(i?"panels.distributors.commissioning.confirmed_help":"panels.distributors.commissioning.needs_sync",s)}</span
          >
          <ha-switch
            .checked="${on(a)}"
        ...
        <div class="run-now-row">
          ...
          >
            <ha-icon icon="mdi:play"></ha-icon>
            ${Ha("panels.distributors.commissioning.run_now",s)}
          </button>
          <span class="run-now-hint">
            ${Ha(n?"panels.distributors.commissioning.run_now_active":"panels.distributors.commissioning.run_now_help",s)}
          </span>
        </div>
      </div>
    `}renderDistributor(e,t){var s;if(!this.hass)return Z``;const i=this._isExpanded(e),a=this.hass.language;return Z`
      <ha-card id="distributor-${null!==(s=e.id)&&void 0!==s?s:"new"}">
        ...
        >
          <div class="name">${e.name}</div>
          <span class="pos-badge pos-${e.position_state}">
            ${Ha(`panels.distributors.commissioning.states.${e.position_state}`,a)}
          </span>
          <ha-icon
            class="dist-chevron"
    ...
    `}render(){var e;if(!this.hass)return Z``;const t=this.hass.language;if(this.isLoading)return Z`
        <ha-card header="${Ha("panels.distributors.title",t)}">
          <div class="card-content">
            <div class="loading-indicator">
              ${Ha("common.loading-messages.general",t)}
            </div>
          </div>
        </ha-card>
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">${Ha("panels.distributors.title",t)}</div>
          ${this._renderSaveStatus()}
          <ha-icon-button
            .path="${Za}"
            title="${Ha("panels.distributors.add.header",t)}"
            @click="${()=>{this._showAdd=!0}}"
          ></ha-icon-button>
        </div>
        <div class="card-content">
          <div class="item-description">
            ${Ha("panels.distributors.description",t)}
          </div>
          ${this._renderAdvisories()}
          ${0===this.distributors.length?Z`<div class="weather-note">
                ${Ha("panels.distributors.no_items",t)}
              </div>`:""}
        </div>
      </ha-card>
      ...
      <ha-dialog
        ...
        heading="${Ha("panels.distributors.add.header",t)}"
      >
        <div class="add-form">
          <si-field
            label="${Ha("panels.distributors.labels.name",t)}"
            required
          >
            <input
              type="text"
              class="settings-input"
              placeholder="${Ha("panels.distributors.add.name_placeholder",t)}"
              .value="${this._newName}"
        ...
        <div class="dialog-footer">
          ...
          >
            ${this.isSaving?Ha("common.saving-messages.adding",t):Ha("panels.distributors.add.actions.add",t)}
          </button>
        </div>
      </ha-dialog>
      ...
      ${s?Z`
            <ha-dialog
              ...
              heading="${Ha("common.actions.confirm_delete",t)}"
            >
              <p>${Ha("panels.distributors.confirm_delete",t)}</p>
      ...
      ${i?Z`
            <ha-dialog
              ...
              heading="${Ha("panels.distributors.commissioning.confirm_dialog.title",t)}"
            >
              <p>
                ${Ha("panels.distributors.commissioning.confirm_dialog.body",t)}
              </p>
              ...
              <div class="dialog-footer">
                ...
                >
                  ${Ha("panels.distributors.commissioning.confirm_dialog.confirm",t)}
                </button>
              </div>
            </ha-dialog>
          `:""}
      ...
      ${a?Z`
            <ha-dialog
              ...
              heading="${Ha("panels.distributors.commissioning.confirm_resync.title",t)}"
            >
              <p>
                ${Ha("panels.distributors.commissioning.confirm_resync.body",t)}
              </p>
              ...
              <div class="dialog-footer">
                ...
                >
                  ${Ha("panels.distributors.commissioning.resync_home",t)}
                </button>
              </div>
            </ha-dialog>
          `:""}
      ...
      ${n?Z`
            <ha-dialog
              ...
              heading="${Ha("panels.distributors.commissioning.confirm_set_outlet.title",t)}"
            >
              <p>
                ${Ha("panels.distributors.commissioning.confirm_set_outlet.body",t)}
              </p>
              <p>
                <strong
                  >${n.name} ·
              ...
              <div class="dialog-footer">
                ...
                >
                  ${Ha("panels.distributors.commissioning.set_outlet",t)}
                </button>
              </div>
            </ha-dialog>
          `:""}
        ...
        <div class="card-content">
          ...
          <div class="moduleconfig">
            <label class="subheader"
              >${Ha("panels.modules.cards.module.labels.configuration",this.hass.language)}
              (*
              ${Ha("panels.modules.cards.module.labels.required",this.hass.language)})</label
            >
            ${e.schema?Object.entries(e.schema).map(([e])=>this.renderConfig(t,e)):null}
          </div>
          <div class="card-footer">
            ${s?Z`<div class="weather-note">
                  ${Ha("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}
                </div>`:Z`<button
                  class="action-btn danger"
    ...
    `;return this.moduleCache.set(i,a),a}renderUsageChip(e){return this.hass?e?Z`<span class="usage-chip"
      ...
      >
        ${Object.entries(n.options).map(([e,s])=>Z`<option
              ...
              ?selected="${h===Na(s,0)}"
            >
              ${Ha("panels.modules.cards.module.translated-options."+Na(s,1),t)}
            </option>`)}
      ...
      <ha-card header="${Ha("panels.modules.title",this.hass.language)}">
        <div class="card-content">
          ${Ha("panels.modules.description",this.hass.language)}
          ${this.isLoading?Z`<div class="loading-indicator">
                ...
                <div class="add-row">
                  <select
                    id="moduleInput"
                    class="settings-input"
                    aria-label="${Ha("common.labels.module",this.hass.language)}"
                    ?disabled="${this.isSaving}"
                  >
                  ...
                  >
                    ...
                    ${this.isSaving?Ha("common.saving-messages.adding",this.hass.language):Ha("panels.modules.cards.add-module.actions.add",this.hass.language)}
                  </button>
                </div>
              `}
        </div>
    ...
    `}renderSimpleRadioOptions(e,t,s){if(!this.hass||!this.config)return Z``;const i=t===Ie||t===Be,a=s[Ye];return Z`
      ${!i&&this.config.use_weather_service?Z`
            <label>
              ...
              />
              ${Ha("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}
            </label>
          `:""}
      ${i?Z`
            <label>
              <input
                ...
                @change="${s=>this.handleSimpleSourceChange(e,t,s)}"
              />
              ${Ha("panels.mappings.cards.mapping.sources.none",this.hass.language)}
            </label>
          `:""}
      ...
      <label>
        <input
          ...
          @change="${s=>this.handleSimpleSourceChange(e,t,s)}"
        />
        ${Ha("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}
      </label>
      ...
      <label>
        <input
          ...
          @change="${s=>this.handleSimpleSourceChange(e,t,s)}"
        />
        ${Ha("panels.mappings.cards.mapping.sources.static",this.hass.language)}
      </label>
    `}handleSimpleSourceChange(e,t,s){const i=this.mappings[e],a=s.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[t]:Object.assign(Object.assign({},i.mappings[t]),{[Ye]:a,[Xe]:""})})}))}handleSimpleInputChange(e,t,s,i){const a=this.mappings[e],n=i.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},a),{mappings:Object.assign(Object.assign({},a.mappings),{[t]:Object.assign(Object.assign({},a.mappings[t]),{[s]:n})})}))}renderMappingInputs(e,t,s){if(!this.hass)return Z``;const i=s[Ye];return Z`
      ...
      ${t!==Pe||i!==We&&i!==Ze?"":this.renderPressureTypeSelect(e,t,s)}
    ...
    `}renderSensorInput(e,t,s){if(!this.hass)return Z``;const i=`${t}_${e}`;return Z`
      <div class="mappingsettingline">
        <label for="${i}_sensor_entity">
          ${Ha("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}:
        </label>
        <input
          type="text"
          class="settings-input"
    ...
    `}renderStaticValueInput(e,t,s){if(!this.hass)return Z``;const i=`${t}_${e}`;return Z`
      <div class="mappingsettingline">
        <label for="${i}_static_value">
          ${Ha("panels.mappings.cards.mapping.static_value",this.hass.language)}:
        </label>
        <input
          type="text"
          class="settings-input"
    ...
    `}renderUnitSelect(e,t,s){if(!this.hass||!this.config)return Z``;const i=`${t}_${e}`;return Z`
      <div class="mappingsettingline">
        <label for="${i}_unit">
          ${Ha("panels.mappings.cards.mapping.input-units",this.hass.language)}:
        </label>
        <select
          id="${i}_unit"
          class="settings-input"
    ...
    `}renderPressureTypeSelect(e,t,s){if(!this.hass)return Z``;const i=`${t}_${e}`;return Z`
      <div class="mappingsettingline">
        <label for="${i}_pressure_type">
          ${Ha("panels.mappings.cards.mapping.pressure-type",this.hass.language)}:
        </label>
        <select
          id="${i}_pressure_type"
          class="settings-input"
    ...
    `}renderAggregateSelect(e,t,s){if(!this.hass)return Z``;const i=`${t}_${e}`;return Z`
      <div class="mappingsettingline">
        <label for="${i}_aggregate">
          ${Ha("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
        </label>
        <select
          id="${i}_aggregate"
          class="settings-input"
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return Z`<option value="${e}" ?selected="${e===t}">
        ${Ha("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return Z``}renderPressureTypes(e,t){if(this.hass&&this.config){let e=Z``;const s=t[qe];return e=Z`${e}
        <option
          value="${Ge}"
          ?selected="${s===Ge}"
        >
          ${Ha("panels.mappings.cards.mapping.pressure_types."+Ge,this.hass.language)}
        </option>
        <option
          value="${Ke}"
          ?selected="${s===Ke}"
        >
          ${Ha("panels.mappings.cards.mapping.pressure_types."+Ke,this.hass.language)}
        </option>`,e}return Z``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return Z``;const s=function(e){switch(e){case He:case Ue:return[{unit:"°C",system:Me},{unit:"°F",system:De}];case Re:case Ie:return[{unit:ot,system:Me},{unit:rt,system:De}];case Le:return[{unit:ht,system:Me},{unit:ut,system:De}];case Ne:return[{unit:"%",system:[Me,De]}];case Pe:return[{unit:"millibar",system:Me},{unit:"hPa",system:Me},{unit:"psi",system:De},{unit:lt,system:De}];case je:return[{unit:"km/h",system:Me},{unit:ct,system:Me},{unit:dt,system:De}];case Be:return[{unit:"W/m2",system:Me},{unit:"MJ/day/m2",system:Me},{unit:"W/sq ft",system:De},{unit:"MJ/day/sq ft",system:De}];default:return[]}}(e);let i=t[Qe];const a=this.config.units;if(!t[Qe])for(const e of s)if("string"==typeof e.system){if(a===e.system){i=e.unit;break}}else{for(const t of e.system)if(a===t.system){i=e.unit;break}if(i===e.unit)break}return Z`
      ${s.map(e=>Z`
    ...
    `}render(){return this.hass?this.isLoading?Z`
        <ha-card
          header="${Ha("panels.mappings.title",this.hass.language)}"
        >
          <div class="card-content">
            <div class="loading-indicator">
              ${Ha("common.loading-messages.general",this.hass.language)}
      ...
      >
        <div class="card-content">
          ${Ha("panels.mappings.description",this.hass.language)}
          <div class="add-row">
            <input
              id="mappingNameInput"
              class="settings-input"
              type="text"
              placeholder="${Ha("panels.mappings.labels.mapping-name",this.hass.language)}"
            />
            <button
              class="action-btn ${this.isSaving?"saving":""}"
              ?disabled="${this.isSaving}"
            ...
            >
              <ha-icon icon="mdi:plus"></ha-icon>
              ${Ha("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    ...
    `}renderMappingCard(e,t){if(!this.hass)return Z``;const s=this.zones.filter(t=>t.mapping===e.id).length;return Z`
      <ha-card>
        ...
        <div class="card-content">
          <ha-settings-row>
            <span slot="heading"
              >${Ha("panels.mappings.labels.mapping-name",this.hass.language)}</span
            >
            <input
              id="name${e.id}"
              class="settings-input"
          ...
          <div class="card-footer">
            ${s?Z`<div class="weather-note">
                  ${Ha("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}
                </div>`:Z`<button
                  class="action-btn danger"
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach(e=>{clearTimeout(e)}),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};t([me()],bn.prototype,"config",void 0),t([me({type:Array})],bn.prototype,"zones",void 0),t([me({type:Array})],bn.prototype,"mappings",void 0),t([me({type:Boolean})],bn.prototype,"isLoading",void 0),t([me({type:Boolean})],bn.prototype,"isSaving",void 0),t([fe("#mappingNameInput")],bn.prototype,"mappingNameInput",void 0),bn=t([ue("smart-irrigation-view-mappings")],bn);const yn="06:00",wn=90;function $n(e){switch(e){case ns:return{mode:e,time:yn};case os:case rs:return{mode:e,offset:0};case ls:return{mode:e,azimuth:wn};default:return{mode:as}}}function xn(e,t,s,i){const a=function(e){return e===as||e===ns||e===os||e===rs||e===ls}(e)?e:as,n=$n(a);return a===ns&&void 0!==t&&(n.time=t),a!==os&&a!==rs||void 0===s||(n.offset=s),a===ls&&void 0!==i&&(n.azimuth=i),n}function kn(e){var t,s,i;return{mode:e.mode,time:e.mode===ns?null!==(t=e.time)&&void 0!==t?t:yn:void 0,offset:e.mode===os||e.mode===rs?null!==(s=e.offset)&&void 0!==s?s:0:void 0,azimuth:e.mode===ls?null!==(i=e.azimuth)&&void 0!==i?i:wn:void 0}}function zn(e){return{start:xn(e.start_mode,e.start_time,e.start_offset,e.start_azimuth),finish:xn(e.finish_mode,e.finish_time,e.finish_offset,e.finish_azimuth),anchor:e.anchor===cs?cs:hs}}function Sn(e,t){const s=e.start.mode!==as,i=e.finish.mode!==as;if(!s&&!i)return{start:"error",finish:"error",valid:!1};return function(e,t,s){if(!(null==s?void 0:s.start)&&!(null==s?void 0:s.finish))return t;const i=e.start.mode!==as,a=e.finish.mode!==as,n=i&&a?e.anchor:i?cs:hs,o=e=>e===n?"unreachable_no_run":"unreachable_ignored";return Object.assign(Object.assign({},t),{start:s.start?o(cs):t.start,finish:s.finish?o(hs):t.finish})}(e,s?i?e.anchor===hs?{start:"demand_floored",finish:"exact_deferred",valid:!0}:{start:"exact",finish:"demand_capped_deferred",valid:!0}:{start:"exact",finish:"demand_open",valid:!0}:{start:"demand_open",finish:"exact",valid:!0},t)}function An(e,t){const s=function(e,t){if("all"===e||!Array.isArray(e))return Ha("panels.schedules.summary.zones_all",t);return Ha("panels.schedules.summary.zones_some",t,"count",e.length)}(e.zones,t),i=function(e,t){switch(e.recurrence){case es:{const s=(e.days_of_week||[]).map(e=>Ha(`panels.schedules.days.${e}`,t)).join(", ");return Ha("panels.schedules.summary.recurrence_weekly",t,"days",s)}case ts:return Ha("panels.schedules.summary.recurrence_monthly",t,"day",e.day_of_month||1);case ss:{const s=e.interval_hours||24;return e.start_time?Ha("panels.schedules.summary.recurrence_interval_at",t,"hours",s,"time",e.start_time):Ha("panels.schedules.summary.recurrence_interval",t,"hours",s)}default:return Ha("panels.schedules.summary.recurrence_daily",t)}}(e,t);if(e.recurrence===ss){return{text:`${i}, ${Ha("panels.schedules.summary.watering",t,"zones",s)}.`,isError:!1}}const a=zn(e),n=a.start.mode!==as,o=a.finish.mode!==as;if(!n&&!o)return{text:Ha("panels.schedules.summary.invalid",t),isError:!0};const r=Ha("panels.schedules.summary.watering",t,"zones",s);let l;return l=n?o?a.anchor===hs?Ha("panels.schedules.summary.anchor_finish",t,"finish",Cn(a.finish,t),"start",Cn(a.start,t)):Ha("panels.schedules.summary.anchor_start",t,"start",Cn(a.start,t),"finish",Cn(a.finish,t)):Ha("panels.schedules.summary.start_only",t,"when",Cn(a.start,t)):Ha("panels.schedules.summary.finish_only",t,"when",Cn(a.finish,t)),{text:`${i}, ${r}, ${l}.`,isError:!1}}function Cn(e,t){var s,i,a;switch(e.mode){case ns:return null!==(s=e.time)&&void 0!==s?s:"";case os:case rs:{const s=Ha(`panels.schedules.summary.${e.mode}`,t),a=null!==(i=e.offset)&&void 0!==i?i:0;if(0===a)return s;return Ha(a<0?"panels.schedules.summary.offset_before":"panels.schedules.summary.offset_after",t,"minutes",Math.abs(a),"event",s)}case ls:return Ha("panels.schedules.summary.at_azimuth",t,"degrees",null!==(a=e.azimuth)&&void 0!==a?a:wn);default:return""}}function En(e){return(e%360+360)%360}const Tn=Math.PI/180;function On(e,t,s){const i=e*Tn,a=23.45*Math.sin(360*(284+function(e){const t=Date.UTC(e.getUTCFullYear(),0,1),s=Date.UTC(e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate());return Math.floor((s-t)/864e5)+1}(s))/365*Tn)*Tn,n=15*(s.getUTCHours()+s.getUTCMinutes()/60+s.getUTCSeconds()/3600+t/15-12)*Tn;return En(Math.atan2(Math.sin(n),Math.cos(n)*Math.sin(i)-Math.tan(a)*Math.cos(i))/Tn+180)}function Dn(e,t,s){return Math.abs(e-t)>180?e>t?s>=e||s<=t:s<=e||s>=t:Math.min(e,t)<=s&&s<=Math.max(e,t)}const Mn=9e5;function Hn(e,t,s,i,a){let n=i,o=a;for(;o-n>6e4;){const i=n+(o-n)/2,a=On(e,t,new Date(i));Dn(On(e,t,new Date(n)),a,s)?o=i:n=i}return new Date(n)}const In={hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"};function Nn(e,t){if(!e)return Rn(t);let s;try{s=new Intl.DateTimeFormat("en-US",Object.assign(Object.assign({},In),{timeZone:e})).formatToParts(t)}catch(e){return Rn(t)}const i=e=>{var t,i;return parseInt(null!==(i=null===(t=s.find(t=>t.type===e))||void 0===t?void 0:t.value)&&void 0!==i?i:"0",10)},a=i("hour")%24;return new Date(Date.UTC(i("year"),i("month")-1,i("day"),a,i("minute"),i("second")))}function Rn(e){return new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours(),e.getMinutes(),e.getSeconds()))}function Ln(e){return 60*e.getUTCHours()+e.getUTCMinutes()}function Pn(e,t){if("number"!=typeof(null==e?void 0:e.latitude)||"number"!=typeof(null==e?void 0:e.longitude))return;const{latitude:s,longitude:i,time_zone:a}=e;return e=>function(e,t,s,i,a){const n=Nn(i,a),o=new Date(Date.UTC(n.getUTCFullYear(),n.getUTCMonth(),n.getUTCDate())),r=function(e,t,s,i,a=1){const n=i.getTime(),o=n+864e5*a;let r=n,l=On(e,t,i);for(;r<o;){r+=Mn;const i=On(e,t,new Date(r));if(Dn(l,i,s))return Hn(e,t,s,r-Mn,r);l=i}return null}(e,t,En(s),function(e,t){let s=e.getTime();for(let i=0;i<2;i++){const i=Nn(t,new Date(s)).getTime()-s;s=e.getTime()-i}return new Date(s)}(o,i));return null===r?null:Ln(Nn(i,r))}(s,i,e,a,t)}const Bn=1440,Un=44,jn=260;function Fn(e){return(e%Bn+Bn)%Bn}function Wn(e){const t=Math.round(Fn(e)),s=Math.floor(t/60),i=t%60;return`${String(s).padStart(2,"0")}:${String(i).padStart(2,"0")}`}function Zn(e){const t=Math.floor(e/60),s=Math.round(e%60);return t?`${t}h ${s}m`:`${s}m`}function qn(e,t){const s=t/Bn*2*Math.PI+Math.PI/2;return[66+e*Math.cos(s),66+e*Math.sin(s)]}function Gn(e,t,s){const i=s-t>=Bn?t+Bn-.5:s,[a,n]=qn(e,t),[o,r]=qn(e,i),l=i-t>720?1:0;return`M ${a.toFixed(2)} ${n.toFixed(2)} A ${e} ${e} 0 ${l} 1 ${o.toFixed(2)} ${r.toFixed(2)}`}function Kn(e,t,s,i,a){const n=2*Math.PI*e/Bn,o=[[0,s]];for(let e=0;e<=10;e++){const t=Math.PI/2+e/10*(Math.PI/2);o.push([i*Math.cos(t),s-i+i*Math.sin(t)])}for(let e=0;e<=10;e++){const t=Math.PI+e/10*(Math.PI/2);o.push([i*Math.cos(t),i*Math.sin(t)-3.2])}return o.push([0,-s]),o.map(([s,i],o)=>{const[r,l]=qn(e+i,(e=>t-a*e/n)(s));return`${o?"L":"M"} ${r.toFixed(2)} ${l.toFixed(2)}`}).join(" ")+" Z"}function Vn(e,t,s,i,a){const n=(t-e)/48,o=[];for(let r=0;r<48;r++){const l=e+r*n,d=l+n/2;let c=1;s>0&&(c=Math.min(c,(d-e)/s)),i>0&&(c=Math.min(c,(t-d)/i)),c=Math.max(0,Math.min(1,c)),o.push({d:Gn(a,l,l+1.25*n),opacity:c})}return o}function Yn(e){const[t,s]=e.split(":").map(e=>parseInt(e,10));return 60*(t||0)+(s||0)}function Xn(e,t,s,i){var a,n,o,r;switch(e.mode){case ns:return Fn(Yn(null!==(a=e.time)&&void 0!==a?a:"06:00"));case os:return Fn(t+(null!==(n=e.offset)&&void 0!==n?n:0));case rs:return Fn(s+(null!==(o=e.offset)&&void 0!==o?o:0));case ls:{if(!i)return null;const t=i(null!==(r=e.azimuth)&&void 0!==r?r:wn);return null===t?null:Fn(t)}default:return null}}function Jn(e,t){return{wraps:!1,arc:Gn(Un,e,t),capStart:Kn(Un,e,5,1.8,-1),capEnd:Kn(Un,t,5,1.8,1)}}function Qn(e){const{rows:t,recurrence:s,intervalHours:i,intervalStartTime:a,nominalDemandMinutes:n,sunriseMinutes:o,sunsetMinutes:r,azimuthResolver:l}=e,d=Gn(Un,0,Bn),c=[0,360,720,1080].map(e=>{const[t,s]=qn(38,e),[i,a]=qn(50,e);return{x1:t,y1:s,x2:i,y2:a}}),[h,u]=qn(57,o),[p,g]=qn(57,r);if(s===ss){const{runs:e,overlaps:t,wrapAt:s}=function(e,t,s){const i=60*Math.max(1,Number(t)||24),a=s?Yn(s):0,n=[];for(let t=a;t<a+Bn&&n.length<24;t+=i)n.push([t,t+e]);const o=[];for(let e=0;e+1<n.length;e++)n[e][1]>n[e+1][0]&&o.push([n[e+1][0],Math.min(n[e][1],n[e+1][1])]);return{runs:n,overlaps:o,wrapAt:a+Bn}}(n,i,a),l=e.map(([e,t])=>{if(t<=s)return Jn(e,t);const i=s-8,a=i-e,n=Math.min(a,120);return{wraps:!0,capStart:Kn(Un,e,5,1.8,-1),fade:Vn(e,i,0,n,Un)}});return{trackPath:d,windowArc:null,dottedPath:null,runs:l,overlaps:t.map(([e,t])=>({d:Gn(Un,e,t),fromMinutes:e,toMinutes:t})),ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:e.map(([e,t])=>{const[s,i]=qn(57,(e+t)/2);return{x:s,y:i,fromMinutes:e,toMinutes:t}}),centre:{kind:"interval",perDay:e.length,intervalHours:Math.max(1,Number(i)||24)}}}const m=Xn(t.start,o,r,l);let v=Xn(t.finish,o,r,l);null!==m&&null!==v&&v<=m&&(v+=Bn);if(null===m&&null===v)return{trackPath:d,windowArc:null,dottedPath:null,runs:[],overlaps:[],ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:[],centre:{kind:"invalid"}};const f=null!==m&&null!==v?v-m:null;let _,b,y=0;if(null!==m&&null!==v){const e=f;b=Math.min(n,e),y=Math.max(0,n-e),_=t.anchor===hs?v-b:m}else null!==m?(_=m,b=n):(b=n,_=v-b);const w=_+b;let $=null!=m?m:_,x=null!=v?v:w,k=0,z=0;null===m&&($=_-jn,k=jn),null===v&&(x=w+jn,z=jn);const S=null!==f&&f<60,A=null===m||null===v?{kind:"faded",segments:Vn($,x,k,z,Un)}:{kind:"solid",d:Gn(Un,$,S?$+60:x)},C=y>1?Gn(Un,_-y,_):null,[E,T]=qn(57,(_+w)/2),O=null===f?{kind:"run",minutes:b}:{kind:"window",minutes:f};return{trackPath:d,windowArc:A,dottedPath:C,runs:[Jn(_,w)],overlaps:[],ticks:c,sun:{x:h,y:u,minutes:o},moon:{x:p,y:g,minutes:r},drops:[{x:E,y:T,fromMinutes:_,toMinutes:w}],centre:O}}const eo=q`<circle cx="12" cy="12" r="4.4" />
  ${Array.from({length:8},(e,t)=>{const s=t*Math.PI/4,i=(12+6.6*Math.cos(s)).toFixed(1),a=(12+6.6*Math.sin(s)).toFixed(1),n=(12+9.2*Math.cos(s)).toFixed(1),o=(12+9.2*Math.sin(s)).toFixed(1);return q`<line x1="${i}" y1="${a}" x2="${n}" y2="${o}" />`})}`,to=q`<path d="M13.5,2.5A9.5,9.5 0 1,0 21.5,14 7.6,7.6 0 0,1 13.5,2.5Z" />`,so=q`<path d="M12,2.6C12,2.6 18.6,9.4 18.6,13.7A6.6,6.6 0 0,1 5.4,13.7C5.4,9.4 12,2.6 12,2.6Z" />`;let io=class extends ce{constructor(){super(...arguments),this.recurrence="daily",this.nominalDemandSeconds=0}_sunTimes(){var e,t,s,i,a,n;const o=null===(t=null===(e=this.hass)||void 0===e?void 0:e.states)||void 0===t?void 0:t["sun.sun"],r=null===(s=null==o?void 0:o.attributes)||void 0===s?void 0:s.next_rising,l=null===(i=null==o?void 0:o.attributes)||void 0===i?void 0:i.next_setting,d=null===(n=null===(a=this.hass)||void 0===a?void 0:a.config)||void 0===n?void 0:n.time_zone,c=(e,t)=>{if(!e)return t;const s=new Date(e);return isNaN(s.getTime())?t:Ln(Nn(d,s))};return{sunrise:c(r,360),sunset:c(l,1200)}}_azimuthResolver(){var e;return Pn(null===(e=this.hass)||void 0===e?void 0:e.config,new Date)}_renderRun(e,t){return e.wraps?q`
    ...
    `:q`
      ...
      `}_t(e,t,s){return Ha(`panels.schedules.dial.${e}`,t,"{from}",Wn(s.fromMinutes),"{to}",Wn(s.toMinutes))}_note(e,t){var s;const i=this.nominalDemandSeconds/60;if(!i)return Z``;if("interval"===e.centre.kind){const s=e.overlaps.length>0;return Z`
        <div class="d-note ${s?"warn":""}">
          ${s?Ha("panels.schedules.dial.collision_note",t):Ha("panels.schedules.dial.runs_of",t,"{count}",e.runs.length,"{duration}",Zn(i))}
        </div>
      `}if("window"!==e.centre.kind)return Z``;const a=i-(null!==(s=e.centre.minutes)&&void 0!==s?s:0);return a<=1?Z``:Z`
      <div class="d-note warn">
        ${Ha("panels.schedules.dial.shortfall",t,"{duration}",Zn(a))}
      </div>
    `}_centreText(e,t){var s,i;const a=e.centre;switch(a.kind){case"invalid":return{val:"—",lbl:""};case"interval":return{val:Ha("panels.schedules.dial.every_hours",t,"{hours}",a.intervalHours),lbl:Ha("panels.schedules.dial.per_day",t,"{count}",a.perDay)};case"run":return{val:Zn(null!==(s=a.minutes)&&void 0!==s?s:0),lbl:Ha("panels.schedules.dial.run_label",t)};default:return{val:Zn(null!==(i=a.minutes)&&void 0!==i?i:0),lbl:Ha("panels.schedules.dial.window_label",t)}}}render(){if(!this.hass||!this.rows)return Z``;const e=this.hass.language,{sunrise:t,sunset:s}=this._sunTimes(),i=Qn({rows:this.rows,recurrence:this.recurrence,intervalHours:this.intervalHours,intervalStartTime:this.intervalStartTime,nominalDemandMinutes:this.nominalDemandSeconds/60,sunriseMinutes:t,sunsetMinutes:s,azimuthResolver:this._azimuthResolver()}),{val:a,lbl:n}=this._centreText(i,e),o=Ha("panels.schedules.dial.sunrise",e,"{time}",Wn(i.sun.minutes)),r=Ha("panels.schedules.dial.sunset",e,"{time}",Wn(i.moon.minutes));return Z`
      <div class="viz-dial">
        <div class="d-wrap">
          <svg
            viewBox="0 0 132 132"
            role="img"
            aria-label="${Ha("panels.schedules.dial.aria_label",e)}"
          >
    ...
    `}};t([me({attribute:!1})],io.prototype,"hass",void 0),t([me({attribute:!1})],io.prototype,"rows",void 0),t([me({attribute:!1})],io.prototype,"recurrence",void 0),t([me({attribute:!1})],io.prototype,"intervalHours",void 0),t([me({attribute:!1})],io.prototype,"intervalStartTime",void 0),t([me({attribute:!1})],io.prototype,"nominalDemandSeconds",void 0),io=t([ue("si-run-window-dial")],io);const ao=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"];function no(){return{name:"",recurrence:"daily",enabled:!0,start_mode:ns,start_time:"06:00",finish_mode:as,action:"irrigate",zones:"all"}}function oo(e,t){return Ha(`panels.schedules.types.${e}`,t)||e}let ro=class extends ce{constructor(){super(...arguments),this.zones=[],this.heading="",this._save=()=>{this.dispatchEvent(new CustomEvent("save",{detail:{value:this.schedule},bubbles:!0,composed:!0}))},this._cancel=()=>{this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}}_emitChanged(e){this.dispatchEvent(new CustomEvent("schedule-changed",{detail:{value:Object.assign(Object.assign({},this.schedule),e)},bubbles:!0,composed:!0}))}_renderZonePicker(){const e="all"===this.schedule.zones||!Array.isArray(this.schedule.zones),t=e?[]:this.schedule.zones.map(String);return Z`
      <div class="field">
        <div class="switch-container">
          ...
          />
          <label for="zones_all"
            >${Ha("panels.schedules.zones_all",this.hass.language)}</label
          >
          <input
            type="radio"
            id="zones_specific"
          ...
          <label for="zones_specific"
            >${Ha("panels.schedules.zones_specific",this.hass.language)}</label
          >
        </div>
        ${e?"":Z`
    ...
    `}_renderRecurrenceFields(){const e=this.schedule,t=this.hass.language;switch(e.recurrence){case"weekly":return Z`
        ...
        `;case"monthly":return Z`
          <div class="field">
            <label
              >${Ha("panels.schedules.fields.day_of_month",t)}</label
            >
            <input
              type="number"
              min="1"
        ...
        `;case"interval":return Z`
          <div class="field field-inline">
            <label
              >${Ha("panels.schedules.fields.interval_hours",t)}</label
            >
            <input
              type="number"
              min="1"
            ...
            />
            <span class="suffix"
              >${Ha("panels.schedules.hours",t)}</span
            >
          </div>
          <div class="field field-inline">
            <label
              >${Ha("panels.schedules.fields.start_time",t)}</label
            >
            <input
              type="time"
              .value="${e.start_time||""}"
            ...
            <span class="field-help"
              >${Ha("panels.schedules.help.interval_start",t)}</span
            >
          </div>
        `;default:return Z``}}_renderRowStepper(e,t){var s,i,a;const n=this.hass.language;switch(e.mode){case ns:return Z`
          <input
            type="time"
            .value="${null!==(s=e.time)&&void 0!==s?s:"06:00"}"
            @change=${s=>t(Object.assign(Object.assign({},e),{time:s.target.value}))}
          />
        `;case os:case rs:return Z`
          <span class="row-inline"
            >${Ha("panels.schedules.fields.offset_by",n)}</span
          >
          <input
            type="number"
            step="1"
          ...
          />
          <span class="row-inline"
            >${Ha("panels.schedules.minutes",n)}</span
          >
        `;case ls:return Z`
          <input
            type="number"
            step="1"
            .value="${String(null!==(a=e.azimuth)&&void 0!==a?a:wn)}"
            @input=${s=>{var i;const a=parseInt(s.target.value);t(Object.assign(Object.assign({},e),{azimuth:isNaN(a)?null!==(i=e.azimuth)&&void 0!==i?i:wn:(a%360+360)%360}))}}
          />
          <span class="row-inline">°</span>
        `;default:return Z``}}_renderWindowRow(e,t,s,i){const a=this.hass.language;return Z`
      <div class="field">
        <label>${Ha(`panels.schedules.fields.${e}_mode`,a)}</label>
        <div class="rowfields">
          <select
            @change=${e=>i($n(e.target.value))}
          >
            ${ds.map(e=>Z`
                <option value="${e}" ?selected="${t.mode===e}">
                  ${Ha(`panels.schedules.bound_mode.${e}`,a)}
                </option>
              `)}
          </select>
        ...
        <span
          ...
          >${Ha(`panels.schedules.help.${s}`,a)}</span
        >
      </div>
    `;var n}_renderAnchorRow(e,t){const s=this.hass.language;return Z`
      <div class="field">
        <div class="rowfields">
          <span class="row-inline"
            >${Ha("panels.schedules.fields.anchor_prefix",s)}</span
          >
          <select
          ...
          >
            ${[cs,hs].map(t=>Z`
                <option value="${t}" ?selected="${e.anchor===t}">
                  ${Ha(`panels.schedules.anchor.${t}`,s)}
                </option>
              `)}
          </select>
          <span class="row-inline"
            >${Ha("panels.schedules.fields.anchor_suffix",s)}</span
          >
        </div>
      </div>
    `}_unresolvableEnds(e){var t;const s=Pn(null===(t=this.hass)||void 0===t?void 0:t.config,new Date);if(!s)return{};const i=e=>{var t;return e.mode===ls&&null===s(null!==(t=e.azimuth)&&void 0!==t?t:wn)};return{start:i(e.start),finish:i(e.finish)}}_renderWindowRows(){const e=this.schedule;if(e.recurrence===ss)return Z``;const t=zn(e),s=Sn(t,this._unresolvableEnds(t)),i=e=>this._emitChanged(function(e){const t=kn(e.start),s=kn(e.finish);return{start_mode:t.mode,start_time:t.time,start_offset:t.offset,start_azimuth:t.azimuth,finish_mode:s.mode,finish_time:s.time,finish_offset:s.offset,finish_azimuth:s.azimuth,anchor:e.anchor}}(e)),a=t.start.mode!==as&&t.finish.mode!==as;return Z`
    ...
    `}_canSave(){const e=this.schedule;return e.recurrence===ss||Sn(zn(e)).valid}_renderSection(e,t){return Z`
      <div class="sect-card">
        <h4>
          ${Ha(`panels.schedules.sections.${e}`,this.hass.language)}
        </h4>
        ${t}
      </div>
    `}_renderSummary(){const e=An(this.schedule,this.hass.language);return Z`
    ...
    `}_renderSeasonSection(){const e=this.schedule,t=this.hass.language;return Z`
      <div class="field">
        <div class="rowfields">
          ...
          />
          <span class="suffix"
            >${Ha("panels.schedules.season.to",t)}</span
          >
          <input
            type="date"
            .value="${e.end_date||""}"
        ...
        <span class="field-help"
          >${Ha("panels.schedules.season.note",t)}</span
        >
      </div>
    `}render(){var e;if(!this.hass||!this.schedule)return Z``;const t=this.schedule,s=this.hass.language;return Z`
      ...
      <ha-dialog open heading="${this.heading}" @closed=${this._cancel}>
        <div class="dialog-content">
          ...
          <div class="field">
            <label>${Ha("panels.schedules.fields.name",s)}</label>
            <input
              type="text"
              .value="${t.name}"
          ...
          ${this._renderSection("when",Z`
              <div class="field">
                <select
                  ...
                  aria-label="${Ha("panels.schedules.fields.recurrence",s)}"
              ...
              ${t.recurrence===ss?Z``:this._renderRecurrenceFields()}
              <div class="when-row">
                <div class="when-rows-col">
                  ${t.recurrence===ss?this._renderRecurrenceFields():Z``}
        ...
        <label slot="secondaryAction" class="enabled-toggle">
          ...
          ></ha-switch>
          <span>${Ha("panels.schedules.fields.enabled",s)}</span>
        </label>
        <div slot="primaryAction" class="dialog-buttons">
          ...
          <button
            ...
            @click=${this._save}
          >
            ${Ha("common.actions.save",this.hass.language)}
          </button>
        </div>
      </ha-dialog>
    `}static get styles(){return[Xa,r`
      ...
      `]}};t([me({attribute:!1})],ro.prototype,"hass",void 0),t([me({attribute:!1})],ro.prototype,"schedule",void 0),t([me({attribute:!1})],ro.prototype,"zones",void 0),t([me({attribute:!1})],ro.prototype,"heading",void 0),ro=t([ue("si-schedule-dialog")],ro);let lo=class extends(qa(ce)){constructor(){super(...arguments),this._schedules=[],this._zones=[],this._isLoading=!0,this._showDialog=!1,this._editingSchedule=no(),this._editingId=null}hassSubscribe(){return this._load(),[this.hass.connection.subscribeMessage(()=>this._load(),{type:be+"_config_updated"})]}async _load(){var e;if(this.hass)try{const[t,s]=await Promise.all([(e=this.hass,e.callWS({type:be+"/schedules"})),Ds(this.hass)]);this._schedules=t||[],this._zones=s||[]}catch(e){console.error("Failed to load schedules",e),Fa(this,this.hass,"common.errors.load_failed",e)}finally{this._isLoading=!1}}_openAdd(){this._editingSchedule=no(),this._editingId=null,this._showDialog=!0,this._refreshNominalDemand()}_openEdit(e){var t;this._editingSchedule=Object.assign({},e),this._editingId=null!==(t=e.id)&&void 0!==t?t:null,this._showDialog=!0}_closeDialog(){this._showDialog=!1}async _save(){const e=Object.assign({},this._editingSchedule);this._editingId&&(e.id=this._editingId);try{const t=await Bs(this.hass,e);if(t&&!1===t.success)throw new Error(t.error||"");this._closeDialog(),await this._load()}catch(e){console.error("Failed to save schedule",e),Fa(this,this.hass,"common.errors.save_failed",e)}}async _delete(e){try{await(t=this.hass,s=e,t.callWS({type:be+"/schedule_delete",schedule_id:s})),await this._load()}catch(e){console.error("Failed to delete schedule",e),Fa(this,this.hass,"common.errors.delete_failed",e)}var t,s}_onScheduleChanged(e){const t=this._editingSchedule.zones;this._editingSchedule=e.detail.value,JSON.stringify(t)!==JSON.stringify(this._editingSchedule.zones)&&this._refreshNominalDemand()}async _refreshNominalDemand(){const e=this._editingSchedule.zones;try{const{nominal_demand_seconds:t}=await((e,t)=>e.callWS({type:be+"/schedule_nominal_demand",zones:t}))(this.hass,"all"===e?"all":e);this._showDialog&&JSON.stringify(this._editingSchedule.zones)===JSON.stringify(e)&&(this._editingSchedule=Object.assign(Object.assign({},this._editingSchedule),{nominal_demand_seconds:t}))}catch(e){console.error("Failed to fetch nominal demand",e)}}_zonesLabel(e){if("all"===e)return Ha("panels.schedules.zones_all",this.hass.language);if(Array.isArray(e)){const t=e.map(e=>{const t=this._zones.find(t=>String(t.id)===String(e));return t?t.name:e}).join(", ");return t||e.join(", ")}return String(e)}_dialogTitle(){return this._editingId?Ha("panels.schedules.dialog.edit_title",this.hass.language):Ha("panels.schedules.dialog.add_title",this.hass.language)}render(){return this.hass?this._isLoading?Z`
        <ha-card
          header="${Ha("panels.schedules.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Ha("common.loading",this.hass.language)}...
          </div>
        </ha-card>
      `:Z`
      ${this._showDialog?Z`
      ...
      >
        <div class="card-content">
          ${Ha("panels.schedules.description",this.hass.language)}
        </div>
        <div class="card-content">
          <button class="add-btn" @click=${this._openAdd}>
            ...
            ${Ha("panels.schedules.add",this.hass.language)}
          </button>
        </div>
      </ha-card>
      ...
      ${0===this._schedules.length?Z`
            <ha-card>
              <div class="card-content">
                ${Ha("panels.schedules.no_items",this.hass.language)}
              </div>
            </ha-card>
          `:this._schedules.map(e=>Z`
              <ha-card header="${e.name}">
                <div class="card-content">
                  <div class="summary">
                    ${An(e,this.hass.language).text}
                  </div>
                  <div class="info-row">
                    <span class="info-label"
                      >${Ha("panels.schedules.fields.recurrence",this.hass.language)}:</span
                    >
                    <span
                      >${oo(e.recurrence,this.hass.language)}</span
                    >
                  </div>
                  ${"interval"!==e.recurrence&&"time"===e.start_mode&&e.start_time?Z`
                        <div class="info-row">
                          <span class="info-label"
                            >${Ha("panels.schedules.fields.start_time",this.hass.language)}:</span
                          >
                  ...
                  ${"interval"!==e.recurrence&&"time"===e.finish_mode&&e.finish_time?Z`
                        <div class="info-row">
                          <span class="info-label"
                            >${Ha("panels.schedules.fields.finish_time",this.hass.language)}:</span
                          >
                  ...
                  ${e.interval_hours?Z`
                        <div class="info-row">
                          <span class="info-label"
                            >${Ha("panels.schedules.fields.interval_hours",this.hass.language)}:</span
                          >
                          <span
                            >${e.interval_hours}
                            ${Ha("panels.schedules.hours",this.hass.language)}</span
                          >
                        </div>
                      `:""}
                  ...
                  <div class="info-row">
                    <span class="info-label"
                      >${Ha("panels.schedules.fields.zones",this.hass.language)}:</span
                    >
                    <span>${this._zonesLabel(e.zones)}</span>
                  </div>
                  <div class="info-row">
                    <span class="info-label"
                      >${Ha("panels.schedules.fields.enabled",this.hass.language)}:</span
                    >
                    <span
                      >${e.enabled?Ha("common.labels.yes",this.hass.language):Ha("common.labels.no",this.hass.language)}</span
                    >
                  </div>
                </div>
                <div class="card-content action-buttons">
                  <div class="action-buttons-left">
                    ...
                    >
                      ...
                      <span class="action-button-label"
                        >${Ha("common.actions.edit",this.hass.language)}</span
                      >
                    </div>
                  </div>
                  <div class="action-buttons-right">
                    ...
                    >
                      <span class="action-button-label"
                        >${Ha("common.actions.delete",this.hass.language)}</span
                      >
                      <svg style="width:20px;height:20px" viewBox="0 0 24 24">
    ...
    `:Z``}static get styles(){return[Xa,r`
      ...
      `]}};t([me({attribute:!1})],lo.prototype,"hass",void 0),t([ve()],lo.prototype,"_schedules",void 0),t([ve()],lo.prototype,"_zones",void 0),t([ve()],lo.prototype,"_isLoading",void 0),t([ve()],lo.prototype,"_showDialog",void 0),t([ve()],lo.prototype,"_editingSchedule",void 0),t([ve()],lo.prototype,"_editingId",void 0),lo=t([ue("smart-irrigation-view-schedules")],lo);let co=class extends(qa(ce)){constructor(){super(...arguments),this._forecast=null,this._mappings=[],this._records=new Map,this._loading=!0,this._metric=!0,this._climate=[]}hassSubscribe(){return this._fetch(),[this.hass.connection.subscribeMessage(()=>this._fetch(),{type:be+"_config_updated"})]}async _fetch(){var e,t;if(this.hass)try{const[s,i,a,n]=await Promise.all([(t=this.hass,t.callWS({type:be+"/weather_forecast"})),Rs(this.hass),Ts(this.hass),Ps(this.hass)]);this._forecast=s,this._mappings=i||[],this._metric=(null==a?void 0:a.units)!==De;const o=n?Object.values(n):[];this._climate=o.length>0&&(null===(e=o[0])||void 0===e?void 0:e.monthly_estimates)||[];const r=new Map;await Promise.all(this._mappings.map(async e=>{if(void 0!==e.id)try{r.set(e.id,await((e,t,s=10)=>e.callWS({type:be+"/weather_records",mapping_id:t,limit:s}))(this.hass,e.id.toString(),0)||[])}catch(e){}})),this._records=r}catch(e){console.error("Failed to fetch weather data",e)}finally{this._loading=!1}}render(){return this.hass?Z`${this._renderForecast()} ${this._renderRecords()}
    ${this._renderSeasonal()}`:Z``}_renderSeasonal(){if(!this.hass)return Z``;const e=this.hass.language;return Z`
      <ha-card
        header="${Ha("panels.setup.weather_data.seasonal_title",e)}"
      >
        <div class="card-content">
          ${0===this._climate.length?Z`<div class="weather-note">
                ${Ha("panels.zones.calendar.no_data",e)}
              </div>`:Z`
                <div class="seasonal-table">
                  <div class="weather-header">
                    <span
                      >${Ha("panels.zones.calendar.month",e)}</span
                    >
                    <span>${Ha("panels.zones.calendar.et",e)}</span>
                    <span
                      >${Ha("panels.zones.calendar.precipitation",e)}</span
                    >
                    <span
                      >${Ha("panels.zones.calendar.avg_temp",e)}</span
                    >
                  </div>
    ...
    `}_renderForecast(){if(!this.hass)return Z``;const e=this.hass.language,t=this._forecast;return Z`
      <ha-card
        header="${Ha("panels.setup.weather_data.forecast_title",e)}"
      >
        <div class="card-content">
          ${t&&t.available&&0!==t.days.length?Z`
              ...
              `:Z`<div class="weather-note">
                ${Ha("panels.setup.weather_data.forecast_none",e)}
              </div>`}
        </div>
      </ha-card>
    ...
    `}_renderRecords(){if(!this.hass)return Z``;const e=this.hass.language;return this._loading&&0===this._mappings.length?Z`<ha-card
        header="${Ha("panels.mappings.weather-records.title",e)}"
      >
        <div class="card-content">
          <div class="loading-indicator">
            ${Ha("common.loading-messages.general",e)}
          </div>
        </div>
      ...
      <ha-card header="${i}">
        <div class="card-content">
          ${0===s.length?Z`<div class="weather-note">
                ${Ha("panels.mappings.weather-records.no-data",t)}
              </div>`:Z`
                <div class="weather-table">
                  <div class="weather-header">
                    <span
                      >${Ha("panels.mappings.weather-records.timestamp",t)}</span
                    >
                    <span
                      >${Ha("panels.mappings.weather-records.temperature",t)}</span
                    >
                    <span
                      >${Ha("panels.mappings.weather-records.humidity",t)}</span
                    >
                    <span
                      >${Ha("panels.mappings.weather-records.dewpoint",t)}</span
                    >
                    <span
                      >${Ha("panels.mappings.weather-records.wind",t)}</span
                    >
                    <span
                      >${Ha("panels.mappings.weather-records.pressure",t)}</span
                    >
                    <span
                      >${Ha("panels.mappings.weather-records.precipitation",t)}</span
                    >
                    <span
                      >${Ha("panels.mappings.weather-records.retrieval-time",t)}</span
                    >
                  </div>
                  ${s.map(e=>Z`
                      <div class="weather-row">
    ...
    `:Z`<div class="loading-indicator">
      ...
      <ha-card header="${Ha(`${e}.title`,this.hass.language)}">
        <div class="card-content description-text">
          ${Ha(`${e}.description`,this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${Ha(`${e}.label`,this.hass.language)}</label>
            <ha-switch
              .checked="${t}"
          ...
          ${t?Z`<div class="setting-row">
                <label>
                  ${Ha(`${e}.debounce_label`,this.hass.language)}
                </label>
                <input
                  type="number"
                  class="settings-input shortfield"
          ...
          <div class="setting-note">
            ${Ha(`${e}.note`,this.hass.language)}
          </div>
        </div>
      </ha-card>
    `}async _saveDebounce(e){if(!this.hass||!this.config)return;const t=Number.parseInt(e,10);if(Number.isNaN(t)||t<0)await this._fetchData();else{this.config=Object.assign(Object.assign({},this.config),{[ke]:t}),this._saving=!0;try{await Os(this.hass,{[ke]:t})}catch(e){console.error("Error saving sensor debounce:",e),Fa(this,this.hass,"common.errors.save_failed",e),await this._fetchData()}finally{this._saving=!1}}}_renderIntro(){return this.hass?Z`
      <div class="experimental-banner">
        <ha-icon icon="mdi:flask-outline"></ha-icon>
        <div>
          <div class="experimental-banner-title">
            ${Ha("panels.experimental.title",this.hass.language)}
          </div>
          <div class="experimental-banner-text">
            ${Ha("panels.experimental.warning",this.hass.language)}
          </div>
        </div>
      </div>
    `:Z``}_renderToggleCard(e,t,s){if(!this.hass)return Z``;const i=`panels.experimental.${e}`;return Z`
      <ha-card header="${Ha(`${i}.title`,this.hass.language)}">
        <div class="card-content description-text">
          ${Ha(`${i}.description`,this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${Ha(`${i}.label`,this.hass.language)}</label>
            <ha-switch
              .checked="${s}"
              ?disabled="${this._saving}"
    ...
    `}};t([me()],ho.prototype,"narrow",void 0),t([ve()],ho.prototype,"config",void 0),t([ve()],ho.prototype,"_saving",void 0),ho=t([ue("smart-irrigation-view-experimental")],ho);var uo;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.Distributors="distributors",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}(uo||(uo={}));const po={[uo.WeatherLocation]:"panels.setup.tabs.weather_location",[uo.Zones]:"panels.setup.tabs.my_zones",[uo.Distributors]:"panels.setup.tabs.distributors",[uo.WhenToWater]:"panels.setup.tabs.when_to_water",[uo.Advanced]:"panels.setup.tabs.advanced",[uo.Experimental]:"panels.setup.tabs.experimental",[uo.Help]:"panels.help.title"};let go=class extends(qa(ce)){hassSubscribe(){return this._fetchConfig(),[this.hass.connection.subscribeMessage(()=>this._fetchConfig(),{type:be+"_config_updated"})]}async _fetchConfig(){if(this.hass)try{this.config=await Ts(this.hass)}catch(e){console.error("Failed to fetch setup config:",e)}}get _distributorsEnabled(){var e,t;return null!==(t=null===(e=this.config)||void 0===e?void 0:e.distributors_enabled)&&void 0!==t&&t}get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(uo).includes(null!=t?t:"")?t:uo.WeatherLocation}_selectTab(e){Pa(0,Ya("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return Z``;const e=this._distributorsEnabled,t=Object.values(uo).filter(t=>t!==uo.Distributors||e);let s=this._activeTab;return s!==uo.Distributors||e||(s=uo.WeatherLocation),Z`
      <div class="setup-container">
        <nav class="setup-nav">
          ${t.map(e=>Z`
              ...
              >
                ${Ha(po[e],this.hass.language)}
              </button>
            `)}
          <button
            class="setup-nav-btn wizard-btn"
            @click="${this._openWizard}"
            title="${Ha("wizard.title",this.hass.language)}"
          >
            <ha-icon icon="mdi:creation"></ha-icon>
            ${Ha("wizard.open_button",this.hass.language)}
          </button>
        </nav>
        <div class="setup-content">${this._renderContent(s)}</div>
      </div>
    `}_renderContent(e){if(!this.hass)return Z``;switch(e){case uo.WeatherLocation:return Z`
          ...
          <smart-irrigation-view-weather-data
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-weather-data>
        `;case uo.Zones:return Z`<smart-irrigation-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-zone-settings>`;case uo.Distributors:return Z`<smart-irrigation-view-distributor-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-distributor-settings>`;case uo.WhenToWater:return Z`
          <smart-irrigation-view-general
            .hass="${this.hass}"
            .narrow="${this.narrow}"
        ...
        `;case uo.Advanced:return Z`
          ...
          <smart-irrigation-view-mappings
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-mappings>
        `;case uo.Experimental:return Z`<smart-irrigation-view-experimental
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-experimental>`;case uo.Help:return this._renderHelp()}}_renderHelp(){return this.hass?Z`
      <ha-card
        header="${Ha("panels.help.cards.how-to-get-help.title",this.hass.language)}"
      >
        <div class="card-content">
          ${Ha("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)}
          <a href="${"https://justchr.github.io/HAsmartirrigation/"}" target="_blank" rel="noopener noreferrer"
            >${Ha("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
          >.
          ${Ha("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
          <a
            href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
            target="_blank"
            rel="noopener noreferrer"
            >${Ha("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
          >
          ${Ha("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
          <a href="${"https://github.com/JustChr/HAsmartirrigation/issues"}" target="_blank" rel="noopener noreferrer"
            >${Ha("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
          >
          (${Ha("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
        </div>
      </ha-card>
      ...
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          <div class="wizard-header">
            <span class="wizard-title">${Ha("wizard.title",s)}</span>
            <button
              class="wizard-close-btn"
              @click="${this._close}"
              title="${Ha("wizard.close",s)}"
              aria-label="${Ha("wizard.close",s)}"
            >
              <ha-icon icon="mdi:close"></ha-icon>
            </button>
          </div>
          ${this._step!==mo.Welcome&&this._step!==mo.Done?Z`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>mo.Welcome&&this._step<mo.Done?this._confirmClose=!0:this._close())}_renderStepper(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=[Ha("wizard.stepper.weather",s),Ha("wizard.stepper.module",s),Ha("wizard.stepper.mapping",s),Ha("wizard.stepper.zone",s)];return Z`
      ${i.map((e,t)=>{const s=t+1,a=this._step===s,n=this._step>s;return Z`
        ...
        `})}
    `}_renderStep(e){switch(this._step){case mo.Welcome:return this._renderWelcome(e);case mo.Weather:return this._renderWeather(e);case mo.Module:return this._renderModule(e);case mo.Mapping:return this._renderMapping(e);case mo.Zone:return this._renderZone(e);case mo.Done:return this._renderDone(e);default:return Z``}}_renderFooter(e){return this._step===mo.Done?Z``:Z`
      <div class="footer-left">
        ${this._step>mo.Welcome?Z`<button
              class="wizard-btn secondary"
              @click="${this._back}"
              ?disabled="${this._saving}"
            >
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Ha("common.saving-messages.saving",e):this._step===mo.Welcome||this._step<mo.Zone?Ha("wizard.next",e):Ha("wizard.finish",e)}
      </button>
    `}_renderWelcome(e){return Z`
      <h2 class="step-title">
        ${Ha("wizard.steps.welcome.title",e)}
      </h2>
      <p class="step-desc">${Ha("wizard.steps.welcome.intro",e)}</p>
      <ul class="step-list">
        <li>① ${Ha("wizard.steps.welcome.step1_label",e)}</li>
        <li>② ${Ha("wizard.steps.welcome.step2_label",e)}</li>
        <li>③ ${Ha("wizard.steps.welcome.step3_label",e)}</li>
        <li>④ ${Ha("wizard.steps.welcome.step4_label",e)}</li>
      </ul>
      <p class="step-tip">${Ha("wizard.steps.welcome.tip",e)}</p>
    `}_renderWeather(e){return Z`
      <h2 class="step-title">
        ${Ha("wizard.steps.weather.title",e)}
      </h2>
      <p class="step-desc">
        ${Ha("wizard.steps.weather.description",e)}
      </p>
    ...
    `}_renderModule(e){if(0===this._availableModules.length)return Z`
        <h2 class="step-title">
          ${Ha("wizard.steps.module.title",e)}
        </h2>
        <p class="step-desc">
          ${Ha("wizard.steps.module.no_modules",e)}
        </p>
      `;const t=this._availableModules[this._selectedModuleIndex];return Z`
      <h2 class="step-title">${Ha("wizard.steps.module.title",e)}</h2>
      <p class="step-desc">
        ${Ha("wizard.steps.module.description",e)}
      </p>

      <si-field
        label="${Ha("wizard.steps.module.pick_label",e)}"
        required
      >
        <select
          class="wizard-input"
    ...
    `}_renderMapping(e){const t=[{value:Fe,label:Ha("wizard.steps.mapping.use_weather_service",e)},{value:"sensor",label:Ha("wizard.steps.mapping.use_sensor",e)},{value:"static",label:Ha("wizard.steps.mapping.use_static",e)},{value:Ve,label:Ha("wizard.steps.mapping.use_none",e)}],s=(s,i,a)=>Z`
      <si-field
        label="${Ha("wizard.steps.mapping.source_label",e)} ${s}"
      >
        <select
          class="wizard-input"
    ...
    `;return Z`
      <h2 class="step-title">
        ${Ha("wizard.steps.mapping.title",e)}
      </h2>
      <p class="step-desc">
        ${Ha("wizard.steps.mapping.description",e)}
      </p>

      <si-field
        label="${Ha("wizard.steps.mapping.name_label",e)}"
        required
      >
        <input
          type="text"
      ...
      ${s(Ha("panels.mappings.cards.mapping.items.temperature",e)||"Temperature",this._tempSource,e=>{this._tempSource=e,this.requestUpdate()})}
      ${s(Ha("panels.mappings.cards.mapping.items.humidity",e)||"Humidity",this._humiditySource,e=>{this._humiditySource=e,this.requestUpdate()})}
      ${s(Ha("panels.mappings.cards.mapping.items.precipitation",e)||"Precipitation",this._precipSource,e=>{this._precipSource=e,this.requestUpdate()})}

      <p class="step-tip">
        ${Ha("wizard.steps.mapping.description",e)}
      </p>
    `}_renderZone(e){var t;const s="imperial"!==(null===(t=this._siConfig)||void 0===t?void 0:t.units);return Z`
      <h2 class="step-title">${Ha("wizard.steps.zone.title",e)}</h2>
      <p class="step-desc">
        ${Ha("wizard.steps.zone.description",e)}
      </p>
    ...
    `}_renderDone(e){return Z`
      <div class="done-wrapper">
        ...
        <h2 class="step-title">${Ha("wizard.steps.done.title",e)}</h2>
        <p class="step-desc">
          ${Ha("wizard.steps.done.description",e)}
        </p>
        <ul class="step-list">
          <li>${Ha("wizard.steps.done.tip1",e)}</li>
          <li>${Ha("wizard.steps.done.tip2",e)}</li>
          <li>${Ha("wizard.steps.done.tip3",e)}</li>
        </ul>
        ...
        <div class="schedule-offer">
          ${this._scheduleCreated?Z`
                <div class="schedule-created">
                  ...
                  <span
                    >${Ha("wizard.steps.done.schedule_created",e)}</span
                  >
                </div>
              `:Z`
                <p class="schedule-offer-title">
                  ${Ha("wizard.steps.done.schedule_title",e)}
                </p>
                <p class="schedule-offer-desc">
                  ${Ha("wizard.steps.done.schedule_desc",e)}
                </p>
                <div class="schedule-offer-row">
                  ...
                  >
                    ${this._creatingSchedule?Ha("common.saving-messages.saving",e):Ha("wizard.steps.done.schedule_create",e)}
                  </button>
                </div>
              `}
        </div>
        ...
        <div class="done-actions">
          ...
          >
            ${Ha("wizard.steps.done.go_zones",e)}
          </button>
          <button
            class="wizard-btn secondary"
            @click="${()=>{this._close(),this._navigate("setup")}}"
          >
            ${Ha("wizard.steps.done.go_setup",e)}
          </button>
        </div>
      </div>
    `}static get styles(){return r`
    ...
    `}};t([me({attribute:!1})],vo.prototype,"hass",void 0),t([ve()],vo.prototype,"_step",void 0),t([ve()],vo.prototype,"_saving",void 0),t([ve()],vo.prototype,"_error",void 0),t([ve()],vo.prototype,"_confirmClose",void 0),t([ve()],vo.prototype,"_siConfig",void 0),t([ve()],vo.prototype,"_useWeather",void 0),t([ve()],vo.prototype,"_weatherService",void 0),t([ve()],vo.prototype,"_apiKey",void 0),t([ve()],vo.prototype,"_weatherConfig",void 0),t([ve()],vo.prototype,"_availableModules",void 0),t([ve()],vo.prototype,"_selectedModuleIndex",void 0),t([ve()],vo.prototype,"_moduleConfig",void 0),t([ve()],vo.prototype,"_mappingName",void 0),t([ve()],vo.prototype,"_tempSource",void 0),t([ve()],vo.prototype,"_humiditySource",void 0),t([ve()],vo.prototype,"_precipSource",void 0),t([ve()],vo.prototype,"_zoneName",void 0),t([ve()],vo.prototype,"_zoneSize",void 0),t([ve()],vo.prototype,"_zoneThroughput",void 0),t([ve()],vo.prototype,"_zoneEntity",void 0),t([ve()],vo.prototype,"_scheduleTime",void 0),t([ve()],vo.prototype,"_scheduleCreated",void 0),t([ve()],vo.prototype,"_creatingSchedule",void 0),vo=t([ue("si-setup-wizard")],vo);const fo=Xa;var _o;!function(e){e.Zones="zones",e.Setup="setup"}(_o||(_o={})),e.SmartIrrigationPanel=class extends ce{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}async firstUpdated(){const e=Va().page;Object.values(_o).includes(e)||Pa(0,Ya(_o.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())}),Ks().then(()=>{this._scheduleUpdate()}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}),this.hass&&Ts(this.hass).then(e=>{this._config=e,this._scheduleUpdate()}).catch(e=>{console.error("Failed to fetch config for version display:",e)})}_ensureLanguage(){this.hass&&!Da(this.hass.language)&&function(e){const t=Oa(e);return Da(e)?Promise.resolve():(Ta[t]||(Ta[t]=fetch(`/smart_irrigation_static/languages/${t}.json?v=${_e}`).then(e=>e.ok?e.json():Promise.reject(e.status)).then(e=>{Ea[t]=e}).catch(()=>{Ea[t]=Ea.en})),Ta[t])}(this.hass.language).then(()=>this.requestUpdate())}render(){var e,t;if(this.hass&&!Da(this.hass.language))return this._ensureLanguage(),Z``;const s=Va(),i=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return Z`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
            .narrow=${this.narrow}
          ></ha-menu-button>
          <div class="main-title">${Ha("title",this.hass.language)}</div>
        ...
        ${i&&a?Z`
              <ha-tab-group @wa-tab-show=${this.handlePageSelected}>
                ${Object.values(_o).map(e=>Z`
                    <ha-tab-group-tab
                      slot="nav"
                      panel="${e}"
                      .active=${s.page===e}
                    >
                      ${Ha(`panels.${e}.title`,this.hass.language)}
                    </ha-tab-group-tab>
                  `)}
              </ha-tab-group>
            `:Z`
    ...
    `}getView(e){switch(e.page){case"zones":default:return Z`
        ...
        `;case"setup":return Z`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0}}"
          ></smart-irrigation-view-setup>
        `}}navigateToPage(e){if(e!==Va().page){const t=Ya(e);Pa(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==Va().page){const e=Ya(t);Pa(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[fo,r`
        :host {
          color: var(--primary-text-color);
    ...
    `}};t([me({attribute:!1})],bo.prototype,"hass",void 0),t([ve()],bo.prototype,"_params",void 0),bo=t([ue("error-dialog")],bo);var yo=Object.freeze({__proto__:null,get ErrorDialog(){return bo}})}({});

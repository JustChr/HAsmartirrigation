...
`;const Ia=e=>String(e).padStart(2,"0");function Na(e){return e instanceof Date?e:new Date(e)}function La(e){const t=Na(e);return`${Ia(t.getHours())}:${Ia(t.getMinutes())}`}function Pa(e){const t=Na(e);return`${t.getFullYear()}-${Ia(t.getMonth()+1)}-${Ia(t.getDate())} ${Ia(t.getHours())}:${Ia(t.getMinutes())}`}function Ra(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class Ba extends(Ca(le)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){Hs().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const s=Object.values(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).some(e=>!0!==e.queued);s&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):s||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[s,i,a,n]=await Promise.all([gs(this.hass),vs(this.hass),(t=this.hass,t.callWS({type:_e+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),zs(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=s,this.zones=i,this._outlook=a,this._distributors=n,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),Sa(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),Sa(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),Sa(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const s="all"===t,i=s?void 0:this.zones.find(e=>{var s;return(null===(s=e.id)||void 0===s?void 0:s.toString())===t}),a=s?`(${this._linkedZoneCount})`:`: ${null!==(e=null==i?void 0:i.name)&&void 0!==e?e:t}`;try{await(n=this.hass,o=s?void 0:t,n.callWS(Object.assign({type:_e+"/irrigate_now"},void 0!==o?{zone_id:o}:{}))),za(this,`${fa("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${a}`)}catch(e){const t=ka(e);console.error("irrigate_now failed",e),za(this,`${fa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var n,o}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const s=new Date(t);return s.getTime()>Date.now()?s:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:_e+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),Sa(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:_e+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),Sa(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,s;const i=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(s=this._runMinutes[i])&&void 0!==s?s:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const s=this._zoneDistributor(e);return!!s&&Object.keys(null!==(t=s.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var s,i,a;if(t>0)try{await(s=this.hass,i=e.id.toString(),a=t,s.callWS({type:_e+"/run_zone",zone_id:i,duration:a})),za(this,`${fa("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=ka(e);console.error("run_zone failed",e),za(this,`${fa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===s?void 0:s[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,s;if(this.hass&&void 0!==e.id)try{await(t=this.hass,s=e.id.toString(),t.callWS({type:_e+"/stop_zone",zone_id:s})),za(this,`${fa("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=ka(e);console.error("stop_zone failed",e),za(this,`${fa("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",_e+"/zones",{id:i,calculate:!0,override_cache:!0})).catch(e=>{const t=ka(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",_e+"/zones",{id:i,update:!0})).catch(e=>{const t=ka(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;xa(0,t?Da("setup","zones",t):Da("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,s,i;const a=null!==(t=e.duration)&&void 0!==t?t:0,n=Number(null!==(s=e.bucket_threshold)&&void 0!==s?s:0),o=this._zoneEstimate(e),r=o&&o.available&&null!=o.live_deficit?o.live_deficit:Number(null!==(i=e.bucket)&&void 0!==i?i:0);return a>0&&r<n}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,s=new Date(e),i=La(s),a=new Date;return Ra(s,a)?`${fa("panels.zones.outlook.today",t)} ${i}`:Ra(s,function(e,t){const s=new Date(e.getTime());return s.setDate(s.getDate()+t),s}(a,1))?`${fa("panels.zones.outlook.tomorrow",t)} ${i}`:function(e,t){const s=Na(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(s)} ${La(s)}`}(s,t)}_guardLabel(e){return fa(`panels.zones.outlook.checks.${e.id}`,this.hass.language)}_guardDetail(e){var t;return e.available&&null!==e.observed?fa(`panels.zones.outlook.check_detail.${e.id}`,this.hass.language,"{observed}",String(e.observed),"{threshold}",String(null!==(t=e.threshold)&&void 0!==t?t:"")):""}_renderSkipReasons(){const e=this.hass.language;return Z`
    ...
    `}_openSchedules(){xa(0,Da("setup","when-to-water"))}_runActionLabel(e){return fa(`panels.zones.outlook.actions.${e.action}`,this.hass.language)}_runTargetsLabel(e){const t=this.hass.language;if("all"===e.zones)return fa("panels.zones.outlook.targets_all",t);const s=Array.isArray(e.zones)?e.zones.length:0;return fa("panels.zones.outlook.targets_zones",t,"{count}",String(s))}_renderOutlookBanner(){if(!this.hass||!this._outlook)return Z``;const e=this.hass.language,t=this._nextIrrigateRun,s=this._triggeredGuards,i=this._outlook.last_skip_evaluation;return t&&t.next_run_utc?Z`
    ...
    `}_renderLastRunLine(e){const t=this.hass.language,s=function(e,t){const s=Na(e).getTime()-Date.now(),i=new Intl.RelativeTimeFormat(t,{numeric:"auto"}),a=Math.round(s/1e3);if(Math.abs(a)<60)return i.format(a,"second");const n=Math.round(a/60);if(Math.abs(n)<60)return i.format(n,"minute");const o=Math.round(n/60);if(Math.abs(o)<24)return i.format(o,"hour");const r=Math.round(o/24);if(Math.abs(r)<30)return i.format(r,"day");const l=Math.round(r/30);return Math.abs(l)<12?i.format(l,"month"):i.format(Math.round(l/12),"year")}(e.timestamp,t),i=e.checks.filter(e=>e.enabled&&e.would_skip).map(e=>this._guardLabel(e).toLowerCase()).join(", "),a=e.would_skip?`${fa("panels.zones.outlook.last_run_skipped",t)}${i?` (${i})`:""}`:fa("panels.zones.outlook.last_run_ran",t);return Z`
    ...
    `}_renderZoneDecision(e){var t;if(!this.hass)return Z``;const s=this.hass.language,i=null!==(t=e.duration)&&void 0!==t?t:0;let a,n,o;if(e.state===Oa.Disabled)a=fa("panels.zones.status.decision_disabled",s),n="neutral",o="mdi:power-off";else if(e.last_calculated)if(this._zoneHasDeficit(e)){const t=function(e){const t=Math.round(e);if(t<60)return`${t} s`;const s=Math.floor(t/60),i=t%60;return i?`${s} min ${i} s`:`${s} min`}(i),r=this._triggeredGuards,l=this._nextIrrigateRunForZone(e);r.length>0?(a=fa("panels.zones.status.decision_water_skip",s,"{duration}",t,"{reason}",this._guardLabel(r[0]).toLowerCase()),n="skip",o="mdi:weather-rainy"):l&&l.next_run_utc?(a=fa("panels.zones.status.decision_water_at",s,"{duration}",t,"{time}",this._formatRunTime(l.next_run_utc)),n="water",o="mdi:water"):(a=fa("panels.zones.status.decision_water_no_schedule",s,"{duration}",t),n="water",o="mdi:water-alert")}else a=fa("panels.zones.status.decision_no_water",s),n="ok",o="mdi:check-circle-outline";else a=fa("panels.zones.status.decision_unknown",s),n="unknown",o="mdi:help-circle-outline";return Z`
      <div class="zone-decision ${n}">
        <ha-icon icon="${o}"></ha-icon>
        <span>${a}</span>
      </div>
    `}_zoneEstimate(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.zone_estimates)||void 0===s?void 0:s[String(e.id)]}_zoneFault(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.zone_faults)||void 0===s?void 0:s[String(e.id)]}_renderZoneFault(e){if(!this.hass)return Z``;const t=this._zoneFault(e);if(!t)return Z``;const s=this.hass.language,i=fa(`panels.zones.fault.${t.reason}`,s)||fa("panels.zones.fault.generic",s),a=t.timestamp?Pa(t.timestamp):"";return Z`
      <div class="zone-fault" title="${a}">
        <ha-icon icon="mdi:alert-circle"></ha-icon>
        <span>
          <strong>${fa("panels.zones.fault.title",s)}</strong>
          — ${i}
        </span>
      </div>
    `}_zoneSkip(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.zone_skips)||void 0===s?void 0:s[String(e.id)]}_renderZoneSkip(e){if(!this.hass)return Z``;const t=this._zoneSkip(e);if(!t)return Z``;const s=this.hass.language,i=fa("panels.zones.skip.soil_moisture",s,"{observed}",String(t.observed),"{threshold}",String(t.threshold)),a=t.timestamp?Pa(t.timestamp):"";return Z`
      <div class="zone-skip" title="${a}">
        <ha-icon icon="mdi:water-off"></ha-icon>
        <span>
          <strong>${fa("panels.zones.skip.title",s)}</strong>
          — ${i}
        </span>
      </div>
    `}_renderZoneEstimate(e){if(!this.hass)return Z``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return Z``;const s=this.hass.language,i=wa(this.config,mt),a=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",n=fa(`panels.zones.status.estimate_method.${"proxy"===t.method||"hourly_sensor"===t.method?t.method:"hourly"}`,s)+(t.as_of?` · ${La(t.as_of)}`:"");return Z`
      <span class="status-sep">·</span>
      <span class="zone-estimate" title="${n}">
        ${fa("panels.zones.status.estimate_now",s)}
        <strong style="color: ${a}"
          >≈ ${t.live_deficit.toFixed(2)} ${i}</strong
        >
        <span class="estimate-tag"
          >${fa("panels.zones.status.estimate_tag",s)}</span
        >
      </span>
    `}_renderZoneNextRun(e){if(!this.hass)return Z``;const t=this._nextIrrigateRunForZone(e);if(!t||!t.next_run_utc)return Z``;return e.state!==Oa.Disabled&&e.last_calculated&&this._zoneHasDeficit(e)&&0===this._triggeredGuards.length?Z``:Z`
      <span class="status-sep">·</span>
      <span>
        ${fa("panels.zones.outlook.next_run",this.hass.language)}:
        <strong>${this._formatRunTime(t.next_run_utc)}</strong>
      </span>
    `}renderZone(e,t){var s;if(!this.hass)return Z``;const i=Number(null!==(s=e.bucket)&&void 0!==s?s:0),a=i<0?"var(--warning-color)":"var(--success-color)",n=e.state===Oa.Automatic?"state-automatic":e.state===Oa.Manual?"state-manual":"state-disabled",o=e.last_calculated?Pa(e.last_calculated):fa("panels.zones.status.never",this.hass.language);return Z`
      <ha-card>
        ...
        <div class="card-content zone-action-bar">
          ${"full"===this.actionsMode&&e.state===Oa.Automatic?Z`
                <button
                  class="action-btn"
    ...
    `}_renderRunZoneControl(e){if(!this.hass||"none"===this.actionsMode||!this._canActuate(e)||void 0===e.id)return Z``;const t=this.hass.language,s=String(e.id),i=this._activeRun(e);if(i){const s=!0===i.queued,a=s?null:this._runSecondsLeft(i);return Z`
        <div class="run-zone-control running ${s?"queued":""}">
          <span class="run-zone-countdown">
            ...
            ></ha-icon>
            ${s?fa("panels.zones.stop_zone.queued",t):null===a?fa("panels.zones.stop_zone.watering",t):this._formatCountdown(a)}
          </span>
          <button
    ...
    `}}t([pe()],Ba.prototype,"config",void 0),t([pe({type:Boolean})],Ba.prototype,"hideSettingsLinks",void 0),t([pe({attribute:!1})],Ba.prototype,"actionsMode",void 0),t([pe({type:Array})],Ba.prototype,"zones",void 0),t([ge()],Ba.prototype,"_outlook",void 0),t([ge()],Ba.prototype,"_distributors",void 0),t([pe({type:Boolean})],Ba.prototype,"isLoading",void 0),t([pe({type:Boolean})],Ba.prototype,"isSaving",void 0),t([ge()],Ba.prototype,"_operationError",void 0),t([ge()],Ba.prototype,"_confirmIrrigate",void 0),t([ge()],Ba.prototype,"_skipDetailsOpen",void 0),t([ge()],Ba.prototype,"_runMinutes",void 0),t([ge()],Ba.prototype,"_now",void 0),customElements.get("smart-irrigation-view-zones")||customElements.define("smart-irrigation-view-zones",Ba)
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */;const Ua={},ja=Ls(class extends Ps{constructor(e){if(super(e),e.type!==Is&&e.type!==Ds&&e.type!==Ns)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===W||t===q)return t;const s=e.element,i=e.name;if(e.type===Is){if(t===s[i])return W}else if(e.type===Ns){if(!!t===s.hasAttribute(i))return W}else if(e.type===Ds&&s.getAttribute(i)===t+"")return W;return((e,t=Ua)=>{e._$AH=t;
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
    ...
    `}_renderKeyField(e){var t;const s=this._hasStoredKey;return Z`
      ...
      >
        <span class="api-badge ${s?"configured":"missing"}"
          >${fa(s?"weather_service_config.api_key_configured":"weather_service_config.api_key_not_configured",e)}</span
        >
        <div class="api-row">
          <input
            type="password"
    ...
    `}};t([pe({attribute:!1})],Za.prototype,"hass",void 0),t([pe({type:Boolean})],Za.prototype,"useWeather",void 0),t([pe()],Za.prototype,"service",void 0),t([pe()],Za.prototype,"apiKey",void 0),t([pe({attribute:!1})],Za.prototype,"weatherConfig",void 0),t([ge()],Za.prototype,"_testing",void 0),t([ge()],Za.prototype,"_testResult",void 0),Za=t([ce("si-weather-source-config")],Za);let Wa=class extends(Ca(le)){constructor(){super(...arguments),this.section="all",this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._weatherConfig=null,this._weatherService=null,this._useWeatherService=!1,this._newApiKey="",this._weatherSaving=!1,this._coords=null,this._coordsEnabled=!1,this._coordsLat="",this._coordsLon="",this._coordsElev="",this._coordsSaving=!1,this._saveStatus="idle",this._savedResetTimer=null,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null,t={};return s=>{t=Object.assign(Object.assign({},t),s),e&&clearTimeout(e),e=window.setTimeout(()=>{const s=t;t={},e=null,this.saveData(s)},500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){var e;if(!this.hass)return;const t=!this._initialLoadDone;t&&(this.isLoading=!0,this._scheduleUpdate());try{const[t,a,n]=await Promise.all([gs(this.hass),As(this.hass),Cs(this.hass)]);this.config=t,this._weatherConfig=a,this._useWeatherService=a.use_weather_service,this._weatherService=null!==(e=a.weather_service)&&void 0!==e?e:xe,this._applyCoordinates(n),this.data=(s=this.config,i=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","days_between_irrigation"],s?Object.entries(s).filter(([e])=>i.includes(e)).reduce((e,[t,s])=>Object.assign(e,{[t]:s}),{}):{}),this._initialLoadDone=!0}catch(e){console.error("Error fetching data:",e),Sa(this,this.hass,"common.errors.load_failed",e)}finally{t&&(this.isLoading=!1),this._scheduleUpdate()}var s,i}firstUpdated(){Hs().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}render(){var e,t;return this.hass&&this.config&&this.data?this.isLoading?Z`<div class="loading-indicator">
        ${fa("common.loading-messages.general",this.hass.language)}
    ...
    `:Z``}async _saveWeatherConfig(){if(this.hass){this._weatherSaving=!0,this._scheduleUpdate();try{await Es(this.hass,this._useWeatherService,this._useWeatherService?this._weatherService:null,this._newApiKey||null),this._newApiKey="",await this._fetchData()}catch(e){console.error("Failed to save weather config:",e),Sa(this,this.hass,"common.errors.save_failed",e)}finally{this._weatherSaving=!1,this._scheduleUpdate()}}}_renderWeatherServiceCard(){var e;return this.hass?Z`
      <ha-card
                ...
                <div class="setting-row">
                  ...
                  <div class="inline-row">
                    ...
                    <select
                      ...
                      .value="${ja(this.data.autoupdateschedule||Se)}"
      ...
      >
        ...
        <div class="card-content">
          ...
          ${this.data.autocalcenabled?Z`
                <div class="setting-row">
                  <label>
                    ${fa("panels.general.cards.automatic-duration-calculation.labels.calc-time",this.hass.language)}
                  </label>
                  <input
                    type="text"
                    class="settings-input shortfield"
      ...
      <ha-card header="${fa("weather_skip.title",this.hass.language)}">
        ...
        <div class="card-content">
          ...
          ${"ignore"!==o?Z`
                ...
                <div class="description-text">
                  ${fa("weather_skip.lookahead_help",n)}
                </div>
              `:""}
          ${"skip"===o?Z`
                <div class="setting-row">
      ...
      >
        ...
        <div class="card-content">
          <div class="setting-row">
            ...
            <select
              class="settings-input"
              .value="${ja(this.config.zone_sequencing||Ut)}"
              @change="${e=>this.handleConfigChange({[Rt]:e.target.value})}"
            >
              <option
                value="${Ut}"
    ...
    `}};t([pe()],Wa.prototype,"narrow",void 0),t([pe()],Wa.prototype,"path",void 0),t([pe()],Wa.prototype,"section",void 0),t([pe()],Wa.prototype,"data",void 0),t([pe()],Wa.prototype,"config",void 0),t([pe({type:Boolean})],Wa.prototype,"isLoading",void 0),t([pe({type:Boolean})],Wa.prototype,"isSaving",void 0),t([pe()],Wa.prototype,"_weatherConfig",void 0),t([pe()],Wa.prototype,"_weatherService",void 0),t([pe({type:Boolean})],Wa.prototype,"_useWeatherService",void 0),t([pe()],Wa.prototype,"_newApiKey",void 0),t([pe({type:Boolean})],Wa.prototype,"_weatherSaving",void 0),t([ge()],Wa.prototype,"_coords",void 0),t([ge()],Wa.prototype,"_coordsEnabled",void 0),t([ge()],Wa.prototype,"_coordsLat",void 0),t([ge()],Wa.prototype,"_coordsLon",void 0),t([ge()],Wa.prototype,"_coordsElev",void 0),t([ge()],Wa.prototype,"_coordsSaving",void 0),t([ge()],Wa.prototype,"_saveStatus",void 0),Wa=t([ce("smart-irrigation-view-general")],Wa);const qa=e=>9*e/5+32;function Ga(e,t,s){if(null==e||Number.isNaN(e))return null;switch(t){case"temperature":return s?{value:e,unit:"°C"}:{value:qa(e),unit:"°F"};case"precipitation":return s?{value:e,unit:st}:{value:(n=e,n/25.4),unit:it};case"windspeed":return s?{value:e,unit:ot}:{value:(a=e,2.2369362920544*a),unit:nt};case"pressure":return s?{value:e,unit:"hPa"}:{value:(i=e,.0295299830714*i),unit:at}}var i,a,n}function Ka(e,t,s,i){const a=Ga(e,t,s);if(!a)return"-";const n=function(e,t){return"pressure"===e?t?0:2:"precipitation"===e?t?1:2:1}(t,s);return`${a.value.toFixed(n)} ${a.unit}`}function Va(e,t){return null==e||Number.isNaN(e)?"-":t?`${e.toFixed(0)} L`:`${(e=>.264172052*e)(e).toFixed(1)} gal`}let Ya=class extends le{constructor(){super(...arguments),this.metric=!0,this.name="",this.size="",this.throughput="",this.linkedEntity="",this.showEntity=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{value:t},bubbles:!0,composed:!0}))}render(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=this.metric?"m²":Je,a=this.metric?Qe:et;return Z`
      <si-field label="${fa("panels.zones.labels.name",s)}" required>
        <input
          type="text"
          class="si-input"
          .value="${this.name}"
      ...
      <si-field
        label="${fa("panels.zones.labels.size",s)}"
        unit="${i}"
        help="${fa("field_help.zone_size",s)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      <si-field
        label="${fa("panels.zones.labels.throughput",s)}"
        unit="${a}"
        help="${fa("field_help.zone_throughput",s)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      ${this.showEntity?Z`
            <si-field
              label="${fa("panels.zones.labels.linked_entity",s)}"
              help="${fa("field_help.zone_linked_entity",s)}"
            >
              <ha-entity-picker
                .hass="${this.hass}"
    ...
    `}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await _s(this.hass,e)}_renderModuleOptions(e){if(!this.hass)return Z``;const t=null!=e?String(e):"";return Z`
    ...
    `}_renderDistributorSelector(e,t){var s,i;if(!this.hass)return Z``;if(!(null===(s=this.config)||void 0===s?void 0:s.distributors_enabled))return Z``;const a=this.hass.language,n=null!=e.distributor_id;return Z`
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${ja(n?String(e.distributor_id):"")}"
             ...
             used to sit alongside it moved to the Weather & Location tab). -->
              <div class="card-content zone-settings">
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${ja(null!==(i=Object.keys(Pt).find(t=>Pt[t]===e.drainage_rate))&&void 0!==i?i:"custom")}"
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${ja(null!==(o=e.plant_type)&&void 0!==o?o:"custom")}"
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${ja(void 0!==e.module?String(e.module):"")}"
                ...
                <ha-settings-row>
                  ...
                  <select
                    class="settings-input"
                    .value="${ja(void 0!==e.mapping?String(e.mapping):"")}"
                ...
                ${null!=e.distributor_id?Z`<div class="distributor-managed">
                      ...
                      <ha-settings-row>
                        ...
                        <select
                          class="settings-input"
                          .value="${ja(null!==(d=e.watering_mode)&&void 0!==d?d:"classic")}"
                      ...
                      ${"service"===e.watering_mode?Z`
                            ...
                            <ha-settings-row>
                              ...
                              <select
                                class="settings-input"
                                .value="${ja(null!==(h=e.duration_unit)&&void 0!==h?h:"seconds")}"
                ...
                ${null==e.distributor_id?Z`
                      ...
                      ${this._flowSensorIsTotalizer(e)?Z`
                            <ha-settings-row>
                              ...
                              <select
                                class="settings-input"
                                .value="${ja(e.flow_counter_type||"auto")}"
    ...
    `}_renderRunHistory(e){var t,s,i;if(!this.hass)return Z``;const a=(null===(t=this.config)||void 0===t?void 0:t.units)===Ce,n=null!==(s=e.run_log)&&void 0!==s?s:[],o=this.hass.language;return Z`
      <ha-expansion-panel
        .header="${fa("panels.zones.history.title",o)}"
      >
        <div class="card-content">
          <div class="history-usage">
            <span class="history-usage-label"
              >${fa("panels.zones.history.total_used",o)}</span
            >
            <span class="history-usage-value"
              >${Va(null!==(i=e.water_used_total)&&void 0!==i?i:0,a)}</span
            >
          </div>
          ${0===n.length?Z`<div class="weather-note">
                ${fa("panels.zones.history.empty",o)}
              </div>`:Z`
                <table class="history-table">
                  <thead>
                    <tr>
                      <th>${fa("panels.zones.history.when",o)}</th>
                      <th>${fa("panels.zones.history.result",o)}</th>
                      <th class="num">
                        ${fa("panels.zones.history.volume",o)}
                      </th>
                      <th>${fa("panels.zones.history.detail",o)}</th>
                    </tr>
                  </thead>
                  <tbody>
    ...
    `}_renderRunLogRow(e,t){const s=this.hass.language,i=fa(`panels.zones.history.results.${e.result}`,s);let a="";return e.detail&&(a="skipped"===e.result?e.detail.split(",").map(e=>fa(`panels.zones.outlook.checks.${e}`,s)||e).join(", "):/^[A-Za-z0-9_-]+$/.test(e.detail)&&fa(`panels.zones.fault.${e.detail}`,s)||e.detail),Z`
      <tr>
        <td>${Pa(e.ts)}</td>
        <td>
        ...
        <td class="num">
          ${e.volume_l>0?Va(e.volume_l,t):"-"}
        </td>
        <td class="history-detail">${Bs(a)}</td>
      </tr>
    ...
    `}};t([pe()],Xa.prototype,"config",void 0),t([pe({attribute:!1})],Xa.prototype,"path",void 0),t([pe({type:Array})],Xa.prototype,"zones",void 0),t([pe({type:Array})],Xa.prototype,"modules",void 0),t([pe({type:Array})],Xa.prototype,"mappings",void 0),t([pe({type:Array})],Xa.prototype,"distributors",void 0),t([pe({type:Boolean})],Xa.prototype,"isLoading",void 0),t([ge()],Xa.prototype,"_expanded",void 0),t([pe({type:Boolean})],Xa.prototype,"isSaving",void 0),t([pe({type:Boolean})],Xa.prototype,"_showAddZone",void 0),t([ge()],Xa.prototype,"_pendingConfirm",void 0),t([ge()],Xa.prototype,"_saveStatus",void 0),t([pe()],Xa.prototype,"_confirmDeleteZoneId",void 0),t([pe()],Xa.prototype,"_newZoneName",void 0),t([pe()],Xa.prototype,"_newZoneSize",void 0),t([pe()],Xa.prototype,"_newZoneThroughput",void 0),t([pe()],Xa.prototype,"_newZoneEntity",void 0),Xa=t([ce("smart-irrigation-view-zone-settings")],Xa);let Ja=class extends le{_emit(e){this.dispatchEvent(new CustomEvent("distributor-changed",{detail:{value:Object.assign(Object.assign({},this.distributor),e)},bubbles:!0,composed:!0}))}_onNumber(e,t){const s=t.target.valueAsNumber;isNaN(s)||this._emit({[e]:Math.max(0,Math.round(s))})}render(){var e,t,s,i;if(!this.hass||!this.distributor)return Z``;const a=this.hass.language,n=this.distributor,o=n.watering_mode===cs;return Z`
      <ha-settings-row>
        <span slot="heading"
      ...
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${ja(null!==(t=n.watering_mode)&&void 0!==t?t:ds)}"
          @change="${e=>this._emit({[Xt]:e.target.value})}"
        >
          <option
            value="${ds}"
            ?selected="${(null!==(s=n.watering_mode)&&void 0!==s?s:ds)===ds}"
          >
            ${fa("panels.zones.labels.watering_modes.classic",a)}
          </option>
          <option
            value="${cs}"
            ?selected="${n.watering_mode===cs}"
          >
      ...
      <ha-settings-row>
        ...
        <input
          ...
          @input="${e=>this._emit({[os]:e.target.value||null})}"
        />
      </ha-settings-row>
    `}_renderInletWatchRows(e){var t;const s=this.distributor,i=s.watering_mode===cs?"panels.distributors.labels.inlet_entity_help_service":"panels.distributors.labels.inlet_entity_help",a=null!==(t=s.watch_mode)&&void 0!==t?t:"ignore";return Z`
      <ha-settings-row>
        <span slot="heading"
          >${fa("panels.distributors.labels.inlet_entity",e)}</span
        >
        <span slot="description">${fa(i,e)}</span>
        <ha-entity-picker
          .hass="${this.hass}"
    ...
    `}_renderServiceRows(e){var t,s;const i=this.distributor;return Z`
      ...
      <ha-settings-row>
        ...
        <select
          class="settings-input"
          .value="${ja(null!==(t=i.duration_unit)&&void 0!==t?t:"seconds")}"
          @change="${e=>this._emit({[is]:e.target.value})}"
        >
          <option
            value="seconds"
      ...
      <ha-settings-row>
        ...
        <ha-entity-picker
          ...
          .includeDomains="${["script"]}"
          allow-custom-entity
          @value-changed="${e=>this._emit({[ts]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>
    `}_renderSensorRows(e){const t=this.distributor;return Z`
      <ha-settings-row>
        ...
        <ha-entity-picker
          ...
          allow-custom-entity
          @value-changed="${e=>this._emit({[as]:e.detail.value||null})}"
        ></ha-entity-picker>
      </ha-settings-row>
    ...
    `}_hasOwnActuation(e){return!!(e.linked_entity||e.run_service||e.stop_service)}_membersByOutlet(e){const t=new Map;if(void 0===e)return t;for(const s of this.zones)s.distributor_id===e&&null!=s.outlet_number&&void 0!==s.id&&t.set(s.outlet_number,s);return t}_outletCount(e){const t=this._membersByOutlet(e.id),s=t.size?Math.max(...t.keys()):0,i=Math.max(2,s),a=void 0!==e.id?this._outletRows[e.id]:void 0;return Math.min(6,Math.max(i,null!=a?a:i))}_assignZone(e,t,s){return _s(this.hass,{id:e.id,[us]:t,[ps]:s})}_optimisticZone(e,t,s){void 0!==e&&(this.zones=this.zones.map(i=>i.id===e?Object.assign(Object.assign({},i),{distributor_id:t,outlet_number:s}):i))}_runAssign(e){e.length&&(this.isSaving=!0,this._saveStatus="saving",this._scheduleUpdate(),Promise.all(e).then(()=>this._markSaved()).catch(e=>{console.error("Failed to assign zone to outlet:",e),this._saveStatus="idle",Sa(this,this.hass,"common.errors.save_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(()=>{})}))}_setOutletCount(e,t){if(void 0===e.id)return;const s=this._membersByOutlet(e.id),i=[];for(const[e,a]of s)e>t&&i.push(a);this._outletRows=Object.assign(Object.assign({},this._outletRows),{[e.id]:t}),i.length?(i.forEach(e=>this._optimisticZone(e.id,null,null)),this._runAssign(i.map(e=>this._assignZone(e,null,null)))):this._scheduleUpdate()}_onOutletZoneChange(e,t,s){const i=s.target.value,a=i?parseInt(i):null,n=this._membersByOutlet(e.id).get(t),o=null!==a?this.zones.find(e=>e.id===a):null,r=[];n&&n.id!==a&&(r.push(this._assignZone(n,null,null)),this._optimisticZone(n.id,null,null)),o&&(r.push(this._assignZone(o,e.id,t)),this._optimisticZone(o.id,e.id,t)),this._runAssign(r)}_renderOutletConfig(e){if(!this.hass)return Z``;const t=this.hass.language,s=this._membersByOutlet(e.id),i=this._outletCount(e),a=this.zones.filter(e=>void 0!==e.id&&null==e.distributor_id&&!this._hasOwnActuation(e)),n=[...s.keys()].sort((e,t)=>e-t),o=n.some((e,t)=>e!==t+1),r=[];for(let n=1;n<=i;n++){const i=s.get(n),o=i?[...a,i]:[...a];o.sort((e,t)=>(e.name||"").localeCompare(t.name||"")),r.push(Z`
        <div class="outlet-row">
          ...
          <select
            class="settings-input"
            .value="${ja(null!=(null==i?void 0:i.id)?String(i.id):"")}"
    ...
    `}_renderAdvisories(){var e,t;if(!this.hass)return Z``;const s=this.hass.language,i=null===(e=this.config)||void 0===e?void 0:e.zone_sequencing,a=i===Ut,n=i===Bt||i===jt,o=!!(null===(t=this.config)||void 0===t?void 0:t.master_off_after);return Z`
      <div class="advisories">
        <div class="advisory">
          <ha-icon icon="mdi:flask-outline"></ha-icon>
          <span
            >${fa("panels.distributors.hints.experimental",s)}</span
          >
        </div>
        <div class="advisory">
          <ha-icon icon="mdi:water-alert-outline"></ha-icon>
          <span>${fa("panels.distributors.hints.pressure",s)}</span>
        </div>
        ${a?Z`<div class="advisory">
              <ha-icon icon="mdi:information-outline"></ha-icon>
              <span
                >${fa("panels.distributors.hints.parallel_draw",s)}</span
              >
            </div>`:""}
        ${n&&o?Z`<div class="advisory">
              <ha-icon icon="mdi:information-outline"></ha-icon>
              <span
                >${fa("panels.distributors.hints.master_off_after",s)}</span
              >
            </div>`:""}
      </div>
    `}_renderCommissioning(e){var t;if(!this.hass)return Z``;const s=this.hass.language,i="synced"===e.position_state,a=!!e.commissioning_confirmed,n=!!e.active_cycle&&Object.keys(e.active_cycle).length>0,o=e.id;return Z`
      <div class="commissioning">
        <div class="commissioning-head">
          <span class="section-title"
            >${fa("panels.distributors.commissioning.title",s)}</span
          >
          <span class="pos-badge pos-${e.position_state}">
            ${fa("panels.distributors.commissioning.outlet",s)}
            ${e.current_outlet} ·
            ${fa(`panels.distributors.commissioning.states.${e.position_state}`,s)}
          </span>
        </div>
        ...
        <ha-settings-row>
          <span slot="heading"
            >${fa("panels.distributors.commissioning.set_outlet",s)}</span
          >
          <span slot="description"
            >${fa("panels.distributors.commissioning.set_outlet_help",s)}</span
          >
          <div class="inline-controls">
            <input
              ...
              max="${6}"
              step="1"
              .value="${ja(String(null!==(t=this._outletDraft[o])&&void 0!==t?t:e.current_outlet))}"
            ...
            >
              ${fa("panels.distributors.commissioning.set_outlet",s)}
            </button>
            <button
              class="action-btn secondary"
              ?disabled="${this.isSaving}"
            ...
            >
              ${fa("panels.distributors.commissioning.resync_home",s)}
            </button>
          </div>
        </ha-settings-row>
        <div class="commissioning-note">
          ${fa("panels.distributors.hints.undetectable",s)}
        </div>

        <!-- Test run -->
        <ha-settings-row>
          <span slot="heading"
            >${fa("panels.distributors.commissioning.test_run",s)}</span
          >
          <span slot="description"
            >${fa("panels.distributors.commissioning.test_run_help",s)}</span
          >
          <button
            class="action-btn secondary"
          ...
          >
            ...
            ${fa("panels.distributors.commissioning.test_run",s)}
          </button>
        </ha-settings-row>
        ...
        <ha-settings-row>
          <span slot="heading"
            >${fa("panels.distributors.commissioning.confirmed",s)}</span
          >
          <span slot="description"
            >${fa(i?"panels.distributors.commissioning.confirmed_help":"panels.distributors.commissioning.needs_sync",s)}</span
          >
          <ha-switch
            .checked="${ja(a)}"
        ...
        <div class="run-now-row">
          ...
          >
            <ha-icon icon="mdi:play"></ha-icon>
            ${fa("panels.distributors.commissioning.run_now",s)}
          </button>
          <span class="run-now-hint">
            ${fa(n?"panels.distributors.commissioning.run_now_active":"panels.distributors.commissioning.run_now_help",s)}
          </span>
        </div>
      </div>
    ...
    `}};t([pe()],Qa.prototype,"config",void 0),t([pe({attribute:!1})],Qa.prototype,"path",void 0),t([pe({type:Array})],Qa.prototype,"distributors",void 0),t([pe({type:Array})],Qa.prototype,"zones",void 0),t([pe({type:Boolean})],Qa.prototype,"isLoading",void 0),t([pe({type:Boolean})],Qa.prototype,"isSaving",void 0),t([ge()],Qa.prototype,"_expanded",void 0),t([pe({type:Boolean})],Qa.prototype,"_showAdd",void 0),t([pe()],Qa.prototype,"_newName",void 0),t([pe()],Qa.prototype,"_confirmDeleteId",void 0),t([ge()],Qa.prototype,"_armConfirmId",void 0),t([ge()],Qa.prototype,"_confirmResyncHomeId",void 0),t([ge()],Qa.prototype,"_confirmSetOutletId",void 0),t([ge()],Qa.prototype,"_outletDraft",void 0),t([ge()],Qa.prototype,"_outletRows",void 0),t([ge()],Qa.prototype,"_saveStatus",void 0),Qa=t([ce("smart-irrigation-view-distributor-settings")],Qa);let en=class extends(Ca(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.moduleCache=new Map,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout(()=>{this.saveToHA(t),e=null},500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){Hs().catch(e=>{console.error("Failed to load HA form:",e)})}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;e&&(this.isLoading=!0,this._scheduleUpdate());try{const[e,t,s,i]=await Promise.all([gs(this.hass),vs(this.hass),fs(this.hass),bs(this.hass)]);this.config=e,this.zones=t,this.modules=s,this.allmodules=i,this._initialLoadDone=!0,this.moduleCache.clear()}catch(e){console.error("Error fetching data:",e),Sa(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}}async handleAddModule(){var e,t;if((null===(t=null===(e=this.moduleInput)||void 0===e?void 0:e.selectedOptions)||void 0===t?void 0:t[0])&&!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.moduleInput.selectedOptions[0].text,t=this.allmodules.find(t=>t.name===e);if(!t)return;const s={name:e,description:t.description,config:t.config,schema:t.schema};this.modules=[...this.modules,s],this.moduleCache.clear(),this._scheduleUpdate(),await this.saveToHA(s),await this._fetchData()}catch(e){console.error("Error adding module:",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}}}async handleRemoveModule(e,t){if(!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.modules[t],a=null==e?void 0:e.id;this.modules;this.modules=this.modules.filter((e,s)=>s!==t),this.moduleCache.clear(),this._scheduleUpdate(),this.hass&&void 0!==a&&await(s=this.hass,i=a.toString(),s.callApi("POST",_e+"/modules",{id:i,remove:!0}))}catch(e){console.error("Error removing module:",e),Sa(this,this.hass,"common.errors.delete_failed",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}var s,i}}async saveToHA(e){if(this.hass)try{await ys(this.hass,e)}catch(e){throw console.error("Error saving module:",e),Sa(this,this.hass,"common.errors.save_failed",e),e}}renderModule(e,t){if(!this.hass)return Z``;const s=this.zones.filter(t=>t.module===e.id).length,i=`module-${e.id||t}-${s}-${JSON.stringify(e)}`;if(this.moduleCache.has(i))return this.moduleCache.get(i);const a=Z`
      <ha-card>
        <div class="card-header">
          <div class="name">${e.name}</div>
    ...
    `;return this.moduleCache.set(i,a),a}renderUsageChip(e){return this.hass?e?Z`<span class="usage-chip"
      ...
      >
        ${Object.entries(n.options).map(([e,s])=>Z`<option
              ...
              ?selected="${h===ya(s,0)}"
            >
              ${fa("panels.modules.cards.module.translated-options."+ya(s,1),t)}
            </option>`)}
    ...
    `}};t([pe()],en.prototype,"config",void 0),t([pe({type:Array})],en.prototype,"zones",void 0),t([pe({type:Array})],en.prototype,"modules",void 0),t([pe({type:Array})],en.prototype,"allmodules",void 0),t([pe({type:Boolean})],en.prototype,"isLoading",void 0),t([pe({type:Boolean})],en.prototype,"isSaving",void 0),t([me("#moduleInput")],en.prototype,"moduleInput",void 0),en=t([ce("smart-irrigation-view-modules")],en);let tn=class extends(Ca(le)){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this.debounceTimers=new Map,this.globalDebounceTimer=null,this.mappingCache=new Map,this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()},this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()}))}firstUpdated(){Hs().catch(e=>{console.error("Failed to load HA form:",e)})}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[t,s,i]=await Promise.all([gs(this.hass),vs(this.hass),ws(this.hass)]);this.config=t,this.zones=s,this.mappings=i,this._initialLoadDone=!0,this.mappingCache.clear()}catch(e){console.error("Error fetching data:",e),Sa(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}}handleAddMapping(){if(!this.mappingNameInput.value.trim())return;const e={[Te]:"",[Oe]:"",[He]:"",[De]:"",[Me]:"",[Ie]:"",[Ne]:"",[Le]:"",[Pe]:""},t={name:this.mappingNameInput.value.trim(),mappings:e};this.mappings=[...this.mappings,t],this.isSaving=!0,this.saveToHA(t).then(()=>(this.mappingNameInput.value="",this._fetchData())).catch(e=>{console.error("Failed to add mapping:",e),Sa(this,this.hass,"common.errors.save_failed",e),this.mappings=this.mappings.slice(0,-1)}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()})}handleRemoveMapping(e,t){const s=this.mappings[t].id;if(null==s)return;const i=[...this.mappings];var a,n;(this.mappings=this.mappings.filter((e,s)=>s!==t),this.mappingCache.delete(s.toString()),this.hass)&&(this.isSaving=!0,(a=this.hass,n=s.toString(),a.callApi("POST",_e+"/mappings",{id:n,remove:!0})).catch(e=>{console.error("Failed to delete mapping:",e),Sa(this,this.hass,"common.errors.delete_failed",e),this.mappings=i,this._fetchData().catch(e=>{console.error("Failed to refresh data after delete error:",e)})}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditMapping(e,t){this.mappings[e]=t,t.id&&this.mappingCache.delete(t.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout(()=>{this.isSaving=!0,this.saveToHA(t).catch(e=>{console.error("Failed to save mapping:",e),Sa(this,this.hass,"common.errors.save_failed",e)}).finally(()=>{this.isSaving=!1,this._scheduleUpdate()}),this.globalDebounceTimer=null},500),this._scheduleUpdate()}async saveToHA(e){var t;if(!this.hass)throw new Error("Home Assistant connection not available");const s=[],i=this.hass.states;for(const t in e.mappings){const a=e.mappings[t].sensorentity;if(a&&""!==a.trim()){const n=a.trim();e.mappings[t].sensorentity=n,n in i||s.push(n)}}if(s.length>0){const e=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("ha-card");throw e&&$a({body:{message:fa("panels.mappings.cards.mapping.errors.source_does_not_exist",this.hass.language)+": "+s.join(", ")},error:fa("panels.mappings.cards.mapping.errors.invalid_source",this.hass.language)},e),new Error("Invalid sensor entities found")}const{id:a,name:n,mappings:o}=e;await $s(this.hass,{id:a,name:n,mappings:o})}renderMappingSetting(e,t){const s=this.mappings[e];if(!s||!this.hass)return Z``;const i=s.mappings[t];return Z`
    ...
    `}handleSimpleSourceChange(e,t,s){const i=this.mappings[e],a=s.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[t]:Object.assign(Object.assign({},i.mappings[t]),{[qe]:a,[Ge]:""})})}))}handleSimpleInputChange(e,t,s,i){const a=this.mappings[e],n=i.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},a),{mappings:Object.assign(Object.assign({},a.mappings),{[t]:Object.assign(Object.assign({},a.mappings[t]),{[s]:n})})}))}renderMappingInputs(e,t,s){if(!this.hass)return Z``;const i=s[qe];return Z`
      ${i===Be?this.renderSensorInput(e,t,s):""}
      ${i===Ue?this.renderStaticValueInput(e,t,s):""}
      ${i===Be||i===Ue?this.renderUnitSelect(e,t,s):""}
      ${t!==Ie||i!==Be&&i!==Ue?"":this.renderPressureTypeSelect(e,t,s)}
      ${i===Be?this.renderAggregateSelect(e,t,s):""}
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return Z`<option value="${e}" ?selected="${e===t}">
        ...
        <option
          ...
          ?selected="${s===Fe}"
        >
          ${fa("panels.mappings.cards.mapping.pressure_types."+Fe,this.hass.language)}
        </option>
        <option
          value="${Ze}"
          ?selected="${s===Ze}"
        >
          ${fa("panels.mappings.cards.mapping.pressure_types."+Ze,this.hass.language)}
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach(e=>{clearTimeout(e)}),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};t([pe()],tn.prototype,"config",void 0),t([pe({type:Array})],tn.prototype,"zones",void 0),t([pe({type:Array})],tn.prototype,"mappings",void 0),t([pe({type:Boolean})],tn.prototype,"isLoading",void 0),t([pe({type:Boolean})],tn.prototype,"isSaving",void 0),t([me("#mappingNameInput")],tn.prototype,"mappingNameInput",void 0),tn=t([ce("smart-irrigation-view-mappings")],tn);const sn=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"];let an=class extends(Ca(le)){constructor(){super(...arguments),this._schedules=[],this._zones=[],this._isLoading=!0,this._showDialog=!1,this._editingSchedule={name:"",type:"daily",enabled:!0,time:"06:00",action:"irrigate",zones:"all"},this._editingId=null}hassSubscribe(){return this._load(),[this.hass.connection.subscribeMessage(()=>this._load(),{type:_e+"_config_updated"})]}async _load(){var e;if(this.hass)try{const[t,s]=await Promise.all([(e=this.hass,e.callWS({type:_e+"/schedules"})),vs(this.hass)]);this._schedules=t||[],this._zones=s||[]}catch(e){console.error("Failed to load schedules",e),Sa(this,this.hass,"common.errors.load_failed",e)}finally{this._isLoading=!1}}_openAdd(){this._editingSchedule={name:"",type:"daily",enabled:!0,time:"06:00",action:"irrigate",zones:"all"},this._editingId=null,this._showDialog=!0}_openEdit(e){var t;this._editingSchedule=Object.assign({},e),this._editingId=null!==(t=e.id)&&void 0!==t?t:null,this._showDialog=!0}_closeDialog(){this._showDialog=!1}async _save(){const e=Object.assign({},this._editingSchedule);this._editingId&&(e.id=this._editingId);try{await ks(this.hass,e),this._closeDialog(),await this._load()}catch(e){console.error("Failed to save schedule",e),Sa(this,this.hass,"common.errors.save_failed",e)}}async _delete(e){try{await(t=this.hass,s=e,t.callWS({type:_e+"/schedule_delete",schedule_id:s})),await this._load()}catch(e){console.error("Failed to delete schedule",e),Sa(this,this.hass,"common.errors.delete_failed",e)}var t,s}_update(e){this._editingSchedule=Object.assign(Object.assign({},this._editingSchedule),e)}_typeLabel(e){return fa(`panels.schedules.types.${e}`,this.hass.language)||e}_zonesLabel(e){if("all"===e)return fa("panels.schedules.zones_all",this.hass.language);if(Array.isArray(e)){const t=e.map(e=>{const t=this._zones.find(t=>String(t.id)===String(e));return t?t.name:e}).join(", ");return t||e.join(", ")}return String(e)}_renderZonePicker(){const e="all"===this._editingSchedule.zones||!Array.isArray(this._editingSchedule.zones),t=e?[]:this._editingSchedule.zones.map(String);return Z`
      <div class="field">
        <label
          >${fa("panels.schedules.fields.zones",this.hass.language)}</label
        >
    ...
    `}_renderTypeFields(){var e;const t=this._editingSchedule;switch(t.type){case"daily":return Z`
          <div class="field">
            <label
              >${fa("panels.schedules.fields.time",this.hass.language)}</label
            >
            <input
              type="time"
              .value="${t.time||"06:00"}"
        ...
        `;case"weekly":return Z`
          ...
          <div class="field">
            <label
              >${fa("panels.schedules.fields.days_of_week",this.hass.language)}</label
            >
            <div class="day-checkboxes">
              ${sn.map(e=>Z`
                  <label class="day-check">
                    ...
                    />
                    ${fa(`panels.schedules.days.${e}`,this.hass.language)}
                  </label>
                `)}
            </div>
          </div>
        `;case"monthly":return Z`
          ...
          <div class="field">
            <label
              >${fa("panels.schedules.fields.day_of_month",this.hass.language)}</label
            >
            <input
              type="number"
              min="1"
        ...
        `;case"interval":return Z`
          <div class="field">
            <label
              >${fa("panels.schedules.fields.interval_hours",this.hass.language)}</label
            >
          ...
          <div class="field">
            <label
              >${fa("panels.schedules.fields.start_time",this.hass.language)}</label
            >
            <input
              type="time"
              .value="${t.start_time||""}"
        ...
        `;case"sunrise":case"sunset":return Z`${this._renderSunOffsetFields()}`;case"solar_azimuth":return Z`
          <div class="field">
            <label
              >${fa("panels.schedules.fields.azimuth_angle",this.hass.language)}</label
            >
            <div class="input-suffix-row">
              <input
                type="number"
      ...
      <div class="field">
        <label
          >${fa("panels.schedules.fields.offset_minutes",this.hass.language)}</label
        >
        <div class="input-suffix-row">
          <input
            type="number"
          ...
          />
          <span class="suffix"
            >${fa("panels.schedules.minutes",this.hass.language)}</span
          >
        </div>
      </div>
    `}_renderTimeAnchorField(){var e;const t=this._editingSchedule;if("irrigate"!==t.action||"interval"===t.type)return Z``;const s=["sunrise","sunset","solar_azimuth"].includes(t.type)&&!1!==t.account_for_duration,i=null!==(e=t.time_anchor)&&void 0!==e?e:s?"finish":"start";return Z`
      <div class="field">
        <label
          >${fa("panels.schedules.fields.time_anchor",this.hass.language)}</label
        >
        <select
        ...
        >
          ${["start","finish"].map(e=>Z`
              <option value="${e}" ?selected="${i===e}">
                ${fa(`panels.schedules.time_anchor.${e}`,this.hass.language)}
              </option>
            `)}
        </select>
      </div>
    `}_renderDialog(){if(!this._showDialog)return Z``;const e=this._editingSchedule,t=this._editingId?fa("panels.schedules.dialog.edit_title",this.hass.language):fa("panels.schedules.dialog.add_title",this.hass.language);return Z`
      <ha-dialog open .heading=${!0} @closed=${this._closeDialog}>
        ...
        <div class="dialog-content">
          <div class="field">
            <label
              >${fa("panels.schedules.fields.name",this.hass.language)}</label
            >
            <input
              type="text"
              .value="${e.name}"
          ...
          <div class="field">
            <label
              >${fa("panels.schedules.fields.type",this.hass.language)}</label
            >
            <select
          ...
          <div class="field-row">
            <label
              >${fa("panels.schedules.fields.enabled",this.hass.language)}</label
            >
            <input
              type="checkbox"
              ?checked="${e.enabled}"
          ...
          <div class="field">
            <label
              >${fa("panels.schedules.fields.start_date",this.hass.language)}</label
            >
            <input
              type="date"
              .value="${e.start_date||""}"
          ...
          <div class="field">
            <label
              >${fa("panels.schedules.fields.end_date",this.hass.language)}</label
            >
            <input
              type="date"
              .value="${e.end_date||""}"
        ...
        <div class="dialog-footer">
          ...
          <button class="dialog-btn dialog-btn-primary" @click=${this._save}>
            ${fa("common.actions.save",this.hass.language)}
          </button>
        </div>
      </ha-dialog>
    `}render(){return this.hass?this._isLoading?Z`
      ...
      ${0===this._schedules.length?Z`
          ...
          `:this._schedules.map(e=>Z`
                ...
                <div class="card-content">
                  <div class="info-row">
                    <span class="info-label"
                      >${fa("panels.schedules.fields.type",this.hass.language)}:</span
                    >
                  ...
                  ${e.time&&["daily","weekly","monthly"].includes(e.type)?Z`
                        <div class="info-row">
                          <span class="info-label"
                            >${fa("panels.schedules.fields.time",this.hass.language)}:</span
                          >
                          <span>${e.time}</span>
                        </div>
                      `:""}
            ...
            `)}
    `:Z``}static get styles(){return[Ma,r`
        .dialog-content {
          display: flex;
          flex-direction: column;
          gap: 14px;
      ...
      `]}};t([pe({attribute:!1})],an.prototype,"hass",void 0),t([ge()],an.prototype,"_schedules",void 0),t([ge()],an.prototype,"_zones",void 0),t([ge()],an.prototype,"_isLoading",void 0),t([ge()],an.prototype,"_showDialog",void 0),t([ge()],an.prototype,"_editingSchedule",void 0),t([ge()],an.prototype,"_editingId",void 0),an=t([ce("smart-irrigation-view-schedules")],an);let nn=class extends(Ca(le)){constructor(){super(...arguments),this._forecast=null,this._mappings=[],this._records=new Map,this._loading=!0,this._metric=!0,this._climate=[]}hassSubscribe(){return this._fetch(),[this.hass.connection.subscribeMessage(()=>this._fetch(),{type:_e+"_config_updated"})]}async _fetch(){var e,t;if(this.hass)try{const[s,i,a,n]=await Promise.all([(t=this.hass,t.callWS({type:_e+"/weather_forecast"})),ws(this.hass),gs(this.hass),xs(this.hass)]);this._forecast=s,this._mappings=i||[],this._metric=(null==a?void 0:a.units)!==Ee;const o=n?Object.values(n):[];this._climate=o.length>0&&(null===(e=o[0])||void 0===e?void 0:e.monthly_estimates)||[];const r=new Map;await Promise.all(this._mappings.map(async e=>{if(void 0!==e.id)try{r.set(e.id,await((e,t,s=10)=>e.callWS({type:_e+"/weather_records",mapping_id:t,limit:s}))(this.hass,e.id.toString(),0)||[])}catch(e){}})),this._records=r}catch(e){console.error("Failed to fetch weather data",e)}finally{this._loading=!1}}render(){return this.hass?Z`${this._renderForecast()} ${this._renderRecords()}
                ...
                <div class="seasonal-table">
                  ...
                  ${this._climate.map(e=>Z`
                      <div class="weather-row">
                        ...
                        >
                        <span
                          >${Ka(e.estimated_et_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${Ka(e.average_precipitation_mm,"precipitation",this._metric)}</span
                        >
                        <span
                          >${Ka(e.average_temperature_c,"temperature",this._metric)}</span
                        >
                      </div>
                    `)}
                </div>
    ...
    `}_renderForecastDay(e,t){const s=(()=>{try{return new Intl.DateTimeFormat(t,{weekday:"short",month:"short",day:"numeric"}).format(new Date(e.date+"T00:00:00"))}catch(t){return e.date}})(),i=e=>{const t=Ga(e,"temperature",this._metric);return t?`${Math.round(t.value)}°`:"-"};return Z`
      <div class="forecast-day">
        ...
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-rainy"></ha-icon>${Ka(e.precipitation,"precipitation",this._metric)}
        </div>
        <div class="forecast-meta">
          <ha-icon icon="mdi:weather-windy"></ha-icon>${Ka(e.windspeed,"windspeed",this._metric)}
        </div>
      </div>
    `}_renderRecords(){if(!this.hass)return Z``;const e=this.hass.language;return this._loading&&0===this._mappings.length?Z`<ha-card
      ...
      </ha-card>`:Z`${this._mappings.map(t=>this._renderMappingRecords(t,e))}`}_renderMappingRecords(e,t){const s=void 0!==e.id&&this._records.get(e.id)||[],i=`${fa("panels.mappings.weather-records.title",t)} — ${e.name}`,a=e=>{try{return t=e,Number.isNaN(Na(t).getTime())?"-":function(e){const t=Na(e);return`${Ia(t.getMonth()+1)}-${Ia(t.getDate())} ${Ia(t.getHours())}:${Ia(t.getMinutes())}`}(e)}catch(e){return"-"}var t};return Z`
      <ha-card header="${i}">
        <div class="card-content">
                ...
                <div class="weather-table">
                  ...
                  ${s.map(e=>Z`
                      <div class="weather-row">
                        ...
                        <span
                          >${Ka(e.temperature,"temperature",this._metric)}</span
                        >
                        <span>${(e=>null!=e?e.toFixed(1)+" %":"-")(e.humidity)}</span>
                        <span
                          >${Ka(e.dewpoint,"temperature",this._metric)}</span
                        >
                        <span
                          >${Ka(e.wind_speed,"windspeed",this._metric)}</span
                        >
                        <span
                          >${Ka(e.pressure,"pressure",this._metric)}</span
                        >
                        <span
                          >${Ka(e.precipitation,"precipitation",this._metric)}</span
                        >
    ...
    `}};t([pe()],nn.prototype,"narrow",void 0),t([ge()],nn.prototype,"_forecast",void 0),t([ge()],nn.prototype,"_mappings",void 0),t([ge()],nn.prototype,"_records",void 0),t([ge()],nn.prototype,"_loading",void 0),t([ge()],nn.prototype,"_metric",void 0),t([ge()],nn.prototype,"_climate",void 0),nn=t([ce("smart-irrigation-view-weather-data")],nn);let on=class extends(Ca(le)){constructor(){super(...arguments),this._saving=!1}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch experimental config:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to refresh experimental config:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(this.hass)try{this.config=await gs(this.hass)}catch(e){console.error("Error fetching config:",e),Sa(this,this.hass,"common.errors.load_failed",e)}}async _toggle(e,t){if(this.hass&&this.config){this.config=Object.assign(Object.assign({},this.config),{[e]:t}),this._saving=!0;try{await ms(this.hass,{[e]:t})}catch(e){console.error("Error saving experimental config:",e),Sa(this,this.hass,"common.errors.save_failed",e),await this._fetchData()}finally{this._saving=!1}}}render(){var e,t;return this.hass&&this.config?Z`
      ${this._renderIntro()}
    ...
    `:Z``}_renderToggleCard(e,t,s){if(!this.hass)return Z``;const i=`panels.experimental.${e}`;return Z`
      <ha-card header="${fa(`${i}.title`,this.hass.language)}">
        <div class="card-content description-text">
          ${fa(`${i}.description`,this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${fa(`${i}.label`,this.hass.language)}</label>
            <ha-switch
              .checked="${s}"
              ?disabled="${this._saving}"
    ...
    `}};t([pe()],on.prototype,"narrow",void 0),t([ge()],on.prototype,"config",void 0),t([ge()],on.prototype,"_saving",void 0),on=t([ce("smart-irrigation-view-experimental")],on);var rn;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.Distributors="distributors",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}(rn||(rn={}));const ln={[rn.WeatherLocation]:"panels.setup.tabs.weather_location",[rn.Zones]:"panels.setup.tabs.my_zones",[rn.Distributors]:"panels.setup.tabs.distributors",[rn.WhenToWater]:"panels.setup.tabs.when_to_water",[rn.Advanced]:"panels.setup.tabs.advanced",[rn.Experimental]:"panels.setup.tabs.experimental",[rn.Help]:"panels.help.title"};let dn=class extends(Ca(le)){hassSubscribe(){return this._fetchConfig(),[this.hass.connection.subscribeMessage(()=>this._fetchConfig(),{type:_e+"_config_updated"})]}async _fetchConfig(){if(this.hass)try{this.config=await gs(this.hass)}catch(e){console.error("Failed to fetch setup config:",e)}}get _distributorsEnabled(){var e,t;return null!==(t=null===(e=this.config)||void 0===e?void 0:e.distributors_enabled)&&void 0!==t&&t}get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(rn).includes(null!=t?t:"")?t:rn.WeatherLocation}_selectTab(e){xa(0,Da("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return Z``;const e=this._distributorsEnabled,t=Object.values(rn).filter(t=>t!==rn.Distributors||e);let s=this._activeTab;return s!==rn.Distributors||e||(s=rn.WeatherLocation),Z`
    ...
    `}_renderContent(e){if(!this.hass)return Z``;switch(e){case rn.WeatherLocation:return Z`
          ...
          <smart-irrigation-view-weather-data
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-weather-data>
        `;case rn.Zones:return Z`<smart-irrigation-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-zone-settings>`;case rn.Distributors:return Z`<smart-irrigation-view-distributor-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-distributor-settings>`;case rn.WhenToWater:return Z`
          <smart-irrigation-view-general
            .hass="${this.hass}"
            .narrow="${this.narrow}"
        ...
        `;case rn.Advanced:return Z`
          ...
          <smart-irrigation-view-mappings
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-mappings>
        `;case rn.Experimental:return Z`<smart-irrigation-view-experimental
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-experimental>`;case rn.Help:return this._renderHelp()}}_renderHelp(){return this.hass?Z`
      <ha-card
    ...
    `}};var cn;t([pe({attribute:!1})],dn.prototype,"hass",void 0),t([pe({type:Boolean})],dn.prototype,"narrow",void 0),t([pe({attribute:!1})],dn.prototype,"path",void 0),t([ge()],dn.prototype,"config",void 0),dn=t([ce("smart-irrigation-view-setup")],dn),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done"}(cn||(cn={}));let hn=class extends le{constructor(){super(...arguments),this._step=cn.Welcome,this._saving=!1,this._error="",this._confirmClose=!1,this._siConfig=null,this._useWeather=!1,this._weatherService=xe,this._apiKey="",this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=Re,this._humiditySource=Re,this._precipSource=Re,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="",this._scheduleTime="06:00",this._scheduleCreated=!1,this._creatingSchedule=!1}async connectedCallback(){super.connectedCallback(),await this._loadInitialData()}async _loadInitialData(){var e;if(this.hass){try{const[t,s,i]=await Promise.all([bs(this.hass),As(this.hass),gs(this.hass)]);this._availableModules=t,this._weatherConfig=s,this._siConfig=i,this._useWeather=s.use_weather_service,this._weatherService=null!==(e=s.weather_service)&&void 0!==e?e:xe}catch(e){console.error("Wizard: failed to load initial data",e),this._error=ka(e)}this.requestUpdate()}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}))}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}))}async _next(){this._error="";try{switch(this._saving=!0,this._step){case cn.Welcome:this._step=cn.Weather;break;case cn.Weather:await this._saveWeather(),this._step=cn.Module;break;case cn.Module:await this._saveModule(),this._step=cn.Mapping;break;case cn.Mapping:await this._saveMapping(),this._step=cn.Zone;break;case cn.Zone:await this._saveZone(),this._step=cn.Done;break;case cn.Done:this._close()}}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._saving=!1,this.requestUpdate()}}_back(){this._step>cn.Welcome&&(this._step=this._step-1,this._error="")}get _canSkipCurrentStep(){return this._step===cn.Weather}_skipStep(){this._canSkipCurrentStep&&this._step<cn.Done&&(this._step=this._step+1,this._error="")}async _saveWeather(){await Es(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null)}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0}catch(e){return}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await ys(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>fs(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.")}async _saveMapping(){const e=this._useWeather?Re:We,t={[Le]:{[qe]:this._tempSource},[He]:{[qe]:this._humiditySource},[De]:{[qe]:this._precipSource}},s=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const i of s)t[i]={[qe]:e};const i=await $s(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(i,()=>ws(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.")}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await _s(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:Oa.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0})}async _createDefaultSchedule(){var e,t;if(!this._scheduleCreated&&!this._creatingSchedule){this._error="",this._creatingSchedule=!0;try{const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";await ks(this.hass,{name:fa("wizard.steps.done.schedule_name",s)||"Daily",type:"daily",enabled:!0,time:this._scheduleTime||"06:00",action:"irrigate",zones:"all"}),this._scheduleCreated=!0}catch(e){this._error=e instanceof Error?e.message:String(e)}finally{this._creatingSchedule=!1,this.requestUpdate()}}}render(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return Z`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          <div class="wizard-header">
            <span class="wizard-title">${fa("wizard.title",s)}</span>
            <button
              class="wizard-close-btn"
              @click="${this._close}"
              title="${fa("wizard.close",s)}"
              aria-label="${fa("wizard.close",s)}"
            >
              <ha-icon icon="mdi:close"></ha-icon>
            </button>
          </div>
          ${this._step!==cn.Welcome&&this._step!==cn.Done?Z`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>cn.Welcome&&this._step<cn.Done?this._confirmClose=!0:this._close())}_renderStepper(){var e,t;const s=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=[fa("wizard.stepper.weather",s),fa("wizard.stepper.module",s),fa("wizard.stepper.mapping",s),fa("wizard.stepper.zone",s)];return Z`
      ${i.map((e,t)=>{const s=t+1,a=this._step===s,n=this._step>s;return Z`
        ...
        `})}
    `}_renderStep(e){switch(this._step){case cn.Welcome:return this._renderWelcome(e);case cn.Weather:return this._renderWeather(e);case cn.Module:return this._renderModule(e);case cn.Mapping:return this._renderMapping(e);case cn.Zone:return this._renderZone(e);case cn.Done:return this._renderDone(e);default:return Z``}}_renderFooter(e){return this._step===cn.Done?Z``:Z`
      <div class="footer-left">
        ${this._step>cn.Welcome?Z`<button
              class="wizard-btn secondary"
              @click="${this._back}"
              ?disabled="${this._saving}"
            >
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?fa("common.saving-messages.saving",e):this._step===cn.Welcome||this._step<cn.Zone?fa("wizard.next",e):fa("wizard.finish",e)}
      </button>
    ...
    `}_renderMapping(e){const t=[{value:Re,label:fa("wizard.steps.mapping.use_weather_service",e)},{value:"sensor",label:fa("wizard.steps.mapping.use_sensor",e)},{value:"static",label:fa("wizard.steps.mapping.use_static",e)},{value:We,label:fa("wizard.steps.mapping.use_none",e)}],s=(s,i,a)=>Z`
      <si-field
        label="${fa("wizard.steps.mapping.source_label",e)} ${s}"
      >
        <select
          class="wizard-input"
    ...
    `;return Z`
      ...
      ${s(fa("panels.mappings.cards.mapping.items.temperature",e)||"Temperature",this._tempSource,e=>{this._tempSource=e,this.requestUpdate()})}
      ${s(fa("panels.mappings.cards.mapping.items.humidity",e)||"Humidity",this._humiditySource,e=>{this._humiditySource=e,this.requestUpdate()})}
      ${s(fa("panels.mappings.cards.mapping.items.precipitation",e)||"Precipitation",this._precipSource,e=>{this._precipSource=e,this.requestUpdate()})}
    ...
    `}};t([pe({attribute:!1})],hn.prototype,"hass",void 0),t([ge()],hn.prototype,"_step",void 0),t([ge()],hn.prototype,"_saving",void 0),t([ge()],hn.prototype,"_error",void 0),t([ge()],hn.prototype,"_confirmClose",void 0),t([ge()],hn.prototype,"_siConfig",void 0),t([ge()],hn.prototype,"_useWeather",void 0),t([ge()],hn.prototype,"_weatherService",void 0),t([ge()],hn.prototype,"_apiKey",void 0),t([ge()],hn.prototype,"_weatherConfig",void 0),t([ge()],hn.prototype,"_availableModules",void 0),t([ge()],hn.prototype,"_selectedModuleIndex",void 0),t([ge()],hn.prototype,"_moduleConfig",void 0),t([ge()],hn.prototype,"_mappingName",void 0),t([ge()],hn.prototype,"_tempSource",void 0),t([ge()],hn.prototype,"_humiditySource",void 0),t([ge()],hn.prototype,"_precipSource",void 0),t([ge()],hn.prototype,"_zoneName",void 0),t([ge()],hn.prototype,"_zoneSize",void 0),t([ge()],hn.prototype,"_zoneThroughput",void 0),t([ge()],hn.prototype,"_zoneEntity",void 0),t([ge()],hn.prototype,"_scheduleTime",void 0),t([ge()],hn.prototype,"_scheduleCreated",void 0),t([ge()],hn.prototype,"_creatingSchedule",void 0),hn=t([ce("si-setup-wizard")],hn);const un=Ma;var pn;!function(e){e.Zones="zones",e.Setup="setup"}(pn||(pn={})),e.SmartIrrigationPanel=class extends le{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}async firstUpdated(){const e=Ha().page;Object.values(pn).includes(e)||xa(0,Da(pn.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())}),Hs().then(()=>{this._scheduleUpdate()}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}),this.hass&&gs(this.hass).then(e=>{this._config=e,this._scheduleUpdate()}).catch(e=>{console.error("Failed to fetch config for version display:",e)})}_ensureLanguage(){this.hass&&!va(this.hass.language)&&function(e){const t=ma(e);return va(e)?Promise.resolve():(ga[t]||(ga[t]=fetch(`/smart_irrigation_static/languages/${t}.json?v=${ve}`).then(e=>e.ok?e.json():Promise.reject(e.status)).then(e=>{pa[t]=e}).catch(()=>{pa[t]=pa.en})),ga[t])}(this.hass.language).then(()=>this.requestUpdate())}render(){var e,t;if(this.hass&&!va(this.hass.language))return this._ensureLanguage(),Z``;const s=Ha(),i=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return Z`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
    ...
    `}getView(e){switch(e.page){case"zones":default:return Z`
        ...
        `;case"setup":return Z`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0}}"
          ></smart-irrigation-view-setup>
        `}}navigateToPage(e){if(e!==Ha().page){const t=Da(e);xa(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==Ha().page){const e=Da(t);xa(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[un,r`
        :host {
          color: var(--primary-text-color);
    ...
    `}};t([pe({attribute:!1})],gn.prototype,"hass",void 0),t([ge()],gn.prototype,"_params",void 0),gn=t([ce("error-dialog")],gn);var mn=Object.freeze({__proto__:null,get ErrorDialog(){return gn}})}({});

...
i.version="2.30.1",n(Ga),i.fn=ls,i.min=Ja,i.max=Qa,i.now=ei,i.utc=g,i.unix=ds,i.months=vs,i.isDate=c,i.locale=ga,i.invalid=f,i.duration=Ai,i.isMoment=z,i.weekdays=fs,i.parseZone=us,i.localeData=_a,i.isDuration=ri,i.monthsShort=_s,i.weekdaysMin=ys,i.defineLocale=ma,i.updateLocale=va,i.locales=fa,i.weekdaysShort=bs,i.normalizeUnits=ae,i.relativeTimeRounding=ir,i.relativeTimeThreshold=sr,i.calendarFormat=Bi,i.prototype=ls,i.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},i;}();}(rr)),rr.exports),lr=ir(or);let dr=class extends de{constructor(){super(...arguments),this.label="",this.unit="",this.help="",this.required=!1,this._helpOpen=!1;}_toggleHelp(){this._helpOpen=!this._helpOpen;}render(){return W`
    ...
    `;}_renderMappingOptions(e){if(!this.hass)return W``;const t=null!=e?String(e):"";return W`
      ...
      ${this.mappings.map(e=>W`
        ...
        `)}
    `;}_fmtDurationShort(e){const t=Math.round(e);if(t<60)return`${t} s`;const a=Math.floor(t/60),i=t%60;return i?`${a} min ${i} s`:`${a} min`;}_renderZoneDecision(e){var t;if(!this.hass)return W``;const a=this.hass.language,i=null!==(t=e.duration)&&void 0!==t?t:0;let n,s,r;return e.state===tr.Disabled?(n=Es("panels.zones.status.decision_disabled",a),s="neutral",r="mdi:power-off"):i>0?(n=Es("panels.zones.status.decision_water",a,"{duration}",this._fmtDurationShort(i)),s="water",r="mdi:water"):e.last_calculated?(n=Es("panels.zones.status.decision_no_water",a),s="ok",r="mdi:check-circle-outline"):(n=Es("panels.zones.status.decision_unknown",a),s="unknown",r="mdi:help-circle-outline"),W`
    ...
    `;}renderStaticValueOption(e,t,a){if(!this.hass)return W``;const i=`${t}_${e}`,n=a[Ke]===Ve;return W`
      <label>
        <input
          type="radio"
          id="${i}_static"
    ...
    `;}handleSourceChange(e,t,a){const i=this.mappings[e],n=a.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[t]:Object.assign(Object.assign({},i.mappings[t]),{[Ke]:n,[Xe]:""})})}));}renderMappingInputs(e,t,a){if(!this.hass)return W``;const i=a[Ke];return W`
      ...
      ${i===Fe||i===Ve?this.renderUnitSelect(e,t,a):""}
      ${t!==Le||i!==Fe&&i!==Ve?"":this.renderPressureTypeSelect(e,t,a)}
    ...
    `;}renderAggregateOption(e,t){if(this.hass&&this.config){return W`<option value="${e}" ?selected="${e===t}">
      ...
      </option>`;}return W``;}renderPressureTypes(e,t){if(this.hass&&this.config){let e=W``;const a=t[qe];return e=W`${e}
        <option
          value="${Ze}"
          ?selected="${a===Ze}"
        >
    ...
    `:W``;}static get styles(){return[ar,c`
      ...
      `];}};n([he({attribute:!1})],mr.prototype,"hass",void 0),n([ge()],mr.prototype,"_schedules",void 0),n([ge()],mr.prototype,"_zones",void 0),n([ge()],mr.prototype,"_isLoading",void 0),n([ge()],mr.prototype,"_showDialog",void 0),n([ge()],mr.prototype,"_editingSchedule",void 0),n([ge()],mr.prototype,"_editingId",void 0),mr=n([ce("smart-irrigation-view-schedules")],mr);const vr=()=>{const e=e=>{let t={};for(let a=0;a<e.length;a+=2){const i=e[a],n=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:n});}return t;},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex(e=>"filter"==e),n=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(n)});}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})));}return a;},_r=(e,...t)=>{let a={page:e,params:{}};t.forEach(e=>{"string"==typeof e?a=Object.assign(Object.assign({},a),{subpage:e}):"params"in e?a=Object.assign(Object.assign({},a),{params:e.params}):"filter"in e&&(a=Object.assign(Object.assign({},a),{filter:e.filter}));});const i=e=>{let t=Object.keys(e);t=t.filter(t=>e[t]),t.sort();let a="";return t.forEach(t=>{const i=e[t];a=a.length?`${a}/${t}/${i}`:`${t}/${i}`;}),a;};let n=`/${Se}/${a.page}`;return a.subpage&&(n=`${n}/${a.subpage}`),i(a.params).length&&(n=`${n}/${i(a.params)}`),a.filter&&(n=`${n}/filter/${i(a.filter)}`),n;};var fr;!function(e){e.General="general",e.Modules="modules",e.Mappings="mappings",e.Schedules="schedules",e.Help="help";}(fr||(fr={}));const br={[fr.General]:"panels.general.title",[fr.Modules]:"panels.modules.title",[fr.Mappings]:"panels.mappings.title",[fr.Schedules]:"panels.schedules.title",[fr.Help]:"panels.help.title"};let yr=class extends de{get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(fr).includes(null!=t?t:"")?t:fr.General;}_selectTab(e){js(0,_r("setup",e));}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}));}render(){if(!this.hass)return W``;const e=this._activeTab;return W`
      <div class="setup-container">
        <nav class="setup-nav">
          ${Object.values(fr).map(t=>W`
              <button
    ...
    `;}_renderContent(e){if(!this.hass)return W``;switch(e){case fr.General:return W`<smart-irrigation-view-general
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-general>`;case fr.Modules:return W`<smart-irrigation-view-modules
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-modules>`;case fr.Mappings:return W`<smart-irrigation-view-mappings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-mappings>`;case fr.Schedules:return W`<smart-irrigation-view-schedules
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-schedules>`;case fr.Help:return this._renderHelp();}}_renderHelp(){return this.hass?W`
      <ha-card
    ...
    `;}};var kr;n([he({attribute:!1})],yr.prototype,"hass",void 0),n([he({type:Boolean})],yr.prototype,"narrow",void 0),n([he({attribute:!1})],yr.prototype,"path",void 0),yr=n([ce("smart-irrigation-view-setup")],yr),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done";}(kr||(kr={}));let wr=class extends de{constructor(){super(...arguments),this._step=kr.Welcome,this._saving=!1,this._error="",this._siConfig=null,this._useWeather=!1,this._weatherService=Me,this._apiKey="",this._testingApi=!1,this._testResult=null,this._testResultTimer=null,this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=We,this._humiditySource=We,this._precipSource=We,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="";}async connectedCallback(){super.connectedCallback(),await this._loadInitialData();}async _loadInitialData(){var e;if(this.hass){try{const[t,a,i]=await Promise.all([Vs(this.hass),Ks(this.hass),Rs(this.hass)]);this._availableModules=t,this._weatherConfig=a,this._siConfig=i,this._useWeather=a.use_weather_service,this._weatherService=null!==(e=a.weather_service)&&void 0!==e?e:Me;}catch(e){console.error("Wizard: failed to load initial data",e),this._error=Os(e);}this.requestUpdate();}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}));}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}));}async _next(){this._error="";try{switch(this._saving=!0,this._step){case kr.Welcome:this._step=kr.Weather;break;case kr.Weather:await this._saveWeather(),this._step=kr.Module;break;case kr.Module:await this._saveModule(),this._step=kr.Mapping;break;case kr.Mapping:await this._saveMapping(),this._step=kr.Zone;break;case kr.Zone:await this._saveZone(),this._step=kr.Done;break;case kr.Done:this._close();}}catch(e){this._error=e instanceof Error?e.message:String(e);}finally{this._saving=!1,this.requestUpdate();}}_back(){this._step>kr.Welcome&&(this._step=this._step-1,this._error="");}get _canSkipCurrentStep(){return this._step===kr.Weather;}_skipStep(){this._canSkipCurrentStep&&this._step<kr.Done&&(this._step=this._step+1,this._error="");}async _saveWeather(){await Js(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null);}async _resolveSavedId(e,t){if("number"==typeof(null==e?void 0:e.id))return e.id;try{const e=(await t()).map(e=>e.id).filter(e=>"number"==typeof e);return e.length?Math.max(...e):void 0;}catch(e){return;}}async _saveModule(){if(0===this._availableModules.length)throw new Error("No calculation module is available to configure. Cannot continue.");const e=this._availableModules[this._selectedModuleIndex],t=await qs(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});if(this._savedModuleId=await this._resolveSavedId(t,()=>Fs(this.hass)),void 0===this._savedModuleId)throw new Error("The calculation module was saved but could not be linked. Please try again.");}async _saveMapping(){const e=this._useWeather?We:Ye,t={[Re]:{[Ke]:this._tempSource},[Ne]:{[Ke]:this._humiditySource},[He]:{[Ke]:this._precipSource}},a=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const i of a)t[i]={[Ke]:e};const i=await Gs(this.hass,{name:this._mappingName,mappings:t});if(this._savedMappingId=await this._resolveSavedId(i,()=>Zs(this.hass)),void 0===this._savedMappingId)throw new Error("The sensor group was saved but could not be linked. Please try again.");}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");const e=parseFloat(this._zoneSize),t=parseFloat(this._zoneThroughput);if(!(e>0))throw new Error("Zone size must be greater than 0.");if(!(t>0))throw new Error("Throughput must be greater than 0 (zones can't water otherwise).");await Ws(this.hass,{name:this._zoneName.trim(),size:e,throughput:t,state:tr.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0});}async _testApiKey(){if(this.hass&&!this._testingApi){this._testingApi=!0,this._testResult=null,this._testResultTimer&&clearTimeout(this._testResultTimer),this.requestUpdate();try{const e=await Xs(this.hass,this._weatherService,this._apiKey||null);this._testResult=e,this._testResultTimer=window.setTimeout(()=>{this._testResult=null,this.requestUpdate();},12e3);}catch(e){this._testResult={success:!1,error:"unknown"};}finally{this._testingApi=!1,this.requestUpdate();}}}render(){var e,t;const a=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return W`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          ...
          ${this._step!==kr.Welcome&&this._step!==kr.Done?W`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `;}_onOverlayClick(e){e.target===e.currentTarget&&this._close();}_renderStepper(){var e,t;const a=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",i=[Es("wizard.stepper.weather",a),Es("wizard.stepper.module",a),Es("wizard.stepper.mapping",a),Es("wizard.stepper.zone",a)];return W`
      ${i.map((e,t)=>{const a=t+1,n=this._step===a,s=this._step>a;return W`
        ...
        `;})}
    `;}_renderStep(e){switch(this._step){case kr.Welcome:return this._renderWelcome(e);case kr.Weather:return this._renderWeather(e);case kr.Module:return this._renderModule(e);case kr.Mapping:return this._renderMapping(e);case kr.Zone:return this._renderZone(e);case kr.Done:return this._renderDone(e);default:return W``;}}_renderFooter(e){return this._step===kr.Done?W``:W`
      <div class="footer-left">
        ${this._step>kr.Welcome?W`<button
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Es("common.saving-messages.saving",e):this._step===kr.Welcome||this._step<kr.Zone?Es("wizard.next",e):Es("wizard.finish",e)}
      </button>
    ...
    `;}};n([he({attribute:!1})],wr.prototype,"hass",void 0),n([ge()],wr.prototype,"_step",void 0),n([ge()],wr.prototype,"_saving",void 0),n([ge()],wr.prototype,"_error",void 0),n([ge()],wr.prototype,"_siConfig",void 0),n([ge()],wr.prototype,"_useWeather",void 0),n([ge()],wr.prototype,"_weatherService",void 0),n([ge()],wr.prototype,"_apiKey",void 0),n([ge()],wr.prototype,"_testingApi",void 0),n([ge()],wr.prototype,"_testResult",void 0),n([ge()],wr.prototype,"_availableModules",void 0),n([ge()],wr.prototype,"_selectedModuleIndex",void 0),n([ge()],wr.prototype,"_moduleConfig",void 0),n([ge()],wr.prototype,"_mappingName",void 0),n([ge()],wr.prototype,"_tempSource",void 0),n([ge()],wr.prototype,"_humiditySource",void 0),n([ge()],wr.prototype,"_precipSource",void 0),n([ge()],wr.prototype,"_zoneName",void 0),n([ge()],wr.prototype,"_zoneSize",void 0),n([ge()],wr.prototype,"_zoneThroughput",void 0),n([ge()],wr.prototype,"_zoneEntity",void 0),wr=n([ce("si-setup-wizard")],wr);const zr=ar;var Sr;!function(e){e.Zones="zones",e.Setup="setup";}(Sr||(Sr={})),e.SmartIrrigationPanel=class extends de{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100;}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate();}));}async firstUpdated(){const e=vr().page;Object.values(Sr).includes(e)||js(0,_r(Sr.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate());}),be().then(()=>{this._scheduleUpdate();}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate();});}render(){const e=vr(),t=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return W`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
    ...
    `;}getView(e){switch(e.page){case"zones":default:return W`
        ...
        `;case"setup":return W`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0;}}"
          ></smart-irrigation-view-setup>
        `;}}navigateToPage(e){if(e!==vr().page){const t=_r(e);js(0,t),this.requestUpdate();}else scrollTo(0,0);}handlePageSelected(e){const t=e.detail.name;if(t!==vr().page){const e=_r(t);js(0,e),this.requestUpdate();}else scrollTo(0,0);}static get styles(){return[zr,c`
        :host {
          color: var(--primary-text-color);

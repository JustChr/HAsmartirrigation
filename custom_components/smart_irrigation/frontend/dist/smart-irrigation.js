!function(e){"use strict";var t=function(e,a){return t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t;}||function(e,t){for(var a in t)Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);},t(e,a);};function a(e,a){if("function"!=typeof a&&null!==a)throw new TypeError("Class extends value "+String(a)+" is not a constructor or null");function i(){this.constructor=e;}t(e,a),e.prototype=null===a?Object.create(a):(i.prototype=a.prototype,new i());}var i=function(){return i=Object.assign||function(e){for(var t,a=1,i=arguments.length;a<i;a++)for(var n in t=arguments[a])Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e;},i.apply(this,arguments);};function n(e,t,a,i){var n,s=arguments.length,r=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,a,i);else for(var o=e.length-1;o>=0;o--)(n=e[o])&&(r=(s<3?n(r):s>3?n(t,a,r):n(t,a))||r);return s>3&&r&&Object.defineProperty(t,a,r),r;}function s(e,t,a){if(a||2===arguments.length)for(var i,n=0,s=t.length;n<s;n++)!i&&n in t||(i||(i=Array.prototype.slice.call(t,0,n)),i[n]=t[n]);return e.concat(i||Array.prototype.slice.call(t));}"function"==typeof SuppressedError&&SuppressedError;/**
  ...
  `);}const Bt=(e,t,a=!1)=>{a?history.replaceState(null,"",t):history.pushState(null,"",t),ke(window,"location-changed",{replace:a});},Ut={},Rt=jt(class extends Ct{constructor(e){if(super(e),e.type!==Dt&&e.type!==Et&&e.type!==Ot)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression");}render(e){return e;}update(e,[t]){if(t===F||t===q)return t;const a=e.element,i=e.name;if(e.type===Dt){if(t===a[i])return F;}else if(e.type===Ot){if(!!t===a.hasAttribute(i))return F;}else if(e.type===Et&&a.getAttribute(i)===t+"")return F;return((e,t=Ut)=>{e._$AH=t;/**
     ...
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */var Wt="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z",Ft="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z";const qt=e=>e.callWS({type:Se+"/config"}),Vt=e=>e.callWS({type:Se+"/zones"}),Zt=(e,t)=>e.callApi("POST",Se+"/zones",t),Yt=e=>e.callWS({type:Se+"/modules"}),Gt=e=>e.callWS({type:Se+"/allmodules"}),Kt=(e,t)=>e.callApi("POST",Se+"/modules",t),Xt=e=>e.callWS({type:Se+"/mappings"}),Jt=(e,t)=>e.callApi("POST",Se+"/mappings",t),Qt=(e,t,a=10)=>e.callWS({type:Se+"/weather_records",mapping_id:t,limit:a}),ea=e=>e.callWS({type:Se+"/weather_config"}),ta=(e,t,a)=>e.callWS({type:Se+"/weather_config_test",weather_service:null!=t?t:null,api_key:null!=a?a:null}),aa=(e,t,a,i)=>e.callWS({type:Se+"/weather_config_save",use_weather_service:t,weather_service:null!=a?a:null,api_key:null!=i?i:null}),ia=e=>{class t extends e{connectedCallback(){super.connectedCallback(),this.__checkSubscribed();}disconnectedCallback(){if(super.disconnectedCallback(),this.__unsubs){for(;this.__unsubs.length;){const e=this.__unsubs.pop();e instanceof Promise?e.then(e=>e()):e();}this.__unsubs=void 0;}}updated(e){super.updated(e),e.has("hass")&&this.__checkSubscribed();}hassSubscribe(){return[];}__checkSubscribed(){void 0===this.__unsubs&&this.isConnected&&void 0!==this.hass&&(this.__unsubs=this.hassSubscribe());}}return n([he({attribute:!1})],t.prototype,"hass",void 0),t;};var na,sa;!function(e){e.Sunrise="sunrise",e.Sunset="sunset",e.SolarAzimuth="solar_azimuth";}(na||(na={})),function(e){e.Disabled="disabled",e.Manual="manual",e.Automatic="automatic";}(sa||(sa={}));const ra=c`
...
i.version="2.30.1",n(Ya),i.fn=ls,i.min=Ja,i.max=Qa,i.now=ei,i.utc=g,i.unix=ds,i.months=vs,i.isDate=c,i.locale=ga,i.invalid=_,i.duration=Ai,i.isMoment=z,i.weekdays=_s,i.parseZone=us,i.localeData=fa,i.isDuration=ri,i.monthsShort=fs,i.weekdaysMin=ys,i.defineLocale=ma,i.updateLocale=va,i.locales=_a,i.weekdaysShort=bs,i.normalizeUnits=ae,i.relativeTimeRounding=nr,i.relativeTimeThreshold=sr,i.calendarFormat=Bi,i.prototype=ls,i.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},i;}();}(ir)),ir.exports),sr=er(nr);let rr=class extends de{constructor(){super(...arguments),this.label="",this.unit="",this.help="",this.required=!1,this._helpOpen=!1;}_toggleHelp(){this._helpOpen=!this._helpOpen;}render(){return W`
    ...
    `;}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await Zt(this.hass,e);}_renderModuleOptions(e){if(!this.hass)return W``;const t=null!=e?String(e):"";return W`
      <option value="" ?selected="${""===t}">
        ---${Qs("common.labels.select",this.hass.language)}---
      </option>
    ...
    `;}_renderMappingOptions(e){if(!this.hass)return W``;const t=null!=e?String(e):"";return W`
      ...
      ${this.mappings.map(e=>W`
        ...
        `)}
    `;}renderZone(e,t){var a,i,n,s,r,o,l,d,u;if(!this.hass)return W``;const c=Number(null!==(a=e.bucket)&&void 0!==a?a:0),p=c<0?"var(--warning-color)":"var(--success-color)",h=e.state===sa.Automatic?"state-automatic":e.state===sa.Manual?"state-manual":"state-disabled";return W`
      <ha-card>
        <div class="card-header">
          <div class="name">${e.name}</div>
          <span class="zone-state-badge ${h}">
            ${Qs(`panels.zones.labels.states.${e.state}`,this.hass.language)}
          </span>
        </div>
          ...
          <div class="zone-status-grid">
            <div class="status-item">
              <span class="status-label"
                >${Qs("panels.zones.labels.bucket",this.hass.language)}</span
              >
            ...
            <div class="status-item">
              <span class="status-label"
                >${Qs("panels.zones.labels.duration",this.hass.language)}</span
              >
            ...
            <div class="status-item">
              <span class="status-label"
                >${Qs("panels.zones.labels.last_calculated",this.hass.language)}</span
              >
              <span class="status-value">
                ${e.last_calculated?sr(e.last_calculated).format("YYYY-MM-DD HH:mm"):"–"}
              </span>
            </div>
            <div class="status-item">
              <span class="status-label"
                >${Qs("panels.zones.labels.data-number-of-data-points",this.hass.language)}</span
              >
              <span class="status-value"
        ...
        <div class="card-content zone-action-bar">
          ${e.state===sa.Automatic?W`
                ...
                >
                  ...
                  ${Qs("panels.zones.actions.calculate",this.hass.language)}
                </button>
                <button
                  class="action-btn"
                ...
                >
                  ...
                  ${Qs("panels.zones.actions.update",this.hass.language)}
                </button>
              `:""}
          ${e.linked_entity&&(null!==(s=e.duration)&&void 0!==s?s:0)>0?W`
                <button
                  ...
                  ?disabled="${this.isSaving}"
                >
                  ${Qs("panels.zones.labels.irrigate_now",this.hass.language)}
                </button>
              `:""}
        </div>
        ...
        <!-- SETTINGS EXPANSION -->
        <ha-expansion-panel
          .header="${Qs("common.labels.settings",this.hass.language)}"
        >
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.name",this.hass.language)}</span
            >
            <input
              type="text"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.size",this.hass.language)}
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.throughput",this.hass.language)}
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.drainage_rate",this.hass.language)}
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.state",this.hass.language)}</span
            >
            <select
              class="settings-input"
              .value="${Rt(e.state)}"
            ...
            >
              <option
                value="${sa.Automatic}"
                ?selected="${e.state===sa.Automatic}"
              >
                ${Qs("panels.zones.labels.states.automatic",this.hass.language)}
              </option>
              <option
                value="${sa.Manual}"
                ?selected="${e.state===sa.Manual}"
              >
                ${Qs("panels.zones.labels.states.manual",this.hass.language)}
              </option>
              <option
                value="${sa.Disabled}"
                ?selected="${e.state===sa.Disabled}"
              >
                ${Qs("panels.zones.labels.states.disabled",this.hass.language)}
              </option>
            </select>
          </ha-settings-row>
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("common.labels.module",this.hass.language)}</span
            >
            <select
              class="settings-input"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.mapping",this.hass.language)}</span
            >
            <select
              class="settings-input"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.linked_entity",this.hass.language)}</span
            >
            <ha-entity-picker
              .hass="${this.hass}"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.flow_sensor",this.hass.language)}</span
            >
            <ha-entity-picker
              .hass="${this.hass}"
              .value="${e.flow_sensor||""}"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.bucket",this.hass.language)}
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.maximum-bucket",this.hass.language)}
              (${It(this.config,ht)})</span
            >
            <input
              type="number"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.multiplier",this.hass.language)}</span
            >
            <input
              type="number"
              class="settings-input shortfield"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.lead-time",this.hass.language)}
              (s)</span
            >
            <input
              type="number"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.maximum-duration",this.hass.language)}
              (s)</span
            >
            <input
              type="number"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${Qs("panels.zones.labels.bucket_threshold",this.hass.language)}
              (${It(this.config,ht)})</span
            >
            <input
              type="number"
          ...
          ${e.state===sa.Manual?W`
                <ha-settings-row>
                  <span slot="heading"
                    >${Qs("panels.zones.labels.duration",this.hass.language)}
                    (${"s"})</span
                  >
                  <input
                    type="number"
          ...
          <div class="settings-danger-row">
            <button
              ...
              ?disabled="${this.isSaving}"
            >
              ${Qs("panels.zones.actions.reset-bucket",this.hass.language)}
            </button>
            <button
              class="action-btn"
              class="danger-button"
            ...
            >
              ...
              ${Qs("common.actions.delete",this.hass.language)}
            </button>
          </div>
        </ha-expansion-panel>
        ...
        ${e.explanation&&e.explanation.length>0?W`
              <ha-expansion-panel
                .header="${Qs("panels.zones.actions.information",this.hass.language)}"
              >
        ...
        ${void 0!==e.mapping?W`
              <ha-expansion-panel
                .header="${Qs("panels.zones.actions.view-weather-info",this.hass.language)}"
              >
        ...
        <!-- CALENDAR EXPANSION -->
        <ha-expansion-panel
          .header="${Qs("panels.zones.actions.view-watering-calendar",this.hass.language)}"
        >
          ${this.renderWateringCalendar(e)}
        </ha-expansion-panel>
      </ha-card>
    `;}render(){var e,t,a,i;if(!this.hass)return W``;if(this.isLoading)return W`
        <ha-card header="${Qs("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            ${Qs("common.loading-messages.general",this.hass.language)}...
          </div>
        </ha-card>
              ...
              <div class="setup-banner">
                ...
                <div class="setup-banner-content">
                  <div class="setup-banner-title">
                    ${Qs("wizard.title",this.hass.language)}
                  </div>
                  <div class="setup-banner-desc">
                    ${Qs("wizard.setup_complete_banner",this.hass.language)}
                  </div>
                </div>
                <button
                ...
                >
                  ${Qs("wizard.open_wizard",this.hass.language)}
                </button>
              </div>
            </ha-card>
          `:""}
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${Qs("panels.zones.title",this.hass.language)}
          </div>
          <ha-icon-button
            .path="${Ft}"
        ...
        <div class="card-content zones-top-actions">
          ...
          >
            ${Qs("panels.zones.actions.irrigate_all",this.hass.language)}
          </button>
          ${s?"":W`<span class="zones-top-note"
                >${Qs("panels.info.cards.irrigate_now.no_linked_zones",this.hass.language)}</span
              >`}
        </div>
      </ha-card>
      ...
      <ha-dialog
        ...
        heading="${Qs("panels.zones.cards.add-zone.header",this.hass.language)}"
      >
        <div class="add-zone-form">
          <si-field
            label="${Qs("panels.zones.labels.name",this.hass.language)}"
            required
          >
            <input
              type="text"
          ...
          <si-field
            label="${Qs("panels.zones.labels.size",this.hass.language)}"
            unit="${(null===(e=this.config)||void 0===e?void 0:e.units)===je?"m²":at}"
            help="${Qs("field_help.zone_size",this.hass.language)}"
          >
            <input
              type="number"
              class="settings-input add-zone-input"
          ...
          <si-field
            label="${Qs("panels.zones.labels.throughput",this.hass.language)}"
            unit="${(null===(t=this.config)||void 0===t?void 0:t.units)===je?it:nt}"
            help="${Qs("field_help.zone_throughput",this.hass.language)}"
          >
            <input
              type="number"
              class="settings-input add-zone-input"
        ...
        <div class="dialog-footer">
          ...
          >
            ${Qs("common.actions.cancel",this.hass.language)}
          </button>
          <button
          ...
          >
            ${this.isSaving?Qs("common.saving-messages.adding",this.hass.language):Qs("panels.zones.cards.add-zone.actions.add",this.hass.language)}
          </button>
        </div>
      </ha-dialog>
      ...
      ${n?W`
            <ha-dialog
              ...
              heading="${Qs("common.actions.confirm_delete",this.hass.language)}"
            >
              <p>
                ${Qs("common.actions.confirm_delete_zone",this.hass.language)}
              </p>
      ...
      ${null!==this._confirmIrrigate?W`
            <ha-dialog
              ...
              heading="${Qs("panels.zones.confirm_irrigate.title",this.hass.language)}"
            >
              <p>
                ${Qs("panels.zones.confirm_irrigate.body",this.hass.language)}
              </p>
              <p>
                <strong>
                  ${"all"===this._confirmIrrigate?`${Qs("panels.zones.confirm_irrigate.all_linked_zones",this.hass.language)} (${this._linkedZoneCount})`:null!==(i=null===(a=this.zones.find(e=>{var t;return(null===(t=e.id)||void 0===t?void 0:t.toString())===this._confirmIrrigate;}))||void 0===a?void 0:a.name)&&void 0!==i?i:this._confirmIrrigate}
                </strong>
              </p>
              <div class="dialog-footer">
                <button
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${Qs("common.labels.bulk_actions",this.hass.language)}
          </div>
        </div>
        <div class="card-content bulk-actions">
          <button
            ...
            ?disabled="${this.isSaving}"
          >
            ${Qs("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language)}
          </button>
          <button
            class="action-btn"
            ...
            ?disabled="${this.isSaving}"
          >
            ${Qs("panels.zones.cards.zone-actions.actions.update-all",this.hass.language)}
          </button>
          <button
            class="action-btn"
            ...
            ?disabled="${this.isSaving}"
          >
            ${Qs("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language)}
          </button>
          <button
            class="action-btn"
            ...
            ?disabled="${this.isSaving}"
          >
            ${Qs("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language)}
          </button>
        </div>
      </ha-card>
      ...
      >
        ...
        <div class="card-content">
          ...
          ${this._useWeatherService?W`
                <div class="setting-row">
                  <label>
                    ${Qs("weather_service_config.service_label",this.hass.language)}
                  </label>
                  <select
                    class="settings-input"
                  ...
                  >
                    ...
                    >
                      ${Qs("weather_service_config.openmeteo",this.hass.language)}
                    </option>
                    <option
                      value="${$e}"
                      ?selected="${this._weatherService===$e}"
                    >
                      ${Qs("weather_service_config.owm",this.hass.language)}
                    </option>
                    <option
                      value="${Ae}"
                      ?selected="${this._weatherService===Ae}"
                    >
                      ${Qs("weather_service_config.pw",this.hass.language)}
                    </option>
                  </select>
                </div>
                ${r?W`
                      <si-field
                        label="${Qs("weather_service_config.api_key_label",this.hass.language)}"
                        help="${Qs("weather_service_config.api_key_help",this.hass.language)}"
                      >
                        <div class="api-key-status">
                          ${(()=>{const e=this._weatherService,t=this._weatherConfig;return(e===$e?null==t?void 0:t.has_owm_api_key:e===Ae&&(null==t?void 0:t.has_pw_api_key))?W`<span class="api-key-badge configured"
                                  >${Qs("weather_service_config.api_key_configured",this.hass.language)}</span
                                >`:W`<span class="api-key-badge missing"
                                  >${Qs("weather_service_config.api_key_not_configured",this.hass.language)}</span
                                >`;})()}
                        </div>
                        <div class="api-key-row">
                          <input
                            ...
                            placeholder="${Qs("weather_service_config.api_key_placeholder",this.hass.language)}"
                          ...
                          >
                            ${this._testingApi?Qs("weather_service_config.test_button_testing",this.hass.language):Qs("weather_service_config.test_button",this.hass.language)}
                          </button>
                        </div>
                        ${null!==this._testResult?W`
                              ...
                              >
                                ${this._testResult.success?Qs("weather_service_config.test_success",this.hass.language):Qs("weather_service_config.test_error_"+(null!==(n=this._testResult.error)&&void 0!==n?n:"unknown"),this.hass.language)}
                              </div>
                            `:""}
                      </si-field>
                    `:W`
                      <div class="description-text" style="padding: 8px 0;">
                        ${Qs("weather_service_config.no_api_key_needed",this.hass.language)}
                      </div>
                    `}
              `:""}
          <div style="margin-top: 12px;">
            ...
            >
              ${this._weatherSaving?Qs("common.saving-messages.saving",this.hass.language):Qs("weather_service_config.save_button",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    `;}_renderAutoUpdateCard(){var e,t;return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${Qs("panels.general.cards.automatic-update.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Qs("panels.general.cards.automatic-update.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Qs("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}
            </label>
            <ha-switch
          ...
          ${this.data.autoupdateenabled?W`
                <div class="setting-row">
                  <label>
                    ${Qs("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}
                  </label>
                  <div class="inline-row">
                    ...
                    >
                      ...
                      >
                        ${Qs("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
                      </option>
                      <option
                        value="${Te}"
                        ?selected="${(this.data.autoupdateschedule||Te)===Te}"
                      >
                        ${Qs("panels.general.cards.automatic-update.options.hours",this.hass.language)}
                      </option>
                      <option
                        value="${De}"
                        ?selected="${this.data.autoupdateschedule===De}"
                      >
                        ${Qs("panels.general.cards.automatic-update.options.days",this.hass.language)}
                      </option>
                    </select>
                  </div>
                </div>
                <div class="setting-row">
                  <label>
                    ${Qs("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language)}
                    (s)
                  </label>
                  <input
                    type="number"
    ...
    `:W``;}_renderAutoCalcCard(){return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${Qs("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Qs("panels.general.cards.automatic-duration-calculation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Qs("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}
            </label>
            <ha-switch
          ...
          ${this.data.autocalcenabled?W`
                <div class="setting-row">
                  <label>
                    ${Qs("panels.general.cards.automatic-duration-calculation.labels.calc-time",this.hass.language)}
                  </label>
                  <input
                    type="text"
                    class="settings-input shortfield"
    ...
    `:W``;}_renderAutoClearCard(){return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${Qs("panels.general.cards.automatic-clear.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Qs("panels.general.cards.automatic-clear.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Qs("panels.general.cards.automatic-clear.labels.automatic-clear-enabled",this.hass.language)}
            </label>
            <ha-switch
          ...
          ${this.data.autoclearenabled?W`
                <div class="setting-row">
                  <label>
                    ${Qs("panels.general.cards.automatic-clear.labels.automatic-clear-time",this.hass.language)}
                  </label>
                  <input
                    type="text"
                    class="settings-input shortfield"
    ...
    `:W``;}_renderContinuousUpdatesCard(){var e;return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${Qs("panels.general.cards.continuousupdates.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Qs("panels.general.cards.continuousupdates.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Qs("panels.general.cards.continuousupdates.labels.continuousupdates",this.hass.language)}
            </label>
            <ha-switch
          ...
          ${this.data.continuousupdates?W`
                <div class="setting-row">
                  <label>
                    ${Qs("panels.general.cards.continuousupdates.labels.sensor_debounce",this.hass.language)}
                    (ms)
                  </label>
                  <input
                    type="number"
    ...
    `:W``;}_renderWeatherSkipCard(){var e,t,a;return this.hass&&this.config&&this.data?W`
      <ha-card header="${Qs("weather_skip.title",this.hass.language)}">
        <div class="card-content description-text">
          ${Qs("weather_skip.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Qs("weather_skip.threshold_label",this.hass.language)}
            </label>
            <ha-switch
          ...
          <div class="section-divider">
            ${Qs("weather_skip.temp_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Qs("weather_skip.temp_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_temp_enabled?W`
                <div class="setting-row">
                  <label>
                    ${Qs("weather_skip.temp_threshold_label",this.hass.language)}
                    (°C)
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Qs("weather_skip.wind_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Qs("weather_skip.wind_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_wind_enabled?W`
                <div class="setting-row">
                  <label>
                    ${Qs("weather_skip.wind_threshold_label",this.hass.language)}
                    (m/s)
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${Qs("weather_skip.rain_sensor_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${Qs("weather_skip.rain_sensor_label",this.hass.language)}
            </label>
            <ha-entity-picker
              .hass="${this.hass}"
    ...
    `:W``;}_renderCoordinateCard(){var e,t,a;if(!this.hass||!this.config||!this.data)return W``;const i=this.hass.config,n=(null==i?void 0:i.latitude)||0,s=(null==i?void 0:i.longitude)||0,r=(null==i?void 0:i.elevation)||0;return W`
      <ha-card
        header="${Qs("coordinate_config.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Qs("coordinate_config.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Qs("coordinate_config.manual_enabled",this.hass.language)}
            </label>
            <ha-switch
          ...
          ${this.config.manual_coordinates_enabled?W`
                <div class="setting-row">
                  <label>
                    ${Qs("coordinate_config.latitude",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="setting-row">
                  <label>
                    ${Qs("coordinate_config.longitude",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="setting-row">
                  <label>
                    ${Qs("coordinate_config.elevation",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
              ...
              `:W`
                ...
                >
                  ${Qs("coordinate_config.current_ha_coords",this.hass.language)}:
                  ${Qs("coordinate_config.latitude",this.hass.language)}:
                  ${n},
                  ${Qs("coordinate_config.longitude",this.hass.language)}:
                  ${s},
    ...
    `;}_renderDaysBetweenIrrigationCard(){var e;return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${Qs("days_between_irrigation.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Qs("days_between_irrigation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Qs("days_between_irrigation.label",this.hass.language)}
              <div class="setting-description">
                ${Qs("days_between_irrigation.help_text",this.hass.language)}
              </div>
            </label>
            <input
              type="number"
    ...
    `:W``;}_renderZoneSequencingCard(){var e,t;if(!this.hass||!this.config||!this.data)return W``;const a=(this.config.zone_sequencing||xt)===$t;return W`
      <ha-card
        header="${Qs("zone_sequencing.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${Qs("zone_sequencing.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${Qs("zone_sequencing.title",this.hass.language)}
            </label>
            <select
              class="settings-input"
            ...
            >
              ...
              >
                ${Qs("zone_sequencing.parallel",this.hass.language)}
              </option>
              <option
                value="${St}"
                ?selected="${this.config.zone_sequencing===St}"
              >
                ${Qs("zone_sequencing.sequential",this.hass.language)}
              </option>
              <option
                value="${$t}"
                ?selected="${this.config.zone_sequencing===$t}"
              >
                ${Qs("zone_sequencing.rotating",this.hass.language)}
              </option>
            </select>
          </div>
          ${a?W`
                <div class="setting-row">
                  <label>
                    ${Qs("zone_sequencing.max_consecutive_duration_label",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    min="1"
                  ...
                  <span class="unit-label">
                    ${Qs("zone_sequencing.max_consecutive_duration_unit",this.hass.language)}
                  </span>
                </div>
                <div class="setting-row">
                  <label>
                    ${Qs("zone_sequencing.min_absorption_time_label",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    min="0"
                  ...
                  />
                  <span class="unit-label">
                    ${Qs("zone_sequencing.min_absorption_time_unit",this.hass.language)}
                  </span>
                </div>
              `:""}
        </div>
    ...
    `;if("boolean"==i.type)o=W`${o}<input
        ...
        >
          ${Object.entries(i.options).map(([e,a])=>W`<option
                ...
                ?selected="${r===Ht(a,0)}"
              >
                ${Qs("panels.modules.cards.module.translated-options."+Ht(a,1),t)}
              </option>`)}
      ...
      <ha-card header="${Qs("panels.modules.title",this.hass.language)}">
        <div class="card-content">
          ${Qs("panels.modules.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${Qs("panels.modules.cards.add-module.header",this.hass.language)}"
      >
        <div class="card-content">
          ${this.isLoading?W`<div class="loading-indicator">
                ...
                <div class="zoneline">
                  <label for="moduleInput"
                    >${Qs("common.labels.module",this.hass.language)}:</label
                  >
                ...
                <div class="zoneline">
                  ...
                  >
                    ${this.isSaving?Qs("common.saving-messages.adding",this.hass.language):Qs("panels.modules.cards.add-module.actions.add",this.hass.language)}
                  </button>
                </div>
              `}
        </div>
      ...
      ${this.isLoading?W`<div class="loading-indicator">
            ${Qs("common.loading-messages.modules",this.hass.language)}
      ...
      <ha-card header="${e.id}: ${e.name}">
        <div class="card-content">
          <div class="card-content">
            ...
            ${i?W`<div class="weather-note">
                  ${Qs("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}
                </div>`:W` <div
                  class="action-button"
    ...
    `;return this.mappingCache.set(a,n),n;}renderMappingSetting(e,t){const a=this.mappings[e];if(!a||!this.hass)return W``;const i=a.mappings[t];return W`
      <div class="mappingline">
        <div class="mappingsettingname">
          <label for="${`${t}_${e}`}">
            ${Qs(`panels.mappings.cards.mapping.items.${t.toLowerCase()}`,this.hass.language)}
          </label>
        </div>
        <div class="mappingsettingline">
          <label
            >${Qs("panels.mappings.cards.mapping.source",this.hass.language)}:</label
          >
    ...
    `;}renderSimpleRadioOptions(e,t,a){if(!this.hass||!this.config)return W``;const i=t===Pe||t===Be,n=a[Ke];return W`
      ${!i&&this.config.use_weather_service?W`
            <label>
              ...
              />
              ${Qs("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}
            </label>
          `:""}
      ${i?W`
            <label>
              <input
                ...
                @change="${a=>this.handleSimpleSourceChange(e,t,a)}"
              />
              ${Qs("panels.mappings.cards.mapping.sources.none",this.hass.language)}
            </label>
          `:""}
      ...
      <label>
        <input
          ...
          @change="${a=>this.handleSimpleSourceChange(e,t,a)}"
        />
        ${Qs("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}
      </label>
      ...
      <label>
        <input
          ...
          @change="${a=>this.handleSimpleSourceChange(e,t,a)}"
        />
        ${Qs("panels.mappings.cards.mapping.sources.static",this.hass.language)}
      </label>
    `;}handleSimpleSourceChange(e,t,a){const i=this.mappings[e],n=a.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[t]:Object.assign(Object.assign({},i.mappings[t]),{[Ke]:n,[Xe]:""})})}));}handleSimpleInputChange(e,t,a,i){const n=this.mappings[e],s=i.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},n),{mappings:Object.assign(Object.assign({},n.mappings),{[t]:Object.assign(Object.assign({},n.mappings[t]),{[a]:s})})}));}renderSourceOptions(e,t,a){if(!this.hass)return W``;const i=t===Pe||t===Be;return W`
      <div class="mappingsettingline">
        <label for="${`${t}_${e}`}_source">
          ${Qs("panels.mappings.cards.mapping.source",this.hass.language)}:
        </label>
      </div>
      <div class="radio-group">
    ...
    `;}renderSensorInput(e,t,a){if(!this.hass)return W``;const i=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${i}_sensor_entity">
          ${Qs("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}:
        </label>
        <input
          type="text"
          id="${i}_sensor_entity"
    ...
    `;}renderStaticValueInput(e,t,a){if(!this.hass)return W``;const i=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${i}_static_value">
          ${Qs("panels.mappings.cards.mapping.static_value",this.hass.language)}:
        </label>
        <input
          type="text"
          id="${i}_static_value"
    ...
    `;}renderUnitSelect(e,t,a){if(!this.hass||!this.config)return W``;const i=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${i}_unit">
          ${Qs("panels.mappings.cards.mapping.input-units",this.hass.language)}:
        </label>
        <select
          id="${i}_unit"
    ...
    `;}renderPressureTypeSelect(e,t,a){if(!this.hass)return W``;const i=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${i}_pressure_type">
          ${Qs("panels.mappings.cards.mapping.pressure-type",this.hass.language)}:
        </label>
        <select
          id="${i}_pressure_type"
    ...
    `;}renderAggregateSelect(e,t,a){if(!this.hass)return W``;const i=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${i}_aggregate">
          ${Qs("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
        </label>
        <select
          id="${i}_aggregate"
        ...
        <label for="${i}_aggregate">
          ${Qs("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}
        </label>
      </div>
    ...
    `;}renderAggregateOption(e,t){if(this.hass&&this.config){return W`<option value="${e}" ?selected="${e===t}">
        ${Qs("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`;}return W``;}renderPressureTypes(e,t){if(this.hass&&this.config){let e=W``;const a=t[Ve];return e=W`${e}
        <option
          value="${Ze}"
          ?selected="${a===Ze}"
        >
          ${Qs("panels.mappings.cards.mapping.pressure_types."+Ze,this.hass.language)}
        </option>
        <option
          value="${Ye}"
          ?selected="${a===Ye}"
        >
          ${Qs("panels.mappings.cards.mapping.pressure_types."+Ye,this.hass.language)}
    ...
    `;}render(){return this.hass?this.isLoading?W`
        <ha-card
          header="${Qs("panels.mappings.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Qs("common.loading-messages.general",this.hass.language)}
          </div>
      ...
      >
        <div class="card-content">
          ${Qs("panels.mappings.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${Qs("panels.mappings.cards.add-mapping.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="zoneline">
          ...
          <div class="zoneline">
            ...
            <button @click="${this.handleAddMapping}">
              ${Qs("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    ...
    `;}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach(e=>{clearTimeout(e);}),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear();}};n([he()],ur.prototype,"config",void 0),n([he({type:Array})],ur.prototype,"zones",void 0),n([he({type:Array})],ur.prototype,"mappings",void 0),n([he({type:Map})],ur.prototype,"weatherRecords",void 0),n([he({type:Boolean})],ur.prototype,"isLoading",void 0),n([he({type:Boolean})],ur.prototype,"isSaving",void 0),n([me("#mappingNameInput")],ur.prototype,"mappingNameInput",void 0),ur=n([ce("smart-irrigation-view-mappings")],ur);const cr=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"];let pr=class extends ia(de){constructor(){super(...arguments),this._schedules=[],this._zones=[],this._isLoading=!0,this._showDialog=!1,this._editingSchedule={name:"",type:"daily",enabled:!0,time:"06:00",action:"irrigate",zones:"all"},this._editingId=null;}hassSubscribe(){return this._load(),[this.hass.connection.subscribeMessage(()=>this._load(),{type:Se+"_config_updated"})];}async _load(){var e;if(this.hass)try{const[t,a]=await Promise.all([(e=this.hass,e.callWS({type:Se+"/schedules"})),Vt(this.hass)]);this._schedules=t||[],this._zones=a||[];}catch(e){console.error("Failed to load schedules",e);}finally{this._isLoading=!1;}}_openAdd(){this._editingSchedule={name:"",type:"daily",enabled:!0,time:"06:00",action:"irrigate",zones:"all"},this._editingId=null,this._showDialog=!0;}_openEdit(e){var t;this._editingSchedule=Object.assign({},e),this._editingId=null!==(t=e.id)&&void 0!==t?t:null,this._showDialog=!0;}_closeDialog(){this._showDialog=!1;}async _save(){const e=Object.assign({},this._editingSchedule);this._editingId&&(e.id=this._editingId);try{await((e,t)=>e.callWS({type:Se+"/schedule_save",schedule:t}))(this.hass,e),this._closeDialog(),await this._load();}catch(e){console.error("Failed to save schedule",e);}}async _delete(e){try{await(t=this.hass,a=e,t.callWS({type:Se+"/schedule_delete",schedule_id:a})),await this._load();}catch(e){console.error("Failed to delete schedule",e);}var t,a;}_update(e){this._editingSchedule=Object.assign(Object.assign({},this._editingSchedule),e);}_typeLabel(e){return Qs(`panels.schedules.types.${e}`,this.hass.language)||e;}_actionLabel(e){return Qs(`panels.schedules.actions.${e}`,this.hass.language)||e;}_zonesLabel(e){if("all"===e)return Qs("panels.schedules.zones_all",this.hass.language);if(Array.isArray(e)){const t=e.map(e=>{const t=this._zones.find(t=>String(t.id)===String(e));return t?t.name:e;}).join(", ");return t||e.join(", ");}return String(e);}_renderZonePicker(){const e="all"===this._editingSchedule.zones||!Array.isArray(this._editingSchedule.zones),t=e?[]:this._editingSchedule.zones.map(String);return W`
      <div class="field">
        ...
        <div class="switch-container">
          ...
          />
          <label for="zones_all"
            >${Qs("panels.schedules.zones_all",this.hass.language)}</label
          >
          <input
            type="radio"
            id="zones_specific"
          ...
          <label for="zones_specific"
            >${Qs("panels.schedules.zones_specific",this.hass.language)}</label
          >
        </div>
        ${e?"":W`
    ...
    `;}_renderTypeFields(){var e;const t=this._editingSchedule;switch(t.type){case"daily":return W`
          <div class="field">
            <label
              >${Qs("panels.schedules.fields.time",this.hass.language)}</label
            >
            <input
              type="time"
              .value="${t.time||"06:00"}"
        ...
        `;case"weekly":return W`
          ...
          <div class="field">
            <label
              >${Qs("panels.schedules.fields.days_of_week",this.hass.language)}</label
            >
            <div class="day-checkboxes">
              ${cr.map(e=>W`
                  <label class="day-check">
                    ...
                    />
                    ${Qs(`panels.schedules.days.${e}`,this.hass.language)}
                  </label>
                `)}
            </div>
          </div>
        `;case"monthly":return W`
          ...
          <div class="field">
            <label
              >${Qs("panels.schedules.fields.day_of_month",this.hass.language)}</label
            >
            <input
              type="number"
              min="1"
        ...
        `;case"interval":return W`
          <div class="field">
            <label
              >${Qs("panels.schedules.fields.interval_hours",this.hass.language)}</label
            >
            <div class="input-suffix-row">
              ...
              />
              <span class="suffix"
                >${Qs("panels.schedules.hours",this.hass.language)}</span
              >
            </div>
          </div>
        `;case"sunrise":case"sunset":return W`${this._renderSunOffsetFields()}`;case"solar_azimuth":return W`
          <div class="field">
            <label
              >${Qs("panels.schedules.fields.azimuth_angle",this.hass.language)}</label
            >
            <div class="input-suffix-row">
              <input
                type="number"
      ...
      <div class="field">
        <label
          >${Qs("panels.schedules.fields.offset_minutes",this.hass.language)}</label
        >
        <div class="input-suffix-row">
          <input
            type="number"
          ...
          />
          <span class="suffix"
            >${Qs("panels.schedules.minutes",this.hass.language)}</span
          >
        </div>
      </div>
      <div class="field-row">
        <label
          >${Qs("panels.schedules.fields.account_for_duration",this.hass.language)}</label
        >
        <input
          type="checkbox"
    ...
    `;}_renderDialog(){if(!this._showDialog)return W``;const e=this._editingSchedule,t=this._editingId?Qs("panels.schedules.dialog.edit_title",this.hass.language):Qs("panels.schedules.dialog.add_title",this.hass.language);return W`
      <ha-dialog open .heading=${!0} @closed=${this._closeDialog}>
        ...
        <div class="dialog-content">
          <div class="field">
            <label
              >${Qs("panels.schedules.fields.name",this.hass.language)}</label
            >
            <input
              type="text"
              .value="${e.name}"
          ...
          <div class="field">
            <label
              >${Qs("panels.schedules.fields.type",this.hass.language)}</label
            >
            <select
          ...
          <div class="field">
            <label
              >${Qs("panels.schedules.fields.action",this.hass.language)}</label
            >
            <select
          ...
          <div class="field-row">
            <label
              >${Qs("panels.schedules.fields.enabled",this.hass.language)}</label
            >
            <input
              type="checkbox"
              ?checked="${e.enabled}"
          ...
          <div class="field">
            <label
              >${Qs("panels.schedules.fields.start_date",this.hass.language)}</label
            >
            <input
              type="date"
              .value="${e.start_date||""}"
          ...
          <div class="field">
            <label
              >${Qs("panels.schedules.fields.end_date",this.hass.language)}</label
            >
            <input
              type="date"
              .value="${e.end_date||""}"
        ...
        <div class="dialog-footer">
          ...
          <button class="dialog-btn dialog-btn-primary" @click=${this._save}>
            ${Qs("common.actions.save",this.hass.language)}
          </button>
        </div>
      </ha-dialog>
    `;}render(){return this.hass?this._isLoading?W`
        <ha-card
          header="${Qs("panels.schedules.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Qs("common.loading",this.hass.language)}...
          </div>
        </ha-card>
      `:W`
      ${this._renderDialog()}
      ...
      >
        <div class="card-content">
          ${Qs("panels.schedules.description",this.hass.language)}
        </div>
        <div class="card-content">
          <button class="add-btn" @click=${this._openAdd}>
            ...
            ${Qs("panels.schedules.add",this.hass.language)}
          </button>
        </div>
      </ha-card>
      ...
      ${0===this._schedules.length?W`
            <ha-card>
              <div class="card-content">
                ${Qs("panels.schedules.no_items",this.hass.language)}
              </div>
            </ha-card>
          `:this._schedules.map(e=>W`
                ...
                <div class="card-content">
                  <div class="info-row">
                    <span class="info-label"
                      >${Qs("panels.schedules.fields.type",this.hass.language)}:</span
                    >
                  ...
                  ${e.time&&["daily","weekly","monthly"].includes(e.type)?W`
                        <div class="info-row">
                          <span class="info-label"
                            >${Qs("panels.schedules.fields.time",this.hass.language)}:</span
                          >
                          <span>${e.time}</span>
                        </div>
                      `:""}
                  ${e.interval_hours?W`
                        <div class="info-row">
                          <span class="info-label"
                            >${Qs("panels.schedules.fields.interval_hours",this.hass.language)}:</span
                          >
                          <span
                            >${e.interval_hours}
                            ${Qs("panels.schedules.hours",this.hass.language)}</span
                  ...
                  <div class="info-row">
                    <span class="info-label"
                      >${Qs("panels.schedules.fields.action",this.hass.language)}:</span
                    >
                    <span>${this._actionLabel(e.action)}</span>
                  </div>
                  <div class="info-row">
                    <span class="info-label"
                      >${Qs("panels.schedules.fields.zones",this.hass.language)}:</span
                    >
                    <span>${this._zonesLabel(e.zones)}</span>
                  </div>
                  <div class="info-row">
                    <span class="info-label"
                      >${Qs("panels.schedules.fields.enabled",this.hass.language)}:</span
                    >
                    <span
                      >${e.enabled?Qs("common.labels.yes",this.hass.language):Qs("common.labels.no",this.hass.language)}</span
                    >
                  </div>
                </div>
                <div class="card-content action-buttons">
                  <div class="action-buttons-left">
                    ...
                    >
                      ...
                      <span class="action-button-label"
                        >${Qs("common.actions.edit",this.hass.language)}</span
                      >
                    </div>
                  </div>
                  <div class="action-buttons-right">
                    ...
                    >
                      <span class="action-button-label"
                        >${Qs("common.actions.delete",this.hass.language)}</span
                      >
                      <svg style="width:20px;height:20px" viewBox="0 0 24 24">
                        <path fill="#404040" d="${Wt}" />
                      </svg>
            ...
            `)}
    `:W``;}static get styles(){return[ra,c`
        .dialog-content {
          display: flex;
          flex-direction: column;
          gap: 14px;
      ...
      `];}};var hr;n([he({attribute:!1})],pr.prototype,"hass",void 0),n([ge()],pr.prototype,"_schedules",void 0),n([ge()],pr.prototype,"_zones",void 0),n([ge()],pr.prototype,"_isLoading",void 0),n([ge()],pr.prototype,"_showDialog",void 0),n([ge()],pr.prototype,"_editingSchedule",void 0),n([ge()],pr.prototype,"_editingId",void 0),pr=n([ce("smart-irrigation-view-schedules")],pr),function(e){e[e.Welcome=0]="Welcome",e[e.Weather=1]="Weather",e[e.Module=2]="Module",e[e.Mapping=3]="Mapping",e[e.Zone=4]="Zone",e[e.Done=5]="Done";}(hr||(hr={}));let gr=class extends de{constructor(){super(...arguments),this._step=hr.Welcome,this._saving=!1,this._error="",this._siConfig=null,this._useWeather=!1,this._weatherService=Me,this._apiKey="",this._testingApi=!1,this._testResult=null,this._testResultTimer=null,this._weatherConfig=null,this._availableModules=[],this._selectedModuleIndex=0,this._moduleConfig={},this._mappingName="My Sensor Group",this._tempSource=We,this._humiditySource=We,this._precipSource=We,this._zoneName="My Zone",this._zoneSize="",this._zoneThroughput="",this._zoneEntity="";}async connectedCallback(){super.connectedCallback(),await this._loadInitialData();}async _loadInitialData(){var e;if(this.hass){try{const[t,a,i]=await Promise.all([Gt(this.hass),ea(this.hass),qt(this.hass)]);this._availableModules=t,this._weatherConfig=a,this._siConfig=i,this._useWeather=a.use_weather_service,this._weatherService=null!==(e=a.weather_service)&&void 0!==e?e:Me;}catch(e){console.error("Wizard: failed to load initial data",e);}this.requestUpdate();}}_close(){this.dispatchEvent(new CustomEvent("wizard-close",{bubbles:!0,composed:!0}));}_navigate(e){this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:e},bubbles:!0,composed:!0}));}async _next(){this._error="";try{switch(this._saving=!0,this._step){case hr.Welcome:this._step=hr.Weather;break;case hr.Weather:await this._saveWeather(),this._step=hr.Module;break;case hr.Module:await this._saveModule(),this._step=hr.Mapping;break;case hr.Mapping:await this._saveMapping(),this._step=hr.Zone;break;case hr.Zone:await this._saveZone(),this._step=hr.Done;break;case hr.Done:this._close();}}catch(e){this._error=e instanceof Error?e.message:String(e);}finally{this._saving=!1,this.requestUpdate();}}_back(){this._step>hr.Welcome&&(this._step=this._step-1,this._error="");}_skipStep(){this._step<hr.Done&&(this._step=this._step+1,this._error="");}async _saveWeather(){await aa(this.hass,this._useWeather,this._useWeather?this._weatherService:null,this._apiKey||null);}async _saveModule(){if(0===this._availableModules.length)return;const e=this._availableModules[this._selectedModuleIndex],t=await Kt(this.hass,{name:e.name,description:e.description,config:Object.assign(Object.assign({},e.config),this._moduleConfig),schema:e.schema});this._savedModuleId="object"==typeof t&&(null==t?void 0:t.id)?t.id:void 0;}async _saveMapping(){const e=this._useWeather?We:Ge,t={[Ue]:{[Ke]:this._tempSource},[Ne]:{[Ke]:this._humiditySource},[He]:{[Ke]:this._precipSource}},a=["Dewpoint","Evapotranspiration","Maximum Temperature","Minimum Temperature","Current Precipitation","Pressure","Solar Radiation","Windspeed"];for(const i of a)t[i]={[Ke]:e};const i=await Jt(this.hass,{name:this._mappingName,mappings:t});this._savedMappingId="object"==typeof i&&(null==i?void 0:i.id)?i.id:void 0;}async _saveZone(){if(!this._zoneName.trim())throw new Error("Zone name is required");await Zt(this.hass,{name:this._zoneName.trim(),size:parseFloat(this._zoneSize)||0,throughput:parseFloat(this._zoneThroughput)||0,state:sa.Automatic,duration:0,bucket:0,delta:0,explanation:"",multiplier:1,module:this._savedModuleId,mapping:this._savedMappingId,lead_time:0,linked_entity:this._zoneEntity||void 0});}async _testApiKey(){if(this.hass&&!this._testingApi){this._testingApi=!0,this._testResult=null,this._testResultTimer&&clearTimeout(this._testResultTimer),this.requestUpdate();try{const e=await ta(this.hass,this._weatherService,this._apiKey||null);this._testResult=e,this._testResultTimer=window.setTimeout(()=>{this._testResult=null,this.requestUpdate();},12e3);}catch(e){this._testResult={success:!1,error:"unknown"};}finally{this._testingApi=!1,this.requestUpdate();}}}render(){var e,t;const a=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return W`
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          <div class="wizard-header">
            <span class="wizard-title">${Qs("wizard.title",a)}</span>
            <button
              class="wizard-close-btn"
              @click="${this._close}"
              title="${Qs("wizard.close",a)}"
            >
              ✕
            </button>
          </div>
          ${this._step!==hr.Welcome&&this._step!==hr.Done?W`<div class="wizard-stepper">${this._renderStepper()}</div>`:""}
    ...
    `;}_onOverlayClick(e){e.target===e.currentTarget&&this._close();}_renderStepper(){const e=["Weather","Module","Sensor Group","Zone"];return W`
      ${e.map((t,a)=>{const i=a+1,n=this._step===i,s=this._step>i;return W`
        ...
        `;})}
    `;}_renderStep(e){switch(this._step){case hr.Welcome:return this._renderWelcome(e);case hr.Weather:return this._renderWeather(e);case hr.Module:return this._renderModule(e);case hr.Mapping:return this._renderMapping(e);case hr.Zone:return this._renderZone(e);case hr.Done:return this._renderDone(e);default:return W``;}}_renderFooter(e){return this._step===hr.Done?W``:W`
      <div class="footer-left">
        ${this._step>hr.Welcome?W`<button
        ...
        ${this._step>hr.Welcome&&this._step<hr.Done?W`<button
              class="wizard-btn ghost"
              @click="${this._skipStep}"
              ?disabled="${this._saving}"
            >
              ${Qs("wizard.skip_step",e)}
            </button>`:""}
      </div>
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?Qs("common.saving-messages.saving",e):this._step===hr.Welcome||this._step<hr.Zone?Qs("wizard.next",e):Qs("wizard.finish",e)}
      </button>
    `;}_renderWelcome(e){return W`
      <h2 class="step-title">
        ${Qs("wizard.steps.welcome.title",e)}
      </h2>
      <p class="step-desc">${Qs("wizard.steps.welcome.intro",e)}</p>
      <ul class="step-list">
        <li>① ${Qs("wizard.steps.welcome.step1_label",e)}</li>
        <li>② ${Qs("wizard.steps.welcome.step2_label",e)}</li>
        <li>③ ${Qs("wizard.steps.welcome.step3_label",e)}</li>
        <li>④ ${Qs("wizard.steps.welcome.step4_label",e)}</li>
      </ul>
      <p class="step-tip">${Qs("wizard.steps.welcome.tip",e)}</p>
    `;}_renderWeather(e){var t,a,i,n,s;const r=[Me],o=this._useWeather&&!r.includes(this._weatherService);return W`
      <h2 class="step-title">
        ${Qs("wizard.steps.weather.title",e)}
      </h2>
      <p class="step-desc">
        ${Qs("wizard.steps.weather.description",e)}
      </p>

      <si-field
        label="${Qs("weather_service_config.enabled_label",e)}"
      >
        <ha-switch
      ...
      ${this._useWeather?W`
            <si-field
              label="${Qs("weather_service_config.service_label",e)}"
            >
              <select
                class="wizard-input"
              ...
              >
                ...
                >
                  ${Qs("weather_service_config.openmeteo",e)}
                </option>
                <option
                  value="${$e}"
                  ?selected="${this._weatherService===$e}"
                >
                  ${Qs("weather_service_config.owm",e)}
                </option>
                <option
                  value="${Ae}"
                  ?selected="${this._weatherService===Ae}"
                >
                  ${Qs("weather_service_config.pw",e)}
                </option>
              </select>
            </si-field>
            ...
            ${o?W`
                  <si-field
                    label="${Qs("weather_service_config.api_key_label",e)}"
                    help="${Qs("weather_service_config.api_key_help",e)}"
                  >
                    ${(this._weatherService===$e?null===(t=this._weatherConfig)||void 0===t?void 0:t.has_owm_api_key:this._weatherService===Ae&&(null===(a=this._weatherConfig)||void 0===a?void 0:a.has_pw_api_key))?W`<span class="api-badge configured"
                          >${Qs("weather_service_config.api_key_configured",e)}</span
                        >`:""}
                    <div class="api-row">
                      <input
                        type="password"
                        class="wizard-input flex1"
                        placeholder="${Qs("weather_service_config.api_key_placeholder",e)}"
                        .value="${this._apiKey}"
                      ...
                      >
                        ${this._testingApi?Qs("weather_service_config.test_button_testing",e):Qs("weather_service_config.test_button",e)}
                      </button>
                    </div>
                    ${null!==this._testResult?W`
                          <div
                            class="test-result ${this._testResult.success?"success":"error"}"
                          >
                            ${this._testResult.success?Qs("weather_service_config.test_success",e):Qs("weather_service_config.test_error_"+(null!==(s=this._testResult.error)&&void 0!==s?s:"unknown"),e)}
                          </div>
                        `:""}
                  </si-field>
                `:W`
                  <div class="info-note">
                    ${Qs("weather_service_config.no_api_key_needed",e)}
                  </div>
                `}
          `:""}
    `;}_renderModule(e){if(0===this._availableModules.length)return W`
        <h2 class="step-title">
          ${Qs("wizard.steps.module.title",e)}
        </h2>
        <p class="step-desc">
          ${Qs("wizard.steps.module.no_modules",e)}
        </p>
      `;const t=this._availableModules[this._selectedModuleIndex];return W`
      <h2 class="step-title">${Qs("wizard.steps.module.title",e)}</h2>
      <p class="step-desc">
        ${Qs("wizard.steps.module.description",e)}
      </p>

      <si-field
        label="${Qs("wizard.steps.module.pick_label",e)}"
        required
      >
        <select
          class="wizard-input"
    ...
    `;}_renderMapping(e){const t=[{value:We,label:Qs("wizard.steps.mapping.use_weather_service",e)},{value:"sensor",label:Qs("wizard.steps.mapping.use_sensor",e)},{value:"static",label:Qs("wizard.steps.mapping.use_static",e)},{value:Ge,label:Qs("wizard.steps.mapping.use_none",e)}],a=(a,i,n)=>W`
      <si-field
        label="${Qs("wizard.steps.mapping.source_label",e)} ${a}"
      >
        <select
          class="wizard-input"
    ...
    `;return W`
      <h2 class="step-title">
        ${Qs("wizard.steps.mapping.title",e)}
      </h2>
      <p class="step-desc">
        ${Qs("wizard.steps.mapping.description",e)}
      </p>

      <si-field
        label="${Qs("wizard.steps.mapping.name_label",e)}"
        required
      >
        <input
          type="text"
      ...
      ${a(Qs("panels.mappings.cards.mapping.items.temperature",e)||"Temperature",this._tempSource,e=>{this._tempSource=e,this.requestUpdate();})}
      ${a(Qs("panels.mappings.cards.mapping.items.humidity",e)||"Humidity",this._humiditySource,e=>{this._humiditySource=e,this.requestUpdate();})}
      ${a(Qs("panels.mappings.cards.mapping.items.precipitation",e)||"Precipitation",this._precipSource,e=>{this._precipSource=e,this.requestUpdate();})}

      <p class="step-tip">
        ${Qs("wizard.steps.mapping.description",e)}
      </p>
    `;}_renderZone(e){var t;const a="imperial"!==(null===(t=this._siConfig)||void 0===t?void 0:t.units),i=a?"m²":at,n=a?it:nt;return W`
      <h2 class="step-title">${Qs("wizard.steps.zone.title",e)}</h2>
      <p class="step-desc">
        ${Qs("wizard.steps.zone.description",e)}
      </p>

      <si-field
        label="${Qs("wizard.steps.zone.name_label",e)}"
        required
      >
        <input
          type="text"
      ...
      <si-field
        label="${Qs("wizard.steps.zone.size_label",e)}"
        unit="${i}"
        help="${Qs("field_help.zone_size",e)}"
      >
        <input
          type="number"
          class="wizard-input"
      ...
      <si-field
        label="${Qs("wizard.steps.zone.throughput_label",e)}"
        unit="${n}"
        help="${Qs("field_help.zone_throughput",e)}"
      >
        <input
          type="number"
          class="wizard-input"
      ...
      <si-field
        label="${Qs("wizard.steps.zone.entity_label",e)}"
        help="${Qs("field_help.zone_linked_entity",e)}"
      >
        <ha-entity-picker
          .hass="${this.hass}"
    ...
    `;}_renderDone(e){return W`
      <div class="done-wrapper">
        ...
        <h2 class="step-title">${Qs("wizard.steps.done.title",e)}</h2>
        <p class="step-desc">
          ${Qs("wizard.steps.done.description",e)}
        </p>
        <ul class="step-list">
          <li>${Qs("wizard.steps.done.tip1",e)}</li>
          <li>${Qs("wizard.steps.done.tip2",e)}</li>
          <li>${Qs("wizard.steps.done.tip3",e)}</li>
        </ul>
        <div class="done-actions">
          ...
          >
            ${Qs("wizard.steps.done.go_zones",e)}
          </button>
          <button
            class="wizard-btn secondary"
            @click="${()=>{this._close(),this._navigate("setup");}}"
          >
            ${Qs("wizard.steps.done.go_setup",e)}
          </button>
        </div>
      </div>
    `;}static get styles(){return c`
    ...
    `;}};n([he({attribute:!1})],gr.prototype,"hass",void 0),n([ge()],gr.prototype,"_step",void 0),n([ge()],gr.prototype,"_saving",void 0),n([ge()],gr.prototype,"_error",void 0),n([ge()],gr.prototype,"_siConfig",void 0),n([ge()],gr.prototype,"_useWeather",void 0),n([ge()],gr.prototype,"_weatherService",void 0),n([ge()],gr.prototype,"_apiKey",void 0),n([ge()],gr.prototype,"_testingApi",void 0),n([ge()],gr.prototype,"_testResult",void 0),n([ge()],gr.prototype,"_availableModules",void 0),n([ge()],gr.prototype,"_selectedModuleIndex",void 0),n([ge()],gr.prototype,"_moduleConfig",void 0),n([ge()],gr.prototype,"_mappingName",void 0),n([ge()],gr.prototype,"_tempSource",void 0),n([ge()],gr.prototype,"_humiditySource",void 0),n([ge()],gr.prototype,"_precipSource",void 0),n([ge()],gr.prototype,"_zoneName",void 0),n([ge()],gr.prototype,"_zoneSize",void 0),n([ge()],gr.prototype,"_zoneThroughput",void 0),n([ge()],gr.prototype,"_zoneEntity",void 0),gr=n([ce("si-setup-wizard")],gr);var mr;!function(e){e.General="general",e.Modules="modules",e.Mappings="mappings",e.Schedules="schedules",e.Help="help";}(mr||(mr={}));const vr={[mr.General]:"panels.general.title",[mr.Modules]:"panels.modules.title",[mr.Mappings]:"panels.mappings.title",[mr.Schedules]:"panels.schedules.title",[mr.Help]:"panels.help.title"};let fr=class extends de{constructor(){super(...arguments),this._activeTab=mr.General,this._wizardOpen=!1;}_openWizard(){this._wizardOpen=!0;}_onWizardClose(){this._wizardOpen=!1;}_onWizardNavigate(e){const{page:t}=e.detail;this.dispatchEvent(new CustomEvent("wizard-navigate",{detail:{page:t},bubbles:!0,composed:!0})),this._wizardOpen=!1;}render(){return this.hass?W`
      ${this._wizardOpen?W`
            <si-setup-wizard
              .hass="${this.hass}"
      ...
      <div class="setup-container">
        <nav class="setup-nav">
          ${Object.values(mr).map(e=>W`
              <button
                class="setup-nav-btn ${this._activeTab===e?"active":""}"
                @click="${()=>{this._activeTab=e;}}"
              >
                ${Qs(vr[e],this.hass.language)}
              </button>
            `)}
          <button
            class="setup-nav-btn wizard-btn"
            @click="${this._openWizard}"
            title="${Qs("wizard.title",this.hass.language)}"
          >
            ✦ ${Qs("wizard.open_button",this.hass.language)}
          </button>
        </nav>
        <div class="setup-content">${this._renderContent()}</div>
      </div>
    `:W``;}_renderContent(){if(!this.hass)return W``;switch(this._activeTab){case mr.General:return W`<smart-irrigation-view-general
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-general>`;case mr.Modules:return W`<smart-irrigation-view-modules
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-modules>`;case mr.Mappings:return W`<smart-irrigation-view-mappings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-mappings>`;case mr.Schedules:return W`<smart-irrigation-view-schedules
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-schedules>`;case mr.Help:return this._renderHelp();}}_renderHelp(){return this.hass?W`
      <ha-card
        header="${Qs("panels.help.cards.how-to-get-help.title",this.hass.language)}"
      >
        <div class="card-content">
          ${Qs("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)}
          <a href="${"https://justchr.github.io/HAsmartirrigation/"}"
            >${Qs("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
          >.
          ${Qs("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
          <a
            href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
            >${Qs("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
          >
          ${Qs("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
          <a href="${"https://github.com/JustChr/HAsmartirrigation/issues"}"
            >${Qs("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
          >
          (${Qs("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
        </div>
      </ha-card>
    ...
    `;}};n([he({attribute:!1})],fr.prototype,"hass",void 0),n([he({type:Boolean})],fr.prototype,"narrow",void 0),n([he()],fr.prototype,"_activeTab",void 0),n([ge()],fr.prototype,"_wizardOpen",void 0),fr=n([ce("smart-irrigation-view-setup")],fr);const _r=ra,br=()=>{const e=e=>{let t={};for(let a=0;a<e.length;a+=2){const i=e[a],n=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:n});}return t;},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex(e=>"filter"==e),n=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(n)});}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})));}return a;},yr=(e,...t)=>{let a={page:e,params:{}};t.forEach(e=>{"string"==typeof e?a=Object.assign(Object.assign({},a),{subpage:e}):"params"in e?a=Object.assign(Object.assign({},a),{params:e.params}):"filter"in e&&(a=Object.assign(Object.assign({},a),{filter:e.filter}));});const i=e=>{let t=Object.keys(e);t=t.filter(t=>e[t]),t.sort();let a="";return t.forEach(t=>{const i=e[t];a=a.length?`${a}/${t}/${i}`:`${t}/${i}`;}),a;};let n=`/${Se}/${a.page}`;return a.subpage&&(n=`${n}/${a.subpage}`),i(a.params).length&&(n=`${n}/${i(a.params)}`),a.filter&&(n=`${n}/filter/${i(a.filter)}`),n;};var wr;!function(e){e.Zones="zones",e.Setup="setup";}(wr||(wr={})),e.SmartIrrigationPanel=class extends de{constructor(){super(...arguments),this._wizardOpen=!1,this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100;}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate();}));}async firstUpdated(){Bt(0,yr(wr.Zones)),window.addEventListener("location-changed",()=>{if(!window.location.pathname.includes("smart-irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate());}),be().then(()=>{this._scheduleUpdate();}).catch(e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate();});}render(){const e=br(),t=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return W`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
            .narrow=${this.narrow}
          ></ha-menu-button>
          <div class="main-title">${Qs("title",this.hass.language)}</div>
          <div class="version">${ze}</div>
        </div>

        ${t&&a?W`
              <ha-tab-group @wa-tab-show=${this.handlePageSelected}>
                ${Object.values(wr).map(t=>W`
                    <ha-tab-group-tab
                      slot="nav"
                      panel="${t}"
                      .active=${e.page===t}
                    >
                      ${Qs(`panels.${t}.title`,this.hass.language)}
                    </ha-tab-group-tab>
                  `)}
              </ha-tab-group>
            `:W`
    ...
    `;}getView(e){switch(e.page){case"zones":default:return W`
        ...
        `;case"setup":return W`
          ...
          ></smart-irrigation-view-setup>
        `;}}navigateToPage(e){if(e!==br().page){const t=yr(e);Bt(0,t),this.requestUpdate();}else scrollTo(0,0);}handlePageSelected(e){const t=e.detail.name;if(t!==br().page){const e=yr(t);Bt(0,e),this.requestUpdate();}else scrollTo(0,0);}static get styles(){return[_r,c`
        :host {
          color: var(--primary-text-color);
    ...
    `;}};n([he({attribute:!1})],kr.prototype,"hass",void 0),n([ge()],kr.prototype,"_params",void 0),kr=n([ce("error-dialog")],kr);var zr=Object.freeze({__proto__:null,get ErrorDialog(){return kr;}});Object.defineProperty(e,"__esModule",{value:!0});}({});

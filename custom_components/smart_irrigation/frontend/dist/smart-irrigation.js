...
`;const on=e=>String(e).padStart(2,"0");function rn(e){return e instanceof Date?e:new Date(e)}function ln(e){const t=rn(e);return`${on(t.getHours())}:${on(t.getMinutes())}`}function dn(e){const t=rn(e);return`${t.getFullYear()}-${on(t.getMonth()+1)}-${on(t.getDate())} ${on(t.getHours())}:${on(t.getMinutes())}`}function cn(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class hn extends(Qa(ce)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){ei().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const s=Object.values(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).some(e=>!0!==e.queued&&!0!==e.paused);s&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):s||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:be+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[s,i,a,n]=await Promise.all([Ns(this.hass),Ls(this.hass),(t=this.hass,t.callWS({type:be+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),Gs(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=s,this.zones=i,this._outlook=a,this._distributors=n,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),Ya(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",be+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),Ya(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",be+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),Ya(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const s="all"===t,i=s?void 0:this.zones.find(e=>{var s;return(null===(s=e.id)||void 0===s?void 0:s.toString())===t}),a=s?`(${this._linkedZoneCount})`:`: ${null!==(e=null==i?void 0:i.name)&&void 0!==e?e:t}`;try{await(n=this.hass,o=s?void 0:t,n.callWS(Object.assign({type:be+"/irrigate_now"},void 0!==o?{zone_id:o}:{}))),Va(this,`${Ua("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${a}`)}catch(e){const t=Ga(e);console.error("irrigate_now failed",e),Va(this,`${Ua("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var n,o}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const s=new Date(t);return s.getTime()>Date.now()?s:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:be+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),Ya(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:be+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),Ya(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,s;const i=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(s=this._runMinutes[i])&&void 0!==s?s:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const s=this._zoneDistributor(e);return!!s&&Object.keys(null!==(t=s.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var s,i,a;if(t>0)try{await(s=this.hass,i=e.id.toString(),a=t,s.callWS({type:be+"/run_zone",zone_id:i,duration:a})),Va(this,`${Ua("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=Ga(e);console.error("run_zone failed",e),Va(this,`${Ua("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,s;if(void 0!==e.id)return null===(s=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===s?void 0:s[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,s;if(this.hass&&void 0!==e.id)try{await(t=this.hass,s=e.id.toString(),t.callWS({type:be+"/stop_zone",zone_id:s})),Va(this,`${Ua("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=Ga(e);console.error("stop_zone failed",e),Va(this,`${Ua("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",be+"/zones",{id:i,calculate:!0,override_cache:!0})).catch(e=>{const t=Ga(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var s,i;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(s=this.hass,i=t.id.toString(),s.callApi("POST",be+"/zones",{id:i,update:!0})).catch(e=>{const t=Ga(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;qa(0,t?an("setup","zones",t):an("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,s,i;const a=null!==(t=e.duration)&&void 0!==t?t:0,n=Number(null!==(s=e.bucket_threshold)&&void 0!==s?s:0),o=this._zoneEstimate(e),r=o&&o.available&&null!=o.live_deficit?o.live_deficit:Number(null!==(i=e.bucket)&&void 0!==i?i:0);return a>0&&r<n}_zoneRunDuration(e){var t,s;const i=this._zoneEstimate(e);return(null===(t=this.config)||void 0===t?void 0:t.live_estimate_enabled)&&i&&i.available&&null!=i.live_deficit&&null!=i.live_duration?{seconds:i.live_duration,live:!0}:{seconds:null!==(s=e.duration)&&void 0!==s?s:0,live:!1}}_zoneWillWater(e){var t;const s=this._zoneRunDuration(e);if(!s.live)return this._zoneHasDeficit(e);const i=Number(null!==(t=e.bucket_threshold)&&void 0!==t?t:0);return this._zoneEstimate(e).live_deficit<i&&s.seconds>0}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,s=new Date(e),i=ln(s),a=new Date;return cn(s,a)?`${Ua("panels.zones.outlook.today",t)} ${i}`:cn(s,function(e,t){const s=new Date(e.getTime());return s.setDate(s.getDate()+t),s}(a,1))?`${Ua("panels.zones.outlook.tomorrow",t)} ${i}`:function(e,t){const s=rn(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(s)} ${ln(s)}`}(s,t)}_renderEstimatedTag(e){if(!this.hass||!e.estimated)return W``;const t=this.hass.language;return W`<span
    ...
    `}_renderZoneDecision(e){if(!this.hass)return W``;const t=this.hass.language;let s,i,a,n;if(e.state===tn.Disabled)s=Ua("panels.zones.status.decision_disabled",t),i="neutral",a="mdi:power-off";else if(e.last_calculated)if(this._zoneWillWater(e)){const o=Ka(this._zoneRunDuration(e).seconds),r=this._triggeredGuards,l=this._nextIrrigateRunForZone(e);r.length>0?(s=Ua("panels.zones.status.decision_water_skip",t,"{duration}",o,"{reason}",this._guardLabel(r[0]).toLowerCase()),i="skip",a="mdi:weather-rainy"):l&&l.next_run_utc?(s=Ua("panels.zones.status.decision_water_at",t,"{duration}",o,"{time}",this._formatRunTime(l.next_run_utc)),i="water",a="mdi:water",n=l):(s=Ua("panels.zones.status.decision_water_no_schedule",t,"{duration}",o),i="water",a="mdi:water-alert")}else s=Ua("panels.zones.status.decision_no_water",t),i="ok",a="mdi:check-circle-outline";else s=Ua("panels.zones.status.decision_unknown",t),i="unknown",a="mdi:help-circle-outline";return W`
    ...
    `}_renderZoneNextRun(e){if(!this.hass)return W``;const t=this._nextIrrigateRunForZone(e);if(!t||!t.next_run_utc)return W``;return e.state!==tn.Disabled&&e.last_calculated&&this._zoneWillWater(e)&&0===this._triggeredGuards.length?W``:W`
      <span class="status-sep">·</span>
      <span>
    ...
    `}static get styles(){return[nn,r`
      ...
      `]}};t([me({attribute:!1})],vn.prototype,"hass",void 0),t([me({attribute:!1})],vn.prototype,"zone",void 0),t([me({attribute:!1})],vn.prototype,"config",void 0),vn=t([ue("si-zone-history")],vn);let fn=class extends(Qa(ce)){constructor(){super(...arguments),this._zones=[],this._isLoading=!0,this._initialLoadDone=!1}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:be+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{const[e,t]=await Promise.all([Ns(this.hass),Ls(this.hass)]);this._config=e,this._zones=t,this._initialLoadDone=!0}catch(e){console.error("Error fetching data:",e),Ya(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this._isLoading=!1)}}get _linkedZoneId(){var e,t;const s=null===(t=null===(e=this.path)||void 0===e?void 0:e.params)||void 0===t?void 0:t.zone;return null!=s&&""!==s?Number(s):null}_effectiveZone(){var e,t;if(!this._zones.length)return;const s=e=>null==e?void 0:this._zones.find(t=>t.id===e);return null!==(t=null!==(e=s(this._selectedZoneId))&&void 0!==e?e:s(this._linkedZoneId))&&void 0!==t?t:this._zones[0]}render(){if(!this.hass)return W``;const e=this.hass.language;if(this._isLoading)return W`
    ...
    `}static get styles(){return[nn,r`
      ...
      `]}};t([me({attribute:!1})],fn.prototype,"hass",void 0),t([me({type:Boolean})],fn.prototype,"narrow",void 0),t([me({attribute:!1})],fn.prototype,"path",void 0),t([ve()],fn.prototype,"_zones",void 0),t([ve()],fn.prototype,"_config",void 0),t([ve()],fn.prototype,"_selectedZoneId",void 0),t([ve()],fn.prototype,"_isLoading",void 0),fn=t([ue("smart-irrigation-view-history")],fn);
/**
     * @license
...
/**
    ...
    `}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await Rs(this.hass,e)}_renderModuleOptions(e){if(!this.hass)return W``;const t=null!=e?String(e):"";return W`
    ...
    `}handleSimpleSourceChange(e,t,s){const i=this.mappings[e],a=s.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[t]:Object.assign(Object.assign({},i.mappings[t]),{[Ye]:a,[Xe]:""})})}))}handleSimpleInputChange(e,t,s,i){const a=this.mappings[e],n=i.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},a),{mappings:Object.assign(Object.assign({},a.mappings),{[t]:Object.assign(Object.assign({},a.mappings[t]),{[s]:n})})}))}renderMappingInputs(e,t,s){if(!this.hass)return W``;const i=s[Ye];return W`
      ...
      ${t!==Re||i!==Ze&&i!==We?"":this.renderPressureTypeSelect(e,t,s)}
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return W`<option value="${e}" ?selected="${e===t}">
        ...
        </option>`,e}return W``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return W``;const s=function(e){switch(e){case He:case Ue:return[{unit:"°C",system:Me},{unit:"°F",system:De}];case Pe:case Ie:return[{unit:ot,system:Me},{unit:rt,system:De}];case Le:return[{unit:ht,system:Me},{unit:ut,system:De}];case Ne:return[{unit:"%",system:[Me,De]}];case Re:return[{unit:"millibar",system:Me},{unit:"hPa",system:Me},{unit:"psi",system:De},{unit:lt,system:De}];case je:return[{unit:"km/h",system:Me},{unit:ct,system:Me},{unit:dt,system:De}];case Be:return[{unit:"W/m2",system:Me},{unit:"MJ/day/m2",system:Me},{unit:"W/sq ft",system:De},{unit:"MJ/day/sq ft",system:De}];default:return[]}}(e);let i=t[Qe];const a=this.config.units;if(!t[Qe])for(const e of s)if("string"==typeof e.system){if(a===e.system){i=e.unit;break}}else{for(const t of e.system)if(a===t.system){i=e.unit;break}if(i===e.unit)break}return W`
      ${s.map(e=>W`
  ...
  ${Array.from({length:8},(e,t)=>{const s=t*Math.PI/4,i=(12+6.6*Math.cos(s)).toFixed(1),a=(12+6.6*Math.sin(s)).toFixed(1),n=(12+9.2*Math.cos(s)).toFixed(1),o=(12+9.2*Math.sin(s)).toFixed(1);return q`<line x1="${i}" y1="${a}" x2="${n}" y2="${o}" />`})}`,uo=q`<path d="M13.5,2.5A9.5,9.5 0 1,0 21.5,14 7.6,7.6 0 0,1 13.5,2.5Z" />`,po=q`<path d="M12,2.6C12,2.6 18.6,9.4 18.6,13.7A6.6,6.6 0 0,1 5.4,13.7C5.4,9.4 12,2.6 12,2.6Z" />`;let go=class extends ce{constructor(){super(...arguments),this.recurrence="daily",this.nominalDemandSeconds=0}_sunTimes(){var e,t,s,i,a,n;const o=null===(t=null===(e=this.hass)||void 0===e?void 0:e.states)||void 0===t?void 0:t["sun.sun"],r=null===(s=null==o?void 0:o.attributes)||void 0===s?void 0:s.next_rising,l=null===(i=null==o?void 0:o.attributes)||void 0===i?void 0:i.next_setting,d=null===(n=null===(a=this.hass)||void 0===a?void 0:a.config)||void 0===n?void 0:n.time_zone,c=(e,t)=>{if(!e)return t;const s=new Date(e);return isNaN(s.getTime())?t:Kn(qn(d,s))};return{sunrise:c(r,360),sunset:c(l,1200)}}_azimuthResolver(){var e;return Vn(null===(e=this.hass)||void 0===e?void 0:e.config,new Date)}_renderRun(e,t){return e.wraps?q`
    ...
    ${this._renderButtons(e)}`;return"content"===this._actionSlot?W`
      ...
      `:W` <div slot="footer" class="dialog-footer">${t}</div> `}static get styles(){return[nn,r`
    ...
    `}getView(e){switch(e.page){case"zones":default:return W`
        ...
        `;case"setup":return W`
          <smart-irrigation-view-setup
            ...
            @open-wizard="${()=>{this._wizardOpen=!0}}"
          ></smart-irrigation-view-setup>
        `}}navigateToPage(e){if(e!==sn().page){const t=an(e);qa(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==sn().page){const e=an(t);qa(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[Ao,r`
        :host {
          color: var(--primary-text-color);

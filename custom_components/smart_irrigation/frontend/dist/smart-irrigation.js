...
`;const Va=e=>String(e).padStart(2,"0");function Ya(e){return e instanceof Date?e:new Date(e)}function Xa(e){const t=Ya(e);return`${Va(t.getHours())}:${Va(t.getMinutes())}`}function Ja(e){const t=Ya(e);return`${t.getFullYear()}-${Va(t.getMonth()+1)}-${Va(t.getDate())} ${Va(t.getHours())}:${Va(t.getMinutes())}`}function Qa(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class es extends(ja(le)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){be().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:ye+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[i,a,s]=await Promise.all([Ca(this.hass),Ha(this.hass),(t=this.hass,t.callWS({type:ye+"/irrigation_outlook"})).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)})]);this.config=i,this.zones=a,this._outlook=s,this._initialLoadDone=!0}catch(e){console.error("Error fetching data:",e),Sa(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",ye+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),Sa(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",ye+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),Sa(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return e.linked_entity&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const i="all"===t,a=i?void 0:this.zones.find(e=>{var i;return(null===(i=e.id)||void 0===i?void 0:i.toString())===t}),s=i?`(${this._linkedZoneCount})`:`: ${null!==(e=null==a?void 0:a.name)&&void 0!==e?e:t}`;try{await(n=this.hass,o=i?void 0:t,n.callWS(Object.assign({type:ye+"/irrigate_now"},void 0!==o?{zone_id:o}:{}))),za(this,`${ba("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${s}`)}catch(e){const t=ka(e);console.error("irrigate_now failed",e),za(this,`${ba("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var n,o}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const i=new Date(t);return i.getTime()>Date.now()?i:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:ye+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),Sa(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:ye+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),Sa(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,i;const a=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(i=this._runMinutes[a])&&void 0!==i?i:10}async _runZoneFor(e){if(!this.hass||!e.linked_entity||void 0===e.id)return;const t=this._zoneRunMinutes(e);var i,a,s;if(t>0)try{await(i=this.hass,a=e.id.toString(),s=t,i.callWS({type:ye+"/run_zone",zone_id:a,duration:s})),za(this,`${ba("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=ka(e);console.error("run_zone failed",e),za(this,`${ba("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var i,a;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,a=t.id.toString(),i.callApi("POST",ye+"/zones",{id:a,calculate:!0,override_cache:!0})).catch(e=>{const t=ka(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var i,a;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,a=t.id.toString(),i.callApi("POST",ye+"/zones",{id:a,update:!0})).catch(e=>{const t=ka(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;xa(0,t?qa("setup","zones",t):qa("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,i,a;const s=null!==(t=e.duration)&&void 0!==t?t:0,n=Number(null!==(i=e.bucket_threshold)&&void 0!==i?i:0),o=this._zoneEstimate(e),r=o&&o.available&&null!=o.live_deficit?o.live_deficit:Number(null!==(a=e.bucket)&&void 0!==a?a:0);return s>0&&r<n}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,i=new Date(e),a=Xa(i),s=new Date;return Qa(i,s)?`${ba("panels.zones.outlook.today",t)} ${a}`:Qa(i,function(e,t){const i=new Date(e.getTime());return i.setDate(i.getDate()+t),i}(s,1))?`${ba("panels.zones.outlook.tomorrow",t)} ${a}`:function(e,t){const i=Ya(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(i)} ${Xa(i)}`}(i,t)}_guardLabel(e){return ba(`panels.zones.outlook.checks.${e.id}`,this.hass.language)}_guardDetail(e){var t;return e.available&&null!==e.observed?ba(`panels.zones.outlook.check_detail.${e.id}`,this.hass.language,"{observed}",String(e.observed),"{threshold}",String(null!==(t=e.threshold)&&void 0!==t?t:"")):""}_renderSkipReasons(){const e=this.hass.language;return W`
      ...
      <div class="outlook-line outlook-dim skip-reasons-note">
        ${ba("panels.zones.outlook.provisional",e)}
      </div>
    `}_openSchedules(){xa(0,qa("setup","when-to-water"))}_runActionLabel(e){return ba(`panels.zones.outlook.actions.${e.action}`,this.hass.language)}_runTargetsLabel(e){const t=this.hass.language;if("all"===e.zones)return ba("panels.zones.outlook.targets_all",t);const i=Array.isArray(e.zones)?e.zones.length:0;return ba("panels.zones.outlook.targets_zones",t,"{count}",String(i))}_renderOutlookBanner(){if(!this.hass||!this._outlook)return W``;const e=this.hass.language,t=this._nextIrrigateRun,i=this._triggeredGuards,a=this._outlook.last_skip_evaluation;return t&&t.next_run_utc?W`
      <ha-card class="outlook-card">
        <div class="outlook">
          <div class="outlook-line outlook-headline">
            ...
            <span>
              <strong
                >${ba("panels.zones.outlook.next_run",e)}:</strong
              >
          ...
          ${i.length>0?W`
                <div class="outlook-line outlook-skip">
                  ...
                  <span
                    >${ba("panels.zones.outlook.will_skip",e)}</span
                  >
                  <button
                    class="outlook-info-btn"
                    aria-expanded="${this._skipDetailsOpen}"
                    title="${ba("panels.zones.outlook.why_skipped",e)}"
                  ...
                  >
                    ...
                    <span class="outlook-info-label"
                      >${ba("panels.zones.outlook.why_skipped",e)}</span
                    >
                  </button>
                </div>
              ...
              `:W`
                <div class="outlook-line outlook-clear">
                  ...
                  <span
                    >${ba("panels.zones.outlook.will_run",e)}</span
                  >
                </div>
              `}
    ...
    `:W`
        <ha-card class="outlook-card">
          <div class="outlook">
            <div class="outlook-line outlook-headline">
              ...
              <span>${ba("panels.zones.outlook.no_schedule",e)}</span>
              ${this.hideSettingsLinks?"":W`
                    <button
                      class="outlook-link"
                      @click="${this._openSchedules}"
                    >
                      ${ba("panels.zones.outlook.setup_schedule",e)}
                    </button>
                  `}
            </div>
            ${a?this._renderLastRunLine(a):""}
        ...
        <ha-card class="rain-delay-card paused">
          <div class="rain-delay">
            ...
            <span class="rain-delay-msg">
              <strong
                >${ba("panels.zones.rain_delay.paused",e)}</strong
              >
              ${ba("panels.zones.rain_delay.until",e)}
              ${Ja(t.toISOString())}
            </span>
            <button class="action-btn" @click="${()=>this._clearRainDelay()}">
              <ha-icon icon="mdi:play"></ha-icon>
              ${ba("panels.zones.rain_delay.resume",e)}
            </button>
          </div>
        </ha-card>
      `:W`
      <div class="rain-delay-row">
        <span class="rain-delay-label">
          ...
          ${ba("panels.zones.rain_delay.title",e)}
        </span>
        <button class="action-btn" @click="${()=>this._setRainDelay(24)}">
          ${ba("panels.zones.rain_delay.delay_24h",e)}
        </button>
        <button class="action-btn" @click="${()=>this._setRainDelay(48)}">
          ${ba("panels.zones.rain_delay.delay_48h",e)}
        </button>
      </div>
    `}_renderLastRunLine(e){const t=this.hass.language,i=function(e,t){const i=Ya(e).getTime()-Date.now(),a=new Intl.RelativeTimeFormat(t,{numeric:"auto"}),s=Math.round(i/1e3);if(Math.abs(s)<60)return a.format(s,"second");const n=Math.round(s/60);if(Math.abs(n)<60)return a.format(n,"minute");const o=Math.round(n/60);if(Math.abs(o)<24)return a.format(o,"hour");const r=Math.round(o/24);if(Math.abs(r)<30)return a.format(r,"day");const l=Math.round(r/30);return Math.abs(l)<12?a.format(l,"month"):a.format(Math.round(l/12),"year")}(e.timestamp,t),a=e.checks.filter(e=>e.enabled&&e.would_skip).map(e=>this._guardLabel(e).toLowerCase()).join(", "),s=e.would_skip?`${ba("panels.zones.outlook.last_run_skipped",t)}${a?` (${a})`:""}`:ba("panels.zones.outlook.last_run_ran",t);return W`
      <div class="outlook-line outlook-last">
        <span class="outlook-dim"
          >${ba("panels.zones.outlook.last_run",t)}:</span
        >
        <span>${s} · ${i}</span>
      </div>
    `}_renderZoneDecision(e){var t;if(!this.hass)return W``;const i=this.hass.language,a=null!==(t=e.duration)&&void 0!==t?t:0;let s,n,o;if(e.state===Za.Disabled)s=ba("panels.zones.status.decision_disabled",i),n="neutral",o="mdi:power-off";else if(e.last_calculated)if(this._zoneHasDeficit(e)){const t=function(e){const t=Math.round(e);if(t<60)return`${t} s`;const i=Math.floor(t/60),a=t%60;return a?`${i} min ${a} s`:`${i} min`}(a),r=this._triggeredGuards,l=this._nextIrrigateRunForZone(e);r.length>0?(s=ba("panels.zones.status.decision_water_skip",i,"{duration}",t,"{reason}",this._guardLabel(r[0]).toLowerCase()),n="skip",o="mdi:weather-rainy"):l&&l.next_run_utc?(s=ba("panels.zones.status.decision_water_at",i,"{duration}",t,"{time}",this._formatRunTime(l.next_run_utc)),n="water",o="mdi:water"):(s=ba("panels.zones.status.decision_water_no_schedule",i,"{duration}",t),n="water",o="mdi:water-alert")}else s=ba("panels.zones.status.decision_no_water",i),n="ok",o="mdi:check-circle-outline";else s=ba("panels.zones.status.decision_unknown",i),n="unknown",o="mdi:help-circle-outline";return W`
      <div class="zone-decision ${n}">
        <ha-icon icon="${o}"></ha-icon>
        <span>${s}</span>
      </div>
    `}_zoneEstimate(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_estimates)||void 0===i?void 0:i[String(e.id)]}_zoneFault(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_faults)||void 0===i?void 0:i[String(e.id)]}_renderZoneFault(e){if(!this.hass)return W``;const t=this._zoneFault(e);if(!t)return W``;const i=this.hass.language,a=ba(`panels.zones.fault.${t.reason}`,i)||ba("panels.zones.fault.generic",i),s=t.timestamp?Ja(t.timestamp):"";return W`
      <div class="zone-fault" title="${s}">
        <ha-icon icon="mdi:alert-circle"></ha-icon>
        <span>
          <strong>${ba("panels.zones.fault.title",i)}</strong>
          — ${a}
        </span>
      </div>
    `}_renderZoneEstimate(e){if(!this.hass)return W``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return W``;const i=this.hass.language,a=wa(this.config,ft),s=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",n=ba(`panels.zones.status.estimate_method.${"proxy"===t.method?"proxy":"hourly"}`,i)+(t.as_of?` · ${Xa(t.as_of)}`:"");return W`
      <span class="status-sep">·</span>
      <span class="zone-estimate" title="${n}">
        ${ba("panels.zones.status.estimate_now",i)}
        <strong style="color: ${s}"
          >≈ ${t.live_deficit.toFixed(2)} ${a}</strong
        >
        <span class="estimate-tag"
          >${ba("panels.zones.status.estimate_tag",i)}</span
        >
      </span>
      ...
      <ha-card>
        <div class="card-header">
          ...
          ${this.hideSettingsLinks?"":W`
                <ha-icon-button
                  ...
                  title="${ba("panels.zones.actions.open_settings",this.hass.language)}"
        ...
        <div class="card-content">
          <div class="zone-status-line">
            <span
              title="${ba("panels.zones.help.bucket",this.hass.language)}"
            >
              ${ba("panels.zones.labels.bucket",this.hass.language)}:
            ...
            <span class="status-sep">·</span>
            <span>
              ${ba("panels.zones.status.last_checked",this.hass.language)}:
              <strong>${r}</strong>
            </span>
        ...
        <div class="card-content zone-action-bar">
          ${"full"===this.actionsMode&&e.state===Za.Automatic?W`
                <button
                  class="action-btn"
                  title="${ba("panels.zones.help.update",this.hass.language)}"
                  @click="${()=>this.handleUpdateZone(t)}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:update"></ha-icon>
                  ${ba("panels.zones.actions.update",this.hass.language)}
                </button>
                <button
                  class="action-btn"
                  title="${ba("panels.zones.help.calculate",this.hass.language)}"
                  @click="${()=>this.handleCalculateZone(t)}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:calculator"></ha-icon>
                  ${ba("panels.zones.actions.calculate",this.hass.language)}
                </button>
              `:""}
          ${"none"!==this.actionsMode&&e.linked_entity&&(null!==(a=e.duration)&&void 0!==a?a:0)>0?W`
                ...
                >
                  ...
                  ${ba("panels.zones.labels.irrigate_now",this.hass.language)}
                </button>
              `:e.linked_entity?"":W`
                  <button
                    class="action-btn"
                    disabled
                    title="${ba("panels.zones.help.irrigate_link_entity",this.hass.language)}"
                  >
                    <ha-icon icon="mdi:water"></ha-icon>
                    ${ba("panels.zones.labels.irrigate_now",this.hass.language)}
                  </button>
                  <span class="zones-top-note">
                    ${ba("panels.zones.help.irrigate_link_entity",this.hass.language)}
                  </span>
                `}
    ...
    `}_renderRunZoneControl(e){if(!this.hass||"none"===this.actionsMode||!e.linked_entity||void 0===e.id)return W``;const t=this.hass.language,i=String(e.id);return W`
      <div
        ...
        title="${ba("panels.zones.run_zone.help",t)}"
      >
        <input
        ...
        <span class="run-zone-unit"
          >${ba("panels.zones.run_zone.minutes",t)}</span
        >
        <button
          class="action-btn"
        ...
        >
          ...
          ${ba("panels.zones.run_zone.run",t)}
        </button>
      </div>
    `}render(){var e,t;if(!this.hass)return W``;if(this.isLoading)return W`
        <ha-card header="${ba("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            <div class="loading-indicator">
              ${ba("common.loading-messages.general",this.hass.language)}
            </div>
          </div>
        </ha-card>
      ...
      ${a?this.hideSettingsLinks?W`
              <ha-card>
                <div class="card-content description-text">
                  ${ba("panels.zones.no_items",this.hass.language)}
                </div>
              </ha-card>
            `:W`
                ...
                <div class="setup-banner">
                  ...
                  <div class="setup-banner-content">
                    <div class="setup-banner-title">
                      ${ba("wizard.title",this.hass.language)}
                    </div>
                    <div class="setup-banner-desc">
                      ${ba("wizard.setup_complete_banner",this.hass.language)}
                    </div>
                  </div>
                  <button
                  ...
                  >
                    ${ba("wizard.open_wizard",this.hass.language)}
                  </button>
                </div>
              </ha-card>
            `:""}
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${ba("panels.zones.title",this.hass.language)}
          </div>
        </div>
        <div class="card-content zones-top-actions">
          ${"full"===this.actionsMode?W`
                <button
                  class="action-btn"
                  title="${ba("panels.zones.help.update_all",this.hass.language)}"
                  @click="${this.handleUpdateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:update"></ha-icon>
                  ${ba("panels.zones.cards.zone-actions.actions.update-all",this.hass.language)}
                </button>
                <button
                  class="action-btn"
                  title="${ba("panels.zones.help.calculate_all",this.hass.language)}"
                  @click="${this.handleCalculateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:calculator"></ha-icon>
                  ${ba("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language)}
                </button>
              `:""}
          ${"none"!==this.actionsMode?W`
                <button
                  class="action-btn"
                  raised
                  title="${ba("panels.zones.help.irrigate_all",this.hass.language)}"
                  @click="${()=>{this._confirmIrrigate="all"}}"
                  ?disabled="${!i||this.isSaving}"
                >
                  <ha-icon icon="mdi:water"></ha-icon>
                  ${ba("panels.zones.actions.irrigate_all",this.hass.language)}
                </button>
              `:""}
          ${i?"":W`<span class="zones-top-note"
                >${ba("panels.info.cards.irrigate_now.no_linked_zones",this.hass.language)}</span
              >`}
        </div>
      </ha-card>
      ...
      ${null!==this._confirmIrrigate?W`
            <ha-dialog
              ...
              heading="${ba("panels.zones.confirm_irrigate.title",this.hass.language)}"
            >
              <p>
                ${ba("panels.zones.confirm_irrigate.body",this.hass.language)}
              </p>
              <p>
                <strong>
                  ${"all"===this._confirmIrrigate?`${ba("panels.zones.confirm_irrigate.all_linked_zones",this.hass.language)} (${this._linkedZoneCount})`:null!==(t=null===(e=this.zones.find(e=>{var t;return(null===(t=e.id)||void 0===t?void 0:t.toString())===this._confirmIrrigate}))||void 0===e?void 0:e.name)&&void 0!==t?t:this._confirmIrrigate}
                </strong>
              </p>
              <div class="dialog-footer">
                ...
                >
                  ${ba("common.actions.cancel",this.hass.language)}
                </button>
                <button
            ...
            <ha-card class="error-banner-card">
              <div class="error-banner">
                ...
                <ha-icon-button
                  ...
                  aria-label="${ba("common.actions.cancel",this.hass.language)}"
                ></ha-icon-button>
              </div>
            </ha-card>
          `:""}
    ...
    `}}t([pe()],es.prototype,"config",void 0),t([pe({type:Boolean})],es.prototype,"hideSettingsLinks",void 0),t([pe({attribute:!1})],es.prototype,"actionsMode",void 0),t([pe({type:Array})],es.prototype,"zones",void 0),t([ge()],es.prototype,"_outlook",void 0),t([pe({type:Boolean})],es.prototype,"isLoading",void 0),t([pe({type:Boolean})],es.prototype,"isSaving",void 0),t([ge()],es.prototype,"_operationError",void 0),t([ge()],es.prototype,"_confirmIrrigate",void 0),t([ge()],es.prototype,"_skipDetailsOpen",void 0),t([ge()],es.prototype,"_runMinutes",void 0),customElements.get("smart-irrigation-view-zones")||customElements.define("smart-irrigation-view-zones",es)
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */;const ts={},is=Rt(class extends Ut{constructor(e){if(super(e),e.type!==Bt&&e.type!==Pt&&e.type!==It)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===Z||t===G)return t;const i=e.element,a=e.name;if(e.type===Bt){if(t===i[a])return Z}else if(e.type===It){if(!!t===i.hasAttribute(a))return Z}else if(e.type===Pt&&i.getAttribute(a)===t+"")return Z;return((e,t=ts)=>{e._$AH=t;
/**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
    ...
    `}};t([pe()],as.prototype,"label",void 0),t([pe()],as.prototype,"unit",void 0),t([pe()],as.prototype,"help",void 0),t([pe({type:Boolean})],as.prototype,"required",void 0),t([ge()],as.prototype,"_helpOpen",void 0),as=t([de("si-field")],as);let ss=class extends le{constructor(){super(...arguments),this.useWeather=!1,this.service=ze,this.apiKey="",this.weatherConfig=null,this._testing=!1,this._testResult=null,this._testResultTimer=null}disconnectedCallback(){super.disconnectedCallback(),this._testResultTimer&&(clearTimeout(this._testResultTimer),this._testResultTimer=null)}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{value:t},bubbles:!0,composed:!0}))}get _noApiKeyServices(){var e,t;return null!==(t=null===(e=this.weatherConfig)||void 0===e?void 0:e.no_api_key_services)&&void 0!==t?t:[ze]}get _needsKey(){return this.useWeather&&!!this.service&&!this._noApiKeyServices.includes(this.service)}get _hasStoredKey(){const e=this.weatherConfig;return this.service===xe?!!(null==e?void 0:e.has_owm_api_key):this.service===ke?!!(null==e?void 0:e.has_pw_api_key):this.service===Se&&!!(null==e?void 0:e.has_met_api_key)}async _testApiKey(){if(this.hass&&!this._testing){this._testing=!0,this._testResult=null,this._testResultTimer&&(clearTimeout(this._testResultTimer),this._testResultTimer=null);try{this._testResult=await(e=this.hass,t=this.service,i=this.apiKey||null,e.callWS({type:ye+"/weather_config_test",weather_service:null!=t?t:null,api_key:null!=i?i:null})),this._testResultTimer=window.setTimeout(()=>{this._testResult=null,this._testResultTimer=null},12e3)}catch(e){this._testResult={success:!1,error:"unknown"}}finally{this._testing=!1}var e,t,i}}render(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en";return W`
      <si-field
        label="${ba("weather_service_config.enabled_label",i)}"
      >
        <ha-switch
    ...
    `}_renderServiceAndKey(e){return W`
      <si-field
        label="${ba("weather_service_config.service_label",e)}"
      >
        <select
          class="si-input"
        ...
        >
          ...
          >
            ${ba("weather_service_config.openmeteo",e)}
          </option>
          <option
            value="${xe}"
            ?selected="${this.service===xe}"
          >
            ${ba("weather_service_config.owm",e)}
          </option>
          <option
            value="${ke}"
            ?selected="${this.service===ke}"
          >
            ${ba("weather_service_config.pw",e)}
          </option>
          <option
            value="${Se}"
            ?selected="${this.service===Se}"
          >
            ${ba("weather_service_config.met",e)}
          </option>
        </select>
      </si-field>

      ${this._needsKey?this._renderKeyField(e):W`<div class="info-note">
            ${ba("weather_service_config.no_api_key_needed",e)}
          </div>`}
    `}_renderKeyField(e){var t;const i=this._hasStoredKey;return W`
      <si-field
        label="${ba("weather_service_config.api_key_label",e)}"
        help="${ba("weather_service_config.api_key_help",e)}"
      >
        <span class="api-badge ${i?"configured":"missing"}"
          >${ba(i?"weather_service_config.api_key_configured":"weather_service_config.api_key_not_configured",e)}</span
        >
        <div class="api-row">
          <input
            type="password"
            class="si-input flex1"
            placeholder="${ba("weather_service_config.api_key_placeholder",e)}"
            .value="${this.apiKey}"
          ...
          >
            ${this._testing?ba("weather_service_config.test_button_testing",e):ba("weather_service_config.test_button",e)}
          </button>
        </div>
        ${null!==this._testResult?W`<div
              class="test-result ${this._testResult.success?"success":"error"}"
            >
              ${this._testResult.success?ba("weather_service_config.test_success",e):ba("weather_service_config.test_error_"+(null!==(t=this._testResult.error)&&void 0!==t?t:"unknown"),e)}
            </div>`:""}
      </si-field>
    `}static get styles(){return r`
      :host {
    ...
    `}};t([pe({attribute:!1})],ss.prototype,"hass",void 0),t([pe({type:Boolean})],ss.prototype,"useWeather",void 0),t([pe()],ss.prototype,"service",void 0),t([pe()],ss.prototype,"apiKey",void 0),t([pe({attribute:!1})],ss.prototype,"weatherConfig",void 0),t([ge()],ss.prototype,"_testing",void 0),t([ge()],ss.prototype,"_testResult",void 0),ss=t([de("si-weather-source-config")],ss);let ns=class extends(ja(le)){constructor(){super(...arguments),this.section="all",this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._weatherConfig=null,this._weatherService=null,this._useWeatherService=!1,this._newApiKey="",this._weatherSaving=!1,this._coords=null,this._coordsEnabled=!1,this._coordsLat="",this._coordsLon="",this._coordsElev="",this._coordsSaving=!1,this._saveStatus="idle",this._savedResetTimer=null,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout(()=>{this.saveData(t),e=null},500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:ye+"_config_updated"})]}async _fetchData(){var e;if(!this.hass)return;const t=!this._initialLoadDone;t&&(this.isLoading=!0,this._scheduleUpdate());try{const[t,s,n]=await Promise.all([Ca(this.hass),Ra(this.hass),Fa(this.hass)]);this.config=t,this._weatherConfig=s,this._useWeatherService=s.use_weather_service,this._weatherService=null!==(e=s.weather_service)&&void 0!==e?e:ze,this._applyCoordinates(n),this.data=(i=this.config,a=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","days_between_irrigation"],i?Object.entries(i).filter(([e])=>a.includes(e)).reduce((e,[t,i])=>Object.assign(e,{[t]:i}),{}):{}),this._initialLoadDone=!0}catch(e){console.error("Error fetching data:",e),Sa(this,this.hass,"common.errors.load_failed",e)}finally{t&&(this.isLoading=!1),this._scheduleUpdate()}var i,a}firstUpdated(){be().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}render(){var e,t;return this.hass&&this.config&&this.data?this.isLoading?W`<div class="loading-indicator">
        ${ba("common.loading-messages.general",this.hass.language)}
      </div>`:W`${this._renderSaveStatus()} ${this._renderCards()}`:W`<div class="loading-indicator">
        ${ba("common.loading-messages.configuration",null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en")}
      ...
      <div class="settings-section-header">
        ${ba(`panels.general.sections.${e}`,this.hass.language)}
      </div>
    `:W``}async _saveWeatherConfig(){if(this.hass){this._weatherSaving=!0,this._scheduleUpdate();try{await Ua(this.hass,this._useWeatherService,this._useWeatherService?this._weatherService:null,this._newApiKey||null),this._newApiKey="",await this._fetchData()}catch(e){console.error("Failed to save weather config:",e),Sa(this,this.hass,"common.errors.save_failed",e)}finally{this._weatherSaving=!1,this._scheduleUpdate()}}}_renderWeatherServiceCard(){var e;return this.hass?W`
      <ha-card
        header="${ba("weather_service_config.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${ba("weather_service_config.description",this.hass.language)}
        </div>
        <div class="card-content">
          ...
          <div style="margin-top: 12px;">
            ...
            >
              ${this._weatherSaving?ba("common.saving-messages.saving",this.hass.language):ba("weather_service_config.save_button",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    `:W``}_renderAutoUpdateCard(){var e,t;return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${ba("panels.general.cards.automatic-update.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${ba("panels.general.cards.automatic-update.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${ba("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}
            </label>
            <ha-switch
          ...
          ${this.data.autoupdateenabled?W`
                <div class="setting-row">
                  <label>
                    ${ba("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}
                  </label>
                  <div class="inline-row">
                    ...
                    >
                      ...
                      >
                        ${ba("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
                      </option>
                      <option
                        value="${Ae}"
                        ?selected="${(this.data.autoupdateschedule||Ae)===Ae}"
                      >
                        ${ba("panels.general.cards.automatic-update.options.hours",this.hass.language)}
                      </option>
                      <option
                        value="${Ce}"
                        ?selected="${this.data.autoupdateschedule===Ce}"
                      >
                        ${ba("panels.general.cards.automatic-update.options.days",this.hass.language)}
                      </option>
                    </select>
                  </div>
                </div>
                <div class="setting-row">
                  <label>
                    ${ba("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language)}
                    (s)
                  </label>
                  <input
                    type="number"
    ...
    `:W``}_renderAutoCalcCard(){return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${ba("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${ba("panels.general.cards.automatic-duration-calculation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${ba("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}
            </label>
            <ha-switch
          ...
          ${this.data.autocalcenabled?W`
                <div class="setting-row">
                  <label>
                    ${ba("panels.general.cards.automatic-duration-calculation.labels.calc-time",this.hass.language)}
                  </label>
                  <input
                    type="text"
                    class="settings-input shortfield"
    ...
    `:W``}_renderWeatherSkipCard(){var e,t,i,a,s;if(!this.hass||!this.config||!this.data)return W``;const n=this.hass.language,o=this.config.skip_irrigation_on_precipitation?"skip":this.config.forecast_weighting_enabled?"water_less":"ignore";return W`
      <ha-card header="${ba("weather_skip.title",this.hass.language)}">
        <div class="card-content description-text">
          ${ba("weather_skip.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${ba("weather_skip.forecast_rain_label",n)}
            </label>
            <select
              class="settings-input"
              .value="${is(o)}"
            ...
            >
              ${["ignore","water_less","skip"].map(e=>W`
                  <option value="${e}" ?selected="${o===e}">
                    ${ba(`weather_skip.forecast_rain_options.${e}`,n)}
                  </option>
                `)}
            </select>
          </div>
          <div class="description-text">
            ${ba(`weather_skip.forecast_rain_help.${o}`,n)}
          </div>
          ${"ignore"!==o?W`
                <div class="setting-row">
                  <label>
                    ${ba("weather_skip.lookahead_label",n)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="description-text">
                  ${ba("weather_skip.lookahead_help",n)}
                </div>
              `:""}
          ${"skip"===o?W`
                <div class="setting-row">
                  <label>
                    ${ba("weather_skip.threshold_label",n)}
                    (${wa(this.config,$e)})
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${ba("weather_skip.temp_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${ba("weather_skip.temp_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_temp_enabled?W`
                <div class="setting-row">
                  <label>
                    ${ba("weather_skip.temp_threshold_label",this.hass.language)}
                    (°C)
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${ba("weather_skip.wind_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${ba("weather_skip.wind_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_wind_enabled?W`
                <div class="setting-row">
                  <label>
                    ${ba("weather_skip.wind_threshold_label",this.hass.language)}
                    (m/s)
                  </label>
                  <input
                    type="number"
          ...
          <div class="section-divider">
            ${ba("weather_skip.freeze_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${ba("weather_skip.freeze_section_title",this.hass.language)}
          ...
          ${this.config.skip_on_freeze_enabled?W`
                <div class="setting-row">
                  <label>
                    ${ba("weather_skip.freeze_threshold_label",this.hass.language)}
                    (°C)
                  </label>
                  <input
                    type="number"
                ...
                <div class="description-text">
                  ${ba("weather_skip.freeze_help",this.hass.language)}
                </div>
              `:""}

          <div class="section-divider">
            ${ba("weather_skip.rain_sensor_section_title",this.hass.language)}
          </div>
          <div class="setting-row">
            <label>
              ${ba("weather_skip.rain_sensor_label",this.hass.language)}
            </label>
            <ha-entity-picker
              .hass="${this.hass}"
      ...
      >
        ...
        <div class="card-content">
          ...
          ${this._coordsEnabled?W`
                <div class="setting-row">
                  <label>
                    ${ba("coordinate_config.latitude",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="setting-row">
                  <label>
                    ${ba("coordinate_config.longitude",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
                ...
                <div class="setting-row">
                  <label>
                    ${ba("coordinate_config.elevation",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    class="settings-input shortfield"
              ...
              `:W`
                ...
                >
                  ${ba("coordinate_config.current_ha_coords",this.hass.language)}:
                  ${ba("coordinate_config.latitude",this.hass.language)}:
          ...
          <div style="margin-top: 12px;">
            ...
            >
              ${this._coordsSaving?ba("common.saving-messages.saving",this.hass.language):ba("common.actions.save",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    `}_renderDaysBetweenIrrigationCard(){var e;return this.hass&&this.config&&this.data?W`
      <ha-card
        header="${ba("days_between_irrigation.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${ba("days_between_irrigation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${ba("days_between_irrigation.label",this.hass.language)}
              <div class="setting-description">
                ${ba("days_between_irrigation.help_text",this.hass.language)}
              </div>
            </label>
            <input
              type="number"
    ...
    `:W``}_renderZoneSequencingCard(){var e,t;if(!this.hass||!this.config||!this.data)return W``;const i=(this.config.zone_sequencing||Ot)===Mt;return W`
      <ha-card
        header="${ba("zone_sequencing.title",this.hass.language)}"
      >
        <div class="card-content description-text">
          ${ba("zone_sequencing.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>
              ${ba("zone_sequencing.title",this.hass.language)}
            </label>
            <select
              class="settings-input"
            ...
            >
              ...
              >
                ${ba("zone_sequencing.parallel",this.hass.language)}
              </option>
              <option
                value="${Ht}"
                ?selected="${this.config.zone_sequencing===Ht}"
              >
                ${ba("zone_sequencing.sequential",this.hass.language)}
              </option>
              <option
                value="${Mt}"
                ?selected="${this.config.zone_sequencing===Mt}"
              >
                ${ba("zone_sequencing.rotating",this.hass.language)}
              </option>
            </select>
          </div>
          ${i?W`
                <div class="setting-row">
                  <label>
                    ${ba("zone_sequencing.max_consecutive_duration_label",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    min="1"
                  ...
                  <span class="unit-label">
                    ${ba("zone_sequencing.max_consecutive_duration_unit",this.hass.language)}
                  </span>
                </div>
                <div class="setting-row">
                  <label>
                    ${ba("zone_sequencing.min_absorption_time_label",this.hass.language)}
                  </label>
                  <input
                    type="number"
                    min="0"
                  ...
                  />
                  <span class="unit-label">
                    ${ba("zone_sequencing.min_absorption_time_unit",this.hass.language)}
                  </span>
                </div>
              `:""}
        </div>
    ...
    `}async saveData(e){if(this.hass&&this.data){this.isSaving=!0,this._saveStatus="saving",this._scheduleUpdate();try{this.data=Object.assign(Object.assign({},this.data),e),this._scheduleUpdate(),await Ta(this.hass,this.data),this._markSaved()}catch(e){console.error("Error saving config:",e),this._saveStatus="idle",Sa(this,this.hass,"common.errors.save_failed",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}}}_markSaved(){this._saveStatus="saved",this._savedResetTimer&&clearTimeout(this._savedResetTimer),this._savedResetTimer=window.setTimeout(()=>{this._saveStatus="idle",this._scheduleUpdate()},2e3)}_renderSaveStatus(){if(!this.hass||"idle"===this._saveStatus)return W``;const e="saving"===this._saveStatus;return W`
      <div class="save-status-float ${this._saveStatus}">
        ...
        ></ha-icon>
        ${ba(e?"common.saving-messages.saving":"panels.zones.status.saved",this.hass.language)}
      </div>
    ...
    `}};t([pe()],ns.prototype,"narrow",void 0),t([pe()],ns.prototype,"path",void 0),t([pe()],ns.prototype,"section",void 0),t([pe()],ns.prototype,"data",void 0),t([pe()],ns.prototype,"config",void 0),t([pe({type:Boolean})],ns.prototype,"isLoading",void 0),t([pe({type:Boolean})],ns.prototype,"isSaving",void 0),t([pe()],ns.prototype,"_weatherConfig",void 0),t([pe()],ns.prototype,"_weatherService",void 0),t([pe({type:Boolean})],ns.prototype,"_useWeatherService",void 0),t([pe()],ns.prototype,"_newApiKey",void 0),t([pe({type:Boolean})],ns.prototype,"_weatherSaving",void 0),t([ge()],ns.prototype,"_coords",void 0),t([ge()],ns.prototype,"_coordsEnabled",void 0),t([ge()],ns.prototype,"_coordsLat",void 0),t([ge()],ns.prototype,"_coordsLon",void 0),t([ge()],ns.prototype,"_coordsElev",void 0),t([ge()],ns.prototype,"_coordsSaving",void 0),t([ge()],ns.prototype,"_saveStatus",void 0),ns=t([de("smart-irrigation-view-general")],ns);const os=e=>9*e/5+32;function rs(e,t,i){if(null==e||Number.isNaN(e))return null;switch(t){case"temperature":return i?{value:e,unit:"°C"}:{value:os(e),unit:"°F"};case"precipitation":return i?{value:e,unit:at}:{value:(n=e,n/25.4),unit:st};case"windspeed":return i?{value:e,unit:rt}:{value:(s=e,2.2369362920544*s),unit:ot};case"pressure":return i?{value:e,unit:"hPa"}:{value:(a=e,.0295299830714*a),unit:nt}}var a,s,n}function ls(e,t,i,a){const s=rs(e,t,i);if(!s)return"-";const n=function(e,t){return"pressure"===e?t?0:2:"precipitation"===e?t?1:2:1}(t,i);return`${s.value.toFixed(n)} ${s.unit}`}function cs(e,t){return null==e||Number.isNaN(e)?"-":t?`${e.toFixed(0)} L`:`${(e=>.264172052*e)(e).toFixed(1)} gal`}let ds=class extends le{constructor(){super(...arguments),this.metric=!0,this.name="",this.size="",this.throughput="",this.linkedEntity="",this.showEntity=!1}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:{value:t},bubbles:!0,composed:!0}))}render(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",a=this.metric?"m²":et,s=this.metric?tt:it;return W`
      <si-field label="${ba("panels.zones.labels.name",i)}" required>
        <input
          type="text"
          class="si-input"
          .value="${this.name}"
      ...
      <si-field
        label="${ba("panels.zones.labels.size",i)}"
        unit="${a}"
        help="${ba("field_help.zone_size",i)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      <si-field
        label="${ba("panels.zones.labels.throughput",i)}"
        unit="${s}"
        help="${ba("field_help.zone_throughput",i)}"
      >
        <input
          type="number"
          class="si-input"
      ...
      ${this.showEntity?W`
            <si-field
              label="${ba("panels.zones.labels.linked_entity",i)}"
              help="${ba("field_help.zone_linked_entity",i)}"
            >
              <ha-entity-picker
                .hass="${this.hass}"
    ...
    `}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await Oa(this.hass,e)}_renderModuleOptions(e){if(!this.hass)return W``;const t=null!=e?String(e):"";return W`
      <option value="" ?selected="${""===t}">
        ---${ba("common.labels.select",this.hass.language)}---
      </option>
    ...
    `}renderZone(e,t){var i,a,s,n,o,r,l,c,d,h,u;return this.hass?W`
      <ha-card id="zone-${null!==(i=e.id)&&void 0!==i?i:"new"}">
        ...
        <div class="card-content zone-settings">
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.name",this.hass.language)}</span
            >
            <input
              type="text"
              class="settings-input"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.size",this.hass.language)}
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.throughput",this.hass.language)}
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.soil_type",this.hass.language)}</span
            >
            <span slot="description"
              >${ba("field_help.zone_soil_type",this.hass.language)}</span
            >
            <select
              class="settings-input"
            ...
            >
              ...
              >
                ${ba("panels.zones.labels.soil_types.custom",this.hass.language)}
              </option>
              ${Object.keys(Ct).map(t=>W`
                  ...
                  >
                    ${ba(`panels.zones.labels.soil_types.${t}`,this.hass.language)}
                  </option>
                `)}
            </select>
          </ha-settings-row>
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.drainage_rate",this.hass.language)}
              (${wa(this.config,$t)})</span
            >
            <span slot="description"
              >${ba("field_help.zone_drainage_rate",this.hass.language)}</span
            >
            <input
              type="number"
              class="settings-input shortfield"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.plant_type",this.hass.language)}</span
            >
            <span slot="description"
              >${ba("field_help.zone_plant_type",this.hass.language)}</span
            >
            <select
              class="settings-input"
            ...
            >
              ...
              >
                ${ba("panels.zones.labels.plant_types.custom",this.hass.language)}
              </option>
              ${Object.keys(At).map(t=>W`
                  <option value="${t}" ?selected="${e.plant_type===t}">
                    ${ba(`panels.zones.labels.plant_types.${t}`,this.hass.language)}
                  </option>
                `)}
            </select>
          </ha-settings-row>
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.kc",this.hass.language)}</span
            >
            <span slot="description"
              >${ba("field_help.zone_kc",this.hass.language)}</span
            >
            <input
              type="number"
              class="settings-input shortfield"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.state",this.hass.language)}</span
            >
            <select
              class="settings-input"
              .value="${is(e.state)}"
            ...
            >
              ...
              >
                ${ba("panels.zones.labels.states.automatic",this.hass.language)}
              </option>
              <option
                value="${Za.Manual}"
                ?selected="${e.state===Za.Manual}"
              >
                ${ba("panels.zones.labels.states.manual",this.hass.language)}
              </option>
              <option
                value="${Za.Disabled}"
                ?selected="${e.state===Za.Disabled}"
              >
                ${ba("panels.zones.labels.states.disabled",this.hass.language)}
              </option>
            </select>
          </ha-settings-row>
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("common.labels.module",this.hass.language)}</span
            >
            <select
              class="settings-input"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.mapping",this.hass.language)}</span
            >
            <select
              class="settings-input"
              .value="${is(void 0!==e.mapping?String(e.mapping):"")}"
              @change="${i=>{const a=i.target.value;this.handleEditZone(t,Object.assign(Object.assign({},e),{[bt]:a?parseInt(a):void 0}))}}"
            >
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.linked_entity",this.hass.language)}</span
            >
            <ha-entity-picker
              .hass="${this.hass}"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.flow_sensor",this.hass.language)}</span
            >
            <ha-entity-picker
              .hass="${this.hass}"
              .value="${e.flow_sensor||""}"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.maximum-bucket",this.hass.language)}
              (${wa(this.config,ft)})</span
            >
            <input
              type="number"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.multiplier",this.hass.language)}</span
            >
            <input
              type="number"
              class="settings-input shortfield"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.lead-time",this.hass.language)}
              (${"s"})</span
            >
            <input
              type="number"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.maximum-duration",this.hass.language)}
              (${"s"})</span
            >
            <input
              type="number"
          ...
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.zones.labels.bucket_threshold",this.hass.language)}
              (${wa(this.config,ft)})</span
            >
            <input
              type="number"
          ...
          ${e.state===Za.Manual?W`
                <ha-settings-row>
                  <span slot="heading"
                    >${ba("panels.zones.labels.duration",this.hass.language)}
                    (${"s"})</span
                  >
                  <input
                    type="number"
          ...
          <div class="settings-danger-row">
            <button
              class="action-btn"
              @click="${()=>{this._pendingConfirm={title:ba("panels.zones.confirm_action.reset_bucket_title",this.hass.language),body:ba("panels.zones.confirm_action.reset_bucket_body",this.hass.language),confirmLabel:ba("panels.zones.actions.reset-bucket",this.hass.language),onConfirm:()=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ft]:0}))}}}"
              ?disabled="${this.isSaving}"
            >
              ${ba("panels.zones.actions.reset-bucket",this.hass.language)}
            </button>
            <button
            ...
            >
              ...
              ${ba("common.actions.delete",this.hass.language)}
            </button>
          </div>
        </div>
        ...
        ${e.explanation&&e.explanation.length>0?W`
              <ha-expansion-panel
                .header="${ba("panels.zones.actions.information",this.hass.language)}"
              >
                <div class="card-content">${jt(e.explanation)}</div>
              </ha-expansion-panel>
            `:""}
    ...
    `:W``}_renderRunHistory(e){var t,i,a;if(!this.hass)return W``;const s=(null===(t=this.config)||void 0===t?void 0:t.units)===He,n=null!==(i=e.run_log)&&void 0!==i?i:[],o=this.hass.language;return W`
      <ha-expansion-panel
        .header="${ba("panels.zones.history.title",o)}"
      >
        <div class="card-content">
          <div class="history-usage">
            <span class="history-usage-label"
              >${ba("panels.zones.history.total_used",o)}</span
            >
          ...
          ${0===n.length?W`<div class="weather-note">
                ${ba("panels.zones.history.empty",o)}
              </div>`:W`
                <table class="history-table">
                  <thead>
                    <tr>
                      <th>${ba("panels.zones.history.when",o)}</th>
                      <th>${ba("panels.zones.history.result",o)}</th>
                      <th class="num">
                        ${ba("panels.zones.history.volume",o)}
                      </th>
                      <th>${ba("panels.zones.history.detail",o)}</th>
                    </tr>
                  </thead>
                  <tbody>
    ...
    `}_renderRunLogRow(e,t){const i=this.hass.language,a=ba(`panels.zones.history.results.${e.result}`,i);let s="";return e.detail&&(s="skipped"===e.result?e.detail.split(",").map(e=>ba(`panels.zones.outlook.checks.${e}`,i)||e).join(", "):"failed"===e.result&&ba(`panels.zones.fault.${e.detail}`,i)||e.detail),W`
      <tr>
        <td>${Ja(e.ts)}</td>
        <td>
        ...
        <td class="history-detail">${jt(s)}</td>
      </tr>
    `}render(){var e;if(!this.hass)return W``;if(this.isLoading)return W`
      ...
      <ha-card>
        <div class="card-header">
          ...
          <ha-icon-button
            .path="${Aa}"
            title="${ba("panels.zones.cards.add-zone.header",this.hass.language)}"
      ...
      <ha-dialog
        ...
        heading="${ba("panels.zones.cards.add-zone.header",this.hass.language)}"
      >
        ...
        <div class="dialog-footer">
          ...
          >
            ${this.isSaving?ba("common.saving-messages.adding",this.hass.language):ba("panels.zones.cards.add-zone.actions.add",this.hass.language)}
          </button>
        </div>
      </ha-dialog>
      ...
      ${t?W`
            <ha-dialog
              ...
              heading="${ba("common.actions.confirm_delete",this.hass.language)}"
            >
              <p>
                ${ba("common.actions.confirm_delete_zone",this.hass.language)}
              </p>
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${ba("common.labels.bulk_actions",this.hass.language)}
          </div>
        </div>
        <div class="card-content bulk-actions">
          <button
            class="action-btn danger-button"
            @click="${()=>{this._pendingConfirm={title:ba("panels.zones.confirm_action.reset_all_buckets_title",this.hass.language),body:ba("panels.zones.confirm_action.reset_all_buckets_body",this.hass.language),confirmLabel:ba("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language),onConfirm:()=>this.handleResetAllBuckets()}}}"
            ?disabled="${this.isSaving}"
          >
            ${ba("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language)}
          </button>
          <button
            class="action-btn danger-button"
            @click="${()=>{this._pendingConfirm={title:ba("panels.zones.confirm_action.clear_weather_title",this.hass.language),body:ba("panels.zones.confirm_action.clear_weather_body",this.hass.language),confirmLabel:ba("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language),onConfirm:()=>this.handleClearAllWeatherdata()}}}"
            ?disabled="${this.isSaving}"
          >
            ${ba("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language)}
          </button>
        </div>
      </ha-card>
        ...
        <div class="card-content">
          ...
          <div class="moduleconfig">
            <label class="subheader"
              >${ba("panels.modules.cards.module.labels.configuration",this.hass.language)}
              (*
              ${ba("panels.modules.cards.module.labels.required",this.hass.language)})</label
            >
            ${e.schema?Object.entries(e.schema).map(([e])=>this.renderConfig(t,e)):null}
          </div>
          <div class="card-footer">
            ${i?W`<div class="weather-note">
                  ${ba("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}
                </div>`:W`<button
    ...
    `;return this.moduleCache.set(a,s),s}renderUsageChip(e){return this.hass?e?W`<span class="usage-chip"
          >${ba("panels.setup.advanced.used_by_zones",this.hass.language,"{count}",e)}</span
        >`:W`<span class="usage-chip unused"
          >${ba("panels.setup.advanced.not_used",this.hass.language)}</span
        >`:W``}renderConfig(e,t){var i,a;const s=Object.values(this.modules).at(e);if(!s||!this.hass)return;const n=s.schema[t],o=n.name,r=e=>{try{const t=ba(e,this.hass.language);return null==t?void 0:t}catch(e){return}},l="panels.modules.cards.module.fields."+o,c=null!==(i=r(l+".name"))&&void 0!==i?i:function(e){if(e)return(e=e.replace("_"," ")).charAt(0).toUpperCase()+e.slice(1)}(o),d=null!==(a=r(l+".description"))&&void 0!==a?a:n.description;let h="";null==s.config&&(s.config=[]),o in s.config&&(h=s.config[o]);let u=W``;if("boolean"==n.type)u=W`<input
        type="checkbox"
        id="${o+e}"
        .checked=${h}
      ...
      >
        ${Object.entries(n.options).map(([e,i])=>W`<option
              ...
              ?selected="${h===ya(i,0)}"
            >
              ${ba("panels.modules.cards.module.translated-options."+ya(i,1),t)}
            </option>`)}
      ...
      <ha-card header="${ba("panels.modules.title",this.hass.language)}">
        <div class="card-content">
          ${ba("panels.modules.description",this.hass.language)}
          ${this.isLoading?W`<div class="loading-indicator">
                ...
                <div class="add-row">
                  <select
                    id="moduleInput"
                    class="settings-input"
                    aria-label="${ba("common.labels.module",this.hass.language)}"
                    ?disabled="${this.isSaving}"
                  >
                  ...
                  >
                    ...
                    ${this.isSaving?ba("common.saving-messages.adding",this.hass.language):ba("panels.modules.cards.add-module.actions.add",this.hass.language)}
                  </button>
                </div>
              `}
        </div>
    ...
    `}renderSimpleRadioOptions(e,t,i){if(!this.hass||!this.config)return W``;const a=t===Me||t===Be,s=i[Ke];return W`
      ${!a&&this.config.use_weather_service?W`
            <label>
              ...
              />
              ${ba("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}
            </label>
          `:""}
      ${a?W`
            <label>
              <input
                ...
                @change="${i=>this.handleSimpleSourceChange(e,t,i)}"
              />
              ${ba("panels.mappings.cards.mapping.sources.none",this.hass.language)}
            </label>
          `:""}
      ...
      <label>
        <input
          ...
          @change="${i=>this.handleSimpleSourceChange(e,t,i)}"
        />
        ${ba("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}
      </label>
      ...
      <label>
        <input
          ...
          @change="${i=>this.handleSimpleSourceChange(e,t,i)}"
        />
        ${ba("panels.mappings.cards.mapping.sources.static",this.hass.language)}
      </label>
    `}handleSimpleSourceChange(e,t,i){const a=this.mappings[e],s=i.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},a),{mappings:Object.assign(Object.assign({},a.mappings),{[t]:Object.assign(Object.assign({},a.mappings[t]),{[Ke]:s,[Ve]:""})})}))}handleSimpleInputChange(e,t,i,a){const s=this.mappings[e],n=a.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[i]:n})})}))}renderMappingInputs(e,t,i){if(!this.hass)return W``;const a=i[Ke];return W`
      ${a===Fe?this.renderSensorInput(e,t,i):""}
      ${a===je?this.renderStaticValueInput(e,t,i):""}
      ${a===Fe||a===je?this.renderUnitSelect(e,t,i):""}
      ${t!==Ne||a!==Fe&&a!==je?"":this.renderPressureTypeSelect(e,t,i)}
      ${a===Fe?this.renderAggregateSelect(e,t,i):""}
    `}renderSensorInput(e,t,i){if(!this.hass)return W``;const a=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${a}_sensor_entity">
          ${ba("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}:
        </label>
        <input
          type="text"
          class="settings-input"
    ...
    `}renderStaticValueInput(e,t,i){if(!this.hass)return W``;const a=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${a}_static_value">
          ${ba("panels.mappings.cards.mapping.static_value",this.hass.language)}:
        </label>
        <input
          type="text"
          class="settings-input"
    ...
    `}renderUnitSelect(e,t,i){if(!this.hass||!this.config)return W``;const a=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${a}_unit">
          ${ba("panels.mappings.cards.mapping.input-units",this.hass.language)}:
        </label>
        <select
          id="${a}_unit"
          class="settings-input"
    ...
    `}renderPressureTypeSelect(e,t,i){if(!this.hass)return W``;const a=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${a}_pressure_type">
          ${ba("panels.mappings.cards.mapping.pressure-type",this.hass.language)}:
        </label>
        <select
          id="${a}_pressure_type"
          class="settings-input"
    ...
    `}renderAggregateSelect(e,t,i){if(!this.hass)return W``;const a=`${t}_${e}`;return W`
      <div class="mappingsettingline">
        <label for="${a}_aggregate">
          ${ba("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
        </label>
        <select
          id="${a}_aggregate"
          class="settings-input"
        ...
        <label for="${a}_aggregate">
          ${ba("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}
        </label>
      </div>
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return W`<option value="${e}" ?selected="${e===t}">
        ${ba("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return W``}renderPressureTypes(e,t){if(this.hass&&this.config){let e=W``;const i=t[We];return e=W`${e}
        <option
          value="${Ze}"
          ?selected="${i===Ze}"
        >
          ${ba("panels.mappings.cards.mapping.pressure_types."+Ze,this.hass.language)}
        </option>
        <option
          value="${Ge}"
          ?selected="${i===Ge}"
        >
          ${ba("panels.mappings.cards.mapping.pressure_types."+Ge,this.hass.language)}
        </option>`,e}return W``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return W``;const i=function(e){switch(e){case Oe:case Ie:return[{unit:"°C",system:He},{unit:"°F",system:Te}];case Le:case Me:return[{unit:at,system:He},{unit:st,system:Te}];case Pe:return[{unit:lt,system:He},{unit:ct,system:Te}];case De:return[{unit:"%",system:[He,Te]}];case Ne:return[{unit:"millibar",system:He},{unit:"hPa",system:He},{unit:"psi",system:Te},{unit:nt,system:Te}];case Re:return[{unit:"km/h",system:He},{unit:rt,system:He},{unit:ot,system:Te}];case Be:return[{unit:"W/m2",system:He},{unit:"MJ/day/m2",system:He},{unit:"W/sq ft",system:Te},{unit:"MJ/day/sq ft",system:Te}];default:return[]}}(e);let a=t[Xe];const s=this.config.units;if(!t[Xe])for(const e of i)if("string"==typeof e.system){if(s===e.system){a=e.unit;break}}else{for(const t of e.system)if(s===t.system){a=e.unit;break}if(a===e.unit)break}return W`
      ${i.map(e=>W`
    ...
    `}render(){return this.hass?this.isLoading?W`
        <ha-card
          header="${ba("panels.mappings.title",this.hass.language)}"
        >
          <div class="card-content">
            <div class="loading-indicator">
              ${ba("common.loading-messages.general",this.hass.language)}
      ...
      >
        <div class="card-content">
          ${ba("panels.mappings.description",this.hass.language)}
          <div class="add-row">
            <input
              id="mappingNameInput"
              class="settings-input"
              type="text"
              placeholder="${ba("panels.mappings.labels.mapping-name",this.hass.language)}"
            />
            <button
              class="action-btn ${this.isSaving?"saving":""}"
              ?disabled="${this.isSaving}"
            ...
            >
              <ha-icon icon="mdi:plus"></ha-icon>
              ${ba("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    ...
    `}renderMappingCard(e,t){if(!this.hass)return W``;const i=this.zones.filter(t=>t.mapping===e.id).length;return W`
      <ha-card>
        ...
        <div class="card-content">
          <ha-settings-row>
            <span slot="heading"
              >${ba("panels.mappings.labels.mapping-name",this.hass.language)}</span
            >
            <input
              id="name${e.id}"
              class="settings-input"
          ...
          <div class="card-footer">
            ${i?W`<div class="weather-note">
                  ${ba("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}
                </div>`:W`<button
                  class="action-btn danger"
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach(e=>{clearTimeout(e)}),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};t([pe()],ps.prototype,"config",void 0),t([pe({type:Array})],ps.prototype,"zones",void 0),t([pe({type:Array})],ps.prototype,"mappings",void 0),t([pe({type:Boolean})],ps.prototype,"isLoading",void 0),t([pe({type:Boolean})],ps.prototype,"isSaving",void 0),t([me("#mappingNameInput")],ps.prototype,"mappingNameInput",void 0),ps=t([de("smart-irrigation-view-mappings")],ps);const gs=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"];let ms=class extends(ja(le)){constructor(){super(...arguments),this._schedules=[],this._zones=[],this._isLoading=!0,this._showDialog=!1,this._editingSchedule={name:"",type:"daily",enabled:!0,time:"06:00",action:"irrigate",zones:"all"},this._editingId=null}hassSubscribe(){return this._load(),[this.hass.connection.subscribeMessage(()=>this._load(),{type:ye+"_config_updated"})]}async _load(){var e;if(this.hass)try{const[t,i]=await Promise.all([(e=this.hass,e.callWS({type:ye+"/schedules"})),Ha(this.hass)]);this._schedules=t||[],this._zones=i||[]}catch(e){console.error("Failed to load schedules",e),Sa(this,this.hass,"common.errors.load_failed",e)}finally{this._isLoading=!1}}_openAdd(){this._editingSchedule={name:"",type:"daily",enabled:!0,time:"06:00",action:"irrigate",zones:"all"},this._editingId=null,this._showDialog=!0}_openEdit(e){var t;this._editingSchedule=Object.assign({},e),this._editingId=null!==(t=e.id)&&void 0!==t?t:null,this._showDialog=!0}_closeDialog(){this._showDialog=!1}async _save(){const e=Object.assign({},this._editingSchedule);this._editingId&&(e.id=this._editingId);try{await Ia(this.hass,e),this._closeDialog(),await this._load()}catch(e){console.error("Failed to save schedule",e),Sa(this,this.hass,"common.errors.save_failed",e)}}async _delete(e){try{await(t=this.hass,i=e,t.callWS({type:ye+"/schedule_delete",schedule_id:i})),await this._load()}catch(e){console.error("Failed to delete schedule",e),Sa(this,this.hass,"common.errors.delete_failed",e)}var t,i}_update(e){this._editingSchedule=Object.assign(Object.assign({},this._editingSchedule),e)}_typeLabel(e){return ba(`panels.schedules.types.${e}`,this.hass.language)||e}_zonesLabel(e){if("all"===e)return ba("panels.schedules.zones_all",this.hass.language);if(Array.isArray(e)){const t=e.map(e=>{const t=this._zones.find(t=>String(t.id)===String(e));return t?t.name:e}).join(", ");return t||e.join(", ")}return String(e)}_renderZonePicker(){const e="all"===this._editingSchedule.zones||!Array.isArray(this._editingSchedule.zones),t=e?[]:this._editingSchedule.zones.map(String);return W`
      <div class="field">
        ...
        <div class="switch-container">
          ...
          />
          <label for="zones_all"
            >${ba("panels.schedules.zones_all",this.hass.language)}</label
          >
          <input
            type="radio"
            id="zones_specific"
          ...
          <label for="zones_specific"
            >${ba("panels.schedules.zones_specific",this.hass.language)}</label
          >
        </div>
        ${e?"":W`
    ...
    `}_renderTypeFields(){var e;const t=this._editingSchedule;switch(t.type){case"daily":return W`
          <div class="field">
            <label
              >${ba("panels.schedules.fields.time",this.hass.language)}</label
            >
            <input
              type="time"
              .value="${t.time||"06:00"}"
        ...
        `;case"weekly":return W`
          ...
          <div class="field">
            <label
              >${ba("panels.schedules.fields.days_of_week",this.hass.language)}</label
            >
            <div class="day-checkboxes">
              ${gs.map(e=>W`
                  <label class="day-check">
                    ...
                    />
                    ${ba(`panels.schedules.days.${e}`,this.hass.language)}
                  </label>
                `)}
            </div>
          </div>
        `;case"monthly":return W`
          ...
          <div class="field">
            <label
              >${ba("panels.schedules.fields.day_of_month",this.hass.language)}</label
            >
            <input
              type="number"
              min="1"
        ...
        `;case"interval":return W`
          <div class="field">
            <label
              >${ba("panels.schedules.fields.interval_hours",this.hass.language)}</label
            >
            <div class="input-suffix-row">
              ...
              />
              <span class="suffix"
                >${ba("panels.schedules.hours",this.hass.language)}</span
              >
            </div>
          </div>
        `;case"sunrise":case"sunset":return W`${this._renderSunOffsetFields()}`;case"solar_azimuth":return W`
          <div class="field">
            <label
              >${ba("panels.schedules.fields.azimuth_angle",this.hass.language)}</label
            >
            <div class="input-suffix-row">
              <input
                type="number"
      ...
      <div class="field">
        <label
          >${ba("panels.schedules.fields.offset_minutes",this.hass.language)}</label
        >
        <div class="input-suffix-row">
          <input
            type="number"
          ...
          />
          <span class="suffix"
            >${ba("panels.schedules.minutes",this.hass.language)}</span
          >
        </div>
      </div>
    `}_renderTimeAnchorField(){var e;const t=this._editingSchedule;if("irrigate"!==t.action||"interval"===t.type)return W``;const i=["sunrise","sunset","solar_azimuth"].includes(t.type)&&!1!==t.account_for_duration,a=null!==(e=t.time_anchor)&&void 0!==e?e:i?"finish":"start";return W`
      <div class="field">
        <label
          >${ba("panels.schedules.fields.time_anchor",this.hass.language)}</label
        >
        <select
        ...
        >
          ${["start","finish"].map(e=>W`
              <option value="${e}" ?selected="${a===e}">
                ${ba(`panels.schedules.time_anchor.${e}`,this.hass.language)}
              </option>
            `)}
        </select>
      </div>
    `}_renderDialog(){if(!this._showDialog)return W``;const e=this._editingSchedule,t=this._editingId?ba("panels.schedules.dialog.edit_title",this.hass.language):ba("panels.schedules.dialog.add_title",this.hass.language);return W`
      <ha-dialog open .heading=${!0} @closed=${this._closeDialog}>
        ...
        <div class="dialog-content">
          <div class="field">
            <label
              >${ba("panels.schedules.fields.name",this.hass.language)}</label
            >
            <input
              type="text"
              .value="${e.name}"
          ...
          <div class="field">
            <label
              >${ba("panels.schedules.fields.type",this.hass.language)}</label
            >
            <select
          ...
          <div class="field-row">
            <label
              >${ba("panels.schedules.fields.enabled",this.hass.language)}</label
            >
            <input
              type="checkbox"
              ?checked="${e.enabled}"
          ...
          <div class="field">
            <label
              >${ba("panels.schedules.fields.start_date",this.hass.language)}</label
            >
            <input
              type="date"
              .value="${e.start_date||""}"
          ...
          <div class="field">
            <label
              >${ba("panels.schedules.fields.end_date",this.hass.language)}</label
            >
            <input
              type="date"
              .value="${e.end_date||""}"
        ...
        <div class="dialog-footer">
          ...
          <button class="dialog-btn dialog-btn-primary" @click=${this._save}>
            ${ba("common.actions.save",this.hass.language)}
          </button>
        </div>
      </ha-dialog>
    `}render(){return this.hass?this._isLoading?W`
        <ha-card
          header="${ba("panels.schedules.title",this.hass.language)}"
        >
          <div class="card-content">
            ${ba("common.loading",this.hass.language)}...
          </div>
        </ha-card>
      `:W`
      ${this._renderDialog()}
      ...
      >
        <div class="card-content">
          ${ba("panels.schedules.description",this.hass.language)}
        </div>
        <div class="card-content">
          <button class="add-btn" @click=${this._openAdd}>
            ...
            ${ba("panels.schedules.add",this.hass.language)}
          </button>
        </div>
      </ha-card>
      ...
      ${0===this._schedules.length?W`
            <ha-card>
              <div class="card-content">
                ${ba("panels.schedules.no_items",this.hass.language)}
              </div>
            </ha-card>
              ...
              <ha-card header="${e.name}">
                <div class="card-content">
                  <div class="info-row">
                    <span class="info-label"
                      >${ba("panels.schedules.fields.type",this.hass.language)}:</span
                    >
                  ...
                  ${e.time&&["daily","weekly","monthly"].includes(e.type)?W`
                        <div class="info-row">
                          <span class="info-label"
                            >${ba("panels.schedules.fields.time",this.hass.language)}:</span
                          >
                          <span>${e.time}</span>
                        </div>
                      `:""}
                  ${e.interval_hours?W`
                        <div class="info-row">
                          <span class="info-label"
                            >${ba("panels.schedules.fields.interval_hours",this.hass.language)}:</span
                          >
                          <span
                            >${e.interval_hours}
                            ${ba("panels.schedules.hours",this.hass.language)}</span
                  ...
                  <div class="info-row">
                    <span class="info-label"
                      >${ba("panels.schedules.fields.zones",this.hass.language)}:</span
                    >
                    <span>${this._zonesLabel(e.zones)}</span>
                  </div>
                  <div class="info-row">
                    <span class="info-label"
                      >${ba("panels.schedules.fields.enabled",this.hass.language)}:</span
                    >
                    <span
                      >${e.enabled?ba("common.labels.yes",this.hass.language):ba("common.labels.no",this.hass.language)}</span
                    >
                  </div>
                </div>
                <div class="card-content action-buttons">
                  <div class="action-buttons-left">
                    ...
                    >
                      ...
                      <span class="action-button-label"
                        >${ba("common.actions.edit",this.hass.language)}</span
                      >
                    </div>
                  </div>
                  <div class="action-buttons-right">
                    ...
                    >
                      <span class="action-button-label"
                        >${ba("common.actions.delete",this.hass.language)}</span
                      >
                      <svg style="width:20px;height:20px" viewBox="0 0 24 24">
    ...
    `}_renderForecast(){if(!this.hass)return W``;const e=this.hass.language,t=this._forecast;return W`
      <ha-card
        header="${ba("panels.setup.weather_data.forecast_title",e)}"
      >
        <div class="card-content">
          ${t&&t.available&&0!==t.days.length?W`
              ...
              `:W`<div class="weather-note">
                ${ba("panels.setup.weather_data.forecast_none",e)}
              </div>`}
        </div>
      </ha-card>
    ...
    `}_renderRecords(){if(!this.hass)return W``;const e=this.hass.language;return this._loading&&0===this._mappings.length?W`<ha-card
        header="${ba("panels.mappings.weather-records.title",e)}"
      >
        <div class="card-content">
          <div class="loading-indicator">
            ${ba("common.loading-messages.general",e)}
          </div>
        </div>
      ...
      >
        <div class="card-content">
          <div class="weather-note">
            ${ba("panels.mappings.no_items",e)}
          </div>
        </div>
      </ha-card>`:W`${this._mappings.map(t=>this._renderMappingRecords(t,e))}`}_renderMappingRecords(e,t){const i=void 0!==e.id&&this._records.get(e.id)||[],a=`${ba("panels.mappings.weather-records.title",t)} — ${e.name}`,s=e=>{try{return t=e,Number.isNaN(Ya(t).getTime())?"-":function(e){const t=Ya(e);return`${Va(t.getMonth()+1)}-${Va(t.getDate())} ${Va(t.getHours())}:${Va(t.getMinutes())}`}(e)}catch(e){return"-"}var t};return W`
      <ha-card header="${a}">
        <div class="card-content">
          ${0===i.length?W`<div class="weather-note">
                ${ba("panels.mappings.weather-records.no-data",t)}
              </div>`:W`
                <div class="weather-table">
                  <div class="weather-header">
                    <span
                      >${ba("panels.mappings.weather-records.timestamp",t)}</span
                    >
                    <span
                      >${ba("panels.mappings.weather-records.temperature",t)}</span
                    >
                    <span
                      >${ba("panels.mappings.weather-records.humidity",t)}</span
                    >
                    <span
                      >${ba("panels.mappings.weather-records.dewpoint",t)}</span
                    >
                    <span
                      >${ba("panels.mappings.weather-records.wind",t)}</span
                    >
                    <span
                      >${ba("panels.mappings.weather-records.pressure",t)}</span
                    >
                    <span
                      >${ba("panels.mappings.weather-records.precipitation",t)}</span
                    >
                    <span
                      >${ba("panels.mappings.weather-records.retrieval-time",t)}</span
                    >
                  </div>
                  ${i.map(e=>W`
                      <div class="weather-row">
      ...
      <div class="experimental-banner">
        ...
        <div>
          <div class="experimental-banner-title">
            ${ba("panels.experimental.title",this.hass.language)}
          </div>
          <div class="experimental-banner-text">
            ${ba("panels.experimental.warning",this.hass.language)}
          </div>
        </div>
      </div>
    `:W``}_renderToggleCard(e,t,i){if(!this.hass)return W``;const a=`panels.experimental.${e}`;return W`
      <ha-card header="${ba(`${a}.title`,this.hass.language)}">
        <div class="card-content description-text">
          ${ba(`${a}.description`,this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <label>${ba(`${a}.label`,this.hass.language)}</label>
            <ha-switch
              .checked="${i}"
    ...
    `}};t([pe()],vs.prototype,"narrow",void 0),t([ge()],vs.prototype,"config",void 0),t([ge()],vs.prototype,"_saving",void 0),vs=t([de("smart-irrigation-view-experimental")],vs);var bs;!function(e){e.WeatherLocation="weather-location",e.Zones="zones",e.WhenToWater="when-to-water",e.Advanced="advanced",e.Experimental="experimental",e.Help="help"}(bs||(bs={}));const _s={[bs.WeatherLocation]:"panels.setup.tabs.weather_location",[bs.Zones]:"panels.setup.tabs.my_zones",[bs.WhenToWater]:"panels.setup.tabs.when_to_water",[bs.Advanced]:"panels.setup.tabs.advanced",[bs.Experimental]:"panels.setup.tabs.experimental",[bs.Help]:"panels.help.title"};let ys=class extends le{get _activeTab(){var e;const t=null===(e=this.path)||void 0===e?void 0:e.subpage;return Object.values(bs).includes(null!=t?t:"")?t:bs.WeatherLocation}_selectTab(e){xa(0,qa("setup",e))}_openWizard(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,composed:!0}))}render(){if(!this.hass)return W``;const e=this._activeTab;return W`
      <div class="setup-container">
        <nav class="setup-nav">
          ${Object.values(bs).map(t=>W`
              ...
              >
                ${ba(_s[t],this.hass.language)}
              </button>
            `)}
          <button
            class="setup-nav-btn wizard-btn"
            @click="${this._openWizard}"
            title="${ba("wizard.title",this.hass.language)}"
          >
            <ha-icon icon="mdi:creation"></ha-icon>
            ${ba("wizard.open_button",this.hass.language)}
          </button>
        </nav>
        <div class="setup-content">${this._renderContent(e)}</div>
      </div>
    `}_renderContent(e){if(!this.hass)return W``;switch(e){case bs.WeatherLocation:return W`
          ...
          <smart-irrigation-view-weather-data
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-weather-data>
        `;case bs.Zones:return W`<smart-irrigation-view-zone-settings
          .hass="${this.hass}"
          .narrow="${this.narrow}"
          .path="${this.path}"
        ></smart-irrigation-view-zone-settings>`;case bs.WhenToWater:return W`
          <smart-irrigation-view-general
            .hass="${this.hass}"
            .narrow="${this.narrow}"
        ...
        `;case bs.Advanced:return W`
          ...
          <smart-irrigation-view-mappings
            ...
            .narrow="${this.narrow}"
          ></smart-irrigation-view-mappings>
        `;case bs.Experimental:return W`<smart-irrigation-view-experimental
          .hass="${this.hass}"
          .narrow="${this.narrow}"
        ></smart-irrigation-view-experimental>`;case bs.Help:return this._renderHelp()}}_renderHelp(){return this.hass?W`
      <ha-card
        header="${ba("panels.help.cards.how-to-get-help.title",this.hass.language)}"
      >
        <div class="card-content">
          ${ba("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)}
          <a href="${"https://justchr.github.io/HAsmartirrigation/"}"
            >${ba("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
          >.
          ${ba("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
          <a
            href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
            >${ba("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
          >
          ${ba("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
          <a href="${"https://github.com/JustChr/HAsmartirrigation/issues"}"
            >${ba("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
          >
          (${ba("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
        </div>
      </ha-card>
      ...
      <div class="wizard-overlay" @click="${this._onOverlayClick}">
        ...
        >
          <div class="wizard-header">
            <span class="wizard-title">${ba("wizard.title",i)}</span>
            <button
              class="wizard-close-btn"
              @click="${this._close}"
              title="${ba("wizard.close",i)}"
              aria-label="${ba("wizard.close",i)}"
            >
    ...
    `}_onOverlayClick(e){e.target===e.currentTarget&&(this._step>ws.Welcome&&this._step<ws.Done?this._confirmClose=!0:this._close())}_renderStepper(){var e,t;const i=null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en",a=[ba("wizard.stepper.weather",i),ba("wizard.stepper.module",i),ba("wizard.stepper.mapping",i),ba("wizard.stepper.zone",i)];return W`
    ...
    `}_renderStep(e){switch(this._step){case ws.Welcome:return this._renderWelcome(e);case ws.Weather:return this._renderWeather(e);case ws.Module:return this._renderModule(e);case ws.Mapping:return this._renderMapping(e);case ws.Zone:return this._renderZone(e);case ws.Done:return this._renderDone(e);default:return W``}}_renderFooter(e){return this._step===ws.Done?W``:W`
      ...
      <button
        ...
        ?disabled="${this._saving}"
      >
        ${this._saving?ba("common.saving-messages.saving",e):this._step===ws.Welcome||this._step<ws.Zone?ba("wizard.next",e):ba("wizard.finish",e)}
      </button>
    `}_renderWelcome(e){return W`
      <h2 class="step-title">
        ${ba("wizard.steps.welcome.title",e)}
      </h2>
      <p class="step-desc">${ba("wizard.steps.welcome.intro",e)}</p>
      <ul class="step-list">
        <li>① ${ba("wizard.steps.welcome.step1_label",e)}</li>
        <li>② ${ba("wizard.steps.welcome.step2_label",e)}</li>
        <li>③ ${ba("wizard.steps.welcome.step3_label",e)}</li>
        <li>④ ${ba("wizard.steps.welcome.step4_label",e)}</li>
      </ul>
      <p class="step-tip">${ba("wizard.steps.welcome.tip",e)}</p>
    `}_renderWeather(e){return W`
      <h2 class="step-title">
        ${ba("wizard.steps.weather.title",e)}
      </h2>
      <p class="step-desc">
        ${ba("wizard.steps.weather.description",e)}
      </p>
    ...
    `}_renderModule(e){if(0===this._availableModules.length)return W`
        <h2 class="step-title">
          ${ba("wizard.steps.module.title",e)}
        </h2>
        <p class="step-desc">
          ${ba("wizard.steps.module.no_modules",e)}
        </p>
      `;const t=this._availableModules[this._selectedModuleIndex];return W`
      <h2 class="step-title">${ba("wizard.steps.module.title",e)}</h2>
      <p class="step-desc">
        ${ba("wizard.steps.module.description",e)}
      </p>

      <si-field
        label="${ba("wizard.steps.module.pick_label",e)}"
        required
      >
        <select
          class="wizard-input"
    ...
    `}_renderMapping(e){const t=[{value:Ue,label:ba("wizard.steps.mapping.use_weather_service",e)},{value:"sensor",label:ba("wizard.steps.mapping.use_sensor",e)},{value:"static",label:ba("wizard.steps.mapping.use_static",e)},{value:qe,label:ba("wizard.steps.mapping.use_none",e)}],i=(i,a,s)=>W`
      <si-field
        label="${ba("wizard.steps.mapping.source_label",e)} ${i}"
      >
        <select
          class="wizard-input"
    ...
    `;return W`
      <h2 class="step-title">
        ${ba("wizard.steps.mapping.title",e)}
      </h2>
      <p class="step-desc">
        ${ba("wizard.steps.mapping.description",e)}
      </p>

      <si-field
        label="${ba("wizard.steps.mapping.name_label",e)}"
        required
      >
        <input
          type="text"
      ...
      ${i(ba("panels.mappings.cards.mapping.items.temperature",e)||"Temperature",this._tempSource,e=>{this._tempSource=e,this.requestUpdate()})}
      ${i(ba("panels.mappings.cards.mapping.items.humidity",e)||"Humidity",this._humiditySource,e=>{this._humiditySource=e,this.requestUpdate()})}
      ${i(ba("panels.mappings.cards.mapping.items.precipitation",e)||"Precipitation",this._precipSource,e=>{this._precipSource=e,this.requestUpdate()})}

      <p class="step-tip">
        ${ba("wizard.steps.mapping.description",e)}
      </p>
    `}_renderZone(e){var t;const i="imperial"!==(null===(t=this._siConfig)||void 0===t?void 0:t.units);return W`
      <h2 class="step-title">${ba("wizard.steps.zone.title",e)}</h2>
      <p class="step-desc">
        ${ba("wizard.steps.zone.description",e)}
      </p>
    ...
    `}_renderDone(e){return W`
      <div class="done-wrapper">
        ...
        <h2 class="step-title">${ba("wizard.steps.done.title",e)}</h2>
        <p class="step-desc">
          ${ba("wizard.steps.done.description",e)}
        </p>
        <ul class="step-list">
          <li>${ba("wizard.steps.done.tip1",e)}</li>
          <li>${ba("wizard.steps.done.tip2",e)}</li>
          <li>${ba("wizard.steps.done.tip3",e)}</li>
        </ul>
        ...
        <div class="schedule-offer">
          ${this._scheduleCreated?W`
                <div class="schedule-created">
                  ...
                  <span
                    >${ba("wizard.steps.done.schedule_created",e)}</span
                  >
                </div>
              `:W`
                <p class="schedule-offer-title">
                  ${ba("wizard.steps.done.schedule_title",e)}
                </p>
                <p class="schedule-offer-desc">
                  ${ba("wizard.steps.done.schedule_desc",e)}
                </p>
                <div class="schedule-offer-row">
                  ...
                  >
                    ${this._creatingSchedule?ba("common.saving-messages.saving",e):ba("wizard.steps.done.schedule_create",e)}
                  </button>
                </div>
              `}
        </div>
        ...
        <div class="done-actions">
          ...
          >
            ${ba("wizard.steps.done.go_zones",e)}
          </button>
          <button
            class="wizard-btn secondary"
            @click="${()=>{this._close(),this._navigate("setup")}}"
          >
            ${ba("wizard.steps.done.go_setup",e)}
          </button>
        </div>
      </div>
    `}static get styles(){return r`
      ...
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            ...
            .narrow=${this.narrow}
          ></ha-menu-button>
          <div class="main-title">${ba("title",this.hass.language)}</div>
              ...
              <ha-tab-group @wa-tab-show=${this.handlePageSelected}>
                ${Object.values(ks).map(t=>W`
                    <ha-tab-group-tab
                      ...
                      .active=${e.page===t}
                    >
                      ${ba(`panels.${t}.title`,this.hass.language)}
                    </ha-tab-group-tab>
                  `)}
              </ha-tab-group>
            `:W`

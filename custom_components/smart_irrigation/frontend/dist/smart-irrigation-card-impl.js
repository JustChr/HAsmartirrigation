...
`;const _i=e=>String(e).padStart(2,"0");function yi(e){return e instanceof Date?e:new Date(e)}function vi(e){const t=yi(e);return`${_i(t.getHours())}:${_i(t.getMinutes())}`}function wi(e){const t=yi(e);return`${t.getFullYear()}-${_i(t.getMonth()+1)}-${_i(t.getDate())} ${_i(t.getHours())}:${_i(t.getMinutes())}`}function ki(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class xi extends(Se(le)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){fe().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const i=Object.keys(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).length>0;i&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):i||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[i,n,o,a]=await Promise.all([(t=this.hass,t.callWS({type:_e+"/config"})),ke(this.hass),xe(this.hass).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),ze(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=i,this.zones=n,this._outlook=o,this._distributors=a,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),gi(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),gi(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),gi(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const i="all"===t,n=i?void 0:this.zones.find(e=>{var i;return(null===(i=e.id)||void 0===i?void 0:i.toString())===t}),o=i?`(${this._linkedZoneCount})`:`: ${null!==(e=null==n?void 0:n.name)&&void 0!==e?e:t}`;try{await(a=this.hass,r=i?void 0:t,a.callWS(Object.assign({type:_e+"/irrigate_now"},void 0!==r?{zone_id:r}:{}))),mi(this,`${ci("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${o}`)}catch(e){const t=di(e);console.error("irrigate_now failed",e),mi(this,`${ci("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var a,r}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const i=new Date(t);return i.getTime()>Date.now()?i:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:_e+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),gi(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:_e+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),gi(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,i;const n=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(i=this._runMinutes[n])&&void 0!==i?i:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const i=this._zoneDistributor(e);return!!i&&Object.keys(null!==(t=i.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var i,n,o;if(t>0)try{await(i=this.hass,n=e.id.toString(),o=t,i.callWS({type:_e+"/run_zone",zone_id:n,duration:o})),mi(this,`${ci("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=di(e);console.error("run_zone failed",e),mi(this,`${ci("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===i?void 0:i[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,i;if(this.hass&&void 0!==e.id)try{await(t=this.hass,i=e.id.toString(),t.callWS({type:_e+"/stop_zone",zone_id:i})),mi(this,`${ci("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=di(e);console.error("stop_zone failed",e),mi(this,`${ci("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var i,n;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,n=t.id.toString(),i.callApi("POST",_e+"/zones",{id:n,calculate:!0,override_cache:!0})).catch(e=>{const t=di(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var i,n;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,n=t.id.toString(),i.callApi("POST",_e+"/zones",{id:n,update:!0})).catch(e=>{const t=di(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;ui(0,t?fi("setup","zones",t):fi("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,i,n;const o=null!==(t=e.duration)&&void 0!==t?t:0,a=Number(null!==(i=e.bucket_threshold)&&void 0!==i?i:0),r=this._zoneEstimate(e),s=r&&r.available&&null!=r.live_deficit?r.live_deficit:Number(null!==(n=e.bucket)&&void 0!==n?n:0);return o>0&&s<a}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,i=new Date(e),n=vi(i),o=new Date;return ki(i,o)?`${ci("panels.zones.outlook.today",t)} ${n}`:ki(i,function(e,t){const i=new Date(e.getTime());return i.setDate(i.getDate()+t),i}(o,1))?`${ci("panels.zones.outlook.tomorrow",t)} ${n}`:function(e,t){const i=yi(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(i)} ${vi(i)}`}(i,t)}_renderEstimatedTag(e){if(!this.hass||!e.estimated)return G``;const t=this.hass.language;return G`<span
      class="estimate-tag"
      title="${ci("panels.zones.outlook.estimated_help",t)}"
      >${ci("panels.zones.outlook.estimated",t)}<ha-icon
        icon="mdi:information-outline"
      ></ha-icon
    ></span>`}_guardLabel(e){return ci(`panels.zones.outlook.checks.${e.id}`,this.hass.language)}_guardDetail(e){var t;return e.available&&null!==e.observed?ci(`panels.zones.outlook.check_detail.${e.id}`,this.hass.language,"{observed}",String(e.observed),"{threshold}",String(null!==(t=e.threshold)&&void 0!==t?t:"")):""}_renderSkipReasons(){const e=this.hass.language;return G`
      ...
      <div class="outlook-line outlook-dim skip-reasons-note">
        ${ci("panels.zones.outlook.provisional",e)}
      </div>
    `}_openSchedules(){ui(0,fi("setup","when-to-water"))}_runActionLabel(e){return ci(`panels.zones.outlook.actions.${e.action}`,this.hass.language)}_runTargetsLabel(e){const t=this.hass.language;if("all"===e.zones)return ci("panels.zones.outlook.targets_all",t);const i=Array.isArray(e.zones)?e.zones.length:0;return ci("panels.zones.outlook.targets_zones",t,"{count}",String(i))}_renderOutlookBanner(){if(!this.hass||!this._outlook)return G``;const e=this.hass.language,t=this._nextIrrigateRun,i=this._triggeredGuards,n=this._outlook.last_skip_evaluation;return t&&t.next_run_utc?G`
      <ha-card class="outlook-card">
        <div class="outlook">
          <div class="outlook-line outlook-headline">
            ...
            <span>
              <strong
                >${ci("panels.zones.outlook.next_run",e)}:</strong
              >
          ...
          ${i.length>0?G`
                <div class="outlook-line outlook-skip">
                  ...
                  <span
                    >${ci("panels.zones.outlook.will_skip",e)}</span
                  >
                  <button
                    class="outlook-info-btn"
                    aria-expanded="${this._skipDetailsOpen}"
                    title="${ci("panels.zones.outlook.why_skipped",e)}"
                  ...
                  >
                    ...
                    <span class="outlook-info-label"
                      >${ci("panels.zones.outlook.why_skipped",e)}</span
                    >
                  </button>
                </div>
              ...
              `:G`
                <div class="outlook-line outlook-clear">
                  ...
                  <span
                    >${ci("panels.zones.outlook.will_run",e)}</span
                  >
                </div>
              `}
    ...
    `:G`
        <ha-card class="outlook-card">
          <div class="outlook">
            <div class="outlook-line outlook-headline">
              ...
              <span>${ci("panels.zones.outlook.no_schedule",e)}</span>
              ${this.hideSettingsLinks?"":G`
                    <button
                      class="outlook-link"
                      @click="${this._openSchedules}"
                    >
                      ${ci("panels.zones.outlook.setup_schedule",e)}
                    </button>
                  `}
            </div>
            ${n?this._renderLastRunLine(n):""}
        ...
        <ha-card class="rain-delay-card paused">
          <div class="rain-delay">
            ...
            <span class="rain-delay-msg">
              <strong
                >${ci("panels.zones.rain_delay.paused",e)}</strong
              >
              ${ci("panels.zones.rain_delay.until",e)}
              ${wi(t.toISOString())}
            </span>
            <button class="action-btn" @click="${()=>this._clearRainDelay()}">
              <ha-icon icon="mdi:play"></ha-icon>
              ${ci("panels.zones.rain_delay.resume",e)}
            </button>
          </div>
        </ha-card>
      `:G`
      <div class="rain-delay-row">
        <span class="rain-delay-label">
          ...
          ${ci("panels.zones.rain_delay.title",e)}
        </span>
        <button class="action-btn" @click="${()=>this._setRainDelay(24)}">
          ${ci("panels.zones.rain_delay.delay_24h",e)}
        </button>
        <button class="action-btn" @click="${()=>this._setRainDelay(48)}">
          ${ci("panels.zones.rain_delay.delay_48h",e)}
        </button>
      </div>
    `}_renderLastRunLine(e){const t=this.hass.language,i=function(e,t){const i=yi(e).getTime()-Date.now(),n=new Intl.RelativeTimeFormat(t,{numeric:"auto"}),o=Math.round(i/1e3);if(Math.abs(o)<60)return n.format(o,"second");const a=Math.round(o/60);if(Math.abs(a)<60)return n.format(a,"minute");const r=Math.round(a/60);if(Math.abs(r)<24)return n.format(r,"hour");const s=Math.round(r/24);if(Math.abs(s)<30)return n.format(s,"day");const l=Math.round(s/30);return Math.abs(l)<12?n.format(l,"month"):n.format(Math.round(l/12),"year")}(e.timestamp,t),n=e.checks.filter(e=>e.enabled&&e.would_skip).map(e=>this._guardLabel(e).toLowerCase()).join(", "),o=e.would_skip?`${ci("panels.zones.outlook.last_run_skipped",t)}${n?` (${n})`:""}`:ci("panels.zones.outlook.last_run_ran",t);return G`
      <div class="outlook-line outlook-last">
        <span class="outlook-dim"
          >${ci("panels.zones.outlook.last_run",t)}:</span
        >
        <span>${o} · ${i}</span>
      </div>
    `}_renderZoneDecision(e){var t;if(!this.hass)return G``;const i=this.hass.language,n=null!==(t=e.duration)&&void 0!==t?t:0;let o,a,r,s;if(e.state===$e.Disabled)o=ci("panels.zones.status.decision_disabled",i),a="neutral",r="mdi:power-off";else if(e.last_calculated)if(this._zoneHasDeficit(e)){const t=pi(n),l=this._triggeredGuards,c=this._nextIrrigateRunForZone(e);l.length>0?(o=ci("panels.zones.status.decision_water_skip",i,"{duration}",t,"{reason}",this._guardLabel(l[0]).toLowerCase()),a="skip",r="mdi:weather-rainy"):c&&c.next_run_utc?(o=ci("panels.zones.status.decision_water_at",i,"{duration}",t,"{time}",this._formatRunTime(c.next_run_utc)),a="water",r="mdi:water",s=c):(o=ci("panels.zones.status.decision_water_no_schedule",i,"{duration}",t),a="water",r="mdi:water-alert")}else o=ci("panels.zones.status.decision_no_water",i),a="ok",r="mdi:check-circle-outline";else o=ci("panels.zones.status.decision_unknown",i),a="unknown",r="mdi:help-circle-outline";return G`
      <div class="zone-decision ${a}">
        <ha-icon icon="${r}"></ha-icon>
        <span>${o}</span>
        ${s?this._renderEstimatedTag(s):""}
      </div>
    `}_zoneEstimate(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_estimates)||void 0===i?void 0:i[String(e.id)]}_zoneFault(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_faults)||void 0===i?void 0:i[String(e.id)]}_renderZoneFault(e){if(!this.hass)return G``;const t=this._zoneFault(e);if(!t)return G``;const i=this.hass.language,n=ci(`panels.zones.fault.${t.reason}`,i)||ci("panels.zones.fault.generic",i),o=t.timestamp?wi(t.timestamp):"";return G`
      <div class="zone-fault" title="${o}">
        <ha-icon icon="mdi:alert-circle"></ha-icon>
        <span>
          <strong>${ci("panels.zones.fault.title",i)}</strong>
          — ${n}
        </span>
      </div>
    `}_zoneSkip(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_skips)||void 0===i?void 0:i[String(e.id)]}_renderZoneSkip(e){if(!this.hass)return G``;const t=this._zoneSkip(e);if(!t)return G``;const i=this.hass.language,n=ci("panels.zones.skip.soil_moisture",i,"{observed}",String(t.observed),"{threshold}",String(t.threshold)),o=t.timestamp?wi(t.timestamp):"";return G`
      <div class="zone-skip" title="${o}">
        <ha-icon icon="mdi:water-off"></ha-icon>
        <span>
          <strong>${ci("panels.zones.skip.title",i)}</strong>
          — ${n}
        </span>
      </div>
    `}_durationClamped(e){var t,i;if(e.state!==$e.Automatic)return!1;const n=e.maximum_duration;if(null==n||n<0)return!1;const o=null!==(t=e.duration)&&void 0!==t?t:0;return!(o<=0)&&o-(null!==(i=e.lead_time)&&void 0!==i?i:0)>=n}_renderDurationClamped(e){var t;if(!this.hass||!this._durationClamped(e))return G``;const i=this.hass.language,n=ci("panels.zones.clamped.detail",i,"{maximum}",pi(null!==(t=e.maximum_duration)&&void 0!==t?t:0));return G`
      <div class="zone-clamped" title="${n}">
        <ha-icon icon="mdi:timer-alert-outline"></ha-icon>
        <span>
          <strong>${ci("panels.zones.clamped.title",i)}</strong>
          <ha-icon
            class="clamped-hint"
            icon="mdi:information-outline"
          ></ha-icon>
    ...
    `}_renderZoneEstimate(e){if(!this.hass)return G``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return G``;const i=this.hass.language,n=hi(this.config,we),o=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",a=ci(`panels.zones.status.estimate_method.${"proxy"===t.method||"hourly_sensor"===t.method?t.method:"hourly"}`,i)+(t.as_of?` · ${vi(t.as_of)}`:"");return G`
      <span class="status-sep">·</span>
      <span class="zone-estimate" title="${a}">
        ${ci("panels.zones.status.estimate_now",i)}
        <strong style="color: ${o}"
          >≈ ${t.live_deficit.toFixed(2)} ${n}</strong
        >
        <span class="estimate-tag"
          >${ci("panels.zones.status.estimate_tag",i)}</span
        >
      </span>
      ...
      <ha-card>
        <div class="card-header">
          ...
          ${this.hideSettingsLinks?"":G`
                <ha-icon-button
                  ...
                  title="${ci("panels.zones.actions.open_settings",this.hass.language)}"
        ...
        <div class="card-content">
          <div class="zone-status-line">
            <span
              title="${ci("panels.zones.help.bucket",this.hass.language)}"
            >
              ${ci("panels.zones.labels.bucket",this.hass.language)}:
              <strong style="color: ${o}"
                >${n.toFixed(2)}
                ${hi(this.config,we)}</strong
              >
            </span>
            <span class="status-sep">·</span>
            <span>
              ${ci("panels.zones.status.last_checked",this.hass.language)}:
              <strong>${r}</strong>
            </span>
        ...
        <div class="card-content zone-action-bar">
          ${"full"===this.actionsMode&&e.state===$e.Automatic?G`
                <button
                  class="action-btn"
                  title="${ci("panels.zones.help.update",this.hass.language)}"
                ...
                <button
                  class="action-btn"
                  title="${ci("panels.zones.help.calculate",this.hass.language)}"
          ...
          ${"none"!==this.actionsMode&&this._canActuate(e)&&this._zoneHasDeficit(e)?G`
                ...
                >
                  ...
                  ${ci("panels.zones.labels.irrigate_now",this.hass.language)}
                </button>
              `:this._canActuate(e)?"":G`
                  <button
                    class="action-btn"
                    disabled
                    title="${ci("panels.zones.help.irrigate_link_entity",this.hass.language)}"
                  >
                    <ha-icon icon="mdi:water"></ha-icon>
                    ${ci("panels.zones.labels.irrigate_now",this.hass.language)}
                  </button>
                  <span class="zones-top-note">
                    ${ci("panels.zones.help.irrigate_link_entity",this.hass.language)}
                  </span>
                `}
    ...
    `}_renderRunZoneControl(e){if(!this.hass||"none"===this.actionsMode||!this._canActuate(e)||void 0===e.id)return G``;const t=this.hass.language,i=String(e.id),n=this._activeRun(e);if(n){const i=this._runSecondsLeft(n);return G`
        <div class="run-zone-control running">
          <span class="run-zone-countdown">
            ...
            ${null===i?ci("panels.zones.stop_zone.watering",t):this._formatCountdown(i)}
          </span>
          <button
          ...
          >
            ...
            ${ci("panels.zones.stop_zone.stop",t)}
          </button>
        </div>
      ...
      <div class="run-zone-control-wrap">
        <div
          ...
          title="${ci("panels.zones.run_zone.help",t)}"
        >
          <input
          ...
          <span class="run-zone-unit"
            >${ci("panels.zones.run_zone.minutes",t)}</span
          >
          <button
            class="action-btn"
          ...
          >
            ...
            ${ci("panels.zones.run_zone.run",t)}
          </button>
        </div>
        ${o?G`<span class="run-zone-busy-hint">
              ${ci("panels.zones.run_zone.busy_hint",t)}
            </span>`:""}
      </div>
    `}_formatCountdown(e){const t=Math.max(0,e),i=Math.floor(t/3600),n=Math.floor(t%3600/60),o=t%60,a=e=>String(e).padStart(2,"0");return i>0?`${i}:${a(n)}:${a(o)}`:`${n}:${a(o)}`}render(){var e,t;if(!this.hass)return G``;if(this.isLoading)return G`
        <ha-card header="${ci("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            <div class="loading-indicator">
              ${ci("common.loading-messages.general",this.hass.language)}
            </div>
          </div>
        </ha-card>
      ...
      ${n?this.hideSettingsLinks?G`
              <ha-card>
                <div class="card-content description-text">
                  ${ci("panels.zones.no_items",this.hass.language)}
                </div>
              </ha-card>
            `:G`
                ...
                <div class="setup-banner">
                  ...
                  <div class="setup-banner-content">
                    <div class="setup-banner-title">
                      ${ci("wizard.title",this.hass.language)}
                    </div>
                    <div class="setup-banner-desc">
                      ${ci("wizard.setup_complete_banner",this.hass.language)}
                    </div>
                  </div>
                  <button
                  ...
                  >
                    ${ci("wizard.open_wizard",this.hass.language)}
                  </button>
                </div>
              </ha-card>
            `:""}
      ...
      <ha-card>
        ...
        <div class="card-content zones-top-actions">
          ${"full"===this.actionsMode?G`
                <button
                  class="action-btn"
                  title="${ci("panels.zones.help.update_all",this.hass.language)}"
                  @click="${this.handleUpdateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:update"></ha-icon>
                  ${ci("panels.zones.cards.zone-actions.actions.update-all",this.hass.language)}
                </button>
                <button
                  class="action-btn"
                  title="${ci("panels.zones.help.calculate_all",this.hass.language)}"
                  @click="${this.handleCalculateAllZones}"
                  ?disabled="${this.isSaving}"
                >
                  <ha-icon icon="mdi:calculator"></ha-icon>
                  ${ci("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language)}
                </button>
              `:""}
          ${"none"!==this.actionsMode?G`
                <button
                  class="action-btn"
                  raised
                  title="${ci("panels.zones.help.irrigate_all",this.hass.language)}"
                  @click="${()=>{this._confirmIrrigate="all"}}"
                  ?disabled="${!i||this.isSaving}"
                >
                  <ha-icon icon="mdi:water"></ha-icon>
                  ${ci("panels.zones.actions.irrigate_all",this.hass.language)}
                </button>
              `:""}
          ${i?"":G`<span class="zones-top-note"
                >${ci("panels.info.cards.irrigate_now.no_linked_zones",this.hass.language)}</span
              >`}
        </div>
      </ha-card>
      ...
      ${null!==this._confirmIrrigate?G`
            <ha-dialog
              ...
              heading="${ci("panels.zones.confirm_irrigate.title",this.hass.language)}"
            >
              <p>
                ${ci("panels.zones.confirm_irrigate.body",this.hass.language)}
              </p>
              <p>
                <strong>
                  ${"all"===this._confirmIrrigate?`${ci("panels.zones.confirm_irrigate.all_linked_zones",this.hass.language)} (${this._linkedZoneCount})`:null!==(t=null===(e=this.zones.find(e=>{var t;return(null===(t=e.id)||void 0===t?void 0:t.toString())===this._confirmIrrigate}))||void 0===e?void 0:e.name)&&void 0!==t?t:this._confirmIrrigate}
                </strong>
              </p>
              <div class="dialog-footer">
                ...
                >
                  ${ci("common.actions.cancel",this.hass.language)}
                </button>
                <button
            ...
            <ha-card class="error-banner-card">
              <div class="error-banner">
                ...
                <ha-icon-button
                  ...
                  aria-label="${ci("common.actions.cancel",this.hass.language)}"
                ></ha-icon-button>
              </div>
            </ha-card>
          `:""}
    ...
    `}}t([de()],xi.prototype,"config",void 0),t([de({type:Boolean})],xi.prototype,"hideSettingsLinks",void 0),t([de({attribute:!1})],xi.prototype,"actionsMode",void 0),t([de({type:Array})],xi.prototype,"zones",void 0),t([pe()],xi.prototype,"_outlook",void 0),t([pe()],xi.prototype,"_distributors",void 0),t([de({type:Boolean})],xi.prototype,"isLoading",void 0),t([de({type:Boolean})],xi.prototype,"isSaving",void 0),t([pe()],xi.prototype,"_operationError",void 0),t([pe()],xi.prototype,"_confirmIrrigate",void 0),t([pe()],xi.prototype,"_skipDetailsOpen",void 0),t([pe()],xi.prototype,"_runMinutes",void 0),t([pe()],xi.prototype,"_now",void 0),customElements.get("smart-irrigation-view-zones")||customElements.define("smart-irrigation-view-zones",xi);class zi extends le{setConfig(e){this._config=e}getCardSize(){return 6}render(){var e;if(!this.hass||!this._config)return G``;if(!si(this.hass.language))return function(e){const t=ri(e);return si(e)?Promise.resolve():(ai[t]||(ai[t]=fetch(`/smart_irrigation_static/languages/${t}.json?v=${be}`).then(e=>e.ok?e.json():Promise.reject(e.status)).then(e=>{oi[t]=e}).catch(()=>{oi[t]=oi.en})),ai[t])}(this.hass.language).then(()=>this.requestUpdate()),G``;const t=null!==(e=this._config.actions)&&void 0!==e?e:"irrigate";return G`
      <smart-irrigation-view-zones
        .hass=${this.hass}
        .hideSettingsLinks=${!0}
        .actionsMode=${t}
      ></smart-irrigation-view-zones>
    `}}t([de({attribute:!1})],zi.prototype,"hass",void 0),t([pe()],zi.prototype,"_config",void 0),customElements.get("smart-irrigation-zones-card-impl")||customElements.define("smart-irrigation-zones-card-impl",zi),e.SmartIrrigationZonesCardImpl=zi}({});

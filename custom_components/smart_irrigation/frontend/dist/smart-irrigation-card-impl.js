...
`;const fi=e=>String(e).padStart(2,"0");function bi(e){return e instanceof Date?e:new Date(e)}function _i(e){const t=bi(e);return`${fi(t.getHours())}:${fi(t.getMinutes())}`}function yi(e){const t=bi(e);return`${t.getFullYear()}-${fi(t.getMonth()+1)}-${fi(t.getDate())} ${fi(t.getHours())}:${fi(t.getMinutes())}`}function vi(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}class wi extends(ze(le)){constructor(){super(...arguments),this.hideSettingsLinks=!1,this.actionsMode="full",this.zones=[],this._distributors=[],this.isLoading=!0,this._initialLoadDone=!1,this.isSaving=!1,this._operationError=null,this._confirmIrrigate=null,this._skipDetailsOpen=!1,this._runMinutes={},this._now=Date.now(),this._countdownTimer=null,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame(()=>{this._updateScheduled=!1,this.requestUpdate()}))}firstUpdated(){fe().then(()=>this._scheduleUpdate()).catch(e=>{console.error("Failed to load HA form:",e),this._scheduleUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdownTicker()}_syncCountdownTicker(){var e,t;const i=Object.keys(null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.active_runs)&&void 0!==t?t:{}).length>0;i&&null===this._countdownTimer?this._countdownTimer=window.setInterval(()=>{this._now=Date.now()},1e3):i||this._stopCountdownTicker()}_stopCountdownTicker(){null!==this._countdownTimer&&(window.clearInterval(this._countdownTimer),this._countdownTimer=null)}hassSubscribe(){return this._fetchData().catch(e=>{console.error("Failed to fetch initial data:",e)}),[this.hass.connection.subscribeMessage(()=>{this._fetchData().catch(e=>{console.error("Failed to fetch data on config update:",e)})},{type:_e+"_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=!this._initialLoadDone;try{e&&(this.isLoading=!0);const[i,n,o,r]=await Promise.all([(t=this.hass,t.callWS({type:_e+"/config"})),ke(this.hass),xe(this.hass).catch(e=>{console.error("Failed to fetch irrigation outlook:",e)}),Se(this.hass).catch(e=>(console.error("Failed to fetch distributors:",e),[]))]);this.config=i,this.zones=n,this._outlook=o,this._distributors=r,this._initialLoadDone=!0,this._syncCountdownTicker()}catch(e){console.error("Error fetching data:",e),pi(this,this.hass,"common.errors.load_failed",e)}finally{e&&(this.isLoading=!1),this._scheduleUpdate()}var t}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{calculate_all:!0})).catch(e=>{console.error("Failed to calculate all zones:",e),pi(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc-all:",e))}))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,this._scheduleUpdate(),(e=this.hass,e.callApi("POST",_e+"/zones",{update_all:!0})).catch(e=>{console.error("Failed to update all zones:",e),pi(this,this.hass,"common.errors.action_failed",e)}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update-all:",e))}))}_canActuate(e){return!!(e.linked_entity||"service"===e.watering_mode&&e.run_service||null!=e.distributor_id)}get _linkedZoneCount(){return this.zones.filter(e=>{var t;return this._canActuate(e)&&(null!==(t=e.duration)&&void 0!==t?t:0)>0}).length}async _doIrrigate(){var e;const t=this._confirmIrrigate;if(this._confirmIrrigate=null,null===t||!this.hass)return;const i="all"===t,n=i?void 0:this.zones.find(e=>{var i;return(null===(i=e.id)||void 0===i?void 0:i.toString())===t}),o=i?`(${this._linkedZoneCount})`:`: ${null!==(e=null==n?void 0:n.name)&&void 0!==e?e:t}`;try{await(r=this.hass,a=i?void 0:t,r.callWS(Object.assign({type:_e+"/irrigate_now"},void 0!==a?{zone_id:a}:{}))),di(this,`${li("panels.zones.confirm_irrigate.toast_started",this.hass.language)} ${o}`)}catch(e){const t=ui(e);console.error("irrigate_now failed",e),di(this,`${li("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}var r,a}get _rainDelayUntil(){var e;const t=null===(e=this._outlook)||void 0===e?void 0:e.rain_delay_until;if(!t)return null;const i=new Date(t);return i.getTime()>Date.now()?i:null}async _setRainDelay(e){if(this.hass)try{await((e,t)=>e.callWS({type:_e+"/set_rain_delay",hours:t}))(this.hass,e),await this._fetchData()}catch(e){console.error("set_rain_delay failed",e),pi(this,this.hass,"common.errors.action_failed",e)}}async _clearRainDelay(){var e;if(this.hass)try{await(e=this.hass,e.callWS({type:_e+"/clear_rain_delay"})),await this._fetchData()}catch(e){console.error("clear_rain_delay failed",e),pi(this,this.hass,"common.errors.action_failed",e)}}_zoneRunMinutes(e){var t,i;const n=String(null!==(t=e.id)&&void 0!==t?t:"");return null!==(i=this._runMinutes[n])&&void 0!==i?i:10}_zoneDistributor(e){if(null!=e.distributor_id)return this._distributors.find(t=>t.id===e.distributor_id)}_distributorBusy(e){var t;const i=this._zoneDistributor(e);return!!i&&Object.keys(null!==(t=i.active_cycle)&&void 0!==t?t:{}).length>0}async _runZoneFor(e){if(!this.hass||!this._canActuate(e)||void 0===e.id)return;if(this._distributorBusy(e))return;const t=this._zoneRunMinutes(e);var i,n,o;if(t>0)try{await(i=this.hass,n=e.id.toString(),o=t,i.callWS({type:_e+"/run_zone",zone_id:n,duration:o})),di(this,`${li("panels.zones.run_zone.toast_started",this.hass.language)}: ${e.name} (${t} min)`)}catch(e){const t=ui(e);console.error("run_zone failed",e),di(this,`${li("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}_activeRun(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.active_runs)||void 0===i?void 0:i[String(e.id)]}_runSecondsLeft(e){if(!e.ends_at)return null;const t=Math.round((new Date(e.ends_at).getTime()-this._now)/1e3);return t>0?t:0}async _stopZone(e){var t,i;if(this.hass&&void 0!==e.id)try{await(t=this.hass,i=e.id.toString(),t.callWS({type:_e+"/stop_zone",zone_id:i})),di(this,`${li("panels.zones.stop_zone.toast_stopped",this.hass.language)}: ${e.name}`),await this._fetchData()}catch(e){const t=ui(e);console.error("stop_zone failed",e),di(this,`${li("panels.zones.confirm_irrigate.toast_failed",this.hass.language)}: ${t}`)}}handleCalculateZone(e){const t=this.zones[e];var i,n;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,n=t.id.toString(),i.callApi("POST",_e+"/zones",{id:n,calculate:!0,override_cache:!0})).catch(e=>{const t=ui(e);console.error("calculateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after calc:",e))}))}handleUpdateZone(e){const t=this.zones[e];var i,n;t&&null!=t.id&&this.hass&&(this._operationError=null,this.isSaving=!0,this._scheduleUpdate(),(i=this.hass,n=t.id.toString(),i.callApi("POST",_e+"/zones",{id:n,update:!0})).catch(e=>{const t=ui(e);console.error("updateZone failed:",e),this._operationError=t}).finally(()=>{this.isSaving=!1,this._fetchData().catch(e=>console.error("fetchData after update:",e))}))}_openZoneSettings(e){const t=void 0!==e.id?{params:{zone:String(e.id)}}:void 0;hi(0,t?mi("setup","zones",t):mi("setup","zones"))}_runTargetsZone(e,t){return"all"===e.zones||!(!Array.isArray(e.zones)||void 0===t.id)&&e.zones.map(e=>Number(e)).includes(Number(t.id))}get _nextIrrigateRun(){var e;return null===(e=this._outlook)||void 0===e?void 0:e.upcoming_runs.find(e=>"irrigate"===e.action&&e.next_run_utc)}_nextIrrigateRunForZone(e){var t;return null===(t=this._outlook)||void 0===t?void 0:t.upcoming_runs.find(t=>"irrigate"===t.action&&t.next_run_utc&&this._runTargetsZone(t,e))}get _activeGuards(){var e,t;return null!==(t=null===(e=this._outlook)||void 0===e?void 0:e.skip_preview.checks.filter(e=>e.enabled))&&void 0!==t?t:[]}get _triggeredGuards(){return this._activeGuards.filter(e=>e.would_skip)}_zoneHasDeficit(e){var t,i,n;const o=null!==(t=e.duration)&&void 0!==t?t:0,r=Number(null!==(i=e.bucket_threshold)&&void 0!==i?i:0),a=this._zoneEstimate(e),s=a&&a.available&&null!=a.live_deficit?a.live_deficit:Number(null!==(n=e.bucket)&&void 0!==n?n:0);return o>0&&s<r}_formatRunTime(e){if(!this.hass)return"";const t=this.hass.language,i=new Date(e),n=_i(i),o=new Date;return vi(i,o)?`${li("panels.zones.outlook.today",t)} ${n}`:vi(i,function(e,t){const i=new Date(e.getTime());return i.setDate(i.getDate()+t),i}(o,1))?`${li("panels.zones.outlook.tomorrow",t)} ${n}`:function(e,t){const i=bi(e);return`${new Intl.DateTimeFormat(t,{weekday:"short"}).format(i)} ${_i(i)}`}(i,t)}_guardLabel(e){return li(`panels.zones.outlook.checks.${e.id}`,this.hass.language)}_guardDetail(e){var t;return e.available&&null!==e.observed?li(`panels.zones.outlook.check_detail.${e.id}`,this.hass.language,"{observed}",String(e.observed),"{threshold}",String(null!==(t=e.threshold)&&void 0!==t?t:"")):""}_renderSkipReasons(){const e=this.hass.language;return G`
    ...
    `}_renderLastRunLine(e){const t=this.hass.language,i=function(e,t){const i=bi(e).getTime()-Date.now(),n=new Intl.RelativeTimeFormat(t,{numeric:"auto"}),o=Math.round(i/1e3);if(Math.abs(o)<60)return n.format(o,"second");const r=Math.round(o/60);if(Math.abs(r)<60)return n.format(r,"minute");const a=Math.round(r/60);if(Math.abs(a)<24)return n.format(a,"hour");const s=Math.round(a/24);if(Math.abs(s)<30)return n.format(s,"day");const l=Math.round(s/30);return Math.abs(l)<12?n.format(l,"month"):n.format(Math.round(l/12),"year")}(e.timestamp,t),n=e.checks.filter(e=>e.enabled&&e.would_skip).map(e=>this._guardLabel(e).toLowerCase()).join(", "),o=e.would_skip?`${li("panels.zones.outlook.last_run_skipped",t)}${n?` (${n})`:""}`:li("panels.zones.outlook.last_run_ran",t);return G`
    ...
    `}_renderZoneDecision(e){var t;if(!this.hass)return G``;const i=this.hass.language,n=null!==(t=e.duration)&&void 0!==t?t:0;let o,r,a;if(e.state===$e.Disabled)o=li("panels.zones.status.decision_disabled",i),r="neutral",a="mdi:power-off";else if(e.last_calculated)if(this._zoneHasDeficit(e)){const t=function(e){const t=Math.round(e);if(t<60)return`${t} s`;const i=Math.floor(t/60),n=t%60;return n?`${i} min ${n} s`:`${i} min`}(n),s=this._triggeredGuards,l=this._nextIrrigateRunForZone(e);s.length>0?(o=li("panels.zones.status.decision_water_skip",i,"{duration}",t,"{reason}",this._guardLabel(s[0]).toLowerCase()),r="skip",a="mdi:weather-rainy"):l&&l.next_run_utc?(o=li("panels.zones.status.decision_water_at",i,"{duration}",t,"{time}",this._formatRunTime(l.next_run_utc)),r="water",a="mdi:water"):(o=li("panels.zones.status.decision_water_no_schedule",i,"{duration}",t),r="water",a="mdi:water-alert")}else o=li("panels.zones.status.decision_no_water",i),r="ok",a="mdi:check-circle-outline";else o=li("panels.zones.status.decision_unknown",i),r="unknown",a="mdi:help-circle-outline";return G`
      <div class="zone-decision ${r}">
        <ha-icon icon="${a}"></ha-icon>
        <span>${o}</span>
      </div>
    `}_zoneEstimate(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_estimates)||void 0===i?void 0:i[String(e.id)]}_zoneFault(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_faults)||void 0===i?void 0:i[String(e.id)]}_renderZoneFault(e){if(!this.hass)return G``;const t=this._zoneFault(e);if(!t)return G``;const i=this.hass.language,n=li(`panels.zones.fault.${t.reason}`,i)||li("panels.zones.fault.generic",i),o=t.timestamp?yi(t.timestamp):"";return G`
    ...
    `}_zoneSkip(e){var t,i;if(void 0!==e.id)return null===(i=null===(t=this._outlook)||void 0===t?void 0:t.zone_skips)||void 0===i?void 0:i[String(e.id)]}_renderZoneSkip(e){if(!this.hass)return G``;const t=this._zoneSkip(e);if(!t)return G``;const i=this.hass.language,n=li("panels.zones.skip.soil_moisture",i,"{observed}",String(t.observed),"{threshold}",String(t.threshold)),o=t.timestamp?yi(t.timestamp):"";return G`
    ...
    `}_renderZoneEstimate(e){if(!this.hass)return G``;const t=this._zoneEstimate(e);if(!t||!t.available||null==t.live_deficit)return G``;const i=this.hass.language,n=ci(this.config,we),o=t.live_deficit<0?"var(--warning-color)":"var(--success-color)",r=li(`panels.zones.status.estimate_method.${"proxy"===t.method?"proxy":"hourly"}`,i)+(t.as_of?` · ${_i(t.as_of)}`:"");return G`

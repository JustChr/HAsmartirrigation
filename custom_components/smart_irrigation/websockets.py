        ...
        vol.Schema(
            {
                ...
                vol.Optional(const.CONF_ZONE_SEQUENCING_MAX_CONSECUTIVE_DURATION): vol.Coerce(int),
                vol.Optional(const.CONF_ZONE_SEQUENCING_MIN_ABSORPTION_TIME): vol.Coerce(int),

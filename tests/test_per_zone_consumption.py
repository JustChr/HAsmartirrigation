...
async def test_calculating_one_zone_keeps_sibling_history(coord):
    ...
    # 4 readings (20,21,22,23) averaged -> 21.5. This zone's mapping is polled,
    # not event-driven, so it keeps the plain mean: time-weighting is opt-in with
    # continuous updates (see test_aggregate_time_weighting_is_opt_in).
